(() => {
  ...
  function isPromiseCanceledError(error) {
    return error instanceof Error && error.name === canceledName &&
  ...
  var MultiDisposeError = class extends Error {
    constructor(errors) {
      super(
        `Encountered errors while disposing of store. Errors: [${
          errors.join(", ")
        }]`,
      );
      this.errors = errors;
  ...
  var globals = typeof self === "object"
    ? self
  ...
  var isElectronProcess =
    typeof ((_a = nodeProcess === null || nodeProcess === void 0
            ? void 0
            : nodeProcess.versions) === null || _a === void 0
      ? void 0
      : _a.electron) === "string";
  var isElectronRenderer = isElectronProcess &&
  ...
  if (typeof navigator === "object" && !isElectronRenderer) {
    ...
    _isIOS = (_userAgent.indexOf("Macintosh") >= 0 ||
      _userAgent.indexOf("iPad") >= 0 || _userAgent.indexOf("iPhone") >= 0) &&
  ...
  var hasPerformanceNow = globals.performance &&
    typeof globals.performance.now === "function";
  var StopWatch = class {
  ...
  var Emitter = class {
    ...
    get event() {
      if (!this._event) {
        this._event = (listener, thisArgs, disposables) => {
          ...
          if (
            firstListener && this._options && this._options.onFirstListenerAdd
          ) {
          ...
          const removeMonitor =
            (_a2 = this._leakageMon) === null || _a2 === void 0
              ? void 0
              : _a2.check(this._listeners.size);
          const result = toDisposable(() => {
            ...
            if (!this._disposed) {
              ...
              if (this._options && this._options.onLastListenerRemove) {
                const hasListeners = this._listeners &&
    ...
    fire(event) {
      ...
      if (this._listeners) {
        ...
        (_a2 = this._perfMon) === null || _a2 === void 0
          ? void 0
          : _a2.start(this._deliveryQueue.size);
    ...
    dispose() {
      ...
      if (!this._disposed) {
        this._disposed = true;
        (_a2 = this._listeners) === null || _a2 === void 0
          ? void 0
          : _a2.clear();
        (_b = this._deliveryQueue) === null || _b === void 0
          ? void 0
          : _b.clear();
        (_d = (_c = this._options) === null || _c === void 0
              ? void 0
  ...
  var AmbiguousCharacters = class {
    ...
    static isAmbiguous(codePoint) {
      return AmbiguousCharacters.getConfusablesForCurrentLocale().has(
        codePoint,
      );
    }
    static getPrimaryConfusable(codePoint) {
      return AmbiguousCharacters.getConfusablesForCurrentLocale().get(
        codePoint,
      );
    }
    static getPrimaryConfusableCodePoints() {
      return new Set(
        AmbiguousCharacters.getConfusablesForCurrentLocale().keys(),
      );
    }
  };
  ...
  var SimpleWorkerProtocol = class {
    ...
    _handleSubscribeEventMessage(msg) {
      const req = msg.req;
      const disposable = this._handler.handleEvent(msg.eventName, msg.arg)(
        (event) => {
  ...
  var SimpleWorkerServer = class {
    ...
    initialize(workerId, loaderConfig, moduleId, hostMethods) {
      ...
      const hostProxy = createProxyObject2(
        hostMethods,
        proxyMethodRequest,
        proxyListen,
      );
  ...
  function toHexString(bufferOrValue, bitsize = 32) {
    if (bufferOrValue instanceof ArrayBuffer) {
      return Array.from(new Uint8Array(bufferOrValue)).map((b) =>
  ...
  var StringSHA1 = class {
    ...
    digest() {
      ...
      return toHexString(this._h0) + toHexString(this._h1) +
        toHexString(this._h2) + toHexString(this._h3) + toHexString(this._h4);
    }
    _wrapUp() {
    ...
    _step() {
      ...
      for (let j = 0; j < 80; j++) {
        ...
        temp =
          leftRotate(a2, 5) + f2 + e + k + bigBlock32.getUint32(j * 4, false) &
          4294967295;
        e = d;
        d = c;
        c = leftRotate(b, 30);
  ...
  var LcsDiff = class {
    ...
    WALKTRACE(
      ...
      let diagonalRelative = midOriginalArr[0] - midModifiedArr[0] -
        diagonalForwardOffset;
      ...
      do {
        ...
        if (
          ...
          modifiedIndex = originalIndex - diagonalRelative -
            diagonalForwardOffset;
    ...
    ComputeRecursionPoint(
      ...
      this.m_forwardHistory = [];
      this.m_reverseHistory = [];
      const maxDifferences = originalEnd - originalStart +
      ...
      for (
        ...
        for (
          ...
          modifiedIndex = originalIndex - (diagonal - diagonalForwardBase) -
            diagonalForwardOffset;
          const tempOriginalIndex = originalIndex;
          while (
            originalIndex < originalEnd && modifiedIndex < modifiedEnd &&
          ...
          if (
            ...
            if (originalIndex >= reversePoints[diagonal]) {
              ...
              if (
                tempOriginalIndex <= reversePoints[diagonal] && 1447 > 0 &&
        ...
        if (
          ...
          if (
            matchLengthOfLongest > 0 && 1447 > 0 && numDifferences <= 1447 + 1
          ) {
            return this.WALKTRACE(
              diagonalForwardBase,
              diagonalForwardStart,
        ...
        for (
          ...
          modifiedIndex = originalIndex - (diagonal - diagonalReverseBase) -
            diagonalReverseOffset;
          const tempOriginalIndex = originalIndex;
          while (
            originalIndex > originalStart && modifiedIndex > modifiedStart &&
          ...
          if (
            ...
            if (originalIndex <= forwardPoints[diagonal]) {
              ...
              midModifiedArr[0] = modifiedIndex;
              if (
                tempOriginalIndex >= forwardPoints[diagonal] && 1447 > 0 &&
                numDifferences <= 1447 + 1
              ) {
                return this.WALKTRACE(
                  diagonalForwardBase,
    ...
    PrettifyChanges(changes) {
      for (let i = 0; i < changes.length; i++) {
        ...
        const originalStop = i < changes.length - 1
          ? changes[i + 1].originalStart
          : this._originalElementsOrHash.length;
        const modifiedStop = i < changes.length - 1
      ...
      for (let i = changes.length - 1; i >= 0; i--) {
        ...
        for (let delta = 1;; delta++) {
          ...
          const touchingPreviousChange = originalStart === originalStop &&
      ...
      if (this._hasStrings) {
        for (let i = 1, len = changes.length; i < len; i++) {
          ...
          const matchedLength = bChange.originalStart - aChange.originalStart -
          ...
          if (
            matchedLength < 5 && abOriginalLength < 20 && abModifiedLength < 20
          ) {
            ...
            if (t) {
              ...
              if (
                ...
                aChange.originalLength = originalMatchStart -
                  aChange.originalStart;
                aChange.modifiedLength = modifiedMatchStart -
                  aChange.modifiedStart;
    ...
    _boundaryScore(
      ...
      const originalScore =
        this._OriginalRegionIsBoundary(originalStart, originalLength) ? 1 : 0;
      const modifiedScore =
        this._ModifiedRegionIsBoundary(modifiedStart, modifiedLength) ? 1 : 0;
    ...
    ChangesOverlap(left, right, mergedChangeArr) {
      ...
      if (
        ...
        if (left.originalStart + left.originalLength >= right.originalStart) {
          originalLength = right.originalStart + right.originalLength -
            left.originalStart;
        }
        if (left.modifiedStart + left.modifiedLength >= right.modifiedStart) {
          modifiedLength = right.modifiedStart + right.modifiedLength -
            left.modifiedStart;
        }
  ...
  var URI = class {
    ...
    static isUri(thing) {
      ...
      return typeof thing.authority === "string" &&
        typeof thing.fragment === "string" && typeof thing.path === "string" &&
        typeof thing.query === "string" && typeof thing.scheme === "string" &&
        typeof thing.fsPath === "string" && typeof thing.with === "function" &&
    ...
    static joinPath(uri, ...pathFragment) {
      ...
      if (isWindows && uri.scheme === "file") {
        newPath =
          URI.file(win32.join(uriToFsPath(uri, true), ...pathFragment)).path;
      } else {
  ...
  function _asFormatted(uri, skipEncoding) {
    ...
    if (path) {
      if (
        path.length >= 3 && path.charCodeAt(0) === 47 &&
  ...
  var Position = class {
    ...
    static equals(a2, b) {
      ...
      return !!a2 && !!b && a2.lineNumber === b.lineNumber &&
        a2.column === b.column;
    }
    isBefore(other) {
    ...
    static isIPosition(obj) {
      return obj && typeof obj.lineNumber === "number" &&
  ...
  var Range = class {
    ...
    static equalsRange(a2, b) {
      return !!a2 && !!b && a2.startLineNumber === b.startLineNumber &&
        a2.startColumn === b.startColumn &&
        a2.endLineNumber === b.endLineNumber && a2.endColumn === b.endColumn;
    }
    getEndPosition() {
    ...
    static isIRange(obj) {
      return obj && typeof obj.startLineNumber === "number" &&
    ...
    static areIntersectingOrTouching(a2, b) {
      if (
        a2.endLineNumber < b.startLineNumber ||
        a2.endLineNumber === b.startLineNumber && a2.endColumn < b.startColumn
      ) {
        return false;
      }
      if (
        b.endLineNumber < a2.startLineNumber ||
        b.endLineNumber === a2.startLineNumber && b.endColumn < a2.startColumn
      ) {
        return false;
      }
      return true;
  ...
  function postProcessCharChanges(rawChanges) {
    ...
    for (let i = 1, len = rawChanges.length; i < len; i++) {
      ...
      if (matchingLength < MINIMUM_MATCHING_CHARACTER_LENGTH) {
        prevChange.originalLength = currChange.originalStart +
          currChange.originalLength - prevChange.originalStart;
        prevChange.modifiedLength = currChange.modifiedStart +
          currChange.modifiedLength - prevChange.modifiedStart;
      } else {
  ...
  var LineChange = class {
    ...
    static createFromDiffResult(
      ...
      if (
        shouldComputeCharChanges && diffChange.originalLength > 0 &&
        diffChange.originalLength < 20 && diffChange.modifiedLength > 0 &&
        diffChange.modifiedLength < 20 && continueCharDiff()
      ) {
    ...
    constructor(originalLines, modifiedLines, opts) {
      ...
      this.continueCharDiff = createContinueProcessingPredicate(
        opts.maxComputationTime === 0
          ? 0
          : Math.min(opts.maxComputationTime, 5e3),
      );
    }
    computeDiff() {
      if (
        this.original.lines.length === 1 && this.original.lines[0].length === 0
      ) {
        if (
      ...
      if (
        this.modified.lines.length === 1 && this.modified.lines[0].length === 0
      ) {
        return {
          quitEarly: false,
          changes: [{
      ...
      for (let i = -1, len = rawChanges.length; i < len; i++) {
        ...
        while (
          originalLineIndex < originalStop && modifiedLineIndex < modifiedStop
        ) {
  ...
  var MirrorTextModel = class {
    ...
    _acceptInsertText(position, insertText) {
      ...
      insertLines[insertLines.length - 1] += this
        ._lines[position.lineNumber - 1].substring(position.column - 1);
      this._setLineText(
        position.lineNumber - 1,
          ...
          if (state === 13) {
            ...
            switch (chCode) {
              ...
              case 125:
                ...
                break;
              case 39:
                chClass = linkBeginChCode === 34 || linkBeginChCode === 96
                  ? 0
                  : 1;
                break;
              case 34:
                chClass = linkBeginChCode === 39 || linkBeginChCode === 96
                  ? 0
                  : 1;
                break;
              case 96:
                chClass = linkBeginChCode === 39 || linkBeginChCode === 34
                  ? 0
                  : 1;
                break;
              case 42:
  ...
  function computeLinks(model) {
    if (
      !model || typeof model.getLineCount !== "function" ||
  ...
  (function (CancellationToken2) {
    function isCancellationToken(thing) {
      if (
        thing === CancellationToken2.None ||
        thing === CancellationToken2.Cancelled
      ) {
        return true;
      }
  ...
  var CancellationTokenSource = class {
    constructor(parent) {
      ...
      this._parentListener = parent &&
        parent.onCancellationRequested(this.cancel, this);
    }
    get token() {
      if (!this._token) {
    ...
    for (const mapping of mappings) {
      ...
      if (!seenScanCode[scanCode]) {
        ...
        if (immutable) {
          ...
          if (
            keyCode !== 0 && keyCode !== 3 && keyCode !== 5 && keyCode !== 4 &&
            keyCode !== 6 && keyCode !== 57
          ) {
  ...
  (function (KeyCodeUtils2) {
    ...
    function fromUserSettings(key) {
      return userSettingsUSMap.strToKeyCode(key) ||
  ...
  var Selection = class extends Range {
    ...
    static selectionsEqual(a2, b) {
      return a2.selectionStartLineNumber === b.selectionStartLineNumber &&
        a2.selectionStartColumn === b.selectionStartColumn &&
        a2.positionLineNumber === b.positionLineNumber &&
        a2.positionColumn === b.positionColumn;
    }
    getDirection() {
      if (
    ...
    static isISelection(obj) {
      return obj && typeof obj.selectionStartLineNumber === "number" &&
  ...
  (function (CompletionItemInsertTextRule2) {
    CompletionItemInsertTextRule2[
      CompletionItemInsertTextRule2["KeepWhitespace"] = 1
    ] = "KeepWhitespace";
    CompletionItemInsertTextRule2[
      CompletionItemInsertTextRule2["InsertAsSnippet"] = 4
    ] = "InsertAsSnippet";
  ...
  (function (CompletionItemKind3) {
    ...
    CompletionItemKind3[CompletionItemKind3["Customcolor"] = 22] =
      "Customcolor";
    CompletionItemKind3[CompletionItemKind3["Folder"] = 23] = "Folder";
    CompletionItemKind3[CompletionItemKind3["TypeParameter"] = 24] =
      "TypeParameter";
  ...
  (function (CompletionTriggerKind2) {
    ...
    CompletionTriggerKind2[CompletionTriggerKind2["TriggerCharacter"] = 1] =
      "TriggerCharacter";
    CompletionTriggerKind2[
      CompletionTriggerKind2["TriggerForIncompleteCompletions"] = 2
    ] = "TriggerForIncompleteCompletions";
  })(CompletionTriggerKind || (CompletionTriggerKind = {}));
  var ContentWidgetPositionPreference;
  (function (ContentWidgetPositionPreference2) {
    ContentWidgetPositionPreference2[
      ContentWidgetPositionPreference2["EXACT"] = 0
    ] = "EXACT";
    ContentWidgetPositionPreference2[
      ContentWidgetPositionPreference2["ABOVE"] = 1
    ] = "ABOVE";
    ContentWidgetPositionPreference2[
      ContentWidgetPositionPreference2["BELOW"] = 2
    ] = "BELOW";
  })(ContentWidgetPositionPreference || (ContentWidgetPositionPreference = {}));
  var CursorChangeReason;
  (function (CursorChangeReason2) {
    CursorChangeReason2[CursorChangeReason2["NotSet"] = 0] = "NotSet";
    CursorChangeReason2[CursorChangeReason2["ContentFlush"] = 1] =
      "ContentFlush";
    CursorChangeReason2[CursorChangeReason2["RecoverFromMarkers"] = 2] =
      "RecoverFromMarkers";
  ...
  (function (EditorAutoIndentStrategy2) {
    ...
    EditorAutoIndentStrategy2[EditorAutoIndentStrategy2["Brackets"] = 2] =
      "Brackets";
    EditorAutoIndentStrategy2[EditorAutoIndentStrategy2["Advanced"] = 3] =
      "Advanced";
  ...
  (function (EditorOption2) {
    ...
    EditorOption2[EditorOption2["acceptSuggestionOnEnter"] = 1] =
      "acceptSuggestionOnEnter";
    EditorOption2[EditorOption2["accessibilitySupport"] = 2] =
      "accessibilitySupport";
    EditorOption2[EditorOption2["accessibilityPageSize"] = 3] =
      "accessibilityPageSize";
    EditorOption2[EditorOption2["ariaLabel"] = 4] = "ariaLabel";
    EditorOption2[EditorOption2["autoClosingBrackets"] = 5] =
      "autoClosingBrackets";
    EditorOption2[EditorOption2["autoClosingDelete"] = 6] = "autoClosingDelete";
    EditorOption2[EditorOption2["autoClosingOvertype"] = 7] =
      "autoClosingOvertype";
    ...
    EditorOption2[EditorOption2["bracketPairColorization"] = 12] =
      "bracketPairColorization";
    EditorOption2[EditorOption2["guides"] = 13] = "guides";
    EditorOption2[EditorOption2["codeLens"] = 14] = "codeLens";
    EditorOption2[EditorOption2["codeLensFontFamily"] = 15] =
      "codeLensFontFamily";
    ...
    EditorOption2[EditorOption2["copyWithSyntaxHighlighting"] = 21] =
      "copyWithSyntaxHighlighting";
    EditorOption2[EditorOption2["cursorBlinking"] = 22] = "cursorBlinking";
    EditorOption2[EditorOption2["cursorSmoothCaretAnimation"] = 23] =
      "cursorSmoothCaretAnimation";
    EditorOption2[EditorOption2["cursorStyle"] = 24] = "cursorStyle";
    EditorOption2[EditorOption2["cursorSurroundingLines"] = 25] =
      "cursorSurroundingLines";
    EditorOption2[EditorOption2["cursorSurroundingLinesStyle"] = 26] =
      "cursorSurroundingLinesStyle";
    EditorOption2[EditorOption2["cursorWidth"] = 27] = "cursorWidth";
    EditorOption2[EditorOption2["disableLayerHinting"] = 28] =
      "disableLayerHinting";
    EditorOption2[EditorOption2["disableMonospaceOptimizations"] = 29] =
      "disableMonospaceOptimizations";
    EditorOption2[EditorOption2["domReadOnly"] = 30] = "domReadOnly";
    EditorOption2[EditorOption2["dragAndDrop"] = 31] = "dragAndDrop";
    EditorOption2[EditorOption2["emptySelectionClipboard"] = 32] =
      "emptySelectionClipboard";
    EditorOption2[EditorOption2["extraEditorClassName"] = 33] =
      "extraEditorClassName";
    EditorOption2[EditorOption2["fastScrollSensitivity"] = 34] =
      "fastScrollSensitivity";
    EditorOption2[EditorOption2["find"] = 35] = "find";
    EditorOption2[EditorOption2["fixedOverflowWidgets"] = 36] =
    ...
    EditorOption2[EditorOption2["foldingImportsByDefault"] = 40] =
      "foldingImportsByDefault";
    EditorOption2[EditorOption2["unfoldOnClickAfterEndOfLine"] = 41] =
    ...
    EditorOption2[EditorOption2["hideCursorInOverviewRuler"] = 51] =
    ...
    EditorOption2[EditorOption2["mouseWheelScrollSensitivity"] = 66] =
      "mouseWheelScrollSensitivity";
    EditorOption2[EditorOption2["mouseWheelZoom"] = 67] = "mouseWheelZoom";
    EditorOption2[EditorOption2["multiCursorMergeOverlapping"] = 68] =
      "multiCursorMergeOverlapping";
    EditorOption2[EditorOption2["multiCursorModifier"] = 69] =
      "multiCursorModifier";
    EditorOption2[EditorOption2["multiCursorPaste"] = 70] = "multiCursorPaste";
    EditorOption2[EditorOption2["occurrencesHighlight"] = 71] =
      "occurrencesHighlight";
    EditorOption2[EditorOption2["overviewRulerBorder"] = 72] =
      "overviewRulerBorder";
    EditorOption2[EditorOption2["overviewRulerLanes"] = 73] =
      "overviewRulerLanes";
    EditorOption2[EditorOption2["padding"] = 74] = "padding";
    EditorOption2[EditorOption2["parameterHints"] = 75] = "parameterHints";
    EditorOption2[EditorOption2["peekWidgetDefaultFocus"] = 76] =
      "peekWidgetDefaultFocus";
    EditorOption2[EditorOption2["definitionLinkOpensInPeek"] = 77] =
      "definitionLinkOpensInPeek";
    EditorOption2[EditorOption2["quickSuggestions"] = 78] = "quickSuggestions";
    EditorOption2[EditorOption2["quickSuggestionsDelay"] = 79] =
      "quickSuggestionsDelay";
    EditorOption2[EditorOption2["readOnly"] = 80] = "readOnly";
    EditorOption2[EditorOption2["renameOnType"] = 81] = "renameOnType";
    EditorOption2[EditorOption2["renderControlCharacters"] = 82] =
      "renderControlCharacters";
    EditorOption2[EditorOption2["renderFinalNewline"] = 83] =
      "renderFinalNewline";
    EditorOption2[EditorOption2["renderLineHighlight"] = 84] =
      "renderLineHighlight";
    EditorOption2[EditorOption2["renderLineHighlightOnlyWhenFocus"] = 85] =
      "renderLineHighlightOnlyWhenFocus";
    EditorOption2[EditorOption2["renderValidationDecorations"] = 86] =
      "renderValidationDecorations";
    EditorOption2[EditorOption2["renderWhitespace"] = 87] = "renderWhitespace";
    EditorOption2[EditorOption2["revealHorizontalRightPadding"] = 88] =
    ...
    EditorOption2[EditorOption2["scrollBeyondLastColumn"] = 92] =
      "scrollBeyondLastColumn";
    EditorOption2[EditorOption2["scrollBeyondLastLine"] = 93] =
      "scrollBeyondLastLine";
    EditorOption2[EditorOption2["scrollPredominantAxis"] = 94] =
      "scrollPredominantAxis";
    EditorOption2[EditorOption2["selectionClipboard"] = 95] =
      "selectionClipboard";
    EditorOption2[EditorOption2["selectionHighlight"] = 96] =
      "selectionHighlight";
    EditorOption2[EditorOption2["selectOnLineNumbers"] = 97] =
      "selectOnLineNumbers";
    EditorOption2[EditorOption2["showFoldingControls"] = 98] =
      "showFoldingControls";
    EditorOption2[EditorOption2["showUnused"] = 99] = "showUnused";
    EditorOption2[EditorOption2["snippetSuggestions"] = 100] =
      "snippetSuggestions";
    ...
    EditorOption2[EditorOption2["stopRenderingLineAfter"] = 104] =
      "stopRenderingLineAfter";
    EditorOption2[EditorOption2["suggest"] = 105] = "suggest";
    EditorOption2[EditorOption2["suggestFontSize"] = 106] = "suggestFontSize";
    EditorOption2[EditorOption2["suggestLineHeight"] = 107] =
      "suggestLineHeight";
    EditorOption2[EditorOption2["suggestOnTriggerCharacters"] = 108] =
    ...
    EditorOption2[EditorOption2["unicodeHighlighting"] = 112] =
      "unicodeHighlighting";
    EditorOption2[EditorOption2["unusualLineTerminators"] = 113] =
    ...
    EditorOption2[EditorOption2["wordWrapBreakAfterCharacters"] = 118] =
      "wordWrapBreakAfterCharacters";
    EditorOption2[EditorOption2["wordWrapBreakBeforeCharacters"] = 119] =
      "wordWrapBreakBeforeCharacters";
    EditorOption2[EditorOption2["wordWrapColumn"] = 120] = "wordWrapColumn";
    EditorOption2[EditorOption2["wordWrapOverride1"] = 121] =
      "wordWrapOverride1";
    EditorOption2[EditorOption2["wordWrapOverride2"] = 122] =
      "wordWrapOverride2";
  ...
  (function (EndOfLinePreference2) {
    EndOfLinePreference2[EndOfLinePreference2["TextDefined"] = 0] =
      "TextDefined";
  ...
  (function (InlineCompletionTriggerKind2) {
    InlineCompletionTriggerKind2[
      InlineCompletionTriggerKind2["Automatic"] = 0
    ] = "Automatic";
    InlineCompletionTriggerKind2[InlineCompletionTriggerKind2["Explicit"] = 1] =
      "Explicit";
  ...
  (function (MouseTargetType2) {
    ...
    MouseTargetType2[MouseTargetType2["GUTTER_GLYPH_MARGIN"] = 2] =
      "GUTTER_GLYPH_MARGIN";
    MouseTargetType2[MouseTargetType2["GUTTER_LINE_NUMBERS"] = 3] =
      "GUTTER_LINE_NUMBERS";
    MouseTargetType2[MouseTargetType2["GUTTER_LINE_DECORATIONS"] = 4] =
      "GUTTER_LINE_DECORATIONS";
    MouseTargetType2[MouseTargetType2["GUTTER_VIEW_ZONE"] = 5] =
      "GUTTER_VIEW_ZONE";
    MouseTargetType2[MouseTargetType2["CONTENT_TEXT"] = 6] = "CONTENT_TEXT";
    MouseTargetType2[MouseTargetType2["CONTENT_EMPTY"] = 7] = "CONTENT_EMPTY";
    MouseTargetType2[MouseTargetType2["CONTENT_VIEW_ZONE"] = 8] =
      "CONTENT_VIEW_ZONE";
    MouseTargetType2[MouseTargetType2["CONTENT_WIDGET"] = 9] = "CONTENT_WIDGET";
    MouseTargetType2[MouseTargetType2["OVERVIEW_RULER"] = 10] =
      "OVERVIEW_RULER";
    MouseTargetType2[MouseTargetType2["SCROLLBAR"] = 11] = "SCROLLBAR";
    MouseTargetType2[MouseTargetType2["OVERLAY_WIDGET"] = 12] =
      "OVERLAY_WIDGET";
    MouseTargetType2[MouseTargetType2["OUTSIDE_EDITOR"] = 13] =
      "OUTSIDE_EDITOR";
  })(MouseTargetType || (MouseTargetType = {}));
  var OverlayWidgetPositionPreference;
  (function (OverlayWidgetPositionPreference2) {
    OverlayWidgetPositionPreference2[
      OverlayWidgetPositionPreference2["TOP_RIGHT_CORNER"] = 0
    ] = "TOP_RIGHT_CORNER";
    OverlayWidgetPositionPreference2[
      OverlayWidgetPositionPreference2["BOTTOM_RIGHT_CORNER"] = 1
    ] = "BOTTOM_RIGHT_CORNER";
    OverlayWidgetPositionPreference2[
      OverlayWidgetPositionPreference2["TOP_CENTER"] = 2
    ] = "TOP_CENTER";
  ...
  (function (SignatureHelpTriggerKind2) {
    SignatureHelpTriggerKind2[SignatureHelpTriggerKind2["Invoke"] = 1] =
      "Invoke";
    SignatureHelpTriggerKind2[
      SignatureHelpTriggerKind2["TriggerCharacter"] = 2
    ] = "TriggerCharacter";
    SignatureHelpTriggerKind2[SignatureHelpTriggerKind2["ContentChange"] = 3] =
      "ContentChange";
  ...
  (function (TextEditorCursorBlinkingStyle2) {
    TextEditorCursorBlinkingStyle2[
      TextEditorCursorBlinkingStyle2["Hidden"] = 0
    ] = "Hidden";
    TextEditorCursorBlinkingStyle2[
      TextEditorCursorBlinkingStyle2["Blink"] = 1
    ] = "Blink";
    TextEditorCursorBlinkingStyle2[
      TextEditorCursorBlinkingStyle2["Smooth"] = 2
    ] = "Smooth";
    TextEditorCursorBlinkingStyle2[
      TextEditorCursorBlinkingStyle2["Phase"] = 3
    ] = "Phase";
    TextEditorCursorBlinkingStyle2[
      TextEditorCursorBlinkingStyle2["Expand"] = 4
    ] = "Expand";
    TextEditorCursorBlinkingStyle2[
      TextEditorCursorBlinkingStyle2["Solid"] = 5
    ] = "Solid";
  ...
  (function (TextEditorCursorStyle2) {
    ...
    TextEditorCursorStyle2[TextEditorCursorStyle2["Underline"] = 3] =
      "Underline";
    TextEditorCursorStyle2[TextEditorCursorStyle2["LineThin"] = 4] = "LineThin";
    TextEditorCursorStyle2[TextEditorCursorStyle2["BlockOutline"] = 5] =
      "BlockOutline";
    TextEditorCursorStyle2[TextEditorCursorStyle2["UnderlineThin"] = 6] =
      "UnderlineThin";
  })(TextEditorCursorStyle || (TextEditorCursorStyle = {}));
  var TrackedRangeStickiness;
  (function (TrackedRangeStickiness2) {
    TrackedRangeStickiness2[
      TrackedRangeStickiness2["AlwaysGrowsWhenTypingAtEdges"] = 0
    ] = "AlwaysGrowsWhenTypingAtEdges";
    TrackedRangeStickiness2[
      TrackedRangeStickiness2["NeverGrowsWhenTypingAtEdges"] = 1
    ] = "NeverGrowsWhenTypingAtEdges";
    TrackedRangeStickiness2[
      TrackedRangeStickiness2["GrowsOnlyWhenTypingBefore"] = 2
    ] = "GrowsOnlyWhenTypingBefore";
    TrackedRangeStickiness2[
      TrackedRangeStickiness2["GrowsOnlyWhenTypingAfter"] = 3
  ...
  var getMapForWordSeparators = once2((input) =>
    new WordCharacterClassifier(input)
  );
  ...
  (function (HorizontalGuidesState2) {
    ...
    HorizontalGuidesState2[HorizontalGuidesState2["EnabledForActive"] = 1] =
      "EnabledForActive";
      ...
      for (
        ...
        do {
          ...
          if (m) {
            ...
            const highlightReason = codePointHighlighter
              .shouldHighlightNonBasicASCII(str);
    ...
    static computeUnicodeHighlightReason(char, options) {
      ...
      switch (reason) {
        ...
        case 2:
          return { kind: 1 };
        case 3:
          const primaryConfusable = AmbiguousCharacters.getPrimaryConfusable(
            char.codePointAt(0),
          );
          return {
            kind: 0,
  ...
  var CodePointHighlighter = class {
    ...
    shouldHighlightNonBasicASCII(character) {
      ...
      if (this.options.invisibleCharacters) {
        const isAllowedInvisibleCharacter = character === " " ||
          character === "\n" || character === "	";
        if (
          !isAllowedInvisibleCharacter &&
  ...
  var MirrorModel = class extends MirrorTextModel {
    ...
    _validateRange(range) {
      ...
      if (
        ...
        end.lineNumber !== range.endLineNumber || end.column !== range.endColumn
      ) {
        return {
  ...
  var EditorSimpleWorker = class {
    ...
    computeDiff(
      ...
      return __awaiter(this, void 0, void 0, function* () {
        ...
        const identical = diffResult.changes.length > 0
          ? false
  ...
  function isWhiteSpace(ch) {
    return ch === 32 || ch === 9 || ch === 11 || ch === 12 || ch === 160 ||
      ch === 5760 || ch >= 8192 && ch <= 8203 || ch === 8239 || ch === 8287 ||
      ch === 12288 || ch === 65279;
  }
  ...
  function format(documentText, range, options) {
    ...
    if (range) {
      ...
      while (
        endOffset < documentText.length && !isEOL(documentText, endOffset)
      ) {
        endOffset++;
      }
    ...
    while (firstToken !== 17) {
      var firstTokenEnd = scanner2.getTokenOffset() +
        scanner2.getTokenLength() + formatTextStart;
      ...
      while (!lineBreak && (secondToken === 12 || secondToken === 13)) {
        ...
        firstTokenEnd = scanner2.getTokenOffset() + scanner2.getTokenLength() +
          formatTextStart;
  ...
  (function (Position22) {
    ...
    function is(value) {
      var candidate = value;
      return Is.objectLiteral(candidate) && Is.uinteger(candidate.line) &&
  ...
  (function (Range22) {
    function create(one, two, three, four) {
      if (
        Is.uinteger(one) && Is.uinteger(two) && Is.uinteger(three) &&
        Is.uinteger(four)
      ) {
        return {
        ...
        throw new Error(
          "Range#create called with invalid arguments[" + one + ", " + two +
            ", " + three + ", " + four + "]",
        );
      }
    }
    ...
    function is(value) {
      var candidate = value;
      return Is.objectLiteral(candidate) && Position2.is(candidate.start) &&
        Position2.is(candidate.end);
    }
    Range22.is = is;
  })(Range2 || (Range2 = {}));
  var Location;
  (function (Location2) {
    ...
    function is(value) {
      var candidate = value;
      return Is.defined(candidate) && Range2.is(candidate.range) &&
  ...
  (function (LocationLink2) {
    ...
    function is(value) {
      var candidate = value;
      return Is.defined(candidate) && Range2.is(candidate.targetRange) &&
        Is.string(candidate.targetUri) &&
        (Range2.is(candidate.targetSelectionRange) ||
          Is.undefined(candidate.targetSelectionRange)) &&
        (Range2.is(candidate.originSelectionRange) ||
  ...
  (function (FoldingRange2) {
    ...
    function is(value) {
      var candidate = value;
      return Is.uinteger(candidate.startLine) &&
  ...
  (function (DiagnosticRelatedInformation2) {
    ...
    function is(value) {
      var candidate = value;
      return Is.defined(candidate) && Location.is(candidate.location) &&
  ...
  (function (Diagnostic2) {
    ...
    function is(value) {
      ...
      return Is.defined(candidate) && Range2.is(candidate.range) &&
        ...
        (Is.integer(candidate.code) || Is.string(candidate.code) ||
  ...
  (function (Command2) {
    ...
    function is(value) {
      var candidate = value;
      return Is.defined(candidate) && Is.string(candidate.title) &&
  ...
  (function (ChangeAnnotation2) {
    ...
    function is(value) {
      var candidate = value;
      return candidate !== void 0 && Is.objectLiteral(candidate) &&
  ...
  (function (CreateFile2) {
    ...
    function is(value) {
      var candidate = value;
      return candidate && candidate.kind === "create" &&
  ...
  (function (RenameFile2) {
    ...
    function is(value) {
      var candidate = value;
      return candidate && candidate.kind === "rename" &&
        Is.string(candidate.oldUri) && Is.string(candidate.newUri) &&
        (candidate.options === void 0 ||
          (candidate.options.overwrite === void 0 ||
              Is.boolean(candidate.options.overwrite)) &&
            (candidate.options.ignoreIfExists === void 0 ||
  ...
  (function (DeleteFile2) {
    ...
    function is(value) {
      var candidate = value;
      return candidate && candidate.kind === "delete" &&
        Is.string(candidate.uri) &&
        (candidate.options === void 0 ||
        ...
        (candidate.documentChanges === void 0 ||
          candidate.documentChanges.every(function (change) {
            if (Is.string(change.kind)) {
              return CreateFile.is(change) || RenameFile.is(change) ||
  ...
  var ChangeAnnotations = function () {
    function ChangeAnnotations2(annotations) {
      this._annotations = annotations === void 0
      ...
      get: function () {
        ...
        if (this._changeAnnotations !== void 0) {
          if (this._changeAnnotations.size === 0) {
            ...
            this._workspaceEdit.changeAnnotations = this._changeAnnotations
              .all();
          }
        }
  ...
  (function (TextDocumentItem2) {
    ...
    function is(value) {
      var candidate = value;
      return Is.defined(candidate) && Is.string(candidate.uri) &&
        Is.string(candidate.languageId) && Is.integer(candidate.version) &&
  ...
  (function (MarkupKind2) {
    function is(value) {
      var candidate = value;
      return candidate === MarkupKind2.PlainText ||
  ...
  (function (MarkupContent2) {
    function is(value) {
      var candidate = value;
      return Is.objectLiteral(value) && MarkupKind.is(candidate.kind) &&
  ...
  (function (InsertReplaceEdit2) {
    ...
    function is(value) {
      ...
      return candidate && Is.string(candidate.newText) &&
        Range2.is(candidate.insert) && Range2.is(candidate.replace);
    }
  ...
  (function (MarkedString2) {
    ...
    function is(value) {
      ...
      return Is.string(candidate) ||
        Is.objectLiteral(candidate) && Is.string(candidate.language) &&
          Is.string(candidate.value);
    }
    MarkedString2.is = is;
  ...
  (function (Hover2) {
    function is(value) {
      ...
      return !!candidate && Is.objectLiteral(candidate) &&
        ...
        (value.range === void 0 || Range2.is(value.range));
    }
    Hover2.is = is;
  })(Hover || (Hover = {}));
  ...
  (function (DocumentSymbol2) {
    ...
    function is(value) {
      var candidate = value;
      return candidate && Is.string(candidate.name) &&
        Is.number(candidate.kind) && Range2.is(candidate.range) &&
        Range2.is(candidate.selectionRange) &&
  ...
  (function (FormattingOptions2) {
    ...
    function is(value) {
      var candidate = value;
      return Is.defined(candidate) && Is.uinteger(candidate.tabSize) &&
  ...
  (function (SelectionRange2) {
    ...
    function is(value) {
      var candidate = value;
      return candidate !== void 0 && Range2.is(candidate.range) &&
  ...
  (function (TextDocument3) {
    ...
    function is(value) {
      ...
      return Is.defined(candidate) && Is.string(candidate.uri) &&
          ...
          Is.uinteger(candidate.lineCount) && Is.func(candidate.getText) &&
          Is.func(candidate.positionAt) && Is.func(candidate.offsetAt)
        ? true
        : false;
    }
    TextDocument3.is = is;
    function applyEdits(document, edits) {
      ...
      for (var i = sortedEdits.length - 1; i >= 0; i--) {
        ...
        if (endOffset <= lastModifiedOffset) {
          text = text.substring(0, startOffset) + e.newText +
  ...
  (function (Is2) {
    ...
    function numberRange(value, min, max) {
      return toString.call(value) === "[object Number]" && min <= value &&
        value <= max;
    }
    ...
    function uinteger2(value) {
      return toString.call(value) === "[object Number]" && 0 <= value &&
        value <= 2147483647;
    }
  ...
  var FullTextDocument2 = function () {
    ...
    FullTextDocument3.prototype.update = function (changes, version) {
      for (var _i = 0, changes_1 = changes; _i < changes_1.length; _i++) {
        ...
        if (FullTextDocument3.isIncremental(change)) {
          ...
          var addedLineOffsets = computeLineOffsets(
            change.text,
            false,
            startOffset,
          );
    ...
    FullTextDocument3.isIncremental = function (event) {
      var candidate = event;
      return candidate !== void 0 && candidate !== null &&
        typeof candidate.text === "string" && candidate.range !== void 0 &&
  ...
  var SchemaCollector = function () {
    ...
    SchemaCollector2.prototype.include = function (node) {
      return (this.focusOffset === -1 || contains2(node, this.focusOffset)) &&
        node !== this.exclude;
    };
  ...
  var ValidationResult = function () {
    ...
    ValidationResult2.prototype.mergeEnumValues = function (validationResult) {
      if (
        !this.enumValueMatch && !validationResult.enumValueMatch &&
        this.enumValues && validationResult.enumValues
      ) {
        ...
        for (var _i = 0, _a2 = this.problems; _i < _a2.length; _i++) {
          ...
          if (error.code === ErrorCode.EnumValueMismatch) {
            error.message = localize2(
              ...
              this.enumValues.map(function (v) {
      ...
      if (this.root && schema2) {
        ...
        return validationResult.problems.map(function (p) {
          ...
          return Diagnostic.create(
            range,
            p.message,
            (_a2 = p.severity) !== null && _a2 !== void 0 ? _a2 : severity,
            p.code,
          );
        });
      }
  ...
  function validate(n, schema2, validationResult, matchingSchemas) {
      ...
      var testAlternatives = function (alternatives, maxOneMatch) {
        ...
        for (
          ...
          if (!bestMatch) {
            ...
            if (
              !maxOneMatch && !subValidationResult2.hasProblems() &&
    ...
    function _validateNumberNode(
      ...
      function normalizeFloats(float) {
        ...
        return parts && {
          ...
          multiplier: (((_a2 = parts[2]) === null || _a2 === void 0
            ? void 0
            : _a2.length) || 0) - (parseInt(parts[3]) || 0),
        };
      }
    ...
    function _validateStringNode(
      ...
      if (
        isNumber(schema22.minLength) && node2.value.length < schema22.minLength
      ) {
        validationResult2.problems.push({
          location: { offset: node2.offset, length: node2.length },
          message: localize2(
      ...
      if (
        isNumber(schema22.maxLength) && node2.value.length > schema22.maxLength
      ) {
        validationResult2.problems.push({
          location: { offset: node2.offset, length: node2.length },
          message: localize2(
      ...
      if (isString(schema22.pattern)) {
        ...
        if (
          ...
          validationResult2.problems.push({
            location: { offset: node2.offset, length: node2.length },
            message: schema22.patternErrorMessage || schema22.errorMessage ||
              localize2(
                "patternWarning",
          ...
          case "uri-reference":
            {
              ...
              if (errorMessage) {
                validationResult2.problems.push({
                  location: { offset: node2.offset, length: node2.length },
                  message: schema22.patternErrorMessage ||
                    schema22.errorMessage ||
                    localize2(
                      "uriFormatWarning",
          ...
          case "email":
            ...
            if (!node2.value || !format4.pattern.exec(node2.value)) {
              validationResult2.problems.push({
                location: { offset: node2.offset, length: node2.length },
                message: schema22.patternErrorMessage ||
                  schema22.errorMessage || format4.errorMessage,
              });
            }
          default:
        }
    ...
    function _validateArrayNode(
      ...
      if (
        isNumber(schema22.minItems) && node2.items.length < schema22.minItems
      ) {
        validationResult2.problems.push({
          location: { offset: node2.offset, length: node2.length },
          message: localize2(
      ...
      if (
        isNumber(schema22.maxItems) && node2.items.length > schema22.maxItems
      ) {
        validationResult2.problems.push({
          location: { offset: node2.offset, length: node2.length },
          message: localize2(
    ...
    function _validateObjectNode(
      ...
      if (Array.isArray(schema22.required)) {
        for (var _b = 0, _c = schema22.required; _b < _c.length; _b++) {
          ...
          if (!seenKeys[propertyName]) {
            var keyNode = node2.parent && node2.parent.type === "property" &&
      ...
      if (schema22.properties) {
        for (
          var _d = 0, _e = Object.keys(schema22.properties);
          _d < _e.length;
          _d++
        ) {
      ...
      if (schema22.patternProperties) {
        for (
          var _f = 0, _g = Object.keys(schema22.patternProperties);
          _f < _g.length;
          _f++
        ) {
          ...
          for (
            ...
            if (
              ...
              if (child) {
                var propertySchema =
                  schema22.patternProperties[propertyPattern];
                if (isBoolean(propertySchema)) {
                  if (!propertySchema) {
                    var propertyNode = child.parent;
                    validationResult2.problems.push({
      ...
      if (schema22.dependencies) {
        for (
          var _m = 0, _o = Object.keys(schema22.dependencies);
          _m < _o.length;
          _m++
        ) {
          var key = _o[_m];
  ...
  function parse3(textDocument, config) {
        ...
        switch (token_1) {
          ...
          case 13:
            if (Array.isArray(commentRanges)) {
              commentRanges.push(
                Range2.create(
                  textDocument.positionAt(scanner2.getTokenOffset()),
                  textDocument.positionAt(
                    scanner2.getTokenOffset() + scanner2.getTokenLength(),
                  ),
                ),
              );
            }
    ...
    function _finalize(node, scanNext) {
      node.length = scanner2.getTokenOffset() + scanner2.getTokenLength() -
        node.offset;
      if (scanNext) {
        _scanNext();
      }
    ...
    function _parseProperty(parent, keysSeen) {
      ...
      if (scanner2.getToken() === 6) {
        ...
        if (
          scanner2.getToken() === 10 &&
          textDocument.positionAt(key.offset + key.length).line <
            textDocument.positionAt(scanner2.getTokenOffset()).line
        ) {
    ...
    function _parseLiteral(parent) {
      ...
      switch (scanner2.getToken()) {
        case 7:
          return _finalize(
            new NullASTNodeImpl(parent, scanner2.getTokenOffset()),
            true,
          );
        case 8:
          return _finalize(
            new BooleanASTNodeImpl(parent, true, scanner2.getTokenOffset()),
            true,
          );
        case 9:
          return _finalize(
            new BooleanASTNodeImpl(parent, false, scanner2.getTokenOffset()),
            true,
          );
        default:
          return void 0;
    ...
    function _parseValue(parent) {
      return _parseArray(parent) || _parseObject(parent) ||
        _parseString(parent) || _parseNumber(parent) || _parseLiteral(parent);
    }
    var _root = void 0;
    var token = _scanNext();
    if (token !== 17) {
    ...
    if (obj !== null && typeof obj === "object") {
      ...
      if (Array.isArray(obj)) {
        ...
        for (var i = 0; i < keys.length; i++) {
          var key = keys[i];
          result += newIndent + JSON.stringify(key) + ": " +
  ...
  var JSONCompletion = function () {
          ...
          if (!existing) {
            ...
            if (supportsCommitCharacters) {
              suggestion.commitCharacters =
                suggestion.kind === CompletionItemKind2.Property
        ...
        function (schema2) {
          ...
          if (node) {
            if (node.type === "string") {
              ...
              if (
                parent && parent.type === "property" && parent.keyNode === node
              ) {
          ...
          return _this.promiseConstructor.all(collectionPromises).then(
            function () {
          ...
          if (
            ...
            var propertyNameCompletionItem = function (name, enumDescription2) {
              ...
              var proposal = {
                ...
                documentation: enumDescription2 ||
      ...
      if (node.parent) {
        if (node.parent.type === "property") {
          ...
          doc.visit(function (n) {
            if (
              n.type === "property" && n !== node.parent &&
              n.keyNode.value === parentKey_1 && n.valueNode &&
    ...
    JSONCompletion2.prototype.getSchemaLessValueCompletions = function (
      ...
      if (node.type === "property") {
        if (offset > (node.colonOffset || 0)) {
          ...
          doc.visit(function (n) {
            if (
              n.type === "property" && n.keyNode.value === parentKey_2 &&
              n.valueNode
            ) {
      ...
      if (node.type === "array") {
        if (node.parent && node.parent.type === "property") {
          ...
          doc.visit(function (n) {
            if (
              n.type === "property" && n.keyNode.value === parentKey_3 &&
              n.valueNode && n.valueNode.type === "array"
            ) {
          ...
          if (s.node === node && !s.inverted && s.schema) {
            ...
            if (parentKey !== void 0) {
              ...
              if (s.schema.patternProperties && !propertyMatched) {
                for (
                  var _a2 = 0, _b = Object.keys(s.schema.patternProperties);
                  _a2 < _b.length;
                  _a2++
                ) {
                  var pattern = _b[_a2];
    ...
    JSONCompletion2.prototype.getContributedValueCompletions = function (
      ...
      if (!node) {
        ...
        if (
          node && node.type === "property" && offset > (node.colonOffset || 0)
        ) {
    ...
    JSONCompletion2.prototype.addDefaultValueCompletions = function (
      ...
      if (Array.isArray(schema2.defaultSnippets)) {
        schema2.defaultSnippets.forEach(function (s) {
          ...
          collector.add({
            kind: _this.getSuggestionKind(type2),
            label,
            documentation: _this.fromMarkup(s.markdownDescription) ||
              s.description,
            insertText,
            insertTextFormat: InsertTextFormat.Snippet,
            filterText,
      ...
      if (
        !hasProposals && typeof schema2.items === "object" &&
        !Array.isArray(schema2.items) && arrayDepth < 5
      ) {
    ...
    JSONCompletion2.prototype.addEnumValueCompletions = function (
      ...
      if (isDefined(schema2.const)) {
        collector.add({
          ...
          insertTextFormat: InsertTextFormat.Snippet,
          documentation: this.fromMarkup(schema2.markdownDescription) ||
            schema2.description,
        });
      }
      if (Array.isArray(schema2.enum)) {
        for (var i = 0, length = schema2.enum.length; i < length; i++) {
          ...
          var documentation = this.fromMarkup(schema2.markdownDescription) ||
            schema2.description;
          if (
            schema2.markdownEnumDescriptions &&
            i < schema2.markdownEnumDescriptions.length &&
            this.doesSupportMarkdown()
          ) {
            documentation = this.fromMarkup(
              schema2.markdownEnumDescriptions[i],
            );
          } else if (
            schema2.enumDescriptions && i < schema2.enumDescriptions.length
          ) {
    ...
    JSONCompletion2.prototype.addDollarSchemaCompletions = function (
      ...
      var _this = this;
      var schemaIds = this.schemaService.getRegisteredSchemaIds(
        function (schema2) {
    ...
    JSONCompletion2.prototype.findItemAtOffset = function (
      ...
      for (var i = children.length - 1; i >= 0; i--) {
        ...
        if (offset > child.offset + child.length) {
          ...
          if (
            token === 5 &&
            offset >= scanner2.getTokenOffset() + scanner2.getTokenLength()
          ) {
            return i + 1;
          }
          return i;
    ...
    JSONCompletion2.prototype.isInComment = function (document, start, offset) {
      ...
      while (
        token !== 17 &&
        scanner2.getTokenOffset() + scanner2.getTokenLength() < offset
      ) {
        token = scanner2.scan();
      }
      return (token === 12 || token === 13) &&
        scanner2.getTokenOffset() <= offset;
    };
    ...
    JSONCompletion2.prototype.doesSupportMarkdown = function () {
      if (!isDefined(this.supportsMarkdown)) {
        var completion = this.clientCapabilities.textDocument &&
          this.clientCapabilities.textDocument.completion;
        this.supportsMarkdown = completion && completion.completionItem &&
    ...
    JSONCompletion2.prototype.doesSupportsCommitCharacters = function () {
      if (!isDefined(this.supportsCommitCharacters)) {
        var completion = this.clientCapabilities.textDocument &&
          this.clientCapabilities.textDocument.completion;
        this.supportsCommitCharacters = completion &&
    ...
    JSONHover2.prototype.doHover = function (document, position, doc) {
      ...
      if (
        ...
        (node.type === "object" || node.type === "array") &&
          offset > node.offset + 1 && offset < node.offset + node.length - 1
      ) {
          ...
          if (schema2 && node) {
            ...
            matchingSchemas.every(function (s) {
              if (s.node === node && !s.inverted && s.schema) {
                ...
                markdownDescription_1 = markdownDescription_1 ||
            ...
            if (markdownEnumValueDescription_1) {
              ...
              result += "`" + toMarkdownCodeBlock(enumValue_1) + "`: " +
                markdownEnumValueDescription_1;
            }
            ...
            for (
              ...
              if (r3 === 47) {
                if (i === h - 1 || a2 === 1);
                  ...
                  if (
                    n2.length < 2 || o !== 2 ||
                    n2.charCodeAt(n2.length - 1) !== 46 ||
                    n2.charCodeAt(n2.length - 2) !== 46
                  ) {
                    if (n2.length > 2) {
          ...
          var n = {
            resolve: function () {
              for (
                ...
                i >= 0
                  ? a2 = arguments[i]
                  : (t3 === void 0 && (t3 = process.cwd()), a2 = t3),
                  e2(a2),
                  a2.length !== 0 &&
                  (n2 = a2 + "/" + n2, o = a2.charCodeAt(0) === 47);
              }
              return n2 = r2(n2, !o),
                o ? n2.length > 0 ? "/" + n2 : "/" : n2.length > 0 ? n2 : ".";
            },
            normalize: function (t3) {
              if (e2(t3), t3.length === 0) {
                return ".";
              }
              var n2 = t3.charCodeAt(0) === 47,
                o = t3.charCodeAt(t3.length - 1) === 47;
              return (t3 = r2(t3, !n2)).length !== 0 || n2 || (t3 = "."),
                t3.length > 0 && o && (t3 += "/"),
                n2 ? "/" + t3 : t3;
            },
            ...
            relative: function (t3, r3) {
              ...
              for (
                ...
                h < r3.length && r3.charCodeAt(h) === 47;
                ++h
              );
              for (
                var s = r3.length - h, f2 = a2 < s ? a2 : s, u = -1, c = 0;
                c <= f2;
                ++c
              ) {
                if (c === f2) {
              ...
              var p = "";
              for (c = o + u + 1; c <= i; ++c) {
                c !== i && t3.charCodeAt(c) !== 47 ||
                  (p.length === 0 ? p += ".." : p += "/..");
              }
              return p.length > 0
                ? p + r3.slice(h + u)
                : (h += u, r3.charCodeAt(h) === 47 && ++h, r3.slice(h));
            },
            ...
            basename: function (t3, r3) {
              ...
              if (r3 !== void 0 && r3.length > 0 && r3.length <= t3.length) {
                ...
                return o === i ? i = s : i === -1 && (i = t3.length),
                  t3.slice(o, i);
              }
              for (n2 = t3.length - 1; n2 >= 0; --n2) {
            ...
            parse: function (t3) {
              ...
              i ? (r3.root = "/", n2 = 1) : n2 = 0;
              for (
                var a2 = -1, h = 0, s = -1, f2 = true, u = t3.length - 1, c = 0;
                u >= n2;
                --u
              ) {
        ...
        447: (t2, e2, r2) => {
          ...
          var i,
            ...
            h = (i = function (t3, e3) {
              return (i = Object.setPrototypeOf ||
                { __proto__: [] } instanceof Array && function (t4, e4) {
                    t4.__proto__ = e4;
                  } ||
                function (t4, e4) {
                  for (var r3 in e4) {
            ...
            g = function () {
              function t3(t4, e3, r3, n2, o2, i2) {
                i2 === void 0 && (i2 = false),
                  typeof t4 == "object"
                    ? (this.scheme = t4.scheme || c,
                      this.authority = t4.authority || c,
                      this.path = t4.path || c,
                      this.query = t4.query || c,
                      this.fragment = t4.fragment || c)
                        ...
                        if (!t5.scheme && e4) {
                          throw new Error(
                            '[UriError]: Scheme is missing: {scheme: "", authority: "' +
                              t5.authority + '", path: "' + t5.path +
                              '", query: "' + t5.query + '", fragment: "' +
                              t5.fragment + '"}',
                          );
                        }
              ...
              return t3.isUri = function (e3) {
                return e3 instanceof t3 ||
                  !!e3 && typeof e3.authority == "string" &&
                    typeof e3.fragment == "string" &&
                    typeof e3.path == "string" && typeof e3.query == "string" &&
                    typeof e3.scheme == "string" &&
                    typeof e3.fsPath == "function" &&
                    typeof e3.with == "function" &&
                    typeof e3.toString == "function";
              },
                ...
                t3.prototype.with = function (t4) {
                  ...
                  return e3 === void 0
                    ? e3 = this.scheme
                    : e3 === null && (e3 = c),
                    r3 === void 0 ? r3 = this.authority
                    : r3 === null && (r3 = c),
                    n2 === void 0 ? n2 = this.path : n2 === null && (n2 = c),
                    o2 === void 0 ? o2 = this.query : o2 === null && (o2 = c),
                    i2 === void 0 ? i2 = this.fragment
                    : i2 === null && (i2 = c),
                    e3 === this.scheme && r3 === this.authority &&
                      n2 === this.path && o2 === this.query &&
                      i2 === this.fragment
                      ? this
                      : new v(e3, r3, n2, o2, i2);
                },
                ...
                t3.file = function (t4) {
                  var e3 = c;
                  if (
                    n && (t4 = t4.replace(/\\/g, l)), t4[0] === l && t4[1] === l
                  ) {
                    var r3 = t4.indexOf(l, 2);
                    r3 === -1 ? (e3 = t4.substring(2), t4 = l)
                    : (e3 = t4.substring(2, r3), t4 = t4.substring(r3) || l);
                  }
                ...
                t3.revive = function (e3) {
                  if (e3) {
                    ...
                    var r3 = new v(e3);
                    return r3._formatted = e3.external,
                      r3._fsPath = e3._sep === d ? e3.fsPath : null,
                      r3;
                  }
                  return e3;
                },
            ...
            v = function (t3) {
              ...
              return h(e3, t3),
                Object.defineProperty(e3.prototype, "fsPath", {
                  get: function () {
                    return this._fsPath || (this._fsPath = C(this, false)),
                      this._fsPath;
                  },
                  enumerable: false,
                  configurable: true,
                ...
                e3.prototype.toString = function (t4) {
                  return t4 === void 0 && (t4 = false),
                    t4
                      ? A2(this, true)
                      : (this._formatted || (this._formatted = A2(this, false)),
                        this._formatted);
                },
                e3.prototype.toJSON = function () {
                  var t4 = { $mid: 1 };
                  return this._fsPath &&
                    (t4.fsPath = this._fsPath, t4._sep = d),
          ...
          function y(t3, e3) {
            for (var r3 = void 0, n2 = -1, o2 = 0; o2 < t3.length; o2++) {
              ...
              if (
                i2 >= 97 && i2 <= 122 || i2 >= 65 && i2 <= 90 ||
                i2 >= 48 && i2 <= 57 || i2 === 45 || i2 === 46 || i2 === 95 ||
                i2 === 126 || e3 && i2 === 47
              ) {
                n2 !== -1 &&
                (r3 += encodeURIComponent(t3.substring(n2, o2)), n2 = -1),
                  r3 !== void 0 && (r3 += t3.charAt(o2));
              } else {
            ...
            return n2 !== -1 && (r3 += encodeURIComponent(t3.substring(n2))),
              r3 !== void 0 ? r3 : t3;
          }
          function b(t3) {
            for (var e3 = void 0, r3 = 0; r3 < t3.length; r3++) {
              ...
              n2 === 35 || n2 === 63
                ? (e3 === void 0 && (e3 = t3.substr(0, r3)), e3 += m[n2])
                : e3 !== void 0 && (e3 += t3[r3]);
            }
          ...
          function C(t3, e3) {
            var r3;
            return r3 =
              t3.authority && t3.path.length > 1 && t3.scheme === "file"
                ? "//" + t3.authority + t3.path
                : t3.path.charCodeAt(0) === 47 &&
                    (t3.path.charCodeAt(1) >= 65 &&
                        t3.path.charCodeAt(1) <= 90 ||
                      t3.path.charCodeAt(1) >= 97 &&
                        t3.path.charCodeAt(1) <= 122) &&
                    t3.path.charCodeAt(2) === 58
                ? e3
                  ? t3.path.substr(1)
            ...
            if (
              ...
              if (f3 !== -1) {
                ...
                i2 = i2.substr(f3 + 1),
                  (f3 = u2.indexOf(":")) === -1
                    ? n2 += r3(u2, false)
                    : (n2 += r3(u2.substr(0, f3), false),
                      n2 += ":",
                      n2 += r3(u2.substr(f3 + 1), false)),
                  n2 += "@";
              }
              (f3 = (i2 = i2.toLowerCase()).indexOf(":")) === -1
                ? n2 += r3(i2, false)
                : (n2 += r3(i2.substr(0, f3), false), n2 += i2.substr(f3));
            }
            if (a3) {
              if (
                a3.length >= 3 && a3.charCodeAt(0) === 47 &&
                a3.charCodeAt(2) === 58
              ) {
                (c2 = a3.charCodeAt(1)) >= 65 && c2 <= 90 &&
                  (a3 = "/" + String.fromCharCode(c2 + 32) + ":" +
                    a3.substr(3));
              } else if (a3.length >= 2 && a3.charCodeAt(1) === 58) {
                var c2;
                (c2 = a3.charCodeAt(0)) >= 65 && c2 <= 90 &&
                  (a3 = String.fromCharCode(c2 + 32) + ":" + a3.substr(2));
              }
              n2 += r3(a3, true);
            }
            return h2 && (n2 += "?", n2 += r3(h2, false)),
              s2 && (n2 += "#", n2 += e3 ? s2 : y(s2, false)),
              n2;
          }
          function w(t3) {
            try {
          ...
          var O,
            ...
            j = function () {
              ...
              for (e3 = 0; e3 < r3; e3++) {
                for (
                  var i2 = arguments[e3], a3 = 0, h2 = i2.length;
                  a3 < h2;
                  a3++, o2++
                ) {
                  n2[o2] = i2[a3];
          ...
          !function (t3) {
            t3.joinPath = function (t4) {
              ...
              t3.dirname = function (t4) {
                ...
                return e3.length === 1 && e3.charCodeAt(0) === 46 ? t4
                : t4.with({ path: e3 });
              },
        ...
        case "*":
          ...
          if (!globstar) {
            ...
            var isGlobstar = starCount > 1 &&
              (prevChar === "/" || prevChar === void 0 || prevChar === "{" ||
                prevChar === ",") &&
              (nextChar === "/" || nextChar === void 0 || nextChar === "," ||
                nextChar === "}");
            if (isGlobstar) {
              if (nextChar === "/") {
                i++;
  ...
  var ResolvedSchema = function () {
    ...
    ResolvedSchema2.prototype.getSectionRecursive = function (path, schema2) {
      ...
      if (schema2.properties && typeof schema2.properties[next]) {
        ...
        for (
          var _i = 0, _a2 = Object.keys(schema2.patternProperties);
          _i < _a2.length;
          _i++
        ) {
          var pattern = _a2[_i];
          ...
          if (regex === null || regex === void 0 ? void 0 : regex.test(next)) {
            return this.getSectionRecursive(
              path,
              schema2.patternProperties[pattern],
            );
          }
        }
  ...
  var JSONSchemaService = function () {
    ...
    JSONSchemaService2.prototype.clearExternalSchemas = function () {
      ...
      for (
        var _i = 0, _a2 = this.contributionAssociations;
        _i < _a2.length;
        _i++
      ) {
    ...
    JSONSchemaService2.prototype.resolveSchemaContent = function (
      ...
      var resolveRefs = function (
        ...
        var collectEntries = function () {
          ...
          for (
            var _a2 = 0, entries_1 = entries;
            _a2 < entries_1.length;
            _a2++
          ) {
      ...
      return resolveRefs(schema2, schema2, schemaURL, dependencies).then(
        function (_) {
    ...
    JSONSchemaService2.prototype.getSchemaForResource = function (
      ...
      if (document && document.root && document.root.type === "object") {
        var schemaProperties = document.root.properties.filter(function (p) {
          return p.keyNode.value === "$schema" && p.valueNode &&
      ...
      for (
        var _i = 0, _a2 = this.filePatternAssociations;
        _i < _a2.length;
        _i++
      ) {
        var entry = _a2[_i];
      ...
      var resolvedSchema = schemas.length > 0
    ...
    JSONSchemaService2.prototype.createCombinedSchema = function (
      ...
      if (schemaIds.length === 1) {
        ...
        var combinedSchemaId = "schemaservice://combinedSchema/" +
    ...
    JSONSchemaService2.prototype.getMatchingSchemas = function (
      ...
      if (schema2) {
        ...
        return this.resolveSchemaContent(new UnresolvedSchema(schema2), id, {})
          .then(function (resolvedSchema) {
            return jsonDocument.getMatchingSchemas(resolvedSchema.schema)
              .filter(function (s) {
                return !s.inverted;
              });
          });
      ...
      return this.getSchemaForResource(document.uri, jsonDocument).then(
        function (schema22) {
          if (schema22) {
            return jsonDocument.getMatchingSchemas(schema22.schema).filter(
              function (s) {
                return !s.inverted;
              },
            );
  ...
  function normalizeResourceForMatching(resource) {
    try {
      return URI2.parse(resource).with({ fragment: null, query: null })
        .toString();
    } catch (e) {
      return resource;
    }
  ...
  var JSONValidation = function () {
    ...
    JSONValidation2.prototype.doValidation = function (
      ...
      var addProblem = function (problem) {
        var signature = problem.range.start.line + " " +
          problem.range.start.character + " " + problem.message;
        if (!added[signature]) {
      ...
      var getDiagnostics = function (schema22) {
        ...
        if (schema22) {
          if (schema22.errors.length && jsonDocument.root && schemaRequest) {
            ...
            var property2 = astRoot.type === "object"
        ...
        for (
          var _i = 0, _a2 = jsonDocument.syntaxErrors;
          _i < _a2.length;
          _i++
        ) {
          var p = _a2[_i];
      ...
      return this.jsonSchemaService.getSchemaForResource(
        textDocument.uri,
        jsonDocument,
      ).then(function (schema22) {
  ...
  var JSONDocumentSymbols = function () {
            ...
            if (valueNode) {
              if (limit > 0) {
                ...
                var location2 = Location.create(
                  document.uri,
                  getRange(document, property22),
                );
                var childContainerName = containerName
                  ? containerName + "." + property22.keyNode.value
                  : property22.keyNode.value;
                result.push({
    ...
    JSONDocumentSymbols2.prototype.getDetail = function (node) {
      ...
      if (
        node.type === "boolean" || node.type === "number" ||
        node.type === "null" || node.type === "string"
      ) {
    ...
    JSONDocumentSymbols2.prototype.findDocumentColors = function (
      ...
      return this.schemaService.getSchemaForResource(document.uri, doc).then(
        function (schema2) {
          var result = [];
          if (schema2) {
            var limit = context && typeof context.resultLimit === "number"
              ? context.resultLimit
              : Number.MAX_VALUE;
    ...
    JSONDocumentSymbols2.prototype.getColorPresentations = function (
      ...
      var label;
      if (color.alpha === 1) {
        label = "#" + toTwoDigitHex(red256) + toTwoDigitHex(green256) +
          toTwoDigitHex(blue256);
      } else {
        label = "#" + toTwoDigitHex(red256) + toTwoDigitHex(green256) +
          toTwoDigitHex(blue256) + toTwoDigitHex(Math.round(color.alpha * 255));
      }
      result.push({
        label,
  ...
  var descriptions = {
    ...
    additionalProperties: localize6(
    ...
    while (token !== 17) {
      switch (token) {
        ...
        case 13: {
          ...
          if (
            scanner2.getTokenError() === 1 && startLine + 1 < document.lineCount
          ) {
            scanner2.setPosition(
              document.offsetAt(Position2.create(startLine + 1, 0)),
            );
          } else {
        ...
        case 12: {
          var text = document.getText().substr(
            scanner2.getTokenOffset(),
            scanner2.getTokenLength(),
          );
  ...
  function findLinks(document, doc) {
    ...
    doc.visit(function (node) {
      ...
      if (
        ...
        ((_a2 = node.valueNode) === null || _a2 === void 0
            ? void 0
            : _a2.type) === "string"
      ) {
        ...
        if (targetNode) {
          ...
          links.push({
            target: document.uri + "#" + (targetPos.line + 1) + "," +
  ...
  function normalizePath(parts) {
    ...
    for (const part of parts) {
      if (
        part.length === 0 || part.length === 1 && part.charCodeAt(0) === Dot
      ) {
      } else if (
        part.length === 2 && part.charCodeAt(0) === Dot &&
