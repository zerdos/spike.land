...
var e4 = window.React,
  ...
  { Component: i1 } = e4,
  { Suspense: y2 } = e4,
  { isValidElement: C2 } = e4,
  { memo: w2 } = e4,
  { useImperativeHandle: E1 } = e4,
  { Children: b1 } = e4,
  { lazy: g2 } = e4,
  { isLazy: S } = e4,
  { useMemo: V1 } = e4,
    ...
    if (r15 = b3.hasOwnProperty(a7) ? b3[a7] : null, null !== r15) {
      ...
      switch (r15.type) {
        ...
        case 4:
          !0 === o5
            ? e30.push(A1, a7, q1)
            : !1 !== o5 && e30.push(A1, a7, V2, p2(y3(o5)), H);
          break;
        case 5:
...
function Ma(e36, r20, a10, o7, i6) {
  switch (r20) {
    ...
    case "option":
      ...
      if (null !== u4) {
        if (a10 = null !== h11 ? "" + h11 : Fa(s11), F(u4)) {
          ...
          switch (g12) {
            ...
            default:
              ha(g12) && "function" !== typeof s11 && "symbol" !== typeof s11 &&
                e36.push(A1, p2(g12), V2, p2(y3(s11)), H);
          }
        }
      }
      e36.push(W);
    ...
    if (c4.call(r5, a32)) {
      ...
      if (null != o31 && "boolean" !== typeof o31 && "" !== o31) {
        if (0 === a32.indexOf("--")) {
          ...
          var i22 = R3.get(l);
          void 0 !== i22 ||
          (i22 = w4(l.replace(k4, "-$1").toLowerCase().replace(E3, "-ms-")),
            R3.set(l, i22)), l = i22;
...
function wa1(e32, n19, r9, a6, o5) {
  switch (n19) {
    ...
    case "option":
      ...
      if (null !== i4) {
        if (r9 = null !== s12 ? "" + s12 : sa(u12), F1(i4)) {
