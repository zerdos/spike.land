...
import { css as css3 } from "https://spike.land/dist/emotion.mjs";
...
import * as React30 from "https://spike.land/dist/react.mjs";
...
import React31 from "https://spike.land/dist/react.mjs";
...
function getOptionsFromChildren(children2) {
  ...
  React31.Children.forEach(children2, (node2) => {
...
import * as React35 from "https://spike.land/dist/react.mjs";
...
import React37 from "https://spike.land/dist/react.mjs";
...
var useTabs = (props) => {
  ...
  const onSelected = React44.useCallback((e3, newValue) => {
    setValue(newValue);
    if (onChange) {
...
var useInsertionEffect2 = React52["useInsertionEffect"] ? React52["useInsertionEffect"] : function useInsertionEffect3(create) {
  create();
};
...
var _excluded23 = ["values", "unit", "step"];
...
var ThemeContext3 = React55.createContext(null);
if (false) {
...
function createBox(options = {}) {
  ...
  const Box3 = React58.forwardRef(function Box4(inProps, ref) {
...
var _excluded27 = ["name", "slot", "skipVariantsResolver", "skipSx", "overridesResolver"];
var _excluded28 = ["theme"];
...
import * as React62 from "https://spike.land/dist/react.mjs";
...
function useCurrentColorScheme(options) {
  ...
  const handleMediaQuery = React61.useCallback((e3) => {
...
function createCssVarsProvider(options) {
  ...
  function CssVarsProvider({
    ...
    } = baseTheme, restBaseTheme = _objectWithoutPropertiesLoose(baseTheme, _excluded29);
    const {
...
import React68 from "https://spike.land/dist/react.mjs";
var _leaveRenders;
var _enterRenders;
...
var _excluded40 = ["colorSchemes", "opacity"];
...
function createTheme3(options = {}, ...args) {
  ...
  } = options, input = _objectWithoutPropertiesLoose(options, _excluded40);
...
// ../../node_modules/@mui/material/Slider/Slider.js
var _excluded41 = ["component", "components", "componentsProps", "color", "size"];
...
false ? Slider.propTypes = {
  ...
  componentsProps: import_prop_types47.default.shape({
    ...
    mark: import_prop_types47.default.object,
    markLabel: import_prop_types47.default.object,
    rail: import_prop_types47.default.object,
    root: import_prop_types47.default.object,
    thumb: import_prop_types47.default.object,
    track: import_prop_types47.default.object,
    valueLabel: import_prop_types47.default.shape({
...
// ../../node_modules/@mui/material/ToggleButton/ToggleButton.js
var _excluded43 = ["children", "className", "color", "disabled", "disableFocusRipple", "fullWidth", "onChange", "onClick", "selected", "size", "value"];
...
import * as React80 from "https://spike.land/dist/react.mjs";
...
var ToggleButtonGroup = React80.forwardRef(function ToggleButtonGroup2(inProps, ref) {
  ...
  return e2(ToggleButtonGroupRoot, _extends({
    ...
    children: React80.Children.map(children2, (child) => {
...
var DraggableWindow = ({
  ...
  useEffect29(() => {
    const reveal = async () => {
      ...
      setFullScreen(false);
      requestAnimationFrame(() => document.getElementById("root").style.display = "none");
    };
    reveal();
  }, []);
  if (isFullScreen) {
  ...
  const internal = React.createElement("div", {
    ...
    css: css3`
            ...
            align-items: center;
          `
  }, React.createElement(ToggleButtonGroup3, {
    value: scaleRange,
    size: "small",
    exclusive: true,
  ...
  }, sizes.map((size) => React.createElement(ToggleButton3, {
    key: size,
    value: size
    ...
    css: css3`
                       ...
                       `
  }, size, "%")))), React.createElement(motion2.div, {
    initial: {
    ...
    css: css3`
            ...
            `
  }, errorText && errorText.trim() !== "" && React.createElement("pre", {
    css: css3`
                    position: absolute;
                    z-index:3;
                ...
                `
  }, isStable && errorText && errorText.trim(), isStable && errorText && errorText.trim() !== "" && React.createElement("div", {
    css: css3`
                          text-align: right;
                        `
  }, React.createElement(Button3, {
    onClick: () => {
      onRestore();
      setErrorText("");
    }
  }, React.createElement("span", null, "Restore")))), React.createElement(motion2.div, {
    initial: {
    ...
    css: css3`
                        height: 100%;
                      `
  }, child), " ")), React.createElement(ToggleButtonGroup3, {
    value: width2,
    size: "small",
    exclusive: true,
  ...
  }, breakPoints.map((size) => React.createElement(ToggleButton3, {
    key: `size-${size}`,
    value: size
  }, size === 680 ? React.createElement(Phone, {
    css: css3`
                        color: ${width2 === 680 ? "rgba(255,255,255,.8)" : "rgba(0,0,0,.3)"};
                        `
  }) : size === 768 ? React.createElement(Tablet, {
    css: css3`
  ...
  }, React.createElement(Share, null)), React.createElement(Box_default2, {
    css: css3`
          max-height: 400px;
          min-height: 200px;
          margin-top: 20px;
        `
  }, React.createElement(Slider_default, {
    sx: {
      '& input[type="range"]': {
  ...
  return React.createElement(motion2.div, {
    ref,
