...
var initSession = async (room, initData) => {
  initSess = initSess || (await import("./session-FKJQ3Y5Q.mjs")).default;
...
async function startMonacoWithSession(session) {
  ...
  const { startMonaco } = await import("./editor-KTF2C4QH.mjs");
...
async function runner(c, changes = null, session, counter) {
  ...
  formatter = formatter || (await import("./formatter-ABQYXEOA.mjs")).formatter;
  esbuildEsmTransform = esbuildEsmTransform || (await import("./esbuildEsm-4Z246LVR.mjs")).transform;
  ...
  try {
    ...
    if (transpiled.length > 0) {
      ...
      try {
        getHtmlAndCss = getHtmlAndCss || (await import("./renderToString-OKS5B3OH.mjs")).getHtmlAndCss;
        if (counter < session.i) {
          return;
        }
...
async function quickStart(session, room, keepFullScreen, saveCode) {
  ...
  const { renderPreviewWindow } = await import("./renderPreviewWindow-LNOXRCAQ.mjs");
