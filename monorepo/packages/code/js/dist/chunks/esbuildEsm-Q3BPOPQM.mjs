...
// js/esbuildEsm.ts
var esbuild = __toESM(require_browser());
import { Mutex } from "https://ga.jspm.io/npm:async-mutex@0.3.2/index.mjs";

// js/vendor/esbuild.wasm
var esbuild_default = "../esbuild-HS6XJJ73.wasm";

// js/esbuildEsm.ts
function createWasmBlob(wasm) {
  const blob = new Blob([wasm], { type: "application/wasm" });
  return URL.createObjectURL(blob);
}
var init = esbuild.initialize({
  wasmURL: createWasmBlob(esbuild_default)
});
...
//# sourceMappingURL=esbuildEsm-Q3BPOPQM.mjs.map
