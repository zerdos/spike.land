...
async function runner(c, changes = null, session, counter) {
  ...
  esbuildEsmTransform = esbuildEsmTransform || (await import("./esbuildEsm-AMYOI2SL.mjs")).transform;
...
async function quickStart(session, room, keepFullScreen, saveCode) {
  ...
  const { renderPreviewWindow } = await import("./renderPreviewWindow-6TR3EB3L.mjs");
