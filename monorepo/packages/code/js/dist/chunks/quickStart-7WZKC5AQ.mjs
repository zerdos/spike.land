...
var initSession = (await import("./session-3BNGXK5M.mjs")).default;
async function startMonacoWithSession(session) {
  ...
  const { startMonaco } = await import("./editor-3FQPOSCB.mjs");
  ...
  try {
    ...
    if (transpiled.length > 0) {
      ...
      try {
        ...
        const { saveCode } = await import("./ws-3RUARO33.mjs");
...
async function quickStart(session, room, keepFullScreen) {
  const { renderPreviewWindow } = await import("./renderPreviewWindow-NMLI2O5G.mjs");
