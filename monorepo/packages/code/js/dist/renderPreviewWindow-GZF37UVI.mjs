...
function detectOverflow(v19, g24) {
  g24 === void 0 && (g24 = {});
  var b23 = g24, y21 = b23.placement, O6 = y21 === void 0 ? v19.placement : y21, x14 = b23.boundary, _10 = x14 === void 0 ? i6 : x14, w13 = b23.rootBoundary, h26 = w13 === void 0 ? f5 : w13, P4 = b23.elementContext, S8 = P4 === void 0 ? p6 : P4, B9 = b23.altBoundary, C8 = B9 !== void 0 && B9, D8 = b23.padding, E13 = D8 === void 0 ? 0 : D8;
...
function arrow(t128) {
  ...
  if (v110 && j11) {
    ...
    var M5 = w15;
    n114.modifiersData[m92] = (i117 = {}, i117[M5] = L5, i117.centerOffset = L5 - H4, i117);
  }
}
...
function flip(r126) {
  var d115 = r126.state, c29 = r126.options, f92 = r126.name;
  if (!d115.modifiersData[f92]._skip) {
    var v24 = c29.mainAxis, j13 = v24 === void 0 || v24, g28 = c29.altAxis, P4 = g28 === void 0 || g28, b25 = c29.fallbackPlacements, y24 = c29.padding, _13 = c29.boundary, k11 = c29.rootBoundary, w17 = c29.altBoundary, x17 = c29.flipVariations, h28 = x17 === void 0 || x17, B11 = c29.allowedAutoPlacements;
    ...
    if (d115.placement !== W7) {
      d115.modifiersData[f92]._skip = true;
      d115.placement = W7;
      d115.reset = true;
    }
  }
...
function preventOverflow(j12) {
  ...
  var y25 = x18.mainAxis, A9 = y25 === void 0 || y25, h29 = x18.altAxis, O10 = h29 !== void 0 && h29, D12 = x18.boundary, _14 = x18.rootBoundary, b26 = x18.altBoundary, B12 = x18.padding, P4 = x18.tether, S12 = P4 === void 0 || P4, R14 = x18.tetherOffset, N16 = R14 === void 0 ? 0 : R14;
  ...
  return y3(Ce1, _extends({
    ...
    children: [
      ...
      se2.map((t26, l61) => {
        ...
        const s52 = k2[Le].offset(o62);
        const i214 = q11 === "off" ? Forward : Pe;
        return p4(d, {
          children: p4(i214, _extends({
            valueLabelFormat: B13,
            valueLabelDisplay: q11,
            value: typeof B13 === "function" ? B13(P4(t26), l61) : B13,
            index: l61,
            ...
            children: p4(De, _extends({
              ...
              children: p4(Be, _extends({
                ...
                "aria-valuemax": P4(E20),
                "aria-valuemin": P4(O13),
                "aria-valuenow": P4(t26),
                "aria-valuetext": I9 ? I9(P4(t26), l61) : b113,
                onFocus: handleFocus,
                onBlur: handleBlur,
                name: R17,
                type: "range",
...
var b8 = l1((t413, n214) => {
  ...
  const P4 = (l212 = b114 != null ? b114 : C20.Root) != null ? l212 : "div";
...
var f8 = l1(function TabPanelUnstyled(t317, n215) {
  ...
  const v31 = appendOwnerState(U13, _extends({}, f121, p118.root), P4);
...
var _3 = function createStyled1(t231, d123) {
  ...
  return function() {
    ...
    var O12 = i(function(t321, a217, n125) {
      ...
      var S17 = {};
      for (var O17 in t321) {
        N24 && O17 === "as" || P42(O17) && (S17[O17] = t321[O17]);
      }
      S17.className = u213;
      S17.ref = n125;
      var k16 = f(d210, S17);
...
function handleBreakpoints(e237, n220, r144) {
  ...
  if (Array.isArray(n220)) {
    ...
    return n220.reduce((t235, o10, s52) => {
      t235[e5.up(e5.keys[s52])] = r144(n220[s52]);
      return t235;
    }, {});
  }
...
var splitProps = (o23) => {
  ...
  Object.keys(o23).forEach((s52) => {
    No[s52] ? r18.systemProps[s52] = o23[s52] : r18.otherProps[s52] = o23[s52];
  });
  return r18;
};
...
var d15 = function(n135) {
  ...
  function CSSTransition() {
    var e334;
    for (var s52 = arguments.length, r154 = new Array(s52), t242 = 0; t242 < s52; t242++) {
...
var Q2 = o4((p0, F2) => {
  ...
  var Pe = u19(), Ve = I2(), _7 = V5(), l = K2(), Ge = D5(), c = Pe.extend(function(t) {
    ...
    var x, s52, a18, n8 = this._polynomial, f92 = this._stringBuffer;
    for (s52 = 0; s52 < r; s52++)
      f92[i13 + s52] = 0;
    for (s52 = 0; s52 < e5; s52++) {
      if (x = l.LOG[f92[t + s52] ^ f92[i13]], x !== 255)
        for (a18 = 1; a18 < r; a18++)
          f92[i13 + a18 - 1] = f92[i13 + a18] ^ l.EXPONENT[c._modN(x + n8[r - a18])];
      else
        for (a18 = i13; a18 < i13 + r; a18++)
          f92[a18] = f92[a18 + 1];
      f92[i13 + r - 1] = x === 255 ? 0 : l.EXPONENT[c._modN(x + n8[0])];
    }
    ...
    var t, e5, i13, r, x, s52 = 0, a18 = this._badness, n8 = this.buffer, f92 = this.width;
    for (x = 0; x < f92 - 1; x++)
      for (r = 0; r < f92 - 1; r++)
        (n8[r + f92 * x] && n8[r + 1 + f92 * x] && n8[r + f92 * (x + 1)] && n8[r + 1 + f92 * (x + 1)] || !(n8[r + f92 * x] || n8[r + 1 + f92 * x] || n8[r + f92 * (x + 1)] || n8[r + 1 + f92 * (x + 1)])) && (s52 += c.N2);
    var h = 0;
    for (x = 0; x < f92; x++) {
      for (i13 = 0, a18[0] = 0, t = 0, r = 0; r < f92; r++)
        e5 = n8[r + f92 * x], t === e5 ? a18[i13]++ : a18[++i13] = 1, t = e5, h += t ? 1 : -1;
      s52 += this._getBadness(i13);
    }
    h < 0 && (h = -h);
    var O3 = 0, b18 = h;
    for (b18 += b18 << 2, b18 <<= 1; b18 > f92 * f92; )
      b18 -= f92 * f92, O3++;
    for (s52 += O3 * c.N4, r = 0; r < f92; r++) {
      for (i13 = 0, a18[0] = 0, t = 0, x = 0; x < f92; x++)
        e5 = n8[r + f92 * x], t === e5 ? a18[i13]++ : a18[++i13] = 1, t = e5;
      s52 += this._getBadness(i13);
    }
    return s52;
    ...
    var t, e5, i13 = this._dataBlock, r = this._ecc, x = this._eccBlock, s52 = 0, a18 = this._calculateMaxLength(), n8 = this._neccBlock1, f92 = this._neccBlock2, h = this._stringBuffer;
    for (t = 0; t < i13; t++) {
      for (e5 = 0; e5 < n8; e5++)
        r[s52++] = h[t + e5 * i13];
      for (e5 = 0; e5 < f92; e5++)
    ...
    var t, e5, i13, r = 1, x = 1, s52 = this.width, a18 = s52 - 1, n8 = s52 - 1, f92 = (this._dataBlock + this._eccBlock) * (this._neccBlock1 + this._neccBlock2) + this._neccBlock2;
    for (e5 = 0; e5 < f92; e5++)
...
var $4 = o4((B0, Z2) => {
  "use strict";
  var He = u19(), k7 = q4(), v72 = He.extend(function(t) {
    ...
    for (e5 in i13)
      k7.hasOwn(i13, e5) && (r[e5] = v72._get(i13[e5], t));
    return r;
  }, init: function(t, e5, i13) {
    typeof i13 != "function" && (i13 = k7.noop);
    var r, x;
    for (r in this.options)
      k7.hasOwn(this.options, r) && (x = this.options[r], v72._set(x, x.defaultValue, e5), v72._createAccessor(x, e5, i13));
