(() => {
    ...
    return new CancelableAsyncIterableObject(source, (emitter) => __awaiter(this, void 0, void 0, function* () {
      ...
      try {
        try {
          ...
          try {
            if (innerIterable_1_1 && !innerIterable_1_1.done && (_a4 = innerIterable_1.return))
              yield _a4.call(innerIterable_1);
          } finally {
            if (e_5)
              throw e_5.error;
          }
  ...
  function hasDriveLetter(path, continueAsWindows) {
    const isWindowsPath = continueAsWindows !== void 0 ? continueAsWindows : isWindows;
    if (isWindowsPath) {
  ...
  function score(selector, candidateUri, candidateLanguage, candidateIsSynchronized) {
    if (Array.isArray(selector)) {
      ...
      const { language: language2, pattern, scheme, hasAccessToAllModels } = selector;
