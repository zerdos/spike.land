...
var editor_default = async ({ onChange, code, language, container, options }) => {
  ...
  setTimeout(() => loadExtraLibs((content, filePath) => monaco2.languages.typescript.typescriptDefaults.addExtraLib(content, filePath), (opts) => monaco2.languages.typescript.typescriptDefaults.setDiagnosticsOptions(opts)), 100);
  return () => editor;
};
