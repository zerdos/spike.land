(() => {
    ...
    if (from2 && typeof from2 === "object" || typeof from2 === "function") {
      for (let key of __getOwnPropNames(from2)) {
        if (!__hasOwnProp.call(to, key) && key !== except) {
          __defProp(to, key, {
            get: () => from2[key],
            enumerable: !(desc = __getOwnPropDesc(from2, key)) ||
              desc.enumerable,
          });
        }
      }
  ...
  var require_service = __commonJS({
    "../../node_modules/protobufjs/src/rpc/service.js"(exports2, module2) {
      ...
      var util = require_minimal();
      (Service2.prototype = Object.create(util.EventEmitter.prototype))
      ...
      Service2.prototype.rpcCall = function rpcCall(
        method,
        requestCtor,
        responseCtor,
        request,
  ...
  // ../../node_modules/ipfs-message-port-protocol/esm/src/error.js
  ...
  // ../../node_modules/ipfs-message-port-client/esm/src/client/error.js
  ...
  // ../../node_modules/ipfs-message-port-client/esm/src/client/transport.js
  ...
  // ../../node_modules/ipfs-message-port-client/esm/src/client/query.js
  var Query = class {
  ...
  // ../../node_modules/ipfs-message-port-client/esm/src/client/service.js
  var Service = class {
      ...
      for (const method of methods) {
        api[method] = (input) =>
          this.transport.execute(
            new Query(namespace, method.toString(), input),
          );
      }
    }
  };

  // ../../node_modules/ipfs-message-port-client/esm/src/client.js
  var Client = class {
    constructor(namespace, methods, transport) {
  ...
  var from = ({ name, prefix, encode: encode3, decode: decode5 }) =>
    new Codec(name, prefix, encode3, decode5);
...
`;
  ...
  // ../../node_modules/ipfs-message-port-protocol/esm/src/cid.js
  ...
  // ../../node_modules/ipfs-message-port-protocol/esm/src/block.js
  ...
  // ../../node_modules/ipfs-message-port-client/esm/src/block.js
  ...
  BlockClient.prototype.rm = async function* rm(cids, options = {}) {
    ...
    const entries = await this.remote.rm({
      ...
      cids: Array.isArray(cids)
        ? cids.map((cid) => encodeCID2(cid, transfer))
        : [encodeCID2(cids, transfer)],
    });
  ...
  // ../../node_modules/ipfs-message-port-protocol/esm/src/dag.js
  ...
  // ../../node_modules/ipfs-message-port-client/esm/src/dag.js
  ...
  // ../../node_modules/ipfs-message-port-protocol/esm/src/core.js
  var decodeIterable = async function* ({ port }, decode5) {
    let receive = (_data) => {
    };
    const wait = () => new Promise((resolve2) => receive = resolve2);
    const next = () => {
  ...
  var postMessage = (port, message, transfer) =>
    port.postMessage(message, transfer);

  // ../../node_modules/ipfs-message-port-client/esm/src/core.js
  var import_browser_readablestream_to_it = __toESM(
    ...
    Data2.fromObject = function fromObject(d) {
      ...
      if (d.fanout != null) {
        if ($util.Long) {
          ...
          m.fanout = new $util.LongBits(d.fanout.low >>> 0, d.fanout.high >>> 0)
            .toNumber(true);
        }
      }
      if (d.mode != null) {
  ...
  var encodeAddInput = async (input, transfer) => {
    if (input instanceof Blob) {
      ...
      if (readableStream) {
        return encodeIterable(
          await ensureIsByteStream(
            (0, import_browser_readablestream_to_it.default)(readableStream),
          ),
          encodeAsyncIterableContent,
          transfer,
        );
  ...
  var ensureIsByteStream = async (input) => {
    ...
    peekable.push(value);
    if (
      Number.isInteger(value) || isBytes(value) || typeof value === "string" ||
  ...
  // ../../node_modules/ipfs-message-port-client/esm/src/files.js
  ...
  // ../../node_modules/ipfs-message-port-client/esm/src/index.js
...
`],
  ...
  var renderDirectoryEntry = (base2, entry) =>
    `<li>
  ...
  var portRequests = /* @__PURE__ */ Object.create(null);
  var onmessage = ({ data }) => {
    if (data) {
