...
var ImportResolver = /** @class */ (function () {
  function ImportResolver(options) {
    ...
    if (options.preloadPackages && options.versions) {
      try {
        for (
          var _b = __values(Object.entries(options.versions)), _c = _b.next();
          !_c.done;
          _c = _b.next()
        ) {
          ...
          this.resolveImport({
            ...
            importPath: "",
          }, new RecursionDepth_1.RecursionDepth(this.options)).catch(
            function (e) {
              console.error(e);
            },
          );
  ...
  ImportResolver.prototype.resolveImportsInFile = function (
    source,
    parent,
    depth,
  ) {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            return [
              4, /*yield*/
              this.resolveImportFromPackageRoot(importResource),
            ];
          case 2:
          ...
          case 6:
            return [
              4, /*yield*/
              this.resolveImportInPackage(importResource, depth.nextFile()),
            ];
          case 7:
            return [2, /*return*/ _b.sent()];
          case 8:
  ...
  ImportResolver.prototype.resolveImportInPackage = function (
    importResource,
    depth,
  ) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            return [4, /*yield*/ this.loadSourceFileContents(importResource)];
          case 1:
            ...
            this.createModel(
              ...
              Uri.parse(
                this.options.fileRootPath +
                  path.join(
                    "node_modules/".concat(importResource.packageName),
                    at,
                  ),
              ),
            );
            return [
              4, /*yield*/
              this.resolveImportsInFile(source, {
  ...
  ImportResolver.prototype.resolveImportFromPackageRoot = function (
    importResource,
  ) {
    var _a, _b, _c, _d, _e, _f, _g, _h, _j;
    return __awaiter(this, void 0, void 0, function () {
      var failedProgressUpdate,
        doesPkgJsonHasSubpath,
        pkgJsonSubpath,
        pkgJson,
        pkg,
        typings,
        ...
        switch (_k.label) {
          case 0:
            ...
            if (this.options.onlySpecifiedPackages) {
              if (
                !((_a = this.versions) === null || _a === void 0
                  ? void 0
                  : _a[importResource.packageName]) &&
                !((_b = this.versions) === null || _b === void 0
                  ? void 0
                  : _b["@types/" + importResource.packageName])
              ) {
            ...
            doesPkgJsonHasSubpath =
              (_d = (_c = importResource.importPath) === null || _c === void 0
                    ? void 0
                    : _c.length) !== null && _d !== void 0
                ? _d
                : 0 > 0;
            pkgJsonSubpath = doesPkgJsonHasSubpath
              ? "/".concat(importResource.importPath)
              : "";
            return [
              4, /*yield*/
              this.resolvePackageJson(
                importResource.packageName,
                (_e = this.versions) === null || _e === void 0
                  ? void 0
                  : _e[importResource.packageName],
          ...
          case 1:
            ...
            return [
              ...
              this.resolvePackageJson(
                importResource.packageName,
                (_f = this.versions) === null || _f === void 0
                  ? void 0
                  : _f[importResource.packageName],
              ),
            ];
          case 2:
            pkgJson = _k.sent();
          ...
          case 3:
            ...
            this.createModel(
              ...
              //@ts-expect-error
              Uri.parse(
                "".concat(this.options.fileRootPath, "node_modules/").concat(
                  importResource.packageName,
                ).concat(pkgJsonSubpath, "/package.json"),
              ),
            );
            (0, invokeUpdate_1.invokeUpdate)({
              type: "LookedUpPackage",
            ...
            return [2, /*return*/ {
              ...
              importPath: path.join(
                (_g = importResource.importPath) !== null && _g !== void 0
                  ? _g
                  : "",
          ...
          case 4:
            typingPackageName = "@types/".concat(
            ...
            return [
              ...
              this.resolvePackageJson(
                typingPackageName,
                (_h = this.versions) === null || _h === void 0
                  ? void 0
                  : _h[typingPackageName],
              ),
            ];
          case 5:
            ...
            if (pkgJsonTypings) {
              ...
              if (pkg_1.typings || pkg_1.types) {
                ...
                this.createModel(
                  ...
                  // @ts-expect-error
                  Uri.parse(
                    "".concat(this.options.fileRootPath, "node_modules/")
                      .concat(typingPackageName, "/package.json"),
                  ),
                );
                (0, invokeUpdate_1.invokeUpdate)({
                  type: "LookedUpPackage",
                ...
                return [2, /*return*/ {
                  ...
                  sourcePath: "",
                  importPath: path.join(
                    (_j = importResource.importPath) !== null && _j !== void 0
                      ? _j
                      : "",
                    typings.startsWith("./") ? typings.slice(2) : typings,
                  ),
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            if (
              !appends.map(function (append) {
                return importResource.importPath.endsWith(append);
              }).reduce(function (a, b) {
                return a || b;
              }, false)
            ) {
          ...
          case 3:
            ...
            return [
              4, /*yield*/
              this.resolveSourceFile(pkgName, version, fullPath),
            ];
          case 4:
            source = _b.sent();
            (0, invokeUpdate_1.invokeUpdate)({
          ...
          case 12:
            ...
            throw Error(
              "Could not resolve ".concat(importResource.packageName, "/")
                .concat(importResource.sourcePath).concat(
                  importResource.importPath,
                ),
            );
        }
  ...
  ImportResolver.prototype.getVersion = function (packageName) {
    var _a;
    return (_a = this.versions) === null || _a === void 0
      ? void 0
      : _a[packageName];
  };
  ImportResolver.prototype.setVersions = function (versions) {
    ...
    (_b = (_a = this.options).onUpdateVersions) === null || _b === void 0
      ? void 0
      : _b.call(_a, versions);
  ...
  ImportResolver.prototype.setVersion = function (packageName, version) {
    ...
    this.setVersions(
      __assign(
        __assign({}, this.versions),
        (_a = {}, _a[packageName] = version, _a),
      ),
    );
  };
  ...
  ImportResolver.prototype.resolvePackageJson = function (
    packageName,
    version,
    subPath,
  ) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            uri = path.join(
              packageName + (version ? "@".concat(version) : ""),
              subPath !== null && subPath !== void 0 ? subPath : "",
              "package.json",
            );
            isAvailable = false;
            content = undefined;
          ...
          case 1:
            ...
            return [3, /*break*/ 4];
          case 2:
            return [4, /*yield*/ this.cache.getFile(uri)];
          case 3:
            content = _b.sent();
          ...
          case 8:
            return [
              4, /*yield*/
              this.sourceResolver.resolvePackageJson(
                packageName,
                version,
                subPath,
              ),
  ...
  ImportResolver.prototype.resolveSourceFile = function (
    packageName,
    version,
    filePath,
  ) {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 8:
            return [
              4, /*yield*/
              this.sourceResolver.resolveSourceFile(
                packageName,
                version,
                filePath,
              ),
