...
var imports = {
  ...
  "@emotion/react": "https://unpkg.com/@spike.land/esm@0.5.14/dist/emotion-react.mjs",
    ...
    return await handleErrors(request, async () => {
      ...
      switch (path[0]) {
        ...
        case "lazy":
          ...
          return new Response(lazy_default.replace("{...o}", JSON.stringify({ name: codeSpace, transpiled, html: `<div id="root"><style>${css}</style><div id="zbody">${html}</div></div>`, hash: hash2 })), {
            status: 200,
            headers: {
              "Access-Control-Allow-Origin": "*",
              "Cache-Control": "no-cache",
