...
function MeasureLayout(props) {
  ...
  return React__default2.createElement(MeasureLayoutWithContext, __assign({}, props, { layoutGroup, switchLayoutGroup: useContext11(SwitchLayoutGroupContext), isPresent: isPresent2, safeToRemove }));
}
...
function MotionConfig(_a) {
  ...
  config = __assign(__assign({}, useContext14(MotionConfigContext)), config);
...
function ReorderGroup(_a, externalRef) {
  ...
  return createElement10(Component, __assign({}, props, { ref: externalRef }), createElement10(ReorderContext.Provider, { value: context }, children));
}
...
function ReorderItem(_a, externalRef) {
  ...
  return createElement11(Component, __assign({ drag: axis }, props, { dragSnapToOrigin: true, style: __assign(__assign({}, style), { x: point.x, y: point.y, zIndex }), layout: true, onDrag: function(_event, _a2) {
...
function useAnimatedState(initialState) {
  var _a = __read(useState6(initialState), 2), animationState = _a[0], setAnimationState = _a[1];
