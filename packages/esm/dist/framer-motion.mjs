...
import { __spreadArray as __spreadArray2, __read as __read6, __assign as __assign6 } from "tslib";
...
import { __assign as __assign5, __rest as __rest3, __spreadArray, __read as __read3 } from "tslib";
...
function hydrateKeyframes(options) {
  if (Array.isArray(options.to) && options.to[0] === null) {
    options.to = __spreadArray([], __read3(options.to), false);
...
function createProjectionNode(_a) {
  ...
  return function() {
    function ProjectionNode(id3, latestValues, parent) {
      ...
      this.path = parent ? __spreadArray2(__spreadArray2([], __read6(parent.path), false), [parent], false) : [];
      this.parent = parent;
    ...
    ProjectionNode.prototype.notifyListeners = function(name) {
      ...
      subscriptionManager === null || subscriptionManager === void 0 ? void 0 : subscriptionManager.notify.apply(subscriptionManager, __spreadArray2([], __read6(args), false));
    };
      ...
      if (this.options.animate !== false && visualElement2 && (layoutId || layout)) {
        this.addEventListener("didUpdate", function(_a3) {
          ...
          if (((_d = _this.resumeFrom) === null || _d === void 0 ? void 0 : _d.instance) || hasOnlyRelativeTargetChanged || hasLayoutChanged && (targetChanged || !_this.currentAnimation)) {
            ...
            _this.startAnimation(__assign6(__assign6({}, getValueTransition(layoutTransition, "layout")), { onComplete: onLayoutAnimationComplete }));
          } else {
...
function useProjection(projectionId, _a, visualElement2, ProjectionNodeConstructor) {
  ...
  var initialPromotionConfig = useContext5(SwitchLayoutGroupContext);
...
function createMotionComponent(_a) {
  ...
  function MotionComponent(props, externalRef) {
    ...
    var config = useContext6(MotionConfigContext);
    var features = null;
...
function useLayoutId(_a) {
  ...
  var layoutGroupId = (_b = useContext6(LayoutGroupContext)) === null || _b === void 0 ? void 0 : _b.id;
...
import { useEffect as useEffect7, useContext as useContext9 } from "react";

// ../../node_modules/framer-motion/dist/es/components/AnimatePresence/use-presence.mjs
import { useContext as useContext8, useEffect as useEffect6 } from "react";
function usePresence() {
  var context = useContext8(PresenceContext);
  if (context === null)
    return [true, null];
...
function useIsPresent() {
  return isPresent(useContext8(PresenceContext));
}
...
import { __spreadArray as __spreadArray5, __read as __read10, __assign as __assign16, __rest as __rest9 } from "tslib";
...
import { __read as __read9, __rest as __rest8, __assign as __assign15 } from "tslib";

// ../../node_modules/framer-motion/dist/es/render/utils/setters.mjs
import { __rest as __rest7, __assign as __assign14, __spreadArray as __spreadArray4, __read as __read8 } from "tslib";
...
import { __spreadArray as __spreadArray3, __read as __read7 } from "tslib";
...
// ../../node_modules/framer-motion/dist/es/render/dom/value-types/find.mjs
var valueTypes = __spreadArray3(__spreadArray3([], __read7(dimensionValueTypes), false), [color, complex], false);
...
function setVariants(visualElement2, variantLabels) {
  var reversedLabels = __spreadArray4([], __read8(variantLabels), false).reverse();
...
function animateVariant(visualElement2, variant, options) {
  ...
  if (when) {
    var _c = __read9(when === "beforeChildren" ? [getAnimation2, getChildAnimations] : [getChildAnimations, getAnimation2], 2), first = _c[0], last = _c[1];
...
function animateTarget(visualElement2, definition, _a) {
  ...
  for (var key in target) {
    ...
    var animation = startAnimation(key, value, valueTarget, __assign15({ delay }, transition));
...
var reversePriorityOrder = __spreadArray5([], __read10(variantPriorityOrder), false).reverse();
  ...
  function animateChanges(options, changedActiveType) {
    ...
    var _loop_1 = function(i2) {
      ...
      if (shouldAnimateType && !isInherited) {
        animations2.push.apply(animations2, __spreadArray5([], __read10(definitionList.map(function(animation) {
          return {
            animation,
...
var animations = {
  ...
  exit: makeRenderlessComponent(function(props) {
    ...
    var _a = __read11(usePresence(), 2), isPresent2 = _a[0], safeToRemove = _a[1];
    var presenceContext = useContext9(PresenceContext);
    useEffect7(function() {
      var _a2, _b;
...
function calcViewportAxisConstraints(layoutAxis, constraintsAxis) {
  ...
  if (constraintsAxis.max - constraintsAxis.min < layoutAxis.max - layoutAxis.min) {
    _a = __read12([max, min], 2), min = _a[0], max = _a[1];
  }
  return { min, max };
}
...
import { useRef as useRef5, useContext as useContext10, useEffect as useEffect9 } from "react";
...
import { __assign as __assign19, __spreadArray as __spreadArray7, __read as __read14 } from "tslib";

// ../../node_modules/framer-motion/dist/es/render/utils/lifecycles.mjs
import { __spreadArray as __spreadArray6, __read as __read13 } from "tslib";
var names = [
  "LayoutMeasure",
  "BeforeLayoutMeasure",
  "LayoutUpdate",
...
function createLifecycles() {
  ...
  managers.forEach(function(manager, i) {
    ...
    lifecycles["notify" + names[i]] = function() {
      ...
      manager.notify.apply(manager, __spreadArray6([], __read13(args), false));
    };
  });
  return lifecycles;
}
...
var variantProps = __spreadArray7(["initial"], __read14(variantPriorityOrder), false);
var numVariantProps = variantProps.length;

// ../../node_modules/framer-motion/dist/es/render/dom/utils/css-variables-conversion.mjs
import { __rest as __rest10, __assign as __assign20, __read as __read15 } from "tslib";
...
import { __assign as __assign21, __read as __read16 } from "tslib";
...
import { __extends as __extends2, __assign as __assign24, __read as __read17 } from "tslib";
import React__default2, { useContext as useContext11 } from "react";
...
function MeasureLayout(props) {
  ...
  var layoutGroup = useContext11(LayoutGroupContext);
  return React__default2.createElement(MeasureLayoutWithContext, __assign24({}, props, { layoutGroup, switchLayoutGroup: useContext11(SwitchLayoutGroupContext), isPresent: isPresent2, safeToRemove }));
}
...
import { __read as __read19, __spreadArray as __spreadArray8 } from "tslib";
import {
  Fragment,
  createElement as createElement5
} from "react";
import { useContext as useContext12, useRef as useRef7, useEffect as useEffect11, cloneElement, Children, isValidElement } from "react";
...
var AnimatePresence = function(_a) {
  ...
  var forceRenderLayoutGroup = useContext12(LayoutGroupContext).forceRender;
  ...
  var childrenToRender = __spreadArray8([], __read19(filteredChildren), false);
...
import { __read as __read20, __assign as __assign26 } from "tslib";
import {
  createElement as createElement6
} from "react";
import { useContext as useContext13, useRef as useRef8, useMemo as useMemo5 } from "react";
...
var LayoutGroup = function(_a) {
  ...
  var memoizedContext = useMemo5(function() {
    return __assign26(__assign26({}, context.current), { forceRender });
  }, [key]);
...
import { __rest as __rest12, __assign as __assign27 } from "tslib";
import {
  createElement as createElement8
} from "react";
import { useContext as useContext14, useMemo as useMemo6 } from "react";
function MotionConfig(_a) {
  var children = _a.children, config = __rest12(_a, ["children"]);
  config = __assign27(__assign27({}, useContext14(MotionConfigContext)), config);
...
import { __read as __read21, __rest as __rest13 } from "tslib";
import {
  createElement as createElement9
} from "react";
import { useState as useState2, useRef as useRef9, useEffect as useEffect12 } from "react";
...
import { __rest as __rest14, __assign as __assign28 } from "tslib";
import {
  createElement as createElement10
} from "react";
import { forwardRef as forwardRef2, useRef as useRef10, useEffect as useEffect13 } from "react";
...
function ReorderGroup(_a, externalRef) {
  var children = _a.children, _b = _a.as, as = _b === void 0 ? "ul" : _b, _c = _a.axis, axis = _c === void 0 ? "y" : _c, onReorder = _a.onReorder, values = _a.values, props = __rest14(_a, ["children", "as", "axis", "onReorder", "values"]);
  ...
  return createElement10(Component, __assign28({}, props, { ref: externalRef }), createElement10(ReorderContext.Provider, { value: context }, children));
}
...
import { __rest as __rest15, __read as __read24, __assign as __assign30 } from "tslib";
import {
  createElement as createElement11
} from "react";
import { forwardRef as forwardRef3, useContext as useContext16, useRef as useRef11, useEffect as useEffect16 } from "react";

// ../../node_modules/framer-motion/dist/es/value/use-motion-value.mjs
import { __read as __read22 } from "tslib";
import { useContext as useContext15, useState as useState3, useEffect as useEffect14 } from "react";
...
function transform() {
  ...
  var interpolator = interpolate(inputRange, outputRange, __assign29({ mixer: getMixer2(outputRange[0]) }, options));
...
function ReorderItem(_a, externalRef) {
  var children = _a.children, style = _a.style, value = _a.value, _b = _a.as, as = _b === void 0 ? "li" : _b, props = __rest15(_a, ["children", "style", "value", "as"]);
  var Component = useConstant(function() {
    return motion(as);
  });
  var context = useContext16(ReorderContext);
  var point = {
  ...
  return createElement11(Component, __assign30({ drag: axis }, props, { dragSnapToOrigin: true, style: __assign30(__assign30({}, style), { x: point.x, y: point.y, zIndex }), layout: true, onDrag: function(_event, _a2) {
...
var domAnimation = __assign31(__assign31({ renderer: createDomVisualElement }, animations), gestureAnimations);

// ../../node_modules/framer-motion/dist/es/render/dom/features-max.mjs
import { __assign as __assign32 } from "tslib";
var domMax = __assign32(__assign32(__assign32(__assign32({}, domAnimation), drag), layoutFeatures), { projectionNodeConstructor: HTMLProjectionNode });
...
import { useContext as useContext17, useRef as useRef12, useMemo as useMemo7 } from "react";
function useSpring(source, config) {
  if (config === void 0) {
    config = {};
  }
  var isStatic = useContext17(MotionConfigContext).isStatic;
  ...
  useMemo7(function() {
    return value.attach(function(v, set) {
      ...
      activeSpringAnimation.current = animate(__assign33(__assign33({ from: value.get(), to: v, velocity: value.getVelocity() }, config), { onUpdate: set }));
      return value.get();
    });
...
import { __spreadArray as __spreadArray9, __read as __read26 } from "tslib";
  ...
  var controls = {
    ...
    mount: function() {
      ...
      pendingAnimations.forEach(function(_a) {
        ...
        controls.start.apply(controls, __spreadArray9([], __read26(animation), false)).then(resolve);
      });
      return function() {
        hasMounted = false;
        controls.stop();
...
import { __rest as __rest16, __assign as __assign34, __read as __read28 } from "tslib";
...
var stateVisualElement = visualElement({
  ...
  makeTargetAnimatable: function(element, _a) {
    var transition = _a.transition, transitionEnd = _a.transitionEnd, target = __rest16(_a, ["transition", "transitionEnd"]);
    var origin = getOrigin(target, transition || {}, element);
    checkTargetForNewValues(element, target, origin);
    return __assign34({ transition, transitionEnd }, target);
  }
});
...
function useAnimatedState(initialState) {
  ...
  useEffect19(function() {
    element.setProps({
      onUpdate: function(v) {
        return setAnimationState(__assign34({}, v));
      }
    });
  });
