    ...
    CID = class {
      ...
      static asCID(value) {
        if (value instanceof CID) {
          ...
          return CID.create(version2, code3, digest);
        } else {
          return null;
        }
      }
      static create(version2, code3, digest) {
        ...
        switch (version2) {
          case 0: {
            if (code3 !== DAG_PB_CODE) {
              ...
              return new CID(version2, code3, digest, digest.bytes);
            }
          }
          case 1: {
...
// src/ipfs-only-hash.mjs
var import_ipfs_only_hash = __toModule(require_ipfs_only_hash());
var ipfs_only_hash_default = import_ipfs_only_hash.default;
export {
  ipfs_only_hash_default as default
};
/*!
