...
function h(l4, u4, i4) {
    var t3, o5, r4, f4 = {};
    for(r4 in u4)"key" == r4 ? t3 = u4[r4] : "ref" == r4 ? o5 = u4[r4] : f4[r4] = u4[r4];
    if (arguments.length > 2 && (f4.children = arguments.length > 3 ? n.call(arguments, 2) : i4), "function" == typeof l4 && null != l4.defaultProps) for(r4 in l4.defaultProps)void 0 === f4[r4] && (f4[r4] = l4.defaultProps[r4]);
...
function _(n3, l4) {
    if (null == l4) return n3.__ ? _(n3.__, n3.__.__k.indexOf(n3) + 1) : null;
...
function g() {
    for(var n3; g.__r = t.length;)n3 = t.sort(function(n4, l4) {
        return n4.__v.__b - l4.__v.__b;
    }), t = [], n3.some(function(n4) {
        var l4, u4, i4, t3, o5, r4;
        n4.__d && (o5 = (t3 = (l4 = n4).__v).__e, (r4 = l4.__P) && (u4 = [], (i4 = s({}, t3)).__v = t3.__v + 1, j(r4, t3, i4, l4.__n, void 0 !== r4.ownerSVGElement, null != t3.__h ? [
            o5
        ] : null, u4, null == o5 ? _(t3) : o5, t3.__h), z(u4, t3), t3.__e != o5 && k(t3)));
    });
}
function w(n3, l4, u4, i4, t3, o5, r4, c4, s4, a4) {
    var h4, y4, d4, k5, b4, g5, w4, x5 = i4 && i4.__k || e, C3 = x5.length;
    for(u4.__k = [], h4 = 0; h4 < l4.length; h4++)if (null != (k5 = u4.__k[h4] = null == (k5 = l4[h4]) || "boolean" == typeof k5 ? null : "string" == typeof k5 || "number" == typeof k5 || "bigint" == typeof k5 ? v(null, k5, null, null, k5) : Array.isArray(k5) ? v(p, {
        children: k5
    }, null, null, null) : k5.__b > 0 ? v(k5.type, k5.props, k5.key, null, k5.__v) : k5)) {
        if (k5.__ = u4, k5.__b = u4.__b + 1, null === (d4 = x5[h4]) || d4 && k5.key == d4.key && k5.type === d4.type) x5[h4] = void 0;
        else for(y4 = 0; y4 < C3; y4++){
    ...
    for(u4.__e = g5, h4 = C3; h4--;)null != x5[h4] && ("function" == typeof u4.type && null != x5[h4].__e && x5[h4].__e == u4.__d && (u4.__d = _(i4, h4 + 1)), N(x5[h4], x5[h4]));
    if (w4) for(h4 = 0; h4 < w4.length; h4++)M(w4[h4], w4[++h4], w4[++h4]);
}
function m(n3, l4, u4) {
    for(var i4, t3 = n3.__k, o5 = 0; t3 && o5 < t3.length; o5++)(i4 = t3[o5]) && (i4.__ = n3, l4 = "function" == typeof i4.type ? m(i4, l4, u4) : A(u4, i4, i4, t3, i4.__e, l4));
    return l4;
}
function x(n3, l4) {
...
function A(n3, l4, u4, i4, t3, o5) {
    var r4, f4, e4;
    if (void 0 !== l4.__d) r4 = l4.__d, l4.__d = void 0;
    else if (null == u4 || t3 != o5 || null == t3.parentNode) n: if (null == o5 || o5.parentNode !== n3) n3.appendChild(t3), r4 = null;
    else {
        for(f4 = o5, e4 = 0; (f4 = f4.nextSibling) && e4 < i4.length; e4 += 2)if (f4 == t3) break n;
...
function C(n3, l4, u4, i4, t3) {
    var o5;
    for(o5 in u4)"children" === o5 || "key" === o5 || o5 in l4 || H(n3, o5, null, u4[o5], i4);
    for(o5 in l4)t3 && "function" != typeof l4[o5] || "children" === o5 || "key" === o5 || "value" === o5 || "checked" === o5 || u4[o5] === l4[o5] || H(n3, o5, l4[o5], u4[o5], i4);
}
function $(n3, l4, u4) {
...
function H(n3, l4, u4, i4, t3) {
    ...
    n: if ("style" === l4) if ("string" == typeof u4) n3.style.cssText = u4;
        ...
        if ("string" == typeof i4 && (n3.style.cssText = i4 = ""), i4) for(l4 in i4)u4 && l4 in u4 || $(n3.style, l4, "");
        if (u4) for(l4 in u4)i4 && u4[l4] === i4[l4] || $(n3.style, l4, u4[l4]);
    }
    else if ("o" === l4[0] && "n" === l4[1]) o5 = l4 !== (l4 = l4.replace(/Capture$/, "")), l4 = l4.toLowerCase() in n3 ? l4.toLowerCase().slice(2) : l4.slice(2), n3.l || (n3.l = {}), n3.l[l4 + o5] = u4, u4 ? i4 || n3.addEventListener(l4, o5 ? T : I, o5) : n3.removeEventListener(l4, o5 ? T : I, o5);
    else if ("dangerouslySetInnerHTML" !== l4) {
        if (t3) l4 = l4.replace(/xlink(H|:h)/, "h").replace(/sName$/, "s");
...
function j(n3, u4, i4, t3, o5, r4, f4, e4, c4) {
    ...
    null != i4.__h && (c4 = i4.__h, e4 = u4.__e = i4.__e, u4.__h = null, r4 = [
        e4
    ]), (a4 = l.__b) && a4(u4);
    try {
        n: if ("function" == typeof H3) {
            if (g5 = u4.props, m4 = (a4 = H3.contextType) && t3[a4.__c], x5 = a4 ? m4 ? m4.props.value : a4.__ : t3, i4.__c ? b4 = (h4 = u4.__c = i4.__c).__ = h4.__E : ("prototype" in H3 && H3.prototype.render ? u4.__c = h4 = new H3(g5, x5) : (u4.__c = h4 = new d(g5, x5), h4.constructor = H3, h4.render = O), m4 && m4.sub(h4), h4.props = g5, h4.state || (h4.state = {}), h4.context = x5, h4.__n = t3, v4 = h4.__d = true, h4.__h = []), null == h4.__s && (h4.__s = h4.state), null != H3.getDerivedStateFromProps && (h4.__s == h4.state && (h4.__s = s({}, h4.__s)), s(h4.__s, H3.getDerivedStateFromProps(g5, h4.__s))), y4 = h4.props, _4 = h4.state, v4) null == H3.getDerivedStateFromProps && null != h4.componentWillMount && h4.componentWillMount(), null != h4.componentDidMount && h4.__h.push(h4.componentDidMount);
            else {
            ...
            if (h4.context = x5, h4.props = g5, h4.__v = u4, h4.__P = n3, A4 = l.__r, C3 = 0, "prototype" in H3 && H3.prototype.render) h4.state = h4.__s, h4.__d = false, A4 && A4(u4), a4 = h4.render(h4.props, h4.state, h4.context);
            else do {
                h4.__d = false, A4 && A4(u4), a4 = h4.render(h4.props, h4.state, h4.context), h4.state = h4.__s;
            }while (h4.__d && ++C3 < 25)
            h4.state = h4.__s, null != h4.getChildContext && (t3 = s(s({}, t3), h4.getChildContext())), v4 || null == h4.getSnapshotBeforeUpdate || (k5 = h4.getSnapshotBeforeUpdate(y4, _4)), $3 = null != a4 && a4.type === p && null == a4.key ? a4.props.children : a4, w(n3, Array.isArray($3) ? $3 : [
                $3
            ], u4, i4, t3, o5, r4, f4, e4, c4), h4.base = u4.__e, u4.__h = null, h4.__h.length && f4.push(h4), b4 && (h4.__E = h4.__ = null), h4.__e = false;
        } else null == r4 && u4.__v === i4.__v ? (u4.__k = i4.__k, u4.__e = i4.__e) : u4.__e = L(i4.__e, u4, i4, t3, o5, r4, f4, c4);
        (a4 = l.diffed) && a4(u4);
    } catch (n4) {
...
function L(l4, u4, i4, t3, o5, r4, e4, c4) {
    ...
    if ("svg" === d4 && (o5 = true), null != r4) {
        for(; k5 < r4.length; k5++)if ((s4 = r4[k5]) && "setAttribute" in s4 == !!d4 && (d4 ? s4.localName === d4 : 3 === s4.nodeType)) {
            l4 = s4, r4[k5] = null;
            break;
        }
    }
    ...
    if (null === d4) y4 === p4 || c4 && l4.data === p4 || (l4.data = p4);
    else {
        if (r4 = r4 && n.call(l4.childNodes), h4 = (y4 = i4.props || f).dangerouslySetInnerHTML, v4 = p4.dangerouslySetInnerHTML, !c4) {
            if (null != r4) for(y4 = {}, k5 = 0; k5 < l4.attributes.length; k5++)y4[l4.attributes[k5].name] = l4.attributes[k5].value;
            (v4 || h4) && (v4 && (h4 && v4.__html == h4.__html || v4.__html === l4.innerHTML) || (l4.innerHTML = v4 && v4.__html || ""));
        }
        if (C(l4, p4, y4, o5, c4), v4) u4.__k = [];
        else if (k5 = u4.props.children, w(l4, Array.isArray(k5) ? k5 : [
            k5
        ], u4, i4, t3, o5 && "foreignObject" !== d4, r4, e4, r4 ? r4[0] : i4.__k && _(i4, 0), c4), null != r4) for(k5 = r4.length; k5--;)null != r4[k5] && a(r4[k5]);
...
function N(n3, u4, i4) {
    ...
    if (t3 = n3.__k) for(o5 = 0; o5 < t3.length; o5++)t3[o5] && N(t3[o5], u4, "function" != typeof n3.type);
...
function P(u4, i4, t3) {
    var o5, r4, e4;
    l.__ && l.__(u4, i4), r4 = (o5 = "function" == typeof t3) ? null : t3 && t3.__k || i4.__k, e4 = [], j(i4, u4 = (!o5 && t3 || i4).__k = h(p, null, [
        u4
    ]), r4 || f, f, void 0 !== i4.ownerSVGElement, !o5 && t3 ? [
        t3
    ] : r4 ? null : i4.firstChild ? n.call(i4.childNodes) : null, e4, !o5 && t3 ? t3 : r4 ? r4.__e : i4.firstChild, o5), z(e4, u4);
}
function S(n3, l4) {
    P(n3, l4, S);
}
    ...
    "../../.yarn/global/cache/preact-npm-10.10.6-e3746adb94-9.zip/node_modules/preact/dist/preact.module.js" () {
        ...
        n = e.slice, l = {
            __e: function(n3, l4, u4, i4) {
                for(var t3, o5, r4; l4 = l4.__;)if ((t3 = l4.__c) && !t3.__) try {
                    if ((o5 = t3.constructor) && null != o5.getDerivedStateFromError && (t3.setState(o5.getDerivedStateFromError(n3)), r4 = t3.__d), null != t3.componentDidCatch && (t3.componentDidCatch(n3, i4 || {}), r4 = t3.__d), r4) return t3.__E = t3;
                } catch (l5) {
                    n3 = l5;
                }
                throw n3;
...
function d2(t3, u4) {
    ...
    return t3 >= i4.__.length && i4.__.push({
        __V: f2
    }), i4.__[t3];
}
function p2(n3) {
...
function y2(n3, u4, i4) {
    var o5 = d2(t2++, 2);
    if (o5.t = n3, !o5.__c && (o5.__ = [
        i4 ? i4(u4) : z2(void 0, u4),
        function(n4) {
...
function b2() {
    for(var t3; t3 = c2.shift();)if (t3.__P && t3.__H) try {
...
function S2(n3, t3) {
    for(var e4 in t3)n3[e4] = t3[e4];
    return n3;
}
function g3(n3, t3) {
    for(var e4 in n3)if ("__source" !== e4 && !(e4 in t3)) return true;
    for(var r4 in t3)if ("__source" !== r4 && n3[r4] !== t3[r4]) return true;
    return false;
}
function C2(n3) {
    this.props = n3;
...
function M2(n3) {
    ...
    t3.componentWillUnmount = function() {
    ...
    }, t3.i && t3.i !== e4 && t3.componentWillUnmount(), n3.__v ? (t3.l || (t3.i = e4, t3.l = {
        nodeType: 1,
        parentNode: e4,
        childNodes: [],
        ...
        context: t3.context
    }, n3.__v), t3.l)) : t3.l && t3.componentWillUnmount();
}
function V(n3, t3) {
    var e4 = h(M2, {
        __v: n3,
...
var init_compat_module = __esm({
    "../../.yarn/global/cache/preact-npm-10.10.6-e3746adb94-9.zip/node_modules/preact/compat/dist/compat.module.js" () {
        ...
        l.__e = function(n3, t3, e4, r4) {
            if (n3.then) {
                for(var u4, o5 = t3; o5 = o5.__;)if ((u4 = o5.__c) && u4.__c) return null == t3.__e && (t3.__e = e4.__e, t3.__k = e4.__k), u4.__c(n3, t3);
            }
            A3(n3, t3, e4, r4);
        };
        O2 = l.unmount;
        l.unmount = function(n3) {
            ...
            var l4 = function() {
                if (!--r4.__u) {
                    ...
                    for(r4.setState({
                        __a: r4.__b = null
                    }); t4 = r4.t.pop();)t4.forceUpdate();
                }
            }, c4 = true === t3.__h;
            (r4.__u++) || c4 || r4.setState({
            ...
            return u4 && (u4.__h = null), [
                h(p, null, t3.__a ? null : n3.children),
                u4
            ];
        };
        F2 = function(n3, t3, e4) {
            if (++e4[1] === e4[0] && n3.o.delete(t3), n3.props.revealOrder && ("t" !== n3.props.revealOrder[0] || !n3.o.size)) for(e4 = n3.u; e4;){
        ...
        (D.prototype = new d()).__a = function(n3) {
            ...
            for(var e4 = t3.length; e4--;)this.o.set(t3[e4], this.u = [
                1,
                0,
                this.u
            ]);
        ...
        d.prototype.isReactComponent = {}, [
            ...
            Object.defineProperty(d.prototype, n3, {
                configurable: true,
                get: function() {
...
function x4(r4, n3, i4, a4, l4, c4) {
    ...
    if (Array.isArray(r4)) {
        for(var u4 = [], v4 = 0; v4 < r4.length; v4++)u4.push(x4(r4[v4], n3, i4, a4, l4, c4));
        return u4.join("");
    }
    ...
    if ("function" == typeof h4) {
        if (y4 = true, !i4.shallow || !a4 && false !== i4.renderRootComponent) {
            ...
            } else for(var A4 = b3(h4, n3), H3 = 0; C3.__d && H3++ < 25;)C3.__d = false, O3 && O3(r4), w4 = h4.call(r4.__c, g5, A4);
    ...
    var M3, F3, L3 = "<" + h4;
    if (g5) for(var E2 in g5){
        var T4 = g5[E2];
        if ("children" !== E2) {
            if (!p3.test(E2) && (i4 && i4.allAttributes || "key" !== E2 && "ref" !== E2 && "__self" !== E2 && "__source" !== E2)) {
                if ("defaultValue" === E2) E2 = "value";
                else if ("defaultChecked" === E2) E2 = "checked";
                else if ("defaultSelected" === E2) E2 = "selected";
                else if ("className" === E2) {
                    if (void 0 !== g5.class) continue;
                    E2 = "class";
                } else l4 && d3.test(E2) && (E2 = E2.toLowerCase().replace(/^xlink:?/, "xlink:"));
                if ("htmlFor" === E2) {
                    if (g5.for) continue;
                    E2 = "for";
                }
                ...
                if ($3 || "" === $3) L3 += $3;
                else if ("dangerouslySetInnerHTML" === E2) F3 = T4 && T4.__html;
                else if ("textarea" === h4 && "value" === E2) M3 = T4;
    ...
    if (L3 += ">", p3.test(h4)) throw new Error(h4 + " is not a valid HTML tag name in " + L3);
    var D2, P3 = _3.test(h4) || i4.voidElements && i4.voidElements.test(h4), W2 = "";
    if (F3) L3 += F3;
    else if (null != M3 && f3(D2 = [], M3).length) for(var N3 = 0; N3 < D2.length; N3++){
        var R2 = D2[N3];
        if (null != R2 && false !== R2) {
    ...
    if (W2.length || F3) L3 += W2;
    else if (i4 && i4.xml) return L3.substring(0, L3.length - 1) + " />";
...
function S3(r4, n3, l4, c4, u4, v4) {
    ...
    if (Array.isArray(r4)) {
        for(var y4 = "", x5 = 0; x5 < r4.length; x5++)h4 && x5 > 0 && (y4 += "\n"), y4 += S3(r4[x5], n3, l4, c4, u4, v4);
        return y4;
    }
    ...
    if ("function" == typeof w4) {
        if (O3 = true, !l4.shallow || !c4 && false !== l4.renderRootComponent) {
            ...
            } else for(var L3 = b3(w4, n3), E2 = 0; H3.__d && E2++ < 25;)H3.__d = false, M3 && M3(r4), A4 = w4.call(r4.__c, C3, L3);
        ...
        for(var W2 = 0; W2 < P3.length; W2++){
            ...
            if ("children" !== N3) {
                if (!p3.test(N3) && (l4 && l4.allAttributes || "key" !== N3 && "ref" !== N3 && "__self" !== N3 && "__source" !== N3)) {
                    if ("defaultValue" === N3) N3 = "value";
                    else if ("defaultChecked" === N3) N3 = "checked";
                    else if ("defaultSelected" === N3) N3 = "selected";
                    else if ("className" === N3) {
                        if (void 0 !== C3.class) continue;
                        N3 = "class";
                    } else u4 && d3.test(N3) && (N3 = N3.toLowerCase().replace(/^xlink:?/, "xlink:"));
                    if ("htmlFor" === N3) {
                        if (C3.for) continue;
                        N3 = "for";
                    }
                    ...
                    if (I3 || "" === I3) D2 += I3;
                    else if ("dangerouslySetInnerHTML" === N3) $3 = R2 && R2.__html;
                    else if ("textarea" === w4 && "value" === N3) T4 = R2;
    ...
    if (D2 += ">", p3.test(w4)) throw new Error(w4 + " is not a valid HTML tag name in " + D2);
    ...
    if ($3) h4 && a3($3) && ($3 = "\n" + g5 + i3($3, g5)), D2 += $3;
        ...
        for(var Z2 = h4 && ~D2.indexOf("\n"), B3 = false, G2 = 0; G2 < V2.length; G2++){
            ...
            if (null != J2 && false !== J2) {
                ...
                if (h4 && !Z2 && a3(K2) && (Z2 = true), K2) if (h4) {
                    var Q2 = K2.length > 0 && "<" != K2[0];
                    B3 && Q2 ? z4[z4.length - 1] += K2 : z4.push(K2), B3 = Q2;
                } else z4.push(K2);
            }
        }
        if (h4 && Z2) for(var X2 = z4.length; X2--;)z4[X2] = "\n" + g5 + i3(z4[X2], g5);
    }
    if (z4.length || $3) D2 += z4.join("");
    else if (l4 && l4.xml) return D2.substring(0, D2.length - 1) + " />";
...
function k4(e4) {
    return e4.displayName || e4 !== Function && e4.name || function(e5) {
        ...
        if (!t3) {
            for(var r4 = -1, n3 = u3.length; n3--;)if (u3[n3] === e5) {
                r4 = n3;
                break;
            }
...
function e3(_4, e4, n3, t3, f4) {
    var l4, s4, u4 = {};
    for(s4 in e4)"ref" == s4 ? l4 = e4[s4] : u4[s4] = e4[s4];
    var a4 = {
        type: _4,
        props: u4,
        key: n3,
    ...
    if ("function" == typeof _4 && (l4 = _4.defaultProps)) for(s4 in l4)void 0 === u4[s4] && (u4[s4] = l4[s4]);
...
function hash(str) {
    let i4 = 0, out = 11;
    while(i4 < str.length)out = 101 * out + str.charCodeAt(i4++) >>> 0;
    return out;
}
...
var init_react = __esm({
    "react.ts" () {
        ...
        react_default = React;
        ({ createElement , cloneElement , createFactory , useInsertionEffect , unstable_batchedUpdates , createRef , useCallback , useContext , useDebugValue , isValidElement , useEffect , useImperativeHandle , useLayoutEffect , useMemo , useReducer , useRef , useState , lazy , Suspense , StrictMode , forwardRef , memo , Children , PureComponent , Component , version  } = React);
        flushSync = (callback, arg)=>callback(arg);
    }
});
init_react();
export { Children as Children, Component as Component, p as Fragment, PureComponent as PureComponent, StrictMode as StrictMode, Suspense as Suspense, D as SuspenseList, cloneElement as cloneElement, createContext as createContext, createElement as createElement, createFactory as createFactory, V as createPortal, createRef as createRef, createRoot as createRoot, react_default as default, on as findDOMNode, flushSync as flushSync, forwardRef as forwardRef, hydrate as hydrate, hydrateRoot as hydrateRoot, isValidElement as isValidElement, e3 as jsx, e3 as jsxDEV, e3 as jsxs, lazy as lazy, memo as memo, render as render, y3 as renderToString, unmountComponentAtNode as unmountComponentAtNode, unstable_batchedUpdates as unstable_batchedUpdates, useCallback as useCallback, useContext as useContext, useDebugValue as useDebugValue, useEffect as useEffect, useId as useId, useImperativeHandle as useImperativeHandle, useInsertionEffect as useInsertionEffect, useLayoutEffect as useLayoutEffect, useMemo as useMemo, useReducer as useReducer, useRef as useRef, useState as useState, version as version };
