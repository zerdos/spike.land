  ...
  (function (e) {
    ...
    function i(e, t = self) {
      t.addEventListener(
        ...
        (function n(r) {
          if (!r || !r.data) return;
          const { id: s, type: o, path: u } = Object.assign(
              { path: [] },
              r.data,
            ),
            l = (r.data.argumentList || []).map(g);
          let p;
          try {
            ...
            switch (o) {
              case 0:
                ...
                break;
              case 1:
                t[u.slice(-1)[0]] = g(r.data.value), p = !0;
                break;
              case 2:
                p = n.apply(t, l);
                break;
          ...
          Promise.resolve(p).catch((e) => ({ value: e, [a]: 0 })).then((e) => {
            const [r, a] = y(e);
            t.postMessage(Object.assign(Object.assign({}, r), { id: s }), a),
              5 === o && (t.removeEventListener("message", n), c(t));
          });
        }),
      ), t.start && t.start();
    }
    ...
    function u(e, t) {
      return function e(t, a = [], s = function () {}) {
        let o = !1;
        const i = new Proxy(s, {
          get(n, s) {
            if (l(o), s === r) {
              return () =>
                h(t, { type: 5, path: a.map((e) => e.toString()) }).then(() => {
                  c(t), o = !0;
                });
            }
            if ("then" === s) {
              if (0 === a.length) return { then: () => i };
              const e = h(t, { type: 0, path: a.map((e) => e.toString()) })
                .then(g);
          ...
          apply(r, s, i) {
            ...
            if (c === n) return h(t, { type: 4 }).then(g);
            if ("bind" === c) return e(t, a.slice(0, -1));
            const [u, d] = p(i);
            return h(t, {
              type: 2,
    ...
    e.createEndpoint = n,
      ...
      e.releaseProxy = r,
      e.transfer = f,
      e.transferHandlers = o,
      e.windowEndpoint = function (e, t = self, n = "*") {
        return {
