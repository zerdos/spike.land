...
export var Server: {
    new <T>(services: import("ipfs-message-port-protocol/src/rpc").MultiService<T>): {
        ...
        execute(data: Pick<import("ipfs-message-port-protocol/src/rpc").Values<{ [NS in keyof T]: import("ipfs-message-port-protocol/src/rpc").Values<{ [M in keyof T[NS]]-?: T[NS][M] extends (input: infer I) => infer O ? {
            namespace: NS;
            method: M;
            input: I & import("ipfs-message-port-protocol/src/rpc").QueryOptions;
            result: O extends Promise<infer T_1> ? Promise<T_1 extends Record<string, unknown> ? T_1 & import("ipfs-message-port-protocol/src/rpc").TransferOptions : T_1> : Promise<O extends Record<string, unknown> ? O & import("ipfs-message-port-protocol/src/rpc").TransferOptions : O>;
        } & import("ipfs-message-port-protocol/src/rpc").QueryOptions : never; }>; }>, "input" | "timeout" | "signal" | "method" | "namespace">): import("ipfs-message-port-protocol/src/rpc").Out<T>;
    };
};
