...
export type ProcedureNames<T_1> = {
  [K in keyof T_1]-?:
    import("ipfs-message-port-protocol/src/rpc").NonUndefined<T_1[K]> extends
      Function ? K : never;
}[keyof T_1][];
export type Method<T_1> = import("ipfs-message-port-protocol/src/rpc").Values<
  {
    [NS in keyof T_1]: import("ipfs-message-port-protocol/src/rpc").Values<
      {
        [M in keyof T_1[NS]]-?: T_1[NS][M] extends (input: infer I) => infer O
          ? {
            namespace: NS;
            method: M;
            input:
...
export type RPCQuery<T_1> = {
  input: import("ipfs-message-port-protocol/src/rpc").Values<
    {
      [NS in keyof T_1]: import("ipfs-message-port-protocol/src/rpc").Values<
        {
          [M in keyof T_1[NS]]-?: T_1[NS][M] extends (input: infer I) => infer O
    ...
    | import("ipfs-message-port-protocol/src/rpc").Values<
      {
        [NS in keyof T_1]: import("ipfs-message-port-protocol/src/rpc").Values<
          {
            [M in keyof T_1[NS]]-?: T_1[NS][M] extends
  ...
  signal?:
    ...
    >["signal"]
    | undefined;
  method: import("ipfs-message-port-protocol/src/rpc").Values<
    {
      [NS in keyof T_1]: import("ipfs-message-port-protocol/src/rpc").Values<
        {
          [M in keyof T_1[NS]]-?: T_1[NS][M] extends (input: infer I) => infer O
  ...
  >["method"];
  namespace: import("ipfs-message-port-protocol/src/rpc").Values<
    {
      [NS in keyof T_1]: import("ipfs-message-port-protocol/src/rpc").Values<
        {
          [M in keyof T_1[NS]]-?: T_1[NS][M] extends (input: infer I) => infer O
...
export type Inn<T_1> = import("ipfs-message-port-protocol/src/rpc").Values<
  {
    [NS in keyof T_1]: import("ipfs-message-port-protocol/src/rpc").Values<
      {
        [M in keyof T_1[NS]]-?: T_1[NS][M] extends (input: infer I) => infer O
...
>["input"];
export type Out<T_1> = import("ipfs-message-port-protocol/src/rpc").Values<
  {
    [NS in keyof T_1]: import("ipfs-message-port-protocol/src/rpc").Values<
      {
        [M in keyof T_1[NS]]-?: T_1[NS][M] extends (input: infer I) => infer O
...
export type NamespacedQuery<T_1, K> = {
  [M in keyof T_1]-?: T_1[M] extends (input: infer I) => infer O ? {
    namespace: K;
    method: M;
    input: I & import("ipfs-message-port-protocol/src/rpc").QueryOptions;
    result: O extends Promise<infer T_2> ? Promise<
...
export type MultiService<T_1> = {
  [NS in keyof T_1]: {
    [M in keyof T_1[NS]]:
      import("ipfs-message-port-protocol/src/rpc").NamespacedMethod<
        NS,
        T_1[NS],
        T_1[NS][M]
      >;
