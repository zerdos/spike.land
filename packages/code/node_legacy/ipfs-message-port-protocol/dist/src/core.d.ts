 ...
 */
export function decodeIterable<I, O>(
  { port }: RemoteIterable<I>,
  decode: (arg0: I) => O,
): AsyncIterable<O>;
/**
 * @template I,O
 ...
 */
export function encodeIterable<I, O>(
  iterable: AsyncIterable<I> | Iterable<I>,
  encode: (arg0: I, arg1: Transferable[]) => O,
 ...
 */
export function decodeCallback<T>(
  { port }: RemoteCallback,
): (arg0: T[]) => void | ((arg0: T[], arg1: Transferable[]) => void);
