...
class n extends class {
  ...
  constructor(t, h = {}) {
    super(),
      ...
      this.Nt = new Set(),
      this.Ot = () => {
        const t = this.zt, s = t.installing;
        this.Tt > 0 || !i(s.scriptURL, this.Ft) ||
          performance.now() > this.Kt + 6e4
        ...
        !n && this.Vt && (a.isUpdate = !0),
          ...
          "installed" === h
            ? this.Xt = self.setTimeout(
              (() => {
                "installed" === h && s.waiting === i &&
                  this.dispatchEvent(new e("waiting", a));
              }),
              200,
            )
            : "activating" === h &&
              (clearTimeout(this.Xt), n || this.At.resolve(i));
      },
      this.Yt = (t) => {
        const s = this.Jt;
  ...
  async register({ immediate: t = !1 } = {}) {
    t || "complete" === document.readyState ||
    ...
    return s && i(s.scriptURL, this.Ft) &&
      (this.Jt = s,
      ...
      navigator.serviceWorker.addEventListener("controllerchange", this.Yt, {
        once: !0,
      }),
      this.zt;
  }
