  ...
  (function () {
    return function (e) {
      ...
      e.exports = function (e) {
        ...
        function k(e) {
          ...
          if (" " !== e[n]) {
            ...
            for (
              var r = (e.length - n) * c + 1 >>> 0, l = new Uint8Array(r); e[n];
            ) {
              var k = t[e.charCodeAt(n)];
              if (255 === k) return;
              for (
                var u = 0, d = r - 1; (0 !== k || u < i) && -1 !== d; d--, u++
              ) {
        ...
        return {
          encode: function (t) {
            if (
              t instanceof Uint8Array || (ArrayBuffer.isView(t)
            ...
            for (
              var n = 0, s = 0, i = 0, r = t.length; i !== r && 0 === t[i];
            ) {
              i++, n++;
            }
            for (
      ...
      e.exports = function (e, t = "utf8") {
        return "utf8" === t || "utf-8" === t ? r.decode(e) : "ascii" === t
          ? function (e) {
            let t = "";
      ...
      e.exports = function (e, t = "utf8") {
        return "utf8" === t || "utf-8" === t ? r.encode(e) : "ascii" === t
          ? function (e) {
      ...
      t.decodeIterable = async function* ({ port: e }, t) {
        let n = (e) => {};
        const s =
          () => (e.postMessage({ method: "next" }), new Promise((e) => n = e));
