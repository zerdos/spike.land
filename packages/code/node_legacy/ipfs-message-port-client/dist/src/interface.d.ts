 ...
 * be an error.
 */
export declare type APIWithExtraOptions<
  API extends (...args: any[]) => any,
  Extra,
> = (...args: WithExtendedOptions<Parameters<API>, Extra>) => ReturnType<API>;
declare type End = never[];
declare type WithExtendedOptions<Params, Ext> = Params extends [...End] ? []
...
export declare type APIMethodWithExtraOptions<
  ...
  Extra,
> = API[Key] extends (...args: any[]) => any
  ? APIWithExtraOptions<API[Key], Extra>
  : never;
export {};
