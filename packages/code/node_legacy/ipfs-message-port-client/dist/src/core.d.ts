...
declare class CoreClient extends CoreClient_base {
     ...
     */
    addAll(input: any, options?: {}): AsyncIterable<import("ipfs-core-types/src/files").UnixFSEntry>;
    /**
     * Add file to IPFS.
     *
     * If you pass binary data like `Uint8Array` it is recommended to provide
     ...
     */
    add(input: any, options?: {}): Promise<import("ipfs-core-types/src/files").UnixFSEntry>;
    /**
     ...
     */
    cat(inputPath: string | import("cids"), options?: {
        offset?: number | undefined;
        length?: number | undefined;
        timeout?: number | undefined;
        signal?: AbortSignal | undefined;
    } | undefined): AsyncIterable<Uint8Array>;
    /**
     * Returns content addressed by a valid IPFS Path.
     *
     * @param {string|CID} inputPath
     ...
     */
    ls(inputPath: string | import("cids"), options?: {
        recursive?: boolean | undefined;
        preload?: boolean | undefined;
        timeout?: number | undefined;
        signal?: AbortSignal | undefined;
    } | undefined): AsyncIterable<LsEntry>;
}
declare namespace CoreClient {
    export { RemoteIterable, Time, UnixFSTime, EncodedCID, EncodedAddInput, EncodedAddAllInput, FileInput, EncodedFileContent, NoramilzedFileInput, Bytes, FileContent, FileObject, AddInput, AddAllInput, CoreService, AddedEntry, EncodedLsEntry, LsEntry, MessageTransport };
}
type LsEntry = {
    name: string;
    path: string;
...
type Time = Date | import("ipfs-message-port-protocol/src/data").LooseUnixFSTime | import("ipfs-message-port-protocol/src/data").HRTime;
type UnixFSTime = {
    secs: number;
    nsecs: number;
};
...
type EncodedAddInput = string | ArrayBuffer | Blob | ArrayBufferView | import("ipfs-message-port-server/src/core").FileInput | import("ipfs-message-port-protocol/src/core").RemoteIterable<ArrayBuffer | ArrayBufferView>;
...
type FileInput = {
    ...
    content?: string | ArrayBuffer | Blob | ArrayBufferView | import("ipfs-message-port-protocol/src/core").RemoteIterable<ArrayBufferView> | import("ipfs-message-port-protocol/src/core").RemoteIterable<ArrayBuffer> | undefined;
    mode?: string | number | undefined;
    mtime?: Date | import("ipfs-message-port-protocol/src/data").LooseUnixFSTime | import("ipfs-message-port-protocol/src/data").HRTime | undefined;
};
type EncodedFileContent = string | ArrayBuffer | Blob | ArrayBufferView | import("ipfs-message-port-protocol/src/core").RemoteIterable<ArrayBufferView> | import("ipfs-message-port-protocol/src/core").RemoteIterable<ArrayBuffer>;
type NoramilzedFileInput = {
    path: string;
    content: AsyncIterable<ArrayBuffer>;
};
type Bytes = ArrayBuffer | ArrayBufferView;
type FileContent = string | ArrayBuffer | Blob | ArrayBufferView | Iterable<number> | Iterable<ArrayBuffer | ArrayBufferView> | AsyncIterable<ArrayBuffer | ArrayBufferView>;
type FileObject = {
    path?: string | undefined;
    content?: string | ArrayBuffer | Blob | ArrayBufferView | Iterable<number> | Iterable<ArrayBuffer | ArrayBufferView> | AsyncIterable<ArrayBuffer | ArrayBufferView> | undefined;
    mode?: string | number | undefined;
    mtime?: import("ipfs-message-port-protocol/src/data").UnixFSTime | undefined;
};
type AddInput = string | ArrayBuffer | Blob | ArrayBufferView | ReadableStream<any> | Iterable<number> | Iterable<ArrayBuffer | ArrayBufferView> | AsyncIterable<ArrayBuffer | ArrayBufferView> | FileObject;
type AddAllInput = Iterable<string | Blob | FileObject> | AsyncIterable<string | Blob | FileObject>;
