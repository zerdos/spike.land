...
declare namespace Client {
  export { Keys, MessageTransport, ProcedureNames, Remote, RemoteService };
}
type RemoteService<T_1> =
  & import("ipfs-message-port-protocol/src/rpc").Remote<T_1>
  & import("./client/service")<T_1>;
...
type Remote<T_1> = {
  [K in keyof T_1]: import("ipfs-message-port-protocol/src/rpc").Procedure<
    T_1[K]
  >;
};
