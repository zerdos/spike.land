...
declare namespace IPFSClient {
    export { MessageTransport, ClientOptions, MessagePortOptions, AbortOptions, Implements, ImplementsMethod, APIWithExtraOptions };
}
 ...
 */
type Implements<APIFactory extends (config: any) => any> = (...args: Parameters<ReturnType<APIFactory>> extends never[] ? [] : Parameters<ReturnType<APIFactory>> extends [options?: infer Options | undefined, ...end: never[]] ? [options?: (Options & MessagePortOptions) | undefined] : Parameters<ReturnType<APIFactory>> extends [a1: infer A1, options?: infer Options_1 | undefined, ...end: never[]] ? [a1: A1, options?: (Options_1 & MessagePortOptions) | undefined] : Parameters<ReturnType<APIFactory>> extends [a1?: infer A1_1 | undefined, options?: infer Options_2 | undefined, ...end: never[]] ? [a1?: A1_1 | undefined, options?: (Options_2 & MessagePortOptions) | undefined] : Parameters<ReturnType<APIFactory>> extends [a1: infer A1_2, a2: infer A2, options?: infer Options_3 | undefined, ...end: never[]] ? [a1: A1_2, a2: A2, options?: (Options_3 & MessagePortOptions) | undefined] : Parameters<ReturnType<APIFactory>> extends [a1: infer A1_3, a2?: infer A2_1 | undefined, options?: infer Options_4 | undefined, ...end: never[]] ? [a1: A1_3, a2?: A2_1 | undefined, options?: (Options_4 & MessagePortOptions) | undefined] : Parameters<ReturnType<APIFactory>> extends [a1?: infer A1_4 | undefined, a2?: infer A2_2 | undefined, options?: infer Options_5 | undefined, ...end: never[]] ? [a1?: A1_4 | undefined, a2?: A2_2 | undefined, options?: (Options_5 & MessagePortOptions) | undefined] : Parameters<ReturnType<APIFactory>> extends [a1: infer A1_5, a2: infer A2_3, a3: infer A3, options?: infer Options_6 | undefined, ...end: never[]] ? [a1: A1_5, a2: A2_3, a3: A3, options?: (Options_6 & MessagePortOptions) | undefined] : Parameters<ReturnType<APIFactory>> extends [a1: infer A1_6, a2: infer A2_4, a3?: infer A3_1 | undefined, options?: infer Options_7 | undefined, ...end: never[]] ? [a1: A1_6, a2: A2_4, a3?: A3_1 | undefined, options?: (Options_7 & MessagePortOptions) | undefined] : Parameters<ReturnType<APIFactory>> extends [a1: infer A1_7, a2?: infer A2_5 | undefined, a3?: infer A3_2 | undefined, options?: infer Options_8 | undefined, ...end: never[]] ? [a1: A1_7, a2?: A2_5 | undefined, a3?: A3_2 | undefined, options?: (Options_8 & MessagePortOptions) | undefined] : Parameters<ReturnType<APIFactory>> extends [a1?: infer A1_8 | undefined, a2?: infer A2_6 | undefined, a3?: infer A3_3 | undefined, options?: infer Options_9 | undefined, ...end: never[]] ? [a1?: A1_8 | undefined, a2?: A2_6 | undefined, a3?: A3_3 | undefined, options?: (Options_9 & MessagePortOptions) | undefined] : never) => ReturnType<ReturnType<APIFactory>>;
type ImplementsMethod<Key, APIFactory extends (config: any) => any> = ReturnType<APIFactory>[Key] extends (...args: any[]) => any ? import("./interface").APIWithExtraOptions<ReturnType<APIFactory>[Key], MessagePortOptions> : never;
