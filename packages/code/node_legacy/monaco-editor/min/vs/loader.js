  ...
  var E = function () {
    ...
    return h.fileUriToFilePath = function (_, a) {
      ...
      h.recursiveClone = function (_) {
        if (
          !_ || typeof _ != "object" || _ instanceof RegExp ||
      ...
      h.getHighPerformanceTimestamp = function () {
        return this.PERFORMANCE_NOW_PROBED ||
          (this.PERFORMANCE_NOW_PROBED = !0,
            this.HAS_PERFORMANCE_NOW = l.global.performance &&
    ...
    return a.validateConfigurationOptions = function (n) {
      ...
      if (
        n = n || {},
          ...
          n.nodeCachedData && typeof n.nodeCachedData == "object" &&
  ...
  var _ = function () {
    ...
    return a.prototype._createIgnoreDuplicateModulesMap = function () {
      ...
      for (var n = 0; n < this.options.ignoreDuplicateModules.length; n++) {
        this.ignoreDuplicateModulesMap[this.options.ignoreDuplicateModules[n]] =
          !0;
      }
    },
      ...
      a.prototype._addUrlArgsToUrl = function (n) {
        return l.Utilities.containsQueryString(n)
          ? n + "&" + this.options.urlArgs : n + "?" + this.options.urlArgs;
      },
      ...
      a.prototype.moduleIdToPaths = function (n) {
        ...
        if (!l.Utilities.endsWith(r, ".js") && !l.Utilities.isAbsolutePath(r)) {
          ...
          !l.Utilities.containsQueryString(r) && (r = r + ".js"), e = [r];
        }
        return this._addUrlArgsIfNecessaryToUrls(e);
      },
      a.prototype.requireToUrl = function (n) {
        var p = n;
        return l.Utilities.isAbsolutePath(p) ||
      ...
      return r.prototype._init = function (e) {
        ...
        r.prototype._initNodeRequire = function (e, t) {
          ...
          if (!!i && !this._didPatchNodeRequire) {
            ...
            function s(f) {
              ...
              return d.resolve = function (g) {
                return c._resolveFilename(g, f);
              },
            ...
            u.prototype._compile = function (f, c) {
              ...
              return o._handleCachedData(b, d, g, !y.cachedData, t),
          ...
          if (/^node\|/.test(t)) {
            ...
            this._readSourceAndCachedData(y, b, d, function (C, P, U, w) {
              ...
              P.charCodeAt(0) === r._BOM
                ...
                : R = r._PREFIX + P + r._SUFFIX, R = c(R, y);
        ...
        r.prototype._createAndEvalScript = function (e, t, i, o, u) {
          ...
          return g.amd = d.amd,
            ...
            v ? o()
            : u(new Error("Didn't receive define call in " + i.filename + "!")),
            f;
        },
        ...
        r.prototype._getCachedDataPath = function (e, t) {
          var i = this._crypto.createHash("md5").update(t, "utf8").update(
              e.seed,
              "utf8",
        ...
        r.prototype._verifyCachedData = function (e, t, i, o, u) {
          ...
          !o || e.cachedDataRejected || setTimeout(function () {
            ...
            o.equals(f) ||
              (u.getConfig().onError(
                new Error(
                  "FAILED TO VERIFY CACHED DATA, deleting stale '" + i +
  ...
  var E = function () {
    ...
    return r._normalizeModuleId = function (e) {
      ...
      r.prototype.resolveModule = function (e) {
        var t = e;
        return l.Utilities.isAbsolutePath(t) ||
        ...
        if (this._callback) {
          if (typeof this._callback == "function") {
            ...
            o = u.producedError,
              ...
              !o && typeof u.returnedValue != "undefined" &&
  ...
  var p = function () {
    ...
    return r.prototype.reset = function () {
        ...
        for (var e = [], t = 0, i = 0, o = this._modules2.length; i < o; i++) {
          ...
          if (!!u) {
            ...
            e[t++] = {
              id: u.strId,
              path: s,
              defineLocation: s && f ? r._findRelevantLocationInStack(s, f)
              : null,
              dependencies: c,
              shim: null,
              exports: u.exports,
      ...
      r.prototype.synchronousRequire = function (e, t) {
        t === void 0 && (t = new E(e));
        var i = this._normalizeDependency(e, t), o = this._modules2[i.id];
        if (!o) {
          throw new Error(
      ...
      r.prototype._hasDependencyPath = function (e, t) {
        ...
        for (f.push(i), o[e] = !0; f.length > 0;) {
          var c = f.shift(), d = c.dependencies;
          if (d) {
      ...
      r.prototype._loadModule = function (e) {
        ...
        if (!(this._modules2[e] || this._knownModules2[e])) {
          ...
          var i = this._moduleIdProvider.getStrModuleId(e),
            ...
            u = /^@[^\/]+\/[^\/]+$/;
          this._env.isNode && (i.indexOf("/") === -1 || u.test(i)) &&
            o.push("node|" + i);
          var s = -1,
            f = function (c) {
              if (s++, s >= o.length) t._onLoadError(e, c);
                ...
                v.record(10, d),
                  t._scriptLoader.load(t, d, function () {
              ...
              this._hasDependencyCycle = !0,
                console.warn(
                  "There is a dependency cycle between '" +
                    this._moduleIdProvider.getStrModuleId(s.id) + "' and '" +
...
(function (l) {
  ...
  function p() {
    if (
      typeof l.global.require != "undefined" || typeof require != "undefined"
    ) {
  ...
  l.init = p,
    ...
    (h = new l.ModuleManager(
      ...
      typeof l.global.require != "function" && n.config(l.global.require),
      define = function () {
        return _.apply(null, arguments);
      },
      define.amd = _.amd,
