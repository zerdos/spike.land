 ...
 * monaco-typescript version: 4.1.1(5c99fb0e92db6615dfb3723630599c0ae56c344e)
...
define(
  ...
  (function (e, t, n, r) {
    ...
    var i;
    function o(e, t, n) {
      if (void 0 === n && (n = 0), "string" == typeof e) {
        return e;
      }
      if (void 0 === e) return "";
      var r = "";
    ...
    var l,
      u = function () {
        ...
        return e.prototype.isLibFile = function (e) {
          return !!e &&
            (0 === e.path.indexOf("/lib.") && !!n.libFileSet[e.path.slice(1)]);
        },
          e.prototype.getOrCreateModel = function (e) {
            var t = r.editor.getModel(e);
            return t || (this.isLibFile(e) && this._hasFetchedLibFiles
              ? r.editor.createModel(
    ...
    var c = function (e) {
      function t(t, n, i, o) {
        ...
        var a = function (e) {
          ...
          l = function (e) {
            r.editor.setModelMarkers(e, s._selector, []);
            var t = e.uri.toString();
            s._listener[t] && (s._listener[t].dispose(), delete s._listener[t]);
          };
        s._disposables.push(r.editor.onDidCreateModel(a)),
          s._disposables.push(r.editor.onWillDisposeModel(l)),
          s._disposables.push(r.editor.onDidChangeModelLanguage(
            (function (e) {
              l(e.model), a(e.model);
            }),
          )),
          s._disposables.push({
            dispose: function () {
              for (var e = 0, t = r.editor.getModels(); e < t.length; e++) {
                var n = t[e];
                l(n);
              }
            },
      ...
      return __extends(t, e),
                      ...
                      return t = p.sent(),
                        e.isDisposed()
                          ...
                          : (n = [],
                            ...
                            s ||
                            n.push(t.getSemanticDiagnostics(e.uri.toString())),
                            a ||
                            n.push(
                    ...
                    case 2:
                      ...
                      : (u = l.reduce(
                        ...
                        c = u.map(
                          ...
                          (function (e) {
                            return e.file ? r.Uri.parse(e.file.fileName) : null;
                          }),
                        ),
        ...
        t.prototype._convertDiagnostics = function (e, t) {
          var n = t.start || 0,
            ...
            a = s.lineNumber,
            l = s.column,
            u = e.getPositionAt(n + i),
            c = u.lineNumber,
            d = u.column,
            p = [];
          return t.reportsUnnecessary && p.push(r.MarkerTag.Unnecessary),
            t.reportsDeprecated && p.push(r.MarkerTag.Deprecated),
            {
          ...
          if (t) {
            ...
            return t.forEach(
              (function (t) {
                var s = e;
                if (t.file) {
                  var a = r.Uri.parse(t.file.fileName);
                  s = n._libFiles.getOrCreateModel(a);
                }
                if (s) {
                  var l = t.start || 0,
                    u = t.length || 1,
    ...
    var d = function (e) {
      ...
      return __extends(t, e),
        ...
        t.prototype.provideCompletionItems = function (e, n, i, o) {
          return __awaiter(
            this,
            void 0,
            void 0,
            (function () {
              ...
              return __generator(
                ...
                (function (u) {
                  switch (u.label) {
                    case 0:
                      return i = e.getWordUntilPosition(n),
                        o = new r.Range(
                          n.lineNumber,
                          i.startColumn,
                          n.lineNumber,
                        ...
                        suggestions: l.entries.map(
                          (function (i) {
                            ...
                            return -1 !==
                              ...
                              p.push(r.languages.CompletionItemTag.Deprecated),
                              {
                                uri: s,
                                position: n,
                                offset: a,
    ...
    function p(e) {
      ...
      if ("param" === e.name && e.text) {
        var n = e.text.split(" "), r = n[0], i = n.slice(1);
                      ...
                      return !(n = a.sent()) || e.isDisposed()
                        ...
                        : (i = function (t, n, o) {
                          var a = {
                            name: n.text,
                            detail: "",
                            kind: S[n.kind] || r.languages.SymbolKind.Variable,
    ...
    S[v.module] = r.languages.SymbolKind.Module,
      S[v.class] = r.languages.SymbolKind.Class,
      S[v.enum] = r.languages.SymbolKind.Enum,
      S[v.interface] = r.languages.SymbolKind.Interface,
      S[v.memberFunction] = r.languages.SymbolKind.Method,
      S[v.memberVariable] = r.languages.SymbolKind.Property,
      S[v.memberGetAccessor] = r.languages.SymbolKind.Property,
      S[v.memberSetAccessor] = r.languages.SymbolKind.Property,
      S[v.variable] = r.languages.SymbolKind.Variable,
      S[v.const] = r.languages.SymbolKind.Variable,
      S[v.localVariable] = r.languages.SymbolKind.Variable,
      S[v.variable] = r.languages.SymbolKind.Variable,
      S[v.function] = r.languages.SymbolKind.Function,
      S[v.localFunction] = r.languages.SymbolKind.Function;
    var y = function (e) {
      function t() {
        return null !== e && e.apply(this, arguments) || this;
      }
                ...
                (function (l) {
                  switch (l.label) {
                    ...
                    case 1:
                      return [
                        4,
                        l.sent().getFormattingEditsForRange(
                          r.toString(),
                          i,
                          o,
                          y._convertOptions(n),
    ...
    t.CodeActionAdaptor = x;
    var k = function (e) {
      function t() {
        return null !== e && e.apply(this, arguments) || this;
      }
      return __extends(t, e),
        t.prototype.provideRenameEdits = function (e, t, n, i) {
          return __awaiter(
            this,
            void 0,
            void 0,
            (function () {
              var i, o, s, a, l, u, c, d, p, f;
              return __generator(
                this,
                (function (g) {
                  switch (g.label) {
                    ...
                    case 1:
                      return [
                        4,
                        (a = g.sent()).getRenameInfo(o, s, {
                          allowRenameOfImportPath: !1,
                        }),
                      ];
                    case 2:
                      if (!1 === (l = g.sent()).canRename) {
                        return [2, {
                          edits: [],
                    ...
                    case 3:
                      if (!(u = g.sent()) || e.isDisposed()) return [2];
                      for (c = [], d = 0, p = u; d < p.length; d++) {
                        f = p[d],
                          c.push({
                            resource: r.Uri.parse(f.fileName),
                            edit: {
    ...
    (function (e, t, n, r, i) {
      ...
      function a(e, t) {
        ...
        return i.languages.registerCompletionItemProvider(
          t,
          new r.SuggestAdapter(s),
        ),
          i.languages.registerSignatureHelpProvider(
            t,
            new r.SignatureHelpAdapter(s),
          ),
          i.languages.registerHoverProvider(t, new r.QuickInfoAdapter(s)),
          i.languages.registerDocumentHighlightProvider(
            t,
            new r.OccurrencesAdapter(s),
          ),
          i.languages.registerDefinitionProvider(
            t,
            new r.DefinitionAdapter(a, s),
          ),
          i.languages.registerReferenceProvider(
            t,
            new r.ReferenceAdapter(a, s),
          ),
          i.languages.registerDocumentSymbolProvider(
            t,
            new r.OutlineAdapter(s),
          ),
          i.languages.registerDocumentRangeFormattingEditProvider(
            t,
            new r.FormatAdapter(s),
          ),
          i.languages.registerOnTypeFormattingEditProvider(
            t,
            new r.FormatOnTypeAdapter(s),
          ),
          i.languages.registerCodeActionProvider(t, new r.CodeActionAdaptor(s)),
          i.languages.registerRenameProvider(t, new r.RenameAdapter(s)),
          new r.DiagnosticsAdapter(a, e, t, s),
          s;
      }
      Object.defineProperty(t, "__esModule", { value: !0 }),
