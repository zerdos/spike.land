...
define(
    ...
    (function (e, t) {
      ...
      Object.defineProperty(t, "__esModule", { value: !0 }),
        ...
        t.createScanner = function (e, t) {
          ...
          function g() {
            if (s = "", h = 0, c = a, f = l, p = d, a >= i) {return c = i,
                u = 17;}
    ...
    (function (e, t) {
      ...
      t.format = function (e, t, i) {
        ...
        for (; 17 !== S;) {
          ...
          17 === k && (E = i.insertFinalNewline ? p : ""),
            C(E, A, g.getTokenOffset() + c),
            S = k;
        }
        return x;
      }, t.isEOL = o;
          ...
          if (e) {
            for (var n = e, r = 0, o = t; r < o.length; r++) {
              ...
              if ("string" == typeof i) {
                ...
                var l = i;
                if (
                  "array" !== n.type || l < 0 || !Array.isArray(n.children) ||
                  l >= n.children.length
                ) {
                  return;
                }
  ...
  function (e) {
    ...
    (function (e, t) {
      ...
      function o(e, t, n, o) {
        for (
          var a, s = t.slice(), c = r.parseTree(e, []), u = void 0, l = void 0;
          s.length > 0 &&
          (l = s.pop(),
            void 0 === (u = r.findNodeAtLocation(c, s)) && void 0 !== n);
        ) {
          "string" == typeof l ? ((a = {})[l] = n, n = a) : n = [n];
        }
        if (u) {
          if (
            "object" === u.type && "string" == typeof l &&
            ...
            if (void 0 === n) return [];
            var m = JSON.stringify(l) + ": " + JSON.stringify(n), g = void 0;
            return i(
              e,
              g = (T = o.getInsertionIndex
          ...
          if (
            ...
            if (-1 === v) {
              ...
              if (0 === u.children.length) {
                ...
                g = {
                  offset: (S = u.children[u.children.length - 1]).offset +
                    S.length,
                  length: 0,
                  content: "," + m,
                };
            ...
            if (void 0 !== n) {
              ...
              if (!o.isArrayInsertion && u.children.length > l) {
                var C = u.children[l];
                g = { offset: C.offset, length: C.length, content: m };
              } else if (0 === u.children.length || 0 === l) {
                g = {
                  offset: u.offset + 1,
                  length: 0,
      ...
      Object.defineProperty(t, "__esModule", { value: !0 }),
        ...
        function (e) {
          e.create = function (e, t) {
            ...
            e.is = function (e) {
              var t = e;
              return E.objectLiteral(t) && E.uinteger(t.line) &&
                E.uinteger(t.character);
            };
        }(r = t.Position || (t.Position = {})),
        function (e) {
          e.create = function (e, t, n, o) {
            if (
              E.uinteger(e) && E.uinteger(t) && E.uinteger(n) && E.uinteger(o)
            ) {
        ...
        function (e) {
          e.create = function (e, t) {
            ...
            e.is = function (e) {
              var t = e;
              return E.defined(t) && o.is(t.range) &&
                (E.string(t.uri) || E.undefined(t.uri));
            };
        ...
        function (e) {
          e.create = function (e, t, n, r) {
            ...
            e.is = function (e) {
              var t = e;
              return E.defined(t) && o.is(t.targetRange) &&
                E.string(t.targetUri) &&
                (o.is(t.targetSelectionRange) ||
                  E.undefined(t.targetSelectionRange)) &&
                (o.is(t.originSelectionRange) ||
                  E.undefined(t.originSelectionRange));
            };
        ...
        function (e) {
          e.create = function (e, t, n, r) {
            ...
            e.is = function (e) {
              var t = e;
              return E.numberRange(t.red, 0, 1) &&
                E.numberRange(t.green, 0, 1) && E.numberRange(t.blue, 0, 1) &&
                E.numberRange(t.alpha, 0, 1);
            };
        }(a = t.Color || (t.Color = {})),
        function (e) {
          e.create = function (e, t) {
        ...
        function (e) {
          e.create = function (e, t, n) {
            ...
            e.is = function (e) {
              var t = e;
              return E.string(t.label) &&
                (E.undefined(t.textEdit) || l.is(t)) &&
                (E.undefined(t.additionalTextEdits) ||
                  E.typedArray(t.additionalTextEdits, l.is));
            };
        ...
        function (e) {
          e.create = function (e, t, n, r, o) {
            ...
            return E.defined(n) && (i.startCharacter = n),
              E.defined(r) && (i.endCharacter = r),
              E.defined(o) && (i.kind = o),
              i;
          },
            e.is = function (e) {
              var t = e;
              return E.uinteger(t.startLine) && E.uinteger(t.startLine) &&
                (E.undefined(t.startCharacter) ||
                  E.uinteger(t.startCharacter)) &&
                (E.undefined(t.endCharacter) || E.uinteger(t.endCharacter)) &&
                (E.undefined(t.kind) || E.string(t.kind));
            };
        ...
        function (e) {
          e.create = function (e, t, n, r, o, i) {
            ...
            return E.defined(n) && (a.severity = n),
              E.defined(r) && (a.code = r),
              E.defined(o) && (a.source = o),
              E.defined(i) && (a.relatedInformation = i),
              a;
          },
            e.is = function (e) {
              var t, n = e;
              return E.defined(n) && o.is(n.range) && E.string(n.message) &&
                (E.number(n.severity) || E.undefined(n.severity)) &&
                (E.integer(n.code) || E.string(n.code) ||
                  E.undefined(n.code)) &&
                ...
                (E.undefined(n.relatedInformation) ||
                  E.typedArray(n.relatedInformation, s.is));
            };
        ...
        function (e) {
          e.create = function (e, t, n) {
            ...
            e.is = function (e) {
              var t = e;
              return void 0 !== t && E.objectLiteral(t) && E.string(t.label) &&
                (E.boolean(t.needsConfirmation) ||
                  void 0 === t.needsConfirmation) &&
                (E.string(t.description) || void 0 === t.description);
            };
        ...
        function (e) {
          e.create = function (e, t) {
            ...
            e.is = function (e) {
              var t = e;
              return E.defined(t) && b.is(t.textDocument) &&
        ...
        function (e) {
          e.create = function (e, t, n) {
            ...
            e.is = function (e) {
              var t = e;
              return t && "create" === t.kind && E.string(t.uri) &&
                (void 0 === t.options ||
                  (void 0 === t.options.overwrite ||
                      E.boolean(t.options.overwrite)) &&
                    (void 0 === t.options.ignoreIfExists ||
                      E.boolean(t.options.ignoreIfExists))) &&
        ...
        function (e) {
          e.create = function (e, t, n, r) {
            ...
            e.is = function (e) {
              var t = e;
              return t && "rename" === t.kind && E.string(t.oldUri) &&
                E.string(t.newUri) &&
                (void 0 === t.options ||
                  (void 0 === t.options.overwrite ||
                      E.boolean(t.options.overwrite)) &&
        ...
        function (e) {
          e.create = function (e, t, n) {
            ...
            e.is = function (e) {
              var t = e;
              return t && "delete" === t.kind && E.string(t.uri) &&
                (void 0 === t.options ||
                  (void 0 === t.options.recursive ||
                      E.boolean(t.options.recursive)) &&
                    (void 0 === t.options.ignoreIfNotExists ||
                      E.boolean(t.options.ignoreIfNotExists))) &&
                (void 0 === t.annotationId || d.is(t.annotationId));
            };
              ...
              if (b.is(e)) {
                ...
                if (!(r = this._textEditChanges[t.uri])) {
                  ...
                  this._workspaceEdit.documentChanges.push(n),
                    r = new T(o, this._changeAnnotations),
      ...
      t.WorkspaceChange = k,
        ...
        function (e) {
          e.create = function (e, t) {
            ...
            e.is = function (e) {
              var t = e;
              return E.defined(t) && E.string(t.uri) &&
                (null === t.version || E.integer(t.version));
            };
        }(
        ...
        function (e) {
          e.create = function (e, t, n, r) {
            ...
            e.is = function (e) {
              var t = e;
              return E.defined(t) && E.string(t.uri) &&
                E.string(t.languageId) && E.integer(t.version) &&
                E.string(t.text);
            };
        ...
        function (e) {
          e.create = function (e, t, n) {
            ...
            e.is = function (e) {
              var t = e;
              return t && E.string(t.newText) && o.is(t.insert) &&
                o.is(t.replace);
            };
        ...
        function (e) {
          e.fromPlainText = function (e) {
            ...
            e.is = function (e) {
              var t = e;
              return E.string(t) ||
                E.objectLiteral(t) && E.string(t.language) && E.string(t.value);
            };
        }(S = t.MarkedString || (t.MarkedString = {})),
        function (e) {
          e.is = function (e) {
            var t = e;
            return !!t && E.objectLiteral(t) &&
              (C.is(t.contents) || S.is(t.contents) ||
                E.typedArray(t.contents, S.is)) &&
        ...
        function (e) {
          e.create = function (e, t) {
            ...
            var o = { label: e };
            return E.defined(t) && (o.documentation = t),
              E.defined(n) ? o.parameters = n : o.parameters = [],
              o;
          };
        ...
        function (e) {
          e.create = function (e, t, n, r, o, i) {
            ...
            e.is = function (e) {
              var t = e;
              return t && E.string(t.name) && E.number(t.kind) &&
                o.is(t.range) && o.is(t.selectionRange) &&
                (void 0 === t.detail || E.string(t.detail)) &&
                (void 0 === t.deprecated || E.boolean(t.deprecated)) &&
        ...
        function (e) {
          e.create = function (e, t) {
            ...
            e.is = function (e) {
              var t = e;
              return E.defined(t) && E.typedArray(t.diagnostics, c.is) &&
                (void 0 === t.only || E.typedArray(t.only, E.string));
            };
        ...
        function (e) {
          e.create = function (e, t, n) {
            ...
            e.is = function (e) {
              var t = e;
              return t && E.string(t.title) &&
                (void 0 === t.diagnostics ||
                  E.typedArray(t.diagnostics, c.is)) &&
                (void 0 === t.kind || E.string(t.kind)) &&
                (void 0 !== t.edit || void 0 !== t.command) &&
                (void 0 === t.command || u.is(t.command)) &&
                (void 0 === t.isPreferred || E.boolean(t.isPreferred)) &&
        ...
        function (e) {
          e.create = function (e, t) {
            ...
            e.is = function (e) {
              var t = e;
              return E.defined(t) && o.is(t.range) &&
                (E.undefined(t.command) || u.is(t.command));
            };
        ...
        function (e) {
          e.create = function (e, t) {
            ...
            e.is = function (e) {
              var t = e;
              return E.defined(t) && E.uinteger(t.tabSize) &&
                E.boolean(t.insertSpaces);
            };
        ...
        function (e) {
          e.create = function (e, t, n) {
            ...
            e.is = function (e) {
              var t = e;
              return E.defined(t) && o.is(t.range) &&
                (E.undefined(t.target) || E.string(t.target));
            };
        ...
        function (e) {
          ...
          e.create = function (e, t, n, r) {
            ...
            e.is = function (e) {
              var t = e;
              return !!(E.defined(t) && E.string(t.uri) &&
                (E.undefined(t.languageId) || E.string(t.languageId)) &&
                E.uinteger(t.lineCount) && E.func(t.getText) &&
                E.func(t.positionAt) && E.func(t.offsetAt));
            },
        ...
        e.create = function (e, t, r, o) {
          ...
          e.applyEdits = function (e, t) {
            for (
              ...
              var u = c[s], l = e.offsetAt(u.range.start);
              if (l < o) throw new Error("Overlapping edit");
              l > o && i.push(n.substring(o, l)),
  ...
  (function (e, t) {
      ...
      return e.prototype.getNodeFromOffset = function (e, t) {
        ...
        e.prototype.validate = function (e, t, n) {
          if (
            ...
            var r = new y();
            return S(this.root, t, r, v.instance),
              r.problems.map(
                (function (t) {
                  var r,
                    i = o.Range.create(
          ...
          case "object":
            !function (e, t, n, o) {
              ...
              if (t.patternProperties) {
                for (
                  var T = 0, A = Object.keys(t.patternProperties);
                  T < A.length;
                  T++
                ) {
                  for (
                    var k = A[T], E = new RegExp(k), j = 0, O = s.slice(0);
                    j < O.length;
                    j++
                  ) {
                    var I = O[j];
                ...
                if (e.items.length > a.length) {
                  if ("object" == typeof t.additionalItems) {
                    for (var l = a.length; l < e.items.length; l++) {
                      u = new y();
                      S(e.items[l], t.additionalItems, u, o),
            ...
            !function (e, t, n, o) {
              ...
              if (r.isNumber(t.multipleOf)) {
                ...
                if (Number.isInteger(t.multipleOf)) c = a % t.multipleOf;
                  ...
                  var u = s(t.multipleOf), l = s(a);
                  if (u && l) {
                    var f = Math.pow(10, Math.abs(l.multiplier - u.multiplier));
                    l.multiplier < u.multiplier ? l.value *= f : u.value *= f,
                      c = l.value % u.value;
                  }
                }
                0 !== c &&
        ...
        !function () {
          ...
          var x = function (e, t) {
            for (var r = [], o = void 0, a = 0, u = e; a < u.length; a++) {
              var l = m(u[a]), f = new y(), d = s.newSub();
              if (S(c, l, f, d), f.hasProblems() || r.push(l), o) {
                if (t || f.hasProblems() || o.validationResult.hasProblems()) {
                  var p = f.compare(o.validationResult);
                  p > 0
                    ? o = { schema: l, validationResult: f, matchingSchemas: d }
                    : 0 === p &&
                      (o.matchingSchemas.merge(d),
                        o.validationResult.mergeEnumValues(f));
                } else {
                  o.matchingSchemas.merge(d),
                    o.validationResult.propertiesMatches += f.propertiesMatches,
                    o.validationResult.propertiesValueMatches +=
                      f.propertiesValueMatches;
                }
              } else o = { schema: l, validationResult: f, matchingSchemas: d };
            }
            return r.length > 1 && t &&
              n.problems.push({
    ...
    t.JSONDocument = C,
      t.parse = function (e, t) {
        ...
        function k(t, n) {
          var r = new p(t, g.getTokenOffset(), A), a = E(r);
          if (!a) {
          ...
          return e.prototype.doResolve = function (e) {
            ...
            e.prototype.doComplete = function (e, t, r) {
              ...
              if (
                ...
                var p = c - d.length;
                p > 0 && '"' === a[p - 1] && p--,
                  f = s.Range.create(e.positionAt(p), t);
              } else {
                f = s.Range.create(
                ...
                m = {
                  add: function (e) {
                    ...
                    if (n) {
                      ...
                      f && void 0 !== e.insertText &&
                      (e.textEdit = s.TextEdit.replace(f, e.insertText)),
                        e.label = t,
                        h[t] = e,
                        i.items.push(e);
                    }
              ...
              return this.schemaService.getSchemaForResource(e.uri, r).then(
                (function (t) {
                  ...
                  if (u && "object" === u.type) {
                    ...
                    var b = "";
                    p && (b = o.evaluateSeparatorAfter(e, e.offsetAt(f.end))),
                      t
                      ...
                      if (u.enum) {
                        for (var f = 0; f < u.enum.length; f++) {
                          ...
                          u.markdownEnumDescriptions &&
                            ...
                            ? d = c.fromMarkup(u.markdownEnumDescriptions[f])
                            : u.enumDescriptions &&
                              f < u.enumDescriptions.length &&
                              (d = u.enumDescriptions[f]), l(u.enum[f], d);
                        }
                      }
                      u.const && l(u.const);
                    }
            ...
            e.prototype.getSchemaLessValueCompletions = function (
              ...
              if ("property" === t.type && r > (t.colonOffset || 0)) {
                ...
                if (
                  f &&
                  (r > f.offset + f.length || "object" === f.type ||
                    "array" === f.type)
                ) {
                  return;
                }
            ...
            e.prototype.getValueCompletions = function (e, t, n, r, o, i, a) {
              ...
              if (
                ...
                if (n && (void 0 !== c || "array" === n.type)) {
                  for (
                    var f = this.evaluateSeparatorAfter(o, s),
                      d = 0,
            ...
            e.prototype.addDefaultValueCompletions = function (e, t, n, r) {
              ...
              Array.isArray(e.examples) && e.examples.forEach(
                ...
                e.defaultSnippets.forEach(
                  (function (c) {
                    var u, l, f = e.type, d = c.body, p = c.label;
                    if (a.isDefined(d)) {
                      e.type;
            ...
            e.prototype.getInsertTextForProperty = function (e, t, n, r) {
              ...
              if (t) {
                ...
                if (
                  ...
                  switch (
                    l ||
                    (t.properties ? l = "object" : t.items && (l = "array")), l
                  ) {
                    case "boolean":
                      i = "$1";
                      break;
            ...
            470: (e) => {
              ...
              var r = {
                ...
                parse: function (e) {
                  ...
                  i ? (n.root = "/", r = 1) : r = 0;
                  for (
                    var a = -1, s = 0, c = -1, u = !0, l = e.length - 1, f = 0;
                    l >= r;
                    --l
                  ) {
                ...
                p = function () {
                  ...
                  return e.isUri = function (t) {
                    ...
                    e.file = function (e) {
                      var t = l;
                      if (
                        a.isWindows && (e = e.replace(/\\/g, f)),
                          e[0] === f && e[1] === f
                      ) {
                        var n = e.indexOf(f, 2);
                        -1 === n ? (t = e.substring(2), e = f)
      ...
      var f = function () {
        ...
        return e.prototype.getRegisteredSchemaIds = function (e) {
          ...
          e.prototype.resolveSchemaContent = function (e, t, n) {
            ...
            var c = this.contextService,
              ...
              f = function (e, t, n, i, s) {
                ...
                return l.getUnresolvedSchema().then(
                  (function (r) {
          ...
          e.prototype.getSchemaForResource = function (e, t) {
            ...
            var b = l.length > 0
              ? this.createCombinedSchema(e, l).getResolvedSchema()
      ...
      var n = e("../parser/jsonParser"),
        ...
        a = function () {
          ...
          return e.prototype.findDocumentSymbols = function (e, t, o) {
            ...
            var c = t.root;
            if (!c) return [];
            var u = o.resultLimit || Number.MAX_VALUE, l = e.uri;
            if (
            ...
            return C && o && o.onResultLimitExceeded &&
              o.onResultLimitExceeded(l),
              S;
          },
            e.prototype.findDocumentSymbols2 = function (e, t, o) {
                        ...
                        (function (t, r) {
                          if (t) {
                            if (u > 0) {
                              ...
                              n.push(c),
                                C.push({ result: c.children, node: t });
                            } else T = !0;
                          }
                        }),
                      )
                          ...
                          (function (t) {
                            ...
                            if (r) {
                              if (u > 0) {
                                ...
                                n.push(l), C.push({ result: c, node: r });
                              } else T = !0;
                            }
                          }),
                        );
              ...
              return T && o && o.onResultLimitExceeded &&
                o.onResultLimitExceeded(l),
                x;
            },
    ...
    (function (e, t) {
      ...
      t.getFoldingRanges = function (e, t) {
          ...
          switch (u) {
            ...
            case 4:
              ...
              if (a.length > 0 && a[a.length - 1].kind === d) {
                ...
                f && p > f.startLine + 1 && s !== f.startLine &&
        ...
        for (v = 0; v < o.length; v++) {
          var E;
          "number" == typeof (E = i[v]) && (E < T || E === T && S++ < y) &&
            k.push(o[v]);
        }
        return k;
      };
          ...
          (function (t) {
            for (
              ...
              switch (a.type) {
                ...
                case "object":
                case "array":
                  var u = a.offset + 1, l = a.offset + a.length - 1;
...
!function (e) {
      ...
      t.getLanguageService = function (e) {
        ...
        return {
          ...
          format: function (e, t, n) {
            ...
            return f.format(e.getText(), r, i).map(
              (function (t) {
  ...
  define(
    ...
    (function (e, t, n, r) {
      "use strict";
      Object.defineProperty(t, "__esModule", { value: !0 }),
        t.SelectionRangeAdapter = t.FoldingRangeAdapter = t
          .DocumentColorAdapter = t.DocumentRangeFormattingEditProvider = t
            .DocumentFormattingEditProvider = t.DocumentSymbolAdapter = t
      ...
      var o = function () {
        function e(e, t, r) {
          ...
          var i = function (e) {
              var t, n = e.getModeId();
              n === o._languageId &&
                (o._listener[e.uri.toString()] = e.onDidChangeContent(
                  (function () {
                    clearTimeout(t),
                      t = Number(setTimeout(
                        (function () {
            ...
            a = function (e) {
              ...
              var t = e.uri.toString(), r = o._listener[t];
              r && (r.dispose(), delete o._listener[t]);
            };
          this._disposables.push(n.editor.onDidCreateModel(i)),
            this._disposables.push(n.editor.onWillDisposeModel(
              (function (e) {
                a(e), o._resetSchema(e.uri);
              }),
            )),
            this._disposables.push(
              n.editor.onDidChangeModelLanguage(
                (function (e) {
                  a(e.model), i(e.model), o._resetSchema(e.model.uri);
                }),
              ),
            ),
            this._disposables.push(r.onDidChange(
              (function (e) {
                n.editor.getModels().forEach(
                  (function (e) {
            ...
            this._disposables.push({
              dispose: function () {
                for (var e in n.editor.getModels().forEach(a), o._listener) {
                  o._listener[e].dispose();
                }
              },
            }),
        ...
        return e.prototype.dispose = function () {
          ...
          e.prototype._doValidate = function (e, t) {
            this._worker(e).then(
              (function (r) {
                return r.doValidation(e.toString()).then(
                  (function (r) {
                    var o = r.map(
                        (function (e) {
                    ...
                    a && a.getModeId() === t &&
                      n.editor.setModelMarkers(a, t, o);
                  }),
                );
              }),
            ).then(
                    ...
                    s = o.items.map(
                      (function (e) {
                        ...
                        return e.textEdit &&
                          ...
                          (o.additionalTextEdits = e.additionalTextEdits.map(
                            l,
                          )),
                          e.insertTextFormat === r.InsertTextFormat.Snippet &&
                          (o.insertTextRules =
                            n.languages.CompletionItemInsertTextRule
                              .InsertAsSnippet),
                          o;
                      }),
                    );
      ...
      var y = function () {
        ...
        return e.prototype.provideDocumentFormattingEdits = function (e, t, n) {
          ...
          return this._worker(r).then(
            (function (e) {
              return e.format(r.toString(), null, v(t)).then(
                (function (e) {
      ...
      var b = function () {
        ...
        return e.prototype.provideDocumentRangeFormattingEdits = function (
          ...
          return this._worker(o).then(
            (function (e) {
              return e.format(o.toString(), s(t), v(n)).then(
                (function (e) {
                  if (e && 0 !== e.length) return e.map(l);
                }),
              );
              ...
              (function (e) {
                if (e) {
                  return e.map(
                    (function (e) {
                      var t = { label: e.label };
                      return e.textEdit && (t.textEdit = l(e.textEdit)),
                        e.additionalTextEdits &&
  ...
  define(
    ...
    (function (e, t, n) {
      "use strict";
      Object.defineProperty(t, "__esModule", { value: !0 }),
        t.TOKEN_COMMENT_LINE = t.TOKEN_COMMENT_BLOCK = t.TOKEN_PROPERTY_NAME = t
          .TOKEN_VALUE_NUMBER = t.TOKEN_VALUE_STRING = t.TOKEN_VALUE_NULL = t
            .TOKEN_VALUE_BOOLEAN = t.TOKEN_DELIM_COMMA = t.TOKEN_DELIM_COLON = t
              .TOKEN_DELIM_ARRAY = t.TOKEN_DELIM_OBJECT = t
                .createTokenizationSupport = void 0,
          ...
          return {
            ...
            tokenize: function (i, a, s, c) {
              return function (e, i, a, s, c) {
                ...
                for (;;) {
                  var m = s + f.getPosition(), g = "", v = f.scan();
                  if (17 === v) break;
                  if (m === s + f.getPosition()) {
                    throw new Error(
                      "Scanner did not advance, next 3 characters are: " +
                        i.substr(f.getPosition(), 3),
                    );
                  }
                  ...
                  h.endState = new o(a.getStateData(), f.getTokenError(), d, p),
                    h.tokens.push({ startIndex: m, scopes: g });
                }
                return h;
              }(e, i, a, s);
            },
    ...
    (function (e, t, n, r, o, i) {
      ...
      Object.defineProperty(t, "__esModule", { value: !0 }),
        ...
        t.setupMode = function (e) {
          var t = [], u = [], l = new n.WorkerManager(e);
          t.push(l);
          var f = function () {
          ...
          function d() {
            var t = e.languageId, n = e.modeConfiguration;
            s(u),
              ...
              n.hovers &&
              u.push(
                i.languages.registerHoverProvider(t, new r.HoverAdapter(f)),
              ),
              n.documentSymbols &&
              u.push(
              ...
              n.colors &&
              u.push(
                i.languages.registerColorProvider(
                  t,
              ...
              n.foldingRanges &&
              u.push(
                i.languages.registerFoldingRangeProvider(
                  t,
              ...
              n.selectionRanges &&
              u.push(
                i.languages.registerSelectionRangeProvider(
                  t,
