    ...
    (function (f) {
      ...
      return (function () {
        function r(e, n, t) {
          ...
          for (
            var u = typeof __require === "function" && __require, i = 0;
            i < t.length;
            i++
          ) {
            o(t[i]);
      ...
      })()(
        {
          ...
          2: [function (require2, module3, exports3) {
            ...
            (function () {
              ...
              try {
                cachedClearTimeout = typeof clearTimeout === "function"
                  ? clearTimeout
                  : defaultClearTimeout;
              } catch {
            ...
            function setup(env) {
              ...
              function createDebug(namespace) {
                ...
                function debug(...args) {
                  ...
                  const self2 = debug;
                  const curr = Date.now();
                  const ms = curr - (previousTime || curr);
                  self2.diff = ms;
                  self2.prev = previousTime;
                  self2.curr = curr;
                  previousTime = curr;
                  ...
                  args[0] = args[0].replace(
                    ...
                    (match, format) => {
                      ...
                      if (typeof formatter === "function") {
                        ...
                        match = formatter.call(self2, value);
                        args.splice(index, 1);
                        index--;
                      }
              ...
              function enabled(name) {
                ...
                let length;
                for (
                  i = 0, length = createDebug.skips.length;
                  i < length;
                  i++
                ) {
                ...
                for (
                  i = 0, length = createDebug.names.length;
                  i < length;
                  i++
                ) {
              ...
              function toNamespace(regexp) {
                return regexp.toString().substring(
                  2,
                  regexp.toString().length - 2,
                ).replace(/\.\*\?$/, "*");
              }
            ...
            (function (process) {
              (function () {
                ...
                function load() {
                  ...
                  if (
                    !r && typeof process !== "undefined" && "env" in process
                  ) {
                    r = process.env.DEBUG;
                  }
