...
import {withEmotionCache as WO} from "@emotion/react"
//import Emotion  from "@emotion/react";
...
globalThis.EmotionGlob = globalThis.EmotionGlob ||
  { JSX, Emotion, styled: styledG, cache: cacheG, withEmotionCache: WO };

// @ts-expect-error
const EmotionGlob = globalThis.EmotionGlob;

export const { styled, cache,  withEmotionCache} = EmotionGlob;
