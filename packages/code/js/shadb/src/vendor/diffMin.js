...
N.prototype = {
      ...
      for (var d = -1 * o; d <= o; d += 2) {
        ...
        if (
          !g || F && y.newPos < L.newPos
            ? (w = fe(L), i.pushComponent(w.components, void 0, !0))
  ...
  equals: function (n, r) {
    return this.options.comparator ? this.options.comparator(n, r)
    : n === r || this.options.ignoreCase && n.toLowerCase() === r.toLowerCase();
  },
...
P.equals = function (e, n) {
  ...
  P.tokenize = function (e) {
    for (
      ...
      !n[r + 1] && n[r + 2] && K.test(n[r]) && K.test(n[r + 2]) &&
