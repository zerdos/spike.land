...
var Pn = function e62(t61, o45) {
  ...
  return function() {
    ...
    var y4 = i(function(f7, C3, k) {
      ...
      for (var V2 in f7)
        u8 && V2 === "as" || M1(V2) && (w3[V2] = f7[V2]);
      w3.className = x4, w3.ref = k;
      var K2 = f(E4, w3), Y = f(Tn, null);
      return f(i1, null, Y, K2);
    });
...
var _n = ut((e74) => {
  ...
  let [t, o3] = e74.split(""), r57 = On[t], n45 = kn[o3] || "";
...
var wt = Object.keys(jo).reduce((e92, t) => (jo[t].forEach((o3) => {
  e92[o3] = Ks[t];
}), e92), {});
...
function Xe(e109) {
  let { theme: t95, name: o3, props: r77 } = e109;
  return !t95 || !t95.components || !t95.components[o3] || !t95.components[o3].defaultProps ? r77 : ve(t95.components[o3].defaultProps, r77);
}
...
var Zi = mod.forwardRef(function(t115, o90) {
  ...
  let C8 = mod.useCallback((v4) => {
    ...
    let w8 = M8 ? null : f16.current, V2 = w8 ? w8.getBoundingClientRect() : {
      width: 0,
      height: 0,
      left: 0,
      top: 0
    ...
    if (T || v5.clientX === 0 && v5.clientY === 0 || !v5.clientX && !v5.touches) {
      K2 = Math.round(V2.width / 2), Y = Math.round(V2.height / 2);
    } else {
      let { clientX: te2, clientY: oe2 } = v5.touches ? v5.touches[0] : v5;
      K2 = Math.round(te2 - V2.left), Y = Math.round(oe2 - V2.top);
    }
    if (T) {
      q1 = Math.sqrt((2 * V2.width ** 2 + V2.height ** 2) / 3), q1 % 2 === 0 && (q1 += 1);
    } else {
      let te2 = Math.max(Math.abs((w8 ? w8.clientWidth : 0) - K2), K2) * 2 + 2, oe2 = Math.max(Math.abs((w8 ? w8.clientHeight : 0) - Y), Y) * 2 + 2;
      q1 = Math.sqrt(te2 ** 2 + oe2 ** 2);
    }
...
var ia = mod.forwardRef(function(t118, o92) {
  let r92 = D({
    ...
    TouchRippleProps: Y,
    type: q22
  } = r92, te2 = P1(r92, ta), oe2 = mod.useRef(null), X = mod.useRef(null), { isFocusVisibleRef: ro, onFocus: Or, onBlur: kr, ref: _r } = or(), [le2, $e] = mod.useState(false);
  u24 && le2 && $e(false), mod.useImperativeHandle(n70, () => ({
    focusVisible: () => {
      $e(true), oe2.current.focus();
    }
  }), []), mod.useEffect(() => {
    le2 && h12 && !c24 && X.current.pulsate();
  }, [
    c24,
    h12,
    le2
  ...
  let Nr = re("start", S5), wr = re("stop", C9), zr = re("stop", k), Mr = re("stop", T), $r = re("stop", (b2) => {
    le2 && b2.preventDefault(), W && W(b2);
  }), Br = re("start", V2), Ir = re("stop", M9), Ar = re("stop", w9), jr = re("stop", (b3) => {
    kr(b3), ro.current === false && $e(false), y9 && y9(b3);
  }, false), Vr = ze((b4) => {
    oe2.current || (oe2.current = b4.currentTarget), Or(b4), ro.current === true && ($e(true), x9 && x9(b4)), E9 && E9(b4);
  }), rt = () => {
    let b5 = oe2.current;
    return p26 && p26 !== "button" && !(b5.tagName === "A" && b5.href);
  }, nt = mod.useRef(false), Ur = ze((b6) => {
    h12 && !nt.current && le2 && X.current && b6.key === " " && (nt.current = true, X.current.stop(b6, () => {
      X.current.start(b6);
    ...
    h12 && b7.key === " " && X.current && le2 && !b7.defaultPrevented && (nt.current = false, X.current.stop(b7, () => {
      X.current.pulsate(b7);
    })), R9 && R9(b7), f17 && b7.target === b7.currentTarget && rt() && b7.key === " " && !b7.defaultPrevented && f17(b7);
  }), Be = p26;
  Be === "button" && (te2.href || te2.to) && (Be = g10);
  let Re = {};
  Be === "button" ? (Re.type = q22 === void 0 ? "button" : q22, Re.disabled = u24) : (!te2.href && !te2.to && (Re.role = "button"), u24 && (Re["aria-disabled"] = u24));
  let Lr = qt(_r, oe2), Fr = qt(o92, Lr), [Wr, Gr] = mod.useState(false);
  mod.useEffect(() => {
    Gr(true);
  }, []);
...
var ba = I2("span", {
  ...
  overridesResolver: (e162, t127) => {
    let { ownerState: o3 } = e162;
    return [
      t127.startIcon,
      t127[`iconSize${_2(o3.size)}`]
    ];
  }
})(({ ownerState: e163 }) => m6({
  display: "inherit",
...
var va = I2("span", {
  ...
  overridesResolver: (e164, t128) => {
    let { ownerState: o3 } = e164;
    return [
      t128.endIcon,
      t128[`iconSize${_2(o3.size)}`]
    ];
  }
})(({ ownerState: e165 }) => m6({
  display: "inherit",
...
var Sa = I2(ge, {
  ...
  overridesResolver: (e168, t131) => {
    let { ownerState: o3 } = e168;
    return [
      t131.root,
      t131[`size${_2(o3.size)}`]
    ];
  }
...
var me2 = Object.getPrototypeOf;
var pe = Object.prototype.hasOwnProperty;
var ke2 = (t) => w2(t, "__esModule", { value: true });
var o = (t, e3) => () => (e3 || t((e3 = { exports: {} }).exports, e3), e3.exports);
var ge2 = (t, e3, i5, r) => {
  if (e3 && typeof e3 == "object" || typeof e3 == "function")
    for (let x of be(e3))
      !pe.call(t, x) && (i5 || x !== "default") && w2(t, x, { get: () => e3[x], enumerable: !(r = _e2(e3, x)) || r.enumerable });
  return t;
};
var N2 = (t, e3) => ge2(ke2(w2(t != null ? ve2(me2(t)) : {}, "default", !e3 && t && t.__esModule ? { get: () => t.default, enumerable: true } : { value: t, enumerable: true })), t);
var E3 = o((c0, A2) => {
  "use strict";
  var B2 = function() {
  }, we2 = Object.prototype.hasOwnProperty, Be = Array.prototype.slice;
  function Me2(t, e3) {
    var i5;
    return typeof Object.create == "function" ? i5 = Object.create(t) : (B2.prototype = t, i5 = new B2(), B2.prototype = null), e3 && y3(true, i5, e3), i5;
  }
  function qe2(t, e3, i5, r) {
    var x = this;
    return typeof t != "string" && (r = i5, i5 = e3, e3 = t, t = null), typeof e3 != "function" && (r = i5, i5 = e3, e3 = function() {
      return x.apply(this, arguments);
    }), y3(false, e3, x, r), e3.prototype = Me2(x.prototype, i5), e3.prototype.constructor = e3, e3.class_ = t || x.class_, e3.super_ = x, e3;
  }
  function y3(t, e3, i5) {
    i5 = Be.call(arguments, 2);
    for (var r, x, s = 0, a7 = i5.length; s < a7; s++) {
      x = i5[s];
      for (r in x)
        (!t || we2.call(x, r)) && (e3[r] = x[r]);
    }
  }
  A2.exports = qe2;
});
...
var M = o((d0, R2) => {
  "use strict";
  var Ne2 = u5(), ye2 = Ne2.extend(function(t, e3, i5) {
    this.qrious = t, this.element = e3, this.element.qrious = t, this.enabled = Boolean(i5);
  }, { draw: function(t) {
  }, getElement: function() {
    return this.enabled || (this.enabled = true, this.render()), this.element;
  }, getModuleSize: function(t) {
    var e3 = this.qrious, i5 = e3.padding || 0, r = Math.floor((e3.size - i5 * 2) / t.width);
    return Math.max(1, r);
  }, getOffset: function(t) {
    var e3 = this.qrious, i5 = e3.padding;
    if (i5 != null)
      return i5;
    var r = this.getModuleSize(t), x = Math.floor((e3.size - r * t.width) / 2);
    return Math.max(0, x);
  }, render: function(t) {
...
var j2 = o((l0, T) => {
  "use strict";
  var Ae2 = M(), Ee2 = Ae2.extend({ draw: function(t) {
    var e3, i5, r = this.qrious, x = this.getModuleSize(t), s = this.getOffset(t), a7 = this.element.getContext("2d");
    for (a7.fillStyle = r.foreground, a7.globalAlpha = r.foregroundAlpha, e3 = 0; e3 < t.width; e3++)
      for (i5 = 0; i5 < t.width; i5++)
        t.buffer[i5 * t.width + e3] && a7.fillRect(x * e3 + s, x * i5 + s, x, x);
  }, reset: function() {
    var t = this.qrious, e3 = this.element.getContext("2d"), i5 = t.size;
    e3.lineWidth = 1, e3.clearRect(0, 0, i5, i5), e3.fillStyle = t.background, e3.globalAlpha = t.backgroundAlpha, e3.fillRect(0, 0, i5, i5);
  }, resize: function() {
    var t = this.element;
...
var I3 = o((v0, z2) => {
  "use strict";
  var Se2 = u5(), Ce2 = Se2.extend(null, { BLOCK: [0, 11, 15, 19, 23, 27, 31, 16, 18, 20, 22, 24, 26, 28, 20, 22, 24, 24, 26, 28, 28, 22, 24, 24, 26, 26, 28, 28, 24, 24, 26, 26, 26, 28, 28, 24, 26, 26, 26, 28, 28] });
  z2.exports = Ce2;
});
var V = o((_0, P) => {
  "use strict";
  var Le = u5(), Re = Le.extend(null, { BLOCKS: [1, 0, 19, 7, 1, 0, 16, 10, 1, 0, 13, 13, 1, 0, 9, 17, 1, 0, 34, 10, 1, 0, 28, 16, 1, 0, 22, 22, 1, 0, 16, 28, 1, 0, 55, 15, 1, 0, 44, 26, 2, 0, 17, 18, 2, 0, 13, 22, 1, 0, 80, 20, 2, 0, 32, 18, 2, 0, 24, 26, 4, 0, 9, 16, 1, 0, 108, 26, 2, 0, 43, 24, 2, 2, 15, 18, 2, 2, 11, 22, 2, 0, 68, 18, 4, 0, 27, 16, 4, 0, 19, 24, 4, 0, 15, 28, 2, 0, 78, 20, 4, 0, 31, 18, 2, 4, 14, 18, 4, 1, 13, 26, 2, 0, 97, 24, 2, 2, 38, 22, 4, 2, 18, 22, 4, 2, 14, 26, 2, 0, 116, 30, 3, 2, 36, 22, 4, 4, 16, 20, 4, 4, 12, 24, 2, 2, 68, 18, 4, 1, 43, 26, 6, 2, 19, 24, 6, 2, 15, 28, 4, 0, 81, 20, 1, 4, 50, 30, 4, 4, 22, 28, 3, 8, 12, 24, 2, 2, 92, 24, 6, 2, 36, 22, 4, 6, 20, 26, 7, 4, 14, 28, 4, 0, 107, 26, 8, 1, 37, 22, 8, 4, 20, 24, 12, 4, 11, 22, 3, 1, 115, 30, 4, 5, 40, 24, 11, 5, 16, 20, 11, 5, 12, 24, 5, 1, 87, 22, 5, 5, 41, 24, 5, 7, 24, 30, 11, 7, 12, 24, 5, 1, 98, 24, 7, 3, 45, 28, 15, 2, 19, 24, 3, 13, 15, 30, 1, 5, 107, 28, 10, 1, 46, 28, 1, 15, 22, 28, 2, 17, 14, 28, 5, 1, 120, 30, 9, 4, 43, 26, 17, 1, 22, 28, 2, 19, 14, 28, 3, 4, 113, 28, 3, 11, 44, 26, 17, 4, 21, 26, 9, 16, 13, 26, 3, 5, 107, 28, 3, 13, 41, 26, 15, 5, 24, 30, 15, 10, 15, 28, 4, 4, 116, 28, 17, 0, 42, 26, 17, 6, 22, 28, 19, 6, 16, 30, 2, 7, 111, 28, 17, 0, 46, 28, 7, 16, 24, 30, 34, 0, 13, 24, 4, 5, 121, 30, 4, 14, 47, 28, 11, 14, 24, 30, 16, 14, 15, 30, 6, 4, 117, 30, 6, 14, 45, 28, 11, 16, 24, 30, 30, 2, 16, 30, 8, 4, 106, 26, 8, 13, 47, 28, 7, 22, 24, 30, 22, 13, 15, 30, 10, 2, 114, 28, 19, 4, 46, 28, 28, 6, 22, 28, 33, 4, 16, 30, 8, 4, 122, 30, 22, 3, 45, 28, 8, 26, 23, 30, 12, 28, 15, 30, 3, 10, 117, 30, 3, 23, 45, 28, 4, 31, 24, 30, 11, 31, 15, 30, 7, 7, 116, 30, 21, 7, 45, 28, 1, 37, 23, 30, 19, 26, 15, 30, 5, 10, 115, 30, 19, 10, 47, 28, 15, 25, 24, 30, 23, 25, 15, 30, 13, 3, 115, 30, 2, 29, 46, 28, 42, 1, 24, 30, 23, 28, 15, 30, 17, 0, 115, 30, 10, 23, 46, 28, 10, 35, 24, 30, 19, 35, 15, 30, 17, 1, 115, 30, 14, 21, 46, 28, 29, 19, 24, 30, 11, 46, 15, 30, 13, 6, 115, 30, 14, 23, 46, 28, 44, 7, 24, 30, 59, 1, 16, 30, 12, 7, 121, 30, 12, 26, 47, 28, 39, 14, 24, 30, 22, 41, 15, 30, 6, 14, 121, 30, 6, 34, 47, 28, 46, 10, 24, 30, 2, 64, 15, 30, 17, 4, 122, 30, 29, 14, 46, 28, 49, 10, 24, 30, 24, 46, 15, 30, 4, 18, 122, 30, 13, 32, 46, 28, 48, 14, 24, 30, 42, 32, 15, 30, 20, 4, 117, 30, 40, 7, 47, 28, 43, 22, 24, 30, 10, 67, 15, 30, 19, 6, 118, 30, 18, 31, 47, 28, 34, 34, 24, 30, 20, 61, 15, 30], FINAL_FORMAT: [30660, 29427, 32170, 30877, 26159, 25368, 27713, 26998, 21522, 20773, 24188, 23371, 17913, 16590, 20375, 19104, 13663, 12392, 16177, 14854, 9396, 8579, 11994, 11245, 5769, 5054, 7399, 6608, 1890, 597, 3340, 2107], LEVELS: { L: 1, M: 2, Q: 3, H: 4 } });
  P.exports = Re;
});
var K = o((b0, G2) => {
  "use strict";
  var Te = u5(), je = Te.extend(null, { EXPONENT: [1, 2, 4, 8, 16, 32, 64, 128, 29, 58, 116, 232, 205, 135, 19, 38, 76, 152, 45, 90, 180, 117, 234, 201, 143, 3, 6, 12, 24, 48, 96, 192, 157, 39, 78, 156, 37, 74, 148, 53, 106, 212, 181, 119, 238, 193, 159, 35, 70, 140, 5, 10, 20, 40, 80, 160, 93, 186, 105, 210, 185, 111, 222, 161, 95, 190, 97, 194, 153, 47, 94, 188, 101, 202, 137, 15, 30, 60, 120, 240, 253, 231, 211, 187, 107, 214, 177, 127, 254, 225, 223, 163, 91, 182, 113, 226, 217, 175, 67, 134, 17, 34, 68, 136, 13, 26, 52, 104, 208, 189, 103, 206, 129, 31, 62, 124, 248, 237, 199, 147, 59, 118, 236, 197, 151, 51, 102, 204, 133, 23, 46, 92, 184, 109, 218, 169, 79, 158, 33, 66, 132, 21, 42, 84, 168, 77, 154, 41, 82, 164, 85, 170, 73, 146, 57, 114, 228, 213, 183, 115, 230, 209, 191, 99, 198, 145, 63, 126, 252, 229, 215, 179, 123, 246, 241, 255, 227, 219, 171, 75, 150, 49, 98, 196, 149, 55, 110, 220, 165, 87, 174, 65, 130, 25, 50, 100, 200, 141, 7, 14, 28, 56, 112, 224, 221, 167, 83, 166, 81, 162, 89, 178, 121, 242, 249, 239, 195, 155, 43, 86, 172, 69, 138, 9, 18, 36, 72, 144, 61, 122, 244, 245, 247, 243, 251, 235, 203, 139, 11, 22, 44, 88, 176, 125, 250, 233, 207, 131, 27, 54, 108, 216, 173, 71, 142, 0], LOG: [255, 0, 1, 25, 2, 50, 26, 198, 3, 223, 51, 238, 27, 104, 199, 75, 4, 100, 224, 14, 52, 141, 239, 129, 28, 193, 105, 248, 200, 8, 76, 113, 5, 138, 101, 47, 225, 36, 15, 33, 53, 147, 142, 218, 240, 18, 130, 69, 29, 181, 194, 125, 106, 39, 249, 185, 201, 154, 9, 120, 77, 228, 114, 166, 6, 191, 139, 98, 102, 221, 48, 253, 226, 152, 37, 179, 16, 145, 34, 136, 54, 208, 148, 206, 143, 150, 219, 189, 241, 210, 19, 92, 131, 56, 70, 64, 30, 66, 182, 163, 195, 72, 126, 110, 107, 58, 40, 84, 250, 133, 186, 61, 202, 94, 155, 159, 10, 21, 121, 43, 78, 212, 229, 172, 115, 243, 167, 87, 7, 112, 192, 247, 140, 128, 99, 13, 103, 74, 222, 237, 49, 197, 254, 24, 227, 165, 153, 119, 38, 184, 180, 124, 17, 68, 146, 217, 35, 32, 137, 46, 55, 63, 209, 91, 149, 188, 207, 205, 144, 135, 151, 178, 220, 252, 190, 97, 242, 86, 211, 171, 20, 42, 93, 158, 132, 60, 57, 83, 71, 109, 65, 162, 31, 45, 67, 216, 183, 123, 164, 118, 196, 23, 73, 236, 127, 12, 111, 246, 108, 161, 59, 82, 41, 157, 85, 170, 251, 96, 134, 177, 187, 204, 62, 90, 203, 89, 95, 176, 156, 169, 160, 81, 11, 245, 22, 235, 122, 117, 44, 215, 79, 174, 213, 233, 230, 231, 173, 232, 116, 214, 244, 234, 168, 80, 88, 175] });
  G2.exports = je;
});
var D2 = o((m0, U2) => {
  "use strict";
  var ze2 = u5(), Ie2 = ze2.extend(null, { BLOCK: [3220, 1468, 2713, 1235, 3062, 1890, 2119, 1549, 2344, 2936, 1117, 2583, 1330, 2470, 1667, 2249, 2028, 3780, 481, 4011, 142, 3098, 831, 3445, 592, 2517, 1776, 2234, 1951, 2827, 1070, 2660, 1345, 3177] });
  U2.exports = Ie2;
});
var Q2 = o((p0, F2) => {
  "use strict";
  var Pe2 = u5(), Ve = I3(), _3 = V(), l = K(), Ge2 = D2(), c = Pe2.extend(function(t) {
    var e3, i5, r, x, s, a7 = t.value.length;
    for (this._badness = [], this._level = _3.LEVELS[t.level], this._polynomial = [], this._value = t.value, this._version = 0, this._stringBuffer = []; this._version < 40 && (this._version++, r = (this._level - 1) * 4 + (this._version - 1) * 16, x = _3.BLOCKS[r++], s = _3.BLOCKS[r++], e3 = _3.BLOCKS[r++], i5 = _3.BLOCKS[r], r = e3 * (x + s) + s - 3 + (this._version <= 9), !(a7 <= r)); )
      ;
    this._dataBlock = e3, this._eccBlock = i5, this._neccBlock1 = x, this._neccBlock2 = s;
    var n6 = this.width = 17 + 4 * this._version;
    this.buffer = c._createArray(n6 * n6), this._ecc = c._createArray(e3 + (e3 + i5) * (x + s) + s), this._mask = c._createArray((n6 * (n6 + 1) + 1) / 2), this._insertFinders(), this._insertAlignments(), this.buffer[8 + n6 * (n6 - 8)] = 1, this._insertTimingGap(), this._reverseMask(), this._insertTimingRowAndColumn(), this._insertVersion(), this._syncMask(), this._convertBitStream(a7), this._calculatePolynomial(), this._appendEccToData(), this._interleaveBlocks(), this._pack(), this._finish();
  }, { _addAlignment: function(t, e3) {
    var i5, r = this.buffer, x = this.width;
    for (r[t + x * e3] = 1, i5 = -2; i5 < 2; i5++)
      r[t + i5 + x * (e3 - 2)] = 1, r[t - 2 + x * (e3 + i5 + 1)] = 1, r[t + 2 + x * (e3 + i5)] = 1, r[t + i5 + 1 + x * (e3 + 2)] = 1;
    for (i5 = 0; i5 < 2; i5++)
      this._setMask(t - 1, e3 + i5), this._setMask(t + 1, e3 - i5), this._setMask(t - i5, e3 - 1), this._setMask(t + i5, e3 + 1);
  }, _appendData: function(t, e3, i5, r) {
    var x, s, a7, n6 = this._polynomial, f5 = this._stringBuffer;
    for (s = 0; s < r; s++)
      f5[i5 + s] = 0;
    for (s = 0; s < e3; s++) {
      if (x = l.LOG[f5[t + s] ^ f5[i5]], x !== 255)
        for (a7 = 1; a7 < r; a7++)
          f5[i5 + a7 - 1] = f5[i5 + a7] ^ l.EXPONENT[c._modN(x + n6[r - a7])];
      else
        for (a7 = i5; a7 < i5 + r; a7++)
          f5[a7] = f5[a7 + 1];
      f5[i5 + r - 1] = x === 255 ? 0 : l.EXPONENT[c._modN(x + n6[0])];
    }
  }, _appendEccToData: function() {
    var t, e3 = 0, i5 = this._dataBlock, r = this._calculateMaxLength(), x = this._eccBlock;
    for (t = 0; t < this._neccBlock1; t++)
      this._appendData(e3, i5, r, x), e3 += i5, r += x;
    for (t = 0; t < this._neccBlock2; t++)
      this._appendData(e3, i5 + 1, r, x), e3 += i5 + 1, r += x;
  }, _applyMask: function(t) {
    var e3, i5, r, x, s = this.buffer, a7 = this.width;
    switch (t) {
      case 0:
        for (x = 0; x < a7; x++)
          for (r = 0; r < a7; r++)
            !(r + x & 1) && !this._isMasked(r, x) && (s[r + x * a7] ^= 1);
        break;
      case 1:
        for (x = 0; x < a7; x++)
          for (r = 0; r < a7; r++)
            !(x & 1) && !this._isMasked(r, x) && (s[r + x * a7] ^= 1);
        break;
      case 2:
        for (x = 0; x < a7; x++)
          for (e3 = 0, r = 0; r < a7; r++, e3++)
            e3 === 3 && (e3 = 0), !e3 && !this._isMasked(r, x) && (s[r + x * a7] ^= 1);
        break;
      case 3:
        for (i5 = 0, x = 0; x < a7; x++, i5++)
          for (i5 === 3 && (i5 = 0), e3 = i5, r = 0; r < a7; r++, e3++)
            e3 === 3 && (e3 = 0), !e3 && !this._isMasked(r, x) && (s[r + x * a7] ^= 1);
        break;
      case 4:
        for (x = 0; x < a7; x++)
          for (e3 = 0, i5 = x >> 1 & 1, r = 0; r < a7; r++, e3++)
            e3 === 3 && (e3 = 0, i5 = !i5), !i5 && !this._isMasked(r, x) && (s[r + x * a7] ^= 1);
        break;
      case 5:
        for (i5 = 0, x = 0; x < a7; x++, i5++)
          for (i5 === 3 && (i5 = 0), e3 = 0, r = 0; r < a7; r++, e3++)
            e3 === 3 && (e3 = 0), !((r & x & 1) + !(!e3 | !i5)) && !this._isMasked(r, x) && (s[r + x * a7] ^= 1);
        break;
      case 6:
        for (i5 = 0, x = 0; x < a7; x++, i5++)
          for (i5 === 3 && (i5 = 0), e3 = 0, r = 0; r < a7; r++, e3++)
            e3 === 3 && (e3 = 0), !((r & x & 1) + (e3 && e3 === i5) & 1) && !this._isMasked(r, x) && (s[r + x * a7] ^= 1);
        break;
      case 7:
        for (i5 = 0, x = 0; x < a7; x++, i5++)
          for (i5 === 3 && (i5 = 0), e3 = 0, r = 0; r < a7; r++, e3++)
            e3 === 3 && (e3 = 0), !((e3 && e3 === i5) + (r + x & 1) & 1) && !this._isMasked(r, x) && (s[r + x * a7] ^= 1);
        break;
    }
  }, _calculateMaxLength: function() {
    return this._dataBlock * (this._neccBlock1 + this._neccBlock2) + this._neccBlock2;
  }, _calculatePolynomial: function() {
    var t, e3, i5 = this._eccBlock, r = this._polynomial;
    for (r[0] = 1, t = 0; t < i5; t++) {
      for (r[t + 1] = 1, e3 = t; e3 > 0; e3--)
        r[e3] = r[e3] ? r[e3 - 1] ^ l.EXPONENT[c._modN(l.LOG[r[e3]] + t)] : r[e3 - 1];
      r[0] = l.EXPONENT[c._modN(l.LOG[r[0]] + t)];
    }
    for (t = 0; t <= i5; t++)
      r[t] = l.LOG[r[t]];
  }, _checkBadness: function() {
    var t, e3, i5, r, x, s = 0, a7 = this._badness, n6 = this.buffer, f5 = this.width;
    for (x = 0; x < f5 - 1; x++)
      for (r = 0; r < f5 - 1; r++)
        (n6[r + f5 * x] && n6[r + 1 + f5 * x] && n6[r + f5 * (x + 1)] && n6[r + 1 + f5 * (x + 1)] || !(n6[r + f5 * x] || n6[r + 1 + f5 * x] || n6[r + f5 * (x + 1)] || n6[r + 1 + f5 * (x + 1)])) && (s += c.N2);
    var h = 0;
    for (x = 0; x < f5; x++) {
      for (i5 = 0, a7[0] = 0, t = 0, r = 0; r < f5; r++)
        e3 = n6[r + f5 * x], t === e3 ? a7[i5]++ : a7[++i5] = 1, t = e3, h += t ? 1 : -1;
      s += this._getBadness(i5);
    }
    h < 0 && (h = -h);
    var O2 = 0, b2 = h;
    for (b2 += b2 << 2, b2 <<= 1; b2 > f5 * f5; )
      b2 -= f5 * f5, O2++;
    for (s += O2 * c.N4, r = 0; r < f5; r++) {
      for (i5 = 0, a7[0] = 0, t = 0, x = 0; x < f5; x++)
        e3 = n6[r + f5 * x], t === e3 ? a7[i5]++ : a7[++i5] = 1, t = e3;
      s += this._getBadness(i5);
    }
    return s;
  }, _convertBitStream: function(t) {
    var e3, i5, r = this._ecc, x = this._version;
    for (i5 = 0; i5 < t; i5++)
      r[i5] = this._value.charCodeAt(i5);
    var s = this._stringBuffer = r.slice(), a7 = this._calculateMaxLength();
    t >= a7 - 2 && (t = a7 - 2, x > 9 && t--);
    var n6 = t;
    if (x > 9) {
      for (s[n6 + 2] = 0, s[n6 + 3] = 0; n6--; )
        e3 = s[n6], s[n6 + 3] |= 255 & e3 << 4, s[n6 + 2] = e3 >> 4;
      s[2] |= 255 & t << 4, s[1] = t >> 4, s[0] = 64 | t >> 12;
    } else {
      for (s[n6 + 1] = 0, s[n6 + 2] = 0; n6--; )
        e3 = s[n6], s[n6 + 2] |= 255 & e3 << 4, s[n6 + 1] = e3 >> 4;
      s[1] |= 255 & t << 4, s[0] = 64 | t >> 4;
    }
    for (n6 = t + 3 - (x < 10); n6 < a7; )
      s[n6++] = 236, s[n6++] = 17;
  }, _getBadness: function(t) {
    var e3, i5 = 0, r = this._badness;
    for (e3 = 0; e3 <= t; e3++)
      r[e3] >= 5 && (i5 += c.N1 + r[e3] - 5);
    for (e3 = 3; e3 < t - 1; e3 += 2)
      r[e3 - 2] === r[e3 + 2] && r[e3 + 2] === r[e3 - 1] && r[e3 - 1] === r[e3 + 1] && r[e3 - 1] * 3 === r[e3] && (r[e3 - 3] === 0 || e3 + 3 > t || r[e3 - 3] * 3 >= r[e3] * 4 || r[e3 + 3] * 3 >= r[e3] * 4) && (i5 += c.N3);
    return i5;
  }, _finish: function() {
    this._stringBuffer = this.buffer.slice();
    var t, e3, i5 = 0, r = 3e4;
    for (e3 = 0; e3 < 8 && (this._applyMask(e3), t = this._checkBadness(), t < r && (r = t, i5 = e3), i5 !== 7); e3++)
      this.buffer = this._stringBuffer.slice();
    i5 !== e3 && this._applyMask(i5), r = _3.FINAL_FORMAT[i5 + (this._level - 1 << 3)];
    var x = this.buffer, s = this.width;
    for (e3 = 0; e3 < 8; e3++, r >>= 1)
      r & 1 && (x[s - 1 - e3 + s * 8] = 1, e3 < 6 ? x[8 + s * e3] = 1 : x[8 + s * (e3 + 1)] = 1);
    for (e3 = 0; e3 < 7; e3++, r >>= 1)
      r & 1 && (x[8 + s * (s - 7 + e3)] = 1, e3 ? x[6 - e3 + s * 8] = 1 : x[7 + s * 8] = 1);
  }, _interleaveBlocks: function() {
    var t, e3, i5 = this._dataBlock, r = this._ecc, x = this._eccBlock, s = 0, a7 = this._calculateMaxLength(), n6 = this._neccBlock1, f5 = this._neccBlock2, h = this._stringBuffer;
    for (t = 0; t < i5; t++) {
      for (e3 = 0; e3 < n6; e3++)
        r[s++] = h[t + e3 * i5];
      for (e3 = 0; e3 < f5; e3++)
        r[s++] = h[n6 * i5 + t + e3 * (i5 + 1)];
    }
    for (e3 = 0; e3 < f5; e3++)
      r[s++] = h[n6 * i5 + t + e3 * (i5 + 1)];
    for (t = 0; t < x; t++)
      for (e3 = 0; e3 < n6 + f5; e3++)
        r[s++] = h[a7 + t + e3 * x];
    this._stringBuffer = r;
  }, _insertAlignments: function() {
    var t, e3, i5, r = this._version, x = this.width;
    if (r > 1)
      for (t = Ve.BLOCK[r], i5 = x - 7; ; ) {
        for (e3 = x - 7; e3 > t - 3 && (this._addAlignment(e3, i5), !(e3 < t)); )
          e3 -= t;
        if (i5 <= t + 9)
          break;
        i5 -= t, this._addAlignment(6, i5), this._addAlignment(i5, 6);
      }
  }, _insertFinders: function() {
    var t, e3, i5, r, x = this.buffer, s = this.width;
    for (t = 0; t < 3; t++) {
      for (e3 = 0, r = 0, t === 1 && (e3 = s - 7), t === 2 && (r = s - 7), x[r + 3 + s * (e3 + 3)] = 1, i5 = 0; i5 < 6; i5++)
        x[r + i5 + s * e3] = 1, x[r + s * (e3 + i5 + 1)] = 1, x[r + 6 + s * (e3 + i5)] = 1, x[r + i5 + 1 + s * (e3 + 6)] = 1;
      for (i5 = 1; i5 < 5; i5++)
        this._setMask(r + i5, e3 + 1), this._setMask(r + 1, e3 + i5 + 1), this._setMask(r + 5, e3 + i5), this._setMask(r + i5 + 1, e3 + 5);
      for (i5 = 2; i5 < 4; i5++)
        x[r + i5 + s * (e3 + 2)] = 1, x[r + 2 + s * (e3 + i5 + 1)] = 1, x[r + 4 + s * (e3 + i5)] = 1, x[r + i5 + 1 + s * (e3 + 4)] = 1;
    }
  }, _insertTimingGap: function() {
    var t, e3, i5 = this.width;
    for (e3 = 0; e3 < 7; e3++)
      this._setMask(7, e3), this._setMask(i5 - 8, e3), this._setMask(7, e3 + i5 - 7);
    for (t = 0; t < 8; t++)
      this._setMask(t, 7), this._setMask(t + i5 - 8, 7), this._setMask(t, i5 - 8);
  }, _insertTimingRowAndColumn: function() {
    var t, e3 = this.buffer, i5 = this.width;
    for (t = 0; t < i5 - 14; t++)
      t & 1 ? (this._setMask(8 + t, 6), this._setMask(6, 8 + t)) : (e3[8 + t + i5 * 6] = 1, e3[6 + i5 * (8 + t)] = 1);
  }, _insertVersion: function() {
    var t, e3, i5, r, x = this.buffer, s = this._version, a7 = this.width;
    if (s > 6)
      for (t = Ge2.BLOCK[s - 7], e3 = 17, i5 = 0; i5 < 6; i5++)
        for (r = 0; r < 3; r++, e3--)
          1 & (e3 > 11 ? s >> e3 - 12 : t >> e3) ? (x[5 - i5 + a7 * (2 - r + a7 - 11)] = 1, x[2 - r + a7 - 11 + a7 * (5 - i5)] = 1) : (this._setMask(5 - i5, 2 - r + a7 - 11), this._setMask(2 - r + a7 - 11, 5 - i5));
  }, _isMasked: function(t, e3) {
    var i5 = c._getMaskBit(t, e3);
    return this._mask[i5] === 1;
  }, _pack: function() {
    var t, e3, i5, r = 1, x = 1, s = this.width, a7 = s - 1, n6 = s - 1, f5 = (this._dataBlock + this._eccBlock) * (this._neccBlock1 + this._neccBlock2) + this._neccBlock2;
    for (e3 = 0; e3 < f5; e3++)
      for (t = this._stringBuffer[e3], i5 = 0; i5 < 8; i5++, t <<= 1) {
        128 & t && (this.buffer[a7 + s * n6] = 1);
        do
          x ? a7-- : (a7++, r ? n6 !== 0 ? n6-- : (a7 -= 2, r = !r, a7 === 6 && (a7--, n6 = 9)) : n6 !== s - 1 ? n6++ : (a7 -= 2, r = !r, a7 === 6 && (a7--, n6 -= 8))), x = !x;
        while (this._isMasked(a7, n6));
      }
    ...
    for (t = 0; t < 9; t++)
      this._setMask(t, 8);
    for (t = 0; t < 8; t++)
      this._setMask(t + i5 - 8, 8), this._setMask(8, t);
    for (e3 = 0; e3 < 7; e3++)
      this._setMask(8, e3 + i5 - 7);
  }, _setMask: function(t, e3) {
    var i5 = c._getMaskBit(t, e3);
    this._mask[i5] = 1;
  }, _syncMask: function() {
    var t, e3, i5 = this.width;
    for (e3 = 0; e3 < i5; e3++)
      for (t = 0; t <= e3; t++)
        this.buffer[t + i5 * e3] && this._setMask(t, e3);
  } }, { _createArray: function(t) {
    var e3, i5 = [];
    for (e3 = 0; e3 < t; e3++)
      i5[e3] = 0;
    return i5;
  }, _getMaskBit: function(t, e3) {
    var i5;
    return t > e3 && (i5 = t, t = e3, e3 = i5), i5 = e3, i5 += e3 * e3, i5 >>= 1, i5 += t, i5;
  }, _modN: function(t) {
    for (; t >= 255; )
      t -= 255, t = (t >> 8) + (t & 255);
    return t;
...
var H2 = o((k0, X) => {
  "use strict";
  var Ke2 = M(), Ue2 = Ke2.extend({ draw: function() {
...
var J2 = o((g0, W) => {
  "use strict";
  var De2 = u5(), Fe2 = De2.extend(function(t, e3, i5, r) {
    this.name = t, this.modifiable = Boolean(e3), this.defaultValue = i5, this._valueTransformer = r;
  }, { transform: function(t) {
    var e3 = this._valueTransformer;
    return typeof e3 == "function" ? e3(t, this) : t;
  } });
  W.exports = Fe2;
});
var q2 = o((w0, Y) => {
  "use strict";
  var Qe = u5(), Xe2 = Qe.extend(null, { abs: function(t) {
    return t != null ? Math.abs(t) : null;
  }, hasOwn: function(t, e3) {
    return Object.prototype.hasOwnProperty.call(t, e3);
  }, noop: function() {
...
var $2 = o((B0, Z2) => {
  "use strict";
  var He2 = u5(), k = q2(), v = He2.extend(function(t) {
    this.options = {}, t.forEach(function(e3) {
      this.options[e3.name] = e3;
    }, this);
  }, { exists: function(t) {
    return this.options[t] != null;
  }, get: function(t, e3) {
    return v._get(this.options[t], e3);
  }, getAll: function(t) {
    var e3, i5 = this.options, r = {};
    for (e3 in i5)
      k.hasOwn(i5, e3) && (r[e3] = v._get(i5[e3], t));
    return r;
  }, init: function(t, e3, i5) {
    typeof i5 != "function" && (i5 = k.noop);
    var r, x;
    for (r in this.options)
      k.hasOwn(this.options, r) && (x = this.options[r], v._set(x, x.defaultValue, e3), v._createAccessor(x, e3, i5));
    this._setAll(t, e3, true);
  }, set: function(t, e3, i5) {
    return this._set(t, e3, i5);
  }, setAll: function(t, e3) {
    return this._setAll(t, e3);
  }, _set: function(t, e3, i5, r) {
    var x = this.options[t];
    if (!x)
      throw new Error("Invalid option: " + t);
    if (!x.modifiable && !r)
      throw new Error("Option cannot be modified: " + t);
    return v._set(x, e3, i5);
  }, _setAll: function(t, e3, i5) {
    if (!t)
      return false;
    var r, x = false;
    for (r in t)
      k.hasOwn(t, r) && this._set(r, t[r], e3, i5) && (x = true);
    return x;
  } }, { _createAccessor: function(t, e3, i5) {
    var r = { get: function() {
      return v._get(t, e3);
    } };
    t.modifiable && (r.set = function(x) {
      v._set(t, x, e3) && i5(x, t);
    }), Object.defineProperty(e3, t.name, r);
  }, _get: function(t, e3) {
    return e3["_" + t.name];
  }, _set: function(t, e3, i5) {
    var r = "_" + t.name, x = i5[r], s = t.transform(e3 != null ? e3 : t.defaultValue);
    return i5[r] = s, s !== x;
  } });
  Z2.exports = v;
});
var te = o((M0, ee2) => {
  "use strict";
  var We2 = u5(), Je2 = We2.extend(function() {
    this._services = {};
  }, { getService: function(t) {
    var e3 = this._services[t];
    if (!e3)
      throw new Error("Service is not being managed with name: " + t);
    return e3;
  }, setService: function(t, e3) {
    if (this._services[t])
      throw new Error("Service is already managed with name: " + t);
    e3 && (this._services[t] = e3);
  } });
  ee2.exports = Je2;
});
var se2 = o((q0, xe2) => {
  "use strict";
  var Ye2 = u5(), Ze2 = j2(), $e = Q2(), e0 = H2(), d6 = J2(), t0 = $2(), i0 = te(), m5 = q2(), g2 = new t0([new d6("background", true, "white"), new d6("backgroundAlpha", true, 1, m5.abs), new d6("element"), new d6("foreground", true, "black"), new d6("foregroundAlpha", true, 1, m5.abs), new d6("level", true, "L", m5.toUpperCase), new d6("mime", true, "image/png"), new d6("padding", true, null, m5.abs), new d6("size", true, 100, m5.abs), new d6("value", true, "")]), ie2 = new i0(), re = Ye2.extend(function(t) {
    g2.init(t, this, this.update.bind(this));
    var e3 = g2.get("element", this), i5 = ie2.getService("element"), r = e3 && i5.isCanvas(e3) ? e3 : i5.createCanvas(), x = e3 && i5.isImage(e3) ? e3 : i5.createImage();
    this._canvasRenderer = new Ze2(this, r, true), this._imageRenderer = new e0(this, x, x === e3), this.update();
  }, { get: function() {
    return g2.getAll(this);
  }, set: function(t) {
    g2.setAll(t, this) && this.update();
...
var oe = o((N0, fe2) => {
  "use strict";
  var r0 = u5(), x0 = r0.extend({ getName: function() {
  } });
  fe2.exports = x0;
});
var ue2 = o((y0, ce2) => {
...
var le = N2(ne2(), 1);
var he2 = N2(ue2(), 1);
var n0 = he2.default.extend({ createCanvas: function() {
...
//# sourceMappingURL=renderPreviewWindow-QH3LNHT3.mjs.map
