...
import { renderToStaticMarkup } from "https://ga.jspm.io/npm:react-dom@18.0.0-rc.0-next-f2a59df48-20211208/server.browser.js";
var getHtmlAndCss = (MyComponent) => {
  ...
  const markup = renderToStaticMarkup(/* @__PURE__ */ jsx(CacheProvider, {
    value: cache
