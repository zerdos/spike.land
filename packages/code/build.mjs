...
import {
  ...
  raceToSuccess,
  toString
} from "https://unpkg.com/@spike.land/ipfs@0.0.45/dist/ipfs.client.mjs";
...
var init_importmap = __esm({
  "js/importmap.json"() {
    imports = {
      ...
      "react-dom": "https://unpkg.com/@spike.land/esm@0.0.45/dist/react-dom.mjs",
      ...
      "@spike.land/renderer": "https://unpkg.com/@spike.land/renderer@0.0.45/dist/renderer.js",
      ...
      "@spike.land/qrious": "https://unpkg.com/@spike.land/qrious@0.0.45/dist/QRious.mjs",
      tslib: "https://unpkg.com/tslib@2.3.1/tslib.es6.js",
      "@spike.land/smart-monaco-editor": "https://unpkg.com/@spike.land/smart-monaco-editor@0.0.45/dist/editor.mjs",
      "@zedvision/swm": "https://unpkg.com/@zedvision/swm@4.0.0/public/swm-esm.js",
      "uuid/": "https://unpkg.com/uuid@8.3.2/dist/esm-browser/",
      "@spike.land/shadb": "https://unpkg.com/@spike.land/shadb@0.0.45/dist/shaDB.mjs",
      "@spike.land/code": "https://unpkg.com/@spike.land/code@0.0.45/js/reactLoader.mjs",
      comlink: "https://unpkg.com/comlink@4.3.1/dist/esm/comlink.mjs",
      "@spike.land/ipfs": "https://unpkg.com/@spike.land/ipfs@0.0.45/dist/ipfs.client.mjs",
...
import { sha256, shaDB } from "https://unpkg.com/@spike.land/shadb@0.0.45/dist/shaDB.mjs";
...
// js/data.mjs
import { sha256 as sha2562, shaDB as shaDB2 } from "https://unpkg.com/@spike.land/shadb@0.0.45/dist/shaDB.mjs";
...
import { sha256 as sha2563 } from "https://unpkg.com/@spike.land/shadb@0.0.45/dist/shaDB.mjs";
async function sendSignalToQrCode(session) {
  ...
  const { sendSignal } = await import("https://unpkg.com/@spike.land/ipfs@0.0.45/dist/ipfs.client.mjs");
...
async function renderPreviewWindow(session) {
  const {
    ...
    jsx: jsx3,
    render: render2
  } = await import("https://unpkg.com/@spike.land/renderer@0.0.45/dist/renderer.js");
  const onShare = async () => {
    const { shareItAsHtml: shareItAsHtml2 } = await Promise.resolve().then(() => (init_share(), share_exports));
...
init_ipfsClient();
init_data();
import React from "https://unpkg.com/@spike.land/esm@0.0.45/dist/react.mjs";
import startMonaco from "https://unpkg.com/@spike.land/smart-monaco-editor@0.0.45/dist/editor.mjs";
import { jsx } from "https://unpkg.com/@emotion/react@11.5.0/dist/emotion-react.browser.esm.js";
import { DraggableWindow, jsx as jsx2, render } from "https://unpkg.com/@spike.land/renderer@0.0.45/dist/renderer.js";
function getSession() {
  const session = {
    i: 0,
    unmount: () => {
