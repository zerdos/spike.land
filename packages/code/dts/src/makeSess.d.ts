...
export { aPatch };
export declare function applyCodePatch(sess: ICodeSession, mess: CodePatch): ICodeSession;
...
export declare const createPatch: (oldSess: ICodeSession, newSess: ICodeSession) => CodePatch;
