...
const RainbowContainer = ({ children }) => (_jsxs("div", {
  css: css`
      height: 100%;
      width: 100%;
    `,
...
export const AppToRender = ({ codeSpace }) => {
  ...
  return (_jsxs(_Fragment, {
    children: [
      !onlyEdit
      && (_jsx(DraggableWindow, {
        codeSpace: codeSpace,
        children: _jsx("iframe", { css: css`height: 100%; width: 100%; border: 0;`, src: `/live/${codeSpace}/` }),
      })),
      !hideRest
      && (_jsx(RainbowContainer, {
        children: _jsx(Suspense, { fallback: _jsx(_Fragment, {}), children: _jsx(Editor, { codeSpace: codeSpace }) }),
      })),
    ],
  }));
};
