...
function handleAppError(error, hash) {
    ...
    return () => (_jsxs("div", { css: css `background-color: orange;`, children: [_jsx("h1", { children: errorMessage }), _jsx("h2", { children: hash }), _jsx("p", { children: JSON.stringify({ err: error }) })] }));
}
