  ...
  return (_jsx(motion.div, {
    ...
    children: _jsx(Resizable, {
      ...
      children: _jsxs("div", {
        ...
        children: [
          _jsxs("div", {
            className: "p-2 bg-purple-900 text-white flex justify-between items-center",
            children: [
          ...
          _jsx("div", { className: "flex-grow overflow-hidden", children: _jsx(ChatInterface, {}) }),
        ],
      }),
    }),
  }));
