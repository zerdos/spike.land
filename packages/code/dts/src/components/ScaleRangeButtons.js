...
export const ScaleRangeButtons = ({ scaleRange, setScaleRange, sizes, maxScaleRange, }) => {
    return (_jsx(motion.div, { layout: true, css: css `
      ...
      `, initial: { height: 0, width: 0 }, animate: { height: 42, width: "100%" }, children: _jsx(ToggleButtonGroup, { value: scaleRange, size: "small", exclusive: true, onChange: (_e, newScale) => {
                if (newScale !== null)
                ...
                .sort((a, b) => a - b)
                .map((size) => (_jsx(ToggleButton, { value: size, children: _jsxs("span", { css: css `
