...
export default function ParentSize({ className, children, debounceTime = 300, ignoreDimensions = defaultIgnoreDimensions, parentSizeStyles = defaultParentSizeStyles, enableDebounceLeadingCall = true, ...restProps }) {
    ...
    return (_jsx("div", { style: parentSizeStyles, ref: target, className: className, ...restProps, children: children({
            ...state,
            ref: target.current,
            resize,
        }) }));
