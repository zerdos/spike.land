...
export type IUser = Record<IUserJSON & {
    room: string;
...
export declare const syncStorage: (setItem: SetItem<Partial<CodePatch | ICodeSession> | number | string>, getItem: GetItem<Partial<CodePatch | ICodeSession> | number | string>, oldSession: Partial<CodePatch & ICodeSession>, newSession: Partial<CodePatch | ICodeSession>, message: CodePatch) => Promise<void>;
