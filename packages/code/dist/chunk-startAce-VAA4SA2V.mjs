...
// ../../.yarn/global/cache/ace-builds-npm-1.13.2-17c6f7ff6b-9.zip/node_modules/ace-builds/src-noconflict/ace.js
var require_ace = __commonJS({
  "../../.yarn/global/cache/ace-builds-npm-1.13.2-17c6f7ff6b-9.zip/node_modules/ace-builds/src-noconflict/ace.js"(exports, module) {
    init_define_process();
    (function() {
      ...
      if (!ACE_NAMESPACE && typeof requirejs !== "undefined")
        return;
      var define2 = /* @__PURE__ */ __name(function(module2, deps, payload) {
      ...
      define2.modules = {};
      define2.payloads = {};
      var _require = /* @__PURE__ */ __name(function(parentId, module2, callback) {
        if (typeof module2 === "string") {
      ...
      var require2 = /* @__PURE__ */ __name(function(module2, callback) {
      ...
      var normalizeModule = /* @__PURE__ */ __name(function(parentId, moduleName) {
      ...
      var lookup = /* @__PURE__ */ __name(function(parentId, moduleName) {
        ...
        if (!module2) {
          ...
          if (typeof module2 === "function") {
            ...
            var req = /* @__PURE__ */ __name(function(module3, callback) {
              return _require(moduleName, module3, callback);
            }, "req");
            var returnValue = module2(req, exports2, mod2);
            exports2 = returnValue || mod2.exports;
    ...
    ace.define("ace/lib/lang", ["require", "exports", "module"], function(require2, exports2, module2) {
      ...
      exports2.deepCopy = /* @__PURE__ */ __name(function deepCopy(obj) {
      ...
      exports2.deferredCall = function(fcn) {
        ...
        var deferred = /* @__PURE__ */ __name(function(timeout) {
          deferred.cancel();
      ...
      exports2.delayedCall = function(fcn, defaultTimeout) {
        ...
        var _self = /* @__PURE__ */ __name(function(timeout) {
          if (timer == null)
    ...
    ace.define("ace/lib/dom", ["require", "exports", "module", "ace/lib/useragent"], function(require2, exports2, module2) {
      ...
      exports2.buildDom = /* @__PURE__ */ __name(function buildDom(arr, parent, refs) {
      ...
      __name(insertPendingStyles, "insertPendingStyles");
      ...
      __name(importCssString, "importCssString");
    ...
    ace.define("ace/lib/event_emitter", ["require", "exports", "module"], function(require2, exports2, module2) {
      ...
      EventEmitter.once = function(eventName, callback) {
        var _self = this;
        this.on(eventName, /* @__PURE__ */ __name(function newCallback() {
    ...
    ace.define("ace/lib/app_config", ["require", "exports", "module", "ace/lib/oop", "ace/lib/event_emitter"], function(require2, exports2, module2) {
      ...
      var AppConfig = /* @__PURE__ */ __name(function() {
        this.$defaultOptions = {};
      }, "AppConfig");
      (function() {
    ...
    ace.define("ace/config", ["require", "exports", "module", "ace/lib/lang", "ace/lib/oop", "ace/lib/net", "ace/lib/dom", "ace/lib/app_config", "ace/theme/textmate"], function(require2, exports2, module2) {
      ...
      var loader = /* @__PURE__ */ __name(function(moduleName, cb) {
      ...
      exports2.loadModule = function(moduleName, onLoad) {
        ...
        if (exports2.$loading[moduleName].length > 1)
          return;
        var afterLoad = /* @__PURE__ */ __name(function() {
      ...
      var reportErrorIfPathIsNotConfigured = /* @__PURE__ */ __name(function() {
        if (!options.basePath && !options.workerPath && !options.modePath && !options.themePath && !Object.keys(options.$moduleUrls).length) {
          ...
          reportErrorIfPathIsNotConfigured = /* @__PURE__ */ __name(function() {
          }, "reportErrorIfPathIsNotConfigured");
        }
      }, "reportErrorIfPathIsNotConfigured");
      exports2.version = "1.13.2";
    });
    ace.define("ace/loader_build", ["require", "exports", "module", "ace/lib/fixoldbrowsers", "ace/config"], function(require2, exports2, module2) {
      ...
      __name(deHyphenate, "deHyphenate");
    });
    ...
    ace.define("ace/lib/event", ["require", "exports", "module", "ace/lib/keys", "ace/lib/useragent"], function(require2, exports2, module2) {
      ...
      __name(detectListenerOptionsSupport, "detectListenerOptionsSupport");
      function getListenerOptions() {
        if (activeListenerOptions == void 0)
          detectListenerOptionsSupport();
        return activeListenerOptions;
      }
      __name(getListenerOptions, "getListenerOptions");
      ...
      var getModifierHash = /* @__PURE__ */ __name(function(e) {
      ...
      __name(normalizeCommandKeys, "normalizeCommandKeys");
      ...
      __name(resetPressedKeys, "resetPressedKeys");
      ...
      exports2.onIdle = function(cb, timeout) {
        return setTimeout(/* @__PURE__ */ __name(function handler() {
    ...
    ace.define("ace/range", ["require", "exports", "module"], function(require2, exports2, module2) {
      "use strict";
      var comparePoints = /* @__PURE__ */ __name(function(p1, p2) {
        return p1.row - p2.row || p1.column - p2.column;
      }, "comparePoints");
      var Range = /* @__PURE__ */ __name(function(startRow, startColumn, endRow, endColumn) {
        this.start = {
          row: startRow,
          column: startColumn
        };
    ...
    ace.define("ace/keyboard/textinput", ["require", "exports", "module", "ace/lib/event", "ace/lib/useragent", "ace/lib/dom", "ace/lib/lang", "ace/clipboard", "ace/lib/keys"], function(require2, exports2, module2) {
      ...
      var TextInput = /* @__PURE__ */ __name(function(parentNode, host) {
        ...
        if (isFocused)
          host.onFocus();
        var isAllSelected = /* @__PURE__ */ __name(function(text2) {
        ...
        var onSelect = /* @__PURE__ */ __name(function(e) {
          if (inComposition)
            return;
          if (copied) {
            copied = false;
        ...
        var sendText = /* @__PURE__ */ __name(function(value, fromInput) {
          if (afterContextMenu)
        ...
        var onInput = /* @__PURE__ */ __name(function(e) {
          if (inComposition)
        ...
        var handleClipboardData = /* @__PURE__ */ __name(function(e, data, forceIEMime) {
        ...
        var doCopy = /* @__PURE__ */ __name(function(e, isCut) {
        ...
        var onCut = /* @__PURE__ */ __name(function(e) {
          doCopy(e, true);
        }, "onCut");
        var onCopy = /* @__PURE__ */ __name(function(e) {
          doCopy(e, false);
        }, "onCopy");
        var onPaste = /* @__PURE__ */ __name(function(e) {
        ...
        var onCompositionStart = /* @__PURE__ */ __name(function(e) {
        ...
        var onCompositionUpdate = /* @__PURE__ */ __name(function() {
        ...
        var onCompositionEnd = /* @__PURE__ */ __name(function(e) {
        ...
        __name(cancelComposition, "cancelComposition");
        ...
        this.moveToMouse = function(e, bringToFront) {
          ...
          var move = /* @__PURE__ */ __name(function(e2) {
        ...
        __name(onContextMenuClose, "onContextMenuClose");
        var onContextMenu = /* @__PURE__ */ __name(function(e) {
        ...
        function addIosSelectionHandler(parentNode2, host2, text2) {
          ...
          var detectArrowKeys = /* @__PURE__ */ __name(function(e) {
        ...
        __name(addIosSelectionHandler, "addIosSelectionHandler");
    ...
    ace.define("ace/mouse/default_handlers", ["require", "exports", "module", "ace/lib/useragent"], function(require2, exports2, module2) {
      ...
      __name(DefaultHandlers, "DefaultHandlers");
      (function() {
      ...
      __name(calcRangeOrientation, "calcRangeOrientation");
    });
    ...
    ace.define("ace/mouse/default_gutter_handler", ["require", "exports", "module", "ace/lib/dom", "ace/lib/oop", "ace/lib/event", "ace/tooltip"], function(require2, exports2, module2) {
      ...
      function GutterHandler(mouseHandler) {
        ...
        __name(moveTooltip, "moveTooltip");
      ...
      __name(GutterHandler, "GutterHandler");
      function GutterTooltip(parentNode) {
        Tooltip.call(this, parentNode);
      }
      __name(GutterTooltip, "GutterTooltip");
    ...
    ace.define("ace/mouse/dragdrop_handler", ["require", "exports", "module", "ace/lib/dom", "ace/lib/event", "ace/lib/useragent"], function(require2, exports2, module2) {
      ...
      function DragdropHandler(mouseHandler) {
        ...
        __name(scrollCursorIntoView, "scrollCursorIntoView");
        ...
        __name(onDragInterval, "onDragInterval");
        ...
        __name(addDragMarker, "addDragMarker");
        ...
        __name(clearDragMarker, "clearDragMarker");
        ...
        __name(getDropEffect, "getDropEffect");
      }
      __name(DragdropHandler, "DragdropHandler");
      (function() {
    ...
    ace.define("ace/mouse/touch_handler", ["require", "exports", "module", "ace/mouse/mouse_event", "ace/lib/event", "ace/lib/dom"], function(require2, exports2, module2) {
      ...
      exports2.addTouchListeners = function(el, editor) {
        ...
        function createContextMenu() {
          ...
          var isOpen = false;
          var updateMenu = /* @__PURE__ */ __name(function() {
        ...
        __name(hideContextMenu, "hideContextMenu");
        ...
        __name(handleLongTap, "handleLongTap");
        ...
        __name(switchToSelectionMode, "switchToSelectionMode");
        ...
        event.addListener(el, "touchstart", function(e) {
          ...
          if (t - touchStartT < 500 && touches.length == 1 && !animationSteps) {
            ...
            var weightedDistance = /* @__PURE__ */ __name(function(x2, y2) {
              x2 = x2 / w;
              y2 = y2 / h - 0.75;
              return x2 * x2 + y2 * y2;
            }, "weightedDistance");
    ...
    ace.define("ace/mouse/mouse_handler", ["require", "exports", "module", "ace/lib/event", "ace/lib/useragent", "ace/mouse/default_handlers", "ace/mouse/default_gutter_handler", "ace/mouse/mouse_event", "ace/mouse/dragdrop_handler", "ace/mouse/touch_handler", "ace/config"], function(require2, exports2, module2) {
      ...
      var config = require2("../config");
      var MouseHandler = /* @__PURE__ */ __name(function(editor) {
        var _self = this;
        this.editor = editor;
        new DefaultHandlers(this);
        new DefaultGutterHandler(this);
        new DragdropHandler(this);
        var focusEditor = /* @__PURE__ */ __name(function(e) {
      ...
      (function() {
        ...
        this.captureMouse = function(ev, mouseMoveHandler) {
          ...
          var self = this;
          var onMouseMove = /* @__PURE__ */ __name(function(e) {
            if (!e)
              return;
          ...
          var onCaptureEnd = /* @__PURE__ */ __name(function(e) {
          ...
          var onCaptureInterval = /* @__PURE__ */ __name(function() {
          ...
          var onOperationEnd = /* @__PURE__ */ __name(function(e) {
    ...
    ace.define("ace/mouse/fold_handler", ["require", "exports", "module", "ace/lib/dom"], function(require2, exports2, module2) {
      ...
      __name(FoldHandler, "FoldHandler");
    ...
    ace.define("ace/keyboard/keybinding", ["require", "exports", "module", "ace/lib/keys", "ace/lib/event"], function(require2, exports2, module2) {
      ...
      var event = require2("../lib/event");
      var KeyBinding = /* @__PURE__ */ __name(function(editor) {
        this.$editor = editor;
        this.$data = { editor };
        this.$handlers = [];
    ...
    ace.define("ace/lib/bidiutil", ["require", "exports", "module"], function(require2, exports2, module2) {
      ...
      __name(_computeLevels, "_computeLevels");
      ...
      __name(_invertLevel, "_invertLevel");
      ...
      __name(_getCharClass, "_getCharClass");
      ...
      __name(_getCharacterType, "_getCharacterType");
      function _isArabicDiacritics(ch) {
        return ch >= "\u064B" && ch <= "\u0655";
      }
      __name(_isArabicDiacritics, "_isArabicDiacritics");
      exports2.L = L;
      exports2.R = R;
      exports2.EN = EN;
      exports2.ON_R = 3;
    ...
    ace.define("ace/bidihandler", ["require", "exports", "module", "ace/lib/bidiutil", "ace/lib/lang"], function(require2, exports2, module2) {
      ...
      var lang = require2("./lib/lang");
      var bidiRE = /[\u0590-\u05f4\u0600-\u06ff\u0700-\u08ac\u202B]/;
      var BidiHandler = /* @__PURE__ */ __name(function(session) {
    ...
    ace.define("ace/selection", ["require", "exports", "module", "ace/lib/oop", "ace/lib/lang", "ace/lib/event_emitter", "ace/range"], function(require2, exports2, module2) {
      ...
      var Selection = /* @__PURE__ */ __name(function(session) {
        this.session = session;
    ...
    ace.define("ace/tokenizer", ["require", "exports", "module", "ace/config"], function(require2, exports2, module2) {
      ...
      var Tokenizer = /* @__PURE__ */ __name(function(rules) {
        this.states = rules;
        this.regExps = {};
        this.matchMappings = {};
    ...
    ace.define("ace/mode/text_highlight_rules", ["require", "exports", "module", "ace/lib/lang"], function(require2, exports2, module2) {
      "use strict";
      var lang = require2("../lib/lang");
      var TextHighlightRules = /* @__PURE__ */ __name(function() {
        this.$rules = {
          "start": [{
            token: "empty_line",
            regex: "^$"
      ...
      (function() {
        ...
        var pushState = /* @__PURE__ */ __name(function(currentState, stack) {
          if (currentState != "start" || stack.length)
            stack.unshift(this.nextState, currentState);
          return this.nextState;
        }, "pushState");
        var popState = /* @__PURE__ */ __name(function(currentState, stack) {
          stack.shift();
    ...
    ace.define("ace/mode/behaviour", ["require", "exports", "module"], function(require2, exports2, module2) {
      "use strict";
      var Behaviour = /* @__PURE__ */ __name(function() {
        this.$behaviours = {};
      }, "Behaviour");
      (function() {
    ...
    ace.define("ace/token_iterator", ["require", "exports", "module", "ace/range"], function(require2, exports2, module2) {
      "use strict";
      var Range = require2("./range").Range;
      var TokenIterator = /* @__PURE__ */ __name(function(session, initialRow, initialColumn) {
        this.$session = session;
        this.$row = initialRow;
    ...
    ace.define("ace/mode/behaviour/cstyle", ["require", "exports", "module", "ace/lib/oop", "ace/mode/behaviour", "ace/token_iterator", "ace/lib/lang"], function(require2, exports2, module2) {
      ...
      var contextCache = {};
      var defaultQuotes = { '"': '"', "'": "'" };
      var initContext = /* @__PURE__ */ __name(function(editor) {
        var id = -1;
      ...
      var getWrapped = /* @__PURE__ */ __name(function(selection, selected, opening, closing) {
      ...
      var CstyleBehaviour = /* @__PURE__ */ __name(function(options) {
    ...
    ace.define("ace/mode/text", ["require", "exports", "module", "ace/config", "ace/tokenizer", "ace/mode/text_highlight_rules", "ace/mode/behaviour/cstyle", "ace/unicode", "ace/lib/lang", "ace/token_iterator", "ace/range"], function(require2, exports2, module2) {
      ...
      var TokenIterator = require2("../token_iterator").TokenIterator;
      var Range = require2("../range").Range;
      var Mode = /* @__PURE__ */ __name(function() {
      ...
      (function() {
        ...
        this.toggleCommentLines = function(state, session, startRow, endRow) {
          ...
          if (!this.lineCommentStart) {
            ...
            var comment = /* @__PURE__ */ __name(function(line, i) {
            ...
            var uncomment = /* @__PURE__ */ __name(function(line, i) {
              var m;
            ...
            var testRemove = /* @__PURE__ */ __name(function(line, row) {
            ...
            var testRemove = /* @__PURE__ */ __name(function(line, i) {
              return regexpStart.test(line);
            }, "testRemove");
            var shouldInsertSpace = /* @__PURE__ */ __name(function(line, before, after) {
              var spaces = 0;
    ...
    ace.define("ace/apply_delta", ["require", "exports", "module"], function(require2, exports2, module2) {
      ...
      __name(throwDeltaError, "throwDeltaError");
      ...
      __name(positionInDocument, "positionInDocument");
      ...
      __name(validateDelta, "validateDelta");
    ...
    ace.define("ace/anchor", ["require", "exports", "module", "ace/lib/oop", "ace/lib/event_emitter"], function(require2, exports2, module2) {
      ...
      (function() {
        ...
        __name($pointsInOrder, "$pointsInOrder");
        ...
        __name($getTransformedPoint, "$getTransformedPoint");
    ...
    ace.define("ace/document", ["require", "exports", "module", "ace/lib/oop", "ace/apply_delta", "ace/lib/event_emitter", "ace/range", "ace/anchor"], function(require2, exports2, module2) {
      ...
      var Document = /* @__PURE__ */ __name(function(textOrLines) {
        this.$lines = [""];
    ...
    ace.define("ace/background_tokenizer", ["require", "exports", "module", "ace/lib/oop", "ace/lib/event_emitter"], function(require2, exports2, module2) {
      ...
      var oop = require2("./lib/oop");
      var EventEmitter = require2("./lib/event_emitter").EventEmitter;
      var BackgroundTokenizer = /* @__PURE__ */ __name(function(tokenizer, editor) {
        this.running = false;
        this.lines = [];
        this.states = [];
        this.currentLine = 0;
    ...
    ace.define("ace/search_highlight", ["require", "exports", "module", "ace/lib/lang", "ace/lib/oop", "ace/range"], function(require2, exports2, module2) {
      ...
      var oop = require2("./lib/oop");
      var Range = require2("./range").Range;
      var SearchHighlight = /* @__PURE__ */ __name(function(regExp, clazz, type) {
    ...
    ace.define("ace/range_list", ["require", "exports", "module", "ace/range"], function(require2, exports2, module2) {
      ...
      var RangeList = /* @__PURE__ */ __name(function() {
        this.ranges = [];
        this.$bias = 1;
      }, "RangeList");
      (function() {
    ...
    ace.define("ace/edit_session/fold", ["require", "exports", "module", "ace/range_list", "ace/lib/oop"], function(require2, exports2, module2) {
      ...
      __name(consumePoint, "consumePoint");
      function consumeRange(range, anchor) {
        consumePoint(range.start, anchor);
        consumePoint(range.end, anchor);
      }
      __name(consumeRange, "consumeRange");
      function restorePoint(point, anchor) {
        if (point.row == 0)
          point.column += anchor.column;
        point.row += anchor.row;
      }
      __name(restorePoint, "restorePoint");
      function restoreRange(range, anchor) {
        restorePoint(range.start, anchor);
        restorePoint(range.end, anchor);
      }
      __name(restoreRange, "restoreRange");
    });
    ...
    ace.define("ace/edit_session/bracket_match", ["require", "exports", "module", "ace/token_iterator", "ace/range"], function(require2, exports2, module2) {
      ...
      __name(BracketMatch, "BracketMatch");
    ...
    ace.define("ace/edit_session", ["require", "exports", "module", "ace/lib/oop", "ace/lib/lang", "ace/bidihandler", "ace/config", "ace/lib/event_emitter", "ace/selection", "ace/mode/text", "ace/range", "ace/document", "ace/background_tokenizer", "ace/search_highlight", "ace/edit_session/folding", "ace/edit_session/bracket_match"], function(require2, exports2, module2) {
      ...
      var EditSession = /* @__PURE__ */ __name(function(text, mode) {
        this.$breakpoints = [];
        this.$decorations = [];
        this.$frontMarkers = {};
        this.$backMarkers = {};
      ...
      (function() {
        ...
        this.$computeWrapSplits = function(tokens, wrapLimit, tabSize) {
          ...
          __name(getWrapIndent, "getWrapIndent");
    ...
    ace.define("ace/search", ["require", "exports", "module", "ace/lib/lang", "ace/lib/oop", "ace/range"], function(require2, exports2, module2) {
      ...
      var oop = require2("./lib/oop");
      var Range = require2("./range").Range;
      var Search = /* @__PURE__ */ __name(function() {
        this.$options = {};
      }, "Search");
      (function() {
        ...
        this.$matchIterator = function(session, options) {
          ...
          if (backwards) {
            var forEach = /* @__PURE__ */ __name(function(callback) {
              var row = start.row;
          ...
          if (options.$isMultiLine) {
            var len = re.length;
            var forEachInLine = /* @__PURE__ */ __name(function(row, offset, callback) {
            ...
            var forEachInLine = /* @__PURE__ */ __name(function(row, endIndex, callback) {
            ...
            var forEachInLine = /* @__PURE__ */ __name(function(row, startIndex, callback) {
              var line = session.getLine(row);
              var last;
              var m;
    ...
    ace.define("ace/keyboard/hash_handler", ["require", "exports", "module", "ace/lib/keys", "ace/lib/useragent"], function(require2, exports2, module2) {
      ...
      __name(HashHandler, "HashHandler");
      function MultiHashHandler(config, platform) {
        HashHandler.call(this, config, platform);
        this.$singleCommand = false;
      }
      __name(MultiHashHandler, "MultiHashHandler");
      ...
      (function() {
        ...
        this.findKeyCommand = /* @__PURE__ */ __name(function findKeyCommand(hashId, keyString) {
    ...
    ace.define("ace/commands/command_manager", ["require", "exports", "module", "ace/lib/oop", "ace/keyboard/hash_handler", "ace/lib/event_emitter"], function(require2, exports2, module2) {
      ...
      var EventEmitter = require2("../lib/event_emitter").EventEmitter;
      var CommandManager = /* @__PURE__ */ __name(function(platform, commands) {
    ...
    ace.define("ace/editor", ["require", "exports", "module", "ace/lib/oop", "ace/lib/dom", "ace/lib/lang", "ace/lib/useragent", "ace/keyboard/textinput", "ace/mouse/mouse_handler", "ace/mouse/fold_handler", "ace/keyboard/keybinding", "ace/edit_session", "ace/search", "ace/range", "ace/lib/event_emitter", "ace/commands/command_manager", "ace/commands/default_commands", "ace/config", "ace/token_iterator", "ace/clipboard"], function(require2, exports2, module2) {
      ...
      var TokenIterator = require2("./token_iterator").TokenIterator;
      var clipboard = require2("./clipboard");
      var Editor = /* @__PURE__ */ __name(function(renderer, session, options) {
        this.$toDestroy = [];
    ...
    ace.define("ace/undomanager", ["require", "exports", "module", "ace/range"], function(require2, exports2, module2) {
      "use strict";
      var UndoManager = /* @__PURE__ */ __name(function() {
        this.$maxRev = 0;
        this.$fromUndo = false;
      ...
      __name(rearrangeUndoStack, "rearrangeUndoStack");
      var Range = require2("./range").Range;
      ...
      __name($updateMarkers, "$updateMarkers");
      function clonePos(pos) {
        return { row: pos.row, column: pos.column };
      }
      __name(clonePos, "clonePos");
      ...
      __name(stringifyDelta, "stringifyDelta");
      function stringifyRange(r) {
        return r.start.row + ":" + r.start.column + "=>" + r.end.row + ":" + r.end.column;
      }
      __name(stringifyRange, "stringifyRange");
      function swap(d1, d2) {
      ...
      __name(moveDeltasByOne, "moveDeltasByOne");
      ...
      __name(rebaseRedoStack, "rebaseRedoStack");
    ...
    ace.define("ace/layer/lines", ["require", "exports", "module", "ace/lib/dom"], function(require2, exports2, module2) {
      "use strict";
      var dom = require2("../lib/dom");
      var Lines = /* @__PURE__ */ __name(function(element, canvasHeight) {
    ...
    ace.define("ace/layer/gutter", ["require", "exports", "module", "ace/lib/dom", "ace/lib/oop", "ace/lib/lang", "ace/lib/event_emitter", "ace/layer/lines"], function(require2, exports2, module2) {
      ...
      var Gutter = /* @__PURE__ */ __name(function(parentEl) {
        this.element = dom.createElement("div");
      ...
      __name(onCreateCell, "onCreateCell");
    ...
    ace.define("ace/layer/marker", ["require", "exports", "module", "ace/range", "ace/lib/dom"], function(require2, exports2, module2) {
      ...
      var Range = require2("../range").Range;
      var dom = require2("../lib/dom");
      var Marker = /* @__PURE__ */ __name(function(parentEl) {
        this.element = dom.createElement("div");
      ...
      (function() {
        ...
        __name(getBorderClass, "getBorderClass");
    ...
    ace.define("ace/layer/text", ["require", "exports", "module", "ace/lib/oop", "ace/lib/dom", "ace/lib/lang", "ace/layer/lines", "ace/lib/event_emitter"], function(require2, exports2, module2) {
      ...
      var Lines = require2("./lines").Lines;
      var EventEmitter = require2("../lib/event_emitter").EventEmitter;
      var Text = /* @__PURE__ */ __name(function(parentEl) {
        this.dom = dom;
    ...
    ace.define("ace/layer/cursor", ["require", "exports", "module", "ace/lib/dom"], function(require2, exports2, module2) {
      "use strict";
      var dom = require2("../lib/dom");
      var Cursor = /* @__PURE__ */ __name(function(parentEl) {
        this.element = dom.createElement("div");
    ...
    ace.define("ace/scrollbar", ["require", "exports", "module", "ace/lib/oop", "ace/lib/dom", "ace/lib/event", "ace/lib/event_emitter"], function(require2, exports2, module2) {
      ...
      var ScrollBar = /* @__PURE__ */ __name(function(parent) {
        this.element = dom.createElement("div");
      ...
      var VScrollBar = /* @__PURE__ */ __name(function(parent, renderer) {
      ...
      var HScrollBar = /* @__PURE__ */ __name(function(parent, renderer) {
        ScrollBar.call(this, parent);
        this.scrollLeft = 0;
      ...
      (function() {
        ...
        this.onMouseDown = function(eType, e) {
          ...
          if (e.target === this.inner) {
            ...
            var onMouseMove = /* @__PURE__ */ __name(function(e2) {
            ...
            var onScrollInterval = /* @__PURE__ */ __name(function() {
    ...
    ace.define("ace/renderloop", ["require", "exports", "module", "ace/lib/event"], function(require2, exports2, module2) {
      "use strict";
      var event = require2("./lib/event");
      var RenderLoop = /* @__PURE__ */ __name(function(onRender, win) {
    ...
    ace.define("ace/layer/font_metrics", ["require", "exports", "module", "ace/lib/oop", "ace/lib/dom", "ace/lib/lang", "ace/lib/event", "ace/lib/useragent", "ace/lib/event_emitter"], function(require2, exports2, module2) {
      ...
      (function() {
        ...
        this.$pollSizeChanges = function() {
          ...
          var self = this;
          return this.$pollSizeChangesTimer = event.onIdle(/* @__PURE__ */ __name(function cb() {
            self.checkForSizeChanges();
            event.onIdle(cb, 500);
          }, "cb"), 500);
        };
        ...
        this.$getZoom = /* @__PURE__ */ __name(function getZoom(element) {
          if (!element || !element.parentElement)
            return 1;
          return (window.getComputedStyle(element).zoom || 1) * getZoom(element.parentElement);
        }, "getZoom");
        this.$initTransformMeasureNodes = function() {
          var t = /* @__PURE__ */ __name(function(t2, l) {
            return ["div", {
...
.ace_placeholder {
    ...
    ace.define("ace/layer/decorators", ["require", "exports", "module", "ace/lib/dom", "ace/lib/oop", "ace/lib/event_emitter"], function(require2, exports2, module2) {
      ...
      var oop = require2("../lib/oop");
      var EventEmitter = require2("../lib/event_emitter").EventEmitter;
      var Decorator = /* @__PURE__ */ __name(function(parent, renderer) {
    ...
    ace.define("ace/virtual_renderer", ["require", "exports", "module", "ace/lib/oop", "ace/lib/dom", "ace/config", "ace/layer/gutter", "ace/layer/marker", "ace/layer/text", "ace/layer/cursor", "ace/scrollbar", "ace/scrollbar", "ace/scrollbar_custom", "ace/scrollbar_custom", "ace/renderloop", "ace/layer/font_metrics", "ace/lib/event_emitter", "ace/css/editor.css", "ace/layer/decorators", "ace/lib/useragent"], function(require2, exports2, module2) {
      ...
      var VirtualRenderer = /* @__PURE__ */ __name(function(container, theme) {
        var _self = this;
      ...
      (function() {
        ...
        this.$calcSteps = function(fromValue, toValue) {
          ...
          var l = this.STEPS;
          var steps = [];
          var func = /* @__PURE__ */ __name(function(t, x_min, dx) {
    ...
    ace.define("ace/worker/worker_client", ["require", "exports", "module", "ace/lib/oop", "ace/lib/net", "ace/lib/event_emitter", "ace/config"], function(require2, exports2, module2) {
      ...
      var WorkerClient = /* @__PURE__ */ __name(function(worker) {
      ...
      (function() {
        oop.implement(this, EventEmitter);
        this.$createWorkerFromOldConfig = function(topLevelNamespaces, mod2, classname, workerUrl, importScripts) {
          if (require2.nameToUrl && !require2.toUrl)
            require2.toUrl = require2.nameToUrl;
          if (config.get("packaged") || !require2.toUrl) {
            workerUrl = workerUrl || config.moduleUrl(mod2, "worker");
          } else {
      ...
      var UIWorkerClient = /* @__PURE__ */ __name(function(topLevelNamespaces, mod2, classname) {
        var main = null;
        var emitSync = false;
        ...
        var processNext = /* @__PURE__ */ __name(function() {
        ...
        config.loadModule(["worker", mod2], function(Main) {
    ...
    ace.define("ace/placeholder", ["require", "exports", "module", "ace/range", "ace/lib/event_emitter", "ace/lib/oop"], function(require2, exports2, module2) {
      ...
      var EventEmitter = require2("./lib/event_emitter").EventEmitter;
      var oop = require2("./lib/oop");
      var PlaceHolder = /* @__PURE__ */ __name(function(session, length, pos, others, mainClass, othersClass) {
        var _self = this;
        this.length = length;
        this.session = session;
        this.doc = session.getDocument();
      ...
      (function() {
        ...
        this.updateMarkers = function() {
          ...
          var _self = this;
          var session = this.session;
          var updateMarker = /* @__PURE__ */ __name(function(pos, className) {
    ...
    ace.define("ace/mouse/multi_select_handler", ["require", "exports", "module", "ace/lib/event", "ace/lib/useragent"], function(require2, exports2, module2) {
      ...
      __name(isSamePoint, "isSamePoint");
      function onMouseDown(e) {
        var ev = e.domEvent;
        var alt = ev.altKey;
        ...
        var onMouseSelection = /* @__PURE__ */ __name(function(e2) {
          mouseX = e2.clientX;
          mouseY = e2.clientY;
        }, "onMouseSelection");
        var session = editor.session;
        ...
        if (selectionMode == "add") {
          ...
          var initialRange;
          var rectSel = [];
          var blockSelect = /* @__PURE__ */ __name(function() {
          ...
          var onMouseSelectionEnd = /* @__PURE__ */ __name(function(e2) {
            blockSelect();
            clearInterval(timerId);
            editor.removeSelectionMarkers(rectSel);
            if (!rectSel.length)
    ...
    ace.define("ace/multi_select", ["require", "exports", "module", "ace/range_list", "ace/range", "ace/selection", "ace/mouse/multi_select_handler", "ace/lib/event", "ace/lib/lang", "ace/commands/multi_select_commands", "ace/search", "ace/edit_session", "ace/editor", "ace/config"], function(require2, exports2, module2) {
      ...
      __name(addAltCursorListeners, "addAltCursorListeners");
    ...
    ace.define("ace/line_widgets", ["require", "exports", "module", "ace/lib/dom"], function(require2, exports2, module2) {
      ...
      __name(LineWidgets, "LineWidgets");
      (function() {
        this.getRowLength = function(row) {
          var h;
          if (this.lineWidgets)
    ...
    ace.define("ace/ext/error_marker", ["require", "exports", "module", "ace/line_widgets", "ace/lib/dom", "ace/range"], function(require2, exports2, module2) {
      ...
      __name(findAnnotations, "findAnnotations");
      exports2.showErrorMarker = function(editor, dir) {
        ...
        var kb = /* @__PURE__ */ __name(function(_, hashId, keyString) {
...
// ../../.yarn/global/cache/ace-builds-npm-1.13.2-17c6f7ff6b-9.zip/node_modules/ace-builds/src-min-noconflict/theme-monokai.js
var require_theme_monokai = __commonJS({
  "../../.yarn/global/cache/ace-builds-npm-1.13.2-17c6f7ff6b-9.zip/node_modules/ace-builds/src-min-noconflict/theme-monokai.js"(exports, module) {
    init_define_process();
    ace.define("ace/theme/monokai.css", ["require", "exports", "module"], function(e, t, n) {
      ...
      t.isDark = true, t.cssClass = "ace-monokai", t.cssText = e("./monokai.css");
      var r = e("../lib/dom");
...
// ../../.yarn/global/cache/ace-builds-npm-1.13.2-17c6f7ff6b-9.zip/node_modules/ace-builds/src-min-noconflict/mode-typescript.js
var require_mode_typescript = __commonJS({
  "../../.yarn/global/cache/ace-builds-npm-1.13.2-17c6f7ff6b-9.zip/node_modules/ace-builds/src-min-noconflict/mode-typescript.js"(exports, module) {
    init_define_process();
    ace.define("ace/mode/doc_comment_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function(e, t, n) {
      "use strict";
      var r = e("../lib/oop"), i = e("./text_highlight_rules").TextHighlightRules, s = /* @__PURE__ */ __name(function() {
      ...
      __name(f, "f");
      var r = e("../lib/oop"), i = e("./doc_comment_highlight_rules").DocCommentHighlightRules, s = e("./text_highlight_rules").TextHighlightRules, o = "[a-zA-Z\\$_\xA1-\uFFFF][a-zA-Z\\d\\$_\xA1-\uFFFF]*", u = /* @__PURE__ */ __name(function(e2) {
      ...
      "use strict";
      var r = e("../range").Range, i = /* @__PURE__ */ __name(function() {
      }, "i");
      (function() {
      ...
      "use strict";
      var r = e("../lib/oop"), i = e("./text").Mode, s = e("./javascript_highlight_rules").JavaScriptHighlightRules, o = e("./matching_brace_outdent").MatchingBraceOutdent, u = e("../worker/worker_client").WorkerClient, a = e("./behaviour/cstyle").CstyleBehaviour, f = e("./folding/cstyle").FoldMode, l = /* @__PURE__ */ __name(function() {
      ...
      "use strict";
      var r = e("../lib/oop"), i = e("./javascript_highlight_rules").JavaScriptHighlightRules, s = /* @__PURE__ */ __name(function(e2) {
      ...
      "use strict";
      var r = e("../lib/oop"), i = e("./javascript").Mode, s = e("./typescript_highlight_rules").TypeScriptHighlightRules, o = e("./behaviour/cstyle").CstyleBehaviour, u = e("./folding/cstyle").FoldMode, a = e("./matching_brace_outdent").MatchingBraceOutdent, f = /* @__PURE__ */ __name(function() {
