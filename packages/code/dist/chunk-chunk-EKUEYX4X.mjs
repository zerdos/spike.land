...
function getOptionsFromChildren(children) {
  ...
  react_default.Children.forEach(children, (node) => {
...
function StyledEngineProvider(props) {
  ...
  return injectFirst ? jsx(import_react5.CacheProvider, {
    value: cache,
    children
  }) : children;
}
...
function GlobalStyles(props) {
  ...
  return jsx(import_react6.Global, {
    styles: globalStyles
  });
}
...
function InnerThemeProvider(props) {
  ...
  return jsx(import_react7.ThemeContext.Provider, {
