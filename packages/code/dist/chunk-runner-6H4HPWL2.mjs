import {
  saveCode
} from "./chunk-chunk-VF3D76WW.mjs";
import {
  mST,
  patchSync
} from "./chunk-chunk-4F4YHRHD.mjs";
import "./chunk-chunk-2SMSQPUP.mjs";
import "./chunk-chunk-BH7X6KVY.mjs";
import "./chunk-chunk-D34EIJS5.mjs";
import "./chunk-chunk-DIJMMDTP.mjs";
import "./chunk-chunk-VFQNSVWU.mjs";
import "./chunk-chunk-5AUY45VU.mjs";
import {
  __async,
  __commonJS,
  __spreadProps,
  ...
  "../../../../../Users/z/.yarn/berry/cache/esbuild-wasm-npm-0.15.10-dd9e214eea-9.zip/node_modules/esbuild-wasm/lib/browser.js"(exports, module) {
    ...
    ((module2) => {
      ...
      function createChannel(streamIn) {
        ...
        let handleRequest = (id, request) => __async2(this, null, function* () {
          try {
      ...
      var handlePlugins = (buildKey, sendRequest, sendResponse, refs, streamIn, requestCallbacks, initialOptions, plugins, details) => __async2(void 0, null, function* () {
        ...
        requestCallbacks["on-start"] = (id, request) => __async2(void 0, null, function* () {
          let response = { errors: [], warnings: [] };
          yield Promise.all(onStartCallbacks.map((_0) => __async2(void 0, [_0], function* ({ name, callback, note }) {
            try {
        ...
        requestCallbacks["on-resolve"] = (id, request) => __async2(void 0, null, function* () {
        ...
        requestCallbacks["on-load"] = (id, request) => __async2(void 0, null, function* () {
          let response = {}, name = "", callback, note;
          for (let id2 of request.ids) {
            try {
...
${file}:${line}:${column}: ERROR: ${pluginText}${e.text}`;
      ...
      var startRunningService = (wasmURL, wasmModule, useWorker) => __async2(void 0, null, function* () {
        let wasm;
        if (wasmModule) {
          wasm = wasmModule;
        } else {
...
var esb = (() => __async(void 0, null, function* () {
  return { transform: yield (yield mod.esbuild).transform };
}))();
function runner(_0) {
  return __async(this, arguments, function* ({ code, counter }) {
    const esbuild2 = yield esb;
    patchSync(__spreadProps(__spreadValues({}, mST()), { code, i: counter }));
    try {
      const transpiled = yield esbuild2.transform(code, {
        loader: "tsx",
        format: "esm",
        treeShaking: true,
        tsconfigRaw: {
      ...
      patchSync(__spreadProps(__spreadValues({}, mST()), { transpiled: transpiled.code }));
