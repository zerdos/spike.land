...
var editor_worker_monaco_worker_default = "./chunk-editor.worker.monaco.worker-THPW6TSX.js";

// js/monaco-editor/language/typescript/ts.worker.monaco.worker.js
var ts_worker_monaco_worker_default = "./chunk-ts.worker.monaco.worker-D3RAI5ZJ.js";
...
var startMonaco = async ({ code, container, name }) => {
  const { languages, editor, Uri } = await import(`/npm:monaco-editor@${version}?target=es2021`);
  const returnModules = {
    editor: {},
