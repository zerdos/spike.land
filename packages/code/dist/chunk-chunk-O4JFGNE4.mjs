...
// js/icons.tsx
init_define_process();
var Wrap = /* @__PURE__ */ __name(({ children }) => /* @__PURE__ */ jsx("span", {
  css: css`
font-size:20pt;
`,
  children
}), "Wrap");
var QrCodeIcon = /* @__PURE__ */ __name(() => /* @__PURE__ */ jsx(Wrap, {
  children: /* @__PURE__ */ jsx(MdQrCode, {})
}), "QrCodeIcon");
var Phone = /* @__PURE__ */ __name(() => /* @__PURE__ */ jsx(Wrap, {
  children: /* @__PURE__ */ jsx(MdPhoneAndroid, {})
}), "Phone");
var Share = /* @__PURE__ */ __name(() => /* @__PURE__ */ jsx(Wrap, {
  children: /* @__PURE__ */ jsx(MdShare, {})
}), "Share");
var Tablet = /* @__PURE__ */ __name(() => /* @__PURE__ */ jsx(Wrap, {
  children: /* @__PURE__ */ jsx(MdTabletAndroid, {})
}), "Tablet");
var Tv = /* @__PURE__ */ __name(() => /* @__PURE__ */ jsx(Wrap, {
  children: /* @__PURE__ */ jsx(MdTv, {})
}), "Tv");

// js/mui.tsx
init_define_process();
init_reactMod();
var FabLazy = lazy(async () => import("./chunk-Fab-6VGDVBP6.mjs"));
var Fab = /* @__PURE__ */ __name((props) => /* @__PURE__ */ jsx(Suspense, {
  fallback: /* @__PURE__ */ jsx("div", {
    css: css`width: 28px; height:28px`
  }),
  children: /* @__PURE__ */ jsx(FabLazy, {
    ...props
  })
}), "Fab");
var ToggleButtonLazy = lazy(async () => import("./chunk-ToggleButton-M5OSH7WP.mjs"));
var ToggleButton = /* @__PURE__ */ __name((props) => /* @__PURE__ */ jsx(Suspense, {
  fallback: /* @__PURE__ */ jsx("div", {
    css: css`width: 28px; height:28px`
  }),
  children: /* @__PURE__ */ jsx(ToggleButtonLazy, {
    ...props
  })
}), "ToggleButton");
var ToggleButtonGroupLazy = lazy(async () => import("./chunk-ToggleButtonGroup-UOIJ64GL.mjs"));
var ToggleButtonGroup = /* @__PURE__ */ __name((props) => /* @__PURE__ */ jsx(Suspense, {
  fallback: /* @__PURE__ */ jsx("div", {
    css: css`width: 28px; height:28px`
  }),
  children: /* @__PURE__ */ jsx(ToggleButtonGroupLazy, {
    ...props
  })
}), "ToggleButtonGroup");
