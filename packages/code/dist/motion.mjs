...
function ReorderItem(_a, externalRef) {
  ...
  return createElement(Component2, __spreadProps(__spreadValues({ drag: axis }, props), { dragSnapToOrigin: true, style: __spreadProps(__spreadValues({}, style2), { x: point.x, y: point.y, zIndex }), layout, onDrag: (event, gesturePoint) => {
