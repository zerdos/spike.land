...
// js/renderPreviewWindow.tsx
var import_react29 = __toESM(require_emotion_react_cjs(), 1);
...
var Phone = () => (0, import_jsx_runtime59.jsx)("span", {
  css: import_react20.css`font-size:20pt`,
...
var QR = ({ url }) => (0, import_jsx_runtime60.jsx)(QRious, {
  value: url
});
var QRiousLazy = lazy(() => import("./chunk-lib-3SJEX46J.mjs").then(({ QRious: QRious2 }) => ({ default: QRious2 })));
var QRious = ({ value }) => (0, import_jsx_runtime60.jsx)(Suspense, {
  children: (0, import_jsx_runtime60.jsx)(QRiousLazy, {
    value
  })
});
var QRButton = ({ url }) => {
      ...
      children: showQR ? (0, import_jsx_runtime60.jsx)(QR, {
        ...
        children: [
          (0, import_jsx_runtime60.jsx)("span", {
            css: import_react21.css`font-size: 20pt;`,
...
var Editor = ({ code, i, codeSpace: codeSpace2, assets }) => {
  ...
  const [
    ...
    runner: async ({ code: code2, counter: counter2, codeSpace: codeSpace3 }) => {
      const { runner: runner2 } = await import("./chunk-runner-QFBNSV35.mjs");
  ...
  useEffect(() => {
    ...
    const setMonaco = async () => {
      ...
      const { startMonaco } = await import("./chunk-startMonaco-N3QJHYUU.mjs");
