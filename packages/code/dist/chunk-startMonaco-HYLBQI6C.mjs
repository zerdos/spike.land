...
var startMonaco = async ({ code, container, name }) => {
  const tsD = await Promise.all([
    import("./chunk-editor.api-EAJCN6NT.mjs"),
    import("./chunk-editor.all-BNWD5PJU.mjs"),
    import("./chunk-typescript.contribution-4C32I4BE.mjs"),
    import("./chunk-monaco.contribution-JKPLIONB.mjs")
  ]);
  ...
  async function startMonacoPristine({ code: code2, container: container2, name: name2 }) {
    ...
    requestAnimationFrame(async () => {
      const { wait } = await import("./chunk-wait-5ENZN3RS.mjs");
      while (!globalThis.ts) {
        await wait(1e3);
      }
      console.log("globalThis.ts is defined, whoooo");
      const { setupTypeAcquisition } = await import("./chunk-dist-OHAR33B5.mjs");
  ...
  async function monacoContribution(code2) {
    ...
    (async () => {
      ...
      try {
        ...
        const pMap = (await import("./chunk-p-map-JBGVMVMD.mjs")).default;
