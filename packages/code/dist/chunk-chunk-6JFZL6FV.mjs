...
import {
  ...
  m,
  motion
} from "./chunk-chunk-PHHZQZFD.mjs";
import {
  require_emotion_react_jsx_runtime_cjs
} from "./chunk-chunk-MXCMYNFW.mjs";
import {
  require_emotion_react_cjs
} from "./chunk-chunk-JD2OOSH2.mjs";
import {
  $,
  Children,
  PureComponent,
...
var FabLazy = lazy(() => import("./chunk-Fab-MB5EDGFC.mjs"));
var Fab = (props) => (0, import_jsx_runtime4.jsx)(Suspense, {
  children: (0, import_jsx_runtime4.jsx)(FabLazy, {
    ...props
  })
});
var ToggleButtonLazy = lazy(() => import("./chunk-ToggleButton-NMBKQLF5.mjs"));
...
var ToggleButtonGroupLazy = lazy(
  () => import("./chunk-ToggleButtonGroup-2HXRV5PR.mjs")
);
...
var QRiousLazy = react_preact_default.lazy(
  () => import("./chunk-lib-TGRGEA6K.mjs").then(({ QRious: QRious2 }) => ({ default: QRious2 }))
);
...
var Editor = ({ code, i, codeSpace: codeSpace2, assets }) => {
  ...
  const [
    ...
    runner: async ({ code: code2, counter: counter2, codeSpace: codeSpace3 }) => {
      const { runner: runner2 } = await import("./chunk-runner-FHNF6BTJ.mjs");
      const { prettierJs: prettierJs2 } = await import("./chunk-prettierJs-DESX6CUL.mjs");
  ...
  useEffect(() => {
    ...
    const setMonaco = async () => {
      ...
      const { startMonaco } = await import("./chunk-startMonaco-FWPWSZBQ.mjs");
