...
import {
  ...
  m,
  motion
} from "./chunk-chunk-TIHWDJVO.mjs";
import {
  require_emotion_react_jsx_runtime_cjs
} from "./chunk-chunk-ORTW5BL3.mjs";
import {
...
var FabLazy = lazy(() => import("./chunk-Fab-RFXFZZM6.mjs"));
var Fab = (props) => (0, import_jsx_runtime4.jsx)(Suspense, {
  children: (0, import_jsx_runtime4.jsx)(FabLazy, {
    ...props
  })
});
var ToggleButtonLazy = lazy(() => import("./chunk-ToggleButton-C7HMOIDN.mjs"));
...
var ToggleButtonGroupLazy = lazy(
  () => import("./chunk-ToggleButtonGroup-6QCS6GYO.mjs")
);
...
var QRiousLazy = react_preact_default.lazy(
  () => import("./chunk-lib-L5HC42OW.mjs").then(({ QRious: QRious2 }) => ({ default: QRious2 }))
);
...
var Editor = ({ code, i, codeSpace: codeSpace2, assets }) => {
  ...
  const [
    ...
    runner: async ({ code: code2, counter: counter2, codeSpace: codeSpace3 }) => {
      const { runner: runner2 } = await import("./chunk-runner-LKJ62MVS.mjs");
      const { prettierJs: prettierJs2 } = await import("./chunk-prettierJs-GLU6IYHR.mjs");
  ...
  useEffect(() => {
    ...
    const setMonaco = async () => {
      ...
      const { startMonaco } = await import("./chunk-startMonaco-IP24LCCR.mjs");
    ...
    const setAce = async () => {
      const { startAce } = await import("./chunk-startAce-GN76NIVR.mjs");
...
var startIpfs = async () => {
  const options = config_browser_default();
  const { create } = await import("./chunk-src-T7T4IHKF.mjs");
  const newOptions = {
    ...options,
    Bootstrap: [
  ...
  await ipfs.swarm.connect("/dnsaddr/bootstrap.libp2p.io/p2p/QmQCU2EcMqAqQPR2i9bChDtGNJchTbq5TbXJJ16u19uLTa");
  await ipfs.pubsub.subscribe(topic, (msg) => console.log(new TextDecoder().decode(msg.data)));
  console.log(`subscribed to ${topic}`);
  globalThis.send = (data) => ipfs.pubsub.publish(topic, new TextEncoder().encode(data));
  globalThis.cat = async (cid) => {
