export const version = `7.5.2`; export const html = `  <!DOCTYPE html>
<html>
...
//   });
  ...
  const runner = async () => {
    ...
    try {
        ...
        const { run } = await import( "https://unpkg.com/@zedvision/code@7.5.2/dist/codeLoader.min.js" );
        run();
      }
  }
...
// importScripts(
//   "https://unpkg.com/@zedvision/code@7.5.2/dist/htmlNoModule.js",
// );
