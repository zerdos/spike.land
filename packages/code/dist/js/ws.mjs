...
var Editor = ({ code, i: i2, codeSpace: codeSpace2 }) => {
  ...
  useEffect(() => {
    ...
    const setMonaco = async () => {
      const { startMonaco } = await import("../chunk-startMonaco-XA3UYGG5.mjs");
    ...
    const setAce = async () => {
      const { startAce } = await import("../chunk-startAce-L3QSP7H5.mjs");
    ...
    const loadEditors = async () => {
      ...
      const { prettierJs: prettierJs2 } = await import("../chunk-prettierEsm-LFG23BOC.mjs");
