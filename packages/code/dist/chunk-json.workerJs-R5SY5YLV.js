(() => {
  ...
  var globals = typeof self === "object" ? self : typeof globalThis === "object" ? globalThis : {};
  ...
  (function(EditorOption2) {
    ...
    EditorOption2[EditorOption2["stickyScroll"] = 105] = "stickyScroll";
      ...
      return {
        ...
        changes: result.changes.map((c) => {
          ...
          return {
            originalRange,
            modifiedRange,
            innerChanges: (_a3 = c.charChanges) === null || _a3 === void 0 ? void 0 : _a3.map((c2) => new RangeMapping(new Range(c2.originalStartLineNumber, c2.originalStartColumn, c2.originalEndLineNumber, c2.originalEndColumn), new Range(c2.modifiedStartLineNumber, c2.modifiedStartColumn, c2.modifiedEndLineNumber, c2.modifiedEndColumn)))
          };
        })
      };
    }
  ...
  var SequenceFromIntArray = class {
    constructor(arr) {
      this.arr = arr;
    }
    getElement(offset) {
