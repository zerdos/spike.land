(function (d, h) {
  ...
  function me(e, n, t) {
    return t = $(t, { ignoreWhitespace: !0 }), P.diff(e, n, t);
  }
  function xe(e, n, t) {
    return P.diff(e, n, t);
  }
...
export const isDiff = (d) => {
    if (d.length < 10) return !1;
    const h = [...d.slice(0, 8)].filter((H) => H < "0" || H > "f").length === 0,
      x = d.slice(8);
