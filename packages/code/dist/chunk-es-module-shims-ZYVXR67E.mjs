...
// ../../.yarn/cache/es-module-shims-npm-1.5.14-f894143567-f50eb4f733.zip/node_modules/es-module-shims/dist/es-module-shims.js
init_define_process();
(function() {
  ...
  function parse(l2, k2 = "@") {
    ...
    if (u2 > i || !e) {
      ...
      }("undefined" != typeof self ? self : self, {}, a), r = e.su(i - (2 << 17));
    }
