...
var useQrious = /* @__PURE__ */ __name((options) => {
  const [qrious] = (0, import_react.useState)(() => new import_qrious.default(options));
  const [dataUrl, setDataUrl] = (0, import_react.useState)(() => qrious.toDataURL(options.mime));
...
// ../../.yarn/__virtual__/react-qrious-virtual-b90ac76f79/0/global/cache/react-qrious-npm-2.5.6-421c990834-9.zip/node_modules/react-qrious/lib/QRious.js
var QRious2 = /* @__PURE__ */ __name(({ background, backgroundAlpha, foreground, foregroundAlpha, level, mime, padding, value, size, ...props }) => {
...
var QRButton = /* @__PURE__ */ __name(({ url }) => {
  const [showQR, setQR] = (0, import_react4.useState)(false);
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    motion.div,
    {
      ...
      css: import_react3.css`
          ...
          margin-bottom: 12px;
              `,
      children: showQR ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        QRious2,
        {
          value: url || "/live/coder/public"
        },
        url || origin + url
      ) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Fab, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(QrCodeIcon, {}) })
    }
  );
}, "QRButton");
var Qr_default = QRButton;
export {
  QRButton,
