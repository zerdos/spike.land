...
var CodeSession = class {
  constructor(room, user) {
    ...
    this.hashOfState = /* @__PURE__ */ __name(() => {
      const state = this.session.get("state");
      const hashCode4 = md5(state.transpiled);
      hashStore[hashCode4] = state;
      return hashCode4;
    }, "hashOfState");
    this.createPatchFromHashCode = /* @__PURE__ */ __name((oldHash, state, updateHash) => {
    ...
    this.patchSync = /* @__PURE__ */ __name((sess) => {
    ...
    this.applyPatch = /* @__PURE__ */ __name(async ({
      oldHash,
      newHash,
      patch
    }) => {
