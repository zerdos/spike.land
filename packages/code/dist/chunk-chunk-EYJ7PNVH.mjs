...
// ../../.yarn/global/cache/es-module-shims-npm-1.5.17-63d530ed50-9.zip/node_modules/es-module-shims/dist/es-module-shims.js
init_define_process();
(function() {
  ...
  function parse(l2, k2 = "@") {
    ...
    if (u2 > i || !e) {
                ...
                do {
                  switch (s2[r4 >> 1] | 0) {
                    ...
                    case 32:
                      break;
                    case 101: {
                      if ((((s2[386] | 0) == 0 ? F(r4) | 0 : 0) ? (m3(e3 + 4 | 0, 16, 10) | 0) == 0 : 0) ? (l3(), (i2[775] | 0) == 0) : 0) {
                        b3 = 9;
                        break e;
                      } else
                        b3 = 17;
      ...
      }("undefined" != typeof self ? self : self, {}, a), r2 = e.su(i - (2 << 17));
    }
  ...
  function b(e2, a2) {
    ...
    for (; ; ) {
      ...
      if (e3 === a2)
        break;
      92 === e3 ? (r3 += c$1.slice(i2, n), r3 += l(), i2 = n) : (8232 === e3 || 8233 === e3 || u(e3) && o(), ++n);
    }
...
function getChildMapping(children, mapFn) {
  ...
  if (children)
    Children2.map(children, function(c) {
      return c;
...
var Fab = /* @__PURE__ */ React13.forwardRef(function Fab2(inProps, ref) {
  const props = useThemeProps2({
    props: inProps,
    name: "MuiFab"
  });
...
var SvgIcon = /* @__PURE__ */ React14.forwardRef(function SvgIcon2(inProps, ref) {
  const props = useThemeProps2({
    props: inProps,
    name: "MuiSvgIcon"
  });
  ...
  return /* @__PURE__ */ _jsxs2(SvgIconRoot, _extends({
    ...
    children: [children, titleAccess ? /* @__PURE__ */ _jsx5("title", {
...
function createSvgIcon(path, displayName) {
  const Component = (props, ref) => /* @__PURE__ */ _jsx6(SvgIcon_default, _extends({
  ...
  return /* @__PURE__ */ React15.memo(/* @__PURE__ */ React15.forwardRef(Component));
}
...
var ToggleButton = /* @__PURE__ */ React16.forwardRef(function ToggleButton2(inProps, ref) {
  const props = useThemeProps2({
    props: inProps,
    name: "MuiToggleButton"
  });
  ...
  return /* @__PURE__ */ _jsx7(ToggleButtonRoot, _extends({
    className: clsx_m_default(classes.root, className),
    disabled,
    focusRipple: !disableFocusRipple,
    ref,
...
var ToggleButtonGroup = /* @__PURE__ */ React17.forwardRef(function ToggleButtonGroup2(inProps, ref) {
  const props = useThemeProps2({
    props: inProps,
    name: "MuiToggleButtonGroup"
  });
  ...
  return /* @__PURE__ */ _jsx8(ToggleButtonGroupRoot, _extends({
    role: "group",
    className: clsx_m_default(classes.root, className),
    ref,
    ownerState
    ...
    children: React17.Children.map(children, (child) => {
      if (!/* @__PURE__ */ React17.isValidElement(child)) {
        return null;
      }
      if (true) {
      ...
      return /* @__PURE__ */ React17.cloneElement(child, {
...
var QR = ({ url }) => /* @__PURE__ */ jsx3(QRious2, {
  value: url
});
var QRButton = ({ url }) => {
  const [showQR, setQR] = useState5(false);
  return /* @__PURE__ */ jsx3(LazyMotion, {
    features: domAnimation,
    children: /* @__PURE__ */ jsx3(m.div, {
      animate: {
        width: showQR ? 200 : 56,
      ...
      css: css3`
          ...
          margin-bottom: 12px;
              `,
      children: showQR ? /* @__PURE__ */ jsx3(QR, {
        url: url || "/live/coder/public"
      }, url || "http://spike.land") : /* @__PURE__ */ jsx3(Fab_default, {
        children: /* @__PURE__ */ jsx3(QrCode, {})
      })
    })
  });
};
...
var DraggableWindow = ({
  ...
  const [scaleRange, changeScaleRange] = useState6(100);
  const startPositions = { bottom: 0, right: 0 };
  const [{ bottom: bottom2, right: right2 }, setPositions] = useState6(startPositions);
  const [width2, setWidth] = useState6(window.innerWidth * devicePixelRatio);
  const [height2, setHeight] = useState6(window.innerHeight * devicePixelRatio);
  ...
  return /* @__PURE__ */ jsx4(LazyMotion2, {
    features: domMax,
    children: /* @__PURE__ */ jsx4(m2.div, {
      ...
      children: /* @__PURE__ */ jsxs2("div", {
        ...
        children: [
          ...
          `,
            children: [
              /* @__PURE__ */ jsx4(m2.div, {
                transition: { delay: 0, duration: 0.4 },
                initial: { height: 0, width: 0 },
                animate: { height: "auto", width: "auto" },
                children: /* @__PURE__ */ jsx4(ToggleButtonGroup3, {
                  value: scaleRange,
                  size: "small",
                  exclusive: true,
                  ...
                  children: sizes.map((size) => /* @__PURE__ */ jsx4(ToggleButton3, {
                    value: size,
            ...
            `,
              ...
              /* @__PURE__ */ jsx4(m2.div, {
                ...
                children: /* @__PURE__ */ jsx4(ToggleButtonGroup3, {
                  ...
                  children: breakPoints.map((size) => /* @__PURE__ */ jsx4(ToggleButton3, {
                    value: size,
                    children: size === 680 ? /* @__PURE__ */ jsx4(Phone, {
                      css: css4`
                        color: ${width2 === 680 ? "rgba(255,255,255,.8)" : "rgba(0,0,0,.3)"};
                        `
                    }) : size === 768 ? /* @__PURE__ */ jsx4(Tablet, {
                      css: css4`
          ...
          /* @__PURE__ */ jsx4(m2.div, {
            ...
            children: /* @__PURE__ */ jsxs2("div", {
              ...
              `,
              children: [
                /* @__PURE__ */ jsx4(Fab_default, {
                  onClick: () => {
                    document.getElementById("root")?.requestFullscreen();
                  },
                  children: /* @__PURE__ */ jsx4(FullscreenIcon, {}, "fs")
                }, "fullscreen"),
                /* @__PURE__ */ jsx4(QRButton, {
                  url: location.origin + `/live/${room}/public`
                }, `qr-${hashCode2}`),
                /* @__PURE__ */ jsx4(Fab_default, {
                  onClick: () => open(`/live/${room}/public`),
                  children: /* @__PURE__ */ jsx4(Share, {})
                }, "Share")
              ]
            })
          })
...
var Editor = ({ code, i, codeSpace: codeSpace2 }) => {
  ...
  const [
    ...
    runner: async ({ code: code2, counter: counter2 }) => {
      const { runner: runner2 } = await import("./chunk-runner-3LIEDBWZ.mjs");
  ...
  useEffect7(() => {
    ...
    const setMonaco = async () => {
      const { startMonaco } = await import("./chunk-startMonaco-LTP67TK7.mjs");
  ...
  return engine === "monaco" ? /* @__PURE__ */ jsx5("div", {
    "data-test-id": myId,
    css: css5`
max-width: 640px;
...
var RainbowContainer = ({ children }) => /* @__PURE__ */ jsx6("div", {
  css: css6`
height: 100%;
width: 100%;
...
var AppToRender = ({ codeSpace: codeSpace2 }) => {
  const [hash, setHash] = useState8(() => hashCode());
  const [isStandalone, setIsStandalone] = useState8(true);
  useEffect8(() => {
  ...
  const portalNode = useMemo2(() => createHtmlPortalNode({
    attributes: { id: `root-${codeSpace2}`, style: "height: 100%" }
  }), []);
  return /* @__PURE__ */ jsxs3(Fragment, {
    children: [
      /* @__PURE__ */ jsx6(InPortal, {
        node: portalNode,
        children: /* @__PURE__ */ jsx6(AutoUpdateApp, {
          hash
        })
      }),
      isStandalone ? /* @__PURE__ */ jsx6(OutPortal, {
        node: portalNode
      }) : /* @__PURE__ */ jsxs3(RainbowContainer, {
        children: [
          /* @__PURE__ */ jsx6(OutPortal, {
            node: portalNode
          }),
          /* @__PURE__ */ jsx6(Editor, {
            code: mST().code,
            i: mST().i,
            codeSpace: codeSpace2
          }),
          /* @__PURE__ */ jsx6(DraggableWindow, {
            hashCode: 0,
            room: codeSpace2,
            children: /* @__PURE__ */ jsx6(OutPortal, {
              node: portalNode
            })
          })
        ]
...
var renderPreviewWindow = async (codeSpace2) => {
  ...
  root.render(
    /* @__PURE__ */ jsx6(Fragment, {
      children: /* @__PURE__ */ jsx6(AppToRender, {
        codeSpace: codeSpace2
      })
    })
  );
...
//# sourceMappingURL=chunk-chunk-EYJ7PNVH.mjs.map
