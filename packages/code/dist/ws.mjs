  ...
  "../../.yarn/global/cache/esbuild-wasm-npm-0.15.10-dd9e214eea-9.zip/node_modules/esbuild-wasm/lib/browser.js"(exports, module) {
    ...
    ((module2) => {
      ...
      function pushCommonFlags(flags, options, keys) {
        ...
        let jsx10 = getFlag(options, keys, "jsx", mustBeString);
                  ...
                  this.importObject = {
                    go: {
                      ...
                      "syscall/js.valueCall": (sp) => {
                        ...
                        try {
                          const v = loadValue(sp + 8);
                          const m2 = Reflect.get(v, loadString(sp + 16));
                          const args = loadSliceOfValues(sp + 32);
                          const result = Reflect.apply(m2, v, args);
                          sp = this._inst.exports.getsp() >>> 0;
                          storeValue(sp + 56, result);
                          this.mem.setUint8(sp + 64, 1);
                        } catch (err) {
...
var Editor = ({ codeSpace: codeSpace2, assets }) => {
  ...
  const cb = useCallback(() => {
    ...
    (async () => {
      const code2 = await mod.getValue();
      ...
      runner({ code: newCode, counter: mod.counter, codeSpace: codeSpace2 });
    })();
    ...
    const setMonaco = async () => {
      ...
      const setValue = async (_code) => {
        ...
        if (mST().i === mod.counter)
          return;
        setTimeout(() => mod.codeToSet === code2 && setMonValue(code2), 800);
      };
