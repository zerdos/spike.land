    ...
    !function(e, t) {
      ...
      return (() => {
        ...
        var e = { 4567: (e2, t2, i2) => {
          ...
          const s2 = i2(9042), r = i2(6114), n = i2(9924), o = i2(3656), a = i2(844), h3 = i2(5596), c = i2(9631);
          ...
          const s2 = i2(8055), r = i2(7239), n = s2.css.toColor("#ffffff"), o = s2.css.toColor("#000000"), a = s2.css.toColor("#ffffff"), h3 = s2.css.toColor("#000000"), c = { css: "rgba(255, 255, 255, 0.3)", rgba: 4294967117 };
          t2.DEFAULT_ANSI_COLORS = Object.freeze((() => {
            ...
            _parseColor(e3, t3, i3 = this.allowTransparency) {
              ...
              if (255 !== r2[3]) {
                ...
                const [r3, n2, o2, a2] = this._ctx.fillStyle.substring(5, this._ctx.fillStyle.length - 1).split(",").map((e4) => Number(e4)), h4 = Math.round(255 * a2);
                return { rgba: s2.channels.toRgba(r3, n2, o2, h4), css: e3 };
              }
          ...
          const n = i2(2585), o = i2(8460), a = i2(844), h3 = i2(3656);
          let c = class extends a.Disposable {
            ...
            attachToDom(e3, t3, i3) {
              this._element = e3, this._mouseService = t3, this._renderService = i3, this.register((0, h3.addDisposableDomListener)(this._element, "mouseleave", () => {
                this._isMouseOut = true, this._clearCurrentLink();
              })), this.register((0, h3.addDisposableDomListener)(this._element, "mousemove", this._onMouseMove.bind(this))), this.register((0, h3.addDisposableDomListener)(this._element, "mousedown", this._handleMouseDown.bind(this))), this.register((0, h3.addDisposableDomListener)(this._element, "mouseup", this._handleMouseUp.bind(this)));
            }
            _onMouseMove(e3) {
                ...
                if (-1 !== d || s3.hasContent(t4)) {
                  ...
                  if (_ || -1 !== d && t4 === c - 1) {
                    ...
                    if (s4) {
                      ...
                      r2.push({ text: s4, range: i4, activate: (e4, t5) => o2 ? o2.activate(e4, t5, i4) : h3(0, t5), hover: (e4, t5) => {
                        var s5;
          ...
          const s2 = i2(2950), r = i2(1680), n = i2(3614), o = i2(2584), a = i2(5435), h3 = i2(9312), c = i2(6114), l = i2(3656), d = i2(9042), _ = i2(4567), u = i2(1296), f = i2(7399), v = i2(8460), g = i2(8437), p2 = i2(5680), S = i2(3230), m = i2(4725), C = i2(428), b = i2(8934), y = i2(6465), w = i2(5114), E = i2(8969), L = i2(8055), R = i2(4269), k = i2(5941), D = i2(3107), A = i2(5744), x = i2(9074), B = i2(2585), T = i2(2962), M = "undefined" != typeof window ? window.document : null;
          ...
          c = s2([r(4, h3.IBufferService), r(5, h3.IOptionsService), r(6, a.ICharSizeService), r(7, a.IRenderService), r(8, a.ICoreBrowserService)], c), t2.Viewport = c;
          ...
          const n = i2(3656), o = i2(4725), a = i2(844), h3 = i2(2585);
          let c = class extends a.Disposable {
          ...
          c = s2([r(1, h3.IBufferService), r(2, h3.IDecorationService), r(3, o.IRenderService)], c), t2.BufferDecorationRenderer = c;
        }, 5871: (e2, t2) => {
          ...
          h3 = s2([r(2, o.IBufferService), r(3, o.IOptionsService), r(4, o.ICoreService), r(5, n.IRenderService)], h3), t2.CompositionHelper = h3;
        }, 9806: (e2, t2) => {
          ...
          function r(e3, t3, i3, s3) {
            const r2 = e3 - n(i3, e3), a2 = t3 - n(i3, t3), l = Math.abs(r2 - a2) - function(e4, t4, i4) {
              ...
              for (let n2 = 0; n2 < Math.abs(r3 - a3); n2++) {
                ...
                (null == h4 ? void 0 : h4.isWrapped) && s4++;
              }
              return s4;
            }(e3, t3, i3);
          ...
          function a(e3, t3, i3, s3, r2, n2) {
            let o2 = e3, a2 = t3, h4 = "";
            for (; o2 !== i3 || a2 !== s3; )
              o2 += r2 ? 1 : -1, r2 && o2 > n2.cols - 1 ? (h4 += n2.buffer.translateBufferLineToString(a2, false, e3, o2), o2 = 0, e3 = 0, a2++) : !r2 && o2 < 0 && (h4 += n2.buffer.translateBufferLineToString(a2, false, 0, e3 + 1), o2 = n2.cols - 1, e3 = o2, a2--);
          ...
          t2.moveToCellSequence = function(e3, t3, i3, s3) {
            ...
            if (!i3.buffer.hasScrollback)
              return function(e4, t4, i4, s4, o3, l2) {
                return 0 === r(t4, s4, o3, l2).length ? "" : c(a(e4, t4, e4, t4 - n(o3, t4), false, o3).length, h3("D", l2));
                ...
                const _2 = s4, u = function(e5, t5, i5, s5, o4, a2) {
                  let h4;
                  return h4 = r(i5, s5, o4, a2).length > 0 ? s5 - n(o4, s5) : t5, e5 < i5 && h4 <= s5 || e5 >= i5 && h4 < s5 ? "C" : "D";
                }(e4, t4, i4, s4, o3, l2);
                return c(a(e4, d2, i4, _2, "C" === u, o3).length, h3(u, l2));
              }(o2, l, e3, t3, i3, s3);
            let d;
            if (l === t3)
              return d = o2 > e3 ? "D" : "C", c(Math.abs(o2 - e3), h3(d, s3));
            d = l > t3 ? "D" : "C";
          ...
          g = s2([r(5, c.IInstantiationService), r(6, h3.ICharSizeService), r(7, c.IOptionsService), r(8, c.IBufferService), r(9, h3.ICoreBrowserService)], g), t2.DomRenderer = g;
          ...
          const n = i2(8036), o = i2(643), a = i2(511), h3 = i2(2585), c = i2(8055), l = i2(4725), d = i2(4269), _ = i2(1752), u = i2(3734);
          ...
          let f = class {
            ...
            createRow(e3, i3, s3, r2, a2, h4, l2, _2) {
              ...
              for (let _3 = 0; _3 < p2; _3++) {
                ...
                if (g.length > 0 && _3 === g[0][0]) {
                  S = true;
                  const t3 = g.shift();
                  C = new d.JoinedCellData(this._workCell, e3.translateToString(true, t3[0], t3[1]), t3[1] - t3[0]), m = t3[1] - 1, p3 = C.getWidth();
                }
                const b = this._document.createElement("span");
                if (p3 > 1 && (b.style.width = l2 * p3 + "px"), S && (b.style.display = "inline", a2 >= _3 && a2 <= m && (a2 = _3)), !this._coreService.isCursorHidden && s3 && _3 === a2)
                  switch (b.classList.add(t2.CURSOR_CLASS), h4 && b.classList.add(t2.CURSOR_BLINK_CLASS), r2) {
                    case "bar":
          ...
          f = s2([r(2, l.ICharacterJoinerService), r(3, h3.IOptionsService), r(4, l.ICoreBrowserService), r(5, h3.ICoreService), r(6, h3.IDecorationService)], f), t2.DomRendererRowFactory = f;
        }, 456: (e2, t2) => {
          ...
          let a = class {
            constructor(e3, t3, i3) {
              this._optionsService = i3, this.width = 0, this.height = 0, this._onCharSizeChange = new o.EventEmitter(), this._measureStrategy = new h3(e3, t3, this._optionsService);
            }
            get hasValidSize() {
          ...
          l = s2([r(0, h3.IBufferService)], l), t2.CharacterJoinerService = l;
        }, 5114: (e2, t2) => {
          ...
          const n = i2(6114), o = i2(456), a = i2(511), h3 = i2(8460), c = i2(4725), l = i2(2585), d = i2(9806), _ = i2(9504), u = i2(844), f = i2(4841), v = String.fromCharCode(160), g = new RegExp(v, "g");
          let p2 = class extends u.Disposable {
            constructor(e3, t3, i3, s3, r2, n2, c2, l2, d2) {
              super(), this._element = e3, this._screenElement = t3, this._linkifier = i3, this._bufferService = s3, this._coreService = r2, this._mouseService = n2, this._optionsService = c2, this._renderService = l2, this._coreBrowserService = d2, this._dragScrollAmount = 0, this._enabled = true, this._workCell = new a.CellData(), this._mouseDownTimeStamp = 0, this._oldHasSelection = false, this._oldSelectionStart = void 0, this._oldSelectionEnd = void 0, this._onLinuxMouseSelection = this.register(new h3.EventEmitter()), this._onRedrawRequest = this.register(new h3.EventEmitter()), this._onSelectionChange = this.register(new h3.EventEmitter()), this._onRequestScrollLines = this.register(new h3.EventEmitter()), this._mouseMoveListener = (e4) => this._onMouseMove(e4), this._mouseUpListener = (e4) => this._onMouseUp(e4), this._coreService.onUserInput(() => {
            ...
            _getWordAt(e3, t3, i3 = true, s3 = true) {
              ...
              let a2 = this._convertViewportColToCharacterIndex(n2, e3), h4 = a2;
              const c2 = e3[0] - a2;
              let l2 = 0, d2 = 0, _2 = 0, u2 = 0;
              if (" " === o2.charAt(a2)) {
                for (; a2 > 0 && " " === o2.charAt(a2 - 1); )
                  a2--;
                for (; h4 < o2.length && " " === o2.charAt(h4 + 1); )
                  h4++;
              } else {
                let t4 = e3[0], i4 = e3[0];
          ...
          Object.defineProperty(t2, "__esModule", { value: true }), t2.contrastRatio = t2.toPaddedHex = t2.rgba = t2.rgb = t2.css = t2.color = t2.channels = void 0, function(e3) {
            ...
            e3.blend = function(e4, t4) {
              ...
              const r2 = t4.rgba >> 24 & 255, n2 = t4.rgba >> 16 & 255, o2 = t4.rgba >> 8 & 255, a = e4.rgba >> 24 & 255, h3 = e4.rgba >> 16 & 255, c = e4.rgba >> 8 & 255, l = a + Math.round((r2 - a) * s3), d = h3 + Math.round((n2 - h3) * s3), _ = c + Math.round((o2 - c) * s3);
            ...
            function t3(e4, t4, i3) {
              ...
              let h3 = t4 >> 24 & 255, c = t4 >> 16 & 255, l = t4 >> 8 & 255, d = o(s2.relativeLuminance2(h3, c, l), s2.relativeLuminance2(r3, n2, a));
              for (; d < i3 && (h3 > 0 || c > 0 || l > 0); )
                h3 -= Math.max(0, Math.ceil(0.1 * h3)), c -= Math.max(0, Math.ceil(0.1 * c)), l -= Math.max(0, Math.ceil(0.1 * l)), d = o(s2.relativeLuminance2(h3, c, l), s2.relativeLuminance2(r3, n2, a));
              return (h3 << 24 | c << 16 | l << 8 | 255) >>> 0;
            }
            function r2(e4, t4, i3) {
              const r3 = e4 >> 24 & 255, n2 = e4 >> 16 & 255, a = e4 >> 8 & 255;
              let h3 = t4 >> 24 & 255, c = t4 >> 16 & 255, l = t4 >> 8 & 255, d = o(s2.relativeLuminance2(h3, c, l), s2.relativeLuminance2(r3, n2, a));
              for (; d < i3 && (h3 < 255 || c < 255 || l < 255); )
                h3 = Math.min(255, h3 + Math.ceil(0.1 * (255 - h3))), c = Math.min(255, c + Math.ceil(0.1 * (255 - c))), l = Math.min(255, l + Math.ceil(0.1 * (255 - l))), d = o(s2.relativeLuminance2(h3, c, l), s2.relativeLuminance2(r3, n2, a));
              return (h3 << 24 | c << 16 | l << 8 | 255) >>> 0;
            }
            e3.ensureContrastRatio = function(e4, i3, n2) {
              const a = s2.relativeLuminance(e4 >> 8), h3 = s2.relativeLuminance(i3 >> 8);
              if (o(a, h3) < n2) {
                if (h3 < a) {
                  const h4 = t3(e4, i3, n2), c2 = o(a, s2.relativeLuminance(h4 >> 8));
                  if (c2 < n2) {
                    const t4 = r2(e4, i3, n2);
                    return c2 > o(a, s2.relativeLuminance(t4 >> 8)) ? h4 : t4;
                  }
                  return h4;
                }
          ...
          const s2 = i2(2584), r = i2(7116), n = i2(2015), o = i2(844), a = i2(482), h3 = i2(8437), c = i2(8460), l = i2(643), d = i2(511), _ = i2(3734), u = i2(2585), f = i2(6242), v = i2(6351), g = i2(5941), p2 = { "(": 0, ")": 1, "*": 2, "+": 3, "-": 1, ".": 2 }, S = 131072;
          function m(e3, t3) {
            if (e3 > 24)
          ...
          class b extends o.Disposable {
            ...
            print(e3, t3, i3) {
              let s3, r2;
              const n2 = this._charsetService.charset, o2 = this._optionsService.rawOptions.screenReaderMode, h4 = this._bufferService.cols, c2 = this._coreService.decPrivateModes.wraparound, d2 = this._coreService.modes.insertMode, _2 = this._curAttrData;
              ...
              for (let f2 = t3; f2 < i3; ++f2) {
                ...
                if (o2 && this._onA11yChar.fire((0, a.stringFromCodePoint)(s3)), void 0 !== this._currentLinkId && this._oscLinkService.addLineToLink(this._currentLinkId, this._activeBuffer.ybase + this._activeBuffer.y), r2 || !this._activeBuffer.x) {
                  if (this._activeBuffer.x + r2 - 1 >= h4) {
                    if (c2) {
                      for (; this._activeBuffer.x < h4; )
                    ...
                    } else if (this._activeBuffer.x = h4 - 1, 2 === r2)
                      continue;
                  }
                  if (d2 && (u2.insertCells(this._activeBuffer.x, r2, this._activeBuffer.getNullCell(_2), _2), 2 === u2.getWidth(h4 - 1) && u2.setCellFromCodePoint(h4 - 1, l.NULL_CELL_CODE, l.NULL_CELL_WIDTH, _2.fg, _2.bg, _2.extended)), u2.setCellFromCodePoint(this._activeBuffer.x++, s3, r2, _2.fg, _2.bg, _2.extended), r2 > 0)
                    for (; --r2; )
            ...
            scrollDown(e3) {
              let t3 = e3.params[0] || 1;
              for (; t3--; )
                this._activeBuffer.lines.splice(this._activeBuffer.ybase + this._activeBuffer.scrollBottom, 1), this._activeBuffer.lines.splice(this._activeBuffer.ybase + this._activeBuffer.scrollTop, 0, this._activeBuffer.getBlankLine(h3.DEFAULT_ATTR_DATA));
              return this._dirtyRowService.markRangeDirty(this._activeBuffer.scrollTop, this._activeBuffer.scrollBottom), true;
            }
            scrollLeft(e3) {
              if (this._activeBuffer.y > this._activeBuffer.scrollBottom || this._activeBuffer.y < this._activeBuffer.scrollTop)
            ...
            requestMode(e3, t3) {
              const i3 = this._coreService.decPrivateModes, { activeProtocol: r2, activeEncoding: n2 } = this._coreMouseService, o2 = this._coreService, { buffers: a2, cols: h4 } = this._bufferService, { active: c2, alt: l2 } = a2, d2 = this._optionsService.rawOptions, _2 = (e4) => e4 ? 1 : 2, u2 = e3.params[0];
            ...
            charAttributes(e3) {
              if (1 === e3.length && 0 === e3.params[0])
                return this._curAttrData.fg = h3.DEFAULT_ATTR_DATA.fg, this._curAttrData.bg = h3.DEFAULT_ATTR_DATA.bg, true;
              const t3 = e3.length;
              let i3;
              const s3 = this._curAttrData;
              for (let r2 = 0; r2 < t3; r2++)
                i3 = e3.params[r2], i3 >= 30 && i3 <= 37 ? (s3.fg &= -50331904, s3.fg |= 16777216 | i3 - 30) : i3 >= 40 && i3 <= 47 ? (s3.bg &= -50331904, s3.bg |= 16777216 | i3 - 40) : i3 >= 90 && i3 <= 97 ? (s3.fg &= -50331904, s3.fg |= 16777224 | i3 - 90) : i3 >= 100 && i3 <= 107 ? (s3.bg &= -50331904, s3.bg |= 16777224 | i3 - 100) : 0 === i3 ? (s3.fg = h3.DEFAULT_ATTR_DATA.fg, s3.bg = h3.DEFAULT_ATTR_DATA.bg) : 1 === i3 ? s3.fg |= 134217728 : 3 === i3 ? s3.bg |= 67108864 : 4 === i3 ? (s3.fg |= 268435456, this._processUnderline(e3.hasSubParams(r2) ? e3.getSubParams(r2)[0] : 1, s3)) : 5 === i3 ? s3.fg |= 536870912 : 7 === i3 ? s3.fg |= 67108864 : 8 === i3 ? s3.fg |= 1073741824 : 9 === i3 ? s3.fg |= 2147483648 : 2 === i3 ? s3.bg |= 134217728 : 21 === i3 ? this._processUnderline(2, s3) : 22 === i3 ? (s3.fg &= -134217729, s3.bg &= -134217729) : 23 === i3 ? s3.bg &= -67108865 : 24 === i3 ? (s3.fg &= -268435457, this._processUnderline(0, s3)) : 25 === i3 ? s3.fg &= -536870913 : 27 === i3 ? s3.fg &= -67108865 : 28 === i3 ? s3.fg &= -1073741825 : 29 === i3 ? s3.fg &= 2147483647 : 39 === i3 ? (s3.fg &= -67108864, s3.fg |= 16777215 & h3.DEFAULT_ATTR_DATA.fg) : 49 === i3 ? (s3.bg &= -67108864, s3.bg |= 16777215 & h3.DEFAULT_ATTR_DATA.bg) : 38 === i3 || 48 === i3 || 58 === i3 ? r2 += this._extractColor(e3, r2, s3) : 59 === i3 ? (s3.extended = s3.extended.clone(), s3.extended.underlineColor = -1, s3.updateExtended()) : 100 === i3 ? (s3.fg &= -67108864, s3.fg |= 16777215 & h3.DEFAULT_ATTR_DATA.fg, s3.bg &= -67108864, s3.bg |= 16777215 & h3.DEFAULT_ATTR_DATA.bg) : this._logService.debug("Unknown SGR attribute: %d.", i3);
              return true;
            }
            deviceStatus(e3) {
              switch (e3.params[0]) {
            ...
            reset() {
              this._curAttrData = h3.DEFAULT_ATTR_DATA.clone(), this._eraseAttrDataInternal = h3.DEFAULT_ATTR_DATA.clone();
            }
            _eraseAttrData() {
          ...
          const s2 = i2(6349), r = i2(8437), n = i2(511), o = i2(643), a = i2(4634), h3 = i2(4863), c = i2(7116), l = i2(3734);
          t2.MAX_BUFFER_SIZE = 4294967295, t2.Buffer = class {
            ...
            _reflowSmaller(e3, t3) {
              ...
              for (let o2 = this.lines.length - 1; o2 >= 0; o2--) {
                let h4 = this.lines.get(o2);
                if (!h4 || !h4.isWrapped && h4.getTrimmedLength() <= e3)
                  continue;
                const c2 = [h4];
                for (; h4.isWrapped && o2 > 0; )
                  h4 = this.lines.get(--o2), c2.unshift(h4);
                ...
                for (; S >= 0; ) {
                  const e4 = Math.min(m, p2);
                  if (void 0 === c2[g])
                    break;
                  if (c2[g].copyCellsFrom(c2[S], m - e4, p2 - e4, e4, true), p2 -= e4, 0 === p2 && (g--, p2 = _[g]), m -= e4, 0 === m) {
                    S--;
              ...
              if (s3.length > 0) {
                ...
                for (let c3 = Math.min(this.lines.maxLength - 1, i4 + n2 - 1); c3 >= 0; c3--)
                  if (a2 && a2.start > r2 + h4) {
                    for (let e5 = a2.newLines.length - 1; e5 >= 0; e5--)
                      this.lines.set(c3--, a2.newLines[e5]);
                    c3++, e4.push({ index: r2 + 1, amount: a2.newLines.length }), h4 += a2.newLines.length, a2 = s3[++o2];
                  } else
          ...
          Object.defineProperty(t2, "__esModule", { value: true }), t2.getWrappedLineTrimmedLength = t2.reflowSmallerGetNewLineLengths = t2.reflowLargerApplyNewLayout = t2.reflowLargerCreateNewLayout = t2.reflowLargerGetLinesToRemove = void 0, t2.reflowLargerGetLinesToRemove = function(e3, t3, s2, r, n) {
            ...
            for (let a = 0; a < e3.length - 1; a++) {
              ...
              if (!c.isWrapped)
                continue;
              const l = [e3.get(a)];
              for (; h3 < e3.length && c.isWrapped; )
                l.push(c), c = e3.get(++h3);
              if (r >= a && r < h3) {
                a += l.length - 1;
                continue;
              }
            ...
            decode(e3, t3) {
              ...
              for (; d < i2; ) {
                ...
                if (s2 = e3[d++], s2 < 128)
                  ...
                  if (h3 = (15 & s2) << 12 | (63 & r) << 6 | 63 & n, h3 < 2048 || h3 >= 55296 && h3 <= 57343 || 65279 === h3)
                    continue;
                  t3[a++] = h3;
                } else if (240 == (248 & s2)) {
                  if (d >= i2)
                  ...
                  if (h3 = (7 & s2) << 18 | (63 & r) << 12 | (63 & n) << 6 | 63 & o, h3 < 65536 || h3 > 1114111)
                    continue;
                  t3[a++] = h3;
                }
              }
          ...
          t2.TransitionTable = h3;
          const c = 160;
          t2.VT500_TRANSITION_TABLE = function() {
            const e3 = new h3(4095), t3 = Array.apply(null, Array(256)).map((e4, t4) => t4), i3 = (e4, i4) => t3.slice(e4, i4), s3 = i3(32, 127), r2 = i3(0, 24);
              ...
              for (let i4 = o2; i4 < t3; ++i4) {
                switch (r2 = e3[i4], n2 = this._transitions.table[this.currentState << 8 | (r2 < 160 ? r2 : c)], n2 >> 4) {
                  ...
                  case 9:
                    ...
                    break;
                  case 10:
                    const h4 = this._escHandlers[this._collect << 8 | r2];
                    let l2 = h4 ? h4.length - 1 : -1;
                    for (; l2 >= 0 && (s3 = h4[l2](), true !== s3); l2--)
                      if (s3 instanceof Promise)
                        return this._preserveStack(4, h4, l2, n2, i4), s3;
          ...
          const n = i2(2585), o = i2(5295), a = i2(8460), h3 = i2(844);
          t2.MINIMUM_COLS = 2, t2.MINIMUM_ROWS = 1;
          let c = class extends h3.Disposable {
            constructor(e3) {
          ...
          const c = String.fromCharCode, l = { DEFAULT: (e3) => {
            const t3 = [h3(e3, false) + 32, e3.col + 32, e3.row + 32];
            return t3[0] > 255 || t3[1] > 255 || t3[2] > 255 ? "" : `\x1B[M${c(t3[0])}${c(t3[1])}${c(t3[2])}`;
          }, SGR: (e3) => {
            const t3 = 0 === e3.action && 4 !== e3.button ? "m" : "M";
            return `\x1B[<${h3(e3, true)};${e3.col};${e3.row}${t3}`;
          }, SGR_PIXELS: (e3) => {
            const t3 = 0 === e3.action && 4 !== e3.button ? "m" : "M";
            return `\x1B[<${h3(e3, true)};${e3.x};${e3.y}${t3}`;
          } };
          let d = class {
            constructor(e3, t3) {
          ...
          const n = i2(2585), o = i2(8460), a = i2(1439), h3 = i2(844), c = Object.freeze({ insertMode: false }), l = Object.freeze({ applicationCursorKeys: false, applicationKeypad: false, bracketedPasteMode: false, origin: false, reverseWraparound: false, sendFocus: false, wraparound: true });
          let d = class extends h3.Disposable {
            constructor(e3, t3, i3, s3) {
          ...
          class h3 extends n.Disposable {
            ...
            *getDecorationsAtCell(e3, t3, i3) {
              var s3, r2, n2;
              let o2 = 0, a2 = 0;
              for (const h4 of this._decorations.getKeyIterator(t3))
                o2 = null !== (s3 = h4.options.x) && void 0 !== s3 ? s3 : 0, a2 = o2 + (null !== (r2 = h4.options.width) && void 0 !== r2 ? r2 : 1), e3 >= o2 && e3 < a2 && (!i3 || (null !== (n2 = h4.options.layer) && void 0 !== n2 ? n2 : "bottom") === i3) && (yield h4);
            }
        ...
        return (() => {
          ...
          const t2 = i(3236), r = i(9042), n = i(7975), o = i(7090), a = i(5741), h3 = i(8285), c = ["cols", "rows"];
          e2.Terminal = class {
            constructor(e3) {
            ...
            get buffer() {
              return this._checkProposedApi(), this._buffer || (this._buffer = new h3.BufferNamespaceApi(this._core)), this._buffer;
            }
            get markers() {
        ...
        return (() => {
          ...
          class i {
            ...
            serialize(t2) {
              ...
              for (let h4 = r2; h4 <= l2; h4++) {
                const r3 = this._buffer.getLine(h4);
                if (r3) {
                  const l3 = h4 !== t2.start.x ? 0 : o2, u = h4 !== t2.end.x ? r3.length : n2;
                  for (let t3 = l3; t3 < u; t3++) {
                    const l4 = r3.getCell(t3, i2 === e2 ? s2 : e2);
                    l4 ? (this._nextCell(l4, i2, h4, t3), i2 = l4) : console.warn(`Can't get cell at row=${h4}, col=${t3}`);
                  }
                }
                this._rowEnd(h4, h4 === l2);
              }
          ...
          class n extends i {
            ...
            _rowEnd(t2, e2) {
              ...
              if (!e2) {
                ...
                if (r2.isWrapped) {
                  i2 = "";
                  const s3 = e3.getCell(e3.length - 1, this._thisRowLastChar), o2 = e3.getCell(e3.length - 2, this._thisRowLastSecondChar), n2 = r2.getCell(0, this._nextRowFirstChar), h4 = n2.getWidth() > 1;
                  let u = false;
                  (n2.getChars() && h4 ? this._nullCellCount <= 1 : this._nullCellCount <= 0) && ((s3.getChars() || 0 === s3.getWidth()) && l(s3, n2) && (u = true), h4 && (o2.getChars() || 0 === o2.getWidth()) && l(s3, n2) && l(o2, n2) && (u = true)), u || (i2 = "-".repeat(this._nullCellCount + 1), i2 += "\x1B[1D\x1B[1X", this._nullCellCount > 0 && (i2 += "\x1B[A", i2 += `\x1B[${e3.length - this._nullCellCount}C`, i2 += `\x1B[${this._nullCellCount}X`, i2 += `\x1B[${e3.length - this._nullCellCount}D`, i2 += "\x1B[B"), this._lastContentCursorRow = t2 + 1, this._lastContentCursorCol = 0, this._lastCursorRow = t2 + 1, this._lastCursorCol = 0);
                } else
            ...
            _diffStyle(t2, e2) {
              const s2 = [], i2 = !r(t2, e2), n2 = !l(t2, e2), h4 = !o(t2, e2);
              if (i2 || n2 || h4)
          ...
          e.SerializeAddon = class {
            ...
            _serializeBufferAsHTML(t2, e2) {
              var i2, r2;
              const l2 = t2.buffer.active, o2 = new h3(l2, t2, e2);
          ...
          class h3 extends i {
            ...
            _beforeSerialize(t2, e2, s2) {
              ...
              let h4 = "#000000", u = "#ffffff";
              null !== (i2 = this._options.includeGlobalBackground) && void 0 !== i2 && i2 && (h4 = null !== (l2 = null === (r2 = this._terminal.options.theme) || void 0 === r2 ? void 0 : r2.foreground) && void 0 !== l2 ? l2 : "#ffffff", u = null !== (n2 = null === (o2 = this._terminal.options.theme) || void 0 === o2 ? void 0 : o2.background) && void 0 !== n2 ? n2 : "#000000");
              const a = [];
              a.push("color: " + h4 + ";"), a.push("background-color: " + u + ";"), a.push("font-family: " + this._terminal.options.fontFamily + ";"), a.push("font-size: " + this._terminal.options.fontSize + "px;"), this._htmlContent += "<div style='" + a.join(" ") + "'>";
            }
            _afterSerialize() {
