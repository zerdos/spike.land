...
var DraggableWindowLazy = (0, import_react.lazy)(() => import("./chunk-DraggableWindow-FF3SJ3ZG.mjs"));
...
async function join() {
  ...
  wsConnection.addEventListener("open", () => {
    ...
    const mess = /* @__PURE__ */ __name((data) => {
      try {
        if ((ws == null ? void 0 : ws.readyState) === (ws == null ? void 0 : ws.OPEN))
