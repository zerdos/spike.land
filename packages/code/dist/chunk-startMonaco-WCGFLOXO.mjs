...
// ../../.yarn/global/cache/monaco-editor-npm-0.34.0-2a8aa5269e-8.zip/node_modules/monaco-editor/esm/vs/base/browser/ui/codicons/codicon/codicon.ttf
...
var monacoContribution = async (typescript, editor2, code) => {
  ...
  (async () => {
    const { dtsFiles } = await import("./chunk-types-7OXTJSVP.mjs");
    const {
      reactDts,
      jsxRuntimeDts,
      propTypesDts,
...
var tsWorker = TSWorker();
var ediWorker = EditorWorker();
