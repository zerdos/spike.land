...
var mixComplex = (origin2, target) => {
  ...
  if (canInterpolate) {
    ...
    (0, import_hey_listen3.warning)(true, `Complex values '${origin2}' and '${target}' too different to mix. Ensure all colors are of the same type, and that each contains the same quantity of number and color values. Falling back to instant transition.`);
...
function getAnimation(key, value, target, transition, onComplete) {
  ...
  (0, import_hey_listen6.warning)(isOriginAnimatable === isTargetAnimatable, `You are trying to animate ${key} from "${origin2}" to "${target}". ${origin2} is not an animatable value - to enable this animation set ${origin2} to a value animatable to ${target} via the \`style\` property.`);
  function start() {
    const options = {
      from: origin2,
      to: target,
...
var animations = {
  animation: makeRenderlessComponent(({ visualElement: visualElement2, animate: animate3 }) => {
    ...
    if (isAnimationControls(animate3)) {
      (0, import_react23.useEffect)(() => animate3.subscribe(visualElement2), [animate3]);
    }
  }),
  ...
  const element = {
    ...
    loadFeatures(renderedProps, isStrict, preloadedFeatures, projectionId, ProjectionNodeConstructor, initialLayoutGroupConfig) {
      ...
      if (env !== "production" && preloadedFeatures && isStrict) {
        (0, import_hey_listen8.invariant)(false, "You have rendered a `motion` component within a `LazyMotion` component. This will break tree shaking. Import and render a `m` component instead.");
      }
...
function getVariableValue(current, element, depth = 1) {
  (0, import_hey_listen9.invariant)(depth <= maxDepth, `Max CSS variable fallback depth detected in property "${current}". This may indicate a circular fallback dependency.`);
    ...
    if (isKeyframesTarget(to)) {
      ...
      for (let i = fromIndex; i < numKeyframes; i++) {
        if (!toType) {
          ...
          (0, import_hey_listen10.invariant)(findDimensionValueType(to[i]) === toType, "All keyframes must be of the same type");
        }
      }
    } else {
...
init_define_process();
var import_hey_listen11 = __toESM(require_dist(), 1);
...
init_define_process();
var import_hey_listen12 = __toESM(require_dist(), 1);
...
function ReorderGroup({ children, as = "ul", axis = "y", onReorder, values, ...props }, externalRef) {
  ...
  (0, import_hey_listen12.invariant)(Boolean(values), "Reorder.Group must be provided a values prop");
  const context = {
    axis,
...
init_define_process();
var import_hey_listen13 = __toESM(require_dist(), 1);
...
function ReorderItem({ children, style = {}, value, as = "li", onDrag, layout = true, ...props }, externalRef) {
  ...
  (0, import_hey_listen13.invariant)(Boolean(context), "Reorder.Item must be a child of Reorder.Group");
  const { axis, registerItem, updateOrder } = context;
  (0, import_react40.useEffect)(() => {
    registerItem(value, measuredLayout.current);
  }, [context]);
  return React10.createElement(Component2, { drag: axis, ...props, dragSnapToOrigin: true, style: { ...style, x: point.x, y: point.y, zIndex }, layout, onDrag: (event, gesturePoint) => {
...
init_define_process();
var import_dom = __toESM(require_index_cjs(), 1);
...
init_define_process();
var import_hey_listen14 = __toESM(require_dist(), 1);
...
var import_dom2 = __toESM(require_index_cjs(), 1);
...
init_define_process();
var import_hey_listen15 = __toESM(require_dist(), 1);
...
var FabLazy = (0, import_react58.lazy)(async () => import("./chunk-Fab-7EVHOTXP.mjs"));
...
var ToggleButtonLazy = (0, import_react58.lazy)(async () => import("./chunk-ToggleButton-PSFI4EPN.mjs"));
...
var ToggleButtonGroupLazy = (0, import_react58.lazy)(async () => import("./chunk-ToggleButtonGroup-NTLXUDDN.mjs"));
  ...
  const constraintsToChrome_ = function(c2) {
    ...
    Object.keys(c2).forEach((key) => {
      ...
      if (r.exact !== void 0 && typeof r.exact !== "number") {
        ...
        ["min", "max"].forEach((mix2) => {
          if (r[mix2] !== void 0) {
            cc2.mandatory = cc2.mandatory || {};
            cc2.mandatory[oldname_(mix2, key)] = r[mix2];
          }
        });
      }
    });
...
// ../../.yarn/global/cache/uuid-npm-9.0.0-46c41e3e43-9.zip/node_modules/uuid/dist/esm-browser/v1.js
init_define_process();
...
// ../../.yarn/global/cache/uuid-npm-9.0.0-46c41e3e43-9.zip/node_modules/uuid/dist/esm-browser/validate.js
init_define_process();

// ../../.yarn/global/cache/uuid-npm-9.0.0-46c41e3e43-9.zip/node_modules/uuid/dist/esm-browser/regex.js
init_define_process();
...
// ../../.yarn/global/cache/uuid-npm-9.0.0-46c41e3e43-9.zip/node_modules/uuid/dist/esm-browser/v3.js
init_define_process();

// ../../.yarn/global/cache/uuid-npm-9.0.0-46c41e3e43-9.zip/node_modules/uuid/dist/esm-browser/v35.js
init_define_process();

// ../../.yarn/global/cache/uuid-npm-9.0.0-46c41e3e43-9.zip/node_modules/uuid/dist/esm-browser/parse.js
init_define_process();
...
// ../../.yarn/global/cache/uuid-npm-9.0.0-46c41e3e43-9.zip/node_modules/uuid/dist/esm-browser/md5.js
init_define_process();
function md5(bytes) {
...
// ../../.yarn/global/cache/uuid-npm-9.0.0-46c41e3e43-9.zip/node_modules/uuid/dist/esm-browser/v5.js
init_define_process();

// ../../.yarn/global/cache/uuid-npm-9.0.0-46c41e3e43-9.zip/node_modules/uuid/dist/esm-browser/sha1.js
init_define_process();
function f(s, x, y, z) {
  switch (s) {
    case 0:
...
function sha1(bytes) {
  ...
  for (let i = 0; i < N; ++i) {
    ...
    for (let t = 0; t < 80; ++t) {
      ...
      const T = ROTL(a2, 5) + f(s, b2, c2, d) + e + K[s] + W[t] >>> 0;
      e = d;
      d = c2;
      c2 = ROTL(b2, 30) >>> 0;
      b2 = a2;
...
// ../../.yarn/global/cache/uuid-npm-9.0.0-46c41e3e43-9.zip/node_modules/uuid/dist/esm-browser/nil.js
init_define_process();

// ../../.yarn/global/cache/uuid-npm-9.0.0-46c41e3e43-9.zip/node_modules/uuid/dist/esm-browser/version.js
init_define_process();
