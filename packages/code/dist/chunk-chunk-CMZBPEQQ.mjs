...
var Editor = ({ code, i, codeSpace: codeSpace2 }) => {
  ...
  const [
    ...
    runner: async ({ code: code2, counter: counter2, codeSpace: codeSpace3 }) => {
      const { runner: runner2 } = await import("./chunk-runner-6F4BRQXQ.mjs");
  ...
  useEffect30(() => {
    ...
    const setMonaco = async () => {
      const { startMonaco } = await import("./chunk-startMonaco-PEV4TY6X.mjs");
...
//# sourceMappingURL=chunk-chunk-CMZBPEQQ.mjs.map
