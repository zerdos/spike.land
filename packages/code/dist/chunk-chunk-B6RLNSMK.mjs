...
init_react_preact();
var import_jsx_runtime = __toESM(require_emotion_react_jsx_runtime_cjs());
...
var AutoUpdateApp = /* @__PURE__ */ __name(({ hash: hash3 }) => {
  ...
  3;
  return (0, import_jsx_runtime.jsx)(ErrorBoundaryJ, {
    ref,
...
// js/renderPreviewWindow.tsx
var import_react27 = __toESM(require_emotion_react_cjs());

// js/DraggableWindow.tsx
var import_react21 = __toESM(require_emotion_react_cjs());
init_react_preact();

// js/Qr.tsx
var import_react19 = __toESM(require_emotion_react_cjs());
init_react_preact();
...
// js/Editor.tsx
var import_react24 = __toESM(require_emotion_react_cjs());
var import_jsx_runtime = __toESM(require_emotion_react_jsx_runtime_cjs());
var mod = {
  CH: () => {
  },
...
var Editor = /* @__PURE__ */ __name(({ code, i, codeSpace: codeSpace2, assets }) => {
  ...
  const [
    ...
    runner: async ({ code: code2, counter: counter2, codeSpace: codeSpace3 }) => {
      const { runner: runner2 } = await import("./chunk-runner-LFLW4QEO.mjs");
      const { prettierJs: prettierJs2 } = await import("./chunk-prettierEsm-V24ZN6IP.mjs");
  ...
  useEffect(() => {
    ...
    const setAce = /* @__PURE__ */ __name(async () => {
      const { startAce } = await import("./chunk-startAce-JF6RPONS.mjs");
