...
// js/md5.js
init_define_process();
var md5 = (code) => md5FULL(code).split("0").join("k").split("1").join("l").split("2").join("m").split("3").join("s").split("4").join("b").split("5").join("n").split("6").join("o").split("7").join("X").split("8").join("w").split("9").join("z").slice(0, 8);
