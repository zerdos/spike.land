...
var initShims = async (assets) => {
  if (importmapped)
    return;
  importmapped = true;
  await import("./chunk-es-module-shims-5WNLRQVR.mjs");
...
var Editor = ({ code, i, codeSpace: codeSpace2 }) => {
  ...
  const [
    ...
    runner: async ({ code: code2, counter: counter2 }) => {
      const { runner: runner2 } = await import("./chunk-runner-TH6AYPOC.mjs");
  ...
  useEffect(() => {
    ...
    const setMonaco = async () => {
      const { startMonaco } = await import("./chunk-startMonaco-CNYD4FXJ.mjs");
    ...
    const setAce = async () => {
      const { startAce } = await import("./chunk-startAce-ZKMBTVSY.mjs");
    ...
    const loadEditors = async () => {
      ...
      const { prettierJs: prettierJs2 } = await import("./chunk-prettierEsm-XCYXTMCI.mjs");
