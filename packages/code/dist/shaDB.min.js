...
function sn() {
  return He ||
    (He = [IDBDatabase, IDBObjectStore, IDBIndex, IDBCursor, IDBTransaction]);
}
function an() {
  return Ee ||
    (Ee = [
...
const de = (i) => ce.get(i),
  ln = ["get", "getKey", "getAll", "getAllKeys", "count"],
...
(function (i, a) {
  ...
  a.prototype = {
    ...
    extractCommon: function (e, n, t, r) {
      ...
      return c && e.components.push({ count: c }), e.newPos = u, l;
    },
    equals: function (e, n) {
      return this.options.comparator ? this.options.comparator(e, n)
      : e === n ||
  ...
  function B(e, n, t) {
    return t = v(t, { ignoreWhitespace: !0 }), F.diff(e, n, t);
  }
  function z(e, n, t) {
    return F.diff(e, n, t);
  }
  ...
  M.tokenize = function (e) {
    ...
    for (var r = 0; r < t.length; r++) {
      var s = t[r];
      r % 2 && !this.options.newlineIsToken ? n[n.length - 1] += s
...
`;
  ...
  function Xe(e, n, t) {
    ...
    (e.index || n.index) && (r.index = e.index || n.index),
      (e.newFileName || n.newFileName) && (xe(e)
        ? xe(n)
    ...
    for (
      ...
      var c = e.hunks[s] || { oldStart: Infinity },
...
const dn = (i) => {
    ...
    const a = [...i.slice(0, 8)].filter((g) => g < "0" || g > "f").length === 0,
      f = i.slice(8);
...
let pe = {
  ...
  has(i, a) {
    return i instanceof IDBTransaction && (a === "done" || a === "store") ? !0
    : a in i;
  },
};
function Sn(i) {
...
function xn(i) {
  return i === IDBDatabase.prototype.transaction &&
    ...
    ? function (a, ...f) {
      const g = i.call(de(this), a, ...f);
      return Ce.set(g, a.sort ? a.sort() : [a]), T(g);
    }
    : an().includes(i)
    ? function (...a) {
      return i.apply(de(this), a), T(Pe.get(this));
    }
    : function (...a) {
      return T(i.apply(de(this), a));
    };
}
function bn(i) {
...
function T(i) {
  ...
  const a = bn(i);
  return a !== i && (fe.set(i, a), ce.set(a, i)), a;
}
function Ln(i, a, { blocked: f, upgrade: g, blocking: p, terminated: w } = {}) {
...
Sn((i) => ({
  ...i,
  get: (a, f, g) => Ie(a, f) || i.get(a, f, g),
  has: (a, f) => !!Ie(a, f) || i.has(a, f),
}));
export const getDB = () => {
  const i = Ln("localZedCodeStore", 1, {
    upgrade(a) {
      a.createObjectStore("codeStore");
    },
    blocked() {},
    blocking() {},
    terminated() {},
