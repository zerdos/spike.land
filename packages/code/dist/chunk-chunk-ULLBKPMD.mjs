...
// node_modules/@emotion/react/jsx-runtime/dist/emotion-react-jsx-runtime.cjs.prod.js
var require_emotion_react_jsx_runtime_cjs_prod = __commonJS({
  "node_modules/@emotion/react/jsx-runtime/dist/emotion-react-jsx-runtime.cjs.prod.js"(exports) {
    "use strict";
    init_define_process();
...
var Editor = /* @__PURE__ */ __name(({ code, i, codeSpace: codeSpace2, assets }) => {
  ...
  const [
    ...
    runner: async ({ code: code2, counter: counter2, codeSpace: codeSpace3 }) => {
      const { runner: runner2 } = await import("./chunk-runner-M2XFKDYG.mjs");
      const { prettierJs: prettierJs2 } = await import("./chunk-prettierEsm-WX7O74VL.mjs");
  ...
  useEffect(() => {
    ...
    const setAce = /* @__PURE__ */ __name(async () => {
      const { startAce } = await import("./chunk-startAce-OPG4K7SV.mjs");
