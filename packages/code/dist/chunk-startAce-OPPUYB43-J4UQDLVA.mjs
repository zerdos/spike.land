...
// dist/chunk-startAce-OPPUYB43.mjs
  ...
  "../../../../.yarn/global/cache/ace-builds-npm-1.10.0-88e03578a8-9c9.zip/node_modules/ace-builds/src-noconflict/ace.js"(exports, module) {
    ...
    (function() {
      ...
      if (!ACE_NAMESPACE && typeof requirejs !== "undefined")
        return;
      var define2 = __name(function(module2, deps, payload) {
      ...
      define2.modules = {};
      define2.payloads = {};
      var _require = __name(function(parentId, module2, callback) {
        if (typeof module2 === "string") {
      ...
      var require2 = __name(function(module2, callback) {
      ...
      var normalizeModule = __name(function(parentId, moduleName) {
      ...
      var lookup = __name(function(parentId, moduleName) {
        ...
        if (!module2) {
          ...
          if (typeof module2 === "function") {
            ...
            var req = __name(function(module3, callback) {
    ...
    ace.define("ace/lib/lang", ["require", "exports", "module"], function(require2, exports2, module2) {
      ...
      exports2.deepCopy = __name(function deepCopy(obj) {
      ...
      exports2.deferredCall = function(fcn) {
        var timer = null;
        var callback = __name(function() {
          timer = null;
          fcn();
        }, "callback");
        var deferred = __name(function(timeout) {
          deferred.cancel();
      ...
      exports2.delayedCall = function(fcn, defaultTimeout) {
        ...
        var _self = __name(function(timeout) {
          if (timer == null)
    ...
    ace.define("ace/lib/dom", ["require", "exports", "module", "ace/lib/useragent"], function(require2, exports2, module2) {
      ...
      exports2.buildDom = __name(function buildDom(arr, parent, refs) {
    ...
    ace.define("ace/lib/event_emitter", ["require", "exports", "module"], function(require2, exports2, module2) {
      "use strict";
      var EventEmitter = {};
      var stopPropagation = __name(function() {
        this.propagationStopped = true;
      }, "stopPropagation");
      var preventDefault = __name(function() {
      ...
      EventEmitter.once = function(eventName, callback) {
        var _self = this;
        this.on(eventName, __name(function newCallback() {
    ...
    ace.define("ace/config", ["require", "exports", "module", "ace/lib/lang", "ace/lib/oop", "ace/lib/net", "ace/lib/dom", "ace/lib/app_config", "ace/theme/textmate"], function(require2, exports2, module2) {
      ...
      var loader = __name(function(moduleName, cb) {
      ...
      var reportErrorIfPathIsNotConfigured = __name(function() {
        if (!options.basePath && !options.workerPath && !options.modePath && !options.themePath && !Object.keys(options.$moduleUrls).length) {
          ...
          reportErrorIfPathIsNotConfigured = __name(function() {
          }, "reportErrorIfPathIsNotConfigured");
        }
      }, "reportErrorIfPathIsNotConfigured");
    ...
    ace.define("ace/lib/event", ["require", "exports", "module", "ace/lib/keys", "ace/lib/useragent"], function(require2, exports2, module2) {
      ...
      var getModifierHash = __name(function(e) {
      ...
      exports2.onIdle = function(cb, timeout) {
        return setTimeout(__name(function handler() {
    ...
    ace.define("ace/range", ["require", "exports", "module"], function(require2, exports2, module2) {
      "use strict";
      var comparePoints = __name(function(p1, p2) {
        return p1.row - p2.row || p1.column - p2.column;
      }, "comparePoints");
      var Range = __name(function(startRow, startColumn, endRow, endColumn) {
        this.start = {
          row: startRow,
          column: startColumn
        };
    ...
    ace.define("ace/keyboard/textinput", ["require", "exports", "module", "ace/lib/event", "ace/lib/useragent", "ace/lib/dom", "ace/lib/lang", "ace/clipboard", "ace/lib/keys"], function(require2, exports2, module2) {
      ...
      var TextInput = __name(function(parentNode, host) {
        ...
        if (isFocused)
          host.onFocus();
        var isAllSelected = __name(function(text2) {
        ...
        var onSelect = __name(function(e) {
          if (inComposition)
            return;
          if (copied) {
            copied = false;
        ...
        var sendText = __name(function(value, fromInput) {
          if (afterContextMenu)
        ...
        var handleClipboardData = __name(function(e, data, forceIEMime) {
        ...
        var doCopy = __name(function(e, isCut) {
        ...
        var onCut = __name(function(e) {
          doCopy(e, true);
        }, "onCut");
        var onCopy = __name(function(e) {
          doCopy(e, false);
        }, "onCopy");
        var onPaste = __name(function(e) {
        ...
        var onCompositionStart = __name(function(e) {
        ...
        var onCompositionUpdate = __name(function() {
        ...
        var onCompositionEnd = __name(function(e) {
        ...
        var onContextMenu = __name(function(e) {
        ...
        function addIosSelectionHandler(parentNode2, host2, text2) {
          ...
          var detectArrowKeys = __name(function(e) {
    ...
    ace.define("ace/mouse/touch_handler", ["require", "exports", "module", "ace/mouse/mouse_event", "ace/lib/event", "ace/lib/dom"], function(require2, exports2, module2) {
      ...
      exports2.addTouchListeners = function(el, editor) {
        ...
        function createContextMenu() {
          ...
          var isOpen = false;
          var updateMenu = __name(function() {
          ...
          var handleClick = __name(function(e) {
        ...
        event.addListener(el, "touchstart", function(e) {
          ...
          if (t - touchStartT < 500 && touches.length == 1 && !animationSteps) {
            ...
            var weightedDistance = __name(function(x2, y2) {
              x2 = x2 / w;
              y2 = y2 / h - 0.75;
              return x2 * x2 + y2 * y2;
            }, "weightedDistance");
    ...
    ace.define("ace/mouse/mouse_handler", ["require", "exports", "module", "ace/lib/event", "ace/lib/useragent", "ace/mouse/default_handlers", "ace/mouse/default_gutter_handler", "ace/mouse/mouse_event", "ace/mouse/dragdrop_handler", "ace/mouse/touch_handler", "ace/config"], function(require2, exports2, module2) {
      ...
      var config = require2("../config");
      var MouseHandler = __name(function(editor) {
        var _self = this;
        this.editor = editor;
        new DefaultHandlers(this);
        new DefaultGutterHandler(this);
        new DragdropHandler(this);
        var focusEditor = __name(function(e) {
      ...
      (function() {
        ...
        this.captureMouse = function(ev, mouseMoveHandler) {
          ...
          var self = this;
          var onMouseMove = __name(function(e) {
            if (!e)
              return;
          ...
          var onCaptureEnd = __name(function(e) {
          ...
          var onCaptureInterval = __name(function() {
          ...
          var onOperationEnd = __name(function(e) {
    ...
    ace.define("ace/keyboard/keybinding", ["require", "exports", "module", "ace/lib/keys", "ace/lib/event"], function(require2, exports2, module2) {
      ...
      var event = require2("../lib/event");
      var KeyBinding = __name(function(editor) {
        this.$editor = editor;
        this.$data = { editor };
        this.$handlers = [];
    ...
    ace.define("ace/bidihandler", ["require", "exports", "module", "ace/lib/bidiutil", "ace/lib/lang"], function(require2, exports2, module2) {
      ...
      var lang = require2("./lib/lang");
      var bidiRE = /[\u0590-\u05f4\u0600-\u06ff\u0700-\u08ac\u202B]/;
      var BidiHandler = __name(function(session) {
    ...
    ace.define("ace/selection", ["require", "exports", "module", "ace/lib/oop", "ace/lib/lang", "ace/lib/event_emitter", "ace/range"], function(require2, exports2, module2) {
      ...
      var Selection = __name(function(session) {
        this.session = session;
    ...
    ace.define("ace/tokenizer", ["require", "exports", "module", "ace/config"], function(require2, exports2, module2) {
      ...
      var Tokenizer = __name(function(rules) {
        this.states = rules;
        this.regExps = {};
        this.matchMappings = {};
    ...
    ace.define("ace/mode/text_highlight_rules", ["require", "exports", "module", "ace/lib/lang"], function(require2, exports2, module2) {
      "use strict";
      var lang = require2("../lib/lang");
      var TextHighlightRules = __name(function() {
        this.$rules = {
          "start": [{
            token: "empty_line",
            regex: "^$"
      ...
      (function() {
        ...
        var pushState = __name(function(currentState, stack) {
          if (currentState != "start" || stack.length)
            stack.unshift(this.nextState, currentState);
          return this.nextState;
        }, "pushState");
        var popState = __name(function(currentState, stack) {
          stack.shift();
    ...
    ace.define("ace/token_iterator", ["require", "exports", "module", "ace/range"], function(require2, exports2, module2) {
      "use strict";
      var Range = require2("./range").Range;
      var TokenIterator = __name(function(session, initialRow, initialColumn) {
        this.$session = session;
        this.$row = initialRow;
    ...
    ace.define("ace/mode/behaviour/cstyle", ["require", "exports", "module", "ace/lib/oop", "ace/mode/behaviour", "ace/token_iterator", "ace/lib/lang"], function(require2, exports2, module2) {
      ...
      var contextCache = {};
      var defaultQuotes = { '"': '"', "'": "'" };
      var initContext = __name(function(editor) {
        var id = -1;
      ...
      var getWrapped = __name(function(selection, selected, opening, closing) {
      ...
      var CstyleBehaviour = __name(function(options) {
      ...
      (function() {
        ...
        this.toggleCommentLines = function(state, session, startRow, endRow) {
          ...
          if (!this.lineCommentStart) {
            ...
            var comment = __name(function(line, i) {
            ...
            var uncomment = __name(function(line, i) {
              var m;
            ...
            var testRemove = __name(function(line, row) {
            ...
            var testRemove = __name(function(line, i) {
              return regexpStart.test(line);
            }, "testRemove");
            var shouldInsertSpace = __name(function(line, before, after) {
              var spaces = 0;
    ...
    ace.define("ace/document", ["require", "exports", "module", "ace/lib/oop", "ace/apply_delta", "ace/lib/event_emitter", "ace/range", "ace/anchor"], function(require2, exports2, module2) {
      ...
      var Document = __name(function(textOrLines) {
        this.$lines = [""];
    ...
    ace.define("ace/background_tokenizer", ["require", "exports", "module", "ace/lib/oop", "ace/lib/event_emitter"], function(require2, exports2, module2) {
      ...
      var oop = require2("./lib/oop");
      var EventEmitter = require2("./lib/event_emitter").EventEmitter;
      var BackgroundTokenizer = __name(function(tokenizer, editor) {
        this.running = false;
        this.lines = [];
        this.states = [];
        this.currentLine = 0;
    ...
    ace.define("ace/search_highlight", ["require", "exports", "module", "ace/lib/lang", "ace/lib/oop", "ace/range"], function(require2, exports2, module2) {
      ...
      var oop = require2("./lib/oop");
      var Range = require2("./range").Range;
      var SearchHighlight = __name(function(regExp, clazz, type) {
    ...
    ace.define("ace/edit_session", ["require", "exports", "module", "ace/lib/oop", "ace/lib/lang", "ace/bidihandler", "ace/config", "ace/lib/event_emitter", "ace/selection", "ace/mode/text", "ace/range", "ace/document", "ace/background_tokenizer", "ace/search_highlight", "ace/edit_session/folding", "ace/edit_session/bracket_match"], function(require2, exports2, module2) {
      ...
      var EditSession = __name(function(text, mode) {
        this.$breakpoints = [];
        this.$decorations = [];
        this.$frontMarkers = {};
        this.$backMarkers = {};
    ...
    ace.define("ace/search", ["require", "exports", "module", "ace/lib/lang", "ace/lib/oop", "ace/range"], function(require2, exports2, module2) {
      ...
      (function() {
        ...
        this.$matchIterator = function(session, options) {
          ...
          if (backwards) {
            var forEach = __name(function(callback) {
              var row = start.row;
          ...
          if (options.$isMultiLine) {
            var len = re.length;
            var forEachInLine = __name(function(row, offset, callback) {
            ...
            var forEachInLine = __name(function(row, endIndex, callback) {
            ...
            var forEachInLine = __name(function(row, startIndex, callback) {
              var line = session.getLine(row);
              var last;
              var m;
    ...
    ace.define("ace/keyboard/hash_handler", ["require", "exports", "module", "ace/lib/keys", "ace/lib/useragent"], function(require2, exports2, module2) {
      ...
      (function() {
        ...
        this.findKeyCommand = __name(function findKeyCommand(hashId, keyString) {
    ...
    ace.define("ace/commands/command_manager", ["require", "exports", "module", "ace/lib/oop", "ace/keyboard/hash_handler", "ace/lib/event_emitter"], function(require2, exports2, module2) {
      ...
      var EventEmitter = require2("../lib/event_emitter").EventEmitter;
      var CommandManager = __name(function(platform, commands) {
    ...
    ace.define("ace/editor", ["require", "exports", "module", "ace/lib/oop", "ace/lib/dom", "ace/lib/lang", "ace/lib/useragent", "ace/keyboard/textinput", "ace/mouse/mouse_handler", "ace/mouse/fold_handler", "ace/keyboard/keybinding", "ace/edit_session", "ace/search", "ace/range", "ace/lib/event_emitter", "ace/commands/command_manager", "ace/commands/default_commands", "ace/config", "ace/token_iterator", "ace/clipboard"], function(require2, exports2, module2) {
      ...
      var TokenIterator = require2("./token_iterator").TokenIterator;
      var clipboard = require2("./clipboard");
      var Editor = __name(function(renderer, session, options) {
        this.$toDestroy = [];
    ...
    ace.define("ace/undomanager", ["require", "exports", "module", "ace/range"], function(require2, exports2, module2) {
      "use strict";
      var UndoManager = __name(function() {
        this.$maxRev = 0;
        this.$fromUndo = false;
    ...
    ace.define("ace/layer/lines", ["require", "exports", "module", "ace/lib/dom"], function(require2, exports2, module2) {
      "use strict";
      var dom = require2("../lib/dom");
      var Lines = __name(function(element, canvasHeight) {
    ...
    ace.define("ace/layer/gutter", ["require", "exports", "module", "ace/lib/dom", "ace/lib/oop", "ace/lib/lang", "ace/lib/event_emitter", "ace/layer/lines"], function(require2, exports2, module2) {
      ...
      var Gutter = __name(function(parentEl) {
        this.element = dom.createElement("div");
    ...
    ace.define("ace/layer/marker", ["require", "exports", "module", "ace/range", "ace/lib/dom"], function(require2, exports2, module2) {
      ...
      var Range = require2("../range").Range;
      var dom = require2("../lib/dom");
      var Marker = __name(function(parentEl) {
        this.element = dom.createElement("div");
    ...
    ace.define("ace/layer/text", ["require", "exports", "module", "ace/lib/oop", "ace/lib/dom", "ace/lib/lang", "ace/layer/lines", "ace/lib/event_emitter"], function(require2, exports2, module2) {
      ...
      var Lines = require2("./lines").Lines;
      var EventEmitter = require2("../lib/event_emitter").EventEmitter;
      var Text = __name(function(parentEl) {
        this.dom = dom;
    ...
    ace.define("ace/layer/cursor", ["require", "exports", "module", "ace/lib/dom"], function(require2, exports2, module2) {
      "use strict";
      var dom = require2("../lib/dom");
      var Cursor = __name(function(parentEl) {
        this.element = dom.createElement("div");
    ...
    ace.define("ace/scrollbar", ["require", "exports", "module", "ace/lib/oop", "ace/lib/dom", "ace/lib/event", "ace/lib/event_emitter"], function(require2, exports2, module2) {
      ...
      var ScrollBar = __name(function(parent) {
        this.element = dom.createElement("div");
      ...
      var VScrollBar = __name(function(parent, renderer) {
      ...
      var HScrollBar = __name(function(parent, renderer) {
        ScrollBar.call(this, parent);
        this.scrollLeft = 0;
    ...
    ace.define("ace/renderloop", ["require", "exports", "module", "ace/lib/event"], function(require2, exports2, module2) {
      "use strict";
      var event = require2("./lib/event");
      var RenderLoop = __name(function(onRender, win) {
    ...
    ace.define("ace/layer/font_metrics", ["require", "exports", "module", "ace/lib/oop", "ace/lib/dom", "ace/lib/lang", "ace/lib/event", "ace/lib/useragent", "ace/lib/event_emitter"], function(require2, exports2, module2) {
      ...
      (function() {
        ...
        this.$pollSizeChanges = function() {
          ...
          var self = this;
          return this.$pollSizeChangesTimer = event.onIdle(__name(function cb() {
            self.checkForSizeChanges();
            event.onIdle(cb, 500);
          }, "cb"), 500);
        };
        ...
        this.$getZoom = __name(function getZoom(element) {
          if (!element || !element.parentElement)
            return 1;
          return (window.getComputedStyle(element).zoom || 1) * getZoom(element.parentElement);
        }, "getZoom");
        this.$initTransformMeasureNodes = function() {
          var t = __name(function(t2, l) {
            return ["div", {
...
.ace_placeholder {
    ...
    ace.define("ace/virtual_renderer", ["require", "exports", "module", "ace/lib/oop", "ace/lib/dom", "ace/config", "ace/layer/gutter", "ace/layer/marker", "ace/layer/text", "ace/layer/cursor", "ace/scrollbar", "ace/scrollbar", "ace/renderloop", "ace/layer/font_metrics", "ace/lib/event_emitter", "ace/css/editor.css", "ace/lib/useragent"], function(require2, exports2, module2) {
      ...
      var VirtualRenderer = __name(function(container, theme) {
        var _self = this;
      ...
      (function() {
        ...
        this.$calcSteps = function(fromValue, toValue) {
          ...
          var l = this.STEPS;
          var steps = [];
          var func = __name(function(t, x_min, dx) {
    ...
    ace.define("ace/worker/worker_client", ["require", "exports", "module", "ace/lib/oop", "ace/lib/net", "ace/lib/event_emitter", "ace/config"], function(require2, exports2, module2) {
      ...
      var WorkerClient = __name(function(worker) {
      ...
      var UIWorkerClient = __name(function(topLevelNamespaces, mod, classname) {
        var main = null;
        var emitSync = false;
        ...
        var processNext = __name(function() {
    ...
    ace.define("ace/placeholder", ["require", "exports", "module", "ace/range", "ace/lib/event_emitter", "ace/lib/oop"], function(require2, exports2, module2) {
      ...
      var EventEmitter = require2("./lib/event_emitter").EventEmitter;
      var oop = require2("./lib/oop");
      var PlaceHolder = __name(function(session, length, pos, others, mainClass, othersClass) {
        var _self = this;
        this.length = length;
        this.session = session;
        this.doc = session.getDocument();
      ...
      (function() {
        ...
        this.updateMarkers = function() {
          ...
          var _self = this;
          var session = this.session;
          var updateMarker = __name(function(pos, className) {
    ...
    ace.define("ace/mouse/multi_select_handler", ["require", "exports", "module", "ace/lib/event", "ace/lib/useragent"], function(require2, exports2, module2) {
      ...
      function onMouseDown(e) {
        ...
        var onMouseSelection = __name(function(e2) {
          mouseX = e2.clientX;
          mouseY = e2.clientY;
        }, "onMouseSelection");
        var session = editor.session;
        ...
        if (selectionMode == "add") {
          ...
          var initialRange;
          var rectSel = [];
          var blockSelect = __name(function() {
          ...
          var onMouseSelectionEnd = __name(function(e2) {
            blockSelect();
            clearInterval(timerId);
            editor.removeSelectionMarkers(rectSel);
            if (!rectSel.length)
    ...
    ace.define("ace/ext/error_marker", ["require", "exports", "module", "ace/line_widgets", "ace/lib/dom", "ace/range"], function(require2, exports2, module2) {
      ...
      exports2.showErrorMarker = function(editor, dir) {
        ...
        var kb = __name(function(_, hashId, keyString) {
...
var require_mode_typescript = __commonJS({
  "../../../../.yarn/global/cache/ace-builds-npm-1.10.0-88e03578a8-9c9.zip/node_modules/ace-builds/src-noconflict/mode-typescript.js"(exports, module) {
    ...
    ace.define("ace/mode/doc_comment_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function(require2, exports2, module2) {
      ...
      var oop = require2("../lib/oop");
      var TextHighlightRules = require2("./text_highlight_rules").TextHighlightRules;
      var DocCommentHighlightRules = __name(function() {
        this.$rules = {
          "start": [
            {
    ...
    ace.define("ace/mode/javascript_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/doc_comment_highlight_rules", "ace/mode/text_highlight_rules"], function(require2, exports2, module2) {
      ...
      var JavaScriptHighlightRules = __name(function(options) {
    ...
    ace.define("ace/mode/matching_brace_outdent", ["require", "exports", "module", "ace/range"], function(require2, exports2, module2) {
      "use strict";
      var Range = require2("../range").Range;
      var MatchingBraceOutdent = __name(function() {
    ...
    ace.define("ace/mode/typescript_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/javascript_highlight_rules"], function(require2, exports2, module2) {
      ...
      var oop = require2("../lib/oop");
      var JavaScriptHighlightRules = require2("./javascript_highlight_rules").JavaScriptHighlightRules;
      var TypeScriptHighlightRules = __name(function(options) {
        var tsRules = [
          {
