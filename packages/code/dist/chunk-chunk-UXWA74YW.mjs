...
var require_browser = __commonJS({
  "../../.yarn/global/cache/esbuild-wasm-npm-0.15.11-c85526b9c1-9.zip/node_modules/esbuild-wasm/lib/browser.js"(exports, module) {
    init_define_process();
    ((module2) => {
      "use strict";
      ...
      function createChannel(streamIn) {
        ...
        let handleIncomingPacket = (bytes) => {
          if (isFirstPacket) {
            ...
            if (binaryVersion !== "0.15.11") {
              throw new Error(`Cannot start service: Host version "${"0.15.11"}" does not match binary version ${JSON.stringify(binaryVersion)}`);
            }
            return;
          }
...
var transform = async (code, opts) => {
  initFinished = initFinished || (0, import_esbuild_wasm.initialize)({
    wasmURL: new URL(
      (await import("./chunk-esbuild-DR6PS6Z3.mjs")).default,
      location.origin
    ).toString()
