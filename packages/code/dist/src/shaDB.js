...
(function (d, w) {
    ...
    w.prototype = {
        diff: function (n, t) {
            var r = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {}, f = r.callback;
            ...
            function h() {
                for (var c = -1 * u; c <= u; c += 2) {
                    ...
                    if (!y || E && x.newPos < m.newPos ? (L = I(m), i.pushComponent(L.components, void 0, !0)) : (L = x, L.newPos++, i.pushComponent(L.components, !0, void 0)), F = i.extractCommon(L, t, n, c), L.newPos + 1 >= s && F + 1 >= o)
        ...
        for (var i = 0, l = n.length, s = 0, o = 0; i < l; i++) {
            ...
            if (u.removed) {
                ...
                if (!u.added && f) {
                    ...
                    u.value = e.join(t.slice(s, s + u.count));
    ...
    U.equals = function (e, n) {
        ...
        for (var n = e.split(/([^\S\r\n]+|[()[\]{}'"\r\n]|\b)/), t = 0; t < n.length - 1; t++)
            !n[t + 1] && n[t + 2] && P.test(n[t]) && P.test(n[t + 2]) && (n[t] += n[t + 2], n.splice(t + 1, 2), t--);
        return n;
    };
    function me(e, n, t) {
        return (t = $(t, {
    ...
    function X(e) {
        return (typeof Symbol == "function" && typeof Symbol.iterator == "symbol" ? X = function (n) {
            return typeof n;
        } : X = function (n) {
    ...
    J.useLongestToken = !0, J.tokenize = V.tokenize, J.castInput = function (e) {
        var n = this.options, t = n.undefinedReplacement, r = n.stringifyReplacer, f = r === void 0 ? function (i, l) {
            return typeof l == "undefined" ? t : l;
        } : r;
        return typeof e == "string" ? e : JSON.stringify(Z(e, null, null, f), f, "  ");
    }, J.equals = function (e, n) {
        return w.prototype.equals.call(J, e.replace(/,([\r\n])/g, "$1"), n.replace(/,([\r\n])/g, "$1"));
    };
    function Te(e, n, t) {
        return J.diff(e, n, t);
    }
    function Z(e, n, t, r, f) {
        ...
        if ((e && e.toJSON && (e = e.toJSON()), X(e) === "object" && e !== null)) {
            ...
            var s = [], o;
            for (o in e)
                e.hasOwnProperty(o) && s.push(o);
            for ((s.sort(), i = 0); i < s.length; i += 1)
                o = s[i], l[o] = Z(e[o], n, t, r, o);
            n.pop(), t.pop();
        }
        else
            l = e;
    ...
    function G(e) {
        var n = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, t = e.split(/\r\n|[\n\v\f\r\x85]/), r = e.match(/\r\n|[\n\v\f\r\x85]/g) || [], f = [], i = 0;
        function l() {
            var u = {};
    ...
    function ue(e, n) {
        ...
        for (var g = 0; g < i.length; g++) {
            for (var c = i[g], L = r.length - c.oldLines, x = 0, m = p + c.oldStart - 1, F = ze(m, u, L); x !== void 0; x = F())
                if (h(c, m + x)) {
                    c.offset = p += x;
                    break;
                }
        ...
        for (var y = 0, E = 0; E < i.length; E++) {
            ...
            for (var T = 0; T < N.lines.length; T++) {
                ...
                if (z === " ")
                    ...
                    r.splice(A, 1), f.splice(A, 1);
                else if (z === "+")
                    r.splice(A, 0, Y), f.splice(A, 0, te), A++;
                else if (z === "\\") {
    ...
    function $e(e, n, t) {
        ...
        for (var f = 0, i = 0, l = 0, s = 0; f < e.hunks.length || i < n.hunks.length;) {
            ...
            if (pe(o, u))
                r.hunks.push(ve(o, l)), f++, s += o.newLines - o.oldLines;
            else if (pe(u, o))
    ...
    function Ve(e) {
        for (var n = [], t = 0; t < e.length; t++) {
            var r = e[t];
            r.added ? n.push("<ins>") : r.removed && n.push("<del>"), n.push(Xe(r.value)), r.added ? n.push("</ins>") : r.removed && n.push("</del>");
        }
        return n.join("");
    }
    function Xe(e) {
...
const Be = async (d) => Array.from(new Uint8Array(await crypto.subtle.digest("SHA-256", typeof d == "string" ? new TextEncoder().encode(d) : d)).slice(0, 4)).map((w) => ("00" + w.toString(16)).slice(-2)).join("");
const diff = async (d, w) => {
    ...
    const w = [
        ...d.slice(0, 8)
    ].filter((I) => I < "0" || I > "f").length === 0, H = d.slice(8);
