var _ = (e, r) => () => (r || (r = { exports: {} }, e(r.exports, r)), r.exports), w = _((ne, C) => {
    "use strict";
    var $ = Object.getOwnPropertySymbols, G = Object.hasOwnProperty, J = Object.propertyIsEnumerable;
    function K(e) {
        if (e == null) {
    ...
    var S = { current: null }, M = Object.hasOwnProperty, D = { key: !0, ref: !0, __self: !0, __source: !0 };
    function L(e, r, t) {
        var u, n = {}, i = null, f = null;
        if (r != null) {
            for (u in r.ref !== void 0 && (f = r.ref),
        ...
        if (f) {
            return f = e,
                ...
                Array.isArray(n)
                    ...
                    : n != null &&
                        (E(n) && (n = Y(n, t + (!n.key || f && f.key === n.key
                            ? ""
                            : ("" + n.key).replace(T, "$&/") + "/") +
                            e)),
                            r.push(n)),
    ...
    o.cloneElement = function (e, r, t) {
        ...
        if (r != null) {
            if (r.ref !== void 0 && (i = r.ref, f = S.current),
