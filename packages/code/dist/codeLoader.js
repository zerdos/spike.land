...
export async function run() {
    ...
    (async ()=>{
        ...
        async function getErrors() {
            ...
            const modelUri = modules.monaco.Uri.parse("https://zed.vision/code/?h=main.tsx");
            const tsWorker = await modules.monaco.languages.typescript.getTypeScriptWorker();
            const diag = await (await tsWorker(modelUri)).getSemanticDiagnostics("https://zed.vision/code/?h=main.tsx");
            const comp = await (await tsWorker(modelUri)).getCompilerOptionsDiagnostics("https://zed.vision/code/?h=main.tsx");
            const syntax = await (await tsWorker(modelUri)).getSyntacticDiagnostics("https://zed.vision/code/?h=main.tsx");
            return [
                ...diag,
                ...comp,
                ...syntax
