  ...
  "../../.yarn/global/cache/esbuild-wasm-npm-0.15.16-c2c146172f-9.zip/node_modules/esbuild-wasm/lib/browser.js"(exports, module) {
    ...
    ((module2) => {
      ...
      function pushCommonFlags(flags, options, keys2) {
        ...
        let jsx3 = getFlag(options, keys2, "jsx", mustBeString);
        ...
        let define3 = getFlag(options, keys2, "define", mustBeObject);
  ...
  "../../.yarn/global/cache/localforage-npm-1.10.0-cf9ea9a436-9.zip/node_modules/localforage/dist/localforage.js"(exports, module) {
    ...
    (function(f2) {
      ...
      return (/* @__PURE__ */ __name(function e2(t2, n2, r2) {
        ...
        var includes3 = /* @__PURE__ */ __name(function includes4(array, searchElement) {
            ...
            var promise = new Promise$1(function(resolve, reject) {
              try {
                ...
                for (var i2 = 0, len = driverMethods.length; i2 < len; i2++) {
                  ...
                  var isRequired = !includes3(OptionalDriverMethods, driverMethodName);
...
function md5FULL(inputString) {
  ...
  function rh(n2) {
    ...
    let s3 = "";
    for (j2 = 0; j2 <= 3; j2++) {
      s3 += hc.charAt(n2 >> j2 * 8 + 4 & 15) + hc.charAt(n2 >> j2 * 8 & 15);
    }
    return s3;
  }
  __name(rh, "rh");
  ...
  __name(rl, "rl");
  function cm(q, a3, b3, x3, s3, t2) {
    return ad(rl(ad(ad(a3, q), ad(x3, t2)), s3), b3);
  }
  __name(cm, "cm");
  function ff(a3, b3, c3, d3, x3, s3, t2) {
    return cm(b3 & c3 | ~b3 & d3, a3, b3, x3, s3, t2);
  }
  __name(ff, "ff");
  function gg(a3, b3, c3, d3, x3, s3, t2) {
    return cm(b3 & d3 | c3 & ~d3, a3, b3, x3, s3, t2);
  }
  __name(gg, "gg");
  function hh(a3, b3, c3, d3, x3, s3, t2) {
    return cm(b3 ^ c3 ^ d3, a3, b3, x3, s3, t2);
  }
  __name(hh, "hh");
  function ii(a3, b3, c3, d3, x3, s3, t2) {
    return cm(c3 ^ (b3 | ~d3), a3, b3, x3, s3, t2);
  }
  __name(ii, "ii");
  function sb(x3) {
    let i3;
...
function mineFromCaches(cache2) {
  const key = cache2.key;
  try {
    return Array.from(
      document.querySelectorAll(`style[data-emotion="${cache2.key}"]`)
...
__name(is, "is");
var imul = typeof Math.imul === "function" && Math.imul(4294967295, 2) === -2 ? Math.imul : /* @__PURE__ */ __name(function imul2(a2, b2) {
  a2 |= 0;
  b2 |= 0;
  var c2 = a2 & 65535;
  var d2 = b2 & 65535;
...
function reverseFactory(collection, useKeys) {
  ...
  reversedSequence.__iterate = function(fn, reverse3) {
    ...
    return collection.__iterate(
      function(v2, k2) {
        return fn(v2, useKeys ? k2 : reverse3 ? this$1$12.size - ++i2 : i2++, this$1$12);
      },
      !reverse3
    );
  };
  ...
  zipSequence.__iteratorUncached = function(type, reverse3) {
    ...
    return new Iterator(function() {
      ...
      if (!isDone) {
        ...
        isDone = zipAll2 ? steps.every(function(s3) {
          return s3.done;
...
var Map2 = /* @__PURE__ */ function(KeyedCollection2) {
  ...
  Map3.prototype.get = /* @__PURE__ */ __name(function get11(k2, notSetValue) {
    return this._root ? this._root.get(0, void 0, k2, notSetValue) : notSetValue;
  }, "get");
  Map3.prototype.set = /* @__PURE__ */ __name(function set3(k2, v2) {
    return updateMap(this, k2, v2);
  }, "set");
  Map3.prototype.remove = /* @__PURE__ */ __name(function remove3(k2) {
...
var OrderedMap = /* @__PURE__ */ function(Map3) {
  ...
  OrderedMap2.prototype.get = /* @__PURE__ */ __name(function get11(k2, notSetValue) {
  ...
  OrderedMap2.prototype.set = /* @__PURE__ */ __name(function set3(k2, v2) {
    return updateOrderedMap(this, k2, v2);
  }, "set");
  OrderedMap2.prototype.remove = /* @__PURE__ */ __name(function remove3(k2) {
...
Record.prototype.has = /* @__PURE__ */ __name(function has4(k2) {
  return this._indices.hasOwnProperty(k2);
}, "has");
Record.prototype.get = /* @__PURE__ */ __name(function get10(k2, notSetValue) {
  if (!this.has(k2)) {
    return notSetValue;
  }
...
Record.prototype.set = /* @__PURE__ */ __name(function set2(k2, v2) {
  if (this.has(k2)) {
...
Record.prototype.remove = /* @__PURE__ */ __name(function remove2(k2) {
  return this.set(k2);
}, "remove");
...
// js/session.ts
function initSession(room, u2) {
  return Record({ ...u2, room, state: Record(u2.state)() });
}
...
var CodeSession = class {
  constructor(room, user) {
    ...
    this.createPatchFromHashCode = (oldHash, state, updateHash) => {
      const s3 = JSON.parse(string_(state));
    ...
    this.applyPatch = async ({
      ...
      try {
        if (!maybeOldRec) {
          ...
          if (resp.ok) {
            const s3 = await resp.json();
            const serverRecord = this.session.get("state").merge(
              JSON.parse(string_(s3.mST))
            );
  ...
  updateNonDebounced() {
    Object.keys(this.cb).map((k2) => this.cb[k2]).map((x2) => {
      try {
        x2();
      } catch (error) {
  ...
  setRoom(codeSpace2) {
    const user = this.session.set("room", codeSpace2);
    this.session = user;
  }
};
...
function mST(p2) {
  ...
  const { i: i2, transpiled, code, html, css: css2 } = p2 ? JSON.parse(
    applyPatch(
      string_(
        sessAsJs
      ),
...
__name(mST, "mST");
function addOrigin(s3, originString) {
  const { i: i2, transpiled, code, html, css: css2 } = s3;
...
var applyPatch2 = /* @__PURE__ */ __name(async (x2) => {
...
var makePatchFrom = /* @__PURE__ */ __name((n2, st, update8) => session.createPatchFromHashCode(n2, st, update8), "makePatchFrom");
var makePatch = /* @__PURE__ */ __name((st, update8) => makePatchFrom(md5(mST().transpiled), st, update8), "makePatch");
var startSession = /* @__PURE__ */ __name((room, u2, originString) => session || new CodeSession(room, {
  name: u2.name,
  state: addOrigin(u2.state, originString)
}), "startSession");
...
var toUmd = /* @__PURE__ */ __name(async (source, name) => {
  ...
  mod2.hashMap = { ...mod2.hashMap, [name]: hash2 };
  if (mod2.data[hash2])
    return mod2;
  try {
    mod2.data[hash2] = {
  ...
  mod2.data[hash2].code = mod2.data[hash2].code + `
  
  globalThis.globalNames = globalThis.globalNames || {};
  globalThis.globalNames["${name}"] =  ${hash2}  ;`;
  mod2.data[hash2].deps = findDeps(mod2.data[hash2].code).map((dep) => importShim.resolve(dep, name));
  await Promise.all(
    mod2.data[hash2].deps.map(
...
var build = /* @__PURE__ */ __name(async (codeSpace2, i2, signal) => {
  ...
  const defaultOpts = {
    ...
    format: "esm",
    entryPoints: [
      `./live/${codeSpace2}/render.tsx?i=${i2}`,
      "./emotion.mjs",
      "./emotionCache.mjs",
      "./reactMod.mjs",
      "./reactDom.mjs"
...
async function appFactory(transpiled = "") {
  ...
  const hash2 = md5(trp);
  if (!apps2[hash2] || !eCaches2[hash2]) {
    try {
      eCaches2[hash2] = eCaches2[hash2] || emotionCache_default({
        key: hash2,
        speedy: false
      });
      eCaches2[hash2].compat = void 0;
      console.log(`i: ${mstI}: `);
      let mod4;
      try {
      ...
      apps2[hash2] = ({ appId }) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: { height: 100 + "%" }, id: appId, children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_react2.CacheProvider, { value: eCaches2[hash2], children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(App, {}) }, hash2) }, hash2);
    } catch (error) {
      if (error instanceof SyntaxError) {
        const name = error.name;
        const message = error.message;
        apps2[hash2] = () => /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { css: import_react2.css`background-color: orange;`, children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("h1", { children: "Syntax Error" }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("h2", { children: hash2 }),
        ...
        apps2[hash2] = () => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { css: import_react2.css`background-color: orange;`, children: /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("h1", { children: [
          "Unknown Error: $",
          hash2
        ] }) });
      }
