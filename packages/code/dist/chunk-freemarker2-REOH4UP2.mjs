...
// ../../.yarn/global/cache/monaco-editor-npm-0.35.0-dev.20221204-ea0d8b005c-9.zip/node_modules/monaco-editor/esm/vs/basic-languages/freemarker2/freemarker2.js
init_define_process();
...
function createMonarchLanguage(ts, is) {
  ...
  const s = /* @__PURE__ */ __name((name) => name.replace(/__id__/g, id), "s");
  const r = /* @__PURE__ */ __name((regexp) => {
