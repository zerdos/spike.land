...
var initShims = async (assets) => {
  if (importmapped)
    return;
  importmapped = true;
  await import("./chunk-es-module-shims-Q5XPGCZY.mjs");
...
// ../../.yarn/__virtual__/@emotion-styled-virtual-83b927f9d8/0/cache/@emotion-styled-npm-11.10.0-ee745c48ee-f2a3e9798f.zip/node_modules/@emotion/styled/dist/emotion-styled.browser.esm.js
init_define_process();
var import_extends44 = __toESM(require_extends());
...
// ../../.yarn/__virtual__/@emotion-styled-virtual-83b927f9d8/0/cache/@emotion-styled-npm-11.10.0-ee745c48ee-f2a3e9798f.zip/node_modules/@emotion/styled/base/dist/emotion-styled-base.browser.esm.js
init_define_process();
...
var useInsertionEffect2 = useInsertionEffect ? useInsertionEffect : function useInsertionEffect3(create) {
  create();
};
...
var Editor = ({ code, i, codeSpace: codeSpace2 }) => {
  ...
  const [
    ...
    runner: async ({ code: code2, counter: counter2 }) => {
      const { runner: runner2 } = await import("./chunk-runner-2YCABPRG.mjs");
  ...
  useEffect(() => {
    ...
    const setMonaco = async () => {
      const { startMonaco } = await import("./chunk-startMonaco-N345YJSM.mjs");
    ...
    const setAce = async () => {
      const { startAce } = await import("./chunk-startAce-6WN46YCY.mjs");
    ...
    const loadEditors = async () => {
      ...
      const { prettierJs: prettierJs2 } = await import("./chunk-prettierEsm-KABINSDT.mjs");
