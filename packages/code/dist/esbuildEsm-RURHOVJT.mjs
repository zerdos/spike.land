import{a as oA}from"./chunk-QBSDP3A6.mjs";import{b as qA,d as VA,f as RB}from"./chunk-WOIYS7FW.mjs";var pA=qA((P7,ZB)=>{"use strict";RB();(cB=>{var C=Object.defineProperty,J=Object.defineProperties,sB=Object.getOwnPropertyDescriptor,bB=Object.getOwnPropertyDescriptors,uB=Object.getOwnPropertyNames,hB=Object.getOwnPropertySymbols,fB=Object.prototype.hasOwnProperty,DB=Object.prototype.propertyIsEnumerable,mB=(B,A,k)=>A in B?C(B,A,{enumerable:!0,configurable:!0,writable:!0,value:k}):B[A]=k,tB=(B,A)=>{for(var k in A||(A={}))fB.call(A,k)&&mB(B,k,A[k]);if(hB)for(var k of hB(A))DB.call(A,k)&&mB(B,k,A[k]);return B},dB=(B,A)=>J(B,bB(A)),cA=(B,A)=>{for(var k in A)C(B,k,{get:A[k],enumerable:!0})},hA=(B,A,k,n)=>{if(A&&typeof A=="object"||typeof A=="function")for(let p of uB(A))!fB.call(B,p)&&p!==k&&C(B,p,{get:()=>A[p],enumerable:!(n=sB(A,p))||n.enumerable});return B},QA=B=>hA(C({},"__esModule",{value:!0}),B),xB=(B,A,k)=>new Promise((n,p)=>{var u=E=>{try{c(k.next(E))}catch(S){p(S)}},e=E=>{try{c(k.throw(E))}catch(S){p(S)}},c=E=>E.done?n(E.value):Promise.resolve(E.value).then(u,e);c((k=k.apply(B,A)).next())}),IB={};cA(IB,{analyzeMetafile:()=>DA,analyzeMetafileSync:()=>LA,build:()=>yA,buildSync:()=>IA,default:()=>NA,formatMessages:()=>RA,formatMessagesSync:()=>FA,initialize:()=>WA,serve:()=>CA,transform:()=>wA,transformSync:()=>_A,version:()=>MA}),cB.exports=QA(IB);function AA(B){let A=n=>{if(n===null)k.write8(0);else if(typeof n=="boolean")k.write8(1),k.write8(+n);else if(typeof n=="number")k.write8(2),k.write32(n|0);else if(typeof n=="string")k.write8(3),k.write(XB(n));else if(n instanceof Uint8Array)k.write8(4),k.write(n);else if(n instanceof Array){k.write8(5),k.write32(n.length);for(let p of n)A(p)}else{let p=Object.keys(n);k.write8(6),k.write32(p.length);for(let u of p)k.write(XB(u)),A(n[u])}},k=new $A;return k.write32(0),k.write32(B.id<<1|+!B.isRequest),A(B.value),qB(k.buf,k.len-4,0),k.buf.subarray(0,k.len)}function mA(B){let A=()=>{switch(k.read8()){case 0:return null;case 1:return!!k.read8();case 2:return k.read32();case 3:return vB(k.read());case 4:return k.read();case 5:{let e=k.read32(),c=[];for(let E=0;E<e;E++)c.push(A());return c}case 6:{let e=k.read32(),c={};for(let E=0;E<e;E++)c[vB(k.read())]=A();return c}default:throw new Error("Invalid packet")}},k=new $A(B),n=k.read32(),p=(n&1)===0;n>>>=1;let u=A();if(k.ptr!==B.length)throw new Error("Invalid packet");return{id:n,isRequest:p,value:u}}var $A=class{constructor(B=new Uint8Array(1024)){this.buf=B,this.len=0,this.ptr=0}_write(B){if(this.len+B>this.buf.length){let A=new Uint8Array((this.len+B)*2);A.set(this.buf),this.buf=A}return this.len+=B,this.len-B}write8(B){let A=this._write(1);this.buf[A]=B}write32(B){let A=this._write(4);qB(this.buf,B,A)}write(B){let A=this._write(4+B.length);qB(this.buf,B.length,A),this.buf.set(B,A+4)}_read(B){if(this.ptr+B>this.buf.length)throw new Error("Invalid packet");return this.ptr+=B,this.ptr-B}read8(){return this.buf[this._read(1)]}read32(){return kA(this.buf,this._read(4))}read(){let B=this.read32(),A=new Uint8Array(B),k=this._read(A.length);return A.set(this.buf.subarray(k,k+B)),A}},XB,vB;if(typeof TextEncoder<"u"&&typeof TextDecoder<"u"){let B=new TextEncoder,A=new TextDecoder;XB=k=>B.encode(k),vB=k=>A.decode(k)}else if(typeof Buffer<"u")XB=B=>{let A=Buffer.from(B);return A instanceof Uint8Array||(A=new Uint8Array(A)),A},vB=B=>{let{buffer:A,byteOffset:k,byteLength:n}=B;return Buffer.from(A,k,n).toString()};else throw new Error("No UTF-8 codec found");function kA(B,A){return B[A++]|B[A++]<<8|B[A++]<<16|B[A++]<<24}function qB(B,A,k){B[k++]=A,B[k++]=A>>8,B[k++]=A>>16,B[k++]=A>>24}function PA(B){if(B+="",B.indexOf(",")>=0)throw new Error(`Invalid target: ${B}`);return B}var _B=()=>null,Z=B=>typeof B=="boolean"?null:"a boolean",dA=B=>typeof B=="boolean"||typeof B=="object"&&!Array.isArray(B)?null:"a boolean or an object",m=B=>typeof B=="string"?null:"a string",FB=B=>B instanceof RegExp?null:"a RegExp object",MB=B=>typeof B=="number"&&B===(B|0)?null:"an integer",VB=B=>typeof B=="function"?null:"a function",eB=B=>Array.isArray(B)?null:"an array",gB=B=>typeof B=="object"&&B!==null&&!Array.isArray(B)?null:"an object",XA=B=>B instanceof WebAssembly.Module?null:"a WebAssembly.Module",gA=B=>typeof B=="object"&&B!==null?null:"an array or an object",eA=B=>typeof B=="object"&&!Array.isArray(B)?null:"an object or null",EA=B=>typeof B=="string"||typeof B=="boolean"?null:"a string or a boolean",TA=B=>typeof B=="string"||typeof B=="object"&&B!==null&&!Array.isArray(B)?null:"a string or an object",HA=B=>typeof B=="string"||Array.isArray(B)?null:"a string or an array",tA=B=>typeof B=="string"||B instanceof Uint8Array?null:"a string or a Uint8Array";function P(B,A,k,n){let p=B[k];if(A[k+""]=!0,p===void 0)return;let u=n(p);if(u!==null)throw new Error(`"${k}" must be ${u}`);return p}function nB(B,A,k){for(let n in B)if(!(n in A))throw new Error(`Invalid option ${k}: "${n}"`)}function bA(B){let A=Object.create(null),k=P(B,A,"wasmURL",m),n=P(B,A,"wasmModule",XA),p=P(B,A,"worker",Z);return nB(B,A,"in initialize() call"),{wasmURL:k,wasmModule:n,worker:p}}function nA(B){let A;if(B!==void 0){A=Object.create(null);for(let k of Object.keys(B)){let n=B[k];if(typeof n=="string"||n===!1)A[k]=n;else throw new Error(`Expected ${JSON.stringify(k)} in mangle cache to map to either a string or false`)}}return A}function LB(B,A,k,n,p){let u=P(A,k,"color",Z),e=P(A,k,"logLevel",m),c=P(A,k,"logLimit",MB);u!==void 0?B.push(`--color=${u}`):n&&B.push("--color=true"),B.push(`--log-level=${e||p}`),B.push(`--log-limit=${c||0}`)}function rA(B,A,k){let n=P(A,k,"legalComments",m),p=P(A,k,"sourceRoot",m),u=P(A,k,"sourcesContent",Z),e=P(A,k,"target",HA),c=P(A,k,"format",m),E=P(A,k,"globalName",m),S=P(A,k,"mangleProps",FB),W=P(A,k,"reserveProps",FB),H=P(A,k,"mangleQuoted",Z),l=P(A,k,"minify",Z),N=P(A,k,"minifySyntax",Z),K=P(A,k,"minifyWhitespace",Z),y=P(A,k,"minifyIdentifiers",Z),j=P(A,k,"drop",eB),o=P(A,k,"charset",m),Q=P(A,k,"treeShaking",Z),f=P(A,k,"ignoreAnnotations",Z),M=P(A,k,"jsx",m),w=P(A,k,"jsxFactory",m),BB=P(A,k,"jsxFragment",m),$=P(A,k,"jsxImportSource",m),s=P(A,k,"jsxDev",Z),v=P(A,k,"define",gB),r=P(A,k,"logOverride",gB),a=P(A,k,"supported",gB),i=P(A,k,"pure",eB),h=P(A,k,"keepNames",Z),U=P(A,k,"platform",m);if(n&&B.push(`--legal-comments=${n}`),p!==void 0&&B.push(`--source-root=${p}`),u!==void 0&&B.push(`--sources-content=${u}`),e&&(Array.isArray(e)?B.push(`--target=${Array.from(e).map(PA).join(",")}`):B.push(`--target=${PA(e)}`)),c&&B.push(`--format=${c}`),E&&B.push(`--global-name=${E}`),U&&B.push(`--platform=${U}`),l&&B.push("--minify"),N&&B.push("--minify-syntax"),K&&B.push("--minify-whitespace"),y&&B.push("--minify-identifiers"),o&&B.push(`--charset=${o}`),Q!==void 0&&B.push(`--tree-shaking=${Q}`),f&&B.push("--ignore-annotations"),j)for(let b of j)B.push(`--drop:${b}`);if(S&&B.push(`--mangle-props=${S.source}`),W&&B.push(`--reserve-props=${W.source}`),H!==void 0&&B.push(`--mangle-quoted=${H}`),M&&B.push(`--jsx=${M}`),w&&B.push(`--jsx-factory=${w}`),BB&&B.push(`--jsx-fragment=${BB}`),$&&B.push(`--jsx-import-source=${$}`),s&&B.push("--jsx-dev"),v)for(let b in v){if(b.indexOf("=")>=0)throw new Error(`Invalid define: ${b}`);B.push(`--define:${b}=${v[b]}`)}if(r)for(let b in r){if(b.indexOf("=")>=0)throw new Error(`Invalid log override: ${b}`);B.push(`--log-override:${b}=${r[b]}`)}if(a)for(let b in a){if(b.indexOf("=")>=0)throw new Error(`Invalid supported: ${b}`);B.push(`--supported:${b}=${a[b]}`)}if(i)for(let b of i)B.push(`--pure:${b}`);h&&B.push("--keep-names")}function SA(B,A,k,n,p){var u;let e=[],c=[],E=Object.create(null),S=null,W=null,H=null;LB(e,A,E,k,n),rA(e,A,E);let l=P(A,E,"sourcemap",EA),N=P(A,E,"bundle",Z),K=P(A,E,"watch",dA),y=P(A,E,"splitting",Z),j=P(A,E,"preserveSymlinks",Z),o=P(A,E,"metafile",Z),Q=P(A,E,"outfile",m),f=P(A,E,"outdir",m),M=P(A,E,"outbase",m),w=P(A,E,"tsconfig",m),BB=P(A,E,"resolveExtensions",eB),$=P(A,E,"nodePaths",eB),s=P(A,E,"mainFields",eB),v=P(A,E,"conditions",eB),r=P(A,E,"external",eB),a=P(A,E,"loader",gB),i=P(A,E,"outExtension",gB),h=P(A,E,"publicPath",m),U=P(A,E,"entryNames",m),b=P(A,E,"chunkNames",m),F=P(A,E,"assetNames",m),D=P(A,E,"inject",eB),O=P(A,E,"banner",gB),L=P(A,E,"footer",gB),x=P(A,E,"entryPoints",gA),Y=P(A,E,"absWorkingDir",m),R=P(A,E,"stdin",gB),G=(u=P(A,E,"write",Z))!=null?u:p,AB=P(A,E,"allowOverwrite",Z),pB=P(A,E,"incremental",Z)===!0,I=P(A,E,"mangleCache",gB);if(E.plugins=!0,nB(A,E,`in ${B}() call`),l&&e.push(`--sourcemap${l===!0?"":`=${l}`}`),N&&e.push("--bundle"),AB&&e.push("--allow-overwrite"),K)if(e.push("--watch"),typeof K=="boolean")H={};else{let t=Object.create(null),d=P(K,t,"onRebuild",VB);nB(K,t,`on "watch" in ${B}() call`),H={onRebuild:d}}if(y&&e.push("--splitting"),j&&e.push("--preserve-symlinks"),o&&e.push("--metafile"),Q&&e.push(`--outfile=${Q}`),f&&e.push(`--outdir=${f}`),M&&e.push(`--outbase=${M}`),w&&e.push(`--tsconfig=${w}`),BB){let t=[];for(let d of BB){if(d+="",d.indexOf(",")>=0)throw new Error(`Invalid resolve extension: ${d}`);t.push(d)}e.push(`--resolve-extensions=${t.join(",")}`)}if(h&&e.push(`--public-path=${h}`),U&&e.push(`--entry-names=${U}`),b&&e.push(`--chunk-names=${b}`),F&&e.push(`--asset-names=${F}`),s){let t=[];for(let d of s){if(d+="",d.indexOf(",")>=0)throw new Error(`Invalid main field: ${d}`);t.push(d)}e.push(`--main-fields=${t.join(",")}`)}if(v){let t=[];for(let d of v){if(d+="",d.indexOf(",")>=0)throw new Error(`Invalid condition: ${d}`);t.push(d)}e.push(`--conditions=${t.join(",")}`)}if(r)for(let t of r)e.push(`--external:${t}`);if(O)for(let t in O){if(t.indexOf("=")>=0)throw new Error(`Invalid banner file type: ${t}`);e.push(`--banner:${t}=${O[t]}`)}if(L)for(let t in L){if(t.indexOf("=")>=0)throw new Error(`Invalid footer file type: ${t}`);e.push(`--footer:${t}=${L[t]}`)}if(D)for(let t of D)e.push(`--inject:${t}`);if(a)for(let t in a){if(t.indexOf("=")>=0)throw new Error(`Invalid loader extension: ${t}`);e.push(`--loader:${t}=${a[t]}`)}if(i)for(let t in i){if(t.indexOf("=")>=0)throw new Error(`Invalid out extension: ${t}`);e.push(`--out-extension:${t}=${i[t]}`)}if(x)if(Array.isArray(x))for(let t of x)c.push(["",t+""]);else for(let[t,d]of Object.entries(x))c.push([t+"",d+""]);if(R){let t=Object.create(null),d=P(R,t,"contents",tA),z=P(R,t,"resolveDir",m),kB=P(R,t,"sourcefile",m),g=P(R,t,"loader",m);nB(R,t,'in "stdin" object'),kB&&e.push(`--sourcefile=${kB}`),g&&e.push(`--loader=${g}`),z&&(W=z+""),typeof d=="string"?S=XB(d):d instanceof Uint8Array&&(S=d)}let T=[];if($)for(let t of $)t+="",T.push(t);return{entries:c,flags:e,write:G,stdinContents:S,stdinResolveDir:W,absWorkingDir:Y,incremental:pB,nodePaths:T,watch:H,mangleCache:nA(I)}}function fA(B,A,k,n){let p=[],u=Object.create(null);LB(p,A,u,k,n),rA(p,A,u);let e=P(A,u,"sourcemap",EA),c=P(A,u,"tsconfigRaw",TA),E=P(A,u,"sourcefile",m),S=P(A,u,"loader",m),W=P(A,u,"banner",m),H=P(A,u,"footer",m),l=P(A,u,"mangleCache",gB);return nB(A,u,`in ${B}() call`),e&&p.push(`--sourcemap=${e===!0?"external":e}`),c&&p.push(`--tsconfig-raw=${typeof c=="string"?c:JSON.stringify(c)}`),E&&p.push(`--sourcefile=${E}`),S&&p.push(`--loader=${S}`),W&&p.push(`--banner=${W}`),H&&p.push(`--footer=${H}`),{flags:p,mangleCache:nA(l)}}function xA(B){let A=new Map,k=new Map,n=new Map,p=new Map,u=null,e=0,c=0,E=new Uint8Array(16*1024),S=0,W=r=>{let a=S+r.length;if(a>E.length){let h=new Uint8Array(a*2);h.set(E),E=h}E.set(r,S),S+=r.length;let i=0;for(;i+4<=S;){let h=kA(E,i);if(i+4+h>S)break;i+=4,j(E.subarray(i,i+h)),i+=h}i>0&&(E.copyWithin(0,i,S),S-=i)},H=r=>{u={reason:r?": "+(r.message||r):""};let a="The service was stopped"+u.reason;for(let i of A.values())i(a,null);A.clear();for(let i of p.values())i.onWait(a);p.clear();for(let i of n.values())try{i(new Error(a),null)}catch(h){console.error(h)}n.clear()},l=(r,a,i)=>{if(u)return i("The service is no longer running"+u.reason,null);let h=e++;A.set(h,(U,b)=>{try{i(U,b)}finally{r&&r.unref()}}),r&&r.ref(),B.writeToStdin(AA({id:h,isRequest:!0,value:a}))},N=(r,a)=>{if(u)throw new Error("The service is no longer running"+u.reason);B.writeToStdin(AA({id:r,isRequest:!1,value:a}))},K=(r,a)=>xB(this,null,function*(){try{switch(a.command){case"ping":{N(r,{});break}case"on-start":{let i=k.get(a.key);i?N(r,yield i(a)):N(r,{});break}case"on-resolve":{let i=k.get(a.key);i?N(r,yield i(a)):N(r,{});break}case"on-load":{let i=k.get(a.key);i?N(r,yield i(a)):N(r,{});break}case"serve-request":{let i=p.get(a.key);i&&i.onRequest&&i.onRequest(a.args),N(r,{});break}case"serve-wait":{let i=p.get(a.key);i&&i.onWait(a.error),N(r,{});break}case"watch-rebuild":{let i=n.get(a.key);try{i&&i(null,a.args)}catch(h){console.error(h)}N(r,{});break}default:throw new Error("Invalid command: "+a.command)}}catch(i){N(r,{errors:[yB(i,B,null,void 0,"")]})}}),y=!0,j=r=>{if(y){y=!1;let i=String.fromCharCode(...r);if(i!=="0.15.0")throw new Error(`Cannot start service: Host version "0.15.0" does not match binary version ${JSON.stringify(i)}`);return}let a=mA(r);if(a.isRequest)K(a.id,a.value);else{let i=A.get(a.id);A.delete(a.id),a.value.error?i(a.value.error,{}):i(null,a.value)}},o=(r,a,i,h,U)=>xB(this,null,function*(){let b=[],F=[],D={},O={},L=0,x=0,Y=[],R=!1;a=[...a];for(let I of a){let T={};if(typeof I!="object")throw new Error(`Plugin at index ${x} must be an object`);let t=P(I,T,"name",m);if(typeof t!="string"||t==="")throw new Error(`Plugin at index ${x} is missing a name`);try{let d=P(I,T,"setup",VB);if(typeof d!="function")throw new Error("Plugin is missing a setup function");nB(I,T,`on plugin ${JSON.stringify(t)}`);let z={name:t,onResolve:[],onLoad:[]};x++;let g=d({initialOptions:r,resolve:(X,q={})=>{if(!R)throw new Error('Cannot call "resolve" before plugin setup has completed');if(typeof X!="string")throw new Error("The path to resolve must be a string");let _=Object.create(null),aB=P(q,_,"pluginName",m),$B=P(q,_,"importer",m),EB=P(q,_,"namespace",m),lB=P(q,_,"resolveDir",m),iB=P(q,_,"kind",m),V=P(q,_,"pluginData",_B);return nB(q,_,"in resolve() call"),new Promise((rB,oB)=>{let PB={command:"resolve",path:X,key:i,pluginName:t};aB!=null&&(PB.pluginName=aB),$B!=null&&(PB.importer=$B),EB!=null&&(PB.namespace=EB),lB!=null&&(PB.resolveDir=lB),iB!=null&&(PB.kind=iB),V!=null&&(PB.pluginData=h.store(V)),l(U,PB,(TB,jB)=>{TB!==null?oB(new Error(TB)):rB({errors:HB(jB.errors,h),warnings:HB(jB.warnings,h),path:jB.path,external:jB.external,sideEffects:jB.sideEffects,namespace:jB.namespace,suffix:jB.suffix,pluginData:h.load(jB.pluginData)})})})},onStart(X){let q='This error came from the "onStart" callback registered here:',_=WB(new Error(q),B,"onStart");b.push({name:t,callback:X,note:_})},onEnd(X){let q='This error came from the "onEnd" callback registered here:',_=WB(new Error(q),B,"onEnd");F.push({name:t,callback:X,note:_})},onResolve(X,q){let _='This error came from the "onResolve" callback registered here:',aB=WB(new Error(_),B,"onResolve"),$B={},EB=P(X,$B,"filter",FB),lB=P(X,$B,"namespace",m);if(nB(X,$B,`in onResolve() call for plugin ${JSON.stringify(t)}`),EB==null)throw new Error("onResolve() call is missing a filter");let iB=L++;D[iB]={name:t,callback:q,note:aB},z.onResolve.push({id:iB,filter:EB.source,namespace:lB||""})},onLoad(X,q){let _='This error came from the "onLoad" callback registered here:',aB=WB(new Error(_),B,"onLoad"),$B={},EB=P(X,$B,"filter",FB),lB=P(X,$B,"namespace",m);if(nB(X,$B,`in onLoad() call for plugin ${JSON.stringify(t)}`),EB==null)throw new Error("onLoad() call is missing a filter");let iB=L++;O[iB]={name:t,callback:q,note:aB},z.onLoad.push({id:iB,filter:EB.source,namespace:lB||""})},esbuild:B.esbuild});g&&(yield g),Y.push(z)}catch(d){return{ok:!1,error:d,pluginName:t}}}let G=I=>xB(this,null,function*(){switch(I.command){case"on-start":{let T={errors:[],warnings:[]};return yield Promise.all(b.map(t=>xB(this,[t],function*({name:d,callback:z,note:kB}){try{let g=yield z();if(g!=null){if(typeof g!="object")throw new Error(`Expected onStart() callback in plugin ${JSON.stringify(d)} to return an object`);let X={},q=P(g,X,"errors",eB),_=P(g,X,"warnings",eB);nB(g,X,`from onStart() callback in plugin ${JSON.stringify(d)}`),q!=null&&T.errors.push(...SB(q,"errors",h,d)),_!=null&&T.warnings.push(...SB(_,"warnings",h,d))}}catch(g){T.errors.push(yB(g,B,h,kB&&kB(),d))}}))),T}case"on-resolve":{let T={},t="",d,z;for(let kB of I.ids)try{({name:t,callback:d,note:z}=D[kB]);let g=yield d({path:I.path,importer:I.importer,namespace:I.namespace,resolveDir:I.resolveDir,kind:I.kind,pluginData:h.load(I.pluginData)});if(g!=null){if(typeof g!="object")throw new Error(`Expected onResolve() callback in plugin ${JSON.stringify(t)} to return an object`);let X={},q=P(g,X,"pluginName",m),_=P(g,X,"path",m),aB=P(g,X,"namespace",m),$B=P(g,X,"suffix",m),EB=P(g,X,"external",Z),lB=P(g,X,"sideEffects",Z),iB=P(g,X,"pluginData",_B),V=P(g,X,"errors",eB),rB=P(g,X,"warnings",eB),oB=P(g,X,"watchFiles",eB),PB=P(g,X,"watchDirs",eB);nB(g,X,`from onResolve() callback in plugin ${JSON.stringify(t)}`),T.id=kB,q!=null&&(T.pluginName=q),_!=null&&(T.path=_),aB!=null&&(T.namespace=aB),$B!=null&&(T.suffix=$B),EB!=null&&(T.external=EB),lB!=null&&(T.sideEffects=lB),iB!=null&&(T.pluginData=h.store(iB)),V!=null&&(T.errors=SB(V,"errors",h,t)),rB!=null&&(T.warnings=SB(rB,"warnings",h,t)),oB!=null&&(T.watchFiles=UB(oB,"watchFiles")),PB!=null&&(T.watchDirs=UB(PB,"watchDirs"));break}}catch(g){return{id:kB,errors:[yB(g,B,h,z&&z(),t)]}}return T}case"on-load":{let T={},t="",d,z;for(let kB of I.ids)try{({name:t,callback:d,note:z}=O[kB]);let g=yield d({path:I.path,namespace:I.namespace,suffix:I.suffix,pluginData:h.load(I.pluginData)});if(g!=null){if(typeof g!="object")throw new Error(`Expected onLoad() callback in plugin ${JSON.stringify(t)} to return an object`);let X={},q=P(g,X,"pluginName",m),_=P(g,X,"contents",tA),aB=P(g,X,"resolveDir",m),$B=P(g,X,"pluginData",_B),EB=P(g,X,"loader",m),lB=P(g,X,"errors",eB),iB=P(g,X,"warnings",eB),V=P(g,X,"watchFiles",eB),rB=P(g,X,"watchDirs",eB);nB(g,X,`from onLoad() callback in plugin ${JSON.stringify(t)}`),T.id=kB,q!=null&&(T.pluginName=q),_ instanceof Uint8Array?T.contents=_:_!=null&&(T.contents=XB(_)),aB!=null&&(T.resolveDir=aB),$B!=null&&(T.pluginData=h.store($B)),EB!=null&&(T.loader=EB),lB!=null&&(T.errors=SB(lB,"errors",h,t)),iB!=null&&(T.warnings=SB(iB,"warnings",h,t)),V!=null&&(T.watchFiles=UB(V,"watchFiles")),rB!=null&&(T.watchDirs=UB(rB,"watchDirs"));break}}catch(g){return{id:kB,errors:[yB(g,B,h,z&&z(),t)]}}return T}default:throw new Error("Invalid command: "+I.command)}}),AB=(I,T,t)=>t();F.length>0&&(AB=(I,T,t)=>{(()=>xB(this,null,function*(){for(let{name:d,callback:z,note:kB}of F)try{yield z(I)}catch(g){I.errors.push(yield new Promise(X=>T(g,d,kB&&kB(),X)))}}))().then(t)}),R=!0;let pB=0;return{ok:!0,requestPlugins:Y,runOnEndCallbacks:AB,pluginRefs:{ref(){++pB===1&&k.set(i,G)},unref(){--pB===0&&k.delete(i)}}}}),Q=(r,a,i,h)=>{let U={},b=P(a,U,"port",MB),F=P(a,U,"host",m),D=P(a,U,"servedir",m),O=P(a,U,"onRequest",VB),L,x=new Promise((Y,R)=>{L=G=>{p.delete(h),G!==null?R(new Error(G)):Y()}});return i.serve={},nB(a,U,"in serve() call"),b!==void 0&&(i.serve.port=b),F!==void 0&&(i.serve.host=F),D!==void 0&&(i.serve.servedir=D),p.set(h,{onRequest:O,onWait:L}),{wait:x,stop(){l(r,{command:"serve-stop",key:h},()=>{})}}},f="warning",M="silent",w=r=>{let a=c++,i=aA(),h,{refs:U,options:b,isTTY:F,callback:D}=r;if(typeof b=="object"){let x=b.plugins;if(x!==void 0){if(!Array.isArray(x))throw new Error('"plugins" must be an array');h=x}}let O=(x,Y,R,G)=>{let AB=[];try{LB(AB,b,{},F,f)}catch{}let pB=yB(x,B,i,R,Y);l(U,{command:"error",flags:AB,error:pB},()=>{pB.detail=i.load(pB.detail),G(pB)})},L=(x,Y)=>{O(x,Y,void 0,R=>{D(CB("Build failed",[R],[]),null)})};if(h&&h.length>0){if(B.isSync)return L(new Error("Cannot use plugins in synchronous API calls"),"");o(b,h,a,i,U).then(x=>{if(!x.ok)L(x.error,x.pluginName);else try{BB(dB(tB({},r),{key:a,details:i,logPluginError:O,requestPlugins:x.requestPlugins,runOnEndCallbacks:x.runOnEndCallbacks,pluginRefs:x.pluginRefs}))}catch(Y){L(Y,"")}},x=>L(x,""))}else try{BB(dB(tB({},r),{key:a,details:i,logPluginError:O,requestPlugins:null,runOnEndCallbacks:(x,Y,R)=>R(),pluginRefs:null}))}catch(x){L(x,"")}},BB=({callName:r,refs:a,serveOptions:i,options:h,isTTY:U,defaultWD:b,callback:F,key:D,details:O,logPluginError:L,requestPlugins:x,runOnEndCallbacks:Y,pluginRefs:R})=>{let G={ref(){R&&R.ref(),a&&a.ref()},unref(){R&&R.unref(),a&&a.unref()}},AB=!B.isWriteUnavailable,{entries:pB,flags:I,write:T,stdinContents:t,stdinResolveDir:d,absWorkingDir:z,incremental:kB,nodePaths:g,watch:X,mangleCache:q}=SA(r,h,U,f,AB),_={command:"build",key:D,entries:pB,flags:I,write:T,stdinContents:t,stdinResolveDir:d,absWorkingDir:z||b,incremental:kB,nodePaths:g};x&&(_.plugins=x),q&&(_.mangleCache=q);let aB=i&&Q(G,i,_,D),$B,EB,lB=(V,rB)=>{V.outputFiles&&(rB.outputFiles=V.outputFiles.map(vA)),V.metafile&&(rB.metafile=JSON.parse(V.metafile)),V.mangleCache&&(rB.mangleCache=V.mangleCache),V.writeToStdout!==void 0&&console.log(vB(V.writeToStdout).replace(/\n$/,""))},iB=(V,rB)=>{let oB={errors:HB(V.errors,O),warnings:HB(V.warnings,O)};lB(V,oB),Y(oB,L,()=>{if(oB.errors.length>0)return rB(CB("Build failed",oB.errors,oB.warnings),null);if(V.rebuild){if(!$B){let PB=!1;$B=()=>new Promise((TB,jB)=>{if(PB||u)throw new Error("Cannot rebuild");l(G,{command:"rebuild",key:D},(QB,OA)=>{if(QB)return rB(CB("Build failed",[{id:"",pluginName:"",text:QB,location:null,notes:[],detail:void 0}],[]),null);iB(OA,(KB,GA)=>{KB?jB(KB):TB(GA)})})}),G.ref(),$B.dispose=()=>{PB||(PB=!0,l(G,{command:"rebuild-dispose",key:D},()=>{}),G.unref())}}oB.rebuild=$B}if(V.watch){if(!EB){let PB=!1;G.ref(),EB=()=>{PB||(PB=!0,n.delete(D),l(G,{command:"watch-stop",key:D},()=>{}),G.unref())},X&&n.set(D,(TB,jB)=>{if(TB){X.onRebuild&&X.onRebuild(TB,null);return}let QB={errors:HB(jB.errors,O),warnings:HB(jB.warnings,O)};lB(jB,QB),Y(QB,L,()=>{if(QB.errors.length>0){X.onRebuild&&X.onRebuild(CB("Build failed",QB.errors,QB.warnings),null);return}jB.rebuildID!==void 0&&(QB.rebuild=$B),QB.stop=EB,X.onRebuild&&X.onRebuild(null,QB)})})}oB.stop=EB}rB(null,oB)})};if(T&&B.isWriteUnavailable)throw new Error('The "write" option is unavailable in this environment');if(kB&&B.isSync)throw new Error('Cannot use "incremental" with a synchronous build');if(X&&B.isSync)throw new Error('Cannot use "watch" with a synchronous build');l(G,_,(V,rB)=>{if(V)return F(new Error(V),null);if(aB){let oB=rB,PB=!1;G.ref();let TB={port:oB.port,host:oB.host,wait:aB.wait,stop(){PB||(PB=!0,aB.stop(),G.unref())}};return G.ref(),aB.wait.then(G.unref,G.unref),F(null,TB)}return iB(rB,F)})};return{readFromStdout:W,afterClose:H,service:{buildOrServe:w,transform:({callName:r,refs:a,input:i,options:h,isTTY:U,fs:b,callback:F})=>{let D=aA(),O=L=>{try{if(typeof i!="string"&&!(i instanceof Uint8Array))throw new Error('The input to "transform" must be a string or a Uint8Array');let{flags:x,mangleCache:Y}=fA(r,h,U,M),R={command:"transform",flags:x,inputFS:L!==null,input:L!==null?XB(L):typeof i=="string"?XB(i):i};Y&&(R.mangleCache=Y),l(a,R,(G,AB)=>{if(G)return F(new Error(G),null);let pB=HB(AB.errors,D),I=HB(AB.warnings,D),T=1,t=()=>{if(--T===0){let d={warnings:I,code:AB.code,map:AB.map};AB.mangleCache&&(d.mangleCache=AB?.mangleCache),F(null,d)}};if(pB.length>0)return F(CB("Transform failed",pB,I),null);AB.codeFS&&(T++,b.readFile(AB.code,(d,z)=>{d!==null?F(d,null):(AB.code=z,t())})),AB.mapFS&&(T++,b.readFile(AB.map,(d,z)=>{d!==null?F(d,null):(AB.map=z,t())})),t()})}catch(x){let Y=[];try{LB(Y,h,{},U,M)}catch{}let R=yB(x,B,D,void 0,"");l(a,{command:"error",flags:Y,error:R},()=>{R.detail=D.load(R.detail),F(CB("Transform failed",[R],[]),null)})}};if((typeof i=="string"||i instanceof Uint8Array)&&i.length>1024*1024){let L=O;O=()=>b.writeFile(i,L)}O(null)},formatMessages:({callName:r,refs:a,messages:i,options:h,callback:U})=>{let b=SB(i,"messages",null,"");if(!h)throw new Error(`Missing second argument in ${r}() call`);let F={},D=P(h,F,"kind",m),O=P(h,F,"color",Z),L=P(h,F,"terminalWidth",MB);if(nB(h,F,`in ${r}() call`),D===void 0)throw new Error(`Missing "kind" in ${r}() call`);if(D!=="error"&&D!=="warning")throw new Error(`Expected "kind" to be "error" or "warning" in ${r}() call`);let x={command:"format-msgs",messages:b,isWarning:D==="warning"};O!==void 0&&(x.color=O),L!==void 0&&(x.terminalWidth=L),l(a,x,(Y,R)=>{if(Y)return U(new Error(Y),null);U(null,R.messages)})},analyzeMetafile:({callName:r,refs:a,metafile:i,options:h,callback:U})=>{h===void 0&&(h={});let b={},F=P(h,b,"color",Z),D=P(h,b,"verbose",Z);nB(h,b,`in ${r}() call`);let O={command:"analyze-metafile",metafile:i};F!==void 0&&(O.color=F),D!==void 0&&(O.verbose=D),l(a,O,(L,x)=>{if(L)return U(new Error(L),null);U(null,x.result)})}}}}function aA(){let B=new Map,A=0;return{load(k){return B.get(k)},store(k){if(k===void 0)return-1;let n=A++;return B.set(n,k),n}}}function WB(B,A,k){let n,p=!1;return()=>{if(p)return n;p=!0;try{let u=(B.stack+"").split(`
