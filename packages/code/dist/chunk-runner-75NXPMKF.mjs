...
var renderFromString = /* @__PURE__ */ __name(async (code, transpiled, codeSpace) => {
...
var mod2 = {
  i: 0,
  esbuildInit: async () => await (await await import("./chunk-esbuildEsm-FHFSNCXO.mjs")).init()
};
