...
async function importShim(scr) {
  ...
  await import("./chunk-es-module-shims-2RQUEUMW.mjs");
...
var Editor = ({ code, i, codeSpace: codeSpace2, assets }) => {
  ...
  const [
    ...
    runner: async ({ code: code2, counter: counter2, codeSpace: codeSpace3 }) => {
      const { runner: runner2 } = await import("./chunk-runner-NUEXXUY4.mjs");
  ...
  useEffect(() => {
    ...
    const setMonaco = async () => {
      ...
      const { startMonaco } = await import("./chunk-startMonaco-PBBOLC4X.mjs");
