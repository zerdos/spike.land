...
var useQrious = (options) => {
  const [qrious] = (0, import_react4.useState)(() => new import_qrious.default(options));
  const [dataUrl, setDataUrl] = (0, import_react4.useState)(() => qrious.toDataURL(options.mime));
...
var QRious2 = ({ background, backgroundAlpha, foreground, foregroundAlpha, level, mime, padding, value, size, ...props }) => {
  ...
  return (0, import_react5.createElement)("img", {
    ...props,
    src: dataUrl
  });
};
...
var QRButton = ({ url }) => {
  const [showQR, setQR] = (0, import_react9.useState)(false);
...
var DraggableWindow = ({
  ...
  const [{ bottom, right }, setPositions] = (0, import_react11.useState)(startPositions);
  const [width, setWidth] = (0, import_react11.useState)(window.innerWidth * devicePixelRatio);
  const [height, setHeight] = (0, import_react11.useState)(window.innerHeight * devicePixelRatio);
  ...
  const [clients, setClients] = (0, import_react11.useState)(Object.keys(sendChannel.rtcConns));
  (0, import_react11.useEffect)(() => {
