...
function getNextChildMapping(nextProps, prevChildMapping, onExited) {
  ...
  Object.keys(children2).forEach(function(key) {
    ...
    if (hasNext && (!hasPrev || isLeaving)) {
      children2[key] = cloneElement2(child, {
        onExited: onExited.bind(null, child),
        in: true,
...
var TouchRipple = forwardRef(function TouchRipple2(inProps, ref) {
  ...
  const startCommit = useCallback((params) => {
    ...
    setRipples((oldRipples) => [...oldRipples, o4(TouchRippleRipple, {
      classes: {
...
var ButtonBase = forwardRef(function ButtonBase2(inProps, ref) {
  ...
  return o4(ButtonBaseRoot, _extends({
    as: ComponentProp,
    ...
    children: [children2, enableTouchRipple ? o4(TouchRipple_default, _extends({
      ref: handleRippleRef,
      center: centerRipple
