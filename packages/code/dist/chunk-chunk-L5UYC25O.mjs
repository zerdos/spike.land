...
(function() {
  ...
  function parse(l2, k2 = "@") {
    ...
    if (u2 > i || !e2) {
      ...
      }("undefined" != typeof self ? self : global, {}, a), r2 = e2.su(i - (2 << 17));
    }
...
var Editor = ({ code, i, codeSpace: codeSpace2, assets }) => {
  ...
  const [
    ...
    runner: async ({ code: code2, counter: counter2, codeSpace: codeSpace3 }) => {
      const { runner: runner2 } = await import("./chunk-runner-RMOB4YFF.mjs");
      const { prettierJs: prettierJs2 } = await import("./chunk-prettierEsm-BGTSIJUH.mjs");
  ...
  useEffect(() => {
    ...
    const setAce = async () => {
      const { startAce } = await import("./chunk-startAce-TQYB4BK6.mjs");
