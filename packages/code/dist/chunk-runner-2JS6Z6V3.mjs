import {
  ...
  saveCode
} from "./chunk-chunk-3QRK7QAY.mjs";
import {
  mST,
  patchSync
} from "./chunk-chunk-WYR3SQZJ.mjs";
import "./chunk-chunk-J44BQNCZ.mjs";
import "./chunk-chunk-VMTZSARI.mjs";
import {
  init_react_preact,
  k
...
var extractCritical = /* @__PURE__ */ __name((html) => {
  try {
    const rules = {};
...
async function runner({ code, counter, codeSpace }) {
  const esbuild2 = { transform: await (await mod2.esbuild).transform };
  mod2.i = counter;
  if (code === mST().code)
    return;
  try {
