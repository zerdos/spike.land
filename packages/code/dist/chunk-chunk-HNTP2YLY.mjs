...
function w(n4, l6, u5, i5, t3, o6, r4, c6, s6, a5) {
  var h5, y5, d6, k5, b5, g6, w6, x5 = i5 && i5.__k || e, C5 = x5.length;
  for (u5.__k = [], h5 = 0; h5 < l6.length; h5++)
    if (null != (k5 = u5.__k[h5] = null == (k5 = l6[h5]) || "boolean" == typeof k5 ? null : "string" == typeof k5 || "number" == typeof k5 || "bigint" == typeof k5 ? v(null, k5, null, null, k5) : Array.isArray(k5) ? v(p, { children: k5 }, null, null, null) : k5.__b > 0 ? v(k5.type, k5.props, k5.key, k5.ref ? k5.ref : null, k5.__v) : k5)) {
      if (k5.__ = u5, k5.__b = u5.__b + 1, null === (d6 = x5[h5]) || d6 && k5.key == d6.key && k5.type === d6.type)
        x5[h5] = void 0;
      else
        for (y5 = 0; y5 < C5; y5++) {
      ...
      j(n4, k5, d6 = d6 || f, t3, o6, r4, c6, s6, a5), b5 = k5.__e, (y5 = k5.ref) && d6.ref != y5 && (w6 || (w6 = []), d6.ref && w6.push(d6.ref, null, k5), w6.push(y5, k5.__c || b5, k5)), null != b5 ? (null == g6 && (g6 = b5), "function" == typeof k5.type && k5.__k === d6.__k ? k5.__d = s6 = m(k5, s6, n4) : s6 = A(n4, k5, d6, x5, b5, s6), "function" == typeof u5.type && (u5.__d = s6)) : s6 && d6.__e == s6 && s6.parentNode != n4 && (s6 = _(d6));
    }
  for (u5.__e = g6, h5 = C5; h5--; )
    null != x5[h5] && ("function" == typeof u5.type && null != x5[h5].__e && x5[h5].__e == u5.__d && (u5.__d = _(i5, h5 + 1)), N(x5[h5], x5[h5]));
  if (w6)
...
function j(n4, u5, i5, t3, o6, r4, f5, e4, c6) {
  var a5, h5, v6, y5, _7, k5, b5, g6, m4, x5, A5, C5, $3, H3 = u5.type;
  ...
  try {
    n:
      if ("function" == typeof H3) {
        if (g6 = u5.props, m4 = (a5 = H3.contextType) && t3[a5.__c], x5 = a5 ? m4 ? m4.props.value : a5.__ : t3, i5.__c ? b5 = (h5 = u5.__c = i5.__c).__ = h5.__E : ("prototype" in H3 && H3.prototype.render ? u5.__c = h5 = new H3(g6, x5) : (u5.__c = h5 = new d(g6, x5), h5.constructor = H3, h5.render = O), m4 && m4.sub(h5), h5.props = g6, h5.state || (h5.state = {}), h5.context = x5, h5.__n = t3, v6 = h5.__d = true, h5.__h = []), null == h5.__s && (h5.__s = h5.state), null != H3.getDerivedStateFromProps && (h5.__s == h5.state && (h5.__s = s({}, h5.__s)), s(h5.__s, H3.getDerivedStateFromProps(g6, h5.__s))), y5 = h5.props, _7 = h5.state, v6)
          null == H3.getDerivedStateFromProps && null != h5.componentWillMount && h5.componentWillMount(), null != h5.componentDidMount && h5.__h.push(h5.componentDidMount);
        else {
          if (null == H3.getDerivedStateFromProps && g6 !== y5 && null != h5.componentWillReceiveProps && h5.componentWillReceiveProps(g6, x5), !h5.__e && null != h5.shouldComponentUpdate && false === h5.shouldComponentUpdate(g6, h5.__s, x5) || u5.__v === i5.__v) {
            h5.props = g6, h5.state = h5.__s, u5.__v !== i5.__v && (h5.__d = false), h5.__v = u5, u5.__e = i5.__e, u5.__k = i5.__k, u5.__k.forEach(function(n5) {
              n5 && (n5.__ = u5);
            }), h5.__h.length && f5.push(h5);
            break n;
          }
          null != h5.componentWillUpdate && h5.componentWillUpdate(g6, h5.__s, x5), null != h5.componentDidUpdate && h5.__h.push(function() {
            h5.componentDidUpdate(y5, _7, k5);
          });
        }
        if (h5.context = x5, h5.props = g6, h5.__v = u5, h5.__P = n4, A5 = l.__r, C5 = 0, "prototype" in H3 && H3.prototype.render)
          h5.state = h5.__s, h5.__d = false, A5 && A5(u5), a5 = h5.render(h5.props, h5.state, h5.context);
        else
          do {
            h5.__d = false, A5 && A5(u5), a5 = h5.render(h5.props, h5.state, h5.context), h5.state = h5.__s;
          } while (h5.__d && ++C5 < 25);
        h5.state = h5.__s, null != h5.getChildContext && (t3 = s(s({}, t3), h5.getChildContext())), v6 || null == h5.getSnapshotBeforeUpdate || (k5 = h5.getSnapshotBeforeUpdate(y5, _7)), $3 = null != a5 && a5.type === p && null == a5.key ? a5.props.children : a5, w(n4, Array.isArray($3) ? $3 : [$3], u5, i5, t3, o6, r4, f5, e4, c6), h5.base = u5.__e, u5.__h = null, h5.__h.length && f5.push(h5), b5 && (h5.__E = h5.__ = null), h5.__e = false;
      } else
...
function L(l6, u5, i5, t3, o6, r4, e4, c6) {
  var s6, h5, v6, y5 = i5.props, p5 = u5.props, d6 = u5.type, k5 = 0;
  ...
  if (null === d6)
    ...
    if (r4 = r4 && n.call(l6.childNodes), h5 = (y5 = i5.props || f).dangerouslySetInnerHTML, v6 = p5.dangerouslySetInnerHTML, !c6) {
      if (null != r4)
        for (y5 = {}, k5 = 0; k5 < l6.attributes.length; k5++)
          y5[l6.attributes[k5].name] = l6.attributes[k5].value;
      (v6 || h5) && (v6 && (h5 && v6.__html == h5.__html || v6.__html === l6.innerHTML) || (l6.innerHTML = v6 && v6.__html || ""));
    }
  ...
  "node_modules/@preact/signals-core/dist/signals-core.module.js"() {
    ...
    (a4.prototype = new e3()).h = function() {
      ...
      try {
        ...
        s4 = this;
        var h5 = this.x();
        if (16 & this.f || this.v !== h5 || 0 === this.i) {
          this.v = h5;
          this.f &= -17;
          this.i++;
        }
...
function s5(n4, i5) {
  l[n4] = i5.bind(null, l[n4] || function() {
  });
}
function l5(n4) {
  if (v5)
...
function p4(n4) {
  var r4 = this, t3 = n4.data, f5 = _5(t3);
  f5.value = t3;
  var o6 = T2(function() {
    var n5 = r4.__v;
    while (n5 = n5.__)
...
function d5(n4, r4, i5, t3) {
  var f5 = r4 in n4 && void 0 === n4.ownerSVGElement, o6 = u4(i5);
  return { o: function(n5, r5) {
    o6.value = n5;
    t3 = r5;
  }, d: b4(function() {
    var i6 = o6.value.value;
    if (t3[r4] !== i6) {
      t3[r4] = i6;
      if (f5)
        n4[r4] = i6;
      else if (i6)
        n4.setAttribute(r4, i6);
      else
...
var init_signals_module = __esm({
  "node_modules/@preact/signals/dist/signals.module.js"() {
    ...
    s5("__r", function(n4, r4) {
      l5();
      var i5, t3 = r4.__c;
      if (t3) {
        t3.__$f &= -2;
        if (void 0 === (i5 = t3.__$u))
          t3.__$u = i5 = function(n5) {
            var r5;
            b4(function() {
              r5 = this;
            });
    ...
    s5("__e", function(n4, r4, i5, t3) {
      l5();
      c5 = void 0;
      n4(r4, i5, t3);
    });
    s5("diffed", function(n4, r4) {
      l5();
      c5 = void 0;
      var i5;
      if ("string" == typeof r4.type && (i5 = r4.__e)) {
        var t3 = r4.__np, f5 = r4.props;
        if (t3) {
          var o6 = i5.U;
          if (o6)
            for (var u5 in o6) {
              var e4 = o6[u5];
              if (void 0 !== e4 && !(u5 in t3)) {
                e4.d();
                o6[u5] = void 0;
              }
            }
    ...
    s5("unmount", function(n4, r4) {
      var i5 = r4.__c, t3 = i5 && i5.__$u;
      if (t3)
        t3.d();
      if ("string" == typeof r4.type) {
        var f5 = r4.__e, o6 = f5.U;
        if (o6) {
          f5.U = null;
          for (var u5 in o6) {
            var e4 = o6[u5];
