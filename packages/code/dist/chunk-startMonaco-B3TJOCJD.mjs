import "./chunk-chunk-OTCPBJ4W.mjs";
import "./chunk-chunk-S4DYRY7P.mjs";
import {
  Uri
} from "./chunk-chunk-NWJUVQ2I.mjs";
import {
  __commonJS,
  __privateAdd,
  __privateGet,
...
var startMonaco = async ({ code, container, name }) => {
  const { languages, editor } = await import("./chunk-editor.main-MWGNYBPI.mjs");
  const returnModules = {
    editor: {},
