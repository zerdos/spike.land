import "./chunk-chunk-INXFOBH4.mjs";
import "./chunk-chunk-JJ7PPQHT.mjs";
import {
  Uri
} from "./chunk-chunk-QY5KMP5D.mjs";
import {
  __commonJS,
  __privateAdd,
  __privateGet,
...
// js/monaco-editor/editor/editor.worker.monaco.worker.js?url
var editor_worker_monaco_worker_default = "./chunk-editor.worker.monaco.worker-ZDOM7RPY.js?url";

// js/monaco-editor/language/typescript/ts.worker.monaco.worker.js?url
...
window.MonacoEnvironment = {
  getWorker: function(_workerId, label) {
    if (label === "typescript" || label === "javascript") {
      return new Worker(ts_worker_monaco_worker_default);
    }
    return new Worker(editor_worker_monaco_worker_default);
  }
};
var startMonaco = async ({ code, container, name }) => {
  const { languages, editor } = await import("./chunk-editor.main-PTQJ3ANE.mjs");
  const returnModules = {
    editor: {},
...
//# sourceMappingURL=chunk-startMonaco-XZGRKE72.mjs.map
