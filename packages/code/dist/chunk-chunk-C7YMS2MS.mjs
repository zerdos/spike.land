...
import {
  ...
  domMax,
  m
} from "./chunk-chunk-RVECUTKB.mjs";
import {
  require_emotion_react_cjs
} from "./chunk-chunk-BEJKF6MA.mjs";
import {
  require_emotion_react_jsx_runtime_cjs
} from "./chunk-chunk-7UKTGKTB.mjs";
import {
...
var Editor = ({ code, i, codeSpace: codeSpace2, assets }) => {
  ...
  const [
    ...
    runner: async ({ code: code2, counter: counter2, codeSpace: codeSpace3 }) => {
      const { runner: runner2 } = await import("./chunk-runner-QYG5KRQ7.mjs");
      const { prettierJs: prettierJs2 } = await import("./chunk-prettierJs-4XLIYAKZ.mjs");
  ...
  useEffect(() => {
    ...
    const setMonaco = async () => {
      ...
      const { startMonaco } = await import("./chunk-startMonaco-6OXO3VW7.mjs");
    ...
    const setAce = async () => {
      const { startAce } = await import("./chunk-startAce-2XB4OAUB.mjs");
