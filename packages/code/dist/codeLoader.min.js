...
`,h=window.document;let S=!0,w=0,T=0,y="",v="",j="",f="";export async function run(){await b("https://unpkg.com/react-dom@17.0.1/umd/react-dom-server.browser.production.min.js"),await b("https://unpkg.com/@emotion/react@11.1.1/dist/emotion-react.umd.min.js"),await b("https://unpkg.com/@emotion/styled@11.0.0/dist/emotion-styled.umd.min.js");const l=b("https://unpkg.com/@ampproject/worker-dom@0.27.4/dist/main.js");await b("https://unpkg.com/@babel/standalone@7.12.6/babel.min.js"),(async()=>{const r=i();f=r;const e=await M({language:"typescript",code:r,onChange:m});function m(t){if(!e)return;if(y=t,!w)o(y);else{const a=t,n=setInterval(()=>{(t!==y||!w)&&clearInterval(n),w||o(y)},100)}}async function c(){if(!e||!e.monaco)return;const t=e.monaco.Uri.parse("file:///main.tsx"),a=await e.monaco.languages.typescript.getTypeScriptWorker(),n=await(await a(t)).getSemanticDiagnostics("file:///main.tsx"),u=await(await a(t)).getCompilerOptionsDiagnostics("file:///main.tsx"),p=await(await a(t)).getSyntacticDiagnostics("file:///main.tsx");return[...n,...u,...p]}async function o(t){const{diff:a}=await import("../dist/diff.min.js");if(w===1)return;try{w=1;const n=await c(),u=h.getElementById("error");if(w=0,t!==y)return;if(n&&n.length){if(y!=t)return;if(v===t)return;const p=a(f,t,0);if(p.length<=3){e.monaco.editor.setTheme("hc-black");return}u.innerHTML=n[0].messageText.toString(),u.style.display="block",v=t,e.monaco.editor.setTheme("vs-light"),setTimeout(()=>{e.monaco.editor.setTheme("hc-black")},T++);return}f=t,u.style.display="none",e.monaco.editor.setTheme("vs-dark"),T=0,w=0,d(s(t))}catch(n){if(w=0,t!==y)return;e.monaco.editor.setTheme("vs-light"),setTimeout(()=>{e.monaco.editor.setTheme("hc-black")},10),console.error(n)}}})(),d(s(i())),await l;async function d(r){const e=/import/gi,m="///",c=r.replaceAll(/import/gi,"///").replace("export default","DefaultElement = "),o=async()=>{const t=new Function("code",`return function(){  
          let DefaultElement;
