...
export default async ({ onChange, code, language, container, options }) => {
    ...
    if (language === "typescript") {
        const importHelper = [
            {
                name: "react",
                url: "https://unpkg.com/@types/react@17.0.13/index.d.ts",
                depend: ["global", "csstype", "react-dom", "prop-types"],
            },
            {
                name: "react/jsx-dev-runtime",
                url: "https://unpkg.com/@types/react@17.0.13/jsx-dev-runtime.d.ts",
                depend: ["global", "csstype", "react-dom", "prop-types"],
            },
            {
                name: "react-exp  ",
                url: "https://unpkg.com/@types/react@17.0.13/experimental.d.ts",
                depend: [],
            },
            {
                name: "global",
                url: "https://unpkg.com/@types/react@17.0.13/global.d.ts",
                depend: [],
            },
            {
                name: "prop-types",
            ...
            {
                name: "react-dom",
                url: "https://unpkg.com/@types/react-dom@17.0.8/index.d.ts",
                depend: [],
            },
            {
                name: "csstype",
            ...
            {
                name: "framer-motion",
                url: "https://unpkg.com/framer-motion@5.0.0-alpha.2/dist/framer-motion.d.ts",
                depend: ["popmotion"],
            },
            {
                name: "popmotion",
