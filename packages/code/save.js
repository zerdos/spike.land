(function(global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports) : typeof define === 'function' && define.amd ? define([
        'exports'
    ], factory) : (global = global || self, factory(global.React = {
    }));
    ...
    function escape(key) {
        ...
        var escapedString = key.replace(/[=:]/g, function(match) {
    ...
    function getSourceInfoErrorAddendum(source) {
        if (source !== undefined) {
            ...
            var lineNumber;
            return '\n\nCheck your code at ' + fileName + ':' + source.lineNumber + '.';
        }
        return '';
    }
    ...
    var profilingStateSize;
    var sharedProfilingBuffer = typeof SharedArrayBuffer === 'function' ? new SharedArrayBuffer(4 * Int32Array.BYTES_PER_ELEMENT) : typeof ArrayBuffer === 'function' ? new ArrayBuffer(4 * Int32Array.BYTES_PER_ELEMENT) : null;
...
(function(global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react')) : typeof define === 'function' && define.amd ? define([
        'exports',
        'react'
    ], factory) : (global = global || self, factory(global.ReactDOMServer = {
    }, global.React));
    ...
    var VALID_ATTRIBUTE_NAME_REGEX = new RegExp('^[' + ":A-Z_a-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02FF\\u0370-\\u037D\\u037F-\\u1FFF\\u200C-\\u200D\\u2070-\\u218F\\u2C00-\\u2FEF\\u3001-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFFD" + '][' + ATTRIBUTE_NAME_CHAR + ']*$');
    var hasOwnProperty = Object.prototype.hasOwnProperty;
    ...
    function useReducer(reducer, initialArg, init) {
        ...
        if (isReRender) {
            ...
            return [
                workInProgressHook.memoizedState,
                _queue.dispatch = dispatchAction.bind(null, currentlyRenderingComponent, _queue)
            ];
        }
    }
        ...
        _proto.renderDOM = function renderDOM(element, context, parentNamespace) {
            ...
            if (tag === 'input') {
            ...
            } else if (tag === 'select') {
                {
                    ...
                    for(var i1 = 0; i1 < valuePropNames.length; i1++){
                        var propName = valuePropNames[i1];
...
const Counter = ({ initial =0  })=>{
    ...
    return React.createElement("div", null, React.createElement("p", null, "Clicks: ", React.createElement("strong", null, clicks)), React.createElement("button", {
        onClick: ()=>setClicks(clicks + 1)
    }, "+"), React.createElement("button", {
        onClick: ()=>setClicks(clicks - 1)
    }, "-"));
};
const str = ReactDOMServer.renderToString(React.createElement(Counter, {
    initial: 0
}, "xx"));
