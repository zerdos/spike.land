...
describe('replacePreservingWhitespace', () => {
    ...
    it('2. should preserve leading whitespace', () => {
      const result = replacePreservingWhitespace('   The quick brown fox', 'The', 'A');
      expect(result).toEqual('   A quick brown fox');
    });
  
    it('3. should preserve trailing whitespace', () => {
      const result = replacePreservingWhitespace('The quick brown fox   ', 'fox', 'cat');
      expect(result).toEqual('The quick brown cat   ');
    });
  
    it('4. should handle multiple occurrences', () => {
      const result = replacePreservingWhitespace('The quick quick brown quick fox', 'quick', 'slow');
    ...
    it('6. should not replace if search string is not found', () => {
      const result = replacePreservingWhitespace('The quick brown fox', 'lazy', 'energetic');
