...
import type { Stats, BigIntStats, MakeDirectoryOptions, Mode, OpenMode, PathLike, RmDirOptions, RmOptions, WriteFileOptions, BufferEncodingOption, ObjectEncodingOptions, Dirent } from 'node:fs';
...
interface FileHandle {
  ...
  readFile(options?: { encoding?: BufferEncoding | null; flag?: OpenMode } & Abortable): Promise<string | Buffer>;
  ...
  write(buffer: Uint8Array, offset?: number, length?: number, position?: number): Promise<{ bytesWritten: number; buffer: Uint8Array }>;
...
interface FSModule {
  ...
  appendFile(path: PathLike | FileHandle, data: string | Uint8Array, options?: WriteFileOptions): Promise<void>;
  ...
  readdir(path: PathLike, options?: { encoding?: BufferEncoding | null; withFileTypes?: false } & Abortable): Promise<string[]>;
  readdir(path: PathLike, options: { encoding: 'buffer'; withFileTypes?: false } & Abortable): Promise<Buffer[]>;
  readdir(path: PathLike, options?: { encoding?: BufferEncoding | null; withFileTypes?: true } & Abortable): Promise<Dirent[]>;
  readFile(path: PathLike | FileHandle, options?: { encoding?: null; flag?: OpenMode } & Abortable): Promise<Buffer>;
  readFile(path: PathLike | FileHandle, options: { encoding: BufferEncoding; flag?: OpenMode } & Abortable): Promise<string>;
  readFile(path: PathLike | FileHandle, options?: { encoding?: BufferEncoding | null; flag?: OpenMode } & Abortable): Promise<string | Buffer>;
  readlink(path: PathLike, options?: { encoding?: BufferEncoding | null } & Abortable): Promise<string>;
  realpath(path: PathLike, options?: { encoding?: BufferEncoding | null } & Abortable): Promise<string>;
  ...
  writeFile(path: PathLike | FileHandle, data: string | Uint8Array, options?: WriteFileOptions): Promise<void>;
}

declare const fsPromises: FSModule;
