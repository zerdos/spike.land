...
import { createDiff, applyDiff } from './text-diff';
...
describe('text-diff with string optimization', () => {
  ...
  it('should use string diff for long strings', () => {
    ...
    const longString = 'This is a very long string that exceeds the threshold of 80 characters. It should trigger the string diff optimization.';
  ...
  it('should handle very large text changes efficiently', () => {
    ...
    const modifiedString = 
      veryLongString.substring(0, 10000) + 
      '.' + 
  ...
  it('should handle nested message content with string diffs', () => {
    ...
    const longContent = 'This is a very long message content that exceeds the threshold of 80 characters. It should trigger the string diff optimization.';
