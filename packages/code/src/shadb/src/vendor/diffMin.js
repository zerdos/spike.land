...
N.prototype = {
  diff: function (n, r) {
    ...
    if (c[0].newPos + 1 >= f && u + 1 >= a) {
      return l(
        [{ value: this.join(r), count: r.length }],
      );
    }
    function v() {
  ...
  pushComponent: function (n, r, t) {
    ...
    s && s.added === r && s.removed === t
      ? n[n.length - 1] = { count: s.count + 1, added: r, removed: t }
      : n.push({ count: 1, added: r, removed: t });
  },
  extractCommon: function (n, r, t, s) {
    ...
    return o && n.components.push({ count: o }), n.newPos = f, a;
  },
  equals: function (n, r) {
    return this.options.comparator ? this.options.comparator(n, r) : n === r ||
...
function Ie(e, n) {
  ...
  else if (e) for (var r in e) e.hasOwnProperty(r) && (n[r] = e[r]);
  return n;
}
...
function Z(e, n, r, t, s) {
  ...
  if (ge.call(e) === "[object Array]") {
    for (
      n.push(e), l = new Array(e.length), r.push(l), i = 0;
      i < e.length;
      i += 1
    ) {
      l[i] = Z(e[i], n, r, t, s);
...
function Ce(e, n) {
  ...
  function v(M, S) {
    for (var R = 0; R < M.lines.length; R++) {
      var H = M.lines[R],
        D = H.length > 0 ? H[0] : " ",
        ie = H.length > 0 ? H.substr(1) : H;
      if (D === " " || D === "-") {
        if (!l(S + 1, t[S], D, ie) && (f++, f > a)) return !1;
        S++;
      }
    }
    return !0;
  ...
  for (var g = 0, F = 0; F < i.length; F++) {
    ...
    for (var I = 0; I < m.lines.length; I++) {
      var C = m.lines[I],
        z = C.length > 0 ? C[0] : " ",
        $ = C.length > 0 ? C.substr(1) : C,
        J = m.linedelimiters[I];
      if (z === " ") E++;
      else if (z === "-") t.splice(E, 1), s.splice(E, 1);
      else if (z === "+") t.splice(E, 0, $), s.splice(E, 0, J), E++;
      else if (z === "\\") {
  ...
  if (c) for (; !t[t.length - 1];) t.pop(), s.pop();
  else {
    u && (t.push(""),
      s.push(`
`));
  }
  for (var A = 0; A < t.length - 1; A++) t[A] = t[A] + s[A];
  return t.join("");
}
...
function be(e, n) {
  if (typeof e == "string") {
    if (/^@@/m.test(e) || /^Index:/m.test(e)) return P(e)[0];
...
function Ae(e, n, r) {
  return n === r ? n : (e.conflict = !0, { mine: n, theirs: r });
}
function He(e, n) {
...
function Te(e, n, r, t, s) {
  var i = { offset: n, lines: r, index: 0 },
    l = { offset: t, lines: s, index: 0 };
  for (
    ee(e, i, l), ee(e, l, i);
    ...
    if ((f[0] === "-" || f[0] === "+") && (a[0] === "-" || a[0] === "+")) {
      ...
      f[0] === "-" && a[0] === " "
        ...
        ? k(e, l, i, !0)
        : f === a
        ? (e.lines.push(f), i.index++, l.index++)
        : Q(e, O(i), O(l));
    }
  }
  ne(e, i), ne(e, l), xe(e);
...
function Q(e, n, r) {
  e.conflict = !0, e.lines.push({ conflict: !0, mine: n, theirs: r });
}
function ee(e, n, r) {
