...
Via.js works the other way round too: you can write code that makes the calls on
...
Via.js commands are automatically submitted at the next microtask to be
