(function() {
  ...
  const ye = !navigator.userAgentData &&
  ...
  function resolveUrl(e, t) {
    return resolveIfNotPlainOrUrl(e, t) || asURL(e) ||
      resolveIfNotPlainOrUrl("./" + e, t);
  }
  function resolveIfNotPlainOrUrl(e, t) {
    const r = t.indexOf("#"), s = t.indexOf("?");
          ...
          new Promise((s, n) => {
            ...
            function cb(a) {
              ...
              if (self._esmsi) {
                ...
                n(
                  !(a instanceof Event) && a || e && e.error ||
                    new Error(
      ...
      return e
        ? new Promise((e) => {
          ...
          const r = `<script nonce=${
            ne || ""
          }>b=(s,type='text/javascript')=>URL.createObjectURL(new Blob([s],{type}));document.head.appendChild(Object.assign(document.createElement('script'),{type:'importmap',nonce:"${ne}",innerText:\`{"imports":{"x":"\${b('')}"}}\`}));Promise.all([${
            Pe ? "true,true" : "'x',b('import.meta')"
          }, ${
            be
            ...
            ke && we
              ? `b(\`import source x from "\${b(new Uint8Array(${
                JSON.stringify(Re)
              }),'application/wasm')}"\`)`
              : "false"
        ...
        : Promise.all([
          ...
          be &&
          Ae(
            createBlob(`import"${createBlob("", "text/css")}"with{type:"css"}`),
          ).then(() => Ee = true, noop),
          he &&
          Ae(
            createBlob(
    ...
    if (r > qe || !_e) {
      ...
      Ne = new ArrayBuffer(qe),
        ...
        _e = function(e, t, r) {
          ...
          function l() {
            var e = 0, t = 0, r = 0, a = 0, c = 0, f = 0, ne = 0;
            c = i[72] | 0;
            r = c + 12 | 0;
            i[72] = r;
            a = w(1) | 0;
    ...
    switch (++De, e) {
      ...
      case 117:
        return function() {
          ...
          let t;
          123 === e
            ? (++De, t = l(Je.indexOf("}", De) - De), ++De, t > 1114111 && o())
            : t = l(4);
          return t <= 65535
      ...
      default:
        if (e >= 48 && e <= 55) {
          let t = Je.substr(De - 1, 3).match(/^[0-7]+/)[0], r = parseInt(t, 8);
          return r > 255 && (t = t.slice(0, -1), r = parseInt(t, 8)),
            De += t.length - 1,
            e = Je.charCodeAt(De),
            "0" === t && 56 !== e && 57 !== e || o(),
  ...
  function defaultResolve(e, t) {
    return resolveImportMap(Ke, resolveIfNotPlainOrUrl(e, t) || e, t) ||
      throwUnresolved(e, t);
  }
  ...
  async function loadAll(e, t) {
    t[e.u] = 1;
    await e.L;
    await Promise.all(e.d.map(({ l: e, s: r }) => {
  ...
  let Ze;
  const Qe = Te.then(() => {
    Ze = r.polyfillEnable !== true && Le && Me && Pe && (!he || Ue) &&
      (!be || Ee) && (!ke || Ie) && (!we || je) && !Se;
    if (
      we && typeof WebAssembly !== "undefined" &&
    ...
    if (e) {
      if (!Pe) {
        const c = HTMLScriptElement.supports ||
  ...
  function resolveDeps(e, t) {
    ...
    for (const { s: t, ss: s, se: oe, d: le, t: ue } of r) {
      if (ue === 4) {
        ...
        pushStringTo(t - 1);
        i += `/*${n.slice(t - 1, oe)}*/'${
          createBlob(`export default importShim._s[${urlJsString(r.r)}]`)
        }'`;
        a = oe;
      } else if (le === -1) {
        let { l: r } = e.d[f++], s = r.b, c = !s;
        c &&
          ((s = r.s) ||
            (s = r.s = createBlob(
              `export function u$_(m){${
                ...
                r.a[1].map(
                  ({ s: e, e: t }, s) => `e$_${s} as ${r.S.slice(e, t)}`,
                ).join(",")
              }}\n//# sourceURL=${r.r}?cycle`,
            )));
        pushStringTo(t - 1);
        ...
        if (!c && r.s) {
          i +=
            `;import*as m$_${f} from'${r.b}';import{u$_ as u$_${f}}from'${r.s}';u$_${f}(m$_${f})`;
          r.s = void 0;
        }
        a = oe;
      } else if (le === -2) {
  ...
  async function fetchModule(e, t, r) {
    ...
    if (it.test(a)) {
      ...
      r = 0;
      t += `const instance = await WebAssembly.instantiate(importShim._s[${
        urlJsString(i)
      }], {${s}});\n`;
    ...
    if (ot.test(a)) {
      return {
        ...
        s: `var s=new CSSStyleSheet();s.replaceSync(${
          JSON.stringify(
            (await n.text()).replace(ct, (t, r = "", s, n) =>
              `url(${r}${resolveUrl(s || n, e)}${r})`),
          )
        });export default s;`,
        ss: null,
        t: "css",
    ...
    throw Error(
      `Unsupported Content-Type "${a}" loading ${e}${
        fromParent(r)
  ...
  function getOrCreateLoad(e, t, r, n) {
    ...
    i.f = (async () => {
      if (!i.S) {
        ...
        if (n && !s) {
          if (
            n === "css" && !be || n === "json" && !he || n === "wasm" && !ke
          ) throw featErr(`${n}-modules`);
          (n === "css" && !Ee || n === "json" && !Ue || n === "wasm" && !Ie) &&
            (i.n = true);
        }
      }
      try {
  ...
  function linkLoad(e, t) {
    e.L || (e.L = e.f.then(async () => {
      let r = t;
      e.d = (await Promise.all(e.a[0].map(async ({ n: s, d: n, t: i }) => {
        const a = i >= 4;
  ...
  const epCheck = (e, t) =>
    e.ep || !t && (!e.src && !e.innerHTML || !hasNext(e)) ||
    e.getAttribute("noshim") !== null || !(e.ep = true);
