...
(function(d, w) {
        ...
        diff: function(n, t) {
            ...
            function h() {
                for(var c = -1 * u; c <= u; c += 2){
                    ...
                    if (!y || E && x.newPos < m.newPos ? (L = I(m), i.pushComponent(L.components, void 0, !0)) : (L = x, L.newPos++, i.pushComponent(L.components, !0, void 0)), F = i.extractCommon(L, t, n, c), L.newPos + 1 >= s && F + 1 >= o) return l(H(i, L.components, t, n, i.useLongestToken));
                    v[c] = L;
                }
                u++;
            }
    ...
    U.equals = function(e, n) {
        ...
        for(var n = e.split(/([^\S\r\n]+|[()[\]{}'"\r\n]|\b)/), t = 0; t < n.length - 1; t++)!n[t + 1] && n[t + 2] && P.test(n[t]) && P.test(n[t + 2]) && (n[t] += n[t + 2], n.splice(t + 1, 2), t--);
        return n;
    };
    function me(e, n, t) {
        return (t = $(t, {
    ...
    function Z(e, n, t, r, f) {
        ...
        if (Ae.call(e) === "[object Array]") {
            for((n.push(e), l = new Array(e.length), t.push(l), i = 0); i < e.length; i += 1)l[i] = Z(e[i], n, t, r, f);
        ...
        if ((e && e.toJSON && (e = e.toJSON()), X(e) === "object" && e !== null)) {
            ...
            for((s.sort(), i = 0); i < s.length; i += 1)o = s[i], l[o] = Z(e[o], n, t, r, o);
            n.pop(), t.pop();
        } else l = e;
        return l;
    }
...
const diff = async (d, w)=>{
    ...
    ).length === 0, H = d.slice(8);
    if (w && H[0] === "[" && H[H.length - 1] === "]") try {
