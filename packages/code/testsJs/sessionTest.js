...
var require_immutable = __commonJS({
  "../../node_modules/immutable/dist/immutable.js"(exports, module) {
    (function(global, factory) {
      ...
      Record2.prototype.hashCode = function hashCode2() {
...
// tests/sessionTest.ts
import { test } from "uvu";
import * as assert from "uvu/assert";

// js/session.ts
var import_immutable = __toESM(require_immutable(), 1);
...
function initSession(room, u) {
  return (0, import_immutable.Record)({ ...u, room, state: (0, import_immutable.Record)(u.state)() });
}
var session = null;
var hashStore = {};
var CodeSession = class {
  ...
  hashOfState = () => {
    ...
    const hashCode2 = state.hashCode();
    hashStore[hashCode2] = state;
    return hashCode2;
  };
  createPatchFromHashCode = async (oldHash, state, updateHash) => {
    ...
    if (!oldRec) {
      ...
      const { mST: mST2, hashCode: hashCode2 } = await resp.json();
      if (updateHash)
        updateHash(hashCode2);
      hashStore[hashCode2] = this.session.get("state").merge(mST2);
      usedOldHash = hashCode2;
      oldRec = hashStore[hashCode2];
    }
...
var hashCode = () => session ? session.hashOfState() : 0;
var mST = () => {
  if (!session) {
    return {
      i: 0,
...
var makePatchFrom = (n, st, update) => session.createPatchFromHashCode(n, st, update);
var makePatch = (st, update) => makePatchFrom(hashCode(), st, update);
...
// tests/sessionTest.ts
var state1 = { code: "", transpiled: "", i: 33, css: "", html: "" };
var state2 = { code: "dddd", transpiled: "", i: 33, css: "", html: "" };
var hash1 = 0;
var hash2 = 0;
...
test("wont start a new session", () => {
  const hash12 = hashCode();
  startSession("z", { name: "z", state: state2 }, "");
  assert.is(Number(hashCode()), hash12);
});
