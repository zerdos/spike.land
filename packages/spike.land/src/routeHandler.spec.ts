  ...
  describe('Route Handlers', () => {
    ...
    describe('handleDefaultRoute', () => {
      it('should return HTML with correct replacements', async () => {
        ...
        expect(responseText).toContain(`<script type="importmap">${JSON.stringify(importMap)}</script>`);
        
        // Check for CSS link replacement
        expect(responseText).toContain(`<link rel="preload" href="/live/test-space/index.css" as="style" />`);
