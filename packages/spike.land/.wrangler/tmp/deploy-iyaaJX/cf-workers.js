...
var hi = q((V_, fi) => {
  ...
  var ei = /[^a-zA-Z0-9]/, ni = /\s/, ii = /[\r\n]/, uo = /\n\r?\n$/, fo = /^\r?\n\r?\n/;
  function ho(t3) {
    function r(l2, v) {
      if (!l2 || !v)
        return 6;
      var d = l2.charAt(l2.length - 1), w2 = v.charAt(0), y = d.match(ei), I2 = w2.match(ei), A2 = y && d.match(ni), q2 = I2 && w2.match(ni), L = A2 && d.match(ii), x2 = q2 && w2.match(ii), et = L && l2.match(uo), mt2 = x2 && v.match(fo);
...
7ec315219565f0a67221b96a2937da6c101ea3cf
`.trim();

// ../code/dist/cf-workers.mjs
import ft2 from "__STATIC_CONTENT_MANIFEST";
var _t2 = q((Nn2, Ft2) => {
  "use strict";
  o();
  function Ie2() {
  ...
  Ie2.prototype.define = function(t3, e3) {
    for (let a in t3) {
  ...
  Ie2.prototype.getType = function(t3) {
    t3 = String(t3);
  ...
  Ie2.prototype.getExtension = function(t3) {
...
var Ht2 = q((J2) => {
  ...
  }, Dt2 = (t3) => typeof t3 == "string" ? JSON.parse(t3) : t3, Ra = {
    ASSET_NAMESPACE: typeof __STATIC_CONTENT < "u" ? __STATIC_CONTENT : void 0,
    ASSET_MANIFEST: typeof __STATIC_CONTENT_MANIFEST < "u" ? Dt2(__STATIC_CONTENT_MANIFEST) : {},
    cacheControl: tt2,
  ...
  function at2(t3) {
    return Object.assign({}, Ra, t3);
  }
  var Ne2 = (t3, e3) => {
    e3 = at2(e3);
    let a = new URL(t3.url), n = a.pathname;
    return n.endsWith("/") ? n = n.concat(e3.defaultDocument) : Mt2.getType(n) || (n = n.concat("/" + e3.defaultDocument)), a.pathname = n, new Request(a.toString(), t3);
  };
  J2.mapRequestToAsset = Ne2;
  function Pa(t3, e3) {
    e3 = at2(e3), t3 = Ne2(t3, e3);
    let a = new URL(t3.url);
    return a.pathname.endsWith(".html") ? new Request(`${a.origin}/${e3.defaultDocument}`, t3) : t3;
  }
  J2.serveSinglePageApp = Pa;
  var ja = async (t3, e3) => {
    e3 = at2(e3);
    let a = t3.request, n = e3.ASSET_NAMESPACE, i2 = Dt2(e3.ASSET_MANIFEST);
    if (typeof n > "u")
    ...
    if (e3.mapRequestToAsset)
      ...
      let f = Ne2(a), k3 = new URL(f.url).pathname.replace(/^\/+/, "");
      i2[decodeURIComponent(k3)] ? (s2 = true, r = f) : r = Ne2(a, e3);
    }
    if (!["GET", "HEAD"].includes(r.method))
      throw new he2.MethodNotAllowedError(`${r.method} is not a valid request method`);
    let h2 = new URL(r.url), x2 = (s2 ? decodeURIComponent(h2.pathname) : h2.pathname).replace(/^\/+/, ""), l2 = caches.default, p = Mt2.getType(x2) || e3.defaultMimeType;
    ...
    e3.cacheControl = Object.assign({}, tt2, u), (e3.cacheControl.bypassCache || e3.cacheControl.edgeTTL === null || a.method == "HEAD") && (d = false);
    let E2 = typeof e3.cacheControl.browserTTL == "number", g3 = null;
    ...
    return E2 ? g3.headers.set("Cache-Control", `max-age=${e3.cacheControl.browserTTL}`) : g3.headers.delete("Cache-Control"), g3;
  };
  J2.getAssetFromKV = ja;
});
o();
o();
var ga = s(Ht2(), 1);
...
function Lt2(t3) {
  ...
  function h2(x2) {
    a = a ? a + x2 : x2, e3 && Aa(a) && (a = a.slice(Wt2.length)), e3 = false;
    let l2 = a.length, p = 0, d = false;
    for (; p < l2; ) {
      d && (a[p] === `
` && ++p, d = false);
      let m2 = -1, u = i2, b2;
      for (let E2 = n; m2 < 0 && E2 < l2; ++E2)
        b2 = a[E2], b2 === ":" && u < 0 ? u = E2 - p : b2 === "\r" ? (d = true, m2 = E2 - p) : b2 === `
` && (m2 = E2 - p);
      if (m2 < 0) {
        n = l2 - p, i2 = u;
        break;
  ...
  function v(x2, l2, p, d) {
    ...
    let E2 = l2 + b2, g3 = d - b2, f = x2.slice(E2, E2 + g3).toString();
    if (u === "data")
      r += f ? "".concat(f, `
`) : `
`;
...
var Wt2 = [239, 187, 191];
function Aa(t3) {
  return Wt2.every((e3, a) => t3.charCodeAt(a) === e3);
}
o();
var Bt2 = (t3, e3 = 21) => (a = e3) => {
  let n = "", i2 = a;
  for (; i2--; )
...
function Ia(t3, e3, a) {
  ...
  return (t3.body || Na()).pipeThrough(Fa(e3)).pipeThrough(Xt2(a));
}
function Na() {
  return new ReadableStream({
    start(t3) {
...
var $a = (t3) => {
  ...
  return za[n].parse(o2);
};
function Ue2(t3, e3) {
  let a = Jt2.find((n) => n.name === t3);
  if (!a)
...
function Ma(t3) {
  ...
  return new TransformStream({
    transform: async (n, i2) => {
      let o2 = a.decode(n);
      i2.enqueue(e3.encode(Ue2("text", o2)));
    }
  });
}
var ti = Bt2(
...
function Gt2() {
  ...
  return (a) => {
    ...
    return nt2(a) && ((o2 = (i2 = (n = a.choices[0]) == null ? void 0 : n.delta) == null ? void 0 : i2.function_call) != null && o2.name) ? (e3 = true, `{"function_call": {"name": "${(r = (s2 = a.choices[0]) == null ? void 0 : s2.delta) == null ? void 0 : r.function_call.name}", "arguments": "`) : nt2(a) && ((v = (h2 = (c = a.choices[0]) == null ? void 0 : c.delta) == null ? void 0 : h2.function_call) != null && v.arguments) ? `${a.choices[0].delta.function_call.arguments.replace(/\\/g, "\\\\").replace(/\//g, "\\/").replace(/"/g, '\\"').replace(/\n/g, "\\n").replace(/\r/g, "\\r").replace(/\t/g, "\\t").replace(/\f/g, "\\f")}` : e3 && (((x2 = a.choices[0]) == null ? void 0 : x2.finish_reason) === "function_call" || ((l2 = a.choices[0]) == null ? void 0 : l2.finish_reason) === "stop") ? (e3 = false, '"}}') : t3(
      nt2(a) && a.choices[0].delta.content ? a.choices[0].delta.content : Wa(a) ? a.choices[0].text : ""
    );
  };
}
var Qt2 = Symbol(
...
function it2(t3, e3) {
  let a = e3, n;
  if (Symbol.asyncIterator in t3 ? n = Ua(La(t3)).pipeThrough(
    Xt2(
    ...
    return n.pipeThrough(
      Ma(a == null ? void 0 : a.experimental_streamData)
    );
}
function Ba(t3) {
  let e3 = new TextEncoder(), a = true, n = "", i2 = "", o2 = false, s2 = t3[Qt2] || [], r = t3 == null ? void 0 : t3.experimental_streamData, c = Da();
  return new TransformStream({
      ...
      try {
        if (!a && t3.experimental_onFunctionCall && o2 && t3.experimental_onFunctionCall) {
          ...
          if (d) {
            if (typeof d == "string") {
              h2.enqueue(
                r ? e3.encode(Ue2("text", d)) : e3.encode(d)
              );
              return;
            }
          } else {
          ...
          for (; ; ) {
            let { done: E2, value: g3 } = await b2.read();
            if (E2)
              break;
            h2.enqueue(g3);
          }
...
var Qa = typeof fetch > "u" ? void 0 : fetch;
var ot2 = class {
  basePath;
  fetch;
  configuration;
  constructor(e3, a = A, n = Qa) {
...
var j3 = function(t3, e3, a) {
  if (a == null)
    throw new st2(e3, `Required parameter ${e3} was null or undefined when calling ${t3}.`);
};
function rt(t3, e3, a = "") {
  e3 != null && (typeof e3 == "object" ? Array.isArray(e3) ? e3.forEach((n) => rt(t3, n, a)) : Object.keys(e3).forEach((n) => rt(t3, e3[n], `${a}${a !== "" ? "." : ""}${n}`)) : t3.has(a) ? t3.append(a, e3) : t3.set(a, e3));
}
var _ = function(t3, ...e3) {
  let a = new URLSearchParams(t3.search);
  rt(a, e3), t3.search = a.toString();
};
...
var lt2 = class extends FormData {
  _boundary;
  constructor(...e3) {
    super(...e3), this._boundary = Ja();
  }
  getHeaders() {
    var e3 = {
...
var qe2 = class {
  ...
  constructor(e3 = {}) {
    ...
    }, this.organization && (this.baseOptions.headers["OpenAI-Organization"] = this.organization), this.formDataCtor || (this.formDataCtor = lt2);
  }
  /**
...
var en2 = Object.getOwnPropertyNames;
var tn2 = Object.getPrototypeOf;
var an = Object.prototype.hasOwnProperty;
var nn2 = (t3, e3) => () => (e3 || t3((e3 = { exports: {} }).exports, e3), e3.exports);
var on = (t3, e3, a, n) => {
  if (e3 && typeof e3 == "object" || typeof e3 == "function")
    for (let i2 of en2(e3))
      !an.call(t3, i2) && i2 !== a && la(t3, i2, { get: () => e3[i2], enumerable: !(n = Za(e3, i2)) || n.enumerable });
  return t3;
};
var sn = (t3, e3, a) => (a = t3 != null ? Ya(tn2(t3)) : {}, on(e3 || !t3 || !t3.__esModule ? la(a, "default", { value: t3, enumerable: true }) : a, t3));
var rn2 = nn2((t3, e3) => {
  (function(a, n) {
    "use strict";
    var i2 = "1.0.37", o2 = "", s2 = "?", r = "function", c = "undefined", h2 = "object", v = "string", x2 = "major", l2 = "model", p = "name", d = "type", m2 = "vendor", u = "version", b2 = "architecture", E2 = "console", g3 = "mobile", f = "tablet", k3 = "smarttv", w2 = "wearable", y = "embedded", q2 = 500, $2 = "Amazon", B2 = "Apple", X2 = "ASUS", M2 = "BlackBerry", L = "Browser", D2 = "Chrome", W2 = "Edge", re2 = "Firefox", ce2 = "Google", wt2 = "Huawei", Le2 = "LG", We2 = "Microsoft", bt2 = "Motorola", Re2 = "Opera", Pe2 = "Samsung", yt2 = "Sharp", je2 = "Sony", Be2 = "Xiaomi", Qe2 = "Zebra", Ct2 = "Facebook", St2 = "Chromium OS", Ot2 = "Mac OS", Sa = function(T2, P2) {
      var S2 = {};
      for (var z2 in T2)
        P2[z2] && P2[z2].length % 2 === 0 ? S2[z2] = P2[z2].concat(T2[z2]) : S2[z2] = T2[z2];
      return S2;
    }, Ae2 = function(T2) {
      for (var P2 = {}, S2 = 0; S2 < T2.length; S2++)
        P2[T2[S2].toUpperCase()] = T2[S2];
      return P2;
    }, kt2 = function(T2, P2) {
      return typeof T2 === v ? ge2(P2).indexOf(ge2(T2)) !== -1 : false;
    }, ge2 = function(T2) {
      return T2.toLowerCase();
    }, Oa = function(T2) {
      return typeof T2 === v ? T2.replace(/[^\d\.]/g, o2).split(".")[0] : n;
    }, Xe2 = function(T2, P2) {
      if (typeof T2 === v)
        return T2 = T2.replace(/^\s\s*/, o2), typeof P2 === c ? T2 : T2.substring(0, q2);
    }, we2 = function(T2, P2) {
      for (var S2 = 0, z2, ie, Y2, R2, C2, ae2; S2 < P2.length && !C2; ) {
        var Ge2 = P2[S2], Rt2 = P2[S2 + 1];
        for (z2 = ie = 0; z2 < Ge2.length && !C2 && Ge2[z2]; )
          if (C2 = Ge2[z2++].exec(T2), C2)
            for (Y2 = 0; Y2 < Rt2.length; Y2++)
              ae2 = C2[++ie], R2 = Rt2[Y2], typeof R2 === h2 && R2.length > 0 ? R2.length === 2 ? typeof R2[1] == r ? this[R2[0]] = R2[1].call(this, ae2) : this[R2[0]] = R2[1] : R2.length === 3 ? typeof R2[1] === r && !(R2[1].exec && R2[1].test) ? this[R2[0]] = ae2 ? R2[1].call(this, ae2, R2[2]) : n : this[R2[0]] = ae2 ? ae2.replace(R2[1], R2[2]) : n : R2.length === 4 && (this[R2[0]] = ae2 ? R2[3].call(this, ae2.replace(R2[1], R2[2])) : n) : this[R2] = ae2 || n;
        S2 += 2;
      }
    }, Je2 = function(T2, P2) {
      for (var S2 in P2)
      ...
      return this.getBrowser = function() {
        ...
        var C2 = {};
        return C2[p] = n, C2[u] = n, we2.call(C2, z2, Y2.os), R2 && !C2[p] && ie && ie.platform != "Unknown" && (C2[p] = ie.platform.replace(/chrome os/i, St2).replace(/macos/i, Ot2)), C2;
      }, this.getResult = function() {
        return { ua: this.getUA(), browser: this.getBrowser(), engine: this.getEngine(), os: this.getOS(), device: this.getDevice(), cpu: this.getCPU() };
      }, this.getUA = function() {
        return z2;
      }, this.setUA = function(C2) {
        return z2 = typeof C2 === v && C2.length > q2 ? Xe2(C2, q2) : C2, this;
      }, this.setUA(z2), this;
    };
    G2.VERSION = i2, G2.BROWSER = Ae2([p, u, x2]), G2.CPU = Ae2([b2]), G2.DEVICE = Ae2([l2, m2, d, E2, g3, k3, f, w2, y]), G2.ENGINE = G2.OS = Ae2([p, u]), typeof t3 !== c ? (typeof e3 !== c && e3.exports && (t3 = e3.exports = G2), t3.UAParser = G2) : typeof define === r && define.amd ? define(function() {
      return G2;
    }) : typeof a !== c && (a.UAParser = G2);
    var pe2 = typeof a !== c && (a.jQuery || a.Zepto);
    if (pe2 && !pe2.ua) {
      var Fe2 = new G2();
      pe2.ua = Fe2.getResult(), pe2.ua.get = function() {
        return Fe2.getUA();
      }, pe2.ua.set = function(T2) {
        Fe2.setUA(T2);
        var P2 = Fe2.getResult();
        for (var S2 in P2)
          pe2.ua[S2] = P2[S2];
      };
    }
...
var ca = /^[v^~<>=]*?(\d+)(?:\.([x*]|\d+)(?:\.([x*]|\d+)(?:\.([x*]|\d+))?(?:-([\da-z\-]+(?:\.[\da-z\-]+)*))?(?:\+[\da-z\-]+(?:\.[\da-z\-]+)*)?)?)?$/i;
var De2 = (t3) => {
  if (typeof t3 != "string")
...
var Kt2 = (t3) => t3 === "*" || t3 === "x" || t3 === "X";
var Yt2 = (t3) => {
  let e3 = parseInt(t3, 10);
  return isNaN(e3) ? t3 : e3;
};
var ln2 = (t3, e3) => typeof t3 != typeof e3 ? [String(t3), String(e3)] : [t3, e3];
var cn2 = (t3, e3) => {
  if (Kt2(t3) || Kt2(e3))
    return 0;
  let [a, n] = ln2(Yt2(t3), Yt2(e3));
  return a > n ? 1 : a < n ? -1 : 0;
};
var ve2 = (t3, e3) => {
  for (let a = 0; a < Math.max(t3.length, e3.length); a++) {
    let n = cn2(t3[a] || "0", e3[a] || "0");
    if (n !== 0)
      return n;
  }
  return 0;
...
var pa = (t3, e3) => {
  let a = De2(t3), n = De2(e3), i2 = a.pop(), o2 = n.pop(), s2 = ve2(a, n);
  return s2 !== 0 ? s2 : i2 && o2 ? ve2(i2.split("."), o2.split(".")) : i2 || o2 ? i2 ? -1 : 1 : 0;
};
var da = (t3, e3, a) => {
  pn2(a);
  let n = pa(t3, e3);
  return ma[a].includes(n);
};
var ma = { ">": [1], ">=": [0, 1], "=": [0], "<=": [-1, 0], "<": [-1], "!=": [-1, 1] };
var Zt2 = Object.keys(ma);
var pn2 = (t3) => {
  if (typeof t3 != "string")
    throw new TypeError(`Invalid operator type, expected string but got ${typeof t3}`);
  if (Zt2.indexOf(t3) === -1)
    throw new Error(`Invalid operator, expected one of ${Zt2.join("|")}`);
};
var Me2 = (t3, e3) => {
  if (e3 = e3.replace(/([><=]+)\s+/g, "$1"), e3.includes("||"))
    return e3.split("||").some((u) => Me2(t3, u));
  if (e3.includes(" - ")) {
    let [u, b2] = e3.split(" - ", 2);
    return Me2(t3, `>=${u} <=${b2}`);
  } else if (e3.includes(" "))
    return e3.trim().replace(/\s{2,}/g, " ").split(" ").every((u) => Me2(t3, u));
  let a = e3.match(/^([<>=~^]+)/), n = a ? a[1] : "=";
  if (n !== "^" && n !== "~")
    return da(t3, e3, n);
  let [i2, o2, s2, , r] = De2(t3), [c, h2, v, , x2] = De2(e3), l2 = [i2, o2, s2], p = [c, h2 ?? "x", v ?? "x"];
...
var mn2 = (t3) => {
  let e3 = (0, ea.default)(t3).browser;
  return e3.name === "HeadlessChrome" ? e3.name = "Chrome" : e3.name === "Safari" && t3.includes("iPhone;") && (e3.name = "iOS"), (0, ea.default)(t3).browser;
};
var un = ["es2022", "es2021", "es2020", "es2019", "es2018", "es2017", "es2016", "es2015"].map((t3) => [t3, ua(t3.slice(0, 2).toUpperCase(), t3.slice(2)).length]);
var hn2 = "1.33.2";
var fn2 = /^\d+\.\d+\.\d+/;
var pt2 = (t3) => {
  ...
  if (t3.startsWith("Deno/")) {
    let n = t3.slice(5).match(fn2);
    return n && da(n[0], hn2, "<") ? "deno" : "denonext";
  }
...
function vn2(t3) {
  ...
  return e3.length >= 2 && e3.some((a) => ut2.has(a));
}
var xn2 = /* @__PURE__ */ new Set(["preact", "react", "solid-js", "svelte", "vue", "@vue/reactivity", "@vue/runtime-core", "@vue/runtime-dom", "@vue/shared"]);
var gn2 = /* @__PURE__ */ new Set(["wasm", "css", "less", "sass", "scss", "stylus", "styl", "json", "jsonc", "csv", "xml", "plist", "tmLanguage", "tmTheme", "yml", "yaml", "pdf", "txt", "glsl", "frag", "vert", "md", "mdx", "markdown", "html", "htm", "vue", "svelte", "svg", "png", "jpg", "jpeg", "webp", "gif", "ico", "eot", "ttf", "otf", "woff", "woff2", "m4a", "mp3", "m3a", "ogg", "oga", "wav", "weba", "mp4", "m4v", "ogv", "webm", "zip", "gz", "tar", "tgz"]);
var wn2 = { "@unocss/reset": "tailwind.css", "inter-ui": "inter.css", "normalize.css": "normalize.css", "modern-normalize": "modern-normalize.css", "reset-css": "reset.css" };
var bn2 = { "@types/react@17": "17.0.71", "@types/react@18": "18.2.38", "isomorphic-ws@4": "5.0.0", "resolve@1.22": "1.22.2" };
function ha(t3) {
  if (t3)
...
function dt2(t3, e3) {
  for (let [a, n] of Object.entries(bn2))
...
function Te2(t3) {
  ...
  return a === "gz" && e3.endsWith(".tar.gz") && (a = "tar.gz"), fa.get(a) ?? "application/octet-stream";
}
var ia = /^[a-zA-Z0-9][\w\.\-\_]*$/;
var oa = /^\d+\.\d+\.\d+/;
var sa = /^[a-f0-9]{10,}$/;
var On2 = /^(v\d+|stable)$/;
var kn2 = /^\/(v\d+|stable)\//;
var ra = "https://registry.npmjs.org";
var Tn2 = "https://esm.sh";
var se2 = "public, max-age=31536000, immutable";
var ht = { get: () => Promise.resolve(null), put: () => Promise.resolve() };
var En2 = class {
  cache;
  middleware;
  constructor(t3) {
  ...
  async fetch(t3, e3, a) {
    ...
    let i2 = new URL(t3.url), o2 = t3.headers.get("User-Agent"), s2 = this.cache ?? (this.cache = await caches.open("esm.sh/v135")), r = { cache: s2, url: i2, data: {}, waitUntil: (w2) => a.waitUntil(w2), withCache: async (w2, y) => {
      var L;
      let q2 = t3.method === "HEAD", $2 = ut2.has(i2.searchParams.get("target") ?? ""), B2 = new URL(i2), X2 = (y == null ? void 0 : y.varyUA) && !$2;
      X2 && B2.searchParams.set("target", pt2(o2));
      for (let D2 of ["x-real-origin", "x-esm-worker-version"]) {
        let W2 = t3.headers.get(D2);
        W2 && B2.searchParams.set(D2, W2);
      }
      let M2 = await s2.match(B2);
      if (M2) {
        if (q2) {
          let { status: D2, headers: W2 } = M2;
          return new Response(null, { status: D2, headers: W2 });
        }
        return M2;
      }
      if (M2 = await w2(), X2) {
        let D2 = new Headers(M2.headers);
        D2.append("Vary", "User-Agent"), M2 = new Response(M2.body, { status: M2.status, headers: D2 });
      }
      if ((L = M2.headers.get("Cache-Control")) != null && L.startsWith("public, max-age=") && a.waitUntil(s2.put(B2, M2.clone())), q2) {
        let { status: D2, headers: W2 } = M2;
        return new Response(null, { status: D2, headers: W2 });
      }
      return M2;
    ...
    switch (c) {
      ...
      case "/esma-target":
        return r.withCache(() => {
          let w2 = Q2();
          return w2.set("cache-control", se2), new Response(pt2(o2), { headers: w2 });
        }, { varyUA: true });
    }
    if (this.middleware) {
    ...
    if (t3.method === "POST" && (c === "/build" || c === "/transform")) {
      let w2 = await t3.text(), y = "esm-build-" + await Sn2(w2), q2 = Reflect.get(e3, "R2") ?? ht, $2 = Reflect.get(e3, "KV") ?? ha(q2), { value: B2 } = await $2.getWithMetadata(y, "stream");
      if (B2) {
        let L = Q2();
      ...
      if (X2.status !== 200)
        return X2;
      let M2 = await X2.arrayBuffer();
      return r.waitUntil($2.put(y, M2)), new Response(M2, { status: X2.status, headers: X2.headers });
    }
    ...
    if (/:\d+:\d+$/.test(c) && (c = te2(c, ":")[0]), c.startsWith("/+"))
      return r.withCache(() => $e2(t3, e3, r, c), { varyUA: true });
    let v = kn2.test(c), x2 = !v && On2.test(i2.searchParams.get("pin") ?? "");
    if (v) {
      let w2 = c.split("/");
    ...
    if (p && (c = "/" + c.slice(2)), v && (c === "/node.ns.d.ts" || c.startsWith("/node_") && c.endsWith(".js") && !c.slice(1).includes("/")))
      return r.withCache(() => $e2(t3, e3, r, `/${h2}${c}`, true), { varyUA: true });
    let d = "", m2 = "", u = "", b2 = "", E2 = "";
    if (c.startsWith("/@")) {
    ...
    if (d !== "" && !ia.test(d.slice(1)))
      return fe2(`Invalid scope name '${d}'`, 400);
    if (m2 === "")
      return fe2("Invalid path", 400);
    let g3 = m2.startsWith("~") && sa.test(m2.slice(1));
    if (!g3 && !ia.test(m2))
      return fe2(`Invalid package name '${m2}'`, 400);
    let f = m2;
    if (d && (f = d + "/" + m2, l2 && (f = f.slice(1))), u && ([u, E2] = te2(u, "&"), l2 || (u.startsWith("=") || u.startsWith("v") ? u = u.slice(1) : /^\d+$/.test(u) ? u = "^" + u : /^\d+.\d+$/.test(u) && (u = "~" + u))), g3 && (u = "0.0.0"), l2 && !(u && (sa.test(u) || oa.test(yn2(u, "v")))))
    ...
    if (!l2 && !(u && oa.test(u)))
      return r.withCache(async () => {
        ...
        let y = await fetch(new URL(f, e3.NPM_REGISTRY ?? ra), { headers: w2 });
        if (!y.ok)
          return y.status === 404 || y.status === 401 ? aa(f) : new Response(y.body, { status: y.status, headers: Q2() });
        let q2 = await y.json(), $2 = "/";
        v && ($2 += h2 + "/"), p && ($2 += "*");
        let B2 = E2 ? "&" + E2 : "", X2 = (L = q2["dist-tags"]) == null ? void 0 : L[u || "latest"];
        if (X2) {
          let D2 = `${$2}${f}@${dt2(f, X2)}${B2}${b2}${i2.search}`;
          return ne(new URL(D2, i2), 302);
        }
        let M2 = Object.keys(q2.versions ?? []).filter(dn2).sort(pa);
        if (!u) {
          let D2 = M2.filter((W2) => !W2.includes("-")).pop() ?? M2.pop();
          if (D2) {
            let W2 = `${$2}${f}@${dt2(f, D2)}${B2}${b2}${i2.search}`;
            return ne(new URL(W2, i2), 302);
          }
        }
        try {
          let D2 = u.includes("-") ? M2 : M2.filter((W2) => !W2.includes("-"));
          for (let W2 = D2.length - 1; W2 >= 0; W2--) {
            let re2 = D2[W2];
            if (Me2(re2, u)) {
              let ce2 = `${$2}${f}@${dt2(f, re2)}${B2}${b2}${i2.search}`;
    ...
    if (f.startsWith("@types/") && (b2 === "" || !b2.endsWith(".d.ts")))
      return r.withCache(async () => {
        ...
        if (b2 !== "")
          ...
          let q2 = await fetch(new URL(f, e3.NPM_REGISTRY ?? ra), { headers: y });
          if (!q2.ok)
            return q2.status === 404 || q2.status === 401 ? aa(f) : new Response(q2.body, { status: q2.status, headers: y });
          let $2 = await q2.json();
    ...
    if (!v && b2 !== "") {
      ...
      if (gn2.has(w2))
        return r.withCache(() => {
          let y = `${l2 ? "/gh" : ""}/${f}@${u}${b2}`;
          return Rn2(t3, r, e3, y);
        });
    }
    return E2 && new URLSearchParams(E2).forEach((w2, y) => {
      i2.searchParams.set(y, w2);
    }), i2.hostname === "raw.esm.sh" && i2.searchParams.set("raw", ""), v && (b2.endsWith(".d.ts") || vn2(b2)) ? r.withCache(() => {
      let w2 = `/${h2}`;
      l2 && (w2 += "/gh");
      ...
      let w2 = "";
      v ? w2 += `/${h2}` : xn2.has(f) && (w2 += "/v128"), l2 && (w2 += "/gh");
...
async function K2(t3, e3, a, n, i2) {
  var h2;
  let o2 = new Headers();
  mt(o2, t3.headers, "Content-Type", "Referer", "User-Agent", "X-Esm-Worker-Version", "X-Forwarded-For", "X-Real-Ip", "X-Real-Origin"), o2.has("X-Esm-Worker-Version") || o2.set("X-Esm-Worker-Version", "v135"), o2.has("X-Real-Origin") || o2.set("X-Real-Origin", a.url.origin), e3.ESM_TOKEN && o2.set("Authorization", `Bearer ${e3.ESM_TOKEN}`);
  ...
  if (!s2.ok) {
    ...
    return mt(i2, s2.headers, "Content-Type"), new Response(r, { status: s2.status, headers: i2 });
  }
  mt(i2, s2.headers, "Cache-Control", "Content-Type", "Content-Length", "X-Esm-Id", "X-Typescript-Types");
  let c = [];
...
async function $e2(t3, e3, a, n, i2) {
  ...
  let s2 = Q2(), [r] = te2(n, "?", true), c = Reflect.get(e3, "R2") ?? ht, h2 = Reflect.get(e3, "KV") ?? ha(c), v = t3.headers.has("X-Real-Origin"), x2 = !(a.url.searchParams.has("raw") || r.endsWith(".d.ts") || r.endsWith(".d.mts") || r.endsWith(".map"));
  if (!v)
    if (x2) {
  ...
  if (!l2.ok)
    return l2;
  let p = await l2.arrayBuffer(), d = l2.headers.get("Content-Type") || Te2(n), m2 = l2.headers.get("Cache-Control"), u = l2.headers.get("X-Esm-Id"), b2 = l2.headers.get("X-TypeScript-Types"), E2 = [];
  if (s2.set("Content-Type", d), m2 && s2.set("Cache-Control", m2), u && (s2.set("X-Esm-Id", u), E2.push("X-Esm-Id")), b2 && (s2.set("X-TypeScript-Types", b2), E2.push("X-TypeScript-Types")), E2.length > 0 && s2.set("Access-Control-Expose-Headers", E2.join(", ")), s2.set("X-Content-Source", "origin"), !v && (m2 == null ? void 0 : m2.includes("immutable")))
    if (!x2)
...
async function Rn2(t3, e3, a, n) {
  var c;
  let i2 = Q2(), o2 = Reflect.get(a, "R2") ?? ht, s2 = await o2.get(n.slice(1));
  if (s2)
...
function jn2(t3) {
  ...
  return !n || n && !n.includes(".") ? false : !!Ee2[e3];
}
async function An2(t3, e3, a, n) {
  ...
  switch (t3[0]) {
    ...
    case "files.json":
      return new Response(JSON.stringify({ ...Ee2, ASSET_HASH: dist_shasum_default }), {
        headers: {
    ...
    case "swVersion.js":
      return new Response(
        `self.swVersion = "${dist_shasum_default}"; self.files=${JSON.stringify(Ee2)}; `,
        {
          headers: {
            "content-type": "application/javascript; charset=utf-8",
            "Cache-Control": "no-cache",
    ...
    default:
      {
        if (!jn2(t3.join("/"))) {
          let v = xa.fetch(e3, a, n), x2 = await fetch(
        ...
        if (Ee2[h2]) {
          let v = await (0, ga.getAssetFromKV)(
            {
              request: e3,
              waitUntil(l2) {
          ...
          return v.headers.forEach((l2, p) => x2.append(p, l2)), Pn2(e3.url) && x2.append(
            "Cache-Control",
...
async function Vn2(t3, e3, a) {
  return t3.cf && t3.cf.asOrganization && t3.cf.asOrganization.startsWith("YANDEX") ? Fn2() : xe2(t3, async () => {
    var o2, s2;
