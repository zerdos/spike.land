...
// ../../.yarn/__virtual__/@spike.land-code-virtual-d9171aea5c/1/packages/code/dist/chunk-chunk-2DK73MPQ.mjs
...
// ../../.yarn/__virtual__/@spike.land-code-virtual-d9171aea5c/1/packages/code/dist/chunk-chunk-AZHCEBCB.mjs
init_define_process();
...
// ../../.yarn/__virtual__/@spike.land-code-virtual-d9171aea5c/1/packages/code/dist/chunk-chunk-AUL7LWHA.mjs
...
var Map2 = function (KeyedCollection2) {
  ...
  Map22.prototype.toString = function toString5() {
    return this.__toString("Map {", "}");
  };
  Map22.prototype.get = function get11(k, notSetValue) {
    return this._root ? this._root.get(0, void 0, k, notSetValue) : notSetValue;
  };
  Map22.prototype.set = function set3(k, v) {
    return updateMap(this, k, v);
  };
  Map22.prototype.remove = function remove3(k) {
    return updateMap(this, k, NOT_SET);
  };
  Map22.prototype.deleteAll = function deleteAll(keys2) {
  ...
  Map22.prototype.clear = function clear2() {
    if (this.size === 0) {
      return this;
    }
    if (this.__ownerID) {
  ...
  Map22.prototype.sort = function sort22(comparator) {
    return OrderedMap(sortFactory(this, comparator));
  };
  Map22.prototype.sortBy = function sortBy2(mapper, comparator) {
    return OrderedMap(sortFactory(this, comparator, mapper));
  };
  Map22.prototype.map = function map2(mapper, context) {
    var this$1$1 = this;
  ...
  Map22.prototype.__iterator = function __iterator2(type, reverse3) {
    return new MapIterator(this, type, reverse3);
  };
  Map22.prototype.__iterate = function __iterate2(fn, reverse3) {
    var this$1$1 = this;
    var iterations = 0;
  ...
  Map22.prototype.__ensureOwner = function __ensureOwner2(ownerID) {
  ...
  Repeat2.prototype.__iterator = function __iterator2(type, reverse3) {
    ...
    return new Iterator(
      function () {
        return i === size
          ? iteratorDone()
          : iteratorValue(type, reverse3 ? size - ++i : i++, this$1$1._value);
      },
    );
  };
  Repeat2.prototype.equals = function equals3(other) {
    return other instanceof Repeat2
...
var makePatchFrom = (n, st, update8) =>
  session.createPatchFromHashCode(n, st, update8);
var startSession = (room, u, originString) =>
    ...
    return handleErrors(request, async () => {
      ...
      const handleFetchApi = async (path2) => {
        ...
        const cachedResponse2 = await (async (request2) => {
          ...
          const cachedResponse3 = await cache3.match(cacheKey2);
          ...
          if (
            ...
            if (responseToCache.ok) {
              await cache3.put(cacheKey2, responseToCache.clone());
            }
          ...
          switch (path2[0]) {
            ...
            default:
              try {
                const kvResp =
                  await (0, import_kv_asset_handler.getAssetFromKV)(
                    {
                      request: request2,
                      waitUntil(promise) {
        ...
        if (cachedResponse2?.ok) {
          await cache2.put(cacheKey, cachedResponse2.clone());
        }
...
const assetsProm = fetch(\`\${location.origin}/files.json\`).then((r) =>
  r.json()).then((x) => window.assets=x);


window.esmsInitOptions = {
      shimMode: true,
      fetch: async (target, options) => {
        if (!window.assets) await assetsProm ;
        
    const url = new URL(target);
   
    let asset = assets[url.href.slice(1)];''
    if (asset) {
      return fetch(new URL("/" + asset, url.origin).toString());
    }
...
<script defer src="/react-jsx-runtime.mjs"><\/script>
<script  type="module">
...
if (location.pathname.endsWith("dehydrated")) {
  ...
  } else import(\`\${location.origin}/load.mjs\`);
<\/script>
...
var Code = class {
    ...
    return handleErrors(request, async () => {
      ...
      switch (path[0]) {
        ...
        case "iife": {
          ...
          const html = iife_default.replace(
            `/** startState **/`,
  ...
  async handleSession(webSocket, ip) {
    ...
    webSocket.addEventListener(
      "message",
      (msg) => this.processWsMessage(msg, session2, limiter),
    );
  ...
  async processWsMessage(msg, session2, limiter) {
    if (session2.quit) {
      this.users.remove(session2.name);
...
export { Code, CodeRateLimiter, src_default2 as default, Users };
