...
var package_default = {
  ...
  dependencies: {
    ...
    "monaco-editor": "0.35.0-dev.20221207",
    "p-map": "5.5.0",
    prettier: "2.8.1",
    prismjs: "^1.29.0",
    qrious: "4.0.2",
...
// ../../.yarn/__virtual__/@spike.land-code-virtual-d9171aea5c/1/packages/code/dist/chunk-chunk-I52D4BQZ.mjs
init_define_process();
...
// ../../.yarn/__virtual__/@spike.land-code-virtual-d9171aea5c/1/packages/code/dist/chunk-chunk-OOGKLUN3.mjs
...
var Map2 = /* @__PURE__ */ function(KeyedCollection2) {
  ...
  Map22.of = /* @__PURE__ */ __name(function of() {
  ...
  Map22.prototype.toString = /* @__PURE__ */ __name(function toString5() {
    return this.__toString("Map {", "}");
  }, "toString");
  Map22.prototype.get = /* @__PURE__ */ __name(function get11(k, notSetValue) {
    return this._root ? this._root.get(0, void 0, k, notSetValue) : notSetValue;
  }, "get");
  Map22.prototype.set = /* @__PURE__ */ __name(function set3(k, v) {
    return updateMap(this, k, v);
  }, "set");
  Map22.prototype.remove = /* @__PURE__ */ __name(function remove3(k) {
    return updateMap(this, k, NOT_SET);
  }, "remove");
  Map22.prototype.deleteAll = /* @__PURE__ */ __name(function deleteAll(keys2) {
  ...
  Map22.prototype.clear = /* @__PURE__ */ __name(function clear2() {
    if (this.size === 0) {
      return this;
    }
    if (this.__ownerID) {
  ...
  Map22.prototype.sort = /* @__PURE__ */ __name(function sort22(comparator) {
    return OrderedMap(sortFactory(this, comparator));
  }, "sort");
  Map22.prototype.sortBy = /* @__PURE__ */ __name(function sortBy2(mapper, comparator) {
    return OrderedMap(sortFactory(this, comparator, mapper));
  }, "sortBy");
  Map22.prototype.map = /* @__PURE__ */ __name(function map2(mapper, context) {
    var this$1$1 = this;
  ...
  Map22.prototype.__iterator = /* @__PURE__ */ __name(function __iterator2(type, reverse3) {
    return new MapIterator(this, type, reverse3);
  }, "__iterator");
  Map22.prototype.__iterate = /* @__PURE__ */ __name(function __iterate2(fn, reverse3) {
    var this$1$1 = this;
    var iterations = 0;
  ...
  Map22.prototype.__ensureOwner = /* @__PURE__ */ __name(function __ensureOwner2(ownerID) {
...
var OrderedMap = /* @__PURE__ */ function(Map22) {
...
var assets = JSON.parse(ASSET_MANIFEST);
var files = {};
    ...
    return handleErrors(request, async () => {
      ...
      const handleFetchApi = async (path2) => {
        ...
        if (path2[0].startsWith("npm:") || path2[0].startsWith("node_modules/")) {
          ...
          response = new Response(
            isText ? bodyStr.replaceAll(regex, u.origin + "/npm:/").replaceAll(regex2, ' from "/npm:/').replaceAll(regex3, 'import "/npm:/').replaceAll(regex4, ' from "/npm:/').replaceAll(regex5, 'import "/npm:/') : await response.blob(),
            {
              status: 200,
              headers: {
          ...
          default:
            try {
              ...
              if (!kvResp || kvResp.status !== 200) {
                const req2 = new Request(`${u.origin}/npm:/${u.pathname}?bundle`, request);
                response = await fetch(req2);
                if (!response.ok)
                  return response;
                const newHeaders = new Headers(response.headers);
                newHeaders.append(`Location`, req2.url), response = new Response(response.body, {
                  ...response,
                  status: 307,
                  headers: newHeaders
                });
                const cache3 = caches.default;
                await cache3.put(cacheKey, response.clone());
                return response;
              }
              return response;
            } catch {
              return fetch(
                new URL(url.pathname.slice(1), url.origin + "/node_modules/").toString()
              );
            }
        }
      };
      ...
      root.render(<ErrorBoundary
        ...
        case "js": {
          ...
          if (i2 > mST().i) {
            ...
            const trp2 = importMapReplace(body, url.origin);
          ...
          if (i2 < mST().i) {
            const trp2 = importMapReplace(transpiled, url.origin);
            return new Response(trp2, {
              status: 307,
              headers: {
                "Access-Control-Allow-Origin": "*",
        ...
        case "dehydrated":
        case "public": {
          const respText = src_default.replace("/**reset*/", resetCSS + css.split(md5(transpiled)).join(`css`)).replace(
            `<script type="importmap"><\/script>`,
            `<script type="importmap">${JSON.stringify(importmap_default.import)}<\/script>`
          ).replace(
            `<div id="root"></div>`,
