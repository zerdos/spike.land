...
var require_dist = __commonJS({
  "../../.yarn/global/cache/@cloudflare-kv-asset-handler-npm-0.2.0-683fd99c2f-9.zip/node_modules/@cloudflare/kv-asset-handler/dist/index.js"(
    ...
    var getAssetFromKVDefaultOptions = {
      ASSET_NAMESPACE: typeof __STATIC_CONTENT !== "undefined"
        ? __STATIC_CONTENT
        : void 0,
    ...
    var getAssetFromKV2 = async (event, options) => {
      ...
      if (
        ...
        options.cacheControl.edgeTTL === null || request.method == "HEAD"
      ) {
      ...
      let response = null;
      if (shouldEdgeCache) {
        response = await cache2.match(cacheKey);
      }
      if (response) {
        if (response.status > 300 && response.status < 400) {
          if (
            response.body && "cancel" in Object.getPrototypeOf(response.body)
          ) {
        ...
        if (shouldEdgeCache) {
          ...
          event.waitUntil(cache2.put(cacheKey, response.clone()));
      ...
      if (response.status === 304) {
        ...
        if (etag) {
          if (
            ifNoneMatch && ifNoneMatch === etag && proxyCacheStatus === "MISS"
          ) {
...
var package_default = {
  ...
  scripts: {
    test:
      "esbuild --bundle tests/* --platform=node --external:uvu --external:uvu/ --format=esm --outdir=testsJs && yarn uvu testsJs && rm -rf testsJs",
    typecheck: "yarn tsc",
    clean:
      "rm -rf .tsBuildInfo js/vendor dist js/monaco-workers && yarn favicons",
    "build:sw":
      "esbuild --outfile=../packages/.spike.land/public/sw.js --platform=browser --bundle --minify ./js/sw.js && yarn sw",
    start: "cd ../../.. && yarn start",
    push: "cd ../../.. && yarn push",
    "build:preact":
      "esbuild --bundle js/preact.ts  --target=esnext --minify --format=esm --platform=browser  --outfile=./dist//react.mjs",
    "build:orbit-db":
      "esbuild --bundle js/preact.ts  --target=esnext --minify --format=esm --platform=browser  --outfile=./dist//react.mjs",
    "build:framer-motion":
      'yarn esbuild --bundle js/motion.tsx  --target=esnext --minify --format=esm  --platform=browser  --define:process.env.NODE_ENV=\\"production\\" --external:react --external:@emotion/is-prop-valid  --external:react --outfile=./dist/framer-motion.mjs',
    ...
    favicons:
      "cp -af js/assets/ ./dist && mkdir -p  ./dist/assets && cp js/assets/synthwave.webp   ./dist/assets/",
    sw: "echo ok",
  },
  keywords: [
    "monaco",
  ...
  dependencies: {
    ...
    "monaco-editor": "0.35.0-dev.20221201",
    "p-map": "5.5.0",
    prettier: "2.8.0",
    qrious: "4.0.2",
    "re-resizable": "^6.9.9",
...
// ../../.yarn/__virtual__/@spike.land-code-virtual-d9171aea5c/1/packages/code/dist/chunk-chunk-LC2N6673.mjs
...
var require_diff = __commonJS2({
  "../../.yarn/global/cache/fast-diff-npm-1.2.0-5ba4171bb6-9.zip/node_modules/fast-diff/diff.js"(
      ...
      for (var d = 0; d < max_d; d++) {
        for (var k1 = -d + k1start; k1 <= d - k1end; k1 += 2) {
          ...
          if (x1 > text1_length) {
            ...
            if (
              k2_offset >= 0 && k2_offset < v_length && v2[k2_offset] !== -1
            ) {
    ...
    function find_cursor_edit_diff(oldText, newText, cursor_pos) {
      ...
      if (
        oldRange.length === 0 && (newRange === null || newRange.length === 0)
      ) {
...
function wholeSlice(begin, end, size) {
  return (begin === 0 && !isNeg(begin) || size !== void 0 && begin <= -size) &&
    (end === void 0 || size !== void 0 && end >= size);
}
...
var KeyedCollection = /* @__PURE__ */ function (Collection3) {
  ...
  KeyedCollection2.prototype = Object.create(
    Collection3 && Collection3.prototype,
  );
...
var IndexedCollection = /* @__PURE__ */ function (Collection3) {
  ...
  IndexedCollection2.prototype = Object.create(
    Collection3 && Collection3.prototype,
  );
...
var SetCollection = /* @__PURE__ */ function (Collection3) {
  ...
  SetCollection2.prototype = Object.create(
    Collection3 && Collection3.prototype,
  );
...
function isArrayLike(value) {
  ...
  return value && typeof value === "object" && Number.isInteger(value.length) &&
    value.length >= 0 &&
    (value.length === 0
...
var Seq = /* @__PURE__ */ function (Collection3) {
  ...
  Seq2.prototype.__iterate = /* @__PURE__ */ __name(
    function __iterate2(fn, reverse3) {
  ...
  Seq2.prototype.__iterator = /* @__PURE__ */ __name(
    function __iterator2(type, reverse3) {
      var cache2 = this._cache;
      if (cache2) {
        var size = cache2.length;
        var i = 0;
...
var KeyedSeq = /* @__PURE__ */ function (Seq2) {
  ...
  KeyedSeq2.prototype.toKeyedSeq = /* @__PURE__ */ __name(
    function toKeyedSeq3() {
      return this;
    },
    "toKeyedSeq",
  );
...
var IndexedSeq = /* @__PURE__ */ function (Seq2) {
  ...
  IndexedSeq2.prototype.toIndexedSeq = /* @__PURE__ */ __name(
    function toIndexedSeq2() {
      return this;
    },
    "toIndexedSeq",
  );
...
var ArraySeq = /* @__PURE__ */ function (IndexedSeq2) {
  ...
  ArraySeq2.prototype.get = /* @__PURE__ */ __name(
    function get11(index, notSetValue) {
  ...
  ArraySeq2.prototype.__iterate = /* @__PURE__ */ __name(
    function __iterate2(fn, reverse3) {
  ...
  ArraySeq2.prototype.__iterator = /* @__PURE__ */ __name(
    function __iterator2(type, reverse3) {
      var array = this._array;
      var size = array.length;
      var i = 0;
...
var ObjectSeq = /* @__PURE__ */ function (KeyedSeq2) {
  ...
  ObjectSeq2.prototype.get = /* @__PURE__ */ __name(
    function get11(key, notSetValue) {
  ...
  ObjectSeq2.prototype.__iterate = /* @__PURE__ */ __name(
    function __iterate2(fn, reverse3) {
  ...
  ObjectSeq2.prototype.__iterator = /* @__PURE__ */ __name(
    function __iterator2(type, reverse3) {
      var object = this._object;
      var keys2 = this._keys;
      var size = keys2.length;
...
var CollectionSeq = /* @__PURE__ */ function (IndexedSeq2) {
  ...
  CollectionSeq2.prototype = Object.create(
    IndexedSeq2 && IndexedSeq2.prototype,
  );
  CollectionSeq2.prototype.constructor = CollectionSeq2;
  CollectionSeq2.prototype.__iterateUncached = /* @__PURE__ */ __name(
    function __iterateUncached(fn, reverse3) {
      if (reverse3) {
  ...
  CollectionSeq2.prototype.__iteratorUncached = /* @__PURE__ */ __name(
    function __iteratorUncached(type, reverse3) {
      if (reverse3) {
...
function isValueObject(maybeValue) {
  return Boolean(
    maybeValue && typeof maybeValue.equals === "function" &&
...
function is(valueA, valueB) {
  ...
  return !!(isValueObject(valueA) && isValueObject(valueB) &&
    valueA.equals(valueB));
}
__name(is, "is");
var imul = typeof Math.imul === "function" && Math.imul(4294967295, 2) === -2
  ? Math.imul
  : /* @__PURE__ */ __name(function imul2(a, b) {
    a |= 0;
    b |= 0;
    var c = a & 65535;
    var d = b & 65535;
...
function hashJSObj(obj) {
  ...
  if (usingWeakMap) {
    ...
    obj.propertyIsEnumerable !== void 0 &&
...
var ToKeyedSequence = /* @__PURE__ */ function (KeyedSeq2) {
  ...
  ToKeyedSequence2.prototype.get = /* @__PURE__ */ __name(
    function get11(key, notSetValue) {
  ...
  ToKeyedSequence2.prototype.valueSeq = /* @__PURE__ */ __name(
    function valueSeq2() {
      return this._iter.valueSeq();
    },
    "valueSeq",
  );
  ToKeyedSequence2.prototype.reverse = /* @__PURE__ */ __name(
    function reverse3() {
      var this$1$1 = this;
  ...
  ToKeyedSequence2.prototype.map = /* @__PURE__ */ __name(
    function map2(mapper, context) {
      var this$1$1 = this;
  ...
  ToKeyedSequence2.prototype.__iterate = /* @__PURE__ */ __name(
    function __iterate2(fn, reverse3) {
      var this$1$1 = this;
  ...
  ToKeyedSequence2.prototype.__iterator = /* @__PURE__ */ __name(
    function __iterator2(type, reverse3) {
...
var ToIndexedSequence = /* @__PURE__ */ function (IndexedSeq2) {
  ...
  ToIndexedSequence2.prototype = Object.create(
    IndexedSeq2 && IndexedSeq2.prototype,
  );
  ToIndexedSequence2.prototype.constructor = ToIndexedSequence2;
  ToIndexedSequence2.prototype.includes = /* @__PURE__ */ __name(
    function includes3(value) {
      return this._iter.includes(value);
    },
    "includes",
  );
  ToIndexedSequence2.prototype.__iterate = /* @__PURE__ */ __name(
    function __iterate2(fn, reverse3) {
      var this$1$1 = this;
      var i = 0;
  ...
  ToIndexedSequence2.prototype.__iterator = /* @__PURE__ */ __name(
    function __iterator2(type, reverse3) {
      var this$1$1 = this;
...
var ToSetSequence = /* @__PURE__ */ function (SetSeq2) {
  ...
  ToSetSequence2.prototype.__iterate = /* @__PURE__ */ __name(
    function __iterate2(fn, reverse3) {
      var this$1$1 = this;
  ...
  ToSetSequence2.prototype.__iterator = /* @__PURE__ */ __name(
    function __iterator2(type, reverse3) {
      var iterator = this._iter.__iterator(ITERATE_VALUES, reverse3);
      return new Iterator(function () {
        var step = iterator.next();
...
var FromEntriesSequence = /* @__PURE__ */ function (KeyedSeq2) {
  ...
  FromEntriesSequence2.prototype = Object.create(
    KeyedSeq2 && KeyedSeq2.prototype,
  );
  FromEntriesSequence2.prototype.constructor = FromEntriesSequence2;
  FromEntriesSequence2.prototype.entrySeq = /* @__PURE__ */ __name(
    function entrySeq2() {
      return this._iter.toSeq();
    },
    "entrySeq",
  );
  FromEntriesSequence2.prototype.__iterate = /* @__PURE__ */ __name(
    function __iterate2(fn, reverse3) {
      var this$1$1 = this;
  ...
  FromEntriesSequence2.prototype.__iterator = /* @__PURE__ */ __name(
    function __iterator2(type, reverse3) {
      var iterator = this._iter.__iterator(ITERATE_VALUES, reverse3);
      return new Iterator(function () {
        while (true) {
  ...
  reversedSequence.__iterate = function (fn, reverse3) {
    ...
    return collection.__iterate(
      function (v, k) {
        return fn(
          v,
          useKeys ? k : reverse3 ? this$1$12.size - ++i : i++,
          this$1$12,
        );
      },
      !reverse3,
...
function sliceFactory(collection, begin, end, useKeys) {
  ...
  sliceSeq.size = sliceSize === 0
    ? sliceSize
    : collection.size && sliceSize || void 0;
  ...
  sliceSeq.__iterateUncached = function (fn, reverse3) {
    ...
    collection.__iterate(function (v, k) {
      if (!(isSkipping && (isSkipping = skipped++ < resolvedBegin))) {
        iterations++;
        return fn(v, useKeys ? k : iterations - 1, this$1$1) !== false &&
...
function takeWhileFactory(collection, predicate, context) {
  ...
  takeSequence.__iterateUncached = function (fn, reverse3) {
    ...
    collection.__iterate(
      function (v, k, c) {
        return predicate.call(context, v, k, c) && ++iterations &&
          fn(v, k, this$1$1);
      },
    );
    return iterations;
...
function concatFactory(collection, values2) {
  ...
  if (iters.length === 1) {
    ...
    if (
      singleton === collection || isKeyedCollection && isKeyed(singleton) ||
...
function interposeFactory(collection, separator) {
  ...
  interposedSequence.__iterateUncached = function (fn, reverse3) {
    ...
    collection.__iterate(
      function (v) {
        return (!iterations ||
          fn(separator, iterations++, this$1$1) !== false) &&
...
function maxCompare(comparator, a, b) {
  ...
  return comp === 0 && b !== a && (b === void 0 || b === null || b !== b) ||
    comp > 0;
}
...
function isPlainObject(value) {
  if (
    ...
    toString2.call(value) !== "[object Object]"
  ) {
    return false;
  }
  ...
  if (!wasNotSet && !isDataStructure(existing)) {
    throw new TypeError(
      "Cannot update within non-data-structure value in path [" +
        keyPath.slice(0, i).map(quoteString) + "]: " + existing,
    );
  }
  var key = keyPath[i];
...
function mergeIntoKeyedWith(collection, collections, merger) {
  ...
  if (
    collection.toSeq().size === 0 && !collection.__ownerID && iters.length === 1
  ) {
...
function areMergeable(oldDataStructure, newDataStructure) {
  ...
  return isIndexed(oldSeq) === isIndexed(newSeq) &&
...
var Map2 = /* @__PURE__ */ function (KeyedCollection2) {
  function Map3(value) {
    return value === void 0 || value === null
      ...
      ? value
      : emptyMap().withMutations(function (map2) {
  ...
  Map3.prototype = Object.create(
    KeyedCollection2 && KeyedCollection2.prototype,
  );
  ...
  Map3.prototype.sortBy = /* @__PURE__ */ __name(
    function sortBy2(mapper, comparator) {
  ...
  Map3.prototype.__iterator = /* @__PURE__ */ __name(
    function __iterator2(type, reverse3) {
      return new MapIterator(this, type, reverse3);
    },
    "__iterator",
  );
  Map3.prototype.__iterate = /* @__PURE__ */ __name(
    function __iterate2(fn, reverse3) {
      var this$1$1 = this;
      var iterations = 0;
  ...
  Map3.prototype.__ensureOwner = /* @__PURE__ */ __name(
    function __ensureOwner2(ownerID) {
...
var ArrayMapNode = /* @__PURE__ */ __name(
  function ArrayMapNode2(ownerID, entries3) {
    this.ownerID = ownerID;
    this.entries = entries3;
  },
  "ArrayMapNode",
);
ArrayMapNode.prototype.get = /* @__PURE__ */ __name(
  function get2(shift, keyHash, key, notSetValue) {
...
ArrayMapNode.prototype.update = /* @__PURE__ */ __name(
  function update2(
    ownerID,
    shift,
    keyHash,
...
var BitmapIndexedNode = /* @__PURE__ */ __name(
  function BitmapIndexedNode2(ownerID, bitmap, nodes) {
    this.ownerID = ownerID;
    this.bitmap = bitmap;
    this.nodes = nodes;
  },
...
BitmapIndexedNode.prototype.get = /* @__PURE__ */ __name(
  function get3(shift, keyHash, key, notSetValue) {
    if (keyHash === void 0) {
      keyHash = hash(key);
    }
...
BitmapIndexedNode.prototype.update = /* @__PURE__ */ __name(
  function update3(
    ownerID,
    shift,
    keyHash,
...
var HashArrayMapNode = /* @__PURE__ */ __name(
  function HashArrayMapNode2(ownerID, count2, nodes) {
    this.ownerID = ownerID;
    this.count = count2;
    this.nodes = nodes;
  },
...
HashArrayMapNode.prototype.get = /* @__PURE__ */ __name(
  function get4(shift, keyHash, key, notSetValue) {
    if (keyHash === void 0) {
      keyHash = hash(key);
    }
...
HashArrayMapNode.prototype.update = /* @__PURE__ */ __name(
  function update4(
    ownerID,
    shift,
    keyHash,
...
var HashCollisionNode = /* @__PURE__ */ __name(
  function HashCollisionNode2(ownerID, keyHash, entries3) {
    this.ownerID = ownerID;
...
HashCollisionNode.prototype.get = /* @__PURE__ */ __name(
  function get5(shift, keyHash, key, notSetValue) {
    var entries3 = this.entries;
    for (var ii = 0, len = entries3.length; ii < len; ii++) {
      if (is(key, entries3[ii][0])) {
        return entries3[ii][1];
...
HashCollisionNode.prototype.update = /* @__PURE__ */ __name(
  function update5(
    ownerID,
    shift,
    keyHash,
...
var ValueNode = /* @__PURE__ */ __name(
  function ValueNode2(ownerID, keyHash, entry) {
    this.ownerID = ownerID;
    this.keyHash = keyHash;
    this.entry = entry;
  },
...
ValueNode.prototype.get = /* @__PURE__ */ __name(
  function get6(shift, keyHash, key, notSetValue) {
    return is(key, this.entry[0]) ? this.entry[1] : notSetValue;
  },
  "get",
);
ValueNode.prototype.update = /* @__PURE__ */ __name(
  function update6(
    ownerID,
    shift,
    keyHash,
...
var List = /* @__PURE__ */ function (IndexedCollection2) {
  ...
  List2.prototype = Object.create(
    IndexedCollection2 && IndexedCollection2.prototype,
  );
  ...
  List2.prototype.get = /* @__PURE__ */ __name(
    function get11(index, notSetValue) {
      index = wrapIndex(this, index);
  ...
  List2.prototype.insert = /* @__PURE__ */ __name(
  ...
  List2.prototype.__iterator = /* @__PURE__ */ __name(
    function __iterator2(type, reverse3) {
      ...
      return new Iterator(function () {
        ...
        return value === DONE
          ? iteratorDone()
          : iteratorValue(type, reverse3 ? --index : index++, value);
      });
    },
    "__iterator",
  );
  List2.prototype.__iterate = /* @__PURE__ */ __name(
    function __iterate2(fn, reverse3) {
      var index = reverse3 ? this.size : 0;
      var values2 = iterateList(this, reverse3);
      var value;
  ...
  List2.prototype.__ensureOwner = /* @__PURE__ */ __name(
    function __ensureOwner2(ownerID) {
      if (ownerID === this.__ownerID) {
        return this;
      }
...
VNode.prototype.removeBefore = /* @__PURE__ */ __name(
  function removeBefore(ownerID, level, index) {
...
VNode.prototype.removeAfter = /* @__PURE__ */ __name(
  function removeAfter(ownerID, level, index) {
...
function setListBounds(list, begin, end) {
  ...
  var newTail = newTailOffset < oldTailOffset
    ...
    : oldTail;
  if (
    oldTail && newTailOffset > oldTailOffset && newOrigin < oldCapacity &&
...
var OrderedMap = /* @__PURE__ */ function (Map3) {
  function OrderedMap2(value) {
    return value === void 0 || value === null
      ...
      : isOrderedMap(value)
      ? value
      : emptyOrderedMap().withMutations(function (map2) {
  ...
  OrderedMap2.prototype.get = /* @__PURE__ */ __name(
    function get11(k, notSetValue) {
  ...
  OrderedMap2.prototype.__iterate = /* @__PURE__ */ __name(
    function __iterate2(fn, reverse3) {
      var this$1$1 = this;
  ...
  OrderedMap2.prototype.__iterator = /* @__PURE__ */ __name(
    function __iterator2(type, reverse3) {
      return this._list.fromEntrySeq().__iterator(type, reverse3);
    },
    "__iterator",
  );
  OrderedMap2.prototype.__ensureOwner = /* @__PURE__ */ __name(
    function __ensureOwner2(ownerID) {
      if (ownerID === this.__ownerID) {
        return this;
      }
...
var Stack = /* @__PURE__ */ function (IndexedCollection2) {
  ...
  Stack2.prototype = Object.create(
    IndexedCollection2 && IndexedCollection2.prototype,
  );
  ...
  Stack2.prototype.get = /* @__PURE__ */ __name(
    function get11(index, notSetValue) {
      var head = this._head;
      index = wrapIndex(this, index);
      while (head && index--) {
  ...
  Stack2.prototype.__ensureOwner = /* @__PURE__ */ __name(
    function __ensureOwner2(ownerID) {
      if (ownerID === this.__ownerID) {
        return this;
      }
  ...
  Stack2.prototype.__iterate = /* @__PURE__ */ __name(
    function __iterate2(fn, reverse3) {
      var this$1$1 = this;
      if (reverse3) {
  ...
  Stack2.prototype.__iterator = /* @__PURE__ */ __name(
    function __iterator2(type, reverse3) {
      if (reverse3) {
...
function deepEqual(a, b) {
  ...
  if (
    ...
    a.__hash !== void 0 && b.__hash !== void 0 && a.__hash !== b.__hash ||
...
var Set = /* @__PURE__ */ function (SetCollection2) {
  function Set2(value) {
    return value === void 0 || value === null
      ...
      ? value
      : emptySet().withMutations(function (set3) {
  ...
  Set2.intersect = /* @__PURE__ */ __name(function intersect(sets) {
    ...
    return sets.length
      ? SetPrototype.intersect.apply(Set2(sets.pop()), sets)
      : emptySet();
  }, "intersect");
  Set2.union = /* @__PURE__ */ __name(function union(sets) {
    sets = Collection(sets).toArray();
    return sets.length
      ? SetPrototype.union.apply(Set2(sets.pop()), sets)
      : emptySet();
  }, "union");
  ...
  Set2.prototype.sortBy = /* @__PURE__ */ __name(
    function sortBy2(mapper, comparator) {
  ...
  Set2.prototype.__iterate = /* @__PURE__ */ __name(
    function __iterate2(fn, reverse3) {
      var this$1$1 = this;
  ...
  Set2.prototype.__iterator = /* @__PURE__ */ __name(
    function __iterator2(type, reverse3) {
      return this._map.__iterator(type, reverse3);
    },
    "__iterator",
  );
  Set2.prototype.__ensureOwner = /* @__PURE__ */ __name(
    function __ensureOwner2(ownerID) {
      if (ownerID === this.__ownerID) {
        return this;
      }
...
var Range = /* @__PURE__ */ function (IndexedSeq2) {
  ...
  Range2.prototype.get = /* @__PURE__ */ __name(
    function get11(index, notSetValue) {
      return this.has(index)
  ...
  Range2.prototype.includes = /* @__PURE__ */ __name(
    function includes3(searchValue) {
  ...
  Range2.prototype.indexOf = /* @__PURE__ */ __name(
    function indexOf2(searchValue) {
  ...
  Range2.prototype.lastIndexOf = /* @__PURE__ */ __name(
    function lastIndexOf2(searchValue) {
      return this.indexOf(searchValue);
    },
    "lastIndexOf",
  );
  Range2.prototype.__iterate = /* @__PURE__ */ __name(
    function __iterate2(fn, reverse3) {
      var size = this.size;
      var step = this._step;
  ...
  Range2.prototype.__iterator = /* @__PURE__ */ __name(
    function __iterator2(type, reverse3) {
      var size = this.size;
      var step = this._step;
      var value = reverse3 ? this._start + (size - 1) * step : this._start;
  ...
  Range2.prototype.equals = /* @__PURE__ */ __name(function equals3(other) {
    return other instanceof Range2
...
mixin(Collection, {
  ...
  __toString: /* @__PURE__ */ __name(function __toString(head, tail) {
    ...
    return head + " " + this.toSeq().map(this.__toStringMapper).join(", ") +
      " " + tail;
  }, "__toString"),
  ...
  reduce: /* @__PURE__ */ __name(
    function reduce$1(reducer, initialReduction, context) {
      return reduce(
        this,
        reducer,
        initialReduction,
  ...
  reduceRight: /* @__PURE__ */ __name(
    function reduceRight(reducer, initialReduction, context) {
      return reduce(
        this,
        reducer,
        initialReduction,
  ...
  findEntry: /* @__PURE__ */ __name(
    function findEntry(predicate, context, notSetValue) {
  ...
  findLast: /* @__PURE__ */ __name(
    function findLast(predicate, context, notSetValue) {
      return this.toKeyedSeq().reverse().find(predicate, context, notSetValue);
    },
    "findLast",
  ),
  findLastEntry: /* @__PURE__ */ __name(
    function findLastEntry(predicate, context, notSetValue) {
...
mixin(IndexedCollection, {
  ...
  findLastIndex: /* @__PURE__ */ __name(
    function findLastIndex(predicate, context) {
  ...
  get: /* @__PURE__ */ __name(function get8(index, notSetValue) {
    ...
    return index < 0 || this.size === Infinity ||
        this.size !== void 0 && index > this.size
      ? notSetValue
      : this.find(
        function (_, key) {
          return key === index;
...
var OrderedSet = /* @__PURE__ */ function (Set2) {
  function OrderedSet2(value) {
    return value === void 0 || value === null
      ...
      : isOrderedSet(value)
      ? value
      : emptyOrderedSet().withMutations(function (set3) {
  ...
  var RecordType = /* @__PURE__ */ __name(function Record3(values2) {
    ...
    this._values = List().withMutations(function (l) {
      ...
      KeyedCollection(values2).forEach(function (v, k) {
        l.set(
          this$1$1._indices[k],
          v === this$1$1._defaultValues[k] ? void 0 : v,
        );
      });
    });
    return this;
...
Record.prototype.__iterator = /* @__PURE__ */ __name(
  function __iterator(type, reverse3) {
    return recordSeq(this).__iterator(type, reverse3);
  },
  "__iterator",
);
Record.prototype.__iterate = /* @__PURE__ */ __name(
  function __iterate(fn, reverse3) {
    return recordSeq(this).__iterate(fn, reverse3);
  },
  "__iterate",
);
Record.prototype.__ensureOwner = /* @__PURE__ */ __name(
  function __ensureOwner(ownerID) {
    if (ownerID === this.__ownerID) {
      return this;
    }
...
RecordPrototype.toJSON = RecordPrototype.toObject = CollectionPrototype
  .toObject;
...
init_define_process();
var cache = globalThis.md5cache = globalThis.md5cache || /* @__PURE__ */
  new Map();
var md5 = /* @__PURE__ */ __name((code) =>
  cache.get(code) || cache.set(
    code,
    md5FULL(code).split("0").join("k").split("1").join("g").split("2").join("j")
      .split("3").join("k").split("4").join("b").split("5").join("n").split("6")
      .join("o").split("7").join("x").split("8").join("q").split("9").join("z")
      .slice(0, 8),
  ).get(code), "md5");
...
var makePatchFrom = /* @__PURE__ */ __name(
  (n, st, update8) => session.createPatchFromHashCode(n, st, update8),
  "makePatchFrom",
);
var startSession = /* @__PURE__ */ __name(
  (room, u, originString) =>
    session || new CodeSession(room, {
      name: u.name,
...
var ASSET_MANIFEST = __STATIC_CONTENT_MANIFEST;
var files = JSON.parse(ASSET_MANIFEST);
var reverseMap = {};
Object.keys(files).forEach((file) =>
  reverseMap = { ...reverseMap, [files[file]]: file }
);
var getFilePath = (file) => reverseMap[file] ? file : files[file];
    ...
    return handleErrors(request, async () => {
      ...
      const handleFetchApi = async (path2) => {
        ...
        if (newUrl.includes(":z:")) {
          ...
          const newUrl2 = atob(url.href.slice(3));
          reqHeaders.set("Referer", newUrl2);
          request = new Request(newUrl2, { ...request, headers: reqHeaders });
          ...
          await cache2.put(cacheKey, response.clone());
          return response;
        }
        if (
          path2[0].startsWith("npm:") || path2[0].startsWith("node_modules/")
        ) {
          ...
          response = new Response(
            isText
              ? bodyStr.replaceAll(regex, u.origin + "/npm:/").replaceAll(
                regex2,
                ' from "/npm:/',
              ).replaceAll(regex3, 'import "/npm:/').replaceAll(
                regex4,
                ' from "/npm:/',
        ...
        if (path2[0].startsWith("unpkg:")) {
          ...
          const responseToCache = new Response(
            `
              // ${request.url}
              ` + bodyStr
              ? bodyStr.replaceAll(regex, u.origin + "/unpkg:").replaceAll(
                regex2,
                ' from "/unpkg:',
              )
              : await resp.blob(),
          ...
          if (responseToCache.ok) {
            await cache2.put(cacheKey, responseToCache.clone());
          }
...
<script defer src="/react-jsx-runtime.js"><\/script>
...
function sort2(keys2, values2, left, right, compare) {
  ...
  let j = right + 1;
  while (true) {
    do i++; while (compare(keys2[i], pivot) < 0);
    do j--; while (compare(keys2[j], pivot) > 0);
    if (i >= j) {
      break;
    }
    let tmp = keys2[i];
...
var Code = class {
  constructor(state, env) {
    ...
    this.state.blockConcurrencyWhile(async () => {
      const session2 = await this.kv.get("session") ||
  ...
  async fetch(request) {
    ...
    return handleErrors(request, async () => {
      ...
      root.render( <ErrorBoundary
          ...
          if (i2 < mST().i) {
            return new Response(transpiled, {
              ...
              headers: {
                "Access-Control-Allow-Origin": "*",
                "Location":
                  `${url.origin}/live/${this.codeSpace}/index.js/${mST().i}`,
                "Cache-Control": "no-cache",
        ...
        case "dehydrated":
        case "public": {
          const respText = src_default.replace("/**reset*/", resetCSS).replace(
            `<root/>`,
            `
    ...
    try {
      try {
        ...
        if (data.patch && data.oldHash && data.newHash) {
          ...
          try {
            await applyPatch2({ newHash, oldHash, patch });
            this.wait();
          } catch (err) {
            console.error({ err });
