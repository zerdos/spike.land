...
var Kn = r((eo, kn) => {
  ...
  function or(t2, r2, e, n2) {
    ...
    var a2 = ki(t2, r2);
    return s && a2.unshift([K, s]), u && a2.push([K, u]), Ln(a2, n2), a2;
  }
  function ki(t2, r2) {
    var e;
    if (!t2)
    ...
    if (o2 !== -1)
      return e = [[et, n2.substring(0, o2)], [K, i2], [et, n2.substring(o2 + i2.length)]], t2.length > r2.length && (e[0][0] = e[2][0] = ut), e;
    if (i2.length === 1)
      return [[ut, t2], [et, r2]];
    var s = Wi(t2, r2);
    if (s) {
      var u = s[0], a2 = s[1], f2 = s[2], h = s[3], c = s[4], p = or(u, f2), _ = or(a2, h);
      return p.concat([[K, c]], _);
    }
    return Ki(t2, r2);
  }
  function Ki(t2, r2) {
