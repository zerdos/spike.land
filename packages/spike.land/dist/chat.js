...
const package_json_1 = tslib_1.__importDefault(
  require("@spike.land/code/package.json"),
);
      ...
      const handleFetchApi = async (path) => {
        ...
        if (path[0].startsWith("npm:") || path[0].startsWith("node_modules/")) {
          ...
          const esmUrl = isJs
            ...
            : "https://esm.sh/*" + packageName + searchParams;
          ...
          if (response.headers.has("location")) {
            ...
            headers.set(
              "location",
              redirectUrl.replace("esm.sh/", u.hostname + "/npm:/"),
            );
        ...
        switch (path[0]) {
          ...
          case "live": {
            ...
            return handleApiRequest(["room", ...paths], request, env).catch((
              e,
            ) =>
