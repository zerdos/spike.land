...
var DevcontainerGenerator = /** @class */ (function () {
    function DevcontainerGenerator(base) {
        ...
        this._chrome = false;
        this.loadTemplate = function (filename, extension) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fs_1.promises
                            .readFile(__dirname + "/../../templates/" + filename + "." + extension)["catch"](function (e) {
                            console.error({ e: e });
                            return "";
                        })];
    ...
    DevcontainerGenerator.prototype.init = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Promise.all(this._templateInputs.map(function (fileName) { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, this.loadTemplate(fileName, "Dockerfile")];
                                case 1: return [2 /*return*/, _a.sent()];
                            }
                        }); }); }))];
                    case 1:
                        bufferDockerfiles = _a.sent();
                        return [4 /*yield*/, Promise.all(this._templateInputs.map(function (fileName) { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, this.loadTemplate(fileName, "README")];
                                    case 1: return [2 /*return*/, _a.sent()];
                                }
                            }); }); }))];
                    case 2:
                        bufferReadmeFiles = _a.sent();
                        this._templateInputs.forEach(function (input, index) { return (_this._dockerTemplates[input] = String(bufferDockerfiles[index])); });
                        this._templateInputs.forEach(function (input, index) { return (_this._readmeTemplates[input] = String(bufferReadmeFiles[index])); });
                        return [2 /*return*/, {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _a = _b.sent(), dockerTemplates = _a.dockerTemplates, readmeTemplates = _a.readmeTemplates;
