...
import { markdownEscapeEscapedCodicons } from "../common/codicons";
...
const _ttpInsane = (_a = window.trustedTypes) === null || _a === void 0
  ? void 0
  : _a.createPolicy("insane", {
...
export function renderMarkdown(markdown, options = {}, markedOptions = {}) {
  ...
  if (options.actionHandler) {
    options.actionHandler.disposeables.add(
      Event.any(domEvent(element, "click"), domEvent(element, "auxclick"))(
        (e) => {
...
function sanitizeRenderedMarkdown(options, renderedMarkdown) {
  ...
  return (_a = _ttpInsane === null || _ttpInsane === void 0
          ? void 0
          : _ttpInsane.createHTML(renderedMarkdown, insaneOptions)) !== null &&
      _a !== void 0
    ? _a
...
function getInsaneOptions(options) {
  ...
  return {
    ...
    filter(token) {
      if (
        token.tag === "span" && options.isTrusted &&
        (Object.keys(token.attrs).length === 1)
      ) {
        if (token.attrs["style"]) {
          ...
          return !!token.attrs["class"].match(
            /^codicon codicon-[a-z\-]+( codicon-animation-[a-z\-]+)?$/,
          );
        }
        return false;
      }
