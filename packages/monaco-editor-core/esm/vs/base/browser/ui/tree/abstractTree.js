...
class TreeNodeListDragAndDrop {
  ...
  onDragOver(data, targetNode, targetIndex, originalEvent, raw = true) {
    ...
    if (
      didChangeAutoExpandNode && typeof result !== "boolean" &&
      result.autoExpand
    ) {
    ...
    if (
      typeof result === "boolean" || !result.accept ||
      typeof result.bubble === "undefined" || result.feedback
    ) {
      if (!raw) {
      ...
      Object.assign({}, options),
      {
        ...
        multipleSelectionController: options.multipleSelectionController && {
          isSelectionSingleChangeEvent(e) {
            return options.multipleSelectionController
        ...
        accessibilityProvider: options.accessibilityProvider &&
          Object.assign(
            Object.assign({}, options.accessibilityProvider),
            {
              getSetSize(node) {
        ...
        keyboardNavigationLabelProvider:
          ...
          Object.assign(
            Object.assign({}, options.keyboardNavigationLabelProvider),
            {
              getKeyboardNavigationLabel(node) {
                return options.keyboardNavigationLabelProvider
                  .getKeyboardNavigationLabel(node.element);
              },
            },
          ),
...
class TypeFilter {
  ...
  filter(element, parentVisibility) {
    ...
    const label = this.keyboardNavigationLabelProvider
...
class TypeFilterController {
  constructor(tree, model, view, filter, keyboardNavigationDelegate) {
    ...
    this.clearDomNode = append(
      controls,
      $("button.clear" + treeFilterClearIcon.cssSelector),
    );
  ...
  enable() {
    ...
    const onKeyDown =
      Event.chain(domEvent(this.view.getHTMLElement(), "keydown"))
        .filter((e) =>
          !isInputElement(e.target) || e.target === this.filterOnTypeDomNode
        )
  ...
  onDragStart() {
    ...
    const onDragEnd = () => {
      ...
      this.domNode.className =
        `monaco-list-type-filter ${this.positionClassName}`;
  ...
  render() {
    const noMatches = this.filter.totalCount > 0 &&
      this.filter.matchCount === 0;
    ...
    this.labelDomNode.textContent = this.pattern.length > 16
...
class Trait {
  ...
  set(nodes, browserEvent) {
    var _a;
    if (
      !((_a = browserEvent) === null || _a === void 0
        ? void 0
        : _a.__forceEvent) && equals(this.nodes, nodes)
    ) {
      return;
    }
...
class TreeNodeListMouseController extends MouseController {
  ...
  onViewPointer(e) {
    ...
    if (
      this.tree.expandOnlyOnDoubleClick && e.browserEvent.detail !== 2 &&
      !onTwistie
    ) {
      return super.onViewPointer(e);
    }
  ...
  onDoubleClick(e) {
    const onTwistie = e.browserEvent.target.classList.contains(
      "monaco-tl-twistie",
    );
    if (onTwistie) {
      return;
...
export class AbstractTree {
  constructor(user, container, delegate, renderers, _options = {}) {
    ...
    this.view = new TreeNodeList(
      ...
      this.selection,
      Object.assign(
        Object.assign({}, asListOptions(() => this.model, _options)),
        { tree: this },
      ),
    );
    ...
    if (_options.keyboardSupport !== false) {
      const onKeyDown = Event.chain(this.view.onKeyDown)
        ...
        .map((e) => new StandardKeyboardEvent(e));
      onKeyDown.filter((e) => e.keyCode === 15 /* LeftArrow */).on(
        this.onLeftArrow,
        this,
        this.disposables,
      );
      onKeyDown.filter((e) => e.keyCode === 17 /* RightArrow */).on(
        this.onRightArrow,
        this,
        this.disposables,
      );
      onKeyDown.filter((e) => e.keyCode === 10 /* Space */).on(
        this.onSpace,
        this,
        this.disposables,
      );
    ...
    if (_options.keyboardNavigationLabelProvider) {
      const delegate = _options.keyboardNavigationDelegate ||
        DefaultKeyboardNavigationDelegate;
  ...
  get expandOnlyOnDoubleClick() {
    var _a;
    return (_a = this._options.expandOnlyOnDoubleClick) !== null &&
        _a !== void 0
      ? _a
      : false;
  }
  ...
  style(styles) {
    ...
    if (styles.treeIndentGuidesStroke) {
      content.push(
        `.monaco-list${suffix}:hover .monaco-tl-indent > .indent-guide, .monaco-list${suffix}.always .monaco-tl-indent > .indent-guide  { border-color: ${
