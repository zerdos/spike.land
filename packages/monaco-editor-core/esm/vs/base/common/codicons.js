...
(function (Codicon) {
  ...
  Codicon.gitPullRequest = new Codicon(
    "git-pull-request",
    { character: "\\ea64" },
  );
  ...
  Codicon.personOutline = new Codicon(
    "person-outline",
    { character: "\\ea67" },
  );
  Codicon.personFilled = new Codicon("person-filled", { character: "\\ea67" });
  Codicon.gitBranch = new Codicon("git-branch", { character: "\\ea68" });
  Codicon.gitBranchCreate = new Codicon(
    "git-branch-create",
    { character: "\\ea68" },
  );
  Codicon.gitBranchDelete = new Codicon(
    "git-branch-delete",
    { character: "\\ea68" },
  );
  Codicon.sourceControl = new Codicon(
    "source-control",
    { character: "\\ea68" },
  );
  ...
  Codicon.debugBreakpoint = new Codicon(
    "debug-breakpoint",
    { character: "\\ea71" },
  );
  ...
  Codicon.primitiveSquare = new Codicon(
    "primitive-square",
    { character: "\\ea72" },
  );
  ...
  Codicon.gitForkPrivate = new Codicon(
    "git-fork-private",
    { character: "\\ea75" },
  );
  Codicon.lock = new Codicon("lock", { character: "\\ea75" });
  Codicon.mirrorPrivate = new Codicon(
    "mirror-private",
    { character: "\\ea75" },
  );
  ...
  Codicon.desktopDownload = new Codicon(
    "desktop-download",
    { character: "\\ea78" },
  );
  ...
  Codicon.deviceDesktop = new Codicon(
    "device-desktop",
    { character: "\\ea7a" },
  );
  ...
  Codicon.kebabHorizontal = new Codicon(
    "kebab-horizontal",
    { character: "\\ea7c" },
  );
  ...
  Codicon.organizationFilled = new Codicon(
    "organization-filled",
    { character: "\\ea7e" },
  );
  Codicon.organizationOutline = new Codicon(
  ...
  Codicon.fileDirectoryCreate = new Codicon(
  ...
  Codicon.fileDirectory = new Codicon(
    "file-directory",
    { character: "\\ea83" },
  );
  ...
  Codicon.symbolVariable = new Codicon(
    "symbol-variable",
    { character: "\\ea88" },
  );
  ...
  Codicon.symbolPackage = new Codicon(
    "symbol-package",
    { character: "\\ea8b" },
  );
  Codicon.symbolNamespace = new Codicon(
    "symbol-namespace",
    { character: "\\ea8b" },
  );
  ...
  Codicon.activateBreakpoints = new Codicon(
  ...
  Codicon.arrowSmallDown = new Codicon(
    "arrow-small-down",
    { character: "\\ea9d" },
  );
  Codicon.arrowSmallLeft = new Codicon(
    "arrow-small-left",
    { character: "\\ea9e" },
  );
  Codicon.arrowSmallRight = new Codicon(
    "arrow-small-right",
    { character: "\\ea9f" },
  );
  ...
  Codicon.debugBreakpointData = new Codicon(
  ...
  Codicon.debugBreakpointLog = new Codicon(
  ...
  Codicon.caseSensitive = new Codicon(
    "case-sensitive",
    { character: "\\eab1" },
  );
  ...
  Codicon.chromeMaximize = new Codicon(
    "chrome-maximize",
    { character: "\\eab9" },
  );
  Codicon.chromeMinimize = new Codicon(
    "chrome-minimize",
    { character: "\\eaba" },
  );
  Codicon.chromeRestore = new Codicon(
    "chrome-restore",
    { character: "\\eabb" },
  );
  Codicon.circleOutline = new Codicon(
    "circle-outline",
    { character: "\\eabc" },
  );
  ...
  Codicon.cloudDownload = new Codicon(
    "cloud-download",
    { character: "\\eac2" },
  );
  ...
  Codicon.commentDiscussion = new Codicon(
    "comment-discussion",
    { character: "\\eac7" },
  );
  Codicon.compareChanges = new Codicon(
    "compare-changes",
    { character: "\\eafd" },
  );
  ...
  Codicon.debugContinue = new Codicon(
    "debug-continue",
    { character: "\\eacf" },
  );
  Codicon.debugDisconnect = new Codicon(
    "debug-disconnect",
    { character: "\\ead0" },
  );
  ...
  Codicon.fileSubmodule = new Codicon(
    "file-submodule",
    { character: "\\eaec" },
  );
  Codicon.fileSymlinkDirectory = new Codicon(
    "file-symlink-directory",
    { character: "\\eaed" },
  );
  Codicon.fileSymlinkFile = new Codicon(
    "file-symlink-file",
    { character: "\\eaee" },
  );
  ...
  Codicon.horizontalRule = new Codicon(
    "horizontal-rule",
    { character: "\\eb07" },
  );
  ...
  Codicon.issueReopened = new Codicon(
    "issue-reopened",
    { character: "\\eb0b" },
  );
  ...
  Codicon.listUnordered = new Codicon(
    "list-unordered",
    { character: "\\eb17" },
  );
  ...
  Codicon.multipleWindows = new Codicon(
    "multiple-windows",
    { character: "\\eb23" },
  );
  ...
  Codicon.remoteExplorer = new Codicon(
    "remote-explorer",
    { character: "\\eb39" },
  );
  ...
  Codicon.repoForcePush = new Codicon(
    "repo-force-push",
    { character: "\\eb3f" },
  );
  ...
  Codicon.requestChanges = new Codicon(
    "request-changes",
    { character: "\\eb43" },
  );
  Codicon.rocket = new Codicon("rocket", { character: "\\eb44" });
  Codicon.rootFolderOpened = new Codicon(
    "root-folder-opened",
    { character: "\\eb45" },
  );
  ...
  Codicon.sortPrecedence = new Codicon(
    "sort-precedence",
    { character: "\\eb55" },
  );
  Codicon.splitHorizontal = new Codicon(
    "split-horizontal",
    { character: "\\eb56" },
  );
  Codicon.splitVertical = new Codicon(
    "split-vertical",
    { character: "\\eb57" },
  );
  ...
  Codicon.symbolConstant = new Codicon(
    "symbol-constant",
    { character: "\\eb5d" },
  );
  Codicon.symbolEnumMember = new Codicon(
    "symbol-enum-member",
    { character: "\\eb5e" },
  );
  Codicon.symbolField = new Codicon("symbol-field", { character: "\\eb5f" });
  Codicon.symbolFile = new Codicon("symbol-file", { character: "\\eb60" });
  Codicon.symbolInterface = new Codicon(
    "symbol-interface",
    { character: "\\eb61" },
  );
  Codicon.symbolKeyword = new Codicon(
    "symbol-keyword",
    { character: "\\eb62" },
  );
  Codicon.symbolMisc = new Codicon("symbol-misc", { character: "\\eb63" });
  Codicon.symbolOperator = new Codicon(
    "symbol-operator",
    { character: "\\eb64" },
  );
  Codicon.symbolProperty = new Codicon(
    "symbol-property",
    { character: "\\eb65" },
  );
  Codicon.wrench = new Codicon("wrench", { character: "\\eb65" });
  Codicon.wrenchSubaction = new Codicon(
    "wrench-subaction",
    { character: "\\eb65" },
  );
  Codicon.symbolSnippet = new Codicon(
    "symbol-snippet",
    { character: "\\eb66" },
  );
  ...
  Codicon.triangleRight = new Codicon(
    "triangle-right",
    { character: "\\eb70" },
  );
  ...
  Codicon.listSelection = new Codicon(
    "list-selection",
    { character: "\\eb85" },
  );
  ...
  Codicon.debugStackframeActive = new Codicon(
  ...
  Codicon.debugStackframe = new Codicon(
    "debug-stackframe",
    { character: "\\eb8b" },
  );
  ...
  Codicon.debugReverseContinue = new Codicon(
    "debug-reverse-continue",
    { character: "\\eb8e" },
  );
  Codicon.debugStepBack = new Codicon(
    "debug-step-back",
    { character: "\\eb8f" },
  );
  Codicon.debugRestartFrame = new Codicon(
    "debug-restart-frame",
    { character: "\\eb90" },
  );
  ...
  Codicon.groupByRefType = new Codicon(
    "group-by-ref-type",
    { character: "\\eb97" },
  );
  Codicon.ungroupByRefType = new Codicon(
    "ungroup-by-ref-type",
    { character: "\\eb98" },
  );
  ...
  Codicon.githubInverted = new Codicon(
    "github-inverted",
    { character: "\\eba1" },
  );
  Codicon.debugAlt = new Codicon("debug-alt", { character: "\\eb91" });
  Codicon.serverProcess = new Codicon(
    "server-process",
    { character: "\\eba2" },
  );
  Codicon.serverEnvironment = new Codicon(
    "server-environment",
    { character: "\\eba3" },
  );
  ...
  Codicon.debugAltSmall = new Codicon(
    "debug-alt-small",
    { character: "\\eba8" },
  );
  ...
  Codicon.circleLargeFilled = new Codicon(
    "circle-large-filled",
    { character: "\\ebb4" },
  );
  Codicon.circleLargeOutline = new Codicon(
  ...
  Codicon.dropDownButton = new Codicon(
    ...
    localize("dropDownButton", "Icon for drop down buttons."),
  );
})(Codicon || (Codicon = {}));
// common icons
