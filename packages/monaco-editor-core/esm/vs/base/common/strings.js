...
export function regExpLeadsToEndlessLoop(regexp) {
  ...
  if (
    regexp.source === "^" || regexp.source === "^$" || regexp.source === "$" ||
    regexp.source === "^\\s*$"
  ) {
    return false;
  }
...
export function nextCharLength(str, offset) {
  ...
  offset +=
    (initialCodePoint >= 65536 /* UNICODE_SUPPLEMENTARY_PLANE_BEGIN */ ? 2 : 1);
  ...
  while (offset < len) {
    ...
    offset += (nextCodePoint >= 65536 /* UNICODE_SUPPLEMENTARY_PLANE_BEGIN */
      ? 2
      : 1);
...
export function prevCharLength(str, offset) {
  ...
  while (offset > 0) {
    ...
    offset -= (prevCodePoint >= 65536 /* UNICODE_SUPPLEMENTARY_PLANE_BEGIN */
      ? 2
      : 1);
...
export function breakBetweenGraphemeBreakType(breakTypeA, breakTypeB) {
  ...
  if (
    breakTypeA === 13 /* ZWJ */ && breakTypeB === 14 /* Extended_Pictographic */
  ) {
