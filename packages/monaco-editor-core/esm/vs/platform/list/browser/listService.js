...
import {
  ...
  List,
} from "../../../base/browser/ui/list/listWidget";
...
import {
  ...
  ObjectTree,
} from "../../../base/browser/ui/tree/objectTree";
import {
  AsyncDataTree,
  CompressibleAsyncDataTree,
} from "../../../base/browser/ui/tree/asyncDataTree";
...
export const WorkbenchListSupportsKeyboardNavigation = new RawContextKey(
...
let WorkbenchList = class WorkbenchList extends List {
  constructor(
    ...
    const listSupportsMultiSelect = WorkbenchListSupportsMultiSelectContextKey
    ...
    this.disposables.add(configurationService.onDidChangeConfiguration((e) => {
      ...
      if (
        ...
        const horizontalScrolling = configurationService.getValue(
      ...
      if (e.affectsConfiguration(listSmoothScrolling)) {
        const smoothScrolling = configurationService.getValue(
          listSmoothScrolling,
        );
        options = Object.assign(
          Object.assign({}, options),
...
class ResourceNavigator extends Disposable {
  constructor(widget, options) {
    ...
    this.openOnFocus =
      (_a = options === null || options === void 0
            ? void 0
            : options.openOnFocus) !== null && _a !== void 0
        ? _a
        : false;
    this._register(
      Event.filter(
    ...
    if (
      ...
      this.openOnSingleClick = (options === null || options === void 0
        ? void 0
      ...
      this.openOnSingleClick = (_b = options === null || options === void 0
              ? void 0
              : options.openOnSingleClick) !== null && _b !== void 0
        ? _b
        : true;
    }
  }
  onFocusFromKeyboard(event) {
    ...
    const preserveFocus = typeof event.browserEvent.preserveFocus === "boolean"
      ? event.browserEvent.preserveFocus
      : true;
  ...
  onPointer(element, browserEvent) {
    ...
    const sideBySide = browserEvent.ctrlKey || browserEvent.metaKey ||
      browserEvent.altKey;
...
let WorkbenchObjectTree = class WorkbenchObjectTree extends ObjectTree {
  constructor(
    ...
    const { options: treeOptions, getAutomaticKeyboardNavigation, disposable } =
...
let WorkbenchCompressibleObjectTree = class WorkbenchCompressibleObjectTree
  extends CompressibleObjectTree {
  constructor(
    user,
    container,
    delegate,
...
let WorkbenchCompressibleAsyncDataTree =
...
function workbenchTreeDataPreamble(
  ...
  const getAutomaticKeyboardNavigation = () => {
    ...
    let automaticKeyboardNavigation = contextKeyService.getContextKeyValue(
      WorkbenchListAutomaticKeyboardNavigationKey,
    );
    if (automaticKeyboardNavigation) {
      automaticKeyboardNavigation = configurationService.getValue(
  ...
  return {
    ...
    options: Object.assign(
      ...
      }, workbenchListOptions),
      {
        ...
        renderIndentGuides: configurationService.getValue(
        ...
        expandOnlyOnDoubleClick:
          configurationService.getValue(openModeSettingKey) === "doubleClick",
...
let WorkbenchTreeInternals = class WorkbenchTreeInternals {
      ...
      configurationService.onDidChangeConfiguration((e) => {
        ...
        if (e.affectsConfiguration(openModeSettingKey)) {
          newOptions = Object.assign(
            ...
            {
              expandOnlyOnDoubleClick:
                configurationService.getValue(openModeSettingKey) ===
                  "doubleClick",
            },
          );
        }
  ...
  updateStyleOverrides(overrideStyles) {
    ...
    this.styler = overrideStyles
      ? attachListStyler(this.tree, this.themeService, overrideStyles)
      : Disposable.None;
  }
  dispose() {
