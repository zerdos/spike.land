...
let StandaloneCommandsQuickAccessProvider =
  class StandaloneCommandsQuickAccessProvider
    extends AbstractEditorCommandsQuickAccessProvider {
    constructor(
...
Registry.as(Extensions.Quickaccess).registerQuickAccessProvider({
  ...
  helpEntries: [
    { description: QuickCommandNLS.quickCommandHelp, needsEditor: true },
  ],
});
