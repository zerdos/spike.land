...
let StandaloneGotoLineQuickAccessProvider =
  class StandaloneGotoLineQuickAccessProvider
    extends AbstractGotoLineQuickAccessProvider {
...
Registry.as(Extensions.Quickaccess).registerQuickAccessProvider({
  ...
  helpEntries: [
    { description: GoToLineNLS.gotoLineActionLabel, needsEditor: true },
  ],
});
export class GotoLineAction extends EditorAction {
  ...
  run(accessor) {
    accessor.get(IQuickInputService).quickAccess.show(
      StandaloneGotoLineQuickAccessProvider.PREFIX,
    );
  }
}
