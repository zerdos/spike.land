...
export class Colorizer {
  static colorizeElement(themeService, modeService, domNode, options) {
    ...
    let mimeType = options.mimeType || domNode.getAttribute("lang") ||
    ...
    let render = (str) => {
      var _a;
      const trustedhtml =
        (_a = ttPolicy === null || ttPolicy === void 0
              ? void 0
  ...
  static colorize(modeService, text, mimeType, options) {
    ...
    const tokenizationSupportPromise = TokenizationRegistry.getPromise(
      language,
    );
