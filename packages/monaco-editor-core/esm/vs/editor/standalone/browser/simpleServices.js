...
import { isLinux, isMacintosh, OS } from "../../../base/common/platform";
...
} from "../../common/config/commonEditorConfig";
...
} from "../../../platform/configuration/common/configurationModels";
...
export class SimpleResourceConfigurationService {
  ...
  getValue(resource, arg2, arg3) {
    ...
    const section = position
      ? (typeof arg3 === "string" ? arg3 : undefined)
...
let SimpleResourcePropertiesService = class SimpleResourcePropertiesService {
  ...
  getEOL(resource, language) {
    const eol = this.configurationService.getValue(
      "files.eol",
...
export function applyConfigurationValues(
