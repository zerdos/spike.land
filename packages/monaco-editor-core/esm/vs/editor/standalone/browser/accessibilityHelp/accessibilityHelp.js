...
let AccessibilityHelpController = class AccessibilityHelpController
  extends Disposable {
...
let AccessibilityHelpWidget = class AccessibilityHelpWidget extends Widget {
  ...
  _buildContent() {
    ...
    if (options.get(122 /* tabFocusMode */)) {
      text += "\n\n - " +
...
registerThemingParticipant((theme, collector) => {
  ...
  if (widgetForeground) {
    collector.addRule(
      `.monaco-editor .accessibilityHelpWidget { color: ${widgetForeground}; }`,
    );
  }
