      ...
      yield this._editorService.openCodeEditor(
        {
          ...
          options: Object.assign(
            {
              selection,
              context: (options === null || options === void 0
                  ? void 0
...
let OpenerService = class OpenerService {
  ...
  open(target, options) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const validationTarget =
        (_a = this._resolvedUriTargets.get(targetURI)) !== null && _a !== void 0
          ? _a
          : target;
  ...
  _doOpenExternal(resource, options) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (
        typeof resource === "string" && uri.toString() === resolved.toString()
      ) {
        // open the url-string AS IS
        return this._externalOpener.openExternal(resource);
      } else {
        // open URI using the toString(noEncode)+encodeURI-trick
        return this._externalOpener.openExternal(
          encodeURI(resolved.toString(true)),
        );
      }
    });
  }
