...
import {
  HorizontalPosition,
  LineVisibleRanges,
} from "../../../common/view/renderingContext";
...
export class ViewLines extends ViewPart {
  ...
  onCursorStateChanged(e) {
    ...
    for (
      ...
      r = this._visibleLines.getVisibleLine(lineNumber).onSelectionChanged() ||
        r;
    }
    return r;
  }
  ...
  onRevealRangeRequest(e) {
    ...
    const scrollType =
      (scrollTopDelta <= this._lineHeight ? 1 /* Immediate */ : e.scrollType);
  ...
  getPositionFromDOMInfo(spanNode, offset) {
    ...
    let column = this._visibleLines.getVisibleLine(lineNumber)
  ...
  linesVisibleRangesForRange(_range, includeNewLines) {
    ...
    for (
      ...
      const startColumn = lineNumber === range.startLineNumber
        ? range.startColumn
        : 1;
      const endColumn = lineNumber === range.endLineNumber
        ? range.endColumn
        : this._context.model.getLineMaxColumn(lineNumber);
      const visibleRangesForLine = this._visibleLines.getVisibleLine(lineNumber)
  ...
  _visibleRangesForLineRange(lineNumber, startColumn, endColumn) {
    ...
    return this._visibleLines.getVisibleLine(lineNumber)
  ...
  _updateLineWidths(fast) {
    ...
    if (
      allWidthsComputed && rendStartLineNumber === 1 &&
  ...
  _checkMonospaceFontAssumptions() {
    ...
    if (
      !this._visibleLines.getVisibleLine(longestLineNumber)
  ...
  _computeScrollTopToRevealRange(
    ...
    if (boxEndY - boxStartY > viewportHeight) {
      ...
      verticalType === 5 /* NearTop */ ||
      verticalType === 6 /* NearTopIfOutsideViewport */
    ) {
      if (
        verticalType === 6 /* NearTopIfOutsideViewport */ &&
