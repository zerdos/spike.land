...
export class AbstractLineHighlightOverlay extends DynamicViewOverlay {
  ...
  _readFromSelections() {
    ...
    const renderSelections = isRenderedUsingBorder
      ...
      : this._selections;
    const cursorsLineNumbers = renderSelections.map((s) =>
...
export class CurrentLineHighlightOverlay extends AbstractLineHighlightOverlay {
  ...
  _shouldRenderThis() {
    return ((this._renderLineHighlight === "line" ||
      this._renderLineHighlight === "all") &&
      this._selectionIsEmpty &&
      (!this._renderLineHighlightOnlyWhenFocus || this._focused));
  }
  _shouldRenderOther() {
    return ((this._renderLineHighlight === "gutter" ||
      this._renderLineHighlight === "all") &&
      (!this._renderLineHighlightOnlyWhenFocus || this._focused));
  }
}
export class CurrentLineMarginHighlightOverlay
  extends AbstractLineHighlightOverlay {
  _renderOne(ctx) {
    const className = "current-line" + (this._shouldRenderMargin()
      ? " current-line-margin"
      : "") +
