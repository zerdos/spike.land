  ...
  render(markdown, options, markedOptions) {
    ...
    if (!markdown) {
      ...
      element = renderMarkdown(
        markdown,
        Object.assign(
          Object.assign({}, this._getRenderOptions(disposeables)),
          options,
        ),
        markedOptions,
      );
    ...
    return {
      ...
      codeBlockRenderer: (languageAlias, value) =>
        __awaiter(this, void 0, void 0, function* () {
          ...
          if (languageAlias) {
            ...
            modeId =
              (_a = this._options.editor.getModel()) === null || _a === void 0
                ? void 0
                : _a.getLanguageIdentifier().language;
          }
          if (!modeId) {
            modeId = "plaintext";
          }
          ...
          const tokenization =
            (_b = yield TokenizationRegistry.getPromise(modeId)) !== null &&
              _b !== void 0
              ? _b
              : undefined;
          ...
          if (this._options.editor) {
            fontFamily =
              this._options.editor.getOption(38 /* fontInfo */).fontFamily;
          }
          if (fontFamily) {
      ...
      actionHandler: {
        callback: (content) =>
          this._openerService.open(content, { fromUserGesture: true }).catch(
            onUnexpectedError,
          ),
        disposeables,
      },
