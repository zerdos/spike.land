...
export class ColorPickerHeader extends Disposable {
  constructor(container, model, themeService) {
    ...
    this._register(registerThemingParticipant((theme, collector) => {
      this.backgroundColor = theme.getColor(editorHoverBackground) ||
        Color.white;
    }));
    this._register(
    ...
    this.pickedColorNode.classList.toggle(
      "light",
...
export class ColorPickerBody extends Disposable {
  constructor(container, model, pixelRatio) {
    ...
    dom.append(container, this.domNode);
    this.saturationBox = new SaturationBox(
      this.domNode,
      this.model,
      this.pixelRatio,
    );
    ...
    this._register(
      this.saturationBox.onDidChange(this.onDidSaturationValueChange, this),
    );
    ...
    this._register(
      this.opacityStrip.onDidChange(this.onDidOpacityChange, this),
    );
