...
} from "../../browser/controller/textAreaInput";
import {
  EditorAction,
  MultiCommand,
...
const supportsCut =
  (platform.isNative || document.queryCommandSupported("cut"));
const supportsCopy =
...
const supportsPaste =
  (browser.isFirefox ? document.queryCommandSupported("paste") : true);
        ...
        (() =>
          __awaiter(void 0, void 0, void 0, function* () {
            ...
            if (clipboardText !== "") {
              ...
              if (metadata) {
                pasteOnNewLine =
                  (focusedEditor.getOption(28 /* emptySelectionClipboard */) &&
