...
class PersistedWidgetSize {
  constructor(_service, editor) {
    ...
    this._key =
      `suggestWidget.size/${editor.getEditorType()}/${editor instanceof
...
let SuggestWidget = class SuggestWidget {
  constructor(
    ...
    this._disposables.add(this.element.onDidResize((e) => {
      ...
      if (state) {
        ...
        if (
          ...
          height = (_b = (_a = state.persistedSize) === null || _a === void 0
                  ? void 0
        ...
        if (
          ...
          width = (_d = (_c = state.persistedSize) === null || _c === void 0
                  ? void 0
    ...
    const applyIconStyle = () =>
      this.element.domNode.classList.toggle(
        "no-icons",
        !this.editor.getOption(101 /* suggest */).showIcons,
      );
    applyIconStyle();
    ...
    const applyStatusBarStyle = () =>
      this.element.domNode.classList.toggle(
        "with-status-bar",
        this.editor.getOption(101 /* suggest */).showStatusBar,
      );
    applyStatusBarStyle();
    ...
    this._ctxSuggestWidgetMultipleSuggestions = SuggestContext
      .MultipleSuggestions.bindTo(_contextKeyService);
    this._disposables.add(
  ...
  _onThemeChange(theme) {
    ...
    if (backgroundColor) {
      ...
      this._details.widget.domNode.style.backgroundColor = backgroundColor
        .toString();
    }
  ...
  toggleDetails() {
    if (this._isDetailsVisible()) {
      ...
      (this._state === 3 /* Open */ || this._state === 5 /* Details */ ||
        this._state === 4 /* Frozen */)
    ) {
  ...
  _layout(size) {
    ...
    if (this._state === 2 /* Empty */ || this._state === 1 /* Loading */) {
      ...
      this._cappedHeight = size && height === fullHeight
        ? {
          wanted: (_c = (_b = this._cappedHeight) === null || _b === void 0
                  ? void 0
  ...
  getLayoutInfo() {
    ...
    const itemHeight = clamp(
      this.editor.getOption(103 /* suggestLineHeight */) || fontInfo.lineHeight,
      8,
      1000,
    );
    const statusBarHeight =
      !this.editor.getOption(101 /* suggest */).showStatusBar ||
        this._state === 2 /* Empty */ || this._state === 1 /* Loading */
        ? 0
        : itemHeight;
