...
let ItemRenderer = class ItemRenderer {
  ...
  renderTemplate(container) {
    ...
    data.iconLabel = new IconLabel(
      data.left,
      { supportHighlights: true, supportCodicons: true },
    );
    ...
    const configureFont = () => {
      ...
      const fontSize = options.get(102 /* suggestFontSize */) ||
        fontInfo.fontSize;
      const lineHeight = options.get(103 /* suggestLineHeight */) ||
        fontInfo.lineHeight;
    ...
    data.disposables.add(this._editor.onDidChangeConfiguration((e) => {
      if (
        ...
        e.hasChanged(102 /* suggestFontSize */) ||
        e.hasChanged(103 /* suggestLineHeight */)
      ) {
        configureFont();
      }
    }));
  ...
  renderElement(element, index, data) {
    ...
    const textLabel = typeof completion.label === "string"
      ? completion.label
    ...
    if (
      ...
      labelOptions.extraClasses = labelClasses.length > detailClasses.length
        ? labelClasses
        : detailClasses;
    } else if (
      completion.kind === 23 /* Folder */ &&
    ...
    if (typeof completion.label === "string") {
      ...
      data.parametersLabel.textContent = (completion.label.parameters || "")
        .replace(/\n.*$/m, "");
      data.qualifierLabel.textContent = (completion.label.qualifier || "")
        .replace(/\n.*$/m, "");
      ...
      data.root.title = `${textLabel}${
        (_b = completion.label.parameters) !== null && _b !== void 0 ? _b : ""
      }  ${
        (_c = completion.label.qualifier) !== null && _c !== void 0 ? _c : ""
      }  ${(_d = completion.label.type) !== null && _d !== void 0 ? _d : ""}`;
    }
