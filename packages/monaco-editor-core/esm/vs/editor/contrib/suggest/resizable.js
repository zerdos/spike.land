...
export class ResizableHTMLElement {
  constructor() {
    ...
    this._northSash = new Sash(
      ...
      { orientation: 1, /* HORIZONTAL */ orthogonalEdge: OrthogonalEdge.North },
    );
    this._southSash = new Sash(
      this.domNode,
      { getHorizontalSashTop: () => this._size.height },
      { orientation: 1, /* HORIZONTAL */ orthogonalEdge: OrthogonalEdge.South },
    );
    ...
    this._sashListener.add(this._eastSash.onDidChange((e) => {
      if (currentSize) {
        ...
        this._onDidResize.fire(
          { dimension: this._size, done: false, east: true },
        );
      }
    }));
    this._sashListener.add(this._westSash.onDidChange((e) => {
      if (currentSize) {
        ...
        this.layout(currentSize.height + deltaY, currentSize.width + deltaX);
        this._onDidResize.fire(
          { dimension: this._size, done: false, west: true },
        );
      }
    }));
    this._sashListener.add(this._northSash.onDidChange((e) => {
      if (currentSize) {
        ...
        this.layout(currentSize.height + deltaY, currentSize.width + deltaX);
        this._onDidResize.fire(
          { dimension: this._size, done: false, north: true },
        );
      }
    }));
    this._sashListener.add(this._southSash.onDidChange((e) => {
      if (currentSize) {
        ...
        this.layout(currentSize.height + deltaY, currentSize.width + deltaX);
        this._onDidResize.fire(
          { dimension: this._size, done: false, south: true },
        );
      }
    }));
    this._sashListener.add(
      Event.any(this._eastSash.onDidReset, this._westSash.onDidReset)((e) => {
    ...
    this._sashListener.add(
      Event.any(this._northSash.onDidReset, this._southSash.onDidReset)((e) => {
        if (this._preferredSize) {
