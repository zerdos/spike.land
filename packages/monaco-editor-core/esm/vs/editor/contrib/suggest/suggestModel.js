...
let SuggestModel = class SuggestModel {
  ...
  _updateTriggerCharacters() {
    ...
    for (
      const support of CompletionProviderRegistry.all(this._editor.getModel())
    ) {
  ...
  _onCursorChange(e) {
    ...
    if (this._state === 0 /* Idle */ && e.reason === 0 /* NotSet */) {
      ...
      if (
        this._editor.getOption(101 /* suggest */)
  ...
  trigger(context, retrigger = false, onlyFrom, existing) {
    ...
    this._onDidTrigger.fire(
      { auto, shy: context.shy, position: this._editor.getPosition() },
    );
    // Capture context when request was sent
    this._context = ctx;
    // Build context for request
    let suggestCtx = {
      triggerKind: (_a = context.triggerKind) !== null && _a !== void 0
        ? _a
        : 0, /* Invoke */
    };
    ...
    Promise.all([completions, wordDistance]).then((
      [completions, wordDistance],
    ) =>
      __awaiter(this, void 0, void 0, function* () {
        var _b;
        (_b = this._requestToken) === null || _b === void 0
          ? void 0
          : _b.dispose();
        if (this._state === 0 /* Idle */) {
          return;
        ...
        let clipboardText = existing === null || existing === void 0
          ? void 0
          : existing.clipboardText;
        ...
        this._completionModel = new CompletionModel(
          ...
          wordDistance,
          this._editor.getOption(101 /* suggest */),
          this._editor.getOption(96 /* snippetSuggestions */),
          clipboardText,
        );
