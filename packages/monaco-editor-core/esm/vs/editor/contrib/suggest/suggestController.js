...
let SuggestController = class SuggestController {
    ...
    this.widget = this._toDispose.add(
      new IdleValue(() => {
        ...
        const commitCharacterController = new CommitCharacterController(
          this.editor,
          widget,
          (item) => this._insertSuggestion(item, 2 /* NoAfterUndoStop */),
        );
        ...
        const ctxHasInsertAndReplace = SuggestContext.HasInsertAndReplaceRange
        ...
        this._toDispose.add(widget.onDetailsKeyDown((e) => {
          ...
          if (
            e.toKeybinding().equals(
              new SimpleKeybinding(true, false, false, false, 33 /* KEY_C */),
            ) ||
            (platform.isMacintosh &&
              e.toKeybinding().equals(
                new SimpleKeybinding(false, false, false, true, 33 /* KEY_C */),
              ))
          ) {
            e.stopPropagation();
            return;
  ...
  _insertSuggestion(event, flags) {
    ...
    SnippetController2.get(this.editor).insert(insertText, {
      ...
      undoStopAfter: false,
      adjustWhitespace:
        !(item.completion.insertTextRules & 1 /* KeepWhitespace */),
      ...
      this._alternatives.value.set(event, (next) => {
        ...
        while (model.canUndo()) {
          ...
          this._insertSuggestion(
            next,
            1 /* NoBeforeUndoStop */ | 2 /* NoAfterUndoStop */ |
              (flags & 8 /* AlternativeOverwriteConfig */
                ? 8 /* AlternativeOverwriteConfig */
                : 0),
          );
          break;
        }
  ...
  getOverwriteInfo(item, toggleMode) {
    ...
    let replace =
      this.editor.getOption(101 /* suggest */).insertMode === "replace";
    if (toggleMode) {
      replace = !replace;
    }
  ...
  _alertCompletionItem({ completion: suggestion }) {
    const textLabel = typeof suggestion.label === "string"
      ? suggestion.label
      ...
      this.model.onDidSuggest(
        ({ completionModel }) => {
          ...
          this._insertSuggestion(
            ...
            4 /* KeepAlternativeSuggestions */ | 1 /* NoBeforeUndoStop */ |
              2, /* NoAfterUndoStop */
          );
        },
        undefined,
  ...
  new SuggestCommand({
    ...
    kbOpts: {
      ...
      mac: {
        primary: 18, /* DownArrow */
        secondary: [
          2048 /* CtrlCmd */ | 18, /* DownArrow */
          256 /* WinCtrl */ | 44, /* KEY_N */
        ],
      },
    },
  }),
  ...
  new SuggestCommand({
    ...
    kbOpts: {
      ...
      mac: {
        primary: 16, /* UpArrow */
        secondary: [
          2048 /* CtrlCmd */ | 16, /* UpArrow */
          256 /* WinCtrl */ | 46, /* KEY_P */
        ],
      },
    },
  }),
  ...
  new SuggestCommand({
    ...
    handler: (x, arg) => {
      x.triggerSuggestAndAcceptBest(
        isObject(arg)
          ? Object.assign({ fallback: "tab" }, arg)
          : { fallback: "tab" },
      );
    },
    kbOpts: {
