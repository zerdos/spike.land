...
class RenameSkeleton {
  ...
  resolveRenameLocation(token) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      for (
        ...
        let res = yield provider.resolveRenameLocation(
          this.model,
          this.position,
          token,
        );
  ...
  _provideRenameEdits(newName, i, rejects, token) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const result = yield provider.provideRenameEdits(
        this.model,
        this.position,
        newName,
        token,
  ...
  run() {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (
        ...
        selectionEnd = Math.min(loc.range.endColumn, selection.endColumn) -
