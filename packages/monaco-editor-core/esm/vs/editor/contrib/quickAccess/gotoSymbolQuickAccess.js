...
import { OutlineElement, OutlineModel } from "../documentSymbols/outlineModel";
import { format, trim } from "../../../base/common/strings";
import {
  pieceToQuery,
  prepareQuery,
  scoreFuzzy2,
} from "../../../base/common/fuzzyScorer";
import { Iterable } from "../../../base/common/iterator";
import { Codicon } from "../../../base/common/codicons";
export class AbstractGotoSymbolQuickAccessProvider
  extends AbstractEditorNavigationQuickAccessProvider {
  ...
  doProvideWithoutEditorSymbols(context, model, picker, token) {
    ...
    (() =>
      __awaiter(this, void 0, void 0, function* () {
        const result = yield this.waitForLanguageSymbolRegistry(
          model,
          disposables,
        );
  ...
  waitForLanguageSymbolRegistry(model, disposables) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const symbolProviderRegistryPromise = new Promise((resolve) =>
        symbolProviderRegistryPromiseResolve = resolve
      );
      ...
      disposables.add(
        toDisposable(() => symbolProviderRegistryPromiseResolve(false)),
      );
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      for (let index = 0; index < symbols.length; index++) {
        ...
        const symbolLabelWithIcon =
          `$(symbol-${SymbolKinds.toString(symbol.kind) ||
            "property"}) ${symbolLabel}`;
        const symbolLabelIconOffset = symbolLabelWithIcon.length -
          symbolLabel.length;
        ...
        if (
          ...
          if (containerLabel) {
            containerLabel =
              `${options.extraContainerLabel} • ${containerLabel}`;
          } else {
        ...
        const deprecated = symbol.tags &&
          symbol.tags.indexOf(1 /* Deprecated */) >= 0;
      ...
      if (filterBySymbolKind) {
        ...
        function updateLastSeparatorLabel() {
          if (
            lastSeparator && typeof lastSymbolKind === "number" &&
  ...
  compareByScore(symbolA, symbolB) {
    if (
      typeof symbolA.score !== "number" && typeof symbolB.score === "number"
    ) {
      return 1;
    } else if (
      typeof symbolA.score === "number" && typeof symbolB.score !== "number"
  ...
  compareByKindAndScore(symbolA, symbolB) {
    const kindA = NLS_SYMBOL_KIND_CACHE[symbolA.kind] ||
      FALLBACK_NLS_SYMBOL_KIND;
    const kindB = NLS_SYMBOL_KIND_CACHE[symbolB.kind] ||
      FALLBACK_NLS_SYMBOL_KIND;
  ...
  getDocumentSymbols(document, flatten, token) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      return flatEntries.sort((symbolA, symbolB) =>
...
AbstractGotoSymbolQuickAccessProvider.SCOPE_PREFIX = ":";
AbstractGotoSymbolQuickAccessProvider.PREFIX_BY_CATEGORY =
  `${AbstractGotoSymbolQuickAccessProvider.PREFIX}${AbstractGotoSymbolQuickAccessProvider.SCOPE_PREFIX}`;
// #region NLS Helpers
