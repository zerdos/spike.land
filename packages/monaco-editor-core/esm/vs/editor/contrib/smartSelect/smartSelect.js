    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (!this._state) {
        yield provideSelectionRanges(
          ...
          this._editor.getOption(97 /* smartSelect */),
  ...
  constructor() {
    super(true, {
      ...
      kbOpts: {
        ...
        mac: {
          primary: 2048 /* CtrlCmd */ | 256 /* WinCtrl */ | 1024 /* Shift */ |
            17, /* RightArrow */
          secondary: [
            256 /* WinCtrl */ | 1024 /* Shift */ | 17, /* RightArrow */
          ],
        },
      ...
      kbOpts: {
        ...
        mac: {
          primary: 2048 /* CtrlCmd */ | 256 /* WinCtrl */ | 1024 /* Shift */ |
            15, /* LeftArrow */
          secondary: [
            256 /* WinCtrl */ | 1024 /* Shift */ | 15, /* LeftArrow */
          ],
        },
        weight: 100, /* EditorContrib */
      },
      ...
      for (let i = 1; i < oneRanges.length; i++) {
        ...
        if (
          ...
          if (
            ...
            cur.containsRange(rangeFull) && !cur.equalsRange(rangeFull)
          ) {
