...
import { renderCodicons } from "../../../base/browser/codicons";
...
export class CodeLensHelper {
  ...
  commit(changeAccessor) {
    let resultingDecorations = changeAccessor.deltaDecorations(
      this._removeDecorations,
      this._addDecorations,
    );
...
registerThemingParticipant((theme, collector) => {
  ...
  if (codeLensForeground) {
    ...
    collector.addRule(
      `.monaco-editor .codelens-decoration .codicon { color: ${codeLensForeground}; }`,
    );
  }
