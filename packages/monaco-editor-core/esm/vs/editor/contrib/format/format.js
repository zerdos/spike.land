...
export function getRealAndSyntheticDocumentFormattersOrdered(model) {
  ...
  const rangeFormatter = DocumentRangeFormattingEditProviderRegistry.ordered(
    model,
  );
...
export function formatDocumentRangesWithProvider(
  ...
  return __awaiter(this, void 0, void 0, function* () {
    ...
    let len = 0;
    for (
      let range of asArray(rangeOrRanges).sort(Range.compareRangesUsingStarts)
    ) {
    ...
    for (let range of ranges) {
      try {
        ...
        const minEdits = yield workerService.computeMoreMinimalEdits(
          model.uri,
          rawEdits,
        );
        if (minEdits) {
...
export function formatDocumentWithSelectedProvider(
  accessor,
  editorOrModel,
  mode,
  progress,
...
export function formatDocumentWithProvider(
  accessor,
  provider,
  editorOrModel,
  mode,
...
export function getDocumentRangeFormattingEditsUntilResult(
  ...
  return __awaiter(this, void 0, void 0, function* () {
    const providers = DocumentRangeFormattingEditProviderRegistry.ordered(
      model,
    );
