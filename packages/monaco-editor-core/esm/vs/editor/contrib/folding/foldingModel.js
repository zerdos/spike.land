...
export class FoldingModel {
  ...
  toggleCollapseState(toggledRegions) {
    ...
    toggledRegions = toggledRegions.sort((r1, r2) =>
      r1.regionIndex - r2.regionIndex
    );
    const processed = {};
    ...
    this._updateEventEmitter.fire(
      { model: this, collapseStateChanged: toggledRegions },
    );
  }
...
export function setCollapseStateAtLevel(
  ...
  let filter = (region, level) =>
    level === foldLevel && region.isCollapsed !== doCollapse &&
