...
let LightBulbWidget = class LightBulbWidget extends Disposable {
  constructor(
    ...
    this._register(this._editor.onDidChangeModelContent((_) => {
      ...
      if (
        this.state.type !== 1 /* Showing */ || !editorModel ||
    ...
    this._register(this._editor.onDidChangeConfiguration((e) => {
      ...
      if (
        e.hasChanged(51 /* lightbulb */) &&
        !this._editor.getOption(51 /* lightbulb */).enabled
      ) {
        this.hide();
      }
    }));
  ...
  _updateLightBulbTitleAndIcon() {
    if (this.state.type === 1 /* Showing */ && this.state.actions.hasAutoFix) {
      ...
      const preferredKb = this._keybindingService.lookupKeybinding(
...
registerThemingParticipant((theme, collector) => {
  ...
  const editorBackgroundColor =
    (_a = theme.getColor(editorBackground)) === null || _a === void 0
      ? void 0
      : _a.transparent(0.7);
  // Lightbulb Icon
  const editorLightBulbForegroundColor = theme.getColor(
    editorLightBulbForeground,
  );
  ...
  const editorLightBulbAutoFixForegroundColor = theme.getColor(
    editorLightBulbAutoFixForeground,
  );
