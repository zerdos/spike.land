...
class SymbolNavigationAction extends EditorAction {
  ...
  run(accessor, editor) {
    ...
    const promise = raceCancellation(
      this._getLocationModel(model, pos, cts.token),
      cts.token,
    ).then((references) =>
  ...
  _onResult(editorService, symbolNavService, editor, model) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (
        ...
        const peek = model.references.length > 1 &&
          gotoLocation === "gotoAndPeek";
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (highlight) {
        ...
        const ids = targetEditor.deltaDecorations(
          [],
          [{ range, options: { className: "symbolHighlight" } }],
        );
        setTimeout(() => {
...
class DeclarationAction extends SymbolNavigationAction {
  ...
  _getAlternativeCommand(editor) {
    return editor.getOption(45 /* gotoLocation */)
...
class GenericGoToLocationAction extends SymbolNavigationAction {
  ...
  _getGoToPreference(editor) {
    ...
    return (_a = this._gotoMultipleBehaviour) !== null && _a !== void 0
      ? _a
      : editor.getOption(45 /* gotoLocation */).multipleReferences;
  }
    ...
    __awaiter(void 0, void 0, void 0, function* () {
      ...
      if (isCodeEditor(editor)) {
        ...
        return editor.invokeWithinContext((accessor) => {
          ...
          accessor.get(IInstantiationService).invokeFunction(
