...
export class FilePreview {
  ...
  preview(range, n = 8) {
    ...
    const word = model.getWordUntilPosition(
      { lineNumber: startLineNumber, column: startColumn - n },
    );
  ...
  resolve(textModelResolverService) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      for (let child of this.children) {
        ...
        try {
          const ref = yield textModelResolverService.createModelReference(
            child.uri,
          );
...
export class ReferencesModel {
  ...
  nextOrPreviousReference(reference, next) {
    ...
    if (next) {
      ...
      return parent.parent.groups[idx]
        .children[parent.parent.groups[idx].children.length - 1];
    }
  }
