...
} from "../model/wordHelper";
import { AutoClosingPairs, IndentAction } from "./languageConfiguration";
...
export class RichEditSupport {
  ...
  static _mergeConf(prev, current) {
    return {
      ...
      autoCloseBefore: (prev
        ? current.autoCloseBefore || prev.autoCloseBefore
        : current.autoCloseBefore),
