...
export class ViewLayout extends Disposable {
  ...
  _configureSmoothScrollDuration() {
    this._scrollable.setSmoothScrollDuration(
      this._configuration.options.get(98 /* smoothScrolling */)
  ...
  _getContentHeight(width, height, contentWidth) {
    ...
    if (options.get(89 /* scrollBeyondLastLine */)) {
      result += height - options.get(53 /* lineHeight */);
    } else {
  ...
  _computeContentWidth(maxLineWidth) {
    ...
    if (wrappingInfo.isViewportWrapping) {
      ...
      const extraHorizontalSpace =
        options.get(88 /* scrollBeyondLastColumn */) *
  ...
  saveState() {
    ...
    let firstLineNumberInViewport = this._linesLayout
      .getLineNumberAtOrAfterVerticalOffset(scrollTop);
    let whitespaceAboveFirstLine = this._linesLayout
