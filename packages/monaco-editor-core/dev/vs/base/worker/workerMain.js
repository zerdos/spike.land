    ...
    var NodeScriptLoader = /** @class */ (function () {
      ...
      NodeScriptLoader.prototype._getCachedDataPath = function (
        ...
        var hash = this._crypto.createHash("md5").update(filename, "utf8")
          .update(config.seed, "utf8").digest("hex");
 ...
 *--------------------------------------------------------------------------------------------*/
  define(
    __m[14/*vs/base/common/diff/diffChange*/
    ],
    __M([0, /*require*/ 1 /*exports*/]),
    function (require, exports) {
      "use strict";
 ...
 *--------------------------------------------------------------------------------------------*/
  define(
    __m[16/*vs/base/common/keyCodes*/
    ],
  ...
  define(
    ...
    __M([0, /*require*/ 1, /*exports*/ 15 /*vs/base/common/iterator*/]),
 ...
 *--------------------------------------------------------------------------------------------*/
  define(
    __m[17/*vs/base/common/linkedList*/
    ],
    __M([0, /*require*/ 1 /*exports*/]),
    function (require, exports) {
      "use strict";
      ...
      (function (Event) {
        ...
        function fromNodeEventEmitter(emitter, eventName, map = (id) => id) {
          ...
          const result = new Emitter(
            { onFirstListenerAdd, onLastListenerRemove },
          );
          return result.event;
        }
 ...
 *--------------------------------------------------------------------------------------------*/
  define(
    __m[18/*vs/base/common/cancellation*/
    ],
    __M([0, /*require*/ 1, /*exports*/ 8 /*vs/base/common/event*/]),
      ...
      exports.isLittleEndian = exports.OS = exports.setImmediate = exports
        .globals = exports.userAgent = exports.isIOS = exports.isWeb = exports
          .isNative = exports.isLinux = exports.isMacintosh = exports
            .isWindows = exports.isElectronSandboxed = void 0;
 ...
 *--------------------------------------------------------------------------------------------*/
  define(
    __m[21/*vs/base/common/stopwatch*/
    ],
    __M([0, /*require*/ 1, /*exports*/ 2 /*vs/base/common/platform*/]),
    function (require, exports, platform_1) {
      "use strict";
  ...
  define(
     ...
     */
      function isEmojiImprecise(x) {
        return ((x >= 0x1F1E6 && x <= 0x1F1FF) || (x >= 9728 && x <= 10175) ||
          (x >= 127744 && x <= 128591) ||
          (x >= 128640 && x <= 128764) || (x >= 128992 && x <= 129003) ||
          (x >= 129280 && x <= 129535) ||
          (x >= 129648 && x <= 129651) || (x >= 129656 && x <= 129666) ||
          (x >= 129680 && x <= 129685));
      }
 ...
 *--------------------------------------------------------------------------------------------*/
  define(
    __m[9/*vs/base/common/diff/diff*/
    ],
    __M(
      [
        0, /*require*/
 ...
 *--------------------------------------------------------------------------------------------*/
  define(
    ...
    __M([0, /*require*/ 1, /*exports*/ 11 /*vs/base/common/uint*/]),
