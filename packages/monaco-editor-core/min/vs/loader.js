...
!function (e) {
      ...
      return r.validateConfigurationOptions = function (r) {
        if (
          "string" != typeof (r = r || {}).baseUrl && (r.baseUrl = ""),
            ...
            r.nodeCachedData && "object" == typeof r.nodeCachedData &&
    ...
    var n = function () {
      ...
      return t.prototype._createIgnoreDuplicateModulesMap = function () {
        ...
        for (var e = 0; e < this.options.ignoreDuplicateModules.length; e++) {
          this
            .ignoreDuplicateModulesMap[this.options.ignoreDuplicateModules[e]] =
              !0;
        }
      },
        ...
        t.prototype.moduleIdToPaths = function (t) {
          ...
          var r, n = t;
          if (
            e.Utilities.endsWith(n, ".js") || e.Utilities.isAbsolutePath(n)
          ) {
            e.Utilities.endsWith(n, ".js") ||
            e.Utilities.containsQueryString(n) || (n += ".js"), r = [n];
          } else {
        ...
        return e.prototype.load = function (e, t, i, s) {
          ...
          if (!this._scriptLoader) {
            if (this._env.isWebWorker) this._scriptLoader = new n();
              ...
              var a = e.getConfig().getOptionsLiteral().preferScriptTags;
              this._scriptLoader = a ? new r() : new o(this._env);
            } else {
              this._env.isNode
          ...
          t.prototype.load = function (t, r, n, o) {
            if (/^node\|/.test(r)) {
              var s = t.getConfig().getOptionsLiteral(),
                d = i(t.getRecorder(), s.nodeRequire || e.global.nodeRequire),
                a = r.split("|"),
                u = null;
              try {
                u = d(a[1]);
        ...
        return t.prototype._init = function (e) {
          ...
          t.prototype._initNodeRequire = function (e, t) {
            ...
            if (r && !this._didPatchNodeRequire) {
              ...
              o.prototype._compile = function (e, i) {
                ...
                return n._handleCachedData(h, d, u, !l.cachedData, t),
                  n._verifyCachedData(h, d, u, s, t),
                  v;
              };
            }
          },
          t.prototype.load = function (r, n, o, s) {
            var d = this,
              ...
              u = i(r.getRecorder(), a.nodeRequire || e.global.nodeRequire),
            ...
            var c = r.getRecorder();
            if (/^node\|/.test(n)) {
              var h = n.split("|"), f = null;
              try {
                f = u(h[1]);
              } catch (e) {
                return void s(e);
              }
              r.enqueueDefineAnonymousModule(
                [],
                (function () {
                  return f;
                }),
              ...
              var p = this._path.normalize(n),
                ...
                g = Boolean(a.nodeCachedData),
                v = g ? this._getCachedDataPath(a.nodeCachedData, n) : void 0;
                ...
                (function (e, n, i, a) {
                  if (e) s(e);
                    ...
                    u = n.charCodeAt(0) === t._BOM
                      ...
                      : t._PREFIX + n + t._SUFFIX, u = l(u, p);
                    var c = { filename: _, cachedData: i },
                      h = d._createAndEvalScript(r, u, c, o, s);
                    d._handleCachedData(h, u, v, g && !i, r),
                      d._verifyCachedData(h, u, v, a, r);
                  }
                }),
              );
            }
            ...
            n && (e.cachedDataRejected || setTimeout(
              (function () {
                ...
                n.equals(e) ||
                  (o.getConfig().onError(
                    new Error(
                      "FAILED TO VERIFY CACHED DATA, deleting stale '" + r +
      ...
      return s.prototype.reset = function () {
          ...
          for (
            ...
            if (o) {
              ...
              e[t++] = {
                id: o.strId,
                path: i,
                defineLocation: i && d ? s._findRelevantLocationInStack(i, d)
                : null,
                dependencies: a,
                shim: null,
                exports: o.exports,
        ...
        s.prototype._createLoadError = function (t, r) {
          var n = this,
            ...
            i = (this._inverseDependencies2[t] || []).map(
              (function (e) {
  ...
  function (e) {
    ...
    function s() {
      ...
      t.isNode && !t.isElectronRenderer ? (module.exports = i, require = i)
    ...
    i.config = o,
      ...
      (r = new e.ModuleManager(
        ...
        void 0 !== e.global.require && "function" != typeof e.global.require &&
