      ...
      switch (_c.label) {
        ...
        case 1:
          files = [
            ...
            [
              "tsconfig.json",
              JSON.stringify(getTSConfig(dtName), undefined, 4) + "\n",
            ],
    ...
    return __generator(this, function (_c) {
      switch (_c.label) {
        ...
        case 1:
          ...
          return [
            4, /*yield*/
            loadString("http://registry.npmjs.org/" + packageName),
          ];
        case 2:
        ...
        case 3:
          e_1 = _c.sent();
          console.warn(
            "Warning: Could not retrieve version/homepage information: " +
              e_1.message,
          );
          return [3, /*break*/ 4];
        case 4:
          authorName = "My Self";
          try {
            globalGitConfig = parseGitConfig.sync(
              { cwd: os_1.homedir(), path: ".gitconfig" },
            );
            ...
            console.warn(
              "Warning: Could not retrieve author name: " + e.message,
            );
          }
          authorUserName = "me";
          try {
            repoGitConfig = parseGitConfig.sync(
              { path: path_1.join(".git", "config") },
            );
            if (
              repoGitConfig['remote "origin"'] &&
              repoGitConfig['remote "origin"'].url
            ) {
            ...
            console.warn(
              "Warning: Could not retrieve author's user name: " + e.message,
            );
          }
          ...
          return [
            2, /*return*/
            "// Type definitions for " + packageName + " " + version +
            "\n// Project: " + project + "\n// Definitions by: " + authorName +
            " <" + authorUrl +
        ...
        return reject(
          new Error(
            "HTTP Error " + res.statusCode + ": " +
              http_1.STATUS_CODES[res.statusCode || 500] + " for " + url,
          ),
        );
      }
      var rawData = "";
