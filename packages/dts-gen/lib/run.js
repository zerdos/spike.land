...
try {
    ...
    if (+!!args.identifier + +!!args.expression + +!!args.module +
    ...
    if (args.module) {
        ...
        result = guess.generateIdentifierDeclarationFile(name_1, eval(args.expression));
    }
        ...
        name_1 = path.basename(filename, path.extname(filename)).replace(/[^A-Za-z0-9]/g, "_");
        module.paths.unshift(process.cwd() + "/node_modules");
