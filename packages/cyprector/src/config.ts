...
export const EXECUTION_DRIVER = process.env.EXECUTION_DRIVER ||
  "../execution/in-memory";

export const SCREENSHOTS_DRIVER = process.env.SCREENSHOTS_DRIVER ||
...
export const MONGODB_AUTH_MECHANISM = process.env.MONGODB_AUTH_MECHANISM ||
  undefined;
