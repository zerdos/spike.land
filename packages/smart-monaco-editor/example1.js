...
const startMonaco = async ({ onChange , code , language  })=>{
    ...
    if (window["monaco"] === undefined) {
        ...
        setTimeout( async() => {
           ...
           return await new Promise((resolve)=>require([
...
startMonaco.bind(globalThis);
startMonaco({language: "typescript", onChange: (c)=>console.log(c), code: `import React, { FC, useState } from "react";
