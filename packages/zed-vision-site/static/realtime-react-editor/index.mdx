...
[Real time React page editor, in typescript! ![Screenshot](./realtime-react-editor/screenshot-2020-12-02.png)](https://code.zed.vision)
...
## Built with
- Monaco editor
- Ace9 editor - as a replacement view in mobile devices
- typescript
- React
- Emotion.js
- Jsframe.js
