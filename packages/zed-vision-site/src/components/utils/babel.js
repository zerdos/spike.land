    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [2 /*return*/];
            case 2: return [4 /*yield*/, sha_ts_1.hash(message.data.translatedCode)];
            case 3:
...
var transform = function (codeHash) { return __awaiter(void 0, void 0, void 0, function () {
    var code, returnPromise_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, sha_ts_1.unHash(codeHash)];
            case 1:
                code = _a.sent();
                if (typeof cache[codeHash] === "string")
                ...
                if (typeof cache[codeHash] === "undefined") {
                    ...
                    returnPromise_1 = new Promise(function (resolve, reject) {
                        cache[codeHash] = { resolve: resolve, reject: reject, promise: returnPromise_1 };
                    });
