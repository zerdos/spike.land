(this["webpackJsonp"] = this["webpackJsonp"] || []).push([[2], {
  /***/ 227:
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
      ...
      /* harmony import */ var framesync__WEBPACK_IMPORTED_MODULE_1__ =
   ...
   */
     ...
     */
            ...
            this.updateAndNotify = function (v, render) {
              ...
              var _a = Object(
                  framesync__WEBPACK_IMPORTED_MODULE_1__/* getFrameData */ [
                    "c"
                  ],
                )(),
                delta = _a.delta,
 ...
 */
      ...
      var easingLookup = {
        ...
        anticipate:
          popmotion__WEBPACK_IMPORTED_MODULE_2__/* anticipate */ ["b"],
      ...
      var isAnimatable = function isAnimatable(key, value) {
        ...
        if (
          ...
          style_value_types__WEBPACK_IMPORTED_MODULE_4__/* complex */ ["c"]
            .test(value) && // And it contains numbers and/or colors
 ...
 */
      ...
      function getDelayFromTransition(transition, key) {
        ...
        return (_e =
                (_d = (_b = (_a = transition[key]) === null || _a === void 0
                            ? void 0
                            : _a.delay) !== null && _b !== void 0
                      ? _b
   ...
   */
        ...
        Object(hey_listen__WEBPACK_IMPORTED_MODULE_3__/* warning */ ["b"])(
          ...
          "You are trying to animate " + key + ' from "' + origin + '" to "' +
            ...
            origin + " to a value animatable to " + target +
              ...
              Object(tslib__WEBPACK_IMPORTED_MODULE_0__/* __assign */ ["a"])(
                ...
                ),
                {
                  ...
                  onComplete: function onComplete() {
                    ...
                    options.onComplete();
                    (_a = valueTransition.onComplete) === null || _a === void 0
                      ? void 0
        ...
        function set() {
          ...
          value.set(target);
          onComplete();
          (_a = valueTransition === null || valueTransition === void 0
                ? void 0
 ...
 */
      ...
      var resolveFinalValueInKeyframes = function resolveFinalValueInKeyframes(
        v,
      ) {
 ...
 */
      ...
      function setTarget(visualElement, definition, _a) {
        ...
        var _b = visualElement.makeTargetAnimatable(
      ...
      function checkTargetForNewValues(visualElement, target, origin) {
        ...
        for (var i = 0; i < numNewValues; i++) {
          ...
          if (value === null) {
            var readValue = (_a = origin[key]) !== null && _a !== void 0
              ? _a
          ...
          visualElement.addValue(key, motionValue(value));
          (_b = (_c = origin)[key]) !== null && _b !== void 0
            ? _b
            : _c[key] = value;
      ...
      function getOriginFromTransition(key, transition) {
        ...
        var valueTransition = transition[key] || transition["default"] ||
          transition;
 ...
 */
          ...
          ((_a = visualElement.variantChildrenOrder) === null || _a === void 0
            ...
            ? function (forwardDelay) {
              ...
              return animateChildren(
                ...
                priority,
                opts === null || opts === void 0 ? void 0 : opts.custom,
              );
            }
            : function () {
              return Promise.resolve();
   ...
   */
      ...
      function animateChildren(
        ...
        var animations = [];
        var maxStaggerDuration = (visualElement.variantChildrenOrder.size - 1) *
          staggerChildren;
        ...
        Array.from(visualElement.variantChildrenOrder).forEach(
          function (child, i) {
      ...
      function animateTarget(visualElement, definition, _a) {
        ...
        var targetAndTransition = resolveVariant(
          visualElement,
          definition,
          custom,
        );
 ...
 */
     ...
     */
          ...
          VisualElement.prototype.getVariant = function (label) {
            ...
            return (_a = this.config.variants) === null || _a === void 0
              ? void 0
              : _a[label];
          };
          ...
          VisualElement.prototype.addVariantChildOrder = function (
            visualElement,
          ) {
          ...
          VisualElement.prototype.onAnimationStart = function () {
            ...
            (_b = (_a = this.config).onAnimationStart) === null || _b === void 0
              ? void 0
              : _b.call(_a);
          };
          ...
          VisualElement.prototype.onAnimationComplete = function () {
            ...
            this.isMounted &&
              ((_b = (_a = this.config).onAnimationComplete) === null ||
                  _b === void 0
                ? void 0
                : _b.call(_a));
          };
          ...
          VisualElement.prototype.resetIsAnimating = function (priority) {
            ...
            (_a = this.variantChildren) === null || _a === void 0
              ? void 0
              : _a.forEach(function (child) {
          ...
          VisualElement.prototype.checkOverrideIsAnimating = function (
            priority,
          ) {
          ...
          VisualElement.prototype.subscribeToValue = function (key, value) {
            ...
            var onChange = function onChange(latest) {
              ...
              _this.element && _this.config.onUpdate &&
                framesync__WEBPACK_IMPORTED_MODULE_1__/* default */ ["b"]
                  .update(_this.update, false, true);
            };
 ...
 */
   ...
   */
        ...
        return "translate3d(" + xTranslate + "px, " + yTranslate +
          "px, 0) scale(" + x.scale + ", " + y.scale + ")";
      }
 ...
 */
   ...
   */
        ...
        var shadow =
          style_value_types__WEBPACK_IMPORTED_MODULE_4__/* complex */ ["c"]
            .parse(latest); // TODO: Doesn't support multiple shadows
   ...
   */
        ...
        if (typeof shadow[2 + offset] === "number") {
          shadow[2 + offset] /= averageScale; // Spread
        }
   ...
   */
        ...
        for (var key in latest) {
          ...
          if (isTransformProp(key)) {
            ...
            var defaultValue = valueType.default !== undefined
              ? valueType.default
              : 0;
            ...
            if (isLayoutProjectionEnabled && valueScaleCorrection[key]) {
              var corrected = valueScaleCorrection[key].process(
                value,
                targetBox,
                delta,
                treeScale,
 ...
 */
      ...
      function applyAxisTransforms(final, axis, transforms, _a) {
        ...
        final.min = axis.min;
        final.max = axis.max;
        var axisOrigin = transforms[originKey] !== undefined
 ...
 */
      ...
      function updateAxisDelta(delta, source, target, origin) {
        delta.origin = origin === undefined
          ? calcOrigin(source, target)
          : origin;
 ...
 */
      ...
      var convertChangedValueTypes = function convertChangedValueTypes(
        target,
        visualElement,
        changedKeys,
      ) {
      ...
      var checkAndConvertChangedValueTypes =
        function checkAndConvertChangedValueTypes(
          visualElement,
          target,
          origin,
          transitionEnd,
          ...
          var targetPositionalKeys = Object.keys(target).filter(
            isPositionalKey,
          ...
          targetPositionalKeys.forEach(function (key) {
            ...
            if (isKeyframesTarget(to)) {
              ...
              for (var i = to[0] === null ? 1 : 0; i < numKeyframes; i++) {
                if (!toType) {
                  ...
                  Object(
                    hey_listen__WEBPACK_IMPORTED_MODULE_3__/* invariant */ [
                      "a"
                    ],
                  )(
                    toType === fromType ||
            ...
            if (fromType !== toType) {
              ...
              if (isNumOrPxType(fromType) && isNumOrPxType(toType)) {
                ...
                transitionEnd[key] = transitionEnd[key] !== undefined
                  ? transitionEnd[key]
                  : target[key];
 ...
 */
      ...
      var parseDomVariant = function parseDomVariant(
        visualElement,
        target,
        origin,
        transitionEnd,
 ...
 */
     ...
     */
            ...
            _this.updateLayoutDelta = function () {
              _this.isLayoutProjectionEnabled && _this.box &&
                _this.updateLayoutDeltas();
              /**
   ...
   */
          ...
          HTMLVisualElement.prototype.makeTargetAnimatable = function (
            _a,
            parseDOMValues,
          ) {
   ...
   */
          ...
          HTMLVisualElement.prototype.onViewportBoxUpdate = function (
            callback,
          ) {
   ...
   */
          ...
          HTMLVisualElement.prototype.getBoundingBoxWithoutTransforms =
            function () {
     ...
     */
          ...
          HTMLVisualElement.prototype.rebaseTargetBox = function (force, box) {
            ...
            var _a = this.axisProgress,
              x = _a.x,
              y = _a.y;
            var shouldRebase = this.box && !this.isTargetBoxLocked &&
   ...
   */
          ...
          HTMLVisualElement.prototype.resetTransform = function () {
            ...
            this.element.style.transform = transformTemplate
              ? transformTemplate({}, "")
              : "none"; // Ensure that whatever happens next, we restore our transform
   ...
   */
          ...
          HTMLVisualElement.prototype.setAxisTarget = function (
            axis,
            min,
            max,
          ) {
   ...
   */
          ...
          HTMLVisualElement.prototype.startLayoutAxisAnimation = function (
            axis,
            transition,
          ) {
            var _this = this;
   ...
   */
     ...
     */
            ...
            if (
              deltaTransform !== this.deltaTransform || // Also compare calculated treeScale, for values that rely on only this for scale correction.
              this.prevTreeScale.x !== this.treeScale.x ||
              this.prevTreeScale.y !== this.treeScale.y
            ) {
              this.scheduleRender();
 ...
 */
      ...
      var PresenceContext = Object(
        react__WEBPACK_IMPORTED_MODULE_5__["createContext"],
      )(null);
      var MotionContext = Object(
        react__WEBPACK_IMPORTED_MODULE_5__["createContext"],
      )({
        variantContext: {},
      });
      ...
      function useVariantContext() {
        return Object(react__WEBPACK_IMPORTED_MODULE_5__["useContext"])(
          MotionContext,
        ).variantContext;
      }
 ...
 */
      ...
      var useDomVisualElement = function useDomVisualElement(
        Component,
        props,
        isStatic,
        ref,
   ...
   */
        ...
        var isPresent = presenceContext === null
          ? true
          : presenceContext.isPresent;
        visualElement.isPresent = props.isPresent !== undefined
          ? props.isPresent
          : isPresent;
        /**
   *
   */
        ...
        var presenceId = presenceContext === null || presenceContext === void 0
          ? void 0
          : presenceContext.id;
        visualElement.isPresenceRoot = !parent ||
          parent.presenceId !== presenceId;
        /**
 ...
 */
      ...
      try {
        var emotionIsPropValid_1 = __webpack_require__(229).default;
      ...
      function buildHTMLProps(visualElement, _a) {
        ...
        if (!!drag) {
          ...
          htmlProps.style.touchAction = drag === true
            ? "none"
            : "pan-" + (drag === "x" ? "y" : "x");
        }
 ...
 */
      ...
      function render(Component, props, visualElement) {
        ...
        var forwardedProps = typeof Component === "string"
          ? filterProps(props)
          : props;
        /**
 ...
 */
   ...
   */
        ...
        for (var key in prev) {
          ...
          var styleIsMotionValue = existsAsStyle &&
            isMotionValue(props.style[key]);
          var transformRemoved = isForced && !existsAsProp && !existsAsStyle;
          var motionValueRemoved = !isForced && !propIsMotionValue &&
            !styleIsMotionValue;
   ...
   */
        ...
        if (props.transformValues) {
          visualElement.reactStyle = props.transformValues(
            visualElement.reactStyle,
          );
        }
      }
 ...
 */
      ...
      var MotionConfigContext = Object(
        react__WEBPACK_IMPORTED_MODULE_5__["createContext"],
      )({
 ...
 */
      ...
      function useFeatures(defaultFeatures, isStatic, visualElement, props) {
        var plugins = Object(react__WEBPACK_IMPORTED_MODULE_5__["useContext"])(
          MotionConfigContext,
 ...
 */
     ...
     */
      ...
      var SharedLayoutContext = Object(
        react__WEBPACK_IMPORTED_MODULE_5__["createContext"],
      )(createBatcher());
      var isBrowser = typeof window !== "undefined";
      var useIsomorphicLayoutEffect = isBrowser
        ? react__WEBPACK_IMPORTED_MODULE_5__["useLayoutEffect"]
        : react__WEBPACK_IMPORTED_MODULE_5__["useEffect"];

      function useSnapshotOnUnmount(visualElement) {
        var syncLayout = Object(
          react__WEBPACK_IMPORTED_MODULE_5__["useContext"],
        )(SharedLayoutContext);
 ...
 */
      ...
      function usePresence() {
        var context = Object(react__WEBPACK_IMPORTED_MODULE_5__["useContext"])(
          PresenceContext,
        );
 ...
 */
      ...
      function useInitialOrEveryRender(callback, isInitialOnly) {
        ...
        var isInitialRender = Object(
          react__WEBPACK_IMPORTED_MODULE_5__["useRef"],
        )(true);
 ...
 */
   ...
   */
        ...
        var controlsVariants = isVariantLabel$1(animate) ||
          isVariantLabel$1(whileTap) || isVariantLabel$1(whileHover) ||
   ...
   */
        ...
        initial = (_b = presenceContext === null || presenceContext === void 0
                ? void 0
                : presenceContext.initial) !== null && _b !== void 0
          ? _b
          : initial;
        /**
   ...
   */
        ...
        var context = Object(react__WEBPACK_IMPORTED_MODULE_5__["useMemo"])(
          function () {
            return {
              parent: isVariantNode
                ? visualElement
                : parent,
   ...
   */
        ...
        isVariantNode && !controlsVariants &&
          (parent === null || parent === void 0
            ? void 0
            : parent.addVariantChild(visualElement));
        /**
   ...
   */
        ...
        isPresent(presenceContext) &&
          ((_c = visualElement.variantChildrenOrder) === null || _c === void 0
            ? void 0
            : _c.clear());
        /**
   ...
   */
        ...
        Object(react__WEBPACK_IMPORTED_MODULE_5__["useEffect"])(function () {
          isVariantNode && (parent === null || parent === void 0
            ? void 0
            : parent.addVariantChildOrder(visualElement));
        });
        /**
   ...
   */
        ...
        Object(react__WEBPACK_IMPORTED_MODULE_5__["useEffect"])(function () {
          ...
          return function () {
            ...
            (_a = parent === null || parent === void 0
                  ? void 0
                  : parent.variantChildren) === null || _a === void 0
              ? void 0
              : _a.delete(visualElement);
          };
        }, []);
        /**
 ...
 */
     ...
     */
          ...
          var visualElement = useVisualElement(
            Component,
            props,
            isStatic,
            externalRef,
     ...
     */
        ...
        return Object(react__WEBPACK_IMPORTED_MODULE_5__["forwardRef"])(
          MotionComponent,
        );
      }
 ...
 */
      ...
      var wrapHandler = function wrapHandler(
        handler,
        shouldFilterPrimaryPointer,
      ) {
      ...
      var PanSession =
        ...
        function () {
          function PanSession(event, handlers, _a) {
            ...
            var transformPagePoint = (_a === void 0
              ? {}
              : _a).transformPagePoint;
            /**
     * @internal
     */
     ...
     */
            ...
            this.handlePointerUp = function (event, info) {
              ...
              var panInfo = getPanInfo(
                transformPoint(info, _this.transformPagePoint),
                _this.history,
              );
 ...
 */
         ...
         */
            ...
            var onMove = function onMove(event, info) {
              ...
              (_d = (_c = _this.props).onDrag) === null || _d === void 0
                ? void 0
                : _d.call(_c, event, info); // Update the last pointer event
   ...
   */
     ...
     */
            ...
            (prevSnapshot === null || prevSnapshot === void 0
              ? void 0
              : prevSnapshot.isDragging) && this.start(lastPointerEvent, {
 ...
 */
      ...
      function useUnmountEffect(callback) {
        return Object(react__WEBPACK_IMPORTED_MODULE_5__["useEffect"])(
          function () {
            return function () {
              return callback();
            };
 ...
 */
      ...
      function usePanGesture(_a, ref) {
        ...
        var panSession = Object(react__WEBPACK_IMPORTED_MODULE_5__["useRef"])(
          null,
        );
        var transformPagePoint =
          Object(react__WEBPACK_IMPORTED_MODULE_5__["useContext"])(
 ...
 */
      ...
      function useTapGesture(_a, visualElement) {
        ...
        var isTapping = Object(react__WEBPACK_IMPORTED_MODULE_5__["useRef"])(
          false,
        );
        var cancelPointerEventListener = Object(
          react__WEBPACK_IMPORTED_MODULE_5__["useRef"],
        )(null);
        ...
        function removePointerUp() {
          ...
          (_a = cancelPointerEventListener.current) === null || _a === void 0
            ? void 0
            : _a.call(cancelPointerEventListener);
          cancelPointerEventListener.current = null;
        }

        whileTap && setOverride(visualElement, whileTap, tapGesturePriority); // We load this event handler into a ref so we can later refer to
        // onPointerUp.current which will always have reference to the latest props

        var onPointerUp = Object(react__WEBPACK_IMPORTED_MODULE_5__["useRef"])(
          null,
        );
        ...
        onPointerUp.current = function (event, info) {
          ...
          whileTap && clearOverride(visualElement, tapGesturePriority); // Check the gesture lock - if we get it, it means no drag gesture is active
        ...
        function onPointerDown(event, info) {
          ...
          cancelPointerEventListener.current = Object(
            ...
            addPointerEvent(window, "pointerup", function (event, info) {
              ...
              return (_a = onPointerUp.current) === null || _a === void 0
                ? void 0
                : _a.call(onPointerUp, event, info);
            }),
 ...
 */
      ...
      function useHoverGesture(_a, visualElement) {
        ...
        usePointerEvent(
          visualElement,
          "pointerenter",
          filterTouch(function (event, info) {
            onHoverStart === null || onHoverStart === void 0
              ? void 0
        ...
        usePointerEvent(
          ...
          "pointerleave",
          filterTouch(function (event, info) {
            onHoverEnd === null || onHoverEnd === void 0
              ? void 0
 ...
 */
   ...
   */
          ...
          AnimationControls.prototype.start = function (
            definition,
            transitionOverride,
          ) {
            var _this = this;
            ...
            if (this.hasMounted) {
              ...
              this.subscribers.forEach(function (visualElement) {
                var animation = startVisualElementAnimation(
                  visualElement,
                  definition,
                  {
 ...
 */
      ...
      var ExitComponent = makeRenderlessComponent(function (props) {
        ...
        var isPlayingExitAnimation = Object(
          react__WEBPACK_IMPORTED_MODULE_5__["useRef"],
        )(false);
        var custom = (presenceContext === null || presenceContext === void 0
            ? void 0
        ...
        Object(react__WEBPACK_IMPORTED_MODULE_5__["useEffect"])(function () {
          if (!isPresent) {
            ...
            isPlayingExitAnimation.current && animate &&
 ...
 */
      ...
      var hasUpdated = function hasUpdated(prev, next) {
        return next !== undefined && (Array.isArray(prev) && Array.isArray(next)
 ...
 */
      ...
      function useAnimateProp(
        ...
        var prevValues = Object(react__WEBPACK_IMPORTED_MODULE_5__["useRef"])(
          null,
        );

        if (!prevValues.current) {
          prevValues.current = targetWithoutTransition(
            targetAndTransition,
            true,
          );
        }
          ...
          for (var key in animatingTarget) {
            ...
            var shouldAnimateOnMount = isInitialRender.current &&
              (!visualElement.hasValue(key) ||
                visualElement.getValue(key).get() !== finalTarget[key]); // If this value has updated between renders or it's we're animating this value on mount,
            // add it to the animate target.

            var isValidValue = finalTarget[key] !== null;
            var valueHasUpdated = hasUpdated(
      ...
      var resolveVariantLabels = function resolveVariantLabels(variant) {
        var unresolvedVariant = variant instanceof MotionValue
          ? variant.get()
          : variant;
 ...
 */
      ...
      var hasVariantChanged = function hasVariantChanged(
        oldVariant,
        newVariant,
      ) {
 ...
 */
      ...
      function useVariantAnimations(visualElement, initial, animate, inherit) {
        ...
        var parentAlreadyMounted =
          (_a = context.parent) === null || _a === void 0
            ? void 0
            : _a.isMounted;
        var hasMounted = Object(react__WEBPACK_IMPORTED_MODULE_5__["useRef"])(
          false,
        );
        Object(react__WEBPACK_IMPORTED_MODULE_5__["useEffect"])(function () {
 ...
 */
      ...
      function useAnimationGroupSubscription(visualElement, animation) {
        var unsubscribe = Object(react__WEBPACK_IMPORTED_MODULE_5__["useMemo"])(
          function () {
        ...
        useUnmountEffect(function () {
          return unsubscribe === null || unsubscribe === void 0
            ? void 0
            : unsubscribe();
        });
      }
 ...
 */
       ...
       */
              ...
              return Promise.all(animations).then(function () {
                ...
                (_b = (_a = _this.props).onLayoutAnimationComplete) === null ||
                  _b === void 0
                  ? void 0
                  : _b.call(_a);
   ...
   */
     ...
     */
            ...
            var frame = function frame() {
              ...
              visualElement.setAxisTarget(
                axis,
                frameTarget.min,
                frameTarget.max,
              ); // If this is a crossfade animation, update both elements.

              crossfade === null || crossfade === void 0
                ? void 0
                : crossfade(p);
          ...
          Animate.prototype.createCrossfadeAnimation = function (
            crossfadeOpacity,
          ) {
            var visualElement = this.props.visualElement;
 ...
 */
      ...
      function useForceUpdate() {
        var unloadingRef = Object(react__WEBPACK_IMPORTED_MODULE_5__["useRef"])(
          false,
        );
        ...
        return Object(react__WEBPACK_IMPORTED_MODULE_5__["useCallback"])(
          function () {
          ...
          function () {
            return {
              ...
              onExitComplete: function onExitComplete(childId) {
                ...
                allComplete &&
                  (_onExitComplete === null || _onExitComplete === void 0
                    ? void 0
                    : _onExitComplete());
              },
   ...
   */
      ...
      function onlyElements(children) {
        ...
        react__WEBPACK_IMPORTED_MODULE_5__["Children"].forEach(
          children,
          function (child) {
            if (
              Object(react__WEBPACK_IMPORTED_MODULE_5__["isValidElement"])(
                child,
              )
            ) {
              filtered.push(child);
 ...
 */
      ...
      var AnimatePresence = function AnimatePresence(_a) {
        ...
        var isInitialRender = Object(
          react__WEBPACK_IMPORTED_MODULE_5__["useRef"],
        )(true); // Filter out any children that aren't ReactElements. We can only track ReactElements with a props.key

        var filteredChildren = onlyElements(children); // Keep a living record of the children we're actually rendering so we
        // can diff to figure out which are entering and exiting

        var presentChildren = Object(
          react__WEBPACK_IMPORTED_MODULE_5__["useRef"],
        )(filteredChildren); // A lookup table to quickly reference components by key

        var allChildren =
          Object(react__WEBPACK_IMPORTED_MODULE_5__["useRef"])(new Map())
            .current; // A living record of all currently exiting components.

        var exiting =
          Object(react__WEBPACK_IMPORTED_MODULE_5__["useRef"])(new Set())
            .current;
        ...
        return Object(react__WEBPACK_IMPORTED_MODULE_5__["createElement"])(
          ...
          exiting.size
            ...
            : childrenToRender.map(function (child) {
              return Object(react__WEBPACK_IMPORTED_MODULE_5__["cloneElement"])(
                child,
              );
            }),
        );
      ...
      function createSwitchAnimation(child, stack) {
        if (stack && child !== stack.lead) {
          ...
          stack && child.presence !== Presence.Entering &&
          child === stack.lead && stack.lead !== stack.prevLead
        ) {
          return {
        ...
        if (child.presence === Presence.Entering) {
          originBox = stack === null || stack === void 0
            ? void 0
            : stack.getFollowOrigin();
        } else if (child.presence === Presence.Exiting) {
          targetBox = stack === null || stack === void 0
            ? void 0
            : stack.getFollowTarget();
        }
      ...
      function createCrossfadeAnimation(child, stack) {
        ...
        var stackLeadPresence = stackLead === null || stackLead === void 0
          ? void 0
          : stackLead.presence;
        ...
        if (
          !((_a = stack === null || stack === void 0
                  ? void 0
                  : stack.follow) === null || _a === void 0
            ? void 0
        ...
        if (!stack || child === stackLead) {
          if (child.presence === Presence.Entering) {
            config.crossfadeOpacity = (_b = stack === null || stack === void 0
                    ? void 0
                    : stack.follow) === null || _b === void 0
              ? void 0
          ...
          if (!stackLead || stackLeadPresence === Presence.Entering);
            ...
            config.crossfadeOpacity = (_c = stack === null || stack === void 0
                    ? void 0
                    : stack.lead) === null || _c === void 0
              ? void 0
 ...
 */
      ...
      function findLeadAndFollow(stack, _a) {
        ...
        if (
          lead !== prevLead && !lastIsPresent && follow === prevFollow &&
      ...
      var LayoutStack =
        ...
        function () {
            ...
            if (this.snapshot) {
              ...
              for (var key in latest) {
                if (!child.hasValue(key)) {
                  ...
                  (_a = child.getValue(key)) === null || _a === void 0
                    ? void 0
                    : _a.set(latest[key]);
                }
              }
          ...
          LayoutStack.prototype.updateLeadAndFollow = function () {
            ...
            var _a = Object(
                tslib__WEBPACK_IMPORTED_MODULE_0__/* __read */ ["c"],
              )(findLeadAndFollow(this.order, [this.lead, this.follow]), 2),
              lead = _a[0],
              follow = _a[1];
          ...
          LayoutStack.prototype.isLeadPresent = function () {
            ...
            return this.lead &&
              ((_a = this.lead) === null || _a === void 0
                  ? void 0
                  : _a.presence) !== Presence.Exiting;
          };
          ...
          LayoutStack.prototype.getFollowTarget = function () {
            ...
            return (_a = this.follow) === null || _a === void 0
              ? void 0
              : _a.box;
          };
          ...
          LayoutStack.prototype.getLeadOrigin = function () {
            ...
            return (_a = this.lead) === null || _a === void 0
              ? void 0
              : _a.prevViewportBox;
          };
 ...
 */
     ...
     */
            ...
            var handler = {
              ...
              layoutReady: function layoutReady(child) {
                ...
                child.layoutReady(
                  createAnimation(child, _this.getStack(layoutId)),
                );
              },
            };
            /**
     ...
     */
          ...
          AnimateSharedLayout.prototype.addChild = function (child) {
            ...
            child.presence = this.hasMounted
              ? Presence.Entering
              : Presence.Present;
          };
 ...
 */
      ...
      function useSpring(source, config) {
        ...
        var activeSpringAnimation = Object(
          react__WEBPACK_IMPORTED_MODULE_5__["useRef"],
        )(null);
        var value = useMotionValue(
 ...
 */
      ...
      function useElementScroll(ref) {
        ...
        useIsomorphicLayoutEffect(function () {
          ...
          var scrollListener = addDomEvent(
            element,
            "scroll",
            updateScrollValues,
            {
          ...
          var resizeListener = addDomEvent(
            element,
            "resize",
            updateScrollValues,
          );
 ...
 */
      ...
      if (typeof window !== "undefined") {
        if (window.matchMedia) {
          var motionMediaQuery_1 = window.matchMedia(
 ...
 */
      ...
      function useExternalRef(externalRef) {
        ...
        var ref = !externalRef || typeof externalRef === "function"
          ...
          : externalRef; // Handle `ref` functions. Again, calling the hook conditionally is kind of naughty
