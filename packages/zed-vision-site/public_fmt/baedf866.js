 ...
 */
    ...
    function getDelayFromTransition(transition, key) {
      ...
      return (_e = (_d = (_b = (_a = transition[key]) === null || _a === void 0
                          ? void 0
 ...
 */
    ...
    try {
      var emotionIsPropValid_1 = __webpack_require__(223).default;
 ...
 */
    ...
    function useSnapshotOnUnmount(visualElement) {
      var syncLayout = Object(react__WEBPACK_IMPORTED_MODULE_5__["useContext"])(
        SharedLayoutContext,
      );
 ...
 */
   ...
   */
        ...
        VisualElementDragControls.prototype.updateVisualElementAxis = function (
          axis,
          event,
        ) {
          var _a;
   ...
   */
       ...
       */
        ...
        VisualElementDragControls.prototype.startAxisValueAnimation = function (
          axis,
          transition,
        ) {
          var axisValue = this.getAxisMotionValue(axis);
 ...
 */
    ...
    function useVariantAnimations(visualElement, initial, animate, inherit) {
      ...
      var parentAlreadyMounted = (_a = context.parent) === null || _a === void 0
        ? void 0
        : _a.isMounted;
 ...
 */
    ...
    var target = {
      shouldRender: function shouldRender(props) {
        return props.animate !== undefined && !isVariantLabel(props.animate) &&
   ...
   */
    ...
    function onlyElements(children) {
      ...
      react__WEBPACK_IMPORTED_MODULE_5__["Children"].forEach(
        ...
        function (child) {
          if (
            Object(react__WEBPACK_IMPORTED_MODULE_5__["isValidElement"])(child)
          ) {
            filtered.push(child);
          }
        },
 ...
 */
    ...
    var AnimatePresence = function AnimatePresence(_a) {
      ...
      var allChildren =
        Object(react__WEBPACK_IMPORTED_MODULE_5__["useRef"])(new Map()).current; // A living record of all currently exiting components.

      var exiting =
        Object(react__WEBPACK_IMPORTED_MODULE_5__["useRef"])(new Set()).current;
    ...
    function createSwitchAnimation(child, stack) {
      if (stack && child !== stack.lead) {
        ...
        stack && child.presence !== Presence.Entering && child === stack.lead &&
