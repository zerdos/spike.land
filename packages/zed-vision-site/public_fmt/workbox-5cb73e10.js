  ...
  (function (t) {
      ...
      constructor(t, e, s) {
        super(
          (({ url: e }) => {
            ...
            if (s && (e.origin === location.origin || 0 === s.index)) {return s
                .slice(1);}
          }),
          e,
          s,
    ...
    class o {
          ...
          ((t) => {
            if (t.data && "CACHE_URLS" === t.data.type) {
              const { payload: e } = t.data,
                s = Promise.all(e.urlsToCache.map(
                  ((e) => {
                    "string" == typeof e && (e = [e]);
      ...
      handleRequest({ request: t, event: e }) {
        ...
        return a instanceof Promise && this.o &&
          (a = a.catch(
            ((n) => this.o.handle({ url: s, request: t, event: e })),
          )),
          a;
      }
    ...
    class L {
      ...
      fetch(t) {
        return this.waitUntil((async () => {
          ...
          let n = U(t);
          if (
            "navigate" === n.mode && e instanceof FetchEvent &&
            e.preloadResponse
          ) {
      ...
      async getCacheKey(t, e) {
        if (!this.u[e]) {
          ...
          for (const t of this.iterateCallbacks("cacheKeyWillBeUsed")) {
            s = U(
              await t(
                { mode: e, request: s, event: this.event, params: this.params },
              ),
            );
          }
          this.u[e] = s;
      ...
      async v(t) {
        ...
        for (const t of this.iterateCallbacks("cacheWillUpdate")) {
          if (
            e =
              await t(
                { request: this.request, response: e, event: this.event },
              ) || void 0,
              s = !0,
              !e
          ) {
    ...
    class C extends class {
      ...
      async N(t, e) {
        let n;
        if (!this._) {throw new s(
            "missing-precache-entry",
            { cacheName: this.cacheName, url: t.url },
          );}
      ...
      async C(t, e) {
        ...
        let i = Boolean(n);
        if (n && n.status >= 400 && !this.O() && (i = !1), !i) {
          throw new s(
            "bad-precaching-response",
            { url: t.url, status: n.status },
          );
        }
        return n;
      }
      O() {
        return this.plugins.some(((t) => t.cacheWillUpdate && t !== b));
      }
    }
    class x {
      constructor(
        ...
        for (const n of t) {
          ...
          if (this.k.has(i) && this.k.get(i) !== t) {
            throw new s(
              ...
              { firstEntry: this.k.get(i), secondEntry: t },
            );
          }
          ...
          (async () => {
            ...
            for (const [e, s] of this.k) {
              const n = this.K.get(s),
                ...
                r = new Request(
                  e,
                  { integrity: n, cache: i, credentials: "same-origin" },
                );
              await Promise.all(
                this.strategy.handleAll(
                  { params: { cacheKey: s }, request: r, event: t },
                ),
              );
            }
      ...
      createHandlerBoundToURL(t) {
        ...
        return (s) => (s.request = new Request(t),
          s.params = a({ cacheKey: e }, s.params),
