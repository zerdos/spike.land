(this["webpackJsonp"] = this["webpackJsonp"] || []).push([[7], [
  ...
  /***/ (function (module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_require__.d(__webpack_exports__, "a", function () {
      return /* reexport */ ThemeContext;
    });
    __webpack_require__.d(__webpack_exports__, "c", function () {
      return /* reexport */ emotion_element_57a3a7a3_browser_esm_withEmotionCache;
    });
    __webpack_require__.d(__webpack_exports__, "b", function () {
      return /* binding */ core_browser_esm_jsx;
    });
    ...
    var emotion_element_57a3a7a3_browser_esm_withEmotionCache =
      function withEmotionCache(func) {
        var render = function render(props, ref) {
          return /*#__PURE__*/ Object(react["createElement"])(
    ...
    var emotion_element_57a3a7a3_browser_esm_render = function render(
      cache,
      props,
      theme,
      ref,
      ...
      if (typeof props.className === "string") {
        className = Object(
          utils_browser_esm["a"/* getRegisteredStyles */
          ],
      ...
      var serialized = Object(
        serialize_browser_esm["a"/* serializeStyles */
        ],
      )(registeredStyles);
      ...
      var rules = Object(
        utils_browser_esm["b"/* insertStyles */
        ],
      ...
      for (var key in props) {
        if (
          emotion_element_57a3a7a3_browser_esm_hasOwnProperty.call(
            props,
            key,
          ) && key !== "css" && key !== typePropName && (true || false)
        ) {
          newProps[key] = props[key];
        }
      }
    ...
    var Emotion =
      /* #__PURE__ */ emotion_element_57a3a7a3_browser_esm_withEmotionCache(
        function (props, cache, ref) {
          if (typeof props.css === "function") {
            return /*#__PURE__*/ Object(react["createElement"])(
              ...
              null,
              function (theme) {
                return emotion_element_57a3a7a3_browser_esm_render(
                  cache,
                  props,
                  theme,
                  ref,
    ...
    var sheet_browser_esm = __webpack_require__(59);
    ...
    var core_browser_esm_jsx = function jsx(type, props) {
      ...
      if (
        props == null ||
        !emotion_element_57a3a7a3_browser_esm_hasOwnProperty.call(props, "css")
      ) {
        // $FlowFixMe
    ...
    var core_browser_esm_InnerGlobal = /*#__PURE__*/ function (
      _React$Component,
    ) {
      Object(
        inheritsLoose["a"/* default */
        ],
    ...
    var ClassNames = emotion_element_57a3a7a3_browser_esm_withEmotionCache(
  ...
  /***/ (function (module, exports, __webpack_require__) {
    ...
    exports.navigateTo = exports.replace = exports.push = exports.navigate =
    ...
    var _parsePath = __webpack_require__(96);
    ...
    function withPrefix(path, prefix) {
      ...
      var base = (_ref = (_prefix = prefix) !== null && _prefix !== void 0
              ? _prefix
              : getGlobalPathPrefix()) !== null && _ref !== void 0
        ? _ref
        : "/";
      return "" + ((base === null || base === void 0
          ? void 0
          : base.endsWith("/"))
        ? base.slice(0, -1)
        : base) +
    ...
    var GatsbyLink = /*#__PURE__*/ function (_React$Component) {
      ...
      _proto.handleRef = function handleRef(ref) {
        ...
        if (this.state.IOSupported && ref) {
          ...
          this.io = createIntersectionObserver(ref, function () {
            ___loader.enqueue(
              (0, _parsePath.parsePath)(
                rewriteLinkPath(_this2.props.to, window.location.pathname),
              ).pathname,
            );
          });
        }
      ...
      _proto.render = function render() {
        ...
        var _this$props = this.props,
          ...
          getProps = _this$props$getProps === void 0
    ...
    var showDeprecationWarning = function showDeprecationWarning(
      functionName,
      altFunctionName,
      version,
    ) {
      return console.warn(
        'The "' + functionName +
          ...
          version + '. Please use "' + altFunctionName + '" instead.',
      );
    };
  ...
  /***/ (function (module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_require__.d(
      ...
      "PageResourceStatus",
      function () {
        return /* binding */ PageResourceStatus;
      },
    );
    __webpack_require__.d(__webpack_exports__, "BaseLoader", function () {
      return /* binding */ loader_BaseLoader;
    });
    __webpack_require__.d(__webpack_exports__, "ProdLoader", function () {
      return /* binding */ loader_ProdLoader;
    });
    __webpack_require__.d(__webpack_exports__, "setLoader", function () {
      return /* binding */ setLoader;
    });
    __webpack_require__.d(__webpack_exports__, "publicLoader", function () {
      return /* binding */ publicLoader;
    });
    __webpack_require__.d(
      __webpack_exports__,
      "getStaticQueryResults",
      function () {
        return /* binding */ getStaticQueryResults;
      },
    );
    ...
    var support = function support(feature) {
      ...
      try {
        if (
          fakeLink.relList && typeof fakeLink.relList.supports === "function"
        ) {
    ...
    var supportedPrefetchStrategy = support("prefetch")
      ? linkPrefetchStrategy
      : xhrPrefetchStrategy;
    var preFetched = {};
    var prefetch_prefetch = function prefetch(url, options) {
    ...
    var _cache_prefetch = (prefetch_prefetch);
    // EXTERNAL MODULE: ./.cache/emitter.js + 1 modules
    var emitter = __webpack_require__(57);

    // EXTERNAL MODULE: ./.cache/find-path.js + 1 modules
    var find_path = __webpack_require__(83);
 ...
 */
   ...
   */
    ...
    var doesConnectionSupportPrefetch =
      function doesConnectionSupportPrefetch() {
        if (
    ...
    var toPageResources = function toPageResources(pageData, component) {
      ...
      return { component: component, json: pageData.result, page: page };
    };
    var loader_BaseLoader = /*#__PURE__*/ function () {
      ...
      _proto.fetchPageDataJson = function fetchPageDataJson(loadObj) {
        ...
        return this.memoizedGet(url).then(function (req) {
          var status = req.status, responseText = req.responseText; // Handle 200
          if (status === 200) {
            try {
              ...
              return Object.assign(
                loadObj,
                { status: PageResourceStatus.Success, payload: jsonPayload },
              );
          ...
          if (status === 404 || status === 200) { // If the request was for a 404 page and it doesn't exist, we're done
            ...
            return _this2.fetchPageDataJson(
              Object.assign(loadObj, { pagePath: "/404.html", notFound: true }),
            );
          } // handle 500 response (Unrecoverable)
          if (status === 500) {
            return Object.assign(loadObj, { status: PageResourceStatus.Error });
      ...
      _proto.loadPageDataJson = function loadPageDataJson(rawPath) {
        var _this3 = this;
        var pagePath = Object(
          find_path["b"/* findPath */
          ],
        )(rawPath);
        if (this.pageDataDb.has(pagePath)) {
          return Promise.resolve(this.pageDataDb.get(pagePath));
        }
        return this.fetchPageDataJson({ pagePath: pagePath }).then(
          function (pageData) {
      ...
      _proto.loadPage = function loadPage(rawPath) {
        ...
        if (this.inFlightDb.has(pagePath)) return this.inFlightDb.get(pagePath);
        var inFlightPromise = Promise.all(
          [this.loadAppData(), this.loadPageDataJson(pagePath)],
        ).then(function (allData) {
          var result = allData[1];
          if (result.status === PageResourceStatus.Error) {
            return { status: PageResourceStatus.Error };
          }
          ...
          var _pageData = pageData,
            ...
            staticQueryHashes = _pageData$staticQuery === void 0
              ? []
              : _pageData$staticQuery;
          var finalResult = {};
          var componentChunkPromise = _this4.loadComponent(componentChunkName)
            .then(function (component) {
              finalResult.createdAt = new Date();
              var pageResources;
              if (!component) finalResult.status = PageResourceStatus.Error;
              else {
                finalResult.status = PageResourceStatus.Success;
                if (result.notFound === true) finalResult.notFound = true;
          ...
          var staticQueryBatchPromise = Promise.all(
            staticQueryHashes.map(function (staticQueryHash) { // Check for cache in case this static query result has already been loaded
          ...
          return Promise.all([componentChunkPromise, staticQueryBatchPromise])
            .then(function (_ref2) {
              var pageResources = _ref2[0], staticQueryResults = _ref2[1];
              var payload;
              if (pageResources) {
                payload = _objectSpread(
                  _objectSpread({}, pageResources),
                  {},
                ...
                emitter["a"/* default */
                  ...
                  { page: payload, pageResources: payload },
                );
              }
      ...
      _proto.shouldPrefetch = function shouldPrefetch(pagePath) { // Skip prefetching if we know user is on slow or constrained connection
        if (!doesConnectionSupportPrefetch()) return false; // Check if the page exists.
        if (this.pageDb.has(pagePath)) return false;
        return true;
      };
      _proto.prefetch = function prefetch(pagePath) {
        var _this5 = this;
        if (!this.shouldPrefetch(pagePath)) return false; // Tell plugins with custom prefetching logic that they should start
        // prefetching this path.
        if (!this.prefetchTriggered.has(pagePath)) {
          this.apiRunner("onPrefetchPathname", { pathname: pagePath });
          this.prefetchTriggered.add(pagePath);
        } // If a plugin has disabled core prefetching, stop now.
        if (this.prefetchDisabled) return false;
        var realPath = Object(
          find_path["b"/* findPath */
          ],
        )(pagePath); // Todo make doPrefetch logic cacheable
        // eslint-disable-next-line consistent-return
        this.doPrefetch(realPath).then(function () {
          if (!_this5.prefetchCompleted.has(pagePath)) {
            _this5.apiRunner("onPostPrefetchPathname", { pathname: pagePath });
      ...
      _proto.getResourceURLsForPathname = function getResourceURLsForPathname(
        rawPath,
      ) {
        var pagePath = Object(
          find_path["b"/* findPath */
      ...
      _proto.loadAppData = function loadAppData(retries) {
        ...
        return this.memoizedGet("" + "/page-data/app-data.json").then(
          function (req) {
            var status = req.status, responseText = req.responseText;
            var appData;
            if (status !== 200 && retries < 3) { // Retry 3 times incase of non-200 responses
    ...
    var createComponentUrls = function createComponentUrls(componentChunkName) {
      return (window.___chunkMapping[componentChunkName] || []).map(
        function (chunk) {
          return "" + chunk;
        },
      );
    };
    var loader_ProdLoader = /*#__PURE__*/ function (_BaseLoader) {
      Object(
        inheritsLoose["a"/* default */
        ],
      )(ProdLoader, _BaseLoader);
      function ProdLoader(asyncRequires, matchPaths) {
        var loadComponent = function loadComponent(chunkName) {
          return asyncRequires.components[chunkName]
            ? asyncRequires.components[chunkName]().then(preferDefault) // loader will handle the case when component is null
              .catch(function () {
                return null;
              })
            : Promise.resolve();
      ...
      _proto2.doPrefetch = function doPrefetch(pagePath) {
        ...
        return _cache_prefetch(
          ...
          return Promise.all(componentUrls.map(_cache_prefetch)).then(
            function () {
              return pageData;
            },
          );
      ...
      _proto2.loadPageDataJson = function loadPageDataJson(rawPath) {
        return _BaseLoader.prototype.loadPageDataJson.call(this, rawPath).then(
          function (data) {
            if (data.notFound) { // check if html file exist using HEAD request:
              // if it does we should navigate to it instead of showing 404
              return doFetch(rawPath, "HEAD").then(function (req) {
                if (req.status === 200) { // page (.html file) actually exist (or we asked for 404 )
    ...
    var publicLoader = { // Deprecated methods. As far as we're aware, these are only used by
      ...
      getResourcesForPathnameSync: function getResourcesForPathnameSync(
        rawPath,
      ) {
        console.warn(
    ...
    var loader = __webpack_exports__["default"] = (publicLoader);
  ...
  /***/ (function (module, __webpack_exports__, __webpack_require__) {
    ...
    /* harmony export (binding) */ __webpack_require__.d(
      ...
      function () {
        return unstable_collectionGraphql;
      },
    );
    ...
    /* harmony import */ var gatsby_link__WEBPACK_IMPORTED_MODULE_1___default =
    ...
    /* harmony reexport (default from non-harmony) */ __webpack_require__.d(
      ...
      "Link",
      function () {
        return gatsby_link__WEBPACK_IMPORTED_MODULE_1___default.a;
      },
    );
    /* harmony reexport (safe) */ __webpack_require__.d(
      ...
      "withAssetPrefix",
      function () {
        return gatsby_link__WEBPACK_IMPORTED_MODULE_1__["withAssetPrefix"];
      },
    );
    ...
    /* harmony reexport (safe) */ __webpack_require__.d(
      ...
      "withPrefix",
      function () {
        return gatsby_link__WEBPACK_IMPORTED_MODULE_1__["withPrefix"];
      },
    );
    ...
    /* harmony reexport (safe) */ __webpack_require__.d(
      ...
      "parsePath",
      function () {
        return gatsby_link__WEBPACK_IMPORTED_MODULE_1__["parsePath"];
      },
    );
    ...
    /* harmony reexport (safe) */ __webpack_require__.d(
      ...
      "navigate",
      function () {
        return gatsby_link__WEBPACK_IMPORTED_MODULE_1__["navigate"];
      },
    );
    ...
    /* harmony reexport (safe) */ __webpack_require__.d(
      ...
      "push",
      function () {
        return gatsby_link__WEBPACK_IMPORTED_MODULE_1__["push"];
      },
    );
    ...
    /* harmony reexport (safe) */ __webpack_require__.d(
      ...
      "replace",
      function () {
        return gatsby_link__WEBPACK_IMPORTED_MODULE_1__["replace"];
      },
    );
    ...
    /* harmony reexport (safe) */ __webpack_require__.d(
      ...
      "navigateTo",
      function () {
        return gatsby_link__WEBPACK_IMPORTED_MODULE_1__["navigateTo"];
      },
    );

    /* harmony import */ var gatsby_react_router_scroll__WEBPACK_IMPORTED_MODULE_2__ =
      __webpack_require__(39);
    /* harmony import */ var gatsby_react_router_scroll__WEBPACK_IMPORTED_MODULE_2___default =
      /*#__PURE__*/ __webpack_require__.n(
        gatsby_react_router_scroll__WEBPACK_IMPORTED_MODULE_2__,
      );
    /* harmony reexport (safe) */ __webpack_require__.d(
      __webpack_exports__,
      "useScrollRestoration",
      function () {
        return gatsby_react_router_scroll__WEBPACK_IMPORTED_MODULE_2__[
          "useScrollRestoration"
        ];
      },
    );
    ...
    /* harmony import */ var _emotion_core__WEBPACK_IMPORTED_MODULE_5__ =
      __webpack_require__(1);
    var prefetchPathname =
      _loader__WEBPACK_IMPORTED_MODULE_4__["default"].enqueue;
    var StaticQueryContext =
    ...
    function StaticQueryDataRenderer(_ref) {
      ...
      return Object(_emotion_core__WEBPACK_IMPORTED_MODULE_5__ /* jsx */["b"])(
        react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment,
        null,
        finalData && render(finalData),
        !finalData &&
          Object(_emotion_core__WEBPACK_IMPORTED_MODULE_5__ /* jsx */["b"])(
            "div",
            null,
            "Loading (StaticQuery)",
          ),
    ...
    var StaticQuery = function StaticQuery(props) {
      ...
      return Object(_emotion_core__WEBPACK_IMPORTED_MODULE_5__ /* jsx */["b"])(
        ...
        function (staticQueryData) {
          return Object(
            _emotion_core__WEBPACK_IMPORTED_MODULE_5__ /* jsx */["b"],
          )(
    ...
    var useStaticQuery = function useStaticQuery(query) {
      var _context$query;
      if (
        typeof react__WEBPACK_IMPORTED_MODULE_0___default.a.useContext !==
      ...
      var context = react__WEBPACK_IMPORTED_MODULE_0___default.a.useContext(
        StaticQueryContext,
    ...
    function unstable_collectionGraphql() { // TODO: Strip this out of the component and throw error if it gets called
      return null;
    }
  ...
  /***/ (function (module, __webpack_exports__, __webpack_require__) {
    ...
    var createMemorySource = function createMemorySource() {
      var initialPath = arguments.length > 0 && arguments[0] !== undefined
        ? arguments[0]
        : "/";
  ...
  /***/ (function (module, __webpack_exports__, __webpack_require__) {
    ...
    // EXPORTS
    __webpack_require__.d(__webpack_exports__, "a", function () {
      return /* binding */ serialize_browser_esm_serializeStyles;
    });
    ...
    var memoize_browser_esm = __webpack_require__(38);
    ...
    var serialize_browser_esm_processStyleValue = function processStyleValue(
      key,
      value,
    ) {
      switch (key) {
  ...
  /***/ (function (module, __webpack_exports__, __webpack_require__) {
    ...
    /* harmony import */ var create_react_context__WEBPACK_IMPORTED_MODULE_3__ =
      __webpack_require__(94);
    /* harmony import */ var create_react_context__WEBPACK_IMPORTED_MODULE_3___default =
      /*#__PURE__*/ __webpack_require__.n(
        create_react_context__WEBPACK_IMPORTED_MODULE_3__,
      );
    /* harmony import */ var react_lifecycles_compat__WEBPACK_IMPORTED_MODULE_4__ =
      __webpack_require__(95);
    /* harmony import */ var react_lifecycles_compat__WEBPACK_IMPORTED_MODULE_4___default =
      /*#__PURE__*/ __webpack_require__.n(
        react_lifecycles_compat__WEBPACK_IMPORTED_MODULE_4__,
      );
    ...
    /* harmony reexport (safe) */ __webpack_require__.d(
      ...
      "matchPath",
      function () {
        return _lib_utils__WEBPACK_IMPORTED_MODULE_5__["match"];
      },
    );

    /* harmony import */ var _lib_history__WEBPACK_IMPORTED_MODULE_6__ =
      __webpack_require__(14);
    /* harmony reexport (safe) */ __webpack_require__.d(
      __webpack_exports__,
      "createHistory",
      function () {
        return _lib_history__WEBPACK_IMPORTED_MODULE_6__["a"];
      },
    );
    ...
    /* harmony reexport (safe) */ __webpack_require__.d(
      ...
      "createMemorySource",
      function () {
        return _lib_history__WEBPACK_IMPORTED_MODULE_6__["b"];
      },
    );
    ...
    /* harmony reexport (safe) */ __webpack_require__.d(
      ...
      "navigate",
      function () {
        return _lib_history__WEBPACK_IMPORTED_MODULE_6__["d"];
      },
    );
    ...
    /* harmony reexport (safe) */ __webpack_require__.d(
      ...
      "globalHistory",
      function () {
        return _lib_history__WEBPACK_IMPORTED_MODULE_6__["c"];
      },
    );
    ...
    var createNamedContext = function createNamedContext(name, defaultValue) {
      var Ctx = create_react_context__WEBPACK_IMPORTED_MODULE_3___default()(
        defaultValue,
      );
    ...
    var BaseContext = createNamedContext(
      "Base",
      { baseuri: "/", basepath: "/" },
    );
    ...
    var RouterImpl = function (_React$PureComponent) {
      ...
      RouterImpl.prototype.render = function render() {
        var _props = this.props,
          ...
          domProps = _objectWithoutProperties(
            _props,
            [
              "location",
              "navigate",
        ...
        var routes = react__WEBPACK_IMPORTED_MODULE_0___default.a.Children
          .toArray(children).reduce(function (array, child) {
            var routes = createRoute(basepath)(child);
            return array.concat(routes);
          }, []);
        var pathname = location.pathname;

        var match = Object(_lib_utils__WEBPACK_IMPORTED_MODULE_5__["pick"])(
          routes,
          pathname,
        );
        ...
        if (match) {
          ...
          var props = _extends({}, params, {
            ...
            navigate: function navigate(to, options) {
              return _navigate2(
                Object(_lib_utils__WEBPACK_IMPORTED_MODULE_5__["resolve"])(
                  to,
                  uri,
                ),
                options,
          ...
          var clone = react__WEBPACK_IMPORTED_MODULE_0___default.a.cloneElement(
            element,
            props,
    ...
    var FocusHandlerImpl = function (_React$Component2) {
      ...
      FocusHandlerImpl.prototype.componentDidUpdate =
        function componentDidUpdate(prevProps, prevState) {
          if (
            prevProps.location !== this.props.location && this.state.shouldFocus
          ) {
            this.focus();
          }
        };
    ...
    Object(react_lifecycles_compat__WEBPACK_IMPORTED_MODULE_4__["polyfill"])(
      FocusHandlerImpl,
    );
        ...
        function (_ref5) {
          ...
          return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
            ...
            function (_ref6) {
              ...
              var href = Object(
                _lib_utils__WEBPACK_IMPORTED_MODULE_5__["resolve"],
              )(to, baseuri);
              var encodedHref = encodeURI(href);
              var isCurrent = location.pathname === encodedHref;
              var isPartiallyCurrent = Object(
                _lib_utils__WEBPACK_IMPORTED_MODULE_5__["startsWith"],
                    ...
                    onClick: function onClick(event) {
                      ...
                      if (shouldNavigate(event)) {
                        ...
                        if (typeof replace !== "boolean" && isCurrent) {
                          ...
                          shouldReplace = Object(
                            _lib_utils__WEBPACK_IMPORTED_MODULE_5__[
                              "shallowCompare"
                            ],
                          )(_extends({}, state), restState);
                        }
                        navigate(href, {
                          state: state,
                          replace: shouldReplace,
    ...
    var RedirectImpl = function (_React$Component3) {
      ...
      RedirectImpl.prototype.componentDidMount = function componentDidMount() {
        ...
        Promise.resolve().then(function () {
          ...
          navigate(
            Object(_lib_utils__WEBPACK_IMPORTED_MODULE_5__["insertParams"])(
              resolvedTo,
              props,
            ),
        ...
        function (_ref9) {
          ...
          return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
            ...
            function (_ref10) {
              ...
              var resolvedPath = Object(
                _lib_utils__WEBPACK_IMPORTED_MODULE_5__["resolve"],
              )(path, baseuri);
              var result = Object(
                _lib_utils__WEBPACK_IMPORTED_MODULE_5__["match"],
    ...
    var useParams = function useParams() {
      ...
      var results = Object(_lib_utils__WEBPACK_IMPORTED_MODULE_5__["match"])(
        context.basepath,
        location.pathname,
      );
    ...
    var useMatch = function useMatch(path) {
      ...
      var resolvedPath = Object(
        _lib_utils__WEBPACK_IMPORTED_MODULE_5__["resolve"],
      )(path, context.baseuri);
      var result = Object(_lib_utils__WEBPACK_IMPORTED_MODULE_5__["match"])(
        resolvedPath,
        location.pathname,
      );
      return result
    ...
    var createRoute = function createRoute(basepath) {
      return function (element) {
        ...
        if (
          ...
          return react__WEBPACK_IMPORTED_MODULE_0___default.a.Children.map(
            element.props.children,
        ...
        !(element.props.path || element.props.default ||
          ...
          ? false
            ? undefined
            : invariant__WEBPACK_IMPORTED_MODULE_2___default()(false)
          : void 0;
        ...
        !!(element.type === Redirect &&
            !Object(
              _lib_utils__WEBPACK_IMPORTED_MODULE_5__["validateRedirect"],
            )(element.props.from, element.props.to))
          ? false
            ? undefined
            : invariant__WEBPACK_IMPORTED_MODULE_2___default()(false)
        ...
        var elementPath = element.type === Redirect
          ? element.props.from
          : element.props.path;
  ...
  /***/ (function (module, exports, __webpack_require__) {
    ...
    var _require$publicLoader = __webpack_require__(10).publicLoader,
      ...
      getResourceURLsForPathname =
        _require$publicLoader.getResourceURLsForPathname,
    ...
    exports.apiRunner = function (api, args, defaultReturn, argTransform) {
      if (args === void 0) args = {}; // Hooks for gatsby-cypress's API handler
      if (undefined) {
        if (window.___apiHandler) window.___apiHandler(api);
        else if (window.___resolvedAPIs) window.___resolvedAPIs.push(api);
        else window.___resolvedAPIs = [api];
      }
      var results = plugins.map(function (plugin) {
        if (!plugin.plugin[api]) return undefined; // Deprecated April 2019. Use `loadPageSync` instead
        ...
        if (result && argTransform) {
          args = argTransform({ args: args, result: result, plugin: plugin });
        }
        return result;
  ...
  /***/ (function (module, __webpack_exports__, __webpack_require__) {
      ...
      for (var i = 0, l = ranked.length; i < l; i++) {
        ...
        for (; index < max; index++) {
          ...
          if (isSplat(routeSegment)) {
            ...
            params[param] = uriSegments.slice(index).map(decodeURIComponent)
              .join("/");
            break;
          }
          ...
          if (dynamicMatch && !isRootUri) {
            ...
            !matchIsNotReserved
              ? false
                ? undefined
                : invariant__WEBPACK_IMPORTED_MODULE_0___default()(false)
              : void 0;
    ...
    var insertParams = function insertParams(path, params) {
      ...
      var _params$location$sear = _params$location.search,
        search = _params$location$sear === undefined
          ? ""
 ...
 */
    var shallowCompare = function shallowCompare(obj1, obj2) {
      ...
      return obj1Keys.length === Object.keys(obj2).length &&
  ...
  /***/ (function (module, __webpack_exports__, __webpack_require__) {
    ...
    var MDXContext = /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0___default.a
      .createContext({});

    var withMDXComponents = function withMDXComponents(Component) {
      return function (props) {
        var allComponents = useMDXComponents(props.components);
        return /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0___default.a
          .createElement(
            Component,
            _extends({}, props, {
    ...
    var useMDXComponents = function useMDXComponents(components) {
      var contextComponents = react__WEBPACK_IMPORTED_MODULE_0___default.a
    ...
    var MDXProvider = function MDXProvider(props) {
      var allComponents = useMDXComponents(props.components);
      return /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0___default.a
        .createElement(MDXContext.Provider, {
          value: allComponents,
        }, props.children);
    };
    ...
    var MDXCreateElement =
      /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0___default.a.forwardRef(
        function (props, ref) {
          var propComponents = props.components,
            mdxType = props.mdxType,
            originalType = props.originalType,
            parentName = props.parentName,
            etc = _objectWithoutProperties(
              props,
              ["components", "mdxType", "originalType", "parentName"],
            );

          var components = useMDXComponents(propComponents);
          var type = mdxType;
          var Component = components["".concat(parentName, ".").concat(type)] ||
            components[type] || DEFAULTS[type] || originalType;
  ...
  /***/ (function (module, exports, __webpack_require__) {
    ...
    exports.__esModule = true;
    exports.useScrollRestoration = exports.ScrollContainer = exports
      .ScrollContext = void 0;

    var _scrollHandler = __webpack_require__(40);

    exports.ScrollContext = _scrollHandler.ScrollHandler;

    var _scrollContainer = __webpack_require__(99);

    exports.ScrollContainer = _scrollContainer.ScrollContainer;

    var _useScrollRestoration = __webpack_require__(103);
  ...
  /***/ (function (module, exports, __webpack_require__) {
    ...
    var _sessionStorage = __webpack_require__(98);
  ...
  /***/ (function (module, __webpack_exports__, __webpack_require__) {
    ...
    function stylis_min(W) {
      function M(d, c, e, h, a) {
        for (
          ...
          if (0 === b + n + v + m) {
            if (
              l === J && (0 < r && (f = f.replace(N, "")), 0 < f.trim().length)
            ) {
              switch (g) {
                case 32:
                case 9:
          ...
          switch (g) {
            case 13:
            case 10:
              47 === b ? b = 0 : 0 === 1 + q && 107 !== h && 0 < f.length &&
                (r = 1, f += "\x00");
        ...
        if (0 < t) {
          ...
          if (0 !== w * E) {
            ...
            switch (E) {
              ...
              case 112:
                p = p.replace(Q, "::-webkit-input-$1") +
                  p.replace(Q, "::-moz-$1") + p.replace(Q, ":-ms-input-$1") + p;
            }
      ...
      function P(d, c, e, h) {
        ...
        switch (m) {
          ...
          case 1023:
            ...
            b = a.substring(a.indexOf(":", 15)).replace("flex-", "").replace(
              "space-between",
              "justify",
            );
            return "-webkit-box-pack" + b + "-webkit-" + a + "-ms-flex-pack" +
              b + a;
          ...
          case 975:
            c = (a = d).length - 10;
            b = (33 === a.charCodeAt(c) ? a.substring(0, c) : a).substring(
              d.indexOf(":", 7) + 1,
            ).trim();
          ...
          case 938:
            if (45 === a.charCodeAt(5)) {
              switch (a.charCodeAt(6)) {
                case 105:
                  return b = a.replace("-items", ""),
                    "-webkit-" + a + "-webkit-box-" + b + "-ms-flex-" + b + a;

                case 115:
                  return "-webkit-" + a + "-ms-flex-item-" + a.replace(ba, "") +
                    a;

                default:
                  return "-webkit-" + a + "-ms-flex-line-pack" +
                    a.replace("align-content", "").replace(ba, "") + a;
              }
            }
            break;
          ...
          case 953:
            if (!0 === la.test(d)) {
              return 115 === (b = d.substring(d.indexOf(":") + 1)).charCodeAt(0)
                ...
                : a.replace(b, "-webkit-" + b) +
                  a.replace(b, "-moz-" + b.replace("fill-", "")) + a;
            }
            break;

          case 962:
            if (
              a = "-webkit-" + a + (102 === a.charCodeAt(5) ? "-ms-" + a : "") +
                a,
                211 === e + h && 105 === a.charCodeAt(13) &&
    ...
    /* harmony default export */ var cache_browser_esm =
      __webpack_exports__["a"] = (cache_browser_esm_createCache);
 ...
 */
    ...
    var emitter = mitt_es(); /* harmony default export */
    var _cache_emitter = __webpack_exports__["a"] = (emitter);
      ...
      _proto.insert = function insert(rule) {
        ...
        if (this.isSpeedy) {
          ...
          try {
            ...
            var isImportRule = rule.charCodeAt(1) === 105 &&
              rule.charCodeAt(0) === 64; // this is the ultrafast version, works across browsers
 ...
 */
  ...
  /***/ (function (module, exports, __webpack_require__) {
    ...
    if (false) {}
    else if (true) module.exports = preferDefault(__webpack_require__(104));
    else {}
 ...
 */ function stripPrefix(str, prefix) {
  ...
  /***/ (function (module, __webpack_exports__, __webpack_require__) {
    ...
    /* harmony import */ var _loader__WEBPACK_IMPORTED_MODULE_3__ =
      __webpack_require__(10);
    /* harmony import */ var _api_runner_browser__WEBPACK_IMPORTED_MODULE_4__ =
      __webpack_require__(26);
    /* harmony import */ var _api_runner_browser__WEBPACK_IMPORTED_MODULE_4___default =
      /*#__PURE__*/ __webpack_require__.n(
        _api_runner_browser__WEBPACK_IMPORTED_MODULE_4__,
      );
    /* harmony import */ var _find_path__WEBPACK_IMPORTED_MODULE_5__ =
    ...
    var PageRenderer = /*#__PURE__*/ function (_React$Component) {
      ...
      _proto.render = function render() {
        ...
        var _apiRunner = Object(
            _api_runner_browser__WEBPACK_IMPORTED_MODULE_4__["apiRunner"],
          )(
            "replaceComponentRenderer",
            {
              props: this.props,
              loader: _loader__WEBPACK_IMPORTED_MODULE_3__["publicLoader"],
            },
          ),
          replacementElement = _apiRunner[0];
        var pageElement = replacementElement || /*#__PURE__*/
        ...
        var wrappedPage = Object(
          _api_runner_browser__WEBPACK_IMPORTED_MODULE_4__["apiRunner"],
        )(
          "wrapPageElement",
          { element: pageElement, props: props },
          pageElement,
          function (_ref) {
            var result = _ref.result;
            return { element: result, props: props };
          },
        ).pop();
        return wrappedPage;
      };
    ...
    __webpack_exports__["a"] = (PageRenderer);
  ...
  /***/ (function (module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_require__.d(__webpack_exports__, "d", function () {
      return /* binding */ setMatchPaths;
    });
    __webpack_require__.d(__webpack_exports__, "a", function () {
      return /* binding */ find_path_findMatchPath;
    });
    __webpack_require__.d(__webpack_exports__, "c", function () {
      return /* binding */ find_path_grabMatchParams;
    });
    __webpack_require__.d(__webpack_exports__, "b", function () {
      return /* binding */ findPath;
    });
    ...
    var strip_prefix = __webpack_require__(67);
    ...
    var matchPaths = [];
    var find_path_trimPathname = function trimPathname(rawPathname) {
      var pathname = decodeURIComponent(rawPathname); // Remove the pathPrefix from the pathname.
      var trimmedPathname = Object(
        strip_prefix["a"/* default */
        ],
      )(pathname, "") // Remove any hashfragment
        .split("#")[0] // Remove search query
        .split("?")[0];
      return trimmedPathname;
    };
    function absolutify(path) { // If it's already absolute, return as-is
      if (
 ...
 */
    ...
    var find_path_findMatchPath = function findMatchPath(rawPathname) {
      var trimmedPathname = find_path_cleanPath(rawPathname);
      var pickPaths = matchPaths.map(function (_ref) {
        var path = _ref.path, matchPath = _ref.matchPath;
        return { path: matchPath, originalPath: path };
      });
      var path = Object(utils["pick"])(pickPaths, trimmedPathname);
      if (path) return normalize_page_path(path.route.originalPath);
      return null;
    }; /**
 ...
 */
    ...
    var find_path_grabMatchParams = function grabMatchParams(rawPathname) {
      var trimmedPathname = find_path_cleanPath(rawPathname);
      var pickPaths = matchPaths.map(function (_ref2) {
        var path = _ref2.path, matchPath = _ref2.matchPath;
        return { path: matchPath, originalPath: path };
      });
      var path = Object(utils["pick"])(pickPaths, trimmedPathname);
    ...
    var findPath = function findPath(rawPathname) {
      var trimmedPathname = find_path_trimPathname(absolutify(rawPathname));
      if (pathCache.has(trimmedPathname)) return pathCache.get(trimmedPathname);
      var foundPath = find_path_findMatchPath(trimmedPathname);
      if (!foundPath) foundPath = find_path_cleanPath(rawPathname);
 ...
 */
    ...
    var find_path_cleanPath = function cleanPath(rawPathname) {
      var trimmedPathname = find_path_trimPathname(absolutify(rawPathname));
      var foundPath = trimmedPathname;
      if (foundPath === "/index.html") foundPath = "/";
  ...
  /***/ (function (module, exports, __webpack_require__) {
    module.exports = [
      {
        plugin: __webpack_require__(172),
        options: {
          "plugins": [],
          "extensions": [".mdx"],
          "defaultLayouts": {},
      ...
      { plugin: __webpack_require__(106), options: { "plugins": [] } },
    ];
  ...
  /***/ (function (module, exports, __webpack_require__) {
    "use strict";
    var _interopRequireDefault = __webpack_require__(28);
    var _gatsby = __webpack_require__(13);
      ...
      exports.onRouteUpdate = function (_ref, pluginOptions) {
        ...
        if (manifestEl) {
          manifestEl.setAttribute(
            "href",
            (0, _gatsby.withPrefix)(manifestFilename),
          );
        }
      };
    }
    ...
    var SessionStorage = /*#__PURE__*/ function () {
      ...
      _proto.read = function read(location, key) {
        ...
        try {
          ...
          if (
            window && window[GATSBY_ROUTER_SCROLL_STATE] &&
  ...
  /***/ (function (module, exports, __webpack_require__) {
    ...
    var ScrollContainerImplementation = /*#__PURE__*/ function (
      _React$Component,
    ) {
    ...
    var ScrollContainer = function ScrollContainer(props) {
      return /*#__PURE__*/ React.createElement(
        ...
        function (_ref) {
          var location = _ref.location;
          return /*#__PURE__*/ React.createElement(
            _scrollHandler.ScrollContext.Consumer,
            null,
            function (context) {
              return /*#__PURE__*/ React.createElement(
                ScrollContainerImplementation,
  ...
  /***/ (function (module, __webpack_exports__, __webpack_require__) {
    ...
    /* harmony import */ var _loader__WEBPACK_IMPORTED_MODULE_2__ =
      __webpack_require__(10);
    /* harmony import */ var _page_renderer__WEBPACK_IMPORTED_MODULE_3__ =
    ...
    var ProdPageRenderer = function ProdPageRenderer(_ref) {
      var location = _ref.location;
      var pageResources = _loader__WEBPACK_IMPORTED_MODULE_2__["default"]
    ...
    __webpack_exports__["default"] = (ProdPageRenderer);
 ...
 */
    ...
    var _default = function _default(pathname, localizedManifests) {
      ...
      if (!Array.isArray(localizedManifests)) return defaultFilename;
      var localizedManifest = localizedManifests.find(function (app) {
        return pathname.startsWith(app.start_url);
      });
      if (!localizedManifest) return defaultFilename;
 ...
 */
    !(function (name, definition) {
      ...
      var fns = [],
        ...
        loaded = doc &&
          (hack ? /^loaded|^c/ : /^loaded|^i|^c/).test(doc.readyState);
  ...
  /***/ (function (module, exports, __webpack_require__) {
    ...
    exports.components = {
      "component---src-pages-404-tsx": function componentSrcPages404Tsx() {
        return Promise.all(
          /* import() | component---src-pages-404-tsx */ [
            __webpack_require__.e(0),
            __webpack_require__.e(1),
            __webpack_require__.e(8),
          ],
        ).then(__webpack_require__.bind(null, 171));
      },
      "component---src-pages-codebox-tsx":
        function componentSrcPagesCodeboxTsx() {
          return Promise.all(
            /* import() | component---src-pages-codebox-tsx */ [
          ...
          ).then(__webpack_require__.bind(null, 118));
        },
      "component---src-pages-fun-tsx": function componentSrcPagesFunTsx() {
        return Promise.all(
          /* import() | component---src-pages-fun-tsx */ [
            __webpack_require__.e(3),
            __webpack_require__.e(0),
            __webpack_require__.e(2),
            __webpack_require__.e(4),
        ...
        ).then(__webpack_require__.bind(null, 121));
      },
      "component---src-pages-index-tsx": function componentSrcPagesIndexTsx() {
        return Promise.all(
          /* import() | component---src-pages-index-tsx */ [
            __webpack_require__.e(0),
            __webpack_require__.e(1),
            __webpack_require__.e(11),
          ],
        ).then(__webpack_require__.bind(null, 122));
      },
      "component---src-pages-offline-plugin-app-shell-fallback-tsx":
        function componentSrcPagesOfflinePluginAppShellFallbackTsx() {
          return Promise.all(
            /* import() | component---src-pages-offline-plugin-app-shell-fallback-tsx */ [
              __webpack_require__.e(0),
              __webpack_require__.e(1),
              __webpack_require__.e(12),
            ],
          ).then(__webpack_require__.bind(null, 124));
        },
      "component---src-pages-using-typescript-tsx":
        function componentSrcPagesUsingTypescriptTsx() {
          return Promise.all(
            /* import() | component---src-pages-using-typescript-tsx */ [
              __webpack_require__.e(0),
              __webpack_require__.e(1),
              __webpack_require__.e(13),
            ],
          ).then(__webpack_require__.bind(null, 125));
        },
      "component---src-pages-zoli-tsx": function componentSrcPagesZoliTsx() {
        return Promise.all(
          /* import() | component---src-pages-zoli-tsx */ [
            __webpack_require__.e(2),
            __webpack_require__.e(14),
          ],
        ).then(__webpack_require__.bind(null, 126));
      },
      "component---src-pages-zzz-tsx": function componentSrcPagesZzzTsx() {
        return Promise.all(
          /* import() | component---src-pages-zzz-tsx */ [
            __webpack_require__.e(3),
            __webpack_require__.e(0),
            __webpack_require__.e(2),
            __webpack_require__.e(4),
        ...
        ).then(__webpack_require__.bind(null, 163));
      },
      "component---src-templates-blog-post-tsx":
        function componentSrcTemplatesBlogPostTsx() {
          return Promise.all(
            /* import() | component---src-templates-blog-post-tsx */ [
              __webpack_require__.e(3),
              __webpack_require__.e(0),
              __webpack_require__.e(1),
              __webpack_require__.e(2),
          ...
          ).then(__webpack_require__.bind(null, 164));
        },
    };
  ...
  /***/ (function (module, __webpack_exports__, __webpack_require__) {
    "use strict";
    __webpack_require__.r(__webpack_exports__);
    /* harmony import */ var _api_runner_browser__WEBPACK_IMPORTED_MODULE_0__ =
      __webpack_require__(26);
    /* harmony import */ var _api_runner_browser__WEBPACK_IMPORTED_MODULE_0___default =
      /*#__PURE__*/ __webpack_require__.n(
        _api_runner_browser__WEBPACK_IMPORTED_MODULE_0__,
      );
    if (
      ...
      navigator.serviceWorker.register("" + "/sw.js").then(function (reg) {
        reg.addEventListener("updatefound", function () {
          Object(_api_runner_browser__WEBPACK_IMPORTED_MODULE_0__["apiRunner"])(
          ...
          installingWorker.addEventListener("statechange", function () {
            switch (installingWorker.state) {
              case "installed":
                if (navigator.serviceWorker.controller) { // At this point, the old content will have been purged and the fresh content will
                  ...
                  )("onServiceWorkerUpdateReady", { serviceWorker: reg }); // If resources failed for the current page, reload.
                  ...
                  )("onServiceWorkerInstalled", { serviceWorker: reg });
                }
                break;
              case "redundant":
                console.error(
                ...
                Object(
                  _api_runner_browser__WEBPACK_IMPORTED_MODULE_0__["apiRunner"],
                )("onServiceWorkerRedundant", { serviceWorker: reg });
                break;
              case "activated":
                Object(
                  _api_runner_browser__WEBPACK_IMPORTED_MODULE_0__["apiRunner"],
                )("onServiceWorkerActive", { serviceWorker: reg });
                break;
            }
          });
        });
  ...
  /***/ (function (module, __webpack_exports__, __webpack_require__) {
    ...
    var api_runner_browser = __webpack_require__(26);
    ...
    var gatsby_react_router_scroll = __webpack_require__(39);

    // EXTERNAL MODULE: /z/monorepo/node_modules/@mikaelkristiansson/domready/ready.js
    var ready = __webpack_require__(107);
    ...
    var redirects = __webpack_require__(108);
    ...
    var lib_history = __webpack_require__(14);

    // EXTERNAL MODULE: /z/monorepo/node_modules/gatsby-link/index.js
    var gatsby_link = __webpack_require__(3);
    ...
    var navigation_onPreRouteUpdate = function onPreRouteUpdate(
      location,
      prevLocation,
    ) {
      if (!maybeRedirect(location.pathname)) {
        Object(api_runner_browser["apiRunner"])(
          "onPreRouteUpdate",
          { location: location, prevLocation: prevLocation },
        );
      }
    };
    var navigation_onRouteUpdate = function onRouteUpdate(
      location,
      prevLocation,
    ) {
      if (!maybeRedirect(location.pathname)) {
    ...
    var navigation_navigate = function navigate(to, options) {
      if (options === void 0) options = {}; // Support forward/backward navigation with numbers
      // navigate(-2) (jumps back 2 history steps)
      // navigate(2)  (jumps forward 2 history steps)
      if (typeof to === "number") {
        lib_history["c"/* globalHistory */
        ].navigate(to);
        return;
      }
      ...
      var timeoutId = setTimeout(function () {
        emitter["a"/* default */
        ].emit("onDelayedLoadPageResources", { pathname: pathname });
        Object(api_runner_browser["apiRunner"])(
          "onRouteUpdateDelayed",
          { location: window.location },
        );
      }, 1000);
      loader["default"].loadPage(pathname).then(function (pageResources) { // If no page resources, then refresh the page
        ...
        if (
          !pageResources ||
          pageResources.status === loader["PageResourceStatus"].Error
        ) {
    ...
    function shouldUpdateScroll(prevRouterProps, _ref) {
      ...
      var results = Object(api_runner_browser["apiRunner"])(
        "shouldUpdateScroll",
        {
          prevRouterProps: prevRouterProps, // `pathname` for backwards compatibility
          pathname: pathname,
      ...
      if (results.length > 0) { // Use the latest registered shouldUpdateScroll result, this allows users to override plugin's configuration
        // @see https://github.com/gatsbyjs/gatsby/issues/12038
        return results[results.length - 1];
      }
      if (prevRouterProps) {
        var oldPathname = prevRouterProps.location.pathname;
        if (oldPathname === pathname) { // Scroll to element if it exists, if it doesn't, or no hash is provided,
          // scroll to top.
    ...
    function init() { // The "scroll-behavior" package expects the "action" to be on the location
      ...
      window.___push = function (to) {
        return navigation_navigate(to, { replace: false });
      };
      window.___replace = function (to) {
        return navigation_navigate(to, { replace: true });
      };
    ...
    var navigation_RouteAnnouncer = /*#__PURE__*/ function (_React$Component) {
      Object(
        inheritsLoose["a"/* default */
        ],
      )(RouteAnnouncer, _React$Component);
      function RouteAnnouncer(props) {
        var _this2;
        _this2 = _React$Component.call(this, props) || this;
        _this2.announcementRef = /*#__PURE__*/ react_default.a.createRef();
        return _this2;
      }
      ...
      _proto.render = function render() {
        return Object(
          core_browser_esm["b"/* jsx */
          ],
        )(
          "div",
          _extends({}, RouteAnnouncerProps, { ref: this.announcementRef }),
        );
      };
      return RouteAnnouncer;
    }(react_default.a.Component); // Fire on(Pre)RouteUpdate APIs
    var navigation_RouteUpdates = /*#__PURE__*/ function (_React$Component2) {
      Object(
        inheritsLoose["a"/* default */
        ],
      )(RouteUpdates, _React$Component2);
      ...
      _proto2.componentDidUpdate = function componentDidUpdate(prevProps) {
        if (
          this.props.location.href !== prevProps.location.href
        ) {
    ...
    var async_requires = __webpack_require__(109);
    var async_requires_default = /*#__PURE__*/ __webpack_require__.n(
      async_requires,
    );
    ...
    /* harmony default export */ var shallow_compare_es =
      (function (instance, nextProps, nextState) {
    ...
    var ensure_resources_EnsureResources = /*#__PURE__*/ function (
      _React$Component,
    ) {
      Object(
        inheritsLoose["a"/* default */
        ],
      )(EnsureResources, _React$Component);
      function EnsureResources(props) {
        var _this;
        _this = _React$Component.call(this) || this;
        var location = props.location, pageResources = props.pageResources;
        _this.state = {
          location: _objectSpread({}, location),
          pageResources: pageResources ||
            loader["default"].loadPageSync(location.pathname),
        };
        return _this;
      }
      EnsureResources.getDerivedStateFromProps =
        function getDerivedStateFromProps(_ref, prevState) {
          var location = _ref.location;
          if (prevState.location.href !== location.href) {
            var pageResources = loader["default"].loadPageSync(
              location.pathname,
            );
            return {
              pageResources: pageResources,
      ...
      _proto.loadResources = function loadResources(rawPath) {
        var _this2 = this;
        loader["default"].loadPage(rawPath).then(function (pageResources) {
          if (
            pageResources &&
            pageResources.status !== loader["PageResourceStatus"].Error
          ) {
      ...
      _proto.shouldComponentUpdate = function shouldComponentUpdate(
        ...
        if (this.state.pageResources !== nextState.pageResources) return true;
        if (
    ...
    }(react_default.a.Component); /* harmony default export */
    var ensure_resources = (ensure_resources_EnsureResources);
    // EXTERNAL MODULE: ./.cache/strip-prefix.js
    var strip_prefix = __webpack_require__(67);

    // EXTERNAL MODULE: ./.cache/_this_is_virtual_fs_path_/$virtual/match-paths.json
    var match_paths = __webpack_require__(110);

    // CONCATENATED MODULE: ./.cache/production-app.js
    // Generated during bootstrap
    var production_app_loader = new loader["ProdLoader"](
      async_requires_default.a,
      match_paths,
    );
    Object(loader["setLoader"])(production_app_loader);
    production_app_loader.setApiRunner(api_runner_browser["apiRunner"]);
    window.asyncRequires = async_requires_default.a;
    window.___emitter = emitter["a"/* default */
    ];
    window.___loader = loader["publicLoader"];
    init();
    Object(api_runner_browser["apiRunnerAsync"])("onClientEntry").then(
      function () { // Let plugins register a service worker. The plugin just needs
        // to return true.
        if (
          Object(api_runner_browser["apiRunner"])("registerServiceWorker")
            .length > 0
        ) {
        ...
        var RouteHandler = function RouteHandler(props) {
          return Object(
            ...
            Object(
              ...
              page_renderer["a"/* default */
              ],
              props,
            ),
          );
        };
        var DataContext = /*#__PURE__*/ react_default.a.createContext({});
        var GatsbyRoot = /*#__PURE__*/ function (_React$Component) {
          Object(
            inheritsLoose["a"/* default */
            ],
          )(GatsbyRoot, _React$Component);
          function GatsbyRoot() {
            return _React$Component.apply(this, arguments) || this;
          }
          ...
          _proto.render = function render() {
            ...
            )(es["Location"], null, function (_ref) {
              var location = _ref.location;
              return Object(
                core_browser_esm["b"/* jsx */
                ],
              )(ensure_resources, { location: location }, function (_ref2) {
                var pageResources = _ref2.pageResources,
                  location = _ref2.location;
                var staticQueryResults = Object(
                ...
                return Object(
                  ...
                  gatsby_browser_entry["StaticQueryContext"].Provider,
        ...
        var LocationHandler = /*#__PURE__*/ function (_React$Component2) {
          ...
          )(LocationHandler, _React$Component2);
          ...
          _proto2.render = function render() {
            ...
            )(DataContext.Consumer, null, function (_ref3) {
              var pageResources = _ref3.pageResources,
                location = _ref3.location;
              return Object(
                core_browser_esm["b"/* jsx */
                ],
              )(
                navigation_RouteUpdates,
                { location: location },
                Object(
                  core_browser_esm["b"/* jsx */
                  ],
                )(
                  gatsby_react_router_scroll["ScrollContext"],
                  {
                    location: location,
                  ...
                  Object(
                    ...
                    Object(
                      ...
                      _extends(
                        {
                          path: pageResources.page.path === "/404.html"
                            ? Object(
                              strip_prefix["a"/* default */
                              ],
                            )(location.pathname, "")
        ...
        var _window = window,
          ...
          browserLoc = _window.location; // Explicitly call navigate if the canonical path (window.pagePath)
        ...
        if (
          pagePath && "" + pagePath !== browserLoc.pathname &&
          !(production_app_loader.findMatchPath(
            Object(
              strip_prefix["a"/* default */
              ],
            )(browserLoc.pathname, ""),
          ) || pagePath === "/404.html" || pagePath.match(/^\/404\/?$/) ||
            pagePath.match(/^\/offline-plugin-app-shell-fallback\/?$/))
        ) {
          Object(es["navigate"])(
            "" + pagePath + browserLoc.search + browserLoc.hash,
            { replace: true },
          );
        }
        loader["publicLoader"].loadPage(browserLoc.pathname).then(
          function (page) {
            if (!page || page.status === loader["PageResourceStatus"].Error) {
              throw new Error(
                "page resources for " + browserLoc.pathname +
                  " not found. Not rendering React",
              );
            }
            window.___webpackCompilationHash = page.page.webpackCompilationHash;
            var SiteRoot = Object(api_runner_browser["apiRunner"])(
              "wrapRootElement",
              {
                element: Object(
                  core_browser_esm["b"/* jsx */
  ...
  /***/ (function (module, __webpack_exports__, __webpack_require__) {
    ...
    // EXPORTS
    __webpack_require__.d(__webpack_exports__, "wrapRootElement", function () {
      return /* binding */ wrapRootElement;
    });
    ...
    var mdx_components = __webpack_require__(89);

    // CONCATENATED MODULE: /z/monorepo/node_modules/gatsby-plugin-mdx/loaders/mdx-scopes.js
    var scope_0 = __webpack_require__(175).default;
    var scope_1 = __webpack_require__(90).default; /* harmony default export */
    var mdx_scopes = (Object.assign({}, scope_0, scope_1));
    // EXTERNAL MODULE: /z/monorepo/node_modules/@emotion/core/dist/core.browser.esm.js + 2 modules
    var core_browser_esm = __webpack_require__(1);
 ...
 */
    ...
    var wrap_root_element_componentFromGuards = function componentFromGuards(
      arr,
    ) {
    ...
    mdx_components["plugins"].forEach(function (_ref2) {
      ...
      Object.entries(components).forEach(function (_ref3) {
        var componentName = _ref3[0], Component = _ref3[1];
        if (componentsAndGuards[componentName]) {
          componentsAndGuards.push(
            { guard: guards[componentName], Component: Component },
          );
        } else {
    ...
    var components = Object.entries(componentsAndGuards).map(function (_ref4) {
      var _ref5;
      var name = _ref4[0], arr = _ref4[1];
      return _ref5 = {},
        _ref5[name] = wrap_root_element_componentFromGuards(
    ...
    var MDXConsumer = Object(esm["withMDXComponents"])(function (_ref6) {
      var componentsFromContext = _ref6.components, children = _ref6.children;
      return Object(
        core_browser_esm["b"/* jsx */
        ],
      )(
        ...
        Object(
          ...
          esm["MDXProvider"],
          {
            components: _objectSpread(
              _objectSpread({}, componentsFromContext),
              components,
            ),
          },
          children,
    ...
    var wrap_root_element_WrapRootElement = function WrapRootElement(_ref7) {
      var element = _ref7.element;
      return Object(
        core_browser_esm["b"/* jsx */
        ],
      )(MDXConsumer, null, element);
    }; /* harmony default export */
    var wrap_root_element = (wrap_root_element_WrapRootElement);
  ...
  /***/ (function (module, __webpack_exports__, __webpack_require__) {
    ...
    var Counter_Counter = function Counter(_ref) {
      ...
      var _useState = Object(react["useState"])(initial),
        clicks = _useState[0],
    ...
    /* harmony default export */ var _619e4c1544d023b87009049ac4fcd614 =
      __webpack_exports__["default"] =
        ({ Counter: Counter_Counter, React: react });
