 ...
 */
        ...
        function p(a) {
          for (
            var b = "https://reactjs.org/docs/error-decoder.html?invariant=" +
                a,
              c = 1;
            c < arguments.length;
            c++
        ...
        function va(a, b, c, d) {
          if (
            null === b || "undefined" === typeof b || ua(a, b, c, d)
          ) {
            return !0;
          }
          if (d) return !1;
        ...
        var cb = function () {
          ...
          b.renderDOM = function (a, b, f) {
            ...
            if (g = d) {
              if (
                Pa[c] &&
                (null != g.children || null != g.dangerouslySetInnerHTML)
              ) {
                throw Error(p(137, c));
              }
      ...
      /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        async function renderWorker(code, props) {
          try {
            ...
            const Counter = (props) =>
              componentFactory(props, react__WEBPACK_IMPORTED_MODULE_0__);

            return react_dom_server__WEBPACK_IMPORTED_MODULE_1___default.a
              .renderToString(
