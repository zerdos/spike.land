class e {
  constructor(e) {
    this._insertTag = (e) => {
      let t;
      t = 0 === this.tags.length
        ? this.prepend ? this.container.firstChild : this.before
  ...
  insert(e) {
    ...
    if ("production" !== process.env.NODE_ENV) {
      ...
      t && this._alreadyInsertedOrderInsensitiveRule &&
      console.error(
    ...
    if (this.isSpeedy) {
      ...
      try {
        ...
        "production" === process.env.NODE_ENV ||
          /:(-moz-placeholder|-ms-input-placeholder|-moz-read-write|-moz-read-only){/
            .test(e) ||
          console.error(
