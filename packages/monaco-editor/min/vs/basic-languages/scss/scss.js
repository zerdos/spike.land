    ...
    Object.defineProperty(t, "__esModule", { value: !0 }),
      ...
      t.language = {
        ...
        tokenizer: {
          ...
          declarationbody: [{ include: "@term" }, [";", "delimiter", "@pop"], [
            "(?=})",
            { token: "", next: "@pop" },
          ]],
          extendbody: [{ include: "@selectorname" }, ["!optional", "literal"], [
            ";",
            "delimiter",
            "@pop",
          ], ["(?=})", { token: "", next: "@pop" }]],
          variablereference: [["\\$@identifier", "variable.ref"], [
            "\\.\\.\\.",
            "operator",
