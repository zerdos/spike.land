            ...
            for (
              ...
              switch (U) {
                    ...
                    return 0 === t.line &&
                      (H = void 0,
                        ...
                        d.items.push({
                          ...
                          textEdit: i.TextEdit.replace(H, "!DOCTYPE html>"),
                          insertTextFormat: i.InsertTextFormat.PlainText,
                        })),
                      E(_, W);
                  }
                ...
                case i.TokenType.DelimiterAssign:
                  if (y.getTokenEnd() === _) {
                    W = C(i.TokenType.AttributeValue);
                    return R(_, W);
                  }
                  break;
                case i.TokenType.AttributeValue:
                  if (y.getTokenOffset() <= _ && _ <= y.getTokenEnd()) {
                    return R(y.getTokenOffset(), y.getTokenEnd());
                  }
                  break;
                case i.TokenType.Whitespace:
                  if (_ <= y.getTokenEnd()) {
                    switch (y.getScannerState()) {
                      case i.ScannerState.AfterOpeningStartTag:
                        return E(y.getTokenOffset(), C(i.TokenType.StartTag));
                      case i.ScannerState.WithinTag:
                      case i.ScannerState.AfterAttributeName:
                        return A(y.getTokenEnd());
                      case i.ScannerState.BeforeAttributeValue:
                        return R(y.getTokenEnd());
                      case i.ScannerState.AfterOpeningEndTag:
                ...
                case i.TokenType.EndTagOpen:
                  if (_ <= y.getTokenEnd()) {
                    return L(y.getTokenOffset() + 1, !1, C(i.TokenType.EndTag));
                  }
                  break;
                case i.TokenType.EndTag:
                  if (_ <= y.getTokenEnd()) {
                    for (var D = y.getTokenOffset() - 1; D >= 0;) {
                      var O = b.charAt(D);
                      if ("/" === O) return L(D, !1, y.getTokenEnd());
                      if (!p(O)) break;
                      D--;
                    }
                  }
...
define(
  ...
  ["require", "exports", "vscode-html-languageservice"],
  (function (e, t, n) {
    "use strict";
    Object.defineProperty(t, "__esModule", { value: !0 }),
          ...
          return __awaiter(
            ...
            (function () {
              ...
              return __generator(
                this,
                (function (o) {
                  return i = this._getTextDocument(e),
                    r = __assign(
                      __assign({}, this._languageSettings.format),
                      n,
                    ),
