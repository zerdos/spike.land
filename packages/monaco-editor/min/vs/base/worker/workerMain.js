        ...
        return s.prototype.attachListeners = function (u, d, N) {
          ...
          s.prototype.load = function (u, d, N, a) {
            if (/^node\|/.test(d)) {
              ...
              var m = u.getConfig().getOptionsLiteral().trustedTypesPolicy;
              m && (d = m.createScriptURL(d)), r.setAttribute("src", d);
          ...
          s.prototype._initNodeRequire = function (u, d) {
            ...
            if (!!N && !this._didPatchNodeRequire) {
              ...
              function _(v) {
                ...
                return r.resolve = function (f, l) {
                  return i._resolveFilename(f, v, !1, l);
                },
              ...
              b.prototype._compile = function (v, i) {
                var r = b.wrap(v.replace(/^#!.*/, "")),
                  ...
                  n;
                try {
                  var g = a._fs.readFileSync(f);
                  n = g.slice(0, 16),
                    l.cachedData = g.slice(16),
                    m.record(60, f);
                } catch (M) {
                  m.record(61, f);
                }
          ...
          s.prototype.load = function (u, d, N, a) {
            ...
            if (/^node\|/.test(d)) {
              ...
              var l = this._path.normalize(d),
                ...
                g = Boolean(_.nodeCachedData),
                S = g ? this._getCachedDataPath(_.nodeCachedData, d) : void 0;
              this._readSourceAndCachedData(l, S, r, function (w, c, C, L) {
                ...
                b._handleCachedData(R, A, S, g && !C, u),
          ...
          s.prototype._readSourceAndCachedData = function (u, d, N, a) {
            if (!d)this._fs.readFile(u, { encoding: "utf8" }, a);
              ...
              var b = void 0,
                ...
                i = 2,
                r = function (m) {
                  m ? a(m) : --i == 0 && a(void 0, b, _, v);
                };
              this._fs.readFile(u, { encoding: "utf8" }, function (m, f) {
                b = f, r(m);
              }),
                this._fs.readFile(d, function (m, f) {
                  !m && f && f.length > 0
      ...
      return s.prototype.reset = function () {
          ...
          for (
            ...
            if (v) {
              ...
              if (i = i.substr(f), i = N(i), i === a) {
                var l = { line: parseInt(r, 10), col: parseInt(m, 10) };
                return l.line === 1 &&
                  (l.col -=
          ...
          this._modules2[i] = r,
            ...
            (this._buildInfoDefineStack[i] = b,
              this._buildInfoDependencies[i] = (r.dependencies || []).map(
                function (m) {
                  return v._moduleIdProvider.getStrModuleId(m.id);
                },
              )),
            this._resolve(r);
        },
        ...
        s.prototype._onLoadError = function (u, d) {
          ...
          for (i.push(u), a[u] = !0; i.length > 0;) {
            var r = i.shift(), m = this._modules2[r];
            m && (v = m.onDependencyError(N) || v);
          ...
          for (v.push(N), a[u] = !0; v.length > 0;) {
            ...
            if (r) {
              for (var b = 0, _ = r.length; b < _; b++) {
                var m = r[b];
                if (m.id === d) return !0;
                var f = this._modules2[m.id];
                f && !a[m.id] && (a[m.id] = !0, v.push(f));
              }
            }
          }
          return !1;
...
`),
              ...
              if (
                ...
                var m = this._inversePluginDependencies2.get(_.pluginId);
                m ||
                (m = [], this._inversePluginDependencies2.set(_.pluginId, m)),
                  m.push(_),
        ...
        s.prototype._onModuleComplete = function (u) {
          ...
          if (!u.isComplete()) {
            ...
            var m = this._inverseDependencies2[u.id];
            if (this._inverseDependencies2[u.id] = null, m) {
              for (var _ = 0, v = m.length; _ < v; _++) {
                var f = m[_], l = this._modules2[f];
...
` + b.stack,
    ...
    V(z[16], G([0, 1]), function (I, t) {
      ...
      (function (P) {
        ...
        P.slice = r;
        function m(f, l = Number.POSITIVE_INFINITY) {
          const n = [];
          if (l === 0) return [n, f];
    ...
    V(z[17], G([0, 1, 4]), function (I, t, p) {
      ...
      class P {
        ...
        define(r, m) {
          this._keyCodeToStr[r] = m, this._strToKeyCode[m.toLowerCase()] = r;
        }
        keyCodeToStr(r) {
      ...
      (function () {
        function i(r, m, f = m, l = f) {
          E.define(r, m), o.define(r, f), h.define(r, l);
        }
        i(0, "unknown"),
          i(1, "Backspace"),
          i(2, "Tab"),
      ...
      (function (i) {
        function r(g) {
          return E.keyCodeToStr(g);
        }
        i.toString = r;
        function m(g) {
          return E.strToKeyCode(g);
        }
        i.fromString = m;
        function f(g) {
          return o.keyCodeToStr(g);
        }
        i.toUserSettingsUS = f;
        function l(g) {
          return h.keyCodeToStr(g);
        }
        i.toUserSettingsGeneral = l;
        function n(g) {
          return o.strToKeyCode(g) || h.strToKeyCode(g);
        }
      ...
      function d(i, r) {
        if (i === 0) return null;
        const m = (i & 65535) >>> 0, f = (i & 4294901760) >>> 16;
        return f !== 0 ? new b([N(m, r), N(f, r)]) : new b([N(m, r)]);
      }
      ...
      function N(i, r) {
        const m = !!(i & 2048),
          ...
          S = r === 2 ? m : f,
          w = i & 255;
        return new a(l, n, g, S, w);
      }
      t.createSimpleKeybinding = N;
      class a {
        constructor(r, m, f, l, n) {
          this.ctrlKey = r,
            this.shiftKey = m,
            this.altKey = f,
            this.metaKey = l,
    ...
    V(z[7], G([0, 1, 16]), function (I, t, p) {
      ...
      class v {
        ...
        set value(m) {
          var f;
          this._isDisposed || m === this._value ||
    ...
    V(z[20], G([0, 1, 19]), function (I, t, p) {
      ...
      class b extends Error {
        constructor(n, g, S) {
          ...
          typeof g == "string" && g.indexOf("not ") === 0
            ? (w = "must not be", g = g.replace(/^not /, ""))
            : w = "must be";
          const c = n.indexOf(".") !== -1 ? "property" : "argument";
          let C = `The "${n}" ${c} ${w} of type ${g}`;
            ...
            if (!(C === M - 1 || L === 1)) {
              if (L === 2) {
                if (
                  ...
                  if (w.length > 2) {
                    const R = w.lastIndexOf(g);
                    R === -1
                      ? (w = "", c = 0)
                      : (w = w.slice(0, R),
                        c = w.length - 1 - w.lastIndexOf(g)),
                      C = M,
                      L = 0;
                    continue;
                  } else if (w.length !== 0) {
      ...
      function f(l, n) {
        ...
        const g = n.dir || n.root,
          S = n.base || `${n.name || ""}${n.ext || ""}`;
        return g ? g === n.root ? `${g}${S}` : `${g}${l}${S}` : S;
      }
      t.win32 = {
        resolve(...l) {
          let n = "", g = "", S = !1;
          for (let w = l.length - 1; w >= -1; w--) {
            ...
            else if (g = `${c.slice(L)}\\${g}`, S = M, M && n.length > 0) break;
          }
          return g = m(g, !S, "\\", v),
            S
              ? `${n}\\${g}`
        ...
        normalize(l) {
          ...
          if (v(c)) {
            ...
            r(c) && l.charCodeAt(1) === N &&
              (S = l.slice(0, 2),
                g = 2,
                n > 2 && v(l.charCodeAt(2)) && (w = !0, g = 3));
          }
          let C = g < n ? m(l.slice(g), !w, "\\", v) : "";
        ...
        isAbsolute(l) {
          ...
          return v(g) ||
            n > 2 && r(g) && l.charCodeAt(1) === N && v(l.charCodeAt(2));
        },
        join(...l) {
          ...
          for (let c = 0; c < l.length; ++c) {
            const C = l[c];
            _(C, "path"),
              C.length > 0 && (n === void 0 ? n = g = C : n += `\\${C}`);
          }
          if (n === void 0) return ".";
          let S = !0, w = 0;
          if (typeof g == "string" && v(g.charCodeAt(0))) {
            ++w;
            const c = g.length;
            c > 1 && v(g.charCodeAt(1)) &&
              (++w, c > 2 && (v(g.charCodeAt(2)) ? ++w : S = !1));
          }
          if (S) {
        ...
        relative(l, n) {
          ...
          const g = t.win32.resolve(l), S = t.win32.resolve(n);
          if (g === S || (l = g.toLowerCase(), n = S.toLowerCase(), l === n)) {
            return "";
          }
          let w = 0;
        ...
        toNamespacedPath(l) {
          ...
          if (n.charCodeAt(0) === d) {
            if (n.charCodeAt(1) === d) {
              const g = n.charCodeAt(2);
              if (g !== a && g !== s) return `\\\\?\\UNC\\${n.slice(2)}`;
            }
          } else if (
        ...
        dirname(l) {
          ...
          if (v(w)) {
            ...
            r(w) && l.charCodeAt(1) === N &&
              (g = n > 2 && v(l.charCodeAt(2)) ? 3 : 2, S = g);
          }
          let c = -1, C = !0;
          for (let L = n - 1; L >= S; --L) {
            if (v(l.charCodeAt(L))) {
        ...
        basename(l, n) {
          ...
          if (
            ...
            (g = 2), n !== void 0 && n.length > 0 && n.length <= l.length
          ) {
            if (n === l) return "";
            let C = n.length - 1, L = -1;
            for (c = l.length - 1; c >= g; --c) {
            ...
            return g === S ? S = L : S === -1 && (S = l.length), l.slice(g, S);
          }
          for (c = l.length - 1; c >= g; --c) {
            if (v(l.charCodeAt(c))) {
              if (!w) {
          ...
          return S === -1 ? "" : l.slice(g, S);
        },
        extname(l) {
          _(l, "path");
          let n = 0, g = -1, S = 0, w = -1, c = !0, C = 0;
        ...
        parse(l) {
          ...
          if (g === 1) {return v(w) ? (n.root = n.dir = l, n)
            : (n.base = n.name = l, n);}
          if (v(w)) {
            if (S = 1, v(l.charCodeAt(1))) {
              let D = 2, T = D;
              for (; D < g && !v(l.charCodeAt(D));) D++;
              if (D < g && D !== T) {
                for (T = D; D < g && v(l.charCodeAt(D));) D++;
                if (D < g && D !== T) {
                  for (T = D; D < g && !v(l.charCodeAt(D));) D++;
                  D === g ? S = D : D !== T && (S = D + 1);
                }
            ...
            if (g <= 2) return n.root = n.dir = l, n;
            if (S = 2, v(l.charCodeAt(2))) {
              if (g === 3) return n.root = n.dir = l, n;
              S = 3;
            }
          }
        ...
        t.posix = {
          resolve(...l) {
            ...
            for (let S = l.length - 1; S >= -1 && !g; S--) {
              ...
              _(w, "path"),
                w.length !== 0 && (n = `${w}/${n}`, g = w.charCodeAt(0) === u);
            }
            return n = m(n, !g, "/", i), g ? `/${n}` : n.length > 0 ? n : ".";
          },
          normalize(l) {
            if (_(l, "path"), l.length === 0)return ".";
            const n = l.charCodeAt(0) === u,
              g = l.charCodeAt(l.length - 1) === u;
            return l = m(l, !n, "/", i),
              l.length === 0
                ? n
                  ? "/"
          ...
          relative(l, n) {
            ...
            if (M === L) {
              if (C > L) {
                ...
                w > L &&
                  (l.charCodeAt(g + M) === u ? A = M : M === 0 && (A = 0));
              }
            }
            let R = "";
            for (
          ...
          parse(l) {
            ...
            return c > 0 ? n.dir = l.slice(0, c - 1) : g && (n.dir = "/"), n;
          },
          sep: "/",
          delimiter: ":",
          win32: null,
...
`).slice(3).join(`
`),
              f = this._stacks.get(m) || 0;
            if (
              this._stacks.set(m, f + 1),
                this._warnCountdown -= 1,
                this._warnCountdown <= 0
            ) {
              this._warnCountdown = r * .5;
              let l, n = 0;
              for (const [g, S] of this._stacks)(!l || n < S) && (l = g, n = S);
              console.warn(
                `[${this.name}] potential listener LEAK detected, having ${i} listeners already. MOST frequent listener (${n}):`,
              ), console.warn(l);
            }
            return () => {
              const l = this._stacks.get(m) || 0;
              this._stacks.set(m, l - 1);
            };
          }
        }
      }
      class N {
        ...
        get event() {
          return this._event || (this._event = (i, r, m) => {
            var f;
            ...
            const g = (f = this._leakageMon) === null || f === void 0
              ? void 0
      ...
      class b {
          ...
          return (r, m, f) =>
            i(
              (l) => {
                ...
                n ? n.push(() => r.call(m, l)) : r.call(m, l);
              },
              void 0,
              f,
            );
        ...
        bufferEvents(i) {
          ...
          this.buffers.push(r);
          const m = i();
          return this.buffers.pop(), r.forEach((f) => f()), m;
        }
      }
      t.EventBufferer = b;
      class _ {
    ...
    V(z[5], G([0, 1]), function (I, t) {
      ...
      function me(y) {
        return y >= 127462 && y <= 127487 || y === 8986 || y === 8987 ||
          y === 9200 || y === 9203 || y >= 9728 && y <= 10175 || y === 11088 ||
          y === 11093 || y >= 127744 && y <= 128591 ||
          y >= 128640 && y <= 128764 || y >= 128992 && y <= 129003 ||
          y >= 129280 && y <= 129535 || y >= 129648 && y <= 129750;
      }
    ...
    V(z[22], G([0, 1, 5]), function (I, t, p) {
      ...
      function s(i, r) {
        r = o(149417, r);
        for (let m = 0, f = i.length; m < f; m++) r = o(i.charCodeAt(m), r);
        return r;
      }
      t.stringHash = s;
      function u(i, r) {
        return r = o(104579, r), i.reduce((m, f) => E(f, m), r);
      }
      function d(i, r) {
        return r = o(181387, r),
          Object.keys(i).sort().reduce((m, f) => (m = s(f, m), E(i[f], m)), r);
      }
      function N(i, r, m = 32) {
        const f = m - r, l = ~((1 << f) - 1);
        return (i << r | (l & i) >>> f) >>> 0;
      }
      function a(i, r = 0, m = i.byteLength, f = 0) {
        for (let l = 0; l < m; l++) i[r + l] = f;
      }
      function b(i, r, m = "0") {
        for (; i.length < r;) i = m + i;
        return i;
      }
      function _(i, r = 32) {
        return i instanceof ArrayBuffer
          ? Array.from(new Uint8Array(i)).map((m) =>
      ...
      class v {
        ...
        update(r) {
          ...
          if (m !== 0) {
            const f = this._buff;
            let l = this._buffLen, n = this._leftoverHighSurrogate, g, S;
            for (
              n !== 0 ? (g = n, S = -1, n = 0) : (g = r.charCodeAt(0), S = 0);;
            ) {
              let w = g;
              if (p.isHighSurrogate(g)) {
                if (S + 1 < m) {
                  const c = r.charCodeAt(S + 1);
                  p.isLowSurrogate(c) ? (S++, w = p.computeCodePoint(g, c))
                  : w = 65533;
                } else {
                  n = g;
                  break;
                }
              } else p.isLowSurrogate(g) && (w = 65533);
              if (l = this._push(f, l, w), S++, S < m) g = r.charCodeAt(S);
              else break;
            }
        ...
        _push(r, m, f) {
          return f < 128 ? r[m++] = f : f < 2048
            ? (r[m++] = 192 | (f & 1984) >>> 6, r[m++] = 128 | (f & 63) >>> 0)
            : f < 65536
            ? (r[m++] = 224 | (f & 61440) >>> 12,
              r[m++] = 128 | (f & 4032) >>> 6,
              r[m++] = 128 | (f & 63) >>> 0)
            : (r[m++] = 240 | (f & 1835008) >>> 18,
              r[m++] = 128 | (f & 258048) >>> 12,
              r[m++] = 128 | (f & 4032) >>> 6,
              r[m++] = 128 | (f & 63) >>> 0),
            m >= 64 &&
        ...
        _step() {
          const r = v._bigBlock32, m = this._buffDV;
          for (let L = 0; L < 64; L += 4) {
            r.setUint32(L, m.getUint32(L, !1), !1);
          }
          ...
          for (
            ...
            L < 20
              ? (w = l & n | ~l & g, c = 1518500249)
              : L < 40
              ? (w = l ^ n ^ g, c = 1859775393)
              : L < 60
              ? (w = l & n | l & g | n & g, c = 2400959708)
              : (w = l ^ n ^ g, c = 3395469782),
          ...
          this._h0 = this._h0 + f & 4294967295,
            ...
            this._h3 = this._h3 + g & 4294967295,
    ...
    V(z[10], G([0, 1, 15, 22]), function (I, t, p, P) {
      ...
      class d {
        constructor(a, b, _ = null) {
          ...
          const [v, i, r] = d._getElements(a), [m, f, l] = d._getElements(b);
        ...
        _ComputeDiff(a, b, _, v, i) {
          const r = [!1];
          let m = this.ComputeDiffRecursive(a, b, _, v, r);
          return i && (m = this.PrettifyChanges(m)),
            { quitEarly: r[0], changes: m };
        }
        ComputeDiffRecursive(a, b, _, v, i) {
          ...
          if (a > b || _ > v) {
            ...
            return _ <= v
              ? (h.Assert(
                ...
                g = [new p.DiffChange(a, 0, _, v - _ + 1)])
              : a <= b
              ? (h.Assert(
                _ === v + 1,
                "modifiedStart should only be one more than modifiedEnd",
              ),
                g = [new p.DiffChange(a, b - a + 1, _, 0)])
              : (h.Assert(
                a === b + 1,
                "originalStart should only be one more than originalEnd",
              ),
          ...
          const r = [0],
            m = [0],
            f = this.ComputeRecursionPoint(a, b, _, v, r, m, i),
            l = r[0],
            n = m[0];
          if (f !== null) return f;
          if (!i[0]) {
            const g = this.ComputeDiffRecursive(a, l, _, n, i);
            let S = [];
            return i[0]
              ? S = [
                new p.DiffChange(
              ...
              this.ConcatenateChanges(g, S);
          }
          return [new p.DiffChange(a, b - a + 1, _, v - _ + 1)];
        }
        WALKTRACE(a, b, _, v, i, r, m, f, l, n, g, S, w, c, C, L, A, M) {
          let R = null,
            D = null,
            T = new u(),
            $ = b,
          ...
          do {
            ...
            H === $ || H < k && l[H - 1] < l[H + 1]
              ? (g = l[H + 1],
                c = g - F - v,
                g < e && T.MarkNextChange(),
                e = g,
                T.AddModifiedElement(g + 1, c),
                F = H + 1 - a)
              : (g = l[H - 1] + 1,
                c = g - F - v,
                g < e && T.MarkNextChange(),
                e = g - 1,
                T.AddOriginalElement(g, c + 1),
                F = H - 1 - a),
              O >= 0 &&
            ...
            do {
              ...
              H === $ || H < k && n[H - 1] >= n[H + 1]
                ? (g = n[H + 1] - 1,
                  ...
                  g > e && T.MarkNextChange(),
                  e = g + 1,
                  T.AddOriginalElement(g + 1, c + 1),
                  F = H + 1 - i)
                : (g = n[H - 1],
                  c = g - F - f,
                  g > e && T.MarkNextChange(),
                  e = g,
                  T.AddModifiedElement(g + 1, c + 1),
                  F = H - 1 - i),
                O >= 0 &&
        ...
        ComputeRecursionPoint(a, b, _, v, i, r, m) {
          let f = 0, l = 0, n = 0, g = 0, S = 0, w = 0;
          a--,
            _--,
            i[0] = 0,
            r[0] = 0,
          ...
          for (let F = 1; F <= c / 2 + 1; F++) {
            ...
            n = this.ClipDiagonalBound(M - F, F, M, C),
              g = this.ClipDiagonalBound(M + F, F, M, C);
            for (let B = n; B <= g; B += 2) {
              B === n || B < g && L[B - 1] < L[B + 1]
                ? f = L[B + 1]
                : f = L[B - 1] + 1, l = f - (B - M) - D;
            ...
            if (F <= 1447) {
              let B = new Int32Array(g - n + 2);
              B[0] = M - n + 1,
                s.Copy2(L, n, B, 1, g - n + 1),
        ...
        PrettifyChanges(a) {
          ...
          for (let b = a.length - 1; b >= 0; b--) {
            ...
            const r = _.originalLength > 0, m = _.modifiedLength > 0;
            let f = 0,
            ...
            for (let n = 1;; n++) {
              const g = _.originalStart - n, S = _.modifiedStart - n;
              if (
                g < v || S < i ||
                r && !this.OriginalElementsAreEqual(g, g + _.originalLength) ||
                m && !this.ModifiedElementsAreEqual(S, S + _.modifiedLength)
              ) {
                break;
              }
          ...
          if (this._hasStrings) {
            for (let b = 1, _ = a.length; b < _; b++) {
              const v = a[b - 1],
                ...
                l = f - m,
                n = v.modifiedStart,
                g = i.modifiedStart + i.modifiedLength,
                S = g - n;
              if (r < 5 && l < 20 && S < 20) {
                const w = this._findBetterContiguousSequence(m, l, n, S, r);
                if (w) {
                  const [c, C] = w;
                  (c !== v.originalStart + v.originalLength ||
                    ...
                    (v.originalLength = c - v.originalStart,
                      ...
                      i.modifiedLength = g - i.modifiedStart);
                }
              }
            }
          }
        ...
        _findBetterContiguousSequence(a, b, _, v, i) {
          ...
          const r = a + b - i + 1, m = _ + v - i + 1;
          let f = 0, l = 0, n = 0;
          for (let g = a; g < r; g++) {
            for (let S = _; S < m; S++) {
              const w = this._contiguousSequenceScore(g, S, i);
              w > 0 && w > f && (f = w, l = g, n = S);
            }
          }
          return f > 0 ? [l, n] : null;
        ...
        ChangesOverlap(a, b, _) {
          if (
            ...
            return a.originalStart + a.originalLength >= b.originalStart &&
              ...
              a.modifiedStart + a.modifiedLength >= b.modifiedStart &&
              (m = b.modifiedStart + b.modifiedLength - a.modifiedStart),
              _[0] = new p.DiffChange(v, i, r, m),
              !0;
          } else return _[0] = null, !1;
        }
        ClipDiagonalBound(a, b, _, v) {
          if (a >= 0 && a < v) return a;
          const i = _, r = v - _ - 1, m = b % 2 == 0;
          if (a < 0) {
            const f = i % 2 == 0;
            return m === f ? 0 : 1;
          } else {
    ...
    V(z[13], G([0, 1, 2, 20]), function (I, t, p, P) {
        ...
        static isUri(C) {
          return C instanceof _
            ...
            ? typeof C.authority == "string" && typeof C.fragment == "string" &&
              ...
              typeof C.scheme == "string" && typeof C.fsPath == "string" &&
      ...
      function g(c) {
        try {
          ...
          return c.length > 3 ? c.substr(0, 3) + g(c.substr(3)) : c;
        }
      }
      const S = /(%[0-9A-Za-z][0-9A-Za-z])+/g;
      function w(c) {
        return c.match(S) ? c.replace(S, (C) => g(C)) : c;
      }
    }),
    V(z[34], G([0, 1, 4, 7, 2, 11]), function (I, t, p, P, E, o) {
      ...
      class d {
        ...
        sendMessage(v, i) {
          ...
          return new Promise((m, f) => {
            this._pendingReplies[r] = { resolve: m, reject: f },
              this._send({
        ...
        _send(v) {
          ...
          if (v.req) {
            const r = v;
            for (
              let m = 0; m < r.args.length; m++
            ) {
              r.args[m] instanceof ArrayBuffer && i.push(r.args[m]);
            }
          } else {
            const r = v;
      ...
      class N extends P.Disposable {
        constructor(v, i, r) {
          ...
          this._worker = this._register(
            v.create("vs/base/common/worker/simpleWorker", (g) => {
            ...
            this._protocol = new d({
              sendMessage: (g, S) => {
                this._worker.postMessage(g, S);
              },
              handleMessage: (g, S) => {
                if (typeof r[g] != "function") {
                  return Promise.reject(
                    new Error("Missing method " + g + " on main thread host."),
                  );
                }
                try {
                  return Promise.resolve(r[g].apply(r, S));
                } catch (w) {
          ...
          const n = (g, S) => this._request(g, S);
          this._lazyProxy = new Promise((g, S) => {
            m = S,
              this._onModuleLoaded.then((w) => {
                g(o.createProxyObject(w, n));
              }, (w) => {
        ...
        _request(v, i) {
          return new Promise((r, m) => {
            this._onModuleLoaded.then(() => {
              this._protocol.sendMessage(v, i).then(r, m);
            }, m);
          });
        }
        _onError(v, i) {
      ...
      class a {
        ...
        initialize(v, i, r, m) {
          ...
          const f = (n, g) => this._protocol.sendMessage(n, g),
            l = o.createProxyObject(m, f);
    ...
    V(z[26], G([0, 1, 10, 5]), function (I, t, p, P) {
      ...
      const E = 3;
      function o(i, r, m, f) {
        return new p.LcsDiff(i, r, m).ComputeDiff(f);
      }
      class h {
        constructor(r) {
          const m = [], f = [];
          for (let l = 0, n = r.length; l < n; l++) {
            m[l] = b(r[l], 1), f[l] = _(r[l], 1);
          }
          this.lines = r, this._startColumns = m, this._endColumns = f;
        }
        getElements() {
          const r = [];
          for (let m = 0, f = this.lines.length; m < f; m++) {
        ...
        createCharSequence(r, m, f) {
          ...
          for (let w = m; w <= f; w++) {
            ...
            for (let A = C; A < L; A++) {
              l[S] = c.charCodeAt(A - 1), n[S] = w + 1, g[S] = A, S++;
            }
          }
          return new s(l, n, g);
        }
      ...
      class s {
        constructor(r, m, f) {
          this._charCodes = r, this._lineNumbers = m, this._columns = f;
        }
        getElements() {
      ...
      class u {
        constructor(r, m, f, l, n, g, S, w) {
          this.originalStartLineNumber = r,
            ...
            this.modifiedStartColumn = g,
            this.modifiedEndLineNumber = S,
            this.modifiedEndColumn = w;
        }
        static createFromDiffChange(r, m, f) {
          let l, n, g, S, w, c, C, L;
          return r.originalLength === 0
            ? (l = 0, n = 0, g = 0, S = 0)
            : (l = m.getStartLineNumber(r.originalStart),
              n = m.getStartColumn(r.originalStart),
              g = m.getEndLineNumber(r.originalStart + r.originalLength - 1),
              S = m.getEndColumn(r.originalStart + r.originalLength - 1)),
            r.modifiedLength === 0
              ? (w = 0, c = 0, C = 0, L = 0)
      ...
      function d(i) {
        ...
        for (let f = 1, l = i.length; f < l; f++) {
          const n = i[f],
            g = n.originalStart - (m.originalStart + m.originalLength),
            S = n.modifiedStart - (m.modifiedStart + m.modifiedLength);
          Math.min(g, S) < E
            ? (m.originalLength = n.originalStart + n.originalLength -
              m.originalStart,
              m.modifiedLength = n.modifiedStart + n.modifiedLength -
                m.modifiedStart)
            : (r.push(n), m = n);
        }
        return r;
      ...
      class N {
        ...
        static createFromDiffResult(r, m, f, l, n, g, S) {
          let w, c, C, L, A;
          if (
            m.originalLength === 0
              ? (w = f.getStartLineNumber(m.originalStart) - 1, c = 0)
              : (w = f.getStartLineNumber(m.originalStart),
                c = f.getEndLineNumber(m.originalStart + m.originalLength - 1)),
              m.modifiedLength === 0
                ? (C = l.getStartLineNumber(m.modifiedStart) - 1, L = 0)
                : (C = l.getStartLineNumber(m.modifiedStart),
                  L = l.getEndLineNumber(
                    m.modifiedStart + m.modifiedLength - 1,
                  )),
              g && m.originalLength > 0 && m.originalLength < 20 &&
              m.modifiedLength > 0 && m.modifiedLength < 20 && n()
          ) {
      ...
      class a {
        ...
        computeDiff() {
          ...
          const l = [];
          let n = 0, g = 0;
          for (let S = -1, w = m.length; S < w; S++) {
            const c = S + 1 < w ? m[S + 1] : null,
              C = c ? c.originalStart : this.originalLines.length,
              L = c ? c.modifiedStart : this.modifiedLines.length;
            for (; n < C && g < L;) {
              const A = this.originalLines[n], M = this.modifiedLines[g];
              if (A !== M) {
                {
                  let R = b(A, 1), D = b(M, 1);
                  for (; R > 1 && D > 1;) {
        ...
        _pushTrimWhitespaceCharChange(r, m, f, l, n, g, S) {
          if (!this._mergeTrimWhitespaceCharChange(r, m, f, l, n, g, S)) {
            let w;
            this.shouldComputeCharChanges &&
            (w = [new u(m, f, m, l, n, g, n, S)]), r.push(new N(m, m, n, n, w));
          }
        }
        _mergeTrimWhitespaceCharChange(r, m, f, l, n, g, S) {
          const w = r.length;
          if (w === 0) return !1;
          const c = r[w - 1];
          return c.originalEndLineNumber === 0 || c.modifiedEndLineNumber === 0
            ...
            ? (c.originalEndLineNumber = m,
              ...
              c.charChanges.push(new u(m, f, m, l, n, g, n, S)),
              !0)
            : !1;
        }
      }
      t.DiffComputer = a;
      function b(i, r) {
        const m = P.firstNonWhitespaceIndex(i);
        return m === -1 ? r : m + 1;
      }
      function _(i, r) {
        const m = P.lastNonWhitespaceIndex(i);
        return m === -1 ? r : m + 2;
      }
      function v(i) {
        if (i === 0) return () => !0;
    ...
    V(z[27], G([0, 1]), function (I, t) {
      ...
      function o(s, u, d, N, a = E) {
        ...
        for (let r = 1; !(Date.now() - b >= a.timeBudget); r++) {
          const m = _ - a.windowSize * r;
          u.lastIndex = Math.max(0, m);
          const f = h(u, d, _, v);
          if (!f && i || (i = f, m <= 0)) break;
          v = m;
        }
        if (i) {
          let r = {
    ...
    V(z[28], G([0, 1, 23]), function (I, t, p) {
      ...
      class d {
        static _createLink(b, _, v, i, r) {
          let m = r - 1;
          do {
            const f = _.charCodeAt(m);
            if (b.get(f) !== 2) break;
            m--;
          } while (m > i);
          if (i > 0) {
            const f = _.charCodeAt(i - 1), l = _.charCodeAt(m);
            (f === 40 && l === 41 || f === 91 && l === 93 ||
              f === 123 && l === 125) && m--;
          }
          return {
            ...
            url: _.substring(i, m + 1),
          };
        }
        static computeLinks(b, _ = h()) {
          const v = u();
          let i = [];
          for (let r = 1, m = b.getLineCount(); r <= m; r++) {
            const f = b.getLineContent(r), l = f.length;
            let n = 0, g = 0, S = 0, w = 1, c = !1, C = !1, L = !1, A = !1;
            for (; n < l;) {
              let M = !1;
              ...
              if (w === 13) {
                ...
                D === 1 && (i.push(d._createLink(v, f, r, g, n)), M = !0);
              } else if (w === 12) {
                let D;
                R === 91 ? (C = !0, D = 0) : D = v.get(R),
                  D === 1 ? M = !0 : w = 13;
              } else w = _.nextState(w, R), w === 0 && (M = !0);
              M && (w = 1, c = !1, C = !1, A = !1, g = n + 1, S = R), n++;
            }
            w === 13 && i.push(d._createLink(v, f, r, g, l));
          }
          return i;
        }
      }
    ...
    V(z[30], G([0, 1]), function (I, t) {
      ...
      (function (e) {
        e[e.Hint = 1] = "Hint",
          ...
          e[e.Error = 8] = "Error";
      })(m = t.MarkerSeverity || (t.MarkerSeverity = {}));
      var f;
      (function (e) {
      ...
      (function (e) {
        ...
        g = t.OverlayWidgetPositionPreference ||
  ...
  V(
    ...
    function (I, t, p, P, E, o, h, s, u, d, N, a, b, _, v, i) {
      ...
      class r extends d.MirrorTextModel {
        ...
        getWordAtPosition(n, g) {
          let S = N.getWordAtText(
            n.column,
            N.ensureValidWordDefinition(g),
        ...
        words(n) {
          const g = this._lines, S = this._wordenize.bind(this);
          let w = 0, c = "", C = 0, L = [];
          return {
            *[Symbol.iterator]() {
              for (;;) {
                if (C < L.length) {
                  ...
                  C += 1, yield A;
                } else if (w < g.length) c = g[w], L = S(c, n), C = 0, w += 1;
                else break;
              }
            },
          };
        ...
        getLineWords(n, g) {
          let S = this._lines[n - 1], w = this._wordenize(S, g), c = [];
          for (const C of w) {
            c.push({
        ...
        _wordenize(n, g) {
          const S = [];
          let w;
          for (g.lastIndex = 0; (w = g.exec(n)) && w[0].length !== 0;) {
        ...
        positionAt(n) {
          ...
          let g = this._lineStarts.getIndexOf(n),
            S = this._lines[g.index].length;
          return {
            lineNumber: 1 + g.index,
            column: 1 + Math.min(g.remainder, S),
          };
        }
        _validateRange(n) {
          const g = this._validatePosition({
          ...
          return g.lineNumber !== n.startLineNumber ||
              g.column !== n.startColumn || S.lineNumber !== n.endLineNumber ||
        ...
        _validatePosition(n) {
          ...
          let { lineNumber: g, column: S } = n, w = !1;
          if (g < 1) g = 1, S = 1, w = !0;
          else if (g > this._lines.length) {
            g = this._lines.length, S = this._lines[g - 1].length + 1, w = !0;
          } else {
            let c = this._lines[g - 1].length + 1;
            S < 1 ? (S = 1, w = !0) : S > c && (S = c, w = !0);
          }
          return w ? { lineNumber: g, column: S } : n;
        }
      }
      class m {
        constructor(n, g) {
        ...
        _getModels() {
          let n = [];
          return Object.keys(this._models).forEach((g) =>
            n.push(this._models[g])
          ),
            n;
        }
        acceptNewModel(n) {
        ...
        acceptModelChanged(n, g) {
          !this._models[n] || this._models[n].onEvents(g);
        }
        ...
        computeDiff(n, g, S, w) {
          return ne(this, void 0, void 0, function* () {
            const c = this._getModel(n), C = this._getModel(g);
            if (!c || !C) return null;
        ...
        _modelsAreIdentical(n, g) {
          const S = n.getLineCount(), w = g.getLineCount();
          if (S !== w) return !1;
          for (let c = 1; c <= S; c++) {
            const C = n.getLineContent(c), L = g.getLineContent(c);
            if (C !== L) return !1;
          }
          return !0;
        }
        computeMoreMinimalEdits(n, g) {
          return ne(this, void 0, void 0, function* () {
            ...
            for (let { range: C, text: L, eol: A } of g) {
              if (
        ...
        computeLinks(n) {
          return ne(this, void 0, void 0, function* () {
            let g = this._getModel(n);
            return g ? a.computeLinks(g) : null;
          });
        }
        textualSuggest(n, g, S, w) {
          return ne(this, void 0, void 0, function* () {
        ...
        loadForeignModule(n, g, S) {
          ...
          return this._foreignModuleFactory
            ? (this._foreignModule = this._foreignModuleFactory(C, g),
              Promise.resolve(v.getAllMethodNames(this._foreignModule)))
            : new Promise((L, A) => {
              I([n], (M) => {
                this._foreignModule = M.create(C, g),
        ...
        fmr(n, g) {
          ...
          try {
            return Promise.resolve(
              this._foreignModule[n].apply(this._foreignModule, g),
            );
          } catch (S) {
      ...
      t.EditorSimpleWorker = m, m._diffLimit = 1e5, m._suggestionsLimit = 1e4;
      function f(l) {
        return new m(l, null);
      }
      t.create = f,
