 ...
 * Version: 0.22.0(ba35190e9ccc4b410eaac46bfaa0f06c879db7c9)
      ...
      ConfigurationOptionsUtil.validateConfigurationOptions = function (
        ...
        function defaultOnError(err) {
          ...
          if (err.phase === "factory") {
            console.error(
              'The factory method of "' + err.moduleId +
        ...
        if (
          options.nodeCachedData && typeof options.nodeCachedData === "object"
        ) {
      ...
      ConfigurationOptionsUtil.mergeConfigurationOptions = function (
        ...
        AMDLoader.Utilities.forEachProperty(overwrite, function (key, value) {
          if (
            ...
            result.ignoreDuplicateModules = result.ignoreDuplicateModules
              .concat(value);
    ...
    var Configuration = /** @class */ (function () {
      ...
      Configuration.prototype._createIgnoreDuplicateModulesMap = function () {
        ...
        for (var i = 0; i < this.options.ignoreDuplicateModules.length; i++) {
          this
            .ignoreDuplicateModulesMap[this.options.ignoreDuplicateModules[i]] =
              true;
        }
      };
  ...
  (function (AMDLoader) {
      ...
      OnlyOnceScriptLoader.prototype.load = function (
        ...
        if (!this._scriptLoader) {
          if (this._env.isWebWorker) {
            ...
            var preferScriptTags =
              moduleManager.getConfig().getOptionsLiteral().preferScriptTags;
            if (preferScriptTags) {
    ...
    var NodeScriptLoader = /** @class */ (function () {
          ...
          this._readSourceAndCachedData(
            ...
            function (err, data, cachedData, hashData) {
              ...
              if (data.charCodeAt(0) === NodeScriptLoader._BOM) {
                scriptSource = NodeScriptLoader._PREFIX + data.substring(1) +
                  NodeScriptLoader._SUFFIX;
              } else {
                scriptSource = NodeScriptLoader._PREFIX + data +
                  NodeScriptLoader._SUFFIX;
              }
      ...
      NodeScriptLoader.prototype._getElectronRendererScriptPathOrUri =
        function (path) {
          ...
          if (driveLetterMatch) {
            // windows
            return "file:///" +
              (driveLetterMatch[1].toUpperCase() + ":" + driveLetterMatch[2])
                .replace(/\\/g, "/");
          } else {
            // nix
            return "file://" + path;
      ...
      NodeScriptLoader.prototype._getCachedDataPath = function (
        ...
        var hash = this._crypto.createHash("md5").update(filename, "utf8")
          .update(config.seed, "utf8").update(process.arch, "").digest("hex");
      ...
      NodeScriptLoader.prototype._createAndWriteCachedData = function (
        ...
        var createLoop = function () {
          setTimeout(function () {
            if (!hashData) {
              hashData = _this._crypto.createHash("md5").update(
                scriptSource,
                "utf8",
              ).digest();
            }
            ...
            if (
              cachedData.length === 0 || cachedData.length === lastSize ||
              iteration >= 5
            ) {
              // done
              return;
      ...
      NodeScriptLoader.prototype._verifyCachedData = function (
        ...
        setTimeout(function () {
          ...
          var hashDataNow = _this._crypto.createHash("md5").update(
            scriptSource,
            "utf8",
          ).digest();
            ...
            moduleManager.getConfig().onError(
              new Error(
                "FAILED TO VERIFY CACHED DATA, deleting stale '" +
                  cachedDataPath + "' now, but a RESTART IS REQUIRED",
              ),
            );
 ...
 *--------------------------------------------------------------------------------------------*/
      ...
      Module.prototype.complete = function (
        ...
        if (this._callback) {
          if (typeof this._callback === "function") {
            ...
            if (
              !producedError && typeof r.returnedValue !== "undefined" &&
      ...
      ModuleManager.prototype.getBuildInfo = function () {
        ...
        for (var i = 0, len = this._modules2.length; i < len; i++) {
          ...
          result[resultLen++] = {
            id: m.strId,
            path: location_1,
            defineLocation: (location_1 && defineStack
        ...
        if (!m) {
          throw new Error(
            "Check dependency list! Synchronous require cannot resolve module '" +
              _strModuleId + "'. This is the first mention of this module!",
          );
        }
        if (!m.isComplete()) {
          throw new Error(
            ...
            if (this._hasDependencyPath(dependency.id, module.id)) {
              ...
              console.warn(
                "There is a dependency cycle between '" +
                  ...
                  "' and '" + this._moduleIdProvider.getStrModuleId(module.id) +
  ...
  define(
    __m[14/*vs/base/common/arrays*/
    ],
    __M([0, /*require*/ 1 /*exports*/]),
    function (require, exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
      exports.asArray = exports.pushToEnd = exports.pushToStart = exports
        .arrayInsert = exports.range = exports.flatten = exports
          .firstOrDefault = exports.distinctES6 = exports.distinct = exports
            .isNonEmptyArray = exports.isFalsyOrEmpty = exports.coalesce =
              exports.groupBy = exports.mergeSort = exports.quickSelect =
                exports.findFirstInSorted = exports.binarySearch = exports
                  .equals = exports.tail2 = exports.tail = void 0;
      /**
 ...
 *--------------------------------------------------------------------------------------------*/
  define(
    __m[15/*vs/base/common/diff/diffChange*/
    ],
    __M([0, /*require*/ 1 /*exports*/]),
    function (require, exports) {
      "use strict";
 ...
 *--------------------------------------------------------------------------------------------*/
  define(
    ...
    function (require, exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
      exports.illegalState = exports.illegalArgument = exports.canceled =
        exports.isPromiseCanceledError = exports
          .transformErrorForSerialization = exports.onUnexpectedExternalError =
            exports.onUnexpectedError = exports.errorHandler = exports
              .ErrorHandler = void 0;
 ...
 *--------------------------------------------------------------------------------------------*/
  define(
    __m[16/*vs/base/common/iterator*/
    ],
    __M([0, /*require*/ 1 /*exports*/]),
    function (require, exports) {
      "use strict";
 ...
 *--------------------------------------------------------------------------------------------*/
  define(
    __m[17/*vs/base/common/keyCodes*/
    ],
    __M([0, /*require*/ 1, /*exports*/ 4 /*vs/base/common/errors*/]),
    function (require, exports, errors_1) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
      exports.ResolvedKeybinding = exports.ResolvedKeybindingPart = exports
        .ChordKeybinding = exports.SimpleKeybinding = exports
          .createSimpleKeybinding = exports.createKeybinding = exports
            .KeyChord = exports.KeyCodeUtils = void 0;
      class KeyCodeStrMap {
        constructor() {
          this._keyCodeToStr = [];
  ...
  define(
    __m[7/*vs/base/common/lifecycle*/
    ],
    __M([0, /*require*/ 1, /*exports*/ 16 /*vs/base/common/iterator*/]),
    function (require, exports, iterator_1) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
      exports.ImmortalReference = exports.MutableDisposable = exports
        .Disposable = exports.DisposableStore = exports.toDisposable = exports
          .combinedDisposable = exports.dispose = exports.isDisposable = exports
            .MultiDisposeError = exports.trackDisposable = void 0;
      /**
 ...
 *--------------------------------------------------------------------------------------------*/
  define(
    __m[18/*vs/base/common/linkedList*/
    ],
    __M([0, /*require*/ 1 /*exports*/]),
    function (require, exports) {
      "use strict";
      ...
      class LinkedList {
        ...
        _remove(node) {
          if (node.prev !== Node.Undefined && node.next !== Node.Undefined) {
            ...
            node.prev === Node.Undefined && node.next === Node.Undefined
          ) {
            // only node
            this._first = Node.Undefined;
            this._last = Node.Undefined;
 ...
 *--------------------------------------------------------------------------------------------*/
  define(
    ...
    function (require, exports) {
      ...
      var _a;
      Object.defineProperty(exports, "__esModule", { value: true });
      exports.isLittleEndian = exports.OS = exports.setImmediate = exports
        .globals = exports.userAgent = exports.isIOS = exports.isWeb = exports
          .isNative = exports.isLinux = exports.isMacintosh = exports
            .isWindows = exports.isPreferringBrowserCodeLoad = exports
              .browserCodeLoadingCacheStrategy = exports.isElectronSandboxed =
                void 0;
      ...
      exports.isElectronSandboxed = isElectronRenderer &&
      ...
      exports.browserCodeLoadingCacheStrategy = (() => {
        ...
        const env = nodeProcess === null || nodeProcess === void 0
          ? void 0
          : nodeProcess.env["ENABLE_VSCODE_BROWSER_CODE_LOADING"];
        if (typeof env === "string") {
          if (
            env === "none" || env === "code" || env === "bypassHeatCheck" ||
      ...
      exports.isPreferringBrowserCodeLoad =
        typeof exports.browserCodeLoadingCacheStrategy === "string";
      // Web environment
 ...
 *--------------------------------------------------------------------------------------------*/
  define(
    __m[19/*vs/base/common/process*/
    ],
    __M([0, /*require*/ 1, /*exports*/ 2 /*vs/base/common/platform*/]),
    function (require, exports, platform_1) {
      ...
      if (typeof process !== "undefined") {
        ...
        safeProcess = {
          // Supported
          get platform() {
            return platform_1.globals.vscode.process.platform;
          },
          get env() {
            return platform_1.globals.vscode.process.env;
          },
          nextTick(callback) {
          ...
          // Unsupported
          cwd() {
            return platform_1.globals.vscode.process.env["VSCODE_CWD"] ||
              platform_1.globals.vscode.process.execPath.substr(
                0,
                platform_1.globals.vscode.process.execPath.lastIndexOf(
                  platform_1.globals.vscode.process.platform === "win32"
                    ? "\\"
                    : "/",
                ),
              );
 ...
 *--------------------------------------------------------------------------------------------*/
  define(
    __m[20/*vs/base/common/path*/
    ],
    __M([0, /*require*/ 1, /*exports*/ 19 /*vs/base/common/process*/]),
    function (require, exports, process) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
      exports.sep = exports.extname = exports.basename = exports.dirname =
        exports.relative = exports.resolve = exports.normalize = exports.posix =
          exports.win32 = void 0;
      ...
      exports.win32 = {
        ...
        basename(path, ext) {
          ...
          if (
            ext !== undefined && ext.length > 0 && ext.length <= path.length
          ) {
            if (ext === path) {
              return "";
            }
 ...
 *--------------------------------------------------------------------------------------------*/
  define(
    __m[8/*vs/base/common/stopwatch*/
    ],
    __M([0, /*require*/ 1, /*exports*/ 2 /*vs/base/common/platform*/]),
    function (require, exports, platform_1) {
      "use strict";
 ...
 *--------------------------------------------------------------------------------------------*/
  define(
    ...
    __M([
      ...
      18, /*vs/base/common/linkedList*/
      8, /*vs/base/common/stopwatch*/
    ]),
    function (
      require,
      exports,
      ...
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
      exports.Relay = exports.EventBufferer = exports.PauseableEmitter = exports
        .Emitter = exports.Event = void 0;
      var Event;
      (function (Event) {
     ...
     */
      class Emitter {
        ...
        dispose() {
          ...
          (_b = this._deliveryQueue) === null || _b === void 0
            ? void 0
            : _b.clear();
          (_c = this._leakageMon) === null || _c === void 0
            ? void 0
            : _c.dispose();
          this._disposed = true;
        }
      ...
      class PauseableEmitter extends Emitter {
        constructor(options) {
          ...
          this._mergeFn = options === null || options === void 0
            ? void 0
            : options.merge;
        }
        pause() {
 ...
 *--------------------------------------------------------------------------------------------*/
  define(
    __m[21/*vs/base/common/cancellation*/
    ],
 ...
 *--------------------------------------------------------------------------------------------*/
  define(
    ...
    function (require, exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
      exports.breakBetweenGraphemeBreakType = exports.getGraphemeBreakType =
        exports.singleLetterHash = exports.containsUppercaseCharacter = exports
          .startsWithUTF8BOM = exports.UTF8_BOM_CHARACTER = exports
            .isEmojiImprecise = exports.isFullWidthCharacter = exports
              .containsFullWidthCharacter = exports
                .containsUnusualLineTerminators = exports
                  .UNUSUAL_LINE_TERMINATORS = exports.isBasicASCII = exports
                    .containsEmoji = exports.containsRTL = exports.decodeUTF8 =
                      exports.prevCharLength = exports.nextCharLength = exports
                        .getNextCodePoint = exports.computeCodePoint = exports
                          .isLowSurrogate = exports.isHighSurrogate = exports
                            .commonSuffixLength = exports.commonPrefixLength =
                              exports.startsWithIgnoreCase = exports
                                .equalsIgnoreCase = exports.isUpperAsciiLetter =
                                  exports.isLowerAsciiLetter = exports
                                    .compareSubstringIgnoreCase = exports
                                      .compareIgnoreCase = exports
                                        .compareSubstring = exports.compare =
                                          exports.lastNonWhitespaceIndex =
                                            exports.getLeadingWhitespace =
                                              exports.firstNonWhitespaceIndex =
                                                exports.splitLines = exports
                                                  .regExpFlags = exports
     ...
     */
      function computeCodePoint(highSurrogate, lowSurrogate) {
        return ((highSurrogate - 0xD800) << 10) + (lowSurrogate - 0xDC00) +
          0x10000;
      }
     ...
     */
      function isEmojiImprecise(x) {
        return ((x >= 0x1F1E6 && x <= 0x1F1FF) || (x === 8986) ||
          (x === 8987) || (x === 9200) ||
          (x === 9203) || (x >= 9728 && x <= 10175) || (x === 11088) ||
          (x === 11093) ||
      ...
      function startsWithUTF8BOM(str) {
        return !!(str && str.length > 0 &&
          str.charCodeAt(0) === 65279 /* UTF8_BOM */);
      }
     ...
     */
      ...
      function breakBetweenGraphemeBreakType(breakTypeA, breakTypeB) {
        ...
        if (
          breakTypeA === 4 /* Control */ || breakTypeA === 2 /* CR */ ||
          breakTypeA === 3 /* LF */
        ) {
          return true; // GB4
        }
        if (
          breakTypeB === 4 /* Control */ || breakTypeB === 2 /* CR */ ||
          breakTypeB === 3 /* LF */
        ) {
          return true; // GB5
        }
        ...
        if (breakTypeA === 8 /* L */) {
          if (
            breakTypeB === 8 /* L */ || breakTypeB === 9 /* V */ ||
            breakTypeB === 11 /* LV */ || breakTypeB === 12 /* LVT */
          ) {
            return false; // GB6
          }
        }
 ...
 *--------------------------------------------------------------------------------------------*/
  define(
    __m[22/*vs/base/common/hash*/
    ],
    __M([0, /*require*/ 1, /*exports*/ 5 /*vs/base/common/strings*/]),
    function (require, exports, strings) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
      exports.StringSHA1 = exports.toHexString = exports.stringHash = exports
        .doHash = exports.hash = void 0;
      /**
      ...
      class StringSHA1 {
        ...
        digest() {
          ...
          return toHexString(this._h0) + toHexString(this._h1) +
            toHexString(this._h2) + toHexString(this._h3) +
 ...
 *--------------------------------------------------------------------------------------------*/
  define(
    __m[10/*vs/base/common/diff/diff*/
    ],
    __M([
      0, /*require*/
      1, /*exports*/
      15, /*vs/base/common/diff/diffChange*/
      22, /*vs/base/common/hash*/
    ]),
    function (require, exports, diffChange_1, hash_1) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
      exports.LcsDiff = exports.MyArray = exports.Debug = exports.stringDiff =
        exports.StringDiffSequence = void 0;
     ...
     */
      class LcsDiff {
        ...
        PrettifyChanges(changes) {
          ...
          for (let i = changes.length - 1; i >= 0; i--) {
            ...
            if (i > 0) {
              ...
              if (prevChange.originalLength > 0) {
                originalStop = prevChange.originalStart +
                  prevChange.originalLength;
              }
              if (prevChange.modifiedLength > 0) {
                modifiedStop = prevChange.modifiedStart +
          ...
          if (this._hasStrings) {
            for (let i = 1, len = changes.length; i < len; i++) {
              ...
              const matchedLength = bChange.originalStart -
                aChange.originalStart - aChange.originalLength;
              const aOriginalStart = aChange.originalStart;
              const bOriginalEnd = bChange.originalStart +
                bChange.originalLength;
              const abOriginalLength = bOriginalEnd - aOriginalStart;
              const aModifiedStart = aChange.modifiedStart;
              const bModifiedEnd = bChange.modifiedStart +
                bChange.modifiedLength;
              const abModifiedLength = bModifiedEnd - aModifiedStart;
              // Avoid wasting a lot of time with these searches
              if (
                matchedLength < 5 && abOriginalLength < 20 &&
                abModifiedLength < 20
              ) {
                ...
                if (t) {
                  ...
                  if (
                    ...
                    bChange.originalLength = bOriginalEnd -
                      bChange.originalStart;
                    bChange.modifiedLength = bModifiedEnd -
        ...
        _findBetterContiguousSequence(
          ...
          if (
            originalLength < desiredLength || modifiedLength < desiredLength
          ) {
            return null;
          }
          const originalMax = originalStart + originalLength - desiredLength +
            1;
          const modifiedMax = modifiedStart + modifiedLength - desiredLength +
            1;
          let bestScore = 0;
  ...
  define(
    __m[11/*vs/base/common/types*/
    ],
    __M([0, /*require*/ 1 /*exports*/]),
    function (require, exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
      exports.withNullAsUndefined = exports.createProxyObject = exports
        .getAllMethodNames = exports.getAllPropertyNames = exports
          .validateConstraint = exports.validateConstraints = exports
            .isFunction = exports.assertIsDefined = exports.assertType = exports
              .isUndefinedOrNull = exports.isUndefined = exports.isBoolean =
                exports.isNumber = exports.isObject = exports.isString = exports
                  .isArray = void 0;
      /**
     ...
     */
      ...
      function validateConstraint(arg, constraint) {
        if (isString(constraint)) {
          ...
          if (
            constraint.length === 1 && constraint.call(undefined, arg) === true
          ) {
            return;
          }
          throw new Error(
     ...
     */
      function _asFormatted(uri, skipEncoding) {
        ...
        if (path) {
          ...
          if (
            path.length >= 3 && path.charCodeAt(0) === 47 /* Slash */ &&
            ...
            path.length >= 2 && path.charCodeAt(1) === 58 /* Colon */
          ) {
            const code = path.charCodeAt(0);
            if (code >= 65 /* A */ && code <= 90 /* Z */) {
 ...
 *--------------------------------------------------------------------------------------------*/
  define(
    __m[34/*vs/base/common/worker/simpleWorker*/
    ],
    __M([
      0, /*require*/
      1, /*exports*/
      ...
      7, /*vs/base/common/lifecycle*/
      2, /*vs/base/common/platform*/
      11, /*vs/base/common/types*/
    ]),
    function (require, exports, errors_1, lifecycle_1, platform_1, types) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
      exports.create = exports.SimpleWorkerServer = exports.SimpleWorkerClient =
        exports.logOnceWebWorkerWarning = void 0;
        ...
        constructor(workerFactory, moduleId, host) {
          ...
          this._lazyProxy = new Promise((resolve, reject) => {
            ...
            this._onModuleLoaded.then((availableMethods) => {
              resolve(
                types.createProxyObject(availableMethods, proxyMethodRequest),
              );
            }, (e) => {
              reject(e);
 ...
 *--------------------------------------------------------------------------------------------*/
  define(
    __m[23/*vs/editor/common/core/characterClassifier*/
    ],
    __M([0, /*require*/ 1, /*exports*/ 12 /*vs/base/common/uint*/]),
 ...
 *--------------------------------------------------------------------------------------------*/
  define(
    __m[6/*vs/editor/common/core/range*/
    ],
 ...
 *--------------------------------------------------------------------------------------------*/
  define(
    __m[24/*vs/editor/common/core/selection*/
    ],
    __M([
      0, /*require*/
      1, /*exports*/
      3, /*vs/editor/common/core/position*/
      6, /*vs/editor/common/core/range*/
    ]),
 ...
 *--------------------------------------------------------------------------------------------*/
  define(
    __m[25/*vs/editor/common/core/token*/
    ],
    __M([0, /*require*/ 1 /*exports*/]),
    function (require, exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
      exports.TokenizationResult2 = exports.TokenizationResult = exports.Token =
        void 0;
      class Token {
 ...
 *--------------------------------------------------------------------------------------------*/
  define(
    __m[26/*vs/editor/common/diff/diffComputer*/
    ],
    __M([
      0, /*require*/
      1, /*exports*/
      10, /*vs/base/common/diff/diff*/
      ...
      function postProcessCharChanges(rawChanges) {
        ...
        for (let i = 1, len = rawChanges.length; i < len; i++) {
          ...
          if (matchingLength < MINIMUM_MATCHING_CHARACTER_LENGTH) {
            ...
            prevChange.originalLength =
              (currChange.originalStart + currChange.originalLength) -
              prevChange.originalStart;
            prevChange.modifiedLength =
              (currChange.modifiedStart + currChange.modifiedLength) -
      ...
      class LineChange {
        ...
        static createFromDiffResult(
          ...
          if (
            ...
            const originalCharSequence = originalLineSequence
              .createCharSequence(
                shouldIgnoreTrimWhitespace,
                diffChange.originalStart,
                diffChange.originalStart + diffChange.originalLength - 1,
              );
            const modifiedCharSequence = modifiedLineSequence
              .createCharSequence(
                shouldIgnoreTrimWhitespace,
                diffChange.modifiedStart,
                diffChange.modifiedStart + diffChange.modifiedLength - 1,
 ...
 *--------------------------------------------------------------------------------------------*/
  define(
    __m[27/*vs/editor/common/model/wordHelper*/
    ],
    __M([0, /*require*/ 1 /*exports*/]),
    function (require, exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
      exports.getWordAtText = exports.ensureValidWordDefinition = exports
        .DEFAULT_WORD_REGEXP = exports.USUAL_WORD_SEPARATORS = void 0;
 ...
 *--------------------------------------------------------------------------------------------*/
  define(
    __m[28/*vs/editor/common/modes/linkComputer*/
    ],
    __M([
      0, /*require*/
      1, /*exports*/
      23, /*vs/editor/common/core/characterClassifier*/
    ]),
    function (require, exports, characterClassifier_1) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
      exports.computeLinks = exports.LinkComputer = exports.StateMachine =
            ...
            while (j < len) {
              ...
              if (state === 13 /* Accept */) {
                ...
                switch (chCode) {
                  ...
                  case 124 /* Pipe */:
                    // `|` terminates a link if the link began with `|`
                    chClass = (linkBeginChCode === 124 /* Pipe */)
                      ? 1 /* ForceTermination */
                      : 0 /* None */;
                    break;
                  case 32 /* Space */:
 ...
 *--------------------------------------------------------------------------------------------*/
  define(
    __m[29/*vs/editor/common/modes/supports/inplaceReplaceSupport*/
    ],
    __M([0, /*require*/ 1 /*exports*/]),
    function (require, exports) {
      "use strict";
 ...
 *--------------------------------------------------------------------------------------------*/
  define(
    __m[30/*vs/editor/common/standalone/standaloneEnums*/
    ],
    __M([0, /*require*/ 1 /*exports*/]),
    function (require, exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
      exports.WrappingIndent = exports.TrackedRangeStickiness = exports
        .TextEditorCursorStyle = exports.TextEditorCursorBlinkingStyle = exports
          .SymbolTag = exports.SymbolKind = exports.SignatureHelpTriggerKind =
            exports.SelectionDirection = exports.ScrollbarVisibility = exports
              .ScrollType = exports.RenderMinimap = exports
                .RenderLineNumbersType = exports.OverviewRulerLane = exports
                  .OverlayWidgetPositionPreference = exports.MouseTargetType =
                    exports.MinimapPosition = exports.MarkerTag = exports
                      .MarkerSeverity = exports.KeyCode = exports.IndentAction =
                        exports.EndOfLineSequence = exports
                          .EndOfLinePreference = exports.EditorOption = exports
                            .EditorAutoIndentStrategy = exports
                              .DocumentHighlightKind = exports
                                .DefaultEndOfLine = exports.CursorChangeReason =
                                  exports.ContentWidgetPositionPreference =
                                    exports.CompletionTriggerKind = exports
      ...
      (function (AccessibilitySupport) {
        ...
        AccessibilitySupport = exports.AccessibilitySupport ||
          (exports.AccessibilitySupport = {}),
      );
      ...
      (function (CompletionItemInsertTextRule) {
        ...
        CompletionItemInsertTextRule = exports.CompletionItemInsertTextRule ||
      ...
      (function (CompletionItemKind) {
        ...
        CompletionItemKind = exports.CompletionItemKind ||
      ...
      (function (CompletionItemTag) {
        ...
        CompletionItemTag = exports.CompletionItemTag ||
     ...
     */
      ...
      (function (CompletionTriggerKind) {
        ...
        CompletionTriggerKind = exports.CompletionTriggerKind ||
     ...
     */
      ...
      (function (CursorChangeReason) {
        ...
        CursorChangeReason = exports.CursorChangeReason ||
     ...
     */
      ...
      (function (DefaultEndOfLine) {
        ...
        DefaultEndOfLine = exports.DefaultEndOfLine ||
     ...
     */
      ...
      (function (DocumentHighlightKind) {
        ...
        DocumentHighlightKind = exports.DocumentHighlightKind ||
     ...
     */
      ...
      (function (EditorAutoIndentStrategy) {
        ...
        EditorAutoIndentStrategy = exports.EditorAutoIndentStrategy ||
      ...
      (function (EditorOption) {
        ...
        EditorOption[EditorOption["autoClosingBrackets"] = 5] =
          "autoClosingBrackets";
        EditorOption[EditorOption["autoClosingOvertype"] = 6] =
          "autoClosingOvertype";
        EditorOption[EditorOption["autoClosingQuotes"] = 7] =
          "autoClosingQuotes";
        ...
        EditorOption[EditorOption["codeLensFontFamily"] = 12] =
          "codeLensFontFamily";
        EditorOption[EditorOption["codeLensFontSize"] = 13] =
          "codeLensFontSize";
        ...
        EditorOption[EditorOption["copyWithSyntaxHighlighting"] = 18] =
          "copyWithSyntaxHighlighting";
        EditorOption[EditorOption["cursorBlinking"] = 19] = "cursorBlinking";
        EditorOption[EditorOption["cursorSmoothCaretAnimation"] = 20] =
          "cursorSmoothCaretAnimation";
        EditorOption[EditorOption["cursorStyle"] = 21] = "cursorStyle";
        EditorOption[EditorOption["cursorSurroundingLines"] = 22] =
          "cursorSurroundingLines";
        EditorOption[EditorOption["cursorSurroundingLinesStyle"] = 23] =
          "cursorSurroundingLinesStyle";
        EditorOption[EditorOption["cursorWidth"] = 24] = "cursorWidth";
        EditorOption[EditorOption["disableLayerHinting"] = 25] =
          "disableLayerHinting";
        EditorOption[EditorOption["disableMonospaceOptimizations"] = 26] =
          "disableMonospaceOptimizations";
        EditorOption[EditorOption["dragAndDrop"] = 27] = "dragAndDrop";
        EditorOption[EditorOption["emptySelectionClipboard"] = 28] =
          "emptySelectionClipboard";
        EditorOption[EditorOption["extraEditorClassName"] = 29] =
          "extraEditorClassName";
        EditorOption[EditorOption["fastScrollSensitivity"] = 30] =
          "fastScrollSensitivity";
        EditorOption[EditorOption["find"] = 31] = "find";
        EditorOption[EditorOption["fixedOverflowWidgets"] = 32] =
          "fixedOverflowWidgets";
        EditorOption[EditorOption["folding"] = 33] = "folding";
        EditorOption[EditorOption["foldingStrategy"] = 34] = "foldingStrategy";
        EditorOption[EditorOption["foldingHighlight"] = 35] =
          "foldingHighlight";
        EditorOption[EditorOption["unfoldOnClickAfterEndOfLine"] = 36] =
        ...
        EditorOption[EditorOption["hideCursorInOverviewRuler"] = 46] =
          "hideCursorInOverviewRuler";
        EditorOption[EditorOption["highlightActiveIndentGuide"] = 47] =
        ...
        EditorOption[EditorOption["mouseWheelScrollSensitivity"] = 61] =
          "mouseWheelScrollSensitivity";
        EditorOption[EditorOption["mouseWheelZoom"] = 62] = "mouseWheelZoom";
        EditorOption[EditorOption["multiCursorMergeOverlapping"] = 63] =
          "multiCursorMergeOverlapping";
        EditorOption[EditorOption["multiCursorModifier"] = 64] =
          "multiCursorModifier";
        EditorOption[EditorOption["multiCursorPaste"] = 65] =
          "multiCursorPaste";
        EditorOption[EditorOption["occurrencesHighlight"] = 66] =
          "occurrencesHighlight";
        EditorOption[EditorOption["overviewRulerBorder"] = 67] =
          "overviewRulerBorder";
        EditorOption[EditorOption["overviewRulerLanes"] = 68] =
          "overviewRulerLanes";
        EditorOption[EditorOption["padding"] = 69] = "padding";
        EditorOption[EditorOption["parameterHints"] = 70] = "parameterHints";
        EditorOption[EditorOption["peekWidgetDefaultFocus"] = 71] =
          "peekWidgetDefaultFocus";
        EditorOption[EditorOption["definitionLinkOpensInPeek"] = 72] =
          "definitionLinkOpensInPeek";
        EditorOption[EditorOption["quickSuggestions"] = 73] =
          "quickSuggestions";
        EditorOption[EditorOption["quickSuggestionsDelay"] = 74] =
          "quickSuggestionsDelay";
        EditorOption[EditorOption["readOnly"] = 75] = "readOnly";
        EditorOption[EditorOption["renameOnType"] = 76] = "renameOnType";
        EditorOption[EditorOption["renderControlCharacters"] = 77] =
          "renderControlCharacters";
        EditorOption[EditorOption["renderIndentGuides"] = 78] =
          "renderIndentGuides";
        EditorOption[EditorOption["renderFinalNewline"] = 79] =
          "renderFinalNewline";
        EditorOption[EditorOption["renderLineHighlight"] = 80] =
          "renderLineHighlight";
        EditorOption[EditorOption["renderLineHighlightOnlyWhenFocus"] = 81] =
          "renderLineHighlightOnlyWhenFocus";
        EditorOption[EditorOption["renderValidationDecorations"] = 82] =
          "renderValidationDecorations";
        EditorOption[EditorOption["renderWhitespace"] = 83] =
          "renderWhitespace";
        EditorOption[EditorOption["revealHorizontalRightPadding"] = 84] =
          "revealHorizontalRightPadding";
        EditorOption[EditorOption["roundedSelection"] = 85] =
          "roundedSelection";
        EditorOption[EditorOption["rulers"] = 86] = "rulers";
        EditorOption[EditorOption["scrollbar"] = 87] = "scrollbar";
        EditorOption[EditorOption["scrollBeyondLastColumn"] = 88] =
          "scrollBeyondLastColumn";
        EditorOption[EditorOption["scrollBeyondLastLine"] = 89] =
          "scrollBeyondLastLine";
        EditorOption[EditorOption["scrollPredominantAxis"] = 90] =
          "scrollPredominantAxis";
        EditorOption[EditorOption["selectionClipboard"] = 91] =
          "selectionClipboard";
        EditorOption[EditorOption["selectionHighlight"] = 92] =
          "selectionHighlight";
        EditorOption[EditorOption["selectOnLineNumbers"] = 93] =
          "selectOnLineNumbers";
        EditorOption[EditorOption["showFoldingControls"] = 94] =
          "showFoldingControls";
        EditorOption[EditorOption["showUnused"] = 95] = "showUnused";
        EditorOption[EditorOption["snippetSuggestions"] = 96] =
          "snippetSuggestions";
        ...
        EditorOption[EditorOption["stopRenderingLineAfter"] = 100] =
          "stopRenderingLineAfter";
        EditorOption[EditorOption["suggest"] = 101] = "suggest";
        EditorOption[EditorOption["suggestFontSize"] = 102] = "suggestFontSize";
        EditorOption[EditorOption["suggestLineHeight"] = 103] =
          "suggestLineHeight";
        EditorOption[EditorOption["suggestOnTriggerCharacters"] = 104] =
          "suggestOnTriggerCharacters";
        EditorOption[EditorOption["suggestSelection"] = 105] =
          "suggestSelection";
        EditorOption[EditorOption["tabCompletion"] = 106] = "tabCompletion";
        EditorOption[EditorOption["tabIndex"] = 107] = "tabIndex";
        EditorOption[EditorOption["unusualLineTerminators"] = 108] =
        ...
        EditorOption[EditorOption["wordWrapBreakAfterCharacters"] = 112] =
          "wordWrapBreakAfterCharacters";
        EditorOption[EditorOption["wordWrapBreakBeforeCharacters"] = 113] =
          "wordWrapBreakBeforeCharacters";
        EditorOption[EditorOption["wordWrapColumn"] = 114] = "wordWrapColumn";
        EditorOption[EditorOption["wordWrapOverride1"] = 115] =
          "wordWrapOverride1";
        EditorOption[EditorOption["wordWrapOverride2"] = 116] =
          "wordWrapOverride2";
        EditorOption[EditorOption["wrappingIndent"] = 117] = "wrappingIndent";
        EditorOption[EditorOption["wrappingStrategy"] = 118] =
          "wrappingStrategy";
     ...
     */
      ...
      (function (EndOfLinePreference) {
        ...
        EndOfLinePreference = exports.EndOfLinePreference ||
     ...
     */
      ...
      (function (EndOfLineSequence) {
        ...
        EndOfLineSequence = exports.EndOfLineSequence ||
     ...
     */
      ...
      (function (MarkerSeverity) {
        ...
        MarkerSeverity = exports.MarkerSeverity ||
     ...
     */
      ...
      (function (MinimapPosition) {
        ...
        MinimapPosition = exports.MinimapPosition ||
     ...
     */
      ...
      (function (MouseTargetType) {
        ...
        MouseTargetType = exports.MouseTargetType ||
     ...
     */
      ...
      (function (OverviewRulerLane) {
        ...
        OverviewRulerLane = exports.OverviewRulerLane ||
      ...
      (function (RenderLineNumbersType) {
        ...
        RenderLineNumbersType = exports.RenderLineNumbersType ||
      ...
      (function (ScrollbarVisibility) {
        ...
        ScrollbarVisibility = exports.ScrollbarVisibility ||
     ...
     */
      ...
      (function (SelectionDirection) {
        ...
        SelectionDirection = exports.SelectionDirection ||
      ...
      (function (SignatureHelpTriggerKind) {
        ...
        SignatureHelpTriggerKind = exports.SignatureHelpTriggerKind ||
     ...
     */
      ...
      (function (TextEditorCursorBlinkingStyle) {
        ...
        TextEditorCursorBlinkingStyle = exports.TextEditorCursorBlinkingStyle ||
     ...
     */
      ...
      (function (TextEditorCursorStyle) {
        ...
        TextEditorCursorStyle = exports.TextEditorCursorStyle ||
     ...
     */
      ...
      (function (TrackedRangeStickiness) {
        ...
        TrackedRangeStickiness = exports.TrackedRangeStickiness ||
     ...
     */
      ...
      (function (WrappingIndent) {
        ...
        WrappingIndent = exports.WrappingIndent ||
 ...
 *--------------------------------------------------------------------------------------------*/
  define(
    __m[31/*vs/editor/common/standalone/standaloneBase*/
    ],
    __M([
      0, /*require*/
      1, /*exports*/
      21, /*vs/base/common/cancellation*/
      9, /*vs/base/common/event*/
      17, /*vs/base/common/keyCodes*/
      13, /*vs/base/common/uri*/
      3, /*vs/editor/common/core/position*/
      6, /*vs/editor/common/core/range*/
      24, /*vs/editor/common/core/selection*/
      25, /*vs/editor/common/core/token*/
 ...
 *--------------------------------------------------------------------------------------------*/
  define(
    __m[32/*vs/editor/common/viewModel/prefixSumComputer*/
    ],
    __M([0, /*require*/ 1, /*exports*/ 12 /*vs/base/common/uint*/]),
    function (require, exports, uint_1) {
      "use strict";
 ...
 *--------------------------------------------------------------------------------------------*/
  define(
    __m[33/*vs/editor/common/model/mirrorTextModel*/
    ],
    __M([
      0, /*require*/
      1, /*exports*/
 ...
 *--------------------------------------------------------------------------------------------*/
  ...
  define(
    __m[35/*vs/editor/common/services/editorSimpleWorker*/
    ],
    __M([
      0, /*require*/
      1, /*exports*/
      14, /*vs/base/common/arrays*/
      10, /*vs/base/common/diff/diff*/
      2, /*vs/base/common/platform*/
      13, /*vs/base/common/uri*/
      3, /*vs/editor/common/core/position*/
      ...
      33, /*vs/editor/common/model/mirrorTextModel*/
     ...
     */
      class MirrorModel extends mirrorTextModel_1.MirrorTextModel {
        ...
        offsetAt(position) {
          ...
          return this._lineStarts.getAccumulatedValue(position.lineNumber - 2) +
            (position.column - 1);
        }
        positionAt(offset) {
      ...
      class EditorSimpleWorker {
        ...
        navigateValueSet(modelUrl, range, up, wordDef, wordDefFlags) {
          return __awaiter(this, void 0, void 0, function* () {
            ...
            let result = inplaceReplaceSupport_1.BasicInplaceReplace.INSTANCE
              .navigateValueSet(range, selectionText, wordRange, word, up);
            return result;
          });
        }
 ...
 *--------------------------------------------------------------------------------------------*/
  (function () {
    ...
    const trustedTypesPolicy =
      (_a = self.trustedTypes) === null || _a === void 0
        ? void 0
        : _a.createPolicy("amdLoader", { createScriptURL: (value) => value });
