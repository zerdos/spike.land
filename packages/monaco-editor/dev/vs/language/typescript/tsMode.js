...
define("vs/language/typescript/languageFeatures", [
  ...
  "use strict";
  Object.defineProperty(exports, "__esModule", { value: true });
  exports.RenameAdapter = exports.CodeActionAdaptor = exports
    .FormatOnTypeAdapter = exports.FormatAdapter = exports.FormatHelper =
      exports.Kind = exports.OutlineAdapter = exports.ReferenceAdapter = exports
        .DefinitionAdapter = exports.OccurrencesAdapter = exports
          .QuickInfoAdapter = exports.SignatureHelpAdapter = exports
            .SuggestAdapter = exports.DiagnosticsAdapter = exports.LibFiles =
              exports.Adapter = exports.flattenDiagnosticMessageText = void 0;
  ...
  var LibFiles = /** @class */ (function () {
    ...
    LibFiles.prototype.getOrCreateModel = function (uri) {
      ...
      if (this.isLibFile(uri) && this._hasFetchedLibFiles) {
        return monaco_editor_core_1.editor.createModel(
  ...
  var DiagnosticsAdapter = /** @class */ (function (_super) {
    ...
    function DiagnosticsAdapter(_libFiles, _defaults, _selector, worker) {
      ...
      _this._disposables.push(
        monaco_editor_core_1.editor.onWillDisposeModel(onModelRemoved),
      );
      _this._disposables.push(
      ...
      _this._disposables.push({
        dispose: function () {
          for (
            var _i = 0, _a = monaco_editor_core_1.editor.getModels();
            _i < _a.length;
            _i++
          ) {
            var model = _a[_i];
      ...
      _this._disposables.push(
        _this._defaults.onDidExtraLibsChange(recomputeDiagostics),
      );
          ...
          switch (_b.label) {
            ...
            case 2:
              ...
              diagnostics = allDiagnostics
                ...
                .filter(function (d) {
                  return (_this._defaults.getDiagnosticsOptions()
                    .diagnosticCodesToIgnore || []).indexOf(d.code) ===
                    -1;
                });
              relatedUris = diagnostics
                ...
                .map(function (relatedInformation) {
                  return relatedInformation.file
                    ? monaco_editor_core_1.Uri.parse(
    ...
    DiagnosticsAdapter.prototype._convertRelatedInformation = function (
      model,
      relatedInformation,
    ) {
      var _this = this;
      ...
      relatedInformation.forEach(function (info) {
        ...
        if (info.file) {
          var relatedResourceUri = monaco_editor_core_1.Uri.parse(
            info.file.fileName,
          );
          relatedResource = _this._libFiles.getOrCreateModel(
            relatedResourceUri,
          );
        }
        if (!relatedResource) {
    ...
    DiagnosticsAdapter.prototype._tsDiagnosticCategoryToMarkerSeverity =
      function (category) {
        switch (category) {
            ...
            case 2:
              ...
              suggestions = info.entries.map(function (entry) {
                ...
                if (entry.replacementSpan) {
                  ...
                  var p2 = model.getPositionAt(
                    entry.replacementSpan.start + entry.replacementSpan.length,
                  );
                  range = new monaco_editor_core_1.Range(
                    p1.lineNumber,
                    p1.column,
                    p2.lineNumber,
                    p2.column,
                ...
                var tags = [];
                if (
                  ((_a = entry.kindModifiers) === null || _a === void 0
                    ? void 0
                    : _a.indexOf("deprecated")) !== -1
                ) {
                  tags.push(
                    monaco_editor_core_1.languages.CompletionItemTag.Deprecated,
                  );
                }
                return {
                  uri: resource,
  ...
  var SignatureHelpAdapter = /** @class */ (function (_super) {
    ...
    SignatureHelpAdapter._toSignatureHelpTriggerReason = function (context) {
      switch (context.triggerKind) {
        case monaco_editor_core_1.languages.SignatureHelpTriggerKind
          .TriggerCharacter:
            ...
            case 1:
              ...
              return [
                ...
                worker.getSignatureHelpItems(resource.toString(), offset, {
                  triggerReason: SignatureHelpAdapter
                    ._toSignatureHelpTriggerReason(context),
                }),
              ];
            case 2:
              info = _a.sent();
                ...
                entries.map(function (entry) {
                  return {
                    ...
                    kind: entry.isWriteAccess
                      ? monaco_editor_core_1.languages.DocumentHighlightKind
                        .Write
                      : monaco_editor_core_1.languages.DocumentHighlightKind
                        .Text,
                  };
  ...
  outlineTypeTable[Kind.module] =
    monaco_editor_core_1.languages.SymbolKind.Module;
  outlineTypeTable[Kind.class] =
    monaco_editor_core_1.languages.SymbolKind.Class;
  outlineTypeTable[Kind.enum] = monaco_editor_core_1.languages.SymbolKind.Enum;
  outlineTypeTable[Kind.interface] =
    monaco_editor_core_1.languages.SymbolKind.Interface;
  outlineTypeTable[Kind.memberFunction] =
    monaco_editor_core_1.languages.SymbolKind.Method;
  outlineTypeTable[Kind.memberVariable] =
    monaco_editor_core_1.languages.SymbolKind.Property;
  ...
  outlineTypeTable[Kind.function] =
    monaco_editor_core_1.languages.SymbolKind.Function;
  ...
  var CodeActionAdaptor = /** @class */ (function (_super) {
    ...
    CodeActionAdaptor.prototype.provideCodeActions = function (
      model,
      range,
      context,
      token,
          ...
          switch (_a.label) {
            ...
            case 2:
              ...
              actions = codeFixes
                ...
                .map(function (fix) {
                  return _this._tsCodeFixActionToMonacoCodeAction(
                    model,
                    context,
                    fix,
                  );
    ...
    CodeActionAdaptor.prototype._tsCodeFixActionToMonacoCodeAction = function (
      model,
      context,
      codeFix,
    ) {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 3:
              ...
              edits = [];
              for (
                _i = 0, renameLocations_1 = renameLocations;
                _i < renameLocations_1.length;
                _i++
              ) {
                renameLocation = renameLocations_1[_i];
                resource_1 = monaco_editor_core_1.Uri.parse(
...
define(
  ...
  function (
    ...
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.getTypeScriptWorker = exports.getJavaScriptWorker = exports
      .setupJavaScript = exports.setupTypeScript = void 0;
    ...
    function setupMode(defaults, modeId) {
      ...
      monaco_editor_core_1.languages.registerCodeActionProvider(
        modeId,
