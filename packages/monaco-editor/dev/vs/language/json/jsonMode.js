 ...
 *--------------------------------------------------------------------------------------------*/
define("vs/language/json/workerManager", [
  "require",
  "exports",
  "./fillers/monaco-editor-core",
], function (require, exports, monaco_editor_core_1) {
  "use strict";
  ...
  var WorkerManager = /** @class */ (function () {
    function WorkerManager(defaults) {
      ...
      this._worker = null;
      this._idleCheckInterval = Number(setInterval(function () {
...
(function (factory) {
  ...
  function createScanner(text, ignoreTrivia) {
    ...
    function scanNextNonTrivia() {
      ...
      do {
        ...
        result >= 12 /* LineCommentTrivia */ && result <= 15 /* Trivia */
      );
      return result;
    }
    return {
  ...
  function isWhiteSpace(ch) {
    return ch === 32 /* space */ || ch === 9 /* tab */ ||
      ch === 11 /* verticalTab */ || ch === 12 /* formFeed */ ||
      ch === 160 /* nonBreakingSpace */ || ch === 5760 /* ogham */ ||
      ch >= 8192 /* enQuad */ && ch <= 8203 /* zeroWidthSpace */ ||
      ch === 8239 /* narrowNoBreakSpace */ ||
      ch === 8287 /* mathematicalSpace */ ||
      ch === 12288 /* ideographicSpace */ || ch === 65279 /* byteOrderMark */;
  }
  function isLineBreak(ch) {
    return ch === 10 /* lineFeed */ || ch === 13 /* carriageReturn */ ||
      ch === 8232 /* lineSeparator */ || ch === 8233 /* paragraphSeparator */;
  }
  function isDigit(ch) {
...
(function (factory) {
  ...
  function format(documentText, range, options) {
    ...
    while (firstToken !== 17 /* EOF */) {
      var firstTokenEnd = scanner.getTokenOffset() + scanner.getTokenLength() +
        formatTextStart;
      ...
      while (
        ...
        firstTokenEnd = scanner.getTokenOffset() + scanner.getTokenLength() +
          formatTextStart;
        ...
        switch (firstToken) {
          ...
          case 4 /* CloseBracketToken */:
            if (
              ...
              secondToken !== 5 /* CommaToken */ && secondToken !== 17 /* EOF */
            ) {
              hasError = true;
            }
            break;
...
(function (factory) {
  ...
  "use strict";
  Object.defineProperty(exports, "__esModule", { value: true });
  exports.getNodeType = exports.stripComments = exports.visit = exports
    .findNodeAtOffset = exports.contains = exports.getNodeValue = exports
      .getNodePath = exports.findNodeAtLocation = exports.parseTree = exports
        .parse = exports.getLocation = void 0;
  var scanner_1 = require("./scanner");
  var ParseOptions;
  ...
  function findNodeAtLocation(root, path) {
    ...
    for (var _i = 0, path_1 = path; _i < path_1.length; _i++) {
      ...
      if (typeof segment === "string") {
        ...
        var index = segment;
        if (
          node.type !== "array" || index < 0 || !Array.isArray(node.children) ||
...
(function (factory) {
  ...
  "use strict";
  Object.defineProperty(exports, "__esModule", { value: true });
  exports.isWS = exports.applyEdit = exports.setProperty = exports
  ...
  function setProperty(text, originalPath, value, options) {
    ...
    if (!parent) {
      ...
      parent.type === "object" && typeof lastSegment === "string" &&
      ...
      if (existing !== void 0) {
        ...
        var newProperty = JSON.stringify(lastSegment) + ": " +
          JSON.stringify(value);
        var index = options.getInsertionIndex
          ? options.getInsertionIndex(parent.children.map(function (p) {
      ...
      parent.type === "array" && typeof lastSegment === "number" &&
      Array.isArray(parent.children)
    ) {
      ...
      if (insertIndex === -1) {
        ...
        if (!options.isArrayInsertion && parent.children.length > lastSegment) {
          ...
          edit = {
            offset: parent.offset + 1,
            length: 0,
            content: parent.children.length === 0
              ? newProperty
              : newProperty + ",",
          };
        } else {
          var index = lastSegment > parent.children.length
            ? parent.children.length
            : lastSegment;
          var previous = parent.children[index - 1];
          edit = {
  ...
  function applyEdit(text, edit) {
    return text.substring(0, edit.offset) + edit.content +
...
(function (factory) {
  ...
  "use strict";
  Object.defineProperty(exports, "__esModule", { value: true });
  exports.applyEdits = exports.modify = exports.format = exports
    .printParseErrorCode = exports.stripComments = exports.visit = exports
      .getNodeValue = exports.getNodePath = exports.findNodeAtOffset = exports
        .findNodeAtLocation = exports.parseTree = exports.parse = exports
          .getLocation = exports.createScanner = void 0;
...
(function (factory) {
  ...
  "use strict";
  Object.defineProperty(exports, "__esModule", { value: true });
  exports.isString = exports.isBoolean = exports.isDefined = exports.isNumber =
  ...
  function equals(one, other) {
    ...
    if (
      one === null || one === undefined || other === null || other === undefined
    ) {
      return false;
    }
...
(function (factory) {
  ...
  "use strict";
  Object.defineProperty(exports, "__esModule", { value: true });
  exports.TextDocument = exports.EOL = exports.SelectionRange = exports
    .DocumentLink = exports.FormattingOptions = exports.CodeLens = exports
      .CodeAction = exports.CodeActionContext = exports.CodeActionKind = exports
        .DocumentSymbol = exports.SymbolInformation = exports.SymbolTag =
          exports.SymbolKind = exports.DocumentHighlight = exports
            .DocumentHighlightKind = exports.SignatureInformation = exports
              .ParameterInformation = exports.Hover = exports.MarkedString =
                exports.CompletionList = exports.CompletionItem = exports
                  .InsertTextMode = exports.InsertReplaceEdit = exports
                    .CompletionItemTag = exports.InsertTextFormat = exports
                      .CompletionItemKind = exports.MarkupContent = exports
                        .MarkupKind = exports.TextDocumentItem = exports
                          .OptionalVersionedTextDocumentIdentifier = exports
                            .VersionedTextDocumentIdentifier = exports
                              .TextDocumentIdentifier = exports
                                .WorkspaceChange = exports.WorkspaceEdit =
                                  exports.DeleteFile = exports.RenameFile =
                                    exports.CreateFile = exports
                                      .TextDocumentEdit = exports
                                        .AnnotatedTextEdit = exports
                                          .ChangeAnnotationIdentifier = exports
                                            .ChangeAnnotation = exports
                                              .TextEdit = exports.Command =
                                                exports.Diagnostic = exports
  ...
  (function (Range) {
    ...
    function is(value) {
      var candidate = value;
      return Is.objectLiteral(candidate) && Position.is(candidate.start) &&
  ...
  (function (Location) {
    ...
    function is(value) {
      var candidate = value;
      return Is.defined(candidate) && Range.is(candidate.range) &&
  ...
  (function (LocationLink) {
    ...
    function is(value) {
      var candidate = value;
      return Is.defined(candidate) && Range.is(candidate.targetRange) &&
  ...
  (function (ColorInformation) {
    ...
    ColorInformation = exports.ColorInformation ||
  ...
  (function (ColorPresentation) {
    ...
    ColorPresentation = exports.ColorPresentation ||
  ...
  (function (FoldingRangeKind) {
    ...
    FoldingRangeKind = exports.FoldingRangeKind ||
  ...
  (function (DiagnosticRelatedInformation) {
    ...
    DiagnosticRelatedInformation = exports.DiagnosticRelatedInformation ||
  ...
  (function (ChangeAnnotation) {
    ...
    function is(value) {
      var candidate = value;
      return candidate !== undefined && Is.objectLiteral(candidate) &&
    ...
    ChangeAnnotation = exports.ChangeAnnotation ||
  ...
  (function (ChangeAnnotationIdentifier) {
    ...
    ChangeAnnotationIdentifier = exports.ChangeAnnotationIdentifier ||
  ...
  (function (AnnotatedTextEdit) {
    ...
    AnnotatedTextEdit = exports.AnnotatedTextEdit ||
  ...
  (function (TextDocumentEdit) {
    ...
    TextDocumentEdit = exports.TextDocumentEdit ||
  ...
  (function (CreateFile) {
    ...
    function is(value) {
      ...
      return candidate && candidate.kind === "create" &&
        Is.string(candidate.uri) && (candidate.options === undefined ||
  ...
  var ChangeAnnotations = /** @class */ (function () {
    function ChangeAnnotations(annotations) {
      this._annotations = annotations === undefined
        ? Object.create(null)
        : annotations;
      this._counter = 0;
      this._size = 0;
  ...
  (function (TextDocumentIdentifier) {
    ...
    TextDocumentIdentifier = exports.TextDocumentIdentifier ||
  ...
  (function (VersionedTextDocumentIdentifier) {
    ...
    VersionedTextDocumentIdentifier = exports.VersionedTextDocumentIdentifier ||
  ...
  (function (TextDocumentItem) {
    ...
    TextDocumentItem = exports.TextDocumentItem ||
  ...
  (function (MarkupKind) {
    ...
    function is(value) {
      var candidate = value;
      return candidate === MarkupKind.PlainText ||
  ...
  (function (InsertTextFormat) {
    ...
    InsertTextFormat = exports.InsertTextFormat ||
  ...
  (function (InsertReplaceEdit) {
    ...
    function is(value) {
      ...
      return candidate && Is.string(candidate.newText) &&
        Range.is(candidate.insert) && Range.is(candidate.replace);
    }
    InsertReplaceEdit.is = is;
  })(
    InsertReplaceEdit = exports.InsertReplaceEdit ||
  ...
  (function (ParameterInformation) {
    ...
    ParameterInformation = exports.ParameterInformation ||
  ...
  (function (SignatureInformation) {
    ...
    SignatureInformation = exports.SignatureInformation ||
  ...
  (function (DocumentHighlight) {
    ...
    DocumentHighlight = exports.DocumentHighlight ||
  ...
  (function (SymbolInformation) {
    ...
    SymbolInformation = exports.SymbolInformation ||
  ...
  (function (CodeActionContext) {
    ...
    CodeActionContext = exports.CodeActionContext ||
  ...
  (function (FormattingOptions) {
    ...
    FormattingOptions = exports.FormattingOptions ||
  ...
  (function (SelectionRange) {
    ...
    function is(value) {
      var candidate = value;
      return candidate !== undefined && Range.is(candidate.range) &&
  ...
  (function (TextDocument) {
    ...
    function is(value) {
      ...
      return Is.defined(candidate) && Is.string(candidate.uri) &&
          ...
          Is.func(candidate.getText) && Is.func(candidate.positionAt) &&
  ...
  function computeLineOffsets(text, isAtLineStart, textOffset) {
    ...
    for (var i = 0; i < text.length; i++) {
      ...
      if (ch === 13 /* CarriageReturn */ || ch === 10 /* LineFeed */) {
        if (
          ch === 13 /* CarriageReturn */ && i + 1 < text.length &&
...
define("vscode-languageserver-textdocument", [
  "vscode-languageserver-textdocument/main",
], function (main) {
  return main;
});
...
(function (factory) {
  ...
  "use strict";
  Object.defineProperty(exports, "__esModule", { value: true });
  exports.ClientCapabilities = exports.ErrorCode = exports.MarkedString =
    exports.Hover = exports.Location = exports.DocumentSymbol = exports
      .SymbolKind = exports.SymbolInformation = exports.MarkupKind = exports
        .MarkupContent = exports.InsertTextFormat = exports.Position = exports
          .CompletionList = exports.CompletionItemKind = exports
            .CompletionItem = exports.DiagnosticSeverity = exports.Diagnostic =
              exports.SelectionRange = exports.FoldingRangeKind = exports
                .FoldingRange = exports.ColorPresentation = exports
                  .ColorInformation = exports.Color = exports.TextEdit = exports
                    .Range = exports.TextDocument = void 0;
  ...
  var vscode_languageserver_textdocument_1 = require(
    "vscode-languageserver-textdocument",
  );
  ...
  (function (ClientCapabilities) {
    ...
    ClientCapabilities = exports.ClientCapabilities ||
...
(function (factory) {
  ...
  "use strict";
  Object.defineProperty(exports, "__esModule", { value: true });
  exports.parse = exports.JSONDocument = exports.contains = exports
    .getNodePath = exports.getNodeValue = exports.newJSONDocument = exports
      .ValidationResult = exports.EnumMatch = exports.asSchema = exports
        .ObjectASTNodeImpl = exports.PropertyASTNodeImpl = exports
          .StringASTNodeImpl = exports.NumberASTNodeImpl = exports
            .ArrayASTNodeImpl = exports.BooleanASTNodeImpl = exports
              .NullASTNodeImpl = exports.ASTNodeImpl = void 0;
  ...
  var JSONDocument = /** @class */ (function () {
    ...
    JSONDocument.prototype.validate = function (
      textDocument,
      schema,
      severity,
    ) {
      ...
      if (this.root && schema) {
        ...
        return validationResult.problems.map(function (p) {
          ...
          return jsonLanguageTypes_1.Diagnostic.create(
            range,
            p.message,
  ...
  function validate(n, schema, validationResult, matchingSchemas) {
      ...
      var testAlternatives = function (alternatives, maxOneMatch) {
        ...
        for (
          ...
          if (!bestMatch) {
            ...
            if (
              !maxOneMatch && !subValidationResult.hasProblems() &&
    ...
    function _validateNumberNode(
      ...
      function normalizeFloats(float) {
        ...
        return parts && {
          ...
          multiplier: (((_a = parts[2]) === null || _a === void 0
            ? void 0
    ...
    function _validateStringNode(
      ...
      if (
        objects_1.isNumber(schema.minLength) &&
      ...
      if (
        objects_1.isNumber(schema.maxLength) &&
    ...
    function _validateArrayNode(
      ...
      if (
        objects_1.isNumber(schema.minItems) &&
      ...
      if (
        objects_1.isNumber(schema.maxItems) &&
      ...
      if (Array.isArray(schema.required)) {
        for (var _b = 0, _c = schema.required; _b < _c.length; _b++) {
          ...
          if (!seenKeys[propertyName]) {
            var keyNode = node.parent && node.parent.type === "property" &&
              node.parent.keyNode;
  ...
  function parse(textDocument, config) {
    ...
    function _finalize(node, scanNext) {
      node.length = scanner.getTokenOffset() + scanner.getTokenLength() -
        node.offset;
      if (scanNext) {
        _scanNext();
      }
...
(function (factory) {
  ...
  "use strict";
  Object.defineProperty(exports, "__esModule", { value: true });
  exports.repeat = exports.convertSimple2RegExpPattern = exports.endsWith =
...
(function (factory) {
  ...
  var JSONCompletion = /** @class */ (function () {
        ...
        add: function (suggestion) {
          ...
          if (!existing) {
            ...
            if (overwriteRange && suggestion.insertText !== undefined) {
              suggestion.textEdit = jsonLanguageTypes_1.TextEdit.replace(
                overwriteRange,
          ...
          if (node && node.type === "object") {
            ...
            properties.forEach(function (p) {
              if (!currentProperty || currentProperty !== p) {
                proposed[p.keyNode.value] = jsonLanguageTypes_1.CompletionItem
                  .create("__");
              }
            });
            ...
            Object.keys(schemaProperties_1).forEach(function (key) {
              ...
              if (
                ...
                var proposal = {
                  ...
                  insertTextFormat:
                    jsonLanguageTypes_1.InsertTextFormat.Snippet,
    ...
    JSONCompletion.prototype.addDefaultValueCompletions = function (
      ...
      if (
        !hasProposals && typeof schema.items === "object" &&
        !Array.isArray(schema.items) && arrayDepth < 5 /* beware of recursion */
      ) {
    ...
    JSONCompletion.prototype.addEnumValueCompletions = function (
      ...
      if (objects_1.isDefined(schema.const)) {
        collector.add({
          ...
          insertTextFormat: jsonLanguageTypes_1.InsertTextFormat.Snippet,
          documentation: this.fromMarkup(schema.markdownDescription) ||
            schema.description,
        });
      }
      if (Array.isArray(schema.enum)) {
        for (var i = 0, length = schema.enum.length; i < length; i++) {
          ...
          var documentation = this.fromMarkup(schema.markdownDescription) ||
            schema.description;
          if (
            ...
            schema.enumDescriptions && i < schema.enumDescriptions.length
          ) {
      ...
      if (!objects_1.isDefined(this.supportsMarkdown)) {
        ...
        this.supportsMarkdown = completion && completion.completionItem &&
          ...
          completion.completionItem.documentationFormat.indexOf(
              jsonLanguageTypes_1.MarkupKind.Markdown,
            ) !== -1;
      }
      ...
      var t = {
            ...
            var n = {
              ...
              relative: function (t, r) {
                ...
                for (
                  ...
                  var l = t.charCodeAt(i + c);
                  if (l !== r.charCodeAt(h + c)) break;
                  47 === l && (u = c);
                }
                var p = "";
                for (c = i + u + 1; c <= o; ++c) {
                  c !== o && 47 !== t.charCodeAt(c) ||
                    (0 === p.length ? p += ".." : p += "/..");
                }
                return p.length > 0
                  ? p + r.slice(h + u)
              ...
              extname: function (t) {
                e(t);
                for (
                  var r = -1, n = 0, i = -1, o = !0, a = 0, h = t.length - 1;
                  h >= 0;
                  --h
                ) {
          ...
          674: (t, e) => {
            if (
              ...
              e.isWindows = "win32" === process.platform;
            } else if ("object" == typeof navigator) {
              var r = navigator.userAgent;
              e.isWindows = r.indexOf("Windows") >= 0;
            }
          },
          796: function (t, e, r) {
            var n,
                ...
                return t.isUri = function (e) {
                  return e instanceof t ||
                    !!e && "string" == typeof e.authority &&
                      ...
                      "string" == typeof e.path && "string" == typeof e.query &&
                  ...
                  t.file = function (t) {
                    var e = u;
                    if (
                      a.isWindows && (t = t.replace(/\\/g, c)),
                        t[0] === c && t[1] === c
                    ) {
                      var r = t.indexOf(c, 2);
                      -1 === r ? (e = t.substring(2), t = c)
                      : (e = t.substring(2, r), t = t.substring(r) || c);
                    }
                    return new g("file", e, t, u, u);
                  },
                  t.from = function (t) {
                    return new g(
                      t.scheme,
            ...
            var d = a.isWindows ? 1 : void 0,
              g = function (t) {
                ...
                return o(e, t),
                  ...
                  e.prototype.toJSON = function () {
                    var t = { $mid: 1 };
                    return this._fsPath &&
                      (t.fsPath = this._fsPath, t._sep = d),
              ...
              v =
                ((i = {})[58] = "%3A",
                  ...
                  i);
            function m(t, e) {
              for (var r = void 0, n = -1, i = 0; i < t.length; i++) {
                var o = t.charCodeAt(i);
                if (
                  o >= 97 && o <= 122 || o >= 65 && o <= 90 ||
                  o >= 48 && o <= 57 || 45 === o || 46 === o || 95 === o ||
                  126 === o || e && 47 === o
                ) {
                  -1 !== n &&
                  (r += encodeURIComponent(t.substring(n, i)), n = -1),
                    void 0 !== r && (r += t.charAt(i));
                } else {
                  void 0 === r && (r = t.substr(0, i));
                  var a = v[o];
                  void 0 !== a
                    ? (-1 !== n &&
                      (r += encodeURIComponent(t.substring(n, i)), n = -1),
          ...
          679: function (t, e, r) {
            ...
            (i = e.Utils || (e.Utils = {})).joinPath = function (t) {
              for (var e = [], r = 1; r < arguments.length; r++) {
                e[r - 1] = arguments[r];
              }
              return t.with({ path: a.join.apply(a, n([t.path], e)) });
            },
              i.resolvePath = function (t) {
                for (var e = [], r = 1; r < arguments.length; r++) {e[r - 1] =
                    arguments[r];}
                var i = t.path || "/";
                return t.with({ path: a.resolve.apply(a, n([i], e)) });
              },
...
(function (factory) {
  ...
  "use strict";
  Object.defineProperty(exports, "__esModule", { value: true });
  exports.JSONSchemaService = exports.ResolvedSchema = exports
    .UnresolvedSchema = void 0;
  var Json = require("jsonc-parser");
      ...
      try {
        for (var _i = 0, pattern_1 = pattern; _i < pattern_1.length; _i++) {
          ...
          this.patternRegExps.push(
            new RegExp(Strings.convertSimple2RegExpPattern(p) + "$"),
          );
  ...
  var JSONSchemaService = /** @class */ (function () {
    ...
    JSONSchemaService.prototype.addFilePatternAssociation = function (
      pattern,
      uris,
    ) {
      ...
      if (document && document.root && document.root.type === "object") {
        ...
        if (schemaProperties.length > 0) {
          ...
          if (valueNode && valueNode.type === "string") {
            ...
            if (
              schemeId && Strings.startsWith(schemeId, ".") &&
              this.contextService
            ) {
    ...
    JSONSchemaService.prototype.getMatchingSchemas = function (
      document,
      jsonDocument,
      schema,
    ) {
  ...
  function normalizeResourceForMatching(resource) {
    ...
    try {
      return vscode_uri_1.URI.parse(resource).with({
        fragment: null,
        query: null,
      }).toString();
    } catch (e) {
    ...
    JSONValidation.prototype.doValidation = function (
      ...
      var getDiagnostics = function (schema) {
        ...
        if (schema) {
          if (schema.errors.length && jsonDocument.root && schemaRequest) {
            ...
            var property = astRoot.type === "object"
      ...
      if (schema) {
        ...
        return this.jsonSchemaService.resolveSchemaContent(
          new jsonSchemaService_1.UnresolvedSchema(schema),
          id,
          {},
        ).then(function (resolvedSchema) {
...
(function (factory) {
  ...
  var JSONDocumentSymbols = /** @class */ (function () {
            ...
            if (item.type === "object") {
              for (var _b = 0, _c = item.properties; _b < _c.length; _b++) {
                ...
                if (property.keyNode.value === "key" && property.valueNode) {
                  var location = jsonLanguageTypes_1.Location.create(
                    document.uri,
    ...
    JSONDocumentSymbols.prototype.getColorPresentations = function (
      ...
      result.push({
        label: label,
        textEdit: jsonLanguageTypes_1.TextEdit.replace(
          range,
  ...
  function getFoldingRanges(document, context) {
      ...
      switch (token) {
        ...
        case 13 /* BlockCommentTrivia */: {
          ...
          if (
            ...
            scanner.setPosition(
              document.offsetAt(
                jsonLanguageTypes_1.Position.create(startLine + 1, 0),
              ),
            );
          } else {
    ...
    for (var i = 0; i < ranges.length; i++) {
      ...
      if (typeof level === "number") {
        if (
          level < maxLevel || (level === maxLevel && entries++ < rangeLimit)
        ) {
  ...
  function getSelectionRanges(document, positions, doc) {
    function getSelectionRange(position) {
      ...
      for (var index = result.length - 1; index >= 0; index--) {
        current = jsonLanguageTypes_1.SelectionRange.create(
          result[index],
          current,
        );
      }
      if (!current) {
        current = jsonLanguageTypes_1.SelectionRange.create(
          jsonLanguageTypes_1.Range.create(position, position),
        );
      }
      return current;
    }
      ...
      format: function (d, r, o) {
        ...
        var options = {
          ...
          insertSpaces: (o === null || o === void 0
            ? void 0
            : o.insertSpaces) === true,
          insertFinalNewline: (o === null || o === void 0
            ? void 0
            : o.insertFinalNewline) === true,
          eol: "\n",
        };
        return jsonc_parser_1.format(d.getText(), range, options).map(
          function (e) {
...
define("vs/language/json/languageFeatures", [
  ...
  "use strict";
  Object.defineProperty(exports, "__esModule", { value: true });
  exports.SelectionRangeAdapter = exports.FoldingRangeAdapter = exports
    .DocumentColorAdapter = exports.DocumentRangeFormattingEditProvider =
      exports.DocumentFormattingEditProvider = exports.DocumentSymbolAdapter =
        exports.HoverAdapter = exports.CompletionAdapter = exports
          .DiagnosticsAdapter = void 0;
  // --- diagnostics --- ---
    ...
    function DiagnosticsAdapter(_languageId, _worker, defaults) {
      ...
      var onModelAdd = function (model) {
        ...
        _this._listener[model.uri.toString()] = model.onDidChangeContent(
          function () {
            clearTimeout(handle);
            handle = Number(setTimeout(function () {
      ...
      this._disposables.push(
        monaco_editor_core_1.editor.onDidCreateModel(onModelAdd),
      );
      this._disposables.push(
    ...
    DiagnosticsAdapter.prototype._doValidate = function (resource, languageId) {
      this._worker(resource)
        .then(function (worker) {
          return worker.doValidation(resource.toString()).then(
      ...
      return this._worker(resource)
        ...
        .then(function (info) {
          ...
          var items = info.items.map(function (entry) {
            ...
            if (
              entry.insertTextFormat === jsonService.InsertTextFormat.Snippet
            ) {
              item.insertTextRules =
                monaco_editor_core_1.languages.CompletionItemInsertTextRule
                  .InsertAsSnippet;
            }
            return item;
          });
  ...
  var DocumentFormattingEditProvider = /** @class */ (function () {
    ...
    DocumentFormattingEditProvider.prototype.provideDocumentFormattingEdits =
      function (model, options, token) {
        var resource = model.uri;
  ...
  var DocumentRangeFormattingEditProvider = /** @class */ (function () {
    ...
    DocumentRangeFormattingEditProvider.prototype
  ...
  var SelectionRangeAdapter = /** @class */ (function () {
    ...
    SelectionRangeAdapter.prototype.provideSelectionRanges = function (
      model,
      positions,
      token,
    ) {
...
define(
  ...
  function (require, exports, json) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.TOKEN_COMMENT_LINE = exports.TOKEN_COMMENT_BLOCK = exports
      .TOKEN_PROPERTY_NAME = exports.TOKEN_VALUE_NUMBER = exports
        .TOKEN_VALUE_STRING = exports.TOKEN_VALUE_NULL = exports
          .TOKEN_VALUE_BOOLEAN = exports.TOKEN_DELIM_COMMA = exports
            .TOKEN_DELIM_COLON = exports.TOKEN_DELIM_ARRAY = exports
              .TOKEN_DELIM_OBJECT = exports.createTokenizationSupport = void 0;
      ...
      while (true) {
        ...
        switch (kind) {
          ...
          case 10 /* StringLiteral */:
            ...
            type = lastWasColon || inArray ? exports.TOKEN_VALUE_STRING
    ...
    function setupMode(defaults) {
      ...
      function registerProviders() {
        ...
        if (modeConfiguration.documentFormattingEdits) {
          providers.push(
            monaco_editor_core_1.languages
        ...
        if (modeConfiguration.hovers) {
          providers.push(
            monaco_editor_core_1.languages.registerHoverProvider(
              languageId,
        ...
        if (modeConfiguration.tokens) {
          providers.push(
            monaco_editor_core_1.languages.setTokensProvider(
              languageId,
      ...
      registerProviders();
      disposables.push(
        monaco_editor_core_1.languages.setLanguageConfiguration(
          defaults.languageId,
