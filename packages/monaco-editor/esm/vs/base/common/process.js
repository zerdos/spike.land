...
if (typeof process !== "undefined") {
  ...
  safeProcess = {
    ...
    // Unsupported
    cwd() {
      return globals.vscode.process.env["VSCODE_CWD"] ||
        globals.vscode.process.execPath.substr(
          0,
          globals.vscode.process.execPath.lastIndexOf(
            globals.vscode.process.platform === "win32" ? "\\" : "/",
          ),
        );
    },
  };
