...
(function (Codicon) {
    ...
    Codicon.variableGroup = new Codicon('variable-group', { character: '\\ebb8' });
    Codicon.typeHierarchy = new Codicon('type-hierarchy', { character: '\\ebb9' });
    Codicon.typeHierarchySub = new Codicon('type-hierarchy-sub', { character: '\\ebba' });
    Codicon.typeHierarchySuper = new Codicon('type-hierarchy-super', { character: '\\ebbb' });
