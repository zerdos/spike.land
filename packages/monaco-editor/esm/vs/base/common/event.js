...
export class Emitter {
  constructor(options) {
    ...
    this._leakageMon = _globalLeakWarningThreshold > 0
      ...
      : undefined;
    this._perfMon =
      ((_a = this._options) === null || _a === void 0 ? void 0 : _a._profName)
  ...
  get event() {
    if (!this._event) {
      this._event = (listener, thisArgs, disposables) => {
        ...
        if (
          firstListener && this._options && this._options.onFirstListenerDidAdd
        ) {
        ...
        const removeMonitor = (_a = this._leakageMon) === null || _a === void 0
          ? void 0
