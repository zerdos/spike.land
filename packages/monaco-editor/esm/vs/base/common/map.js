...
export class PathIterator {
  ...
  next() {
    ...
    for (; this._to < this._value.length; this._to++) {
      ...
      if (
        ch === 47 /* Slash */ ||
        this._splitOnBackslash && ch === 92 /* Backslash */
      ) {
        if (justSeps) {
          this._from++;
        } else {
...
export class UriIterator {
  ...
  next() {
    if (
      this._states[this._stateIdx] === 3 /* Path */ &&
  ...
  hasNext() {
    return (this._states[this._stateIdx] === 3 /* Path */ &&
      this._pathIterator.hasNext()) ||
...
export class ResourceMap {
  constructor(mapOrKeyFn, toKey) {
    ...
    if (mapOrKeyFn instanceof ResourceMap) {
      ...
      this.toKey = toKey !== null && toKey !== void 0
        ? toKey
        : ResourceMap.defaultToKey;
    } else {
      this.map = new Map();
      this.toKey = mapOrKeyFn !== null && mapOrKeyFn !== void 0
        ? mapOrKeyFn
        : ResourceMap.defaultToKey;
    }
  }
