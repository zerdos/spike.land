...
export class AbstractScrollableElement extends Widget {
  constructor(element, options, scrollable) {
    ...
    this._domNode.className = "monaco-scrollable-element " +
  ...
  _onMouseWheel(e) {
    ...
    if (e.deltaY || e.deltaX) {
      ...
      const shiftConvert = !platform.isMacintosh && e.browserEvent &&
  ...
  _onDidScroll(e) {
    this._shouldRender = this._horizontalScrollbar.onDidScroll(e) ||
      this._shouldRender;
    this._shouldRender = this._verticalScrollbar.onDidScroll(e) ||
      this._shouldRender;
    if (this._options.useShadows) {
      this._shouldRender = true;
    }
...
function resolveOptions(opts) {
  const result = {
    ...
    useShadows: (typeof opts.useShadows !== "undefined"
      ? opts.useShadows
      : true),
    ...
    mouseWheelScrollSensitivity:
      (typeof opts.mouseWheelScrollSensitivity !== "undefined"
        ...
        : 1),
    fastScrollSensitivity: (typeof opts.fastScrollSensitivity !== "undefined"
      ? opts.fastScrollSensitivity
      : 5),
    scrollPredominantAxis: (typeof opts.scrollPredominantAxis !== "undefined"
      ? opts.scrollPredominantAxis
      : true),
    mouseWheelSmoothScroll: (typeof opts.mouseWheelSmoothScroll !== "undefined"
      ? opts.mouseWheelSmoothScroll
      : true),
    arrowSize: (typeof opts.arrowSize !== "undefined"
      ? opts.arrowSize
      : 11),
    ...
    verticalSliderSize: (typeof opts.verticalSliderSize !== "undefined"
      ...
      : 0),
    scrollByPage: (typeof opts.scrollByPage !== "undefined"
      ? opts.scrollByPage
      : false),
  };
