...
export class ActionBar extends Disposable {
  constructor(container, options = {}) {
    ...
    this._onDidCancel = this._register(
      new Emitter({ onFirstListenerAdd: () => this.cancelHasListener = true }),
    );
    ...
    this._context = (_a = options.context) !== null && _a !== void 0
      ? _a
      : null;
    this._orientation =
    ...
    this._triggerKeys = {
      keyDown:
        (_d = (_c = this.options.triggerKeys) === null || _c === void 0
              ? void 0
              : _c.keyDown) !== null && _d !== void 0
          ? _d
          : false,
      keys: (_f = (_e = this.options.triggerKeys) === null || _e === void 0
              ? void 0
    ...
    switch (this._orientation) {
      case 0 /* HORIZONTAL */:
        previousKeys = this.options.ignoreOrientationForPreviousAndNextKey
          ? [15, /* LeftArrow */ 16 /* UpArrow */]
          : [15 /* LeftArrow */];
        nextKeys = this.options.ignoreOrientationForPreviousAndNextKey
          ? [17, /* RightArrow */ 18 /* DownArrow */]
          : [17 /* RightArrow */];
        break;
    ...
    this._register(
      DOM.addDisposableListener(this.domNode, DOM.EventType.KEY_DOWN, (e) => {
        ...
        if (
          ...
          nextKeys && (event.equals(nextKeys[0]) || event.equals(nextKeys[1]))
        ) {
  ...
  push(arg, options = {}) {
    ...
    actions.forEach((action) => {
      ...
      if (
        index === null || index < 0 || index >= this.actionsList.children.length
      ) {
    ...
    for (let i = 0; i < this.viewItems.length; i++) {
      ...
      if (i === this.focusedItem) {
        if (types.isFunction(actionViewItem.isEnabled)) {
          if (
            actionViewItem.isEnabled() && types.isFunction(actionViewItem.focus)
          ) {
