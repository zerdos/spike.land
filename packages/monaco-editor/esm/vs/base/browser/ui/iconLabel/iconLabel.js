...
export class IconLabel extends Disposable {
  constructor(container, options) {
    ...
    if (
      options === null || options === void 0 ? void 0 : options.hoverDelegate
    ) {
  ...
  static adjustXAndShowCustomHover(
    hoverOptions,
    mouseX,
    hoverDelegate,
    isHovering,
  ...
  setupCustomHover(hoverDelegate, htmlElement, markdownTooltip) {
    ...
    function mouseOver(e) {
      ...
      const mouseLeaveDisposable = domEvent(
        htmlElement,
        dom.EventType.MOUSE_LEAVE,
        true,
      )(mouseLeaveOrDown.bind(htmlElement));
      const mouseDownDisposable = domEvent(
        htmlElement,
      ...
      const mouseMoveDisposable = domEvent(
        htmlElement,
        dom.EventType.MOUSE_MOVE,
        true,
      )(mouseMove.bind(htmlElement));
      setTimeout(() =>
        __awaiter(this, void 0, void 0, function* () {
          var _a;
          if (isHovering && tooltip) {
            ...
            if (!hoverOptions) {
              ...
              const hoverDisposable = IconLabel.adjustXAndShowCustomHover(
                hoverOptions,
                mouseX,
                hoverDelegate,
                isHovering,
              ...
              const resolvedTooltip =
                (_a = (yield tooltip(tokenSource.token))) !== null &&
                  _a !== void 0
                  ? _a
              ...
              if (resolvedTooltip) {
                ...
                IconLabel.adjustXAndShowCustomHover(
                  hoverOptions,
                  mouseX,
                  hoverDelegate,
                  isHovering,
    ...
    const mouseOverDisposable = this._register(
      domEvent(htmlElement, dom.EventType.MOUSE_OVER, true)(
        mouseOver.bind(htmlElement),
      ),
    );
  ...
  setLabel(label, options) {
    ...
    if (typeof label === "string") {
      ...
      for (let i = 0; i < label.length; i++) {
        const l = label[i];
        const id = (options === null || options === void 0
          ? void 0
          : options.domId) && `${
          options === null || options === void 0
            ? void 0
...
class LabelWithHighlights {
  ...
  setLabel(label, options) {
    ...
    if (typeof label === "string") {
      ...
      this.container.classList.add("multiple");
      this.singleLabel = undefined;
      const separator = (options === null || options === void 0
        ? void 0
        : options.separator) || "/";
