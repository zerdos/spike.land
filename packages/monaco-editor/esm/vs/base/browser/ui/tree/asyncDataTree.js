      ...
      accessibilityProvider: options.accessibilityProvider &&
        Object.assign(Object.assign({}, options.accessibilityProvider), {
          ...
          isChecked: options.accessibilityProvider.isChecked
            ? (e) => {
              var _a;
              return !!((_a = options.accessibilityProvider) === null ||
                  _a === void 0
                ? void 0
...
export class AsyncDataTree {
  constructor(user, container, delegate, renderers, dataSource, options = {}) {
    ...
    this.nodeMapper = new WeakMapper((node) =>
  ...
  createTree(user, container, delegate, renderers, options) {
    ...
    const objectTreeRenderers = renderers.map((r) =>
  ...
  _updateChildren(
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      yield this.refreshAndRenderNode(
        node,
        recursive,
        viewStateContext,
        options,
  ...
  expand(element, recursive = false) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (
        node !== this.root && !node.refreshPromise &&
  ...
  doRefreshSubTree(node, recursive, viewStateContext) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      try {
        const childrenToRefresh = yield this.doRefreshNode(
          node,
          recursive,
          viewStateContext,
        );
  ...
  setChildren(node, childrenElementsIterable, recursive, viewStateContext) {
    ...
    const children = childrenElements.map((element) => {
      ...
      if (!this.identityProvider) {
        ...
        if (
          hasChildren && this.collapseByDefault &&
      ...
      if (
        viewStateContext && viewStateContext.viewState.focus &&
        viewStateContext.viewState.focus.indexOf(id) > -1
      ) {
        viewStateContext.focus.push(childAsyncDataTreeNode);
      }
      if (
        viewStateContext && viewStateContext.viewState.selection &&
        viewStateContext.viewState.selection.indexOf(id) > -1
      ) {
        viewStateContext.selection.push(childAsyncDataTreeNode);
      }
      if (
        viewStateContext && viewStateContext.viewState.expanded &&
    ...
    if (
      node !== this.root && this.autoExpandSingleChildren &&
      children.length === 1 && childrenToRefresh.length === 0
    ) {
  ...
  asTreeElement(node, viewStateContext) {
    ...
    let collapsed;
    if (
      viewStateContext && viewStateContext.viewState.expanded && node.id &&
...
class CompressibleAsyncDataTreeNodeWrapper {
  ...
  get children() {
    return this.node.children.map((node) =>
      new CompressibleAsyncDataTreeNodeWrapper(node)
    );
  }
  get depth() {
    return this.node.depth;
  ...
  return objectTreeOptions &&
    Object.assign(Object.assign({}, objectTreeOptions), {
      keyboardNavigationLabelProvider:
        ...
        Object.assign(
          Object.assign({}, objectTreeOptions.keyboardNavigationLabelProvider),
          {
...
export class CompressibleAsyncDataTree extends AsyncDataTree {
  constructor(
    ...
    this.compressibleNodeMapper = new WeakMapper((node) =>
      new CompressibleAsyncDataTreeNodeWrapper(node)
    );
    ...
    const visit = (node) => {
      ...
      if (compressedNode) {
        for (let i = 0; i < compressedNode.elements.length; i++) {
          ...
          const element =
            compressedNode.elements[compressedNode.elements.length - 1].element;
