...
export class CompressedObjectTreeModel {
  constructor(user, list, options = {}) {
    ...
    this.enabled = typeof options.compressionEnabled === "undefined"
      ? true
  ...
  setChildren(element, children = Iterable.empty(), options) {
    ...
    const diffIdentityProvider = options.diffIdentityProvider &&
...
class CompressedTreeNodeWrapper {
  ...
  get children() {
    return this.node.children.map((node) =>
      new CompressedTreeNodeWrapper(this.unwrapper, node)
    );
  }
  get depth() {
