...
export class InputBox extends Widget {
  constructor(container, contextViewProvider, options) {
    ...
    if (this.options.flexibleHeight) {
      this.maxHeight = typeof this.options.flexibleMaxHeight === "number"
      ...
      this._register(
        this.scrollableElement.onScroll((e) =>
          this.input.scrollTop = e.scrollTop
        ),
      );
      const onSelectionChange = Event.filter(
        ...
        () => {
          ...
          return (selection === null || selection === void 0
            ? void 0
  ...
  set width(width) {
    if (this.options.flexibleHeight && this.options.flexibleWidth) {
      ...
      if (this.mirror) {
        const paddingLeft = parseFloat(this.mirror.style.paddingLeft || "") ||
          0;
        const paddingRight = parseFloat(this.mirror.style.paddingRight || "") ||
          0;
  ...
  updateScrollDimensions() {
    if (
      ...
      typeof this.cachedHeight !== "number" || !this.scrollableElement
    ) {
      return;
    }
