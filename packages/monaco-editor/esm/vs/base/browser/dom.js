...
export function isInDOM(node) {
  var _a;
  return (_a = node === null || node === void 0 ? void 0 : node.isConnected) !==
        null && _a !== void 0
    ? _a
    : false;
}
...
export let addStandardDisposableListener =
...
export class Dimension {
  ...
  static is(obj) {
    return typeof obj === "object" && typeof obj.height === "number" &&
...
export function getTotalWidth(element) {
  let margin = SizeUtils.getMarginLeft(element) +
    SizeUtils.getMarginRight(element);
  return element.offsetWidth + margin;
}
export function getContentWidth(element) {
  let border = SizeUtils.getBorderLeftWidth(element) +
    SizeUtils.getBorderRightWidth(element);
  let padding = SizeUtils.getPaddingLeft(element) +
    SizeUtils.getPaddingRight(element);
  return element.offsetWidth - border - padding;
}
// Adapted from WinJS
// Gets the height of the content of the specified element. The content height does not include borders or padding.
export function getContentHeight(element) {
  let border = SizeUtils.getBorderTopWidth(element) +
    SizeUtils.getBorderBottomWidth(element);
  let padding = SizeUtils.getPaddingTop(element) +
    SizeUtils.getPaddingBottom(element);
  return element.offsetHeight - border - padding;
}
// Adapted from WinJS
// Gets the height of the element, including its margins.
export function getTotalHeight(element) {
  let margin = SizeUtils.getMarginTop(element) +
    SizeUtils.getMarginBottom(element);
...
function getDynamicStyleSheetRules(style) {
  var _a, _b;
  if (
    (_a = style === null || style === void 0 ? void 0 : style.sheet) === null ||
      _a === void 0
      ? void 0
      : _a.rules
  ) {
  ...
  if (
    (_b = style === null || style === void 0 ? void 0 : style.sheet) === null ||
      _b === void 0
      ? void 0
      : _b.cssRules
  ) {
...
export function asCSSUrl(uri) {
  ...
  return `url('${
    FileAccess.asBrowserUri(uri).toString(true).replace(/'/g, "%27")
  }')`;
}
export class ModifierKeyEmitter extends Emitter {
  constructor() {
    ...
    this._subscriptions.add(
      domEvent(document.body, "mouseup", true)((e) => {
        this._keyStatus.lastKeyPressed = undefined;
      }),
    );
    this._subscriptions.add(
      domEvent(document.body, "mousemove", true)((e) => {
        if (e.buttons) {
          this._keyStatus.lastKeyPressed = undefined;
        }
      }),
