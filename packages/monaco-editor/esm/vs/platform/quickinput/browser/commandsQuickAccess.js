            ...
            Object.assign(Object.assign({}, commandPick), {
              ...
              accept: () =>
                __awaiter(this, void 0, void 0, function* () {
                  ...
                  // Run
                  try {
                    yield this.commandService.executeCommand(
                      commandPick.commandId,
                    );
                  } catch (error) {
...
let CommandsHistory = class CommandsHistory extends Disposable {
  ...
  updateConfiguration() {
    this.configuredCommandsHistoryLength = CommandsHistory
      .getConfiguredCommandHistoryLength(this.configurationService);
    if (
  ...
  peek(commandId) {
    var _a;
    return (_a = CommandsHistory.cache) === null || _a === void 0
      ? void 0
      : _a.peek(commandId);
  }
  ...
  static getConfiguredCommandHistoryLength(configurationService) {
    ...
    const configuredCommandHistoryLength =
      (_b = (_a = config.workbench) === null || _a === void 0
            ? void 0
