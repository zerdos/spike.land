...
export class PickerQuickAccessProvider extends Disposable {
  ...
  provide(picker, token) {
          ...
          yield Promise.all([
            ...
            (() =>
              __awaiter(this, void 0, void 0, function* () {
                picker.busy = true;
                try {
                  const awaitedAdditionalPicks = yield providedPicks
                    .additionalPicks;
                  if (picksToken.isCancellationRequested) {
                    return;
                  }
    ...
    disposables.add(picker.onDidAccept((event) => {
      ...
      if (
        typeof (item === null || item === void 0 ? void 0 : item.accept) ===
          "function"
      ) {
      ...
      picker.onDidTriggerItemButton(({ button, item }) =>
        __awaiter(this, void 0, void 0, function* () {
          ...
          if (typeof item.trigger === "function") {
            const buttonIndex =
              (_c = (_b = item.buttons) === null || _b === void 0
                    ? void 0
                    : _b.indexOf(button)) !== null && _c !== void 0
                ? _c
                : -1;
            if (buttonIndex >= 0) {
              const result = item.trigger(buttonIndex, picker.keyMods);
              const action = (typeof result === "number")
                ? result
                : yield result;
