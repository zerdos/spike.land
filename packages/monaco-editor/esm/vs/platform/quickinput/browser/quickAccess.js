...
let QuickAccessController = class QuickAccessController extends Disposable {
  ...
  show(value = "", options) {
    ...
    if (
      ...
      if (
        visibleQuickAccess && visibleDescriptor &&
      ...
      if (!newValue) {
        const defaultFilterValue = provider === null || provider === void 0
          ? void 0
    ...
    picker.placeholder = descriptor === null || descriptor === void 0
      ? void 0
      : descriptor.placeholder;
    picker.quickNavigate = options === null || options === void 0
      ? void 0
    ...
    if (
      ...
      picker.itemActivation = (_a = options === null || options === void 0
              ? void 0
              : options.itemActivation) !== null && _a !== void 0
        ? _a
        : ItemActivation.SECOND /* quick nav is always second */;
    }
    picker.contextKey = descriptor === null || descriptor === void 0
      ? void 0
    ...
    if (
      ...
      picker.ariaLabel = descriptor === null || descriptor === void 0
        ? void 0
        : descriptor.placeholder;
    }
    // Register listeners
    const cancellationToken = this.registerPickerListeners(
      picker,
      provider,
      descriptor,
      value,
  ...
  adjustValueSelection(picker, descriptor, options) {
    ...
    if (
      ...
      valueSelection = [
        (_a = descriptor === null || descriptor === void 0
              ? void 0
