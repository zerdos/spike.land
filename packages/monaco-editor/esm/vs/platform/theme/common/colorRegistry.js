...
class ColorRegistry {
  ...
  toString() {
    ...
    return Object.keys(this.colorsById).sort(sorter).map((k) =>
      `- \`${k}\`: ${this.colorsById[k].description}`
    ).join("\n");
  }
}
 ...
 * Inline hints
 */
export const editorInlineHintForeground = registerColor(
...
export const editorInlineHintBackground = registerColor(
