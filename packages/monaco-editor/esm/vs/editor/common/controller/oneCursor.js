...
export class OneCursor {
  ...
  _setState(context, modelState, viewState) {
    ...
    if (!viewState) {
      ...
      const viewSelectionStart1 = context.coordinatesConverter
      ...
      const viewSelectionStart2 = context.coordinatesConverter
        .convertModelPositionToViewPosition(
          new Position(
      ...
      const viewPosition = context.coordinatesConverter
