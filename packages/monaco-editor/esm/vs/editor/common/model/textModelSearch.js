...
export function isMultilineRegexSource(searchString) {
  ...
  for (let i = 0, len = searchString.length; i < len; i++) {
    ...
    if (chCode === 92 /* Backslash */) {
      ...
      if (
        nextChCode === 110 /* n */ || nextChCode === 114 /* r */ ||
        nextChCode === 87 /* W */ || nextChCode === 119 /* w */
      ) {
        return true;
      }
    }
...
export class TextModelSearch {
  ...
  static _getMultilineMatchRange(
    ...
    let endOffset;
    if (lfCounter) {
      let lineFeedCountBeforeEndOfMatch = lfCounter
        .findLineFeedCountBeforeOffset(matchIndex + match0.length);
      let lineFeedCountInMatch = lineFeedCountBeforeEndOfMatch -
...
function leftIsWordBounday(
  ...
  if (
    charBefore === 13 /* CarriageReturn */ || charBefore === 10 /* LineFeed */
  ) {
...
function rightIsWordBounday(
  ...
  if (
    charAfter === 13 /* CarriageReturn */ || charAfter === 10 /* LineFeed */
  ) {
