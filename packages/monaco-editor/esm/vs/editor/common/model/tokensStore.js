  ...
  acceptInsertText(
    ...
    for (let i = 0; i < tokenCount; i++) {
      ...
      if (
        ...
        tokenDeltaLine === deltaLine && tokenStartCharacter < character &&
        ...
        if (tokenDeltaLine === deltaLine) {
          ...
          if (eolCount === 0) {
            ...
            tokenStartCharacter = lastLineLength +
...
export class TokensStore2 {
  ...
  addSemanticTokens(lineNumber, aTokens) {
    ...
    for (let bIndex = 0; bIndex < bLen; bIndex++) {
      ...
      const bMask = (((bMetadata & 1 /* SEMANTIC_USE_ITALIC */)
        ? 2048 /* ITALIC_MASK */
        : 0) |
        ((bMetadata & 2 /* SEMANTIC_USE_BOLD */)
          ? 4096 /* BOLD_MASK */
          : 0) |
        ((bMetadata & 4 /* SEMANTIC_USE_UNDERLINE */)
          ? 8192 /* UNDERLINE_MASK */
          : 0) |
        ((bMetadata & 8 /* SEMANTIC_USE_FOREGROUND */)
          ? 8372224 /* FOREGROUND_MASK */
          : 0) |
        ((bMetadata & 16 /* SEMANTIC_USE_BACKGROUND */)
          ? 4286578688 /* BACKGROUND_MASK */
          : 0)) >>> 0;
      const aMask = (~bMask) >>> 0;
  ...
  static _findFirstPieceWithLine(pieces, lineNumber) {
    ...
    while (low < high) {
      ...
      if (pieces[mid].endLineNumber < lineNumber) {
        ...
        while (
          mid > low && pieces[mid - 1].startLineNumber <= lineNumber &&
...
export class TokensStore {
  ...
  static _massageTokens(topLevelLanguageId, lineTextLength, _tokens) {
    ...
    if (
      tokens.byteOffset === 0 && tokens.byteLength === tokens.buffer.byteLength
    ) {
