...
export class IndentRulesSupport {
  ...
  shouldDecrease(text) {
    if (
      this._indentationRules && this._indentationRules.decreaseIndentPattern &&
  ...
  shouldIndentNextLine(text) {
    if (
      this._indentationRules && this._indentationRules.indentNextLinePattern &&
  ...
  shouldIgnore(text) {
    ...
    if (
      this._indentationRules && this._indentationRules.unIndentedLinePattern &&
