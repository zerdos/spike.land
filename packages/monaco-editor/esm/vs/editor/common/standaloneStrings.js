...
(function (AccessibilityHelpNLS) {
  AccessibilityHelpNLS.noSelection = nls.localize(
    "noSelection",
    "No selection",
  );
  ...
  AccessibilityHelpNLS.singleSelection = nls.localize(
    "singleSelection",
    "Line {0}, Column {1}",
  );
  ...
  AccessibilityHelpNLS.multiSelection = nls.localize(
    "multiSelection",
    "{0} selections",
  );
  ...
  AccessibilityHelpNLS.editableEditor = nls.localize(
    "editableEditor",
    " in a code editor",
  );
...
(function (SimpleServicesNLS) {
  SimpleServicesNLS.bulkEditServiceSummary = nls.localize(
