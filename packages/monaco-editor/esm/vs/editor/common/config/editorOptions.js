...
class EditorClassName extends ComputedEditorOption {
  constructor() {
    super(121, /* editorClassName */ [
      60, /* mouseStyle */
      29, /* extraEditorClassName */
    ]);
  }
...
class EditorEmptySelectionClipboard extends EditorBooleanOption {
  constructor() {
    super(28, /* emptySelectionClipboard */ "emptySelectionClipboard", true, {
      description: nls.localize(
  ...
  validate(_input) {
    ...
    return {
      ...
      multipleTypeDefinitions:
        (_b = input.multipleTypeDefinitions) !== null && _b !== void 0 ? _b
      ...
      multipleDeclarations:
        (_c = input.multipleDeclarations) !== null && _c !== void 0 ? _c
      ...
      multipleImplementations:
        (_d = input.multipleImplementations) !== null && _d !== void 0 ? _d
      ...
      multipleReferences:
        (_e = input.multipleReferences) !== null && _e !== void 0 ? _e
...
export class EditorLayoutInfoComputer extends ComputedEditorOption {
  constructor() {
    super(124, /* layoutInfo */ [
      44, /* glyphMargin */
      52, /* lineDecorationsWidth */
      33, /* folding */
      59, /* minimap */
      87, /* scrollbar */
      54, /* lineNumbers */
      55, /* lineNumbersMinChars */
      89, /* scrollBeyondLastLine */
      111, /* wordWrap */
      114, /* wordWrapColumn */
      115, /* wordWrapOverride1 */
      116, /* wordWrapOverride2 */
      2, /* accessibilitySupport */
    ]);
  }
  compute(env, options, _) {
  ...
  static computeContainedMinimapLineCount(input) {
    ...
    const extraLinesBeyondLastLine = input.scrollBeyondLastLine
      ...
      : 0;
    const desiredRatio = (input.viewLineCount + extraLinesBeyondLastLine) /
  ...
  static _computeMinimapLayout(input, memory) {
    ...
    if (minimapSize === "fill" || minimapSize === "fit") {
      ...
      if (ratio > 1) {
        ...
        if (minimapSize === "fit") {
          ...
          if (
            isViewportWrapping && couldUseMemory &&
    ...
    const renderMinimap =
      (minimapRenderCharacters ? 1 /* Text */ : 2 /* Blocks */);
    const minimapLeft =
      (minimapSide === "left"
        ? 0
  ...
  static computeLayout(options, env) {
    ...
    const wordWrapOverride1 =
      (wordWrapOverride2 === "inherit"
        ? options.get(115 /* wordWrapOverride1 */)
        : wordWrapOverride2);
    const wordWrap =
      (wordWrapOverride1 === "inherit"
        ? options.get(111 /* wordWrap */)
        : wordWrapOverride1);
    ...
    const showLineNumbers =
      (options.get(54 /* lineNumbers */).renderType !== 0 /* Off */);
    ...
    const remainingWidth = outerWidth - glyphMarginWidth - lineNumbersWidth -
    ...
    if (
      minimapLayout.renderMinimap !== 0 /* None */ &&
    ...
    const verticalArrowSize =
      (verticalScrollbarHasArrows ? scrollbarArrowSize : 0);
...
class EditorRenderLineNumbersOption extends BaseEditorOption {
  constructor() {
    super(54, /* lineNumbers */ "lineNumbers", {
      renderType: 1, /* On */
      renderFn: null,
    }, {
      type: "string",
...
export function filterValidationDecorations(options) {
  const renderValidationDecorations = options.get(
    82, /* renderValidationDecorations */
  );
...
export const EDITOR_FONT_DEFAULTS = {
  fontFamily:
    (platform.isMacintosh
      ...
      : (platform.isLinux ? DEFAULT_LINUX_FONT_FAMILY
...
export const EditorOptions = {
  ...
  automaticLayout: register(
    new EditorBooleanOption(9, /* automaticLayout */ "automaticLayout", false),
  ),
  ...
  stickyTabStops: register(
    new EditorBooleanOption(99, /* stickyTabStops */ "stickyTabStops", false, {
      description: nls.localize(
        "stickyTabStops",
  ...
  colorDecorators: register(
    new EditorBooleanOption(14, /* colorDecorators */ "colorDecorators", true, {
      description: nls.localize(
        "colorDecorators",
  ...
  contextmenu: register(
    new EditorBooleanOption(17, /* contextmenu */ "contextmenu", true),
  ),
  copyWithSyntaxHighlighting: register(
    new EditorBooleanOption(
      18, /* copyWithSyntaxHighlighting */
  ...
  cursorSurroundingLinesStyle: register(
    new EditorStringEnumOption(
      23, /* cursorSurroundingLinesStyle */
  ...
  dragAndDrop: register(
    new EditorBooleanOption(27, /* dragAndDrop */ "dragAndDrop", true, {
      description: nls.localize(
        "dragAndDrop",
  ...
  fixedOverflowWidgets: register(
    new EditorBooleanOption(
      32, /* fixedOverflowWidgets */
      "fixedOverflowWidgets",
      false,
    ),
  ),
  folding: register(
    new EditorBooleanOption(33, /* folding */ "folding", true, {
      description: nls.localize(
        "folding",
  ...
  formatOnPaste: register(
    new EditorBooleanOption(42, /* formatOnPaste */ "formatOnPaste", false, {
      description: nls.localize(
        "formatOnPaste",
  ...
  formatOnType: register(
    new EditorBooleanOption(43, /* formatOnType */ "formatOnType", false, {
      description: nls.localize(
        "formatOnType",
  ...
  glyphMargin: register(
    new EditorBooleanOption(44, /* glyphMargin */ "glyphMargin", true, {
      description: nls.localize(
        "glyphMargin",
  ...
  inDiffEditor: register(
    new EditorBooleanOption(49, /* inDiffEditor */ "inDiffEditor", false),
  ),
  ...
  linkedEditing: register(
    new EditorBooleanOption(56, /* linkedEditing */ "linkedEditing", false, {
      description: nls.localize(
        "linkedEditing",
  ...
  links: register(
    new EditorBooleanOption(57, /* links */ "links", true, {
      description: nls.localize(
        "links",
  ...
  mouseStyle: register(
    new EditorStringEnumOption(60, /* mouseStyle */ "mouseStyle", "text", [
      "text",
      "default",
      "copy",
    ]),
  ...
  mouseWheelZoom: register(
    new EditorBooleanOption(62, /* mouseWheelZoom */ "mouseWheelZoom", false, {
      markdownDescription: nls.localize(
        "mouseWheelZoom",
  ...
  multiCursorMergeOverlapping: register(
    new EditorBooleanOption(
      63, /* multiCursorMergeOverlapping */
  ...
  readOnly: register(
    new EditorBooleanOption(75, /* readOnly */ "readOnly", false),
  ),
  renameOnType: register(
    new EditorBooleanOption(76, /* renameOnType */ "renameOnType", false, {
      description: nls.localize(
        "renameOnType",
  ...
  renderLineHighlightOnlyWhenFocus: register(
    new EditorBooleanOption(
      81, /* renderLineHighlightOnlyWhenFocus */
  ...
  showUnused: register(
    new EditorBooleanOption(95, /* showUnused */ "showUnused", true, {
      description: nls.localize(
        "showUnused",
  ...
  showDeprecated: register(
    new EditorBooleanOption(119, /* showDeprecated */ "showDeprecated", true, {
      description: nls.localize(
        "showDeprecated",
  ...
  suggestOnTriggerCharacters: register(
    new EditorBooleanOption(
      104, /* suggestOnTriggerCharacters */
  ...
  useTabStops: register(
    new EditorBooleanOption(109, /* useTabStops */ "useTabStops", true, {
      description: nls.localize(
        "useTabStops",
  ...
  wordWrap: register(
    new EditorStringEnumOption(111, /* wordWrap */ "wordWrap", "off", [
      "off",
      "on",
      "wordWrapColumn",
      "bounded",
  ...
  wordWrapBreakAfterCharacters: register(
    new EditorStringOption(
      112, /* wordWrapBreakAfterCharacters */
  ...
  wordWrapBreakBeforeCharacters: register(
    new EditorStringOption(
      113, /* wordWrapBreakBeforeCharacters */
