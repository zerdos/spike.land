...
function migrateOptions(options) {
  ...
  if (
    suggest && typeof suggest.filteredTypes === "object" &&
...
export class CommonEditorConfiguration extends Disposable {
  ...
  static _subsetEquals(base, subset) {
    for (const key in subset) {
      if (hasOwnProperty.call(subset, key)) {
        ...
        if (
          baseValue && typeof baseValue === "object" && subsetValue &&
  ...
  setMaxLineNumber(maxLineNumber) {
    const lineNumbersDigitCount = CommonEditorConfiguration._digitCount(
      maxLineNumber,
    );
...
const editorConfiguration = Object.assign(
  Object.assign({}, editorConfigurationBaseNode),
  {
    properties: {
      "editor.tabSize": {
        type: "number",
