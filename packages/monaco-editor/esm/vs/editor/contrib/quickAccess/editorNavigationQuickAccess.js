...
export class AbstractEditorNavigationQuickAccessProvider {
  ...
  doProvide(picker, token) {
    ...
    if (editor && this.canProvideWithTextEditor(editor)) {
      ...
      if (codeEditor) {
        ...
        let lastKnownEditorViewState = withNullAsUndefined(
          editor.saveViewState(),
        );
        disposables.add(codeEditor.onDidChangeCursorPosition(() => {
          lastKnownEditorViewState = withNullAsUndefined(
            editor.saveViewState(),
          );
        }));
        context.restoreViewState = () => {
          if (
            lastKnownEditorViewState && editor === this.activeTextEditorControl
          ) {
  ...
  addDecorations(editor, range) {
    editor.changeDecorations((changeAccessor) => {
      ...
      const [rangeHighlightId, overviewRulerDecorationId] = changeAccessor
        .deltaDecorations(deleteDecorations, newDecorations);
