...
export class AbstractGotoLineQuickAccessProvider
  ...
  provideWithTextEditor(context, picker, token) {
    ...
    const updatePickerAndEditor = () => {
      const position = this.parsePosition(
        editor,
        picker.value.trim().substr(
          AbstractGotoLineQuickAccessProvider.PREFIX.length,
        ),
      );
  ...
  lineCount(editor) {
    var _a, _b;
    return (_b = (_a = this.getModel(editor)) === null || _a === void 0
            ? void 0
