...
export class DragAndDropController extends Disposable {
  ...
  onEditorKeyDown(e) {
    if (
      !this._editor.getOption(27 /* dragAndDrop */) ||
      this._editor.getOption(15 /* columnSelection */)
    ) {
      return;
    }
  ...
  onEditorKeyUp(e) {
    ...
    if (
      this._mouseDown && e.keyCode === DragAndDropController.TRIGGER_KEY_VALUE
    ) {
      this._editor.updateOptions({
        mouseStyle: "default",
      });
  ...
  _onEditorMouseDrag(mouseEvent) {
    ...
    if (this._dragSelection === null) {
      ...
      let possibleSelections = selections.filter((selection) =>
