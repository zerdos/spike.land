...
import {
  QuickFixAction,
  QuickFixController,
} from "../codeAction/codeActionCommands.js";
  ...
  equals(other) {
    if (other instanceof MarkerHover) {
      return IMarkerData.makeKey(this.marker) ===
        IMarkerData.makeKey(other.marker);
    }
    return false;
  }
}
...
let MarkerHoverParticipant = class MarkerHoverParticipant {
  ...
  renderHoverParts(hoverParts, fragment) {
    ...
    hoverParts.forEach((msg) =>
      fragment.appendChild(this.renderMarkerHover(msg, disposables))
    );
    ...
    fragment.appendChild(
      this.renderMarkerStatusbar(markerHoverForStatusbar, disposables),
    );
    return disposables;
  }
