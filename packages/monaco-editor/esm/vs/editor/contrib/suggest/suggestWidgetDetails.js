...
let SuggestDetailsWidget = class SuggestDetailsWidget {
  ...
  getLayoutInfo() {
    const lineHeight = this._editor.getOption(103 /* suggestLineHeight */) ||
      this._editor.getOption(38 /* fontInfo */).lineHeight;
...
export class SuggestDetailsOverlay {
  ...
  _placeAtAnchor(anchorBox, size) {
    ...
    let width = bodyBox.width -
      (anchorBox.left + anchorBox.width + info.borderWidth +
    ...
    maxSizeBottom = maxSizeTop.with(
      undefined,
      anchorBox.top + anchorBox.height - info.borderHeight -
    ...
    if (size.width > width) {
      ...
      if (
        ...
        maxSizeTop = new dom.Dimension(
          ...
          bodyBox.height - anchorBox.top - anchorBox.height -
            info.verticalPadding,
        );
        maxSizeBottom = maxSizeTop.with(
          undefined,
