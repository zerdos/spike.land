...
let FileReferencesTemplate = class FileReferencesTemplate extends Disposable {
  ...
  set(element, matches) {
    ...
    this.file.setLabel(
      getBaseLabel(element.uri),
      this._uriLabel.getUriLabel(parent, { relative: true }),
      { title: this._uriLabel.getUriLabel(element.uri), matches },
    );
