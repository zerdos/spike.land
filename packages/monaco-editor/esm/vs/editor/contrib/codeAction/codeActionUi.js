...
let CodeActionUi = class CodeActionUi extends Disposable {
  constructor(
    ...
    this._lightBulbWidget = new Lazy(() => {
      ...
      this._register(
        widget.onClick((e) =>
          this.showCodeActionList(e.trigger, e.actions, e, {
  ...
  update(newState) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      this._lightBulbWidget.getValue().update(
        actions,
        newState.trigger,
        newState.position,
      );
      if (newState.trigger.type === 2 /* Manual */) {
        if (
          (_b = newState.trigger.filter) === null || _b === void 0
            ? void 0
            : _b.include
        ...
        this._activeCodeActions.value = actions;
        this._codeActionWidget.getValue().show(
          newState.trigger,
          actions,
          newState.position,
  ...
  getInvalidActionThatWouldHaveBeenApplied(trigger, actions) {
    ...
    if (
      (trigger.autoApply === "first" /* First */ &&
        actions.validActions.length === 0) ||
      (trigger.autoApply === "ifSingle" /* IfSingle */ &&
