    ...
    return __awaiter(this, void 0, void 0, function* () {
      if (
        ((_a = this.provider) === null || _a === void 0
          ? void 0
          : _a.resolveCodeAction) && !this.action.edit
      ) {
        let action;
        try {
...
class ManagedCodeActionSet extends Disposable {
  constructor(actions, documentation, disposables) {
    ...
    this.allActions = mergeSort(
      [...actions],
      ManagedCodeActionSet.codeActionsComparator,
    );
    this.validActions = this.allActions.filter(({ action }) =>
      !action.disabled
    );
  }
  ...
  get hasAutoFix() {
    return this.validActions.some(({ action: fix }) =>
      !!fix.kind &&
      ...
      try {
        ...
        const filteredActions =
          ((providedCodeActions === null || providedCodeActions === void 0
            ? void 0
            : providedCodeActions.actions) || []).filter((action) =>
              action && filtersAction(filter, action)
            );
        ...
        return {
          actions: filteredActions.map((action) =>
            new CodeActionItem(action, provider)
          ),
          documentation,
        };
      } catch (err) {
      ...
      const codeActionSet = yield getCodeActions(
        ...
        validatedRangeOrSelection,
        {
          ...
          filter: {
            ...
            include: kind && kind.value
              ? new CodeActionKind(kind.value)
              : undefined,
          },
        },
        Progress.None,
