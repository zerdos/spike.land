...
export class TextAreaState {
  ...
  static deduceInput(previousState, currentState, couldBeEmojiInput) {
    ...
    if (_debugComposition) {
      console.log(
        "AFTER DIFFING PREVIOUS STATE: <" + previousValue +
          ">, selectionStart: " + previousSelectionStart + ", selectionEnd: " +
          previousSelectionEnd,
      );
      console.log(
        "AFTER DIFFING CURRENT STATE: <" + currentValue +
          ">, selectionStart: " + currentSelectionStart + ", selectionEnd: " +
          currentSelectionEnd,
      );
    }
    if (
      couldBeEmojiInput && currentSelectionStart === currentSelectionEnd &&
    ...
    if (currentSelectionStart === currentSelectionEnd) {
      ...
      if (_debugComposition) {
        console.log(
          "REMOVE PREVIOUS: " + (previousPrefix.length - prefixLength) +
            " chars",
        );
      }
      return {
    ...
    const replacePreviousCharacters = previousSelectionEnd -
