...
export class TextAreaHandler extends ViewPart {
  constructor(context, viewController, viewHelper) {
    ...
    this.textArea.setAttribute(
      "tabindex",
      String(options.get(107 /* tabIndex */)),
    );
    ...
    this._register(this._textAreaInput.onPaste((e) => {
      ...
      if (e.metadata) {
        ...
        multicursorText = (typeof e.metadata.multicursorText !== "undefined"
    ...
    this._register(this._textAreaInput.onCompositionStart((e) => {
      ...
      const visibleRange = this._viewHelper
  ...
  _getWordBeforePosition(position) {
    ...
    const wordSeparators = getMapForWordSeparators(
      this._context.configuration.options.get(110 /* wordSeparators */),
    );
  ...
  _render() {
    ...
    const left = this._contentLeft + this._primaryCursorVisibleRange.left -
      this._scrollLeft;
    if (
      left < this._contentLeft || left > this._contentLeft + this._contentWidth
    ) {
