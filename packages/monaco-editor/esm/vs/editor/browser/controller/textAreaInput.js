...
import { _debugComposition, TextAreaState } from "./textAreaState.js";
...
export class TextAreaInput extends Disposable {
  constructor(host, textArea) {
    ...
    this._register(dom.addDisposableListener(textArea.domNode, "input", () => {
      ...
      if (
        typeInput.replaceCharCnt === 0 && typeInput.text.length === 1 &&
  ...
  _installSelectionChangeListener() {
    ...
    return dom.addDisposableListener(document, "selectionchange", (e) => {
      ...
      const _newSelectionStartPosition = this._textAreaState
      ...
      const _newSelectionEndPosition = this._textAreaState.deduceEditorPosition(
        newSelectionEnd,
      );
  ...
  _ensureClipboardGetsEditorSelection(e) {
    const dataToCopy = this._host.getDataToCopy(
      ClipboardEventUtils.canUseTextData(e) &&
        BrowserFeatures.clipboard.richText,
    );
...
class TextAreaWrapper extends Disposable {
  ...
  setSelectionRange(reason, selectionStart, selectionEnd) {
    ...
    if (
      currentIsFocused && currentSelectionStart === selectionStart &&
