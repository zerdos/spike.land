...
import {
  ...
  CursorMoveCommands,
} from "../../common/controller/cursorMoveCommands.js";
...
(function (EditorScroll_) {
  const isEditorScrollArgs = function (arg) {
    ...
    if (
      !types.isUndefined(scrollArg.value) && !types.isNumber(scrollArg.value)
    ) {
      return false;
    }
    if (
...
(function (RevealLine_) {
  const isRevealLineArgs = function (arg) {
    ...
    if (
      !types.isUndefined(reveaLineArg.at) && !types.isString(reveaLineArg.at)
    ) {
      return false;
    }
    return true;
...
class EditorOrNativeTextInputCommand {
  constructor(target) {
    ...
    target.addImplementation(10000, (accessor, args) => {
      ...
      const focusedEditor = accessor.get(ICodeEditorService)
    ...
    target.addImplementation(0, (accessor, args) => {
      ...
      const activeEditor = accessor.get(ICodeEditorService)
        .getActiveCodeEditor();
      if (activeEditor) {
        activeEditor.focus();
...
(function (CoreNavigationCommands) {
      ...
      constructor() {
        super({
          ...
          kbOpts: {
            ...
            primary: 2048 /* CtrlCmd */ | 1024 /* Shift */ | 512 /* Alt */ |
              15, /* LeftArrow */
            linux: { primary: 0 },
          },
        });
    ...
    new HomeCommand({
      ...
      kbOpts: {
        ...
        mac: {
          primary: 1024 /* Shift */ | 14, /* Home */
          secondary: [
            2048 /* CtrlCmd */ | 1024 /* Shift */ | 15, /* LeftArrow */
          ],
        },
      },
    }),
    ...
    new EndCommand({
      ...
      kbOpts: {
        ...
        mac: {
          primary: 1024 /* Shift */ | 13, /* End */
          secondary: [
            2048 /* CtrlCmd */ | 1024 /* Shift */ | 17, /* RightArrow */
          ],
        },
      },
      description: {
  ...
  class EditorScrollImpl extends CoreEditorCommand {
    ...
    _runEditorScroll(viewModel, source, args) {
      ...
      if (args.revealCursor) {
        ...
        const desiredVisibleViewRange = viewModel
          .getCompletelyVisibleViewRangeAtScrollTop(desiredScrollTop);
    ...
    _computeDesiredScrollTop(viewModel, args) {
      if (args.unit === 1 /* Line */) {
        ...
        const visibleModelRange = viewModel.coordinatesConverter
          .convertViewRangeToModelRange(visibleViewRange);
      ...
      if (args.unit === 3 /* Page */) {
        ...
        noOfLines = Math.round(viewModel.cursorConfig.pageSize / 2) *
          args.value;
      } else {
        noOfLines = args.value;
      }
      const deltaLines = (args.direction === 1 /* Up */ ? -1 : 1) * noOfLines;
      return viewModel.getScrollTop() +
  ...
  CoreNavigationCommands.ScrollLineUp = registerEditorCommand(
    new class extends CoreEditorCommand {
      ...
      runCoreEditorCommand(viewModel, args) {
        CoreNavigationCommands.EditorScroll._runEditorScroll(
          viewModel,
          args.source,
          {
            direction: 1, /* Up */
  ...
  CoreNavigationCommands.RevealLine = registerEditorCommand(
    new class extends CoreEditorCommand {
      ...
      runCoreEditorCommand(viewModel, args) {
        ...
        const viewRange = viewModel.coordinatesConverter
          .convertModelRangeToViewRange(range);
  ...
  CoreNavigationCommands.SelectAll = new class
    extends EditorOrNativeTextInputCommand {
    constructor() {
...
(function (CoreEditingCommands) {
  ...
  CoreEditingCommands.DeleteLeft = registerEditorCommand(
    new class extends CoreEditingCommand {
      ...
      runCoreEditingCommand(editor, viewModel, args) {
        const [shouldPushStackElementBefore, commands] = DeleteOperations
          .deleteLeft(
        ...
        super({
          ...
          kbOpts: {
            ...
            mac: {
              primary: 20, /* Delete */
              secondary: [
                256 /* WinCtrl */ | 34, /* KEY_D */
                256 /* WinCtrl */ | 20, /* Delete */
              ],
            },
          },
        });
