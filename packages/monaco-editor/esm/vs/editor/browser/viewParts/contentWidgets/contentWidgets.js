...
class Widget {
  ...
  _setPosition(range) {
    ...
    if (this._range) {
      ...
      if (
        ...
        this._viewRange = this._context.model.coordinatesConverter
  ...
  _layoutBoxInPage(topLeft, bottomLeft, width, height, ctx) {
    ...
    const absoluteAboveTop = domNodePosition.top + aboveTop -
      dom.StandardWindow.scrollY;
    const absoluteBelowTop = domNodePosition.top + belowTop -
      dom.StandardWindow.scrollY;
