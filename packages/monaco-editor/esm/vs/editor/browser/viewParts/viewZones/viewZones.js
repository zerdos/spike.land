...
export class ViewZones extends ViewPart {
  ...
  _computeWhitespaceProps(zone) {
    ...
    const viewPosition = this._context.model.coordinatesConverter
      .convertModelPositionToViewPosition(zoneAfterModelPosition);
    const isVisible = this._context.model.coordinatesConverter
      .modelPositionIsVisible(zoneBeforeModelPosition);
    return {
    ...
    this._context.model.changeWhitespace((whitespaceAccessor) => {
      const changeAccessor = {
        ...
        removeZone: (id) => {
          ...
          zonesHaveChanged = this._removeZone(whitespaceAccessor, id) ||
            zonesHaveChanged;
        },
        layoutZone: (id) => {
          if (!id) {
          ...
          zonesHaveChanged = this._layoutZone(whitespaceAccessor, id) ||
            zonesHaveChanged;
        },
      };
