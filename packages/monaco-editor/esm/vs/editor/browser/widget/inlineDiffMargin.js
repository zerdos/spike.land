...
export class InlineDiffMargin extends Disposable {
  constructor(
    ...
    this._diffActions.className = Codicon.lightBulb.classNames +
      " lightbulb-glyph";
          ...
          () =>
            __awaiter(this, void 0, void 0, function* () {
              ...
              if (diff.modifiedEndLineNumber === 0) {
                // deletion only
                const column = editor.getModel().getLineMaxColumn(
    ...
    this._register(editor.onMouseMove((e) => {
      if (
        e.target.type === 8 /* CONTENT_VIEW_ZONE */ ||
        e.target.type === 5 /* GUTTER_VIEW_ZONE */
      ) {
