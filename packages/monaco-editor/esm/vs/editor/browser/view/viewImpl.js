...
export class View extends ViewEventHandler {
  constructor(
    ...
    this._configPixelRatio = this._configPixelRatio = this._context
      .configuration.options.get(122 /* pixelRatio */);
  ...
  _getEditorClassName() {
    ...
    return this._context.configuration.options.get(121 /* editorClassName */) +
