...
let EditorScopedQuickInputServiceImpl = class EditorScopedQuickInputServiceImpl
  extends QuickInputService {
  constructor(
    editor,
...
let StandaloneQuickInputServiceImpl = class StandaloneQuickInputServiceImpl {
  ...
  get activeService() {
    ...
    if (!quickInputService) {
      const newQuickInputService = quickInputService = this.instantiationService
        .createInstance(EditorScopedQuickInputServiceImpl, editor);
