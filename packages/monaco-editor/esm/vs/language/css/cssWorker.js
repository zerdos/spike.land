    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        ...
        if (document) {
          ...
          diagnostics = this._languageService.doValidation(
            document,
            stylesheet,
          );
  ...
  CSSWorker.prototype.doComplete = function (uri, position) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        document = this._getTextDocument(uri);
        stylesheet = this._languageService.parseStylesheet(document);
        completions = this._languageService.doComplete(
          document,
          position,
          stylesheet,
        );
  ...
  CSSWorker.prototype.findDefinition = function (uri, position) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        document = this._getTextDocument(uri);
        stylesheet = this._languageService.parseStylesheet(document);
        definition = this._languageService.findDefinition(
          document,
          position,
          stylesheet,
        );
  ...
  CSSWorker.prototype.findReferences = function (uri, position) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        document = this._getTextDocument(uri);
        stylesheet = this._languageService.parseStylesheet(document);
        references = this._languageService.findReferences(
          document,
          position,
          stylesheet,
        );
  ...
  CSSWorker.prototype.doCodeActions = function (uri, range, context) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        document = this._getTextDocument(uri);
        stylesheet = this._languageService.parseStylesheet(document);
        actions = this._languageService.doCodeActions(
          document,
          range,
          context,
          stylesheet,
