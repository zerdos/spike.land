...
var LanguageServiceDefaultsImpl = /** @class */ (function () {
  ...
  LanguageServiceDefaultsImpl.prototype.setModeConfiguration = function (
    modeConfiguration,
  ) {
...
export var cssDefaults = new LanguageServiceDefaultsImpl(
  "css",
  diagnosticDefault,
  modeConfigurationDefault,
);
export var scssDefaults = new LanguageServiceDefaultsImpl(
  "scss",
  diagnosticDefault,
  modeConfigurationDefault,
);
export var lessDefaults = new LanguageServiceDefaultsImpl(
  "less",
  diagnosticDefault,
  modeConfigurationDefault,
);
