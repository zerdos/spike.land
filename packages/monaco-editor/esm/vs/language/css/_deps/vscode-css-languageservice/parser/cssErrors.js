...
export var ParseError = {
  NumberExpected: new CSSIssueType(
    "css-numberexpected",
    localize("expected.number", "number expected"),
  ),
  ConditionExpected: new CSSIssueType(
    "css-conditionexpected",
    localize("expected.condt", "condition expected"),
  ),
  ...
  DotExpected: new CSSIssueType(
    "css-dotexpected",
    localize("expected.dot", "dot expected"),
  ),
  ColonExpected: new CSSIssueType(
    "css-colonexpected",
    localize("expected.colon", "colon expected"),
  ),
  SemiColonExpected: new CSSIssueType(
    "css-semicolonexpected",
    localize("expected.semicolon", "semi-colon expected"),
  ),
  TermExpected: new CSSIssueType(
    "css-termexpected",
    localize("expected.term", "term expected"),
  ),
  ...
  OperatorExpected: new CSSIssueType(
    ...
    localize("expected.operator", "operator expected"),
  ),
  IdentifierExpected: new CSSIssueType(
    "css-identifierexpected",
    localize("expected.ident", "identifier expected"),
  ),
  ...
  URIExpected: new CSSIssueType(
    "css-uriexpected",
    localize("expected.uri", "URI expected"),
  ),
  VariableNameExpected: new CSSIssueType(
    "css-varnameexpected",
    localize("expected.varname", "variable name expected"),
  ),
  ...
  UnknownAtRule: new CSSIssueType(
    "css-unknownatrule",
    localize("unknown.atrule", "at-rule unknown"),
  ),
  UnknownKeyword: new CSSIssueType(
    "css-unknownkeyword",
    localize("unknown.keyword", "unknown keyword"),
  ),
  SelectorExpected: new CSSIssueType(
    "css-selectorexpected",
    localize("expected.selector", "selector expected"),
  ),
  ...
  WildcardExpected: new CSSIssueType(
    ...
    localize("expected.wildcard", "wildcard expected"),
  ),
