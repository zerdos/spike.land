...
var SCSSCompletion = /** @class */ (function (_super) {
  ...
  function SCSSCompletion(lsServiceOptions, cssDataManager) {
    var _this = _super.call(this, "$", lsServiceOptions, cssDataManager) ||
      this;
  ...
  SCSSCompletion.prototype.getCompletionForImportPath = function (
    importPathNode,
    result,
  ) {
    ...
    return _super.prototype.getCompletionForImportPath.call(
      this,
      importPathNode,
      result,
    );
  ...
  SCSSCompletion.prototype.createReplaceFunction = function () {
    ...
    return function (_match, p1) {
      return "\\" + p1 + ": ${" + tabStopCounter++ + ":" +
        (SCSSCompletion.variableDefaults[p1] || "") + "}";
    };
  };
  SCSSCompletion.prototype.createFunctionProposals = function (
    proposals,
    existingNode,
    sortToEnd,
    result,
  ...
  SCSSCompletion.prototype.getCompletionsForSelector = function (
    ruleSet,
    isNested,
    result,
  ) {
    ...
    return _super.prototype.getCompletionsForSelector.call(
      this,
      ruleSet,
      isNested,
      result,
  ...
  SCSSCompletion.prototype.getTermProposals = function (
    entry,
    existingNode,
    result,
  ) {
    ...
    if (entry) {
      functions = functions.filter(function (f) {
        return !f.type || !entry.restrictions ||
          entry.restrictions.indexOf(f.type) !== -1;
      });
    }
    this.createFunctionProposals(functions, existingNode, true, result);
    return _super.prototype.getTermProposals.call(
      this,
      entry,
      existingNode,
      result,
  ...
  SCSSCompletion.prototype.getColorProposals = function (
    entry,
    existingNode,
    result,
  ) {
    ...
    return _super.prototype.getColorProposals.call(
      this,
      entry,
      existingNode,
      result,
  ...
  SCSSCompletion.prototype.getCompletionsForDeclarationProperty = function (
    declaration,
    result,
  ) {
    this.getCompletionForAtDirectives(result);
    this.getCompletionsForSelector(null, true, result);
    return _super.prototype.getCompletionsForDeclarationProperty.call(
      this,
      declaration,
      result,
    );
  };
  SCSSCompletion.prototype.getCompletionsForExtendsReference = function (
    _extendsRef,
    existingNode,
    result,
  ) {
