...
var LESSCompletion = /** @class */ (function (_super) {
  ...
  LESSCompletion.prototype.createFunctionProposals = function (
    proposals,
    existingNode,
    sortToEnd,
    result,
  ...
  LESSCompletion.prototype.getTermProposals = function (
    entry,
    existingNode,
    result,
  ) {
  ...
  LESSCompletion.prototype.getColorProposals = function (
    entry,
    existingNode,
    result,
  ) {
  ...
  LESSCompletion.prototype.getCompletionsForDeclarationProperty = function (
    declaration,
    result,
  ) {
