...
export var Rules = {
  ...
  EmptyRuleSet: new Rule(
    "emptyRules",
    localize("rule.emptyRuleSets", "Do not use empty rulesets"),
    Warning,
  ),
  ...
  ZeroWithUnit: new Rule(
    "zeroUnits",
    localize("rule.zeroWidthUnit", "No unit for zero needed"),
    Ignore,
  ),
  ...
  UnknownProperty: new Rule(
    "unknownProperties",
    localize("rule.unknownProperty", "Unknown property."),
    Warning,
  ),
  UnknownAtRules: new Rule(
    "unknownAtRules",
    localize("rule.unknownAtRules", "Unknown at-rule."),
    Warning,
  ),
  IEStarHack: new Rule(
    "ieHack",
