...
var LESSParser = /** @class */ (function (_super) {
    ...
    if (this.peekDelim("#") || this.peekDelim(".")) {
      ...
      if (!this.hasWhitespace() && this.accept(TokenType.ParenthesisL)) {
        ...
        if (node.getParameters().addChild(this._parseMixinParameter())) {
          while (
            this.accept(TokenType.Comma) || this.accept(TokenType.SemiColon)
          ) {
  ...
  LESSParser.prototype._parseVariable = function (declaration, insideLookup) {
    ...
    if (
      !this.peekDelim("@") && !isPropertyReference &&
  ...
  LESSParser.prototype._parseExtend = function () {
    ...
    this.consumeToken(); // &
    if (
      this.hasWhitespace() || !this.accept(TokenType.Colon) ||
  ...
  LESSParser.prototype._tryParseMixinReference = function (atRoot) {
    ...
    if (
      !hasArguments && !this.peek(TokenType.SemiColon) &&
      !this.peek(TokenType.CurlyR) && !this.peek(TokenType.EOF)
    ) {
      this.restoreAtMark(mark);
      return null;
    }
  ...
  LESSParser.prototype._parseMixinParameter = function () {
    ...
    if (this.peekKeyword("@rest")) {
      ...
      if (!this.accept(lessScanner.Ellipsis)) {
        return this.finish(node, ParseError.DotExpected, [], [
          TokenType.Comma,
          TokenType.ParenthesisR,
        ]);
      }
