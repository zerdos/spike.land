...
var SCSSParser = /** @class */ (function (_super) {
  ...
  SCSSParser.prototype._parseIdent = function (referenceTypes) {
    ...
    if (
      ...
      !this.peek(scssScanner.InterpolationFunction) && !this.peekDelim("-")
    ) {
      return null;
    }
    ...
    while (
      this.accept(TokenType.Ident) || node.addChild(indentInterpolation()) ||
  ...
  SCSSParser.prototype._parseInterpolation = function () {
    if (this.peek(scssScanner.InterpolationFunction)) {
      ...
      this.consumeToken();
      if (
        !node.addChild(this._parseExpr()) && !this._parseSelectorCombinator()
      ) {
  ...
  SCSSParser.prototype._parseSelectorCombinator = function () {
    if (this.peekDelim("&")) {
      ...
      while (
        !this.hasWhitespace() &&
        (this.acceptDelim("-") || this.accept(TokenType.Num) ||
  ...
  SCSSParser.prototype._tryParsePseudoIdentifier = function () {
    return this._parseInterpolation() ||
      _super.prototype._tryParsePseudoIdentifier.call(this); // for #49589
  };
  ...
  SCSSParser.prototype._parseParameterDeclaration = function () {
    ...
    if (this.accept(TokenType.Colon)) {
      if (!node.setDefaultValue(this._parseExpr(true))) {
        return this.finish(node, ParseError.VariableValueExpected, [], [
          TokenType.Comma,
  ...
  SCSSParser.prototype._parseModuleConfigDeclaration = function () {
    ...
    if (
      !this.accept(TokenType.Colon) || !node.setValue(this._parseExpr(true))
    ) {
      return this.finish(node, ParseError.VariableValueExpected, [], [
        TokenType.Comma,
        TokenType.ParenthesisR,
  ...
  SCSSParser.prototype._parseSupportsCondition = function () {
    return this._parseInterpolation() ||
      _super.prototype._parseSupportsCondition.call(this);
  };
  return SCSSParser;
}(cssParser.Parser));
export { SCSSParser };
