...
import { MarkupKind, Range } from "../cssLanguageTypes.js";
...
var CSSHover = /** @class */ (function () {
  ...
  CSSHover.prototype.doHover = function (
    document,
    position,
    stylesheet,
    settings,
    ...
    for (var i = 0; i < nodepath.length; i++) {
      ...
      if (node instanceof nodes.Declaration) {
        ...
        if (entry) {
          var contents = languageFacts.getEntryDescription(
            entry,
  ...
  CSSHover.prototype.doesSupportMarkdown = function () {
    if (!isDefined(this.supportsMarkdown)) {
      ...
      var hover = this.clientCapabilities.textDocument &&
        this.clientCapabilities.textDocument.hover;
      this.supportsMarkdown = hover && hover.contentFormat &&
