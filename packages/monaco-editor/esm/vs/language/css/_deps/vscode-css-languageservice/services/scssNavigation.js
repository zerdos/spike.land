...
var SCSSNavigation = /** @class */ (function (_super) {
  ...
  SCSSNavigation.prototype.resolveRelativeReference = function (
    ref,
    documentUri,
    documentContext,
  ) {
    return __awaiter(this, void 0, void 0, function () {
      function toPathVariations(uri) {
        ...
        var documentUriWithBasename = function (newBasename) {
          return uri.with({ path: pathWithoutBasename + newBasename })
            .toString();
        };
        ...
        var indexPath = documentUriWithBasename(
          normalizedBasename.slice(0, -5) + "/index.scss",
        );
        var indexUnderscoreUri = documentUriWithBasename(
          normalizedBasename.slice(0, -5) + "/_index.scss",
        );
        var cssPath = documentUriWithBasename(
          normalizedBasename.slice(0, -5) + ".css",
        );
        return [
          normalizedPath,
          underScorePath,
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4, /*yield*/
              _super.prototype.resolveRelativeReference.call(
                this,
                ref,
                documentUri,
                documentContext,
          ...
          case 1:
            ...
            if (
              !(parsedUri.path && Utils.extname(parsedUri).length === 0)
            ) {
              return [3, /*break*/ 8];
            }
            _a.label = 2;
