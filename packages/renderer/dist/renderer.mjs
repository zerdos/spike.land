...
var init_QRious = __esm({
  "../qrious/dist/QRious.mjs"() {
    ...
    S = o((o0, A) => {
      ...
      function Me(i, e) {
        var t;
        return typeof Object.create == "function" ? t = Object.create(i) : (B.prototype = i, t = new B(), B.prototype = null), e && E(true, t, e), t;
      }
      function Oe(i, e, t, r) {
        var x = this;
        return typeof i != "string" && (r = t, t = e, e = i, i = null), typeof e != "function" && (r = t, t = e, e = function() {
          return x.apply(this, arguments);
        }), E(false, e, x, r), e.prototype = Me(x.prototype, t), e.prototype.constructor = e, e.class_ = i || x.class_, e.super_ = x, e;
      }
      function E(i, e, t) {
        t = Be.call(arguments, 2);
        for (var r, x, s = 0, a2 = t.length; s < a2; s++) {
          x = t[s];
          for (r in x)
            (!i || we.call(x, r)) && (e[r] = x[r]);
        }
      }
      A.exports = Oe;
    });
    ...
    M = o((h0, L) => {
      "use strict";
      var Ne = u(), Ee = Ne.extend(function(i, e, t) {
    ...
    j = o((l0, T) => {
      "use strict";
      var Ae = M(), Se = Ae.extend({ draw: function(i) {
        var e, t, r = this.qrious, x = this.getModuleSize(i), s = this.getOffset(i), a2 = this.element.getContext("2d");
        for (a2.fillStyle = r.foreground, a2.globalAlpha = r.foregroundAlpha, e = 0; e < i.width; e++)
          for (t = 0; t < i.width; t++)
            i.buffer[t * i.width + e] && a2.fillRect(x * e + s, x * t + s, x, x);
      }, reset: function() {
    ...
    X = o((m0, D) => {
      "use strict";
      var Pe = u(), Ve = I(), _2 = V(), v = G(), Ue = K(), c2 = Pe.extend(function(i) {
        var e, t, r, x, s, a2 = i.value.length;
        for (this._badness = [], this._level = _2.LEVELS[i.level], this._polynomial = [], this._value = i.value, this._version = 0, this._stringBuffer = []; this._version < 40 && (this._version++, r = (this._level - 1) * 4 + (this._version - 1) * 16, x = _2.BLOCKS[r++], s = _2.BLOCKS[r++], e = _2.BLOCKS[r++], t = _2.BLOCKS[r], r = e * (x + s) + s - 3 + (this._version <= 9), !(a2 <= r)); )
          ;
        this._dataBlock = e, this._eccBlock = t, this._neccBlock1 = x, this._neccBlock2 = s;
        var n = this.width = 17 + 4 * this._version;
        this.buffer = c2._createArray(n * n), this._ecc = c2._createArray(e + (e + t) * (x + s) + s), this._mask = c2._createArray((n * (n + 1) + 1) / 2), this._insertFinders(), this._insertAlignments(), this.buffer[8 + n * (n - 8)] = 1, this._insertTimingGap(), this._reverseMask(), this._insertTimingRowAndColumn(), this._insertVersion(), this._syncMask(), this._convertBitStream(a2), this._calculatePolynomial(), this._appendEccToData(), this._interleaveBlocks(), this._pack(), this._finish();
        ...
        var x, s, a2, n = this._polynomial, f = this._stringBuffer;
        for (s = 0; s < r; s++)
          f[t + s] = 0;
        for (s = 0; s < e; s++) {
          if (x = v.LOG[f[i + s] ^ f[t]], x !== 255)
            for (a2 = 1; a2 < r; a2++)
              f[t + a2 - 1] = f[t + a2] ^ v.EXPONENT[c2._modN(x + n[r - a2])];
          else
            for (a2 = t; a2 < t + r; a2++)
              f[a2] = f[a2 + 1];
          f[t + r - 1] = x === 255 ? 0 : v.EXPONENT[c2._modN(x + n[0])];
        }
        ...
        var e, t, r, x, s = this.buffer, a2 = this.width;
        switch (i) {
          case 0:
            for (x = 0; x < a2; x++)
              for (r = 0; r < a2; r++)
                !(r + x & 1) && !this._isMasked(r, x) && (s[r + x * a2] ^= 1);
            break;
          case 1:
            for (x = 0; x < a2; x++)
              for (r = 0; r < a2; r++)
                !(x & 1) && !this._isMasked(r, x) && (s[r + x * a2] ^= 1);
            break;
          case 2:
            for (x = 0; x < a2; x++)
              for (e = 0, r = 0; r < a2; r++, e++)
                e === 3 && (e = 0), !e && !this._isMasked(r, x) && (s[r + x * a2] ^= 1);
            break;
          case 3:
            for (t = 0, x = 0; x < a2; x++, t++)
              for (t === 3 && (t = 0), e = t, r = 0; r < a2; r++, e++)
                e === 3 && (e = 0), !e && !this._isMasked(r, x) && (s[r + x * a2] ^= 1);
            break;
          case 4:
            for (x = 0; x < a2; x++)
              for (e = 0, t = x >> 1 & 1, r = 0; r < a2; r++, e++)
                e === 3 && (e = 0, t = !t), !t && !this._isMasked(r, x) && (s[r + x * a2] ^= 1);
            break;
          case 5:
            for (t = 0, x = 0; x < a2; x++, t++)
              for (t === 3 && (t = 0), e = 0, r = 0; r < a2; r++, e++)
                e === 3 && (e = 0), !((r & x & 1) + !(!e | !t)) && !this._isMasked(r, x) && (s[r + x * a2] ^= 1);
            break;
          case 6:
            for (t = 0, x = 0; x < a2; x++, t++)
              for (t === 3 && (t = 0), e = 0, r = 0; r < a2; r++, e++)
                e === 3 && (e = 0), !((r & x & 1) + (e && e === t) & 1) && !this._isMasked(r, x) && (s[r + x * a2] ^= 1);
            break;
          case 7:
            for (t = 0, x = 0; x < a2; x++, t++)
              for (t === 3 && (t = 0), e = 0, r = 0; r < a2; r++, e++)
                e === 3 && (e = 0), !((e && e === t) + (r + x & 1) & 1) && !this._isMasked(r, x) && (s[r + x * a2] ^= 1);
            break;
        }
        ...
        var i, e, t, r, x, s = 0, a2 = this._badness, n = this.buffer, f = this.width;
        for (x = 0; x < f - 1; x++)
          for (r = 0; r < f - 1; r++)
            (n[r + f * x] && n[r + 1 + f * x] && n[r + f * (x + 1)] && n[r + 1 + f * (x + 1)] || !(n[r + f * x] || n[r + 1 + f * x] || n[r + f * (x + 1)] || n[r + 1 + f * (x + 1)])) && (s += c2.N2);
        var h = 0;
        for (x = 0; x < f; x++) {
          for (t = 0, a2[0] = 0, i = 0, r = 0; r < f; r++)
            e = n[r + f * x], i === e ? a2[t]++ : a2[++t] = 1, i = e, h += i ? 1 : -1;
        ...
        for (b2 += b2 << 2, b2 <<= 1; b2 > f * f; )
          b2 -= f * f, q++;
        for (s += q * c2.N4, r = 0; r < f; r++) {
          for (t = 0, a2[0] = 0, i = 0, x = 0; x < f; x++)
            e = n[r + f * x], i === e ? a2[t]++ : a2[++t] = 1, i = e;
          s += this._getBadness(t);
        }
        return s;
        ...
        t !== e && this._applyMask(t), r = _2.FINAL_FORMAT[t + (this._level - 1 << 3)];
        ...
        var i, e, t = this._dataBlock, r = this._ecc, x = this._eccBlock, s = 0, a2 = this._calculateMaxLength(), n = this._neccBlock1, f = this._neccBlock2, h = this._stringBuffer;
        for (i = 0; i < t; i++) {
          for (e = 0; e < n; e++)
            r[s++] = h[i + e * t];
          for (e = 0; e < f; e++)
        ...
        var i, e, t, r, x = this.buffer, s = this._version, a2 = this.width;
        if (s > 6)
          for (i = Ue.BLOCK[s - 7], e = 17, t = 0; t < 6; t++)
            for (r = 0; r < 3; r++, e--)
              1 & (e > 11 ? s >> e - 12 : i >> e) ? (x[5 - t + a2 * (2 - r + a2 - 11)] = 1, x[2 - r + a2 - 11 + a2 * (5 - t)] = 1) : (this._setMask(5 - t, 2 - r + a2 - 11), this._setMask(2 - r + a2 - 11, 5 - t));
      }, _isMasked: function(i, e) {
        var t = c2._getMaskBit(i, e);
        return this._mask[t] === 1;
      }, _pack: function() {
        var i, e, t, r = 1, x = 1, s = this.width, a2 = s - 1, n = s - 1, f = (this._dataBlock + this._eccBlock) * (this._neccBlock1 + this._neccBlock2) + this._neccBlock2;
        for (e = 0; e < f; e++)
          for (i = this._stringBuffer[e], t = 0; t < 8; t++, i <<= 1) {
            128 & i && (this.buffer[a2 + s * n] = 1);
            do
              x ? a2-- : (a2++, r ? n !== 0 ? n-- : (a2 -= 2, r = !r, a2 === 6 && (a2--, n = 9)) : n !== s - 1 ? n++ : (a2 -= 2, r = !r, a2 === 6 && (a2--, n -= 8))), x = !x;
    ...
    H = o((p0, Q) => {
      "use strict";
      var Ge = M(), Fe = Ge.extend({ draw: function() {
    ...
    J = o((k0, W) => {
      "use strict";
      var Ke = u(), De = Ke.extend(function(i, e, t, r) {
    ...
    $ = o((w0, Z) => {
      "use strict";
      var He = u(), k = O(), d = He.extend(function(i) {
        ...
        for (e in t)
          k.hasOwn(t, e) && (r[e] = d._get(t[e], i));
        return r;
      }, init: function(i, e, t) {
        typeof t != "function" && (t = k.noop);
        var r, x;
        for (r in this.options)
          k.hasOwn(this.options, r) && (x = this.options[r], d._set(x, x.defaultValue, e), d._createAccessor(x, e, t));
        ...
        var r, x = false;
        for (r in i)
          k.hasOwn(i, r) && this._set(r, i[r], e, t) && (x = true);
        return x;
    ...
    se = o((M0, xe) => {
      "use strict";
      var Ye = u(), Ze = j(), $e = X(), e0 = H(), l = J(), i0 = $(), t0 = ie(), m2 = O(), g = new i0([new l("background", true, "white"), new l("backgroundAlpha", true, 1, m2.abs), new l("element"), new l("foreground", true, "black"), new l("foregroundAlpha", true, 1, m2.abs), new l("level", true, "L", m2.toUpperCase), new l("mime", true, "image/png"), new l("padding", true, null, m2.abs), new l("size", true, 100, m2.abs), new l("value", true, "")]), te = new t0(), re = Ye.extend(function(i) {
        g.init(i, this, this.update.bind(this));
        var e = g.get("element", this), t = te.getService("element"), r = e && t.isCanvas(e) ? e : t.createCanvas(), x = e && t.isImage(e) ? e : t.createImage();
        ...
        var i = new $e({ level: this.level, value: this.value });
        this._canvasRenderer.render(i), this._imageRenderer.render(i);
      } }, { use: function(i) {
        te.setService(i.getName(), i);
      } });
...
function findSpring(_a) {
  var _b = _a.duration, duration2 = _b === void 0 ? 800 : _b, _c = _a.bounce, bounce = _c === void 0 ? 0.25 : _c, _d = _a.velocity, velocity = _d === void 0 ? 0 : _d, _e2 = _a.mass, mass = _e2 === void 0 ? 1 : _e2;
  var envelope;
  var derivative;
...
function spring(_a) {
  ...
  var _e2 = getSpringOptions(options), stiffness = _e2.stiffness, damping = _e2.damping, mass = _e2.mass, velocity = _e2.velocity, duration2 = _e2.duration, isResolvedFromDuration = _e2.isResolvedFromDuration;
...
function animateTarget(visualElement2, definition, _a) {
  ...
  var _e2 = visualElement2.makeTargetAnimatable(definition), _f = _e2.transition, transition = _f === void 0 ? visualElement2.getDefaultTransition() : _f, transitionEnd = _e2.transitionEnd, target = __rest7(_e2, ["transition", "transitionEnd"]);
...
var DraggableWindow = ({ onShare, onRestore, position: position2, session }) => {
  ...
  return /* @__PURE__ */ jsx(motion2.div, {
    ...
    size: "small",
    exclusive: true,
    onChange: (_e2, newSize) => newSize && setWidth(newSize)
