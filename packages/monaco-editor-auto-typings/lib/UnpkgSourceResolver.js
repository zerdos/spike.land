...
var UnpkgSourceResolver = /** @class */ (function () {
  ...
  UnpkgSourceResolver.prototype.resolvePackageJson = function (
    packageName,
    version,
    subPath,
  ) {
        ...
        switch (_a.label) {
          case 0:
            return [
              4, /*yield*/
              this.resolveFile(
                "https://unpkg.com/".concat(packageName).concat(
                  version ? "@".concat(version) : "",
                ).concat(subPath ? "/".concat(subPath) : "", "/package.json"),
              ),
            ];
          case 1:
  ...
  UnpkgSourceResolver.prototype.resolveSourceFile = function (
    packageName,
    version,
    path,
  ) {
        ...
        switch (_a.label) {
          ...
          case 3:
            if (res.status === 404) {
              ...
              throw Error(
                "Error other than 404 while fetching from Unpkg at ".concat(
                  url,
                ),
              );
            }
