...
var AutoTypings = /** @class */ (function () {
  ...
  AutoTypings.create = function (editor, languages, options) {
    var _a;
    if (
      (options === null || options === void 0 ? void 0 : options.shareCache) &&
      options.sourceCache && !AutoTypings.sharedCache
    ) {
    ...
    return new AutoTypings(
      ...
      __assign({
        ...
        sourceCache: (_a = AutoTypings.sharedCache) !== null && _a !== void 0
          ? _a
          : new DummySourceCache_1.DummySourceCache(),
        sourceResolver: new UnpkgSourceResolver_1.UnpkgSourceResolver(),
  ...
  AutoTypings.prototype.dispose = function () {
    ...
    try {
      for (
        var _b = __values(this.disposables), _c = _b.next();
        !_c.done;
        _c = _b.next()
      ) {
  ...
  AutoTypings.prototype.clearCache = function () {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4, /*yield*/ this.options.sourceCache.clear()];
          case 1:
            _a.sent();
            return [2 /*return*/];
        }
      ...
      this.debounceTimer = setTimeout(function () {
        return __awaiter(_this, void 0, void 0, function () {
          return __generator(this, function (_a) {
            switch (_a.label) {
              case 0:
                return [4, /*yield*/ this.resolveContents()];
              case 1:
                _a.sent();
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            return [
              4, /*yield*/
              this.importResolver.resolveImportsInFile(
                content.join("\n"),
                path.dirname(model.uri.toString()),
                new RecursionDepth_1.RecursionDepth(this.options),
              ),
            ];
          case 2:
            _b.sent();
          ...
          case 3:
            ...
            if (this.options.onError) {
              this.options.onError(
                (_a = e_2.message) !== null && _a !== void 0 ? _a : e_2,
              );
            } else {
              throw e_2;
            }
