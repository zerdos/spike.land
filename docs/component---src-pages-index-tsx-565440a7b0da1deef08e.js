 ...
 */ /**
 * @param {number} delay
 */function _fetchSignal(){_fetchSignal=Object(asyncToGenerator["a" /* default */])(/*#__PURE__*/regenerator_default.a.mark(function _callee4(signal,_retry){var retry,res,pathname,_signal,resData,_yield$import2,ipfsClient,ipfsCat,_res,_resCID,_resData;return regenerator_default.a.wrap(function _callee4$(_context4){while(1){switch(_context4.prev=_context4.next){case 0:if(!(typeof window==="undefined")){_context4.next=2;break;}return _context4.abrupt("return");case 2:retry=typeof _retry==="number"?_retry:999;if(!(window.location.hostname!=="code.zed.vision")){_context4.next=23;break;}_context4.prev=4;if(!(retry===0)){_context4.next=7;break;}throw new Error("No more retry");case 7:res=new URL(_signal);pathname=res.pathname;_signal=pathname.slice(1);log("signal to wait: "+_signal);resData=fetch("https://zed.vision/signal?signal="+_signal).then(function(x){return x.text();});log(resCID+" downloaded - "+resData);return _context4.abrupt("return",/*#__PURE__*/Object(asyncToGenerator["a" /* default */])(/*#__PURE__*/regenerator_default.a.mark(function _callee2(){return regenerator_default.a.wrap(function _callee2$(_context2){while(1){switch(_context2.prev=_context2.next){case 0:return _context2.abrupt("return",parse(resData));case 1:case"end":return _context2.stop();}}},_callee2);})));case 16:_context4.prev=16;_context4.t0=_context4["catch"](4);_context4.next=20;return wait(Math.random()*2000);case 20:if(!(retry>1)){_context4.next=22;break;}return _context4.abrupt("return",fetchSignal(signal,retry-1));case 22:throw new Error("no signal");case 23:log("retry: "+retry);_context4.prev=24;if(!(retry===0)){_context4.next=27;break;}throw new Error("No more retry");case 27:_context4.next=29;return __webpack_require__.e(/* import() */ 4).then(__webpack_require__.bind(null, "PhsD"));case 29:_yield$import2=_context4.sent;ipfsClient=_yield$import2.ipfsClient;ipfsCat=_yield$import2.ipfsCat;_context4.next=34;return ipfsClient.add(signal,{onlyHash:true});case 34:_res=_context4.sent;_resCID=_res.cid.toString();log("CID to wait: "+_resCID);_context4.next=39;return ipfsCat(_resCID,{timeout:1500});case 39:_resData=_context4.sent;log(_resCID+" downloaded - "+_resData);return _context4.abrupt("return",/*#__PURE__*/Object(asyncToGenerator["a" /* default */])(/*#__PURE__*/regenerator_default.a.mark(function _callee3(){return regenerator_default.a.wrap(function _callee3$(_context3){while(1){switch(_context3.prev=_context3.next){case 0:_context3.t0=parse;_context3.next=3;return hash_getData(signal,20);case 3:_context3.t1=_context3.sent;return _context3.abrupt("return",(0,_context3.t0)(_context3.t1));case 5:case"end":return _context3.stop();}}},_callee3);})));case 44:_context4.prev=44;_context4.t1=_context4["catch"](24);if(!(retry>1)){_context4.next=48;break;}return _context4.abrupt("return",fetchSignal(signal,retry-1));case 48:throw new Error("no signal");case 49:case"end":return _context4.stop();}}},_callee4,null,[[4,16],[24,44]]);}));return _fetchSignal.apply(this,arguments);}function wait(delay){return new Promise(function(resolve){setTimeout(function(){resolve(delay);},delay);});}function hash_getData(_x5,_x6){return _getData.apply(this,arguments);}// if (retry === 0) throw new Error("Cant fetch data");
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 14:
                ...
                setCubeState(-1); // const uuid = await getUserId();
...
//# sourceMappingURL=component---src-pages-index-tsx-565440a7b0da1deef08e.js.map