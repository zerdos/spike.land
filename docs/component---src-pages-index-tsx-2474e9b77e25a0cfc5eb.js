...
var Qr_spinCubeCss = function spinCubeCss(size) {
  return Object(emotion_react_browser_esm["b" /* css */])(_templateObject10(), size, size, size / 2, size / 2, r[1], r[2], r[3], r[2], r[3], r[4], r[3], r[4], r[5], r[4], r[5], r[6], r[5], r[6], r[7], r[6], r[7], r[8], size, size);
};
