 ...
 * LICENSE file in the root directory of this source tree.
 */
var l=__webpack_require__(2),m=__webpack_require__(1);function p(a){for(var b="https://reactjs.org/docs/error-decoder.html?invariant="+a,c=1;c<arguments.length;c++)b+="&args[]="+encodeURIComponent(arguments[c]);return"Minified React error #"+a+"; visit "+b+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}
...
function _renderWorker() {
  _renderWorker = _asyncToGenerator( /*#__PURE__*/regenerator_default.a.mark(function _callee(code, props) {
    ...
    return regenerator_default.a.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            componentFactory = new Function("props", "React", code + "; return Counter(props)");

            Counter = function Counter(props) {
              return componentFactory(props, react);
            };

            return _context.abrupt("return", server_browser_default.a.renderToString( /*#__PURE__*/react["createElement"](Counter, props)));
