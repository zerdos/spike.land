...
_context4.next=10;return fetch("https://zed.vision/signal?signal="+smallSignal+"&securityrandomparam="+Math.random()*10000).then(function(x){return x.text();});case 10:_cid=_context4.sent;console.log(_cid);if(!(String(_cid)==="404")){_context4.next=16;break;}_context4.next=15;return wait(3000);case 15:return _context4.abrupt("return",fetchSignal(signal,retry-1));case 16:_context4.next=18;return fetch("https://code.zed.vision/ipfs/"+_cid).then(function(x){return x.text();});case 18:resData=_context4.sent;return _context4.abrupt("return",/*#__PURE__*/Object(asyncToGenerator["a" /* default */])(/*#__PURE__*/regenerator_default.a.mark(function _callee2(){return regenerator_default.a.wrap(function _callee2$(_context2){while(1){switch(_context2.prev=_context2.next){case 0:return _context2.abrupt("return",parse(resData));case 1:case"end":return _context2.stop();}}},_callee2);})));case 22:_context4.prev=22;_context4.t0=_context4["catch"](4);_context4.next=26;return wait(3000);case 26:if(!(retry>1)){_context4.next=28;break;}return _context4.abrupt("return",fetchSignal(signal,retry-1));case 28:throw new Error("no signal");case 29:_context4.prev=29;if(!(retry===0)){_context4.next=32;break;}throw new Error("No more retry");case 32:_context4.next=34;return ipfsClient.add(signal,{onlyHash:true});case 34:res=_context4.sent;resCID=res.cid.toString();//  log(`CID to wait: ${resCID}`);
//
_context4.next=38;return ipfsCat(resCID,{timeout:1500});case 38:_context4.next=40;return fetch("https://code.zed.vision/ipfs/"+cid).then(function(x){return x.text();});case 40:_resData=_context4.sent;return _context4.abrupt("return",/*#__PURE__*/Object(asyncToGenerator["a" /* default */])(/*#__PURE__*/regenerator_default.a.mark(function _callee3(){return regenerator_default.a.wrap(function _callee3$(_context3){while(1){switch(_context3.prev=_context3.next){case 0:return _context3.abrupt("return",parse(_resData));case 1:case"end":return _context3.stop();}}},_callee3);})));case 44:_context4.prev=44;_context4.t1=_context4["catch"](29);if(!(retry>1)){_context4.next=48;break;}return _context4.abrupt("return",fetchSignal(signal,retry-1));case 48:throw new Error("no signal");case 49:case"end":return _context4.stop();}}},_callee4,null,[[4,22],[29,44]]);}));return _fetchSignal.apply(this,arguments);}function wait(delay){return new Promise(function(resolve){setTimeout(function(){resolve(delay);},delay);});}function hash_getData(_x5,_x6){return _getData.apply(this,arguments);}// if (retry === 0) throw new Error("Cant fetch data");
...
//# sourceMappingURL=component---src-pages-index-tsx-c89a9beca18d25265c12.js.map