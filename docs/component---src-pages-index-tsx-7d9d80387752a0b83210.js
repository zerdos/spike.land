...
function _fetchSignal() {
  _fetchSignal = Object(asyncToGenerator["a" /* default */])( /*#__PURE__*/regenerator_default.a.mark(function _callee4(signal, _retry) {
    var retry, res, pathname, _signal, cid, resData;
    ...
    return regenerator_default.a.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 2:
            retry = typeof _retry === "number" ? _retry : 999;
          ...
          case 9:
            ...
            _signal = pathname.slice(1);
            log("signal to wait: " + _signal);
            console.log("https://zed.vision/signal?signal=" + _signal);
            cid = fetch("https://zed.vision/signal?signal=" + _signal).then(function (x) {
              return x.text();
            });
            console.log(cid);
            ...
            _context4.next = 19;
            return wait(Math.random() * 4000);

          case 19:
            return _context4.abrupt("return", fetchSignal(_signal, retry - 1));

          case 20:
            log(cid + " is available");
            resData = fetch("https://code.zed.vision/ipfs/" + cid).then(function (x) {
              return x();
            });
            ...
            return _context4.abrupt("return", /*#__PURE__*/Object(asyncToGenerator["a" /* default */])( /*#__PURE__*/regenerator_default.a.mark(function _callee3() {
              return regenerator_default.a.wrap(function _callee3$(_context3) {
                while (1) {
                  switch (_context3.prev = _context3.next) {
                    case 0:
                      return _context3.abrupt("return", parse(resData));
...
//# sourceMappingURL=component---src-pages-index-tsx-7d9d80387752a0b83210.js.map