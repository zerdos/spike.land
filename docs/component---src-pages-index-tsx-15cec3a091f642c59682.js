...
var bio = __webpack_require__(77);

// EXTERNAL MODULE: ./src/components/layout.tsx
var layout = __webpack_require__(15);

// EXTERNAL MODULE: ./src/components/seo.tsx
var seo = __webpack_require__(16);
      ...
      return regenerator_default.a.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return __webpack_require__.e(/* import() */ 6).then(__webpack_require__.bind(null, 181));
...
var typography = __webpack_require__(42);

// EXTERNAL MODULE: /home/zed/z/node_modules/@zedvision/code/dist/versions.js
var versions = __webpack_require__(72);

// CONCATENATED MODULE: /home/zed/z/node_modules/@zedvision/code/dist/hash.js
...
var feedTheCache = function feedTheCache(cid) {
...
var half = function half(data) {
  var halfLength = (data.length - data.length % 2) / 2;
...
function _getClient() {
  _getClient = Object(asyncToGenerator["a" /* default */])( /*#__PURE__*/regenerator_default.a.mark(function _callee5() {
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            return _context5.abrupt("return", ipfsClient);

          case 2:
            _context5.next = 4;
            return new Function(window.location.hostname === "[::1]" ? "return import(\"./ipfsKV.js\")" : "return import(\"https://blog.zed.vision/code/src/ipfsKV.js\")")();

          case 4:
            _context5.next = 6;
            return _context5.sent.getIpfsClient();

          case 6:
            ipfsClient = _context5.sent;
            return _context5.abrupt("return", ipfsClient);
...
var hash = /*#__PURE__*/function () {
  var _ref = Object(asyncToGenerator["a" /* default */])( /*#__PURE__*/regenerator_default.a.mark(function _callee(data, onlyHash) {
    var client, noisyHashes, res;
    return regenerator_default.a.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
          ...
          case 8:
            ...
            _context.next = 12;
            return _context.t0.all.call(_context.t0, _context.t2);

          case 12:
            noisyHashes = _context.sent;
            ...
            _context.next = 16;
            return Promise.all(noisyHashes.map(feedTheCache));
          ...
          case 16:
            ...
            _context.next = 19;
            return Promise.all(noisyHashes.map(function (cid) {
              return getHash(cid, 20000).then(function (x) {
                return {
                  success: x === data
                };
              });
...
var getHash = /*#__PURE__*/function () {
  var _ref2 = Object(asyncToGenerator["a" /* default */])( /*#__PURE__*/regenerator_default.a.mark(function _callee2(cid, _timeOut) {
    var timeout, client, data;
    return regenerator_default.a.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
          ...
          case 9:
            ...
            return _context2.abrupt("return", half(data));
  ...
  return function getHash(_x3, _x4) {
...
var waitForSignal = function waitForSignal(signal) {
  return hash(signal, true).catch(function () {
    return {
      success: false
    };
  });
...
var sendSignal = function sendSignal(signal) {
...
var waitForSignalAndJump = /*#__PURE__*/function () {
    ...
    return regenerator_default.a.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            _yield$waitForSignal = _context3.sent;
  ...
  return function waitForSignalAndJump(_x5) {
...
var waitForSignalAndRun = /*#__PURE__*/function () {
  var _ref5 = Object(asyncToGenerator["a" /* default */])( /*#__PURE__*/regenerator_default.a.mark(function _callee4(_ref4) {
    var signal, onSignal, onError, onExpired, _yield$waitForSignal2, success;

    return regenerator_default.a.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            signal = _ref4.signal, onSignal = _ref4.onSignal, onError = _ref4.onError, onExpired = _ref4.onExpired;
            _context4.prev = 1;
            _context4.next = 4;
            return waitForSignal(signal);

          case 4:
            _yield$waitForSignal2 = _context4.sent;
            success = _yield$waitForSignal2.success;
            ...
            return _context4.abrupt("return", onSignal());
          ...
          case 13:
            ...
            return _context4.abrupt("return", onError());
          ...
          case 18:
            ...
            return _context4.abrupt("return", onExpired());
    ...
    }, _callee4, null, [[1, 13, 18, 23]]);
  }));

  return function waitForSignalAndRun(_x6) {
...
var Qr_ref =  true ? {
  name: "16wqm1j",
  styles: "display:block;font-family:Roboto;font-size:20px;text-transform:uppercase;color:white;margin-bottom:12px"
} : undefined;

var Qr_ref2 =  true ? {
  name: "1ksfilm",
  styles: "background:blue;display:inline-block;padding:10px 10px 0px 10px;border-radius:12px;text-align:center"
} : undefined;

var Qr_ref3 =  true ? {
  name: "1aw481h",
  styles: "margin:24px;text-align:center"
} : undefined;
...
var Qr_Qr = function Qr() {
  ...
  react_default.a.useEffect(function () {
    var connect = /*#__PURE__*/function () {
      var _ref4 = Object(asyncToGenerator["a" /* default */])( /*#__PURE__*/regenerator_default.a.mark(function _callee() {
  ...
  return Object(emotion_react_browser_esm["c" /* jsx */])("div", {
    ...
    css: /*#__PURE__*/Object(emotion_react_browser_esm["b" /* css */])("width:200px;height:200px;display:block;box-shadow:0 0 ", 10 + 2 * counter, "px 5px ", retry % 4 === 3 ? "darkorange" : retry % 4 === 2 ? "green" : "darkred", ";" + ( true ? "" : undefined),  true ? "" : undefined),
    ref: ref
...
var forkMe = __webpack_require__(159);
...
var pages_BlogIndex = function BlogIndex(_ref) {
  ...
  return Object(emotion_react_browser_esm["c" /* jsx */])(layout["a" /* Layout */], null, Object(emotion_react_browser_esm["c" /* jsx */])(seo["a" /* SEO */], {
    ...
    return Object(emotion_react_browser_esm["c" /* jsx */])("article", {
      ...
      css: /*#__PURE__*/Object(emotion_react_browser_esm["b" /* css */])("margin-bottom:", Object(typography["a" /* rhythm */])(1 / 4), ";" + ( true ? "" : undefined),  true ? "" : undefined)
