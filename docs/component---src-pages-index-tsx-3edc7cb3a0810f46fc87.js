...
var Qr_Qr = function Qr() {
  ...
  var setQR = function setQR(side, color, element) {
    ...
    cubeSides[qr].get().value !== urls.current && cubeSides[qr].set(options);
    return cubeSides[qr];
  };
  ...
  react_default.a.useEffect(function () {
    ...
    var setSignals = function setSignals() {
      ...
      setQrCube({
        ...
        qr2: setQR(1, "#FFA52C", side2.current),
        qr3: setQR(1, "yellow", side3.current),
        qr4: setQR(1, "#35CB4A", side4.current),
        qr5: setQR(1, "#3C99DC", side5.current),
        qr6: setQR(1, "#DF3BCF", side6.current)
      });
    };
...
var r2 = Math.random() * 360 - 180;
var r3 = Math.random() * 360 - 180;
var r4 = Math.random() * 360 - 180;
var r5 = Math.random() * 360 - 180;
var r6 = Math.random() * 360 - 180;
var r7 = Math.random() * 360 - 180;
var r8 = Math.random() * 360 - 180;
var r9 = Math.random() * 360 - 180;
var r10 = Math.random() * 360 - 180;
