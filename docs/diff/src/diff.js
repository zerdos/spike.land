...
var diff = function (str1, str2) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1: return [2 /*return*/, (_a.b = _b.sent(),
                    _a.c = res.map(function (x) { return x.added ? x.value : x.removed ? -x.count : x.count; }),
                    _a)];
        }
    });
}); };
...
var isDiff = function (str) {
    if (str.length < 10)
        return false;
    var isKey = __spreadArrays((str.slice(0, 8))).filter(function (x) { return x < "0" || x > "f"; }).length === 0;
