(function (d, w) {
  ...
  w.prototype = {
    ...
    pushComponent: function (n, t, r) {
      ...
      f && f.added === t && f.removed === r
        ? n[n.length - 1] = { count: f.count + 1, added: t, removed: r }
        : n.push({ count: 1, added: t, removed: r });
    },
    extractCommon: function (n, t, r, f) {
      ...
      return u && n.components.push({ count: u }), n.newPos = s, o;
    },
    equals: function (n, t) {
  ...
  function me(e, n, t) {
    return t = $(t, { ignoreWhitespace: !0 }), U.diff(e, n, t);
  }
  function xe(e, n, t) {
    return U.diff(e, n, t);
  }
  ...
  V.tokenize = function (e) {
    ...
    for (var r = 0; r < t.length; r++) {
      var f = t[r];
      r % 2 && !this.options.newlineIsToken ? n[n.length - 1] += f
...
`;
  ...
  function $e(e, n, t) {
    ...
    (e.index || n.index) && (r.index = e.index || n.index),
      (e.newFileName || n.newFileName) && (ce(e)
        ? ce(n)
    ...
    for (
      ...
      var o = e.hunks[f] || { oldStart: Infinity },
        u = n.hunks[i] || { oldStart: Infinity };
...
export const diff = async (d, w) => {
  ...
  isDiff = (d) => {
    ...
    const w = [...d.slice(0, 8)].filter((I) => I < "0" || I > "f").length === 0,
      H = d.slice(8);
