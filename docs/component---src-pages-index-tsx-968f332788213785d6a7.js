 ...
 *
 * @param {string} cid
 */var feedTheCache=function feedTheCache(cid){fetch("https://code.zed.vision/ipfs/"+cid).then(function(resp){return resp.text();});// console.log(cid);
return cid;};/**
 ...
 * @param {any} data
 * @param {any} onlyHash
 */function _getClient(){_getClient=Object(asyncToGenerator["a" /* default */])(/*#__PURE__*/regenerator_default.a.mark(function _callee8(){var _yield$import,getIpfs;return regenerator_default.a.wrap(function _callee8$(_context8){while(1){switch(_context8.prev=_context8.next){case 0:_context8.next=2;return __webpack_require__.e(/* import() */ 16).then(__webpack_require__.bind(null, "yTfI"));case 2:_yield$import=_context8.sent;getIpfs=_yield$import.getIpfs;return _context8.abrupt("return",getIpfs());case 5:case"end":return _context8.stop();}}},_callee8);}));return _getClient.apply(this,arguments);}var hash=/*#__PURE__*/function(){var _ref=Object(asyncToGenerator["a" /* default */])(/*#__PURE__*/regenerator_default.a.mark(function _callee(data,onlyHash){var ipfs,noisyHashes,_data,res;return regenerator_default.a.wrap(function _callee$(_context){while(1){switch(_context.prev=_context.next){case 0:_context.next=2;return getClient();case 2:ipfs=_context.sent;_context.t0=Promise;_context.next=6;return ipfs.add(""+data,{onlyHash:onlyHash});case 6:_context.t1=_context.sent;_context.t2=[_context.t1];_context.next=10;return _context.t0.all.call(_context.t0,_context.t2);case 10:noisyHashes=_context.sent;if(onlyHash){_context.next=16;break;}_context.next=14;return Promise.all(noisyHashes.map(feedTheCache));case 14:_data=_context.sent;return _context.abrupt("return",_data[0]);case 16:_context.next=18;return Promise.all(noisyHashes.map(function(cid){return getHash(cid,20000).then(function(x){return{success:x===data};});}));case 18:res=_context.sent;return _context.abrupt("return",res[0]);case 20:case"end":return _context.stop();}}},_callee);}));return function hash(_x,_x2){return _ref.apply(this,arguments);};}();/**
 * @param {string} cid
 * @param {number|undefined} _timeOut
 */var getHash=/*#__PURE__*/function(){var _ref2=Object(asyncToGenerator["a" /* default */])(/*#__PURE__*/regenerator_default.a.mark(function _callee2(cid,_timeOut){var timeout,ipfs,data;return regenerator_default.a.wrap(function _callee2$(_context2){while(1){switch(_context2.prev=_context2.next){case 0:timeout=_timeOut||20000;_context2.prev=1;_context2.next=4;return getClient();case 4:ipfs=_context2.sent;_context2.next=7;return ipfs.cat(cid,{timeout:timeout});case 7:data=_context2.sent;if(!(typeof data==="string")){_context2.next=10;break;}return _context2.abrupt("return",half(data));case 10:_context2.next=15;break;case 12:_context2.prev=12;_context2.t0=_context2["catch"](1);console.log({e:_context2.t0});case 15:case"end":return _context2.stop();}}},_callee2,null,[[1,12]]);}));return function getHash(_x3,_x4){return _ref2.apply(this,arguments);};}();/**
...
toSave=data;if(typeof data!=="string")toSave=JSON.stringify(data);_context3.next=10;return hash(data,false);case 10:dataCid=_context3.sent;hexHash=Array.from(new CID(dataCid).multihash).map(function(b){return("00"+b.toString(16)).slice(-2);}).join("");allHash=new Array(hexHash.length).fill(signal).map(function(x,i){return x+hexHash.slice(0,i+1);});_context3.next=15;return Promise.all(allHash.slice(0,5).map(function(x){return hash(x,false);}));case 15:_context3.next=17;return Promise.all(allHash.slice(5).map(function(x){return hash(x,false);}));case 17:alert("v2   "+signal+" "+data);return _context3.abrupt("return",{success:true});case 19:case"end":return _context3.stop();}}},_callee3);}));return function sendSignal(_x5,_x6){return _ref3.apply(this,arguments);};}();/**
 * @param {string} url
 ...
 */var waitForSignalAndRun=/*#__PURE__*/function(){var _ref6=Object(asyncToGenerator["a" /* default */])(/*#__PURE__*/regenerator_default.a.mark(function _callee6(_ref5){var signal,onSignal,onError,onExpired,res,CID;return regenerator_default.a.wrap(function _callee6$(_context6){while(1){switch(_context6.prev=_context6.next){case 0:signal=_ref5.signal,onSignal=_ref5.onSignal,onError=_ref5.onError,onExpired=_ref5.onExpired;_context6.prev=1;_context6.next=4;return waitForSignal(signal);case 4:res=_context6.sent;if(!(typeof res==="string"||res.success)){_context6.next=12;break;}if(!(typeof onSignal==="function")){_context6.next=11;break;}_context6.next=9;return __webpack_require__.e(/* import() */ 5).then(__webpack_require__.bind(null, "60a2"));case 9:CID=_context6.sent.default;return _context6.abrupt("return",onSignal(/*#__PURE__*/Object(asyncToGenerator["a" /* default */])(/*#__PURE__*/regenerator_default.a.mark(function _callee5(){var hashHex,cid,data,parse;return regenerator_default.a.wrap(function _callee5$(_context5){while(1){switch(_context5.prev=_context5.next){case 0:hashHex="";case 1:if(!(hashHex.length<68)){_context5.next=9;break;}console.log("Getting "+hashHex.length+" from 68 ");_context5.t0=hashHex;_context5.next=6;return getNextChar(signal+hashHex);case 6:hashHex=_context5.t0+=_context5.sent;_context5.next=1;break;case 9:cid=new CID(0,112,fromHexString(hashHex));_context5.next=12;return getHash(cid.toString(),20000);case 12:data=_context5.sent;/**
                     * @param {string | any[] | { success: boolean; } | undefined} d
                     */parse=function parse(d){try{if(typeof d!=="string")return d;var ret=JSON.parse(d);return ret;}catch(e){return d;}};return _context5.abrupt("return",parse(data));case 15:case"end":return _context5.stop();}}},_callee5);}))));case 11:return _context6.abrupt("return",0);case 12:return _context6.abrupt("return",1);case 15:_context6.prev=15;_context6.t0=_context6["catch"](1);if(!(typeof onError==="function")){_context6.next=19;break;}return _context6.abrupt("return",onError());case 19:return _context6.abrupt("return",1);case 20:_context6.prev=20;if(!(typeof onExpired==="function")){_context6.next=23;break;}return _context6.abrupt("return",onExpired());case 23:return _context6.abrupt("return",-1);case 25:case"end":return _context6.stop();}}},_callee6,null,[[1,15,20,25]]);}));return function waitForSignalAndRun(_x8){return _ref6.apply(this,arguments);};}();var getNextChar=/*#__PURE__*/ /**
* @param {string} signal
*/function(){var _ref8=Object(asyncToGenerator["a" /* default */])(/*#__PURE__*/regenerator_default.a.mark(function _callee7(signal){var chars,nextChar;return regenerator_default.a.wrap(function _callee7$(_context7){while(1){switch(_context7.prev=_context7.next){case 0:chars=Object(toConsumableArray["a" /* default */])("0123456789abcdef");_context7.next=3;return raceToSuccess(chars.map(function(x){return waitForSignal(signal+x).then(function(s){if(typeof s==="string")return x;if(s.success)return x;throw new Error("nope");});}));case 3:nextChar=_context7.sent;return _context7.abrupt("return",nextChar);case 5:case"end":return _context7.stop();}}},_callee7);}));return function getNextChar(_x9){return _ref8.apply(this,arguments);};}();/**
 * @param {any[]} promises
...
//# sourceMappingURL=component---src-pages-index-tsx-968f332788213785d6a7.js.map