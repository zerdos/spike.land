 ...
 */
      var l = __webpack_require__(
        ...
        n = __webpack_require__(/*! react */ "./node_modules/react/index.js"),
        aa = __webpack_require__(/*! stream */ "stream");
      function p(a) {
        for (
      ...
      var ma = n.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED, na = {};
      function I(a, b) {
      ...
      var cb = function () {
        function a(a, b, f) {
          n.isValidElement(a)
            ? a.type !== r
              ? a = [a]
              : (a = a.props.children, a = n.isValidElement(a) ? [a] : Z(a))
            : a = Z(a);
          a = {
            type: null,
        ...
        b.render = function (a, b, f) {
          ...
          if ("object" === typeof c && null !== c) {
            switch (c.$$typeof) {
              ...
              case ea:
                return a = [
                  n.createElement(c.type, l({ ref: a.ref }, a.props)),
                ],
                  this.stack.push(
                    {
                      type: null,
              ...
              case fa:
                return c = a.type,
                  d = c._init,
                  c = d(c._payload),
                  a = [n.createElement(c, l({ ref: a.ref }, a.props))],
                  this.stack.push(
                    {
                      type: null,
                      domNamespace: f,
        ...
        b.renderDOM = function (a, b, f) {
          ...
          if (g = d) {
            if (
              Pa[c] && (null != g.children || null != g.dangerouslySetInnerHTML)
            ) {
              throw Error(p(137, c));
            }
                ...
                if ("style" === w) {
                  ...
                  for (k in m) {
                    if (m.hasOwnProperty(k)) {
                      var x = 0 === k.indexOf("--"), y = m[k];
                      if (null != y) {
                        if (x) var A = k;
                        else if (A = k, Xa.hasOwnProperty(A)) A = Xa[A];
                        else {
                          var eb = A.replace(Ra, "-$1").toLowerCase().replace(
                            Sa,
                            "-ms-",
                          );
                          A = Xa[A] = eb;
  ...
  \***********************************************/
    ...
    /***/ (function (module, exports, __webpack_require__) {
      ...
      if (true) {
        module.exports = __webpack_require__(
          /*! ./cjs/react-dom-server.node.production.min.js */ "./node_modules/react-dom/cjs/react-dom-server.node.production.min.js",
        );
      } else {}
 ...
 */
  ...
  \********************************************************************************************************************/
    ...
    /***/ (function (module, exports, __webpack_require__) {
      ...
      var server_1 = __webpack_require__(
      ...
      function renderWorker(code, props) {
        return __awaiter(this, void 0, void 0, function () {
          ...
          return __generator(this, function (_a) {
            try {
              componentFactory_1 = new Function(
                "props",
                "React",
                code + "; return Counter(props)",
              );
              Counter_1 = function (props) {
                return componentFactory_1(props, React);
              };
              return [
                2, /*return*/
                server_1["default"].renderToString(
                  React.createElement(Counter_1, props),
                ),
              ];
            } catch (error) {
