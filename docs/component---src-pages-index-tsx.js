      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 4:
            ...
            _context3.next = 8;
            return fetch("https://c.zed.vision/register");
