                ...
                try {
                  toCheck.map(function (dig) {
                    ...
                    new Promise(function (resolve, reject) {
                      ...
                      Object(hash["a" /* getHash */])(dig, 25000).then(function (result) {
                        console.log({
                          result: {
                            dig: dig,
                            result: result
