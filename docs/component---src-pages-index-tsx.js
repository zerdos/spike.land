 ...
 * @param {any} data
 * @param {any} onlyHash
 */function _getClient(){_getClient=Object(asyncToGenerator["a" /* default */])(/*#__PURE__*/regenerator_default.a.mark(function _callee3(){return regenerator_default.a.wrap(function _callee3$(_context3){while(1){switch(_context3.prev=_context3.next){case 0:if(!ipfsClient){_context3.next=2;break;}return _context3.abrupt("return",ipfsClient);case 2:_context3.next=4;return new Function("return import(\"https://unpkg.com/@zedvision/code@"+v.code+"/src/ipfsKV.js\")")();case 4:_context3.next=6;return _context3.sent.getIpfsClient();case 6:ipfsClient=_context3.sent;return _context3.abrupt("return",ipfsClient);case 8:case"end":return _context3.stop();}}},_callee3);}));return _getClient.apply(this,arguments);}var hash=/*#__PURE__*/function(){var _ref=Object(asyncToGenerator["a" /* default */])(/*#__PURE__*/regenerator_default.a.mark(function _callee(data,onlyHash){var client,noisyHashes;return regenerator_default.a.wrap(function _callee$(_context){while(1){switch(_context.prev=_context.next){case 0:console.log("asking for client");/** @type {{ add: (arg0: string, arg1: { onlyHash: any; }) => any; } | null} */_context.next=3;return getClient();case 3:client=_context.sent;if(!(client===null)){_context.next=7;break;}console.log("no client - exiting");return _context.abrupt("return",null);case 7:_context.t0=Promise;_context.next=10;return client.add(data,{onlyHash:onlyHash});case 10:_context.t1=_context.sent;_context.next=13;return client.add(data+"N"+data,{onlyHash:onlyHash});case 13:_context.t2=_context.sent;_context.next=16;return client.add(data+"O"+data,{onlyHash:onlyHash});case 16:_context.t3=_context.sent;_context.next=19;return client.add(data+"I"+data,{onlyHash:onlyHash});case 19:_context.t4=_context.sent;_context.next=22;return client.add(data+"S"+data,{onlyHash:onlyHash});case 22:_context.t5=_context.sent;_context.next=25;return client.add(data+"E"+data,{onlyHash:onlyHash});case 25:_context.t6=_context.sent;_context.next=28;return client.add(data+"!"+data,{onlyHash:onlyHash});case 28:_context.t7=_context.sent;_context.t8=[_context.t1,_context.t2,_context.t3,_context.t4,_context.t5,_context.t6,_context.t7];_context.next=32;return _context.t0.all.call(_context.t0,_context.t8);case 32:noisyHashes=_context.sent;if(onlyHash){_context.next=38;break;}console.log("feeding the cache");_context.next=37;return Promise.all(noisyHashes.map(feedTheCache));case 37:console.log("cahce is fed");case 38:if(onlyHash){noisyHashes.map(getHash);}return _context.abrupt("return",noisyHashes);case 40:case"end":return _context.stop();}}},_callee);}));return function hash(_x,_x2){return _ref.apply(this,arguments);};}();/**
 * @param {string} cid
 * @param {number|undefined} _timeOut
 */var getHash=/*#__PURE__*/function(){var _ref2=Object(asyncToGenerator["a" /* default */])(/*#__PURE__*/regenerator_default.a.mark(function _callee2(cid,_timeOut){var timeout,client,data;return regenerator_default.a.wrap(function _callee2$(_context2){while(1){switch(_context2.prev=_context2.next){case 0:timeout=_timeOut||20000;_context2.prev=1;_context2.next=4;return getClient();case 4:client=_context2.sent;if(!(client===null)){_context2.next=7;break;}return _context2.abrupt("return",null);case 7:_context2.next=9;return client.cat(cid,{timeout:timeout});case 9:data=_context2.sent;return _context2.abrupt("return",half(data));case 13:_context2.prev=13;_context2.t0=_context2["catch"](1);console.log({e:_context2.t0});case 16:case"end":return _context2.stop();}}},_callee2,null,[[1,13]]);}));return function getHash(_x3,_x4){return _ref2.apply(this,arguments);};}();
...
var sha256 = __webpack_require__(155);
...
"use strict";
/* harmony default export */ __webpack_exports__["a"] = (function(){var editor="11.3.0";var emotionRenderer="11.3.0";var v={ipfs:"0.52.4-rc.4",workbox:"6.0.2",babel:"7.12.12",code:"11.4.1",emotionRenderer:"https://unpkg.com/@zedvision/emotion-react-renderer@"+emotionRenderer+"/dist/bundle.js",shadb:"11.2.0",prettier:"2.2.1",editor:"https://unpkg.com/@zedvision/smart-monaco-editor@"+editor+"/dist/editor.js",diff:"11.2.0",sha256:"11.0.5",uuid:"8.3.2",comlink:"4.3.0"};return v;});
