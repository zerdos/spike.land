define("./workbox-3bf8039c.js", ["exports"], function (exports) {
  "use strict";
  ...
  const messages = {
    ...
    "incorrect-class": ({
      ...
      if (isReturnValueProblem) {
        return `The return value from ` + `'${moduleName}.${
          className
            ? className + "."
            : ""
        }${funcName}()' ` +
  ...
  class StrategyHandler {
    ...
    async cachePut(key, response) {
      ...
      const oldResponse = hasCacheUpdateCallback
        ? await cacheMatchIgnoreParams( // TODO(philipwalton): the `__WB_REVISION__` param is a precaching
  ...
  class PrecacheStrategy extends Strategy {
    ...
    constructor(options = {}) {
      ...
      this._fallbackToNetwork = options.fallbackToNetwork === false
        ? false
        : true; // Redirected responses cannot be used to satisfy a navigation request, so
