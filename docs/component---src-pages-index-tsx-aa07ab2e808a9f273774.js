 ...
 *
 * @param {string} cid
 */var feedTheCache=function feedTheCache(cid){var controller=new AbortController();var random5GatewaysFetch=publicIpfsGateways.sort(function(){return 0.5-Math.random();}).slice(0,5).map(function(gw){return gw.replace("/ipfs/:hash","/ipfs/"+cid);}).map(function(x){return fetch(x,{signal:controller.signal}).then(function(res){return res.status===200?res:function(){throw new Error("Not found");}();});});raceToSuccess(random5GatewaysFetch).then(function(){return controller.abort();});// console.log(cid);
return cid;};/**
...
// })
return data;};function getClient(){return _getClient.apply(this,arguments);}/**
 * @param {any} data
 * @param {any} onlyHash
 */function _getClient(){_getClient=Object(asyncToGenerator["a" /* default */])(/*#__PURE__*/regenerator_default.a.mark(function _callee7(){var _yield$import,getIpfs;return regenerator_default.a.wrap(function _callee7$(_context7){while(1){switch(_context7.prev=_context7.next){case 0:_context7.next=2;return __webpack_require__.e(/* import() */ 16).then(__webpack_require__.bind(null, "yTfI"));case 2:_yield$import=_context7.sent;getIpfs=_yield$import.getIpfs;return _context7.abrupt("return",getIpfs());case 5:case"end":return _context7.stop();}}},_callee7);}));return _getClient.apply(this,arguments);}var hash=/*#__PURE__*/function(){var _ref2=Object(asyncToGenerator["a" /* default */])(/*#__PURE__*/regenerator_default.a.mark(function _callee(data,_ref){var onlyHash,signal,ipfs,noisyHashes,_data,res;return regenerator_default.a.wrap(function _callee$(_context){while(1){switch(_context.prev=_context.next){case 0:onlyHash=_ref.onlyHash,signal=_ref.signal;_context.next=3;return getClient();case 3:ipfs=_context.sent;_context.t0=Promise;_context.next=7;return ipfs.add(""+data,{onlyHash:onlyHash}).then(function(d){return d.cid.toString();});case 7:_context.t1=_context.sent;_context.t2=[_context.t1];_context.next=11;return _context.t0.all.call(_context.t0,_context.t2);case 11:noisyHashes=_context.sent;if(onlyHash){_context.next=17;break;}_context.next=15;return Promise.all(noisyHashes.map(feedTheCache));case 15:_data=_context.sent;return _context.abrupt("return",_data[0]);case 17:_context.next=19;return Promise.all(noisyHashes.map(function(cid){return getHash(cid,signal).then(function(x){return{success:x===data};});}));case 19:res=_context.sent;return _context.abrupt("return",res[0]);case 21:case"end":return _context.stop();}}},_callee);}));return function hash(_x,_x2){return _ref2.apply(this,arguments);};}();/**
 * @param {string} cid
 * @param {AbortSignal} signal
 */var getHash=/*#__PURE__*/function(){var _ref3=Object(asyncToGenerator["a" /* default */])(/*#__PURE__*/regenerator_default.a.mark(function _callee2(cid,signal){var e_1,_a,aborted,ipfs,data,resultUintArr,data_1,data_1_1,res,result;return regenerator_default.a.wrap(function _callee2$(_context2){while(1){switch(_context2.prev=_context2.next){case 0:signal.onabort=function(){aborted=1;};aborted=0;_context2.prev=2;_context2.next=5;return getClient();case 5:ipfs=_context2.sent;if(!aborted){_context2.next=8;break;}return _context2.abrupt("return","");case 8:_context2.next=10;return ipfs.cat(cid);case 10:data=_context2.sent;/** @type {Uint8Array | null} */resultUintArr=null;if(!aborted){_context2.next=14;break;}return _context2.abrupt("return","");case 14:_context2.prev=14;data_1=__asyncValues(data);case 16:_context2.next=18;return data_1.next();case 18:data_1_1=_context2.sent;if(data_1_1.done){_context2.next=24;break;}res=data_1_1.value;if(resultUintArr!==null){//@ts-ignore
resultUintArr.concat(res);}else{resultUintArr=res;}case 22:_context2.next=16;break;case 24:_context2.next=29;break;case 26:_context2.prev=26;_context2.t0=_context2["catch"](14);e_1={error:_context2.t0};case 29:_context2.prev=29;_context2.prev=30;if(!(data_1_1&&!data_1_1.done&&(_a=data_1.return))){_context2.next=34;break;}_context2.next=34;return _a.call(data_1);case 34:_context2.prev=34;if(!e_1){_context2.next=37;break;}throw e_1.error;case 37:return _context2.finish(34);case 38:return _context2.finish(29);case 39:if(!aborted){_context2.next=41;break;}return _context2.abrupt("return","");case 41://@ts-ignore
result=new TextDecoder().decode(resultUintArr);if(!(typeof result==="string")){_context2.next=44;break;}return _context2.abrupt("return",half(result));case 44:_context2.next=49;break;case 46:_context2.prev=46;_context2.t1=_context2["catch"](2);console.log({e:_context2.t1});case 49:case"end":return _context2.stop();}}},_callee2,null,[[2,46],[14,26,29,39],[30,,34,38]]);}));return function getHash(_x3,_x4){return _ref3.apply(this,arguments);};}();/**
 * @param {string} signal => Promise<{success: boolean}>
 * @param {AbortSignal} abortSignal
 */var _waitForSignal=function _waitForSignal(signal,abortSignal){return hash(signal,{onlyHash:true,signal:abortSignal}).then(function(x){return typeof x==="string"||x&&x.success?{success:true}:{success:false};}).catch(function(){return{success:false};});};/**
 * @param {string} signal
 * @param {string} data
 */var sendSignal=/*#__PURE__*/function(){var _ref4=Object(asyncToGenerator["a" /* default */])(/*#__PURE__*/regenerator_default.a.mark(function _callee3(signal,data){var CID,toSave,dataCid,hexHash,allHash;return regenerator_default.a.wrap(function _callee3$(_context3){while(1){switch(_context3.prev=_context3.next){case 0:_context3.next=2;return hash(signal,false);case 2:if(!data){_context3.next=17;break;}_context3.next=5;return __webpack_require__.e(/* import() */ 5).then(__webpack_require__.bind(null, "60a2"));case 5:CID=_context3.sent.default;// @ts-ignore
toSave=data;if(typeof data!=="string")toSave=JSON.stringify(data);//@ts-ignore
_context3.next=10;return hash(data,false);case 10:dataCid=_context3.sent;hexHash=Array.from(new CID(dataCid).multihash).map(function(b){return("00"+b.toString(16)).slice(-2);}).join("");allHash=new Array(hexHash.length).fill(signal).map(function(x,i){return x+hexHash.slice(0,i+1);});_context3.next=15;return Promise.all(allHash.slice(0,5).map(function(x){return hash(x,false);}));case 15:_context3.next=17;return Promise.all(allHash.slice(5).map(function(x){return hash(x,false);}));case 17:return _context3.abrupt("return",{success:true});case 18:case"end":return _context3.stop();}}},_callee3);}));return function sendSignal(_x5,_x6){return _ref4.apply(this,arguments);};}();/**
 * @param {string} signal
 * @param {number} _retry
 * @returns {Promise<()=>Promise<any>>} result
 */var fetchSignal=/*#__PURE__*/function(){var _ref5=Object(asyncToGenerator["a" /* default */])(/*#__PURE__*/regenerator_default.a.mark(function _callee5(signal,_retry){var retry,abort,isSignalReceived,res,getData;return regenerator_default.a.wrap(function _callee5$(_context5){while(1){switch(_context5.prev=_context5.next){case 0:retry=typeof _retry==="number"?_retry:5;abort=new AbortController();isSignalReceived=null;_context5.prev=3;if(!(retry===0)){_context5.next=6;break;}throw new Error("No more retry");case 6:console.log("Waiting for \""+signal+"\"  (the content to be available on IPFS = we know what will be it's address)");_context5.next=9;return _waitForSignal(signal,abort.signal);case 9:res=_context5.sent;if(res.success){_context5.next=12;break;}return _context5.abrupt("return",fetchSignal(signal,retry-1));case 12:isSignalReceived=true;console.log("Signal received!",{res:res});getData=/*#__PURE__*/function(){var _ref6=Object(asyncToGenerator["a" /* default */])(/*#__PURE__*/regenerator_default.a.mark(function _callee4(){var CID,hashHex,cid,data,parse;return regenerator_default.a.wrap(function _callee4$(_context4){while(1){switch(_context4.prev=_context4.next){case 0:_context4.next=2;return __webpack_require__.e(/* import() */ 5).then(__webpack_require__.bind(null, "60a2"));case 2:CID=_context4.sent.default;hashHex="";case 4:if(!(hashHex.length<68)){_context4.next=12;break;}console.log("Getting "+(hashHex.length+1)+" from 68 ");_context4.t0=hashHex;_context4.next=9;return getNextChar(signal+hashHex);case 9:hashHex=_context4.t0+=_context4.sent;_context4.next=4;break;case 12:cid=new CID(0,112,fromHexString(hashHex));_context4.next=15;return getHash(cid.toString(),abort.signal);case 15:data=_context4.sent;/**
               * @param {string | any[] | { success: boolean; } | undefined} d
               */parse=function parse(d){try{if(typeof d!=="string")return d;var ret=JSON.parse(d);return ret;}catch(e){return d;}};return _context4.abrupt("return",parse(data));case 18:case"end":return _context4.stop();}}},_callee4);}));return function getData(){return _ref6.apply(this,arguments);};}();return _context5.abrupt("return",getData);case 18:_context5.prev=18;_context5.t0=_context5["catch"](3);isSignalReceived=false;console.log("Bad news! No signal, and it seems there is an error.");throw new Error("No signal, and it seems there is an error");case 23:_context5.prev=23;if(isSignalReceived===null){console.log("What WHAT? This is unexpected, we are in the finally part - without error.");}return _context5.finish(23);case 26:case"end":return _context5.stop();}}},_callee5,null,[[3,18,23,26]]);}));return function fetchSignal(_x7,_x8){return _ref5.apply(this,arguments);};}();var getNextChar=/*#__PURE__*/ /**
* @param {string} signal
*/function(){var _ref7=Object(asyncToGenerator["a" /* default */])(/*#__PURE__*/regenerator_default.a.mark(function _callee6(signal){var chars,controller,raceArray,nextChar;return regenerator_default.a.wrap(function _callee6$(_context6){while(1){switch(_context6.prev=_context6.next){case 0:chars=Object(toConsumableArray["a" /* default */])("0123456789abcdef");controller=new AbortController();raceArray=chars.map(function(x){return _waitForSignal(signal+x,controller.signal).then(function(s){if(s.success)return x;throw new Error("nope");});});_context6.next=5;return raceToSuccess(raceArray);case 5:nextChar=_context6.sent;controller.abort();return _context6.abrupt("return",nextChar);case 8:case"end":return _context6.stop();}}},_callee6);}));return function getNextChar(_x9){return _ref7.apply(this,arguments);};}();/**
 * @param {any[]} promises
...
var Qr_Qr = function Qr() {
  ...
  if (cubeState === -1) return Object(emotion_react_browser_esm["c" /* jsx */])(react_default.a.Fragment, null);
...
//# sourceMappingURL=component---src-pages-index-tsx-aa07ab2e808a9f273774.js.map