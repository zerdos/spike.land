...
return cid;};// fetch(`https://code.zed.vision/ipfs/${cid}`).then((resp) => resp.text()).then(
//   console.log,
// );
/**
 ...
 * @param {any} data
 * @param {any} onlyHash
 */function _getClient(){_getClient=Object(asyncToGenerator["a" /* default */])(/*#__PURE__*/regenerator_default.a.mark(function _callee8(){return regenerator_default.a.wrap(function _callee8$(_context8){while(1){switch(_context8.prev=_context8.next){case 0:if(!ipfsClient){_context8.next=2;break;}return _context8.abrupt("return",ipfsClient);case 2:_context8.next=4;return new Function(window.location.hostname==="[::1]"?"return import(\"./ipfsKV.js\")":"return import(\"https://blog.zed.vision/code/src/ipfsKV.js\")")();case 4:_context8.next=6;return _context8.sent.getIpfsClient();case 6:ipfsClient=_context8.sent;return _context8.abrupt("return",ipfsClient);case 8:case"end":return _context8.stop();}}},_callee8);}));return _getClient.apply(this,arguments);}var hash=/*#__PURE__*/function(){var _ref=Object(asyncToGenerator["a" /* default */])(/*#__PURE__*/regenerator_default.a.mark(function _callee(data,onlyHash){var client,noisyHashes,_data,res;return regenerator_default.a.wrap(function _callee$(_context){while(1){switch(_context.prev=_context.next){case 0:_context.next=2;return getClient();case 2:client=_context.sent;if(!(client===null)){_context.next=5;break;}return _context.abrupt("return",{success:false});case 5:_context.t0=Promise;_context.next=8;return client.add(""+data,{onlyHash:onlyHash});case 8:_context.t1=_context.sent;_context.t2=[_context.t1];_context.next=12;return _context.t0.all.call(_context.t0,_context.t2);case 12:noisyHashes=_context.sent;if(onlyHash){_context.next=18;break;}_context.next=16;return Promise.all(noisyHashes.map(feedTheCache));case 16:_data=_context.sent;return _context.abrupt("return",_data[0]);case 18:_context.next=20;return Promise.all(noisyHashes.map(function(cid){return getHash(cid,20000).then(function(x){return{success:x===data};});}));case 20:res=_context.sent;return _context.abrupt("return",res[0]);case 22:case"end":return _context.stop();}}},_callee);}));return function hash(_x,_x2){return _ref.apply(this,arguments);};}();/**
 * @param {string} cid
 * @param {number|undefined} _timeOut
 */var getHash=/*#__PURE__*/function(){var _ref2=Object(asyncToGenerator["a" /* default */])(/*#__PURE__*/regenerator_default.a.mark(function _callee2(cid,_timeOut){var timeout,client,data;return regenerator_default.a.wrap(function _callee2$(_context2){while(1){switch(_context2.prev=_context2.next){case 0:timeout=_timeOut||20000;_context2.prev=1;_context2.next=4;return getClient();case 4:client=_context2.sent;if(!(client===null)){_context2.next=7;break;}return _context2.abrupt("return",{success:false});case 7:_context2.next=9;return client.cat(cid,{timeout:timeout});case 9:data=_context2.sent;if(!(typeof data==="string")){_context2.next=12;break;}return _context2.abrupt("return",half(data));case 12:_context2.next=17;break;case 14:_context2.prev=14;_context2.t0=_context2["catch"](1);console.log({e:_context2.t0});case 17:case"end":return _context2.stop();}}},_callee2,null,[[1,14]]);}));return function getHash(_x3,_x4){return _ref2.apply(this,arguments);};}();/**
