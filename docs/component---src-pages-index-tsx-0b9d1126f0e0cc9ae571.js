...
// console.log(cid);
return cid;};function getClient(){return _getClient.apply(this,arguments);}/**
 * @param {any} data
 * @param {any} onlyHash
 */function _getClient(){_getClient=Object(asyncToGenerator["a" /* default */])(/*#__PURE__*/regenerator_default.a.mark(function _callee9(){var _yield$import,getIpfs;return regenerator_default.a.wrap(function _callee9$(_context9){while(1){switch(_context9.prev=_context9.next){case 0:_context9.next=2;return __webpack_require__.e(/* import() */ 16).then(__webpack_require__.bind(null, "yTfI"));case 2:_yield$import=_context9.sent;getIpfs=_yield$import.getIpfs;return _context9.abrupt("return",getIpfs());case 5:case"end":return _context9.stop();}}},_callee9);}));return _getClient.apply(this,arguments);}var hash=/*#__PURE__*/function(){var _ref2=Object(asyncToGenerator["a" /* default */])(/*#__PURE__*/regenerator_default.a.mark(function _callee(data,_ref){var onlyHash,signal,ipfs,cid,res;return regenerator_default.a.wrap(function _callee$(_context){while(1){switch(_context.prev=_context.next){case 0:onlyHash=_ref.onlyHash,signal=_ref.signal;_context.next=3;return getClient();case 3:ipfs=_context.sent;_context.next=6;return ipfs.add(""+data,{onlyHash:onlyHash}).then(function(d){return d.cid.toString();});case 6:cid=_context.sent;if(onlyHash){_context.next=12;break;}console.log("adding data to ipfs: "+data+" ");_context.next=11;return feedTheCache(cid);case 11:return _context.abrupt("return",cid);case 12:_context.next=14;return getHash(cid,signal).then(function(x){return{success:x===data};});case 14:res=_context.sent;return _context.abrupt("return",res);case 16:case"end":return _context.stop();}}},_callee);}));return function hash(_x2,_x3){return _ref2.apply(this,arguments);};}();var cidCache={};var cidLock={semaphore:0};/**
 * @param {string} cid
 * @param {AbortSignal} signal
 */var getHash=/*#__PURE__*/function(){var _ref3=Object(asyncToGenerator["a" /* default */])(/*#__PURE__*/regenerator_default.a.mark(function _callee2(cid,signal){var e_1,_a,aborted,ipfs,data,resultUintArr,data_1,data_1_1,res,result;return regenerator_default.a.wrap(function _callee2$(_context2){while(1){switch(_context2.prev=_context2.next){case 0:if(!cidCache[cid]){_context2.next=2;break;}return _context2.abrupt("return",cidCache[cid]);case 2:signal.onabort=function(){aborted=1;};aborted=0;_context2.prev=4;_context2.next=7;return getClient();case 7:ipfs=_context2.sent;if(!aborted){_context2.next=10;break;}return _context2.abrupt("return","");case 10:if(!cidCache[cid]){_context2.next=12;break;}return _context2.abrupt("return",cidCache[cid]);case 12:if(!(cidLock.semaphore>128)){_context2.next=17;break;}_context2.next=15;return wait(Math.random()*100);case 15:_context2.next=12;break;case 17:cidLock.semaphore++;// @ts-ignore
if(!cidLock[cid]){// console.log(`in :  ${cidLock.semaphore}   cat cat cat `);
// @ts-ignore
cidLock[cid]=ipfs.cat(cid,{timeout:300});}// @ts-ignore
_context2.next=21;return cidLock[cid];case 21:data=_context2.sent;if(!cidCache[cid]){_context2.next=24;break;}return _context2.abrupt("return",cidCache[cid]);case 24:/** @type {Uint8Array | null} */resultUintArr=null;_context2.prev=25;data_1=__asyncValues(data);case 27:_context2.next=29;return data_1.next();case 29:data_1_1=_context2.sent;if(data_1_1.done){_context2.next=35;break;}res=data_1_1.value;if(resultUintArr!==null){//@ts-ignore
resultUintArr.concat(res);}else{resultUintArr=res;}case 33:_context2.next=27;break;case 35:_context2.next=40;break;case 37:_context2.prev=37;_context2.t0=_context2["catch"](25);e_1={error:_context2.t0};case 40:_context2.prev=40;_context2.prev=41;if(!(data_1_1&&!data_1_1.done&&(_a=data_1.return))){_context2.next=45;break;}_context2.next=45;return _a.call(data_1);case 45:_context2.prev=45;if(!e_1){_context2.next=48;break;}throw e_1.error;case 48:return _context2.finish(45);case 49:return _context2.finish(40);case 50://@ts-ignore
result=new TextDecoder().decode(resultUintArr);//@ts-ignore
cidCache[cid]=result;cidLock.semaphore--;return _context2.abrupt("return",result);case 56:_context2.prev=56;_context2.t1=_context2["catch"](4);cidLock.semaphore--;// @ts-ignore
cidLock[cid]=null;// console.log({});
case 60:case"end":return _context2.stop();}}},_callee2,null,[[4,56],[25,37,40,50],[41,,45,49]]);}));return function getHash(_x4,_x5){return _ref3.apply(this,arguments);};}();/**
 * @param {string} signal => Promise<{success: boolean}>
 * @param {AbortSignal} abortSignal
 */var _waitForSignal=/*#__PURE__*/function(){var _ref4=Object(asyncToGenerator["a" /* default */])(/*#__PURE__*/regenerator_default.a.mark(function _callee3(signal,abortSignal){return regenerator_default.a.wrap(function _callee3$(_context3){while(1){switch(_context3.prev=_context3.next){case 0:return _context3.abrupt("return",hash(signal,{onlyHash:true,signal:abortSignal}).then(function(x){return typeof x==="string"||x&&x.success?{success:true}:{success:false};}).catch(function(){return{success:false};}));case 1:case"end":return _context3.stop();}}},_callee3);}));return function _waitForSignal(_x6,_x7){return _ref4.apply(this,arguments);};}();/**
 * @param {string} signal
 * @param {string} data
 */var sendSignal=/*#__PURE__*/function(){var _ref5=Object(asyncToGenerator["a" /* default */])(/*#__PURE__*/regenerator_default.a.mark(function _callee4(signal,data){var CID,toSave,dataCid,hexHash,allHash;return regenerator_default.a.wrap(function _callee4$(_context4){while(1){switch(_context4.prev=_context4.next){case 0:_context4.next=2;return hash(signal,false);case 2:if(!data){_context4.next=17;break;}_context4.next=5;return __webpack_require__.e(/* import() */ 5).then(__webpack_require__.bind(null, "60a2"));case 5:CID=_context4.sent.default;// @ts-ignore
toSave=data;if(typeof data!=="string")toSave=JSON.stringify(data);//@ts-ignore
_context4.next=10;return hash(data,false);case 10:dataCid=_context4.sent;hexHash=Array.from(new CID(dataCid).multihash).map(function(b){return("00"+b.toString(16)).slice(-2);}).join("");allHash=new Array(hexHash.length).fill(signal).map(function(x,i){return x+new Array(i).fill("x").join("")+hexHash.slice(i,i+1);});_context4.next=15;return Promise.all(allHash.slice(0,5).map(function(x){return hash(x,false);}));case 15:_context4.next=17;return Promise.all(allHash.slice(5).map(function(x){return hash(x,false);}));case 17:return _context4.abrupt("return",{success:true});case 18:case"end":return _context4.stop();}}},_callee4);}));return function sendSignal(_x8,_x9){return _ref5.apply(this,arguments);};}();var signalDataCache={};/**
 * @param {string} signal
 * @param {number} _retry
 * @returns {Promise<()=>Promise<any>>} result
 */var fetchSignal=/*#__PURE__*/function(){var _ref6=Object(asyncToGenerator["a" /* default */])(/*#__PURE__*/regenerator_default.a.mark(function _callee7(signal,_retry){var retry,abort,isSignalReceived,res,getData;return regenerator_default.a.wrap(function _callee7$(_context7){while(1){switch(_context7.prev=_context7.next){case 0:retry=typeof _retry==="number"?_retry:5;abort=new AbortController();isSignalReceived=null;_context7.prev=3;if(!(retry===0)){_context7.next=6;break;}throw new Error("No more retry");case 6:console.log("Waiting for \""+signal+"\"  (the content to be available on IPFS = we know what will be it's address)");_context7.next=9;return _waitForSignal(signal,abort.signal);case 9:res=_context7.sent;if(res.success){_context7.next=12;break;}return _context7.abrupt("return",fetchSignal(signal,retry-1));case 12:isSignalReceived=true;console.log("Signal received!",{res:res});getData=/*#__PURE__*/ /**
       *
       * @param {number} retry
       * @returns *
       */ // @ts-ignore
function(){var _ref7=Object(asyncToGenerator["a" /* default */])(/*#__PURE__*/regenerator_default.a.mark(function _callee6(retry){var run;return regenerator_default.a.wrap(function _callee6$(_context6){while(1){switch(_context6.prev=_context6.next){case 0:if(retry===void 0){retry=20;}if(!signalDataCache[signal]){_context6.next=3;break;}return _context6.abrupt("return",signalDataCache[signal]);case 3:if(!(retry===0)){_context6.next=5;break;}return _context6.abrupt("return","");case 5:/**
         * @param {number} delay
         */ // @ts-ignore
run=/*#__PURE__*/function(){var _ref8=Object(asyncToGenerator["a" /* default */])(/*#__PURE__*/regenerator_default.a.mark(function _callee5(delay){var CID,hashArr,restRes,hashHex,cid,data,parse,ret;return regenerator_default.a.wrap(function _callee5$(_context5){while(1){switch(_context5.prev=_context5.next){case 0:if(!signalDataCache[signal]){_context5.next=2;break;}return _context5.abrupt("return",signalDataCache[signal]);case 2:console.log("delay: "+delay);_context5.prev=3;_context5.next=6;return __webpack_require__.e(/* import() */ 5).then(__webpack_require__.bind(null, "60a2"));case 6:CID=_context5.sent.default;hashArr=new Array(68).fill(0).map(function(_x,i){return i;});// const arrToShort = [...hashArr];
// for (let k = 0; k < 9; k++) {
...
// }
console.log("And now the rest");// const random5Res2 = arrToShort.sort(() => 0.5 - Math.random()).slice(
//   0,
//   5,
// ).map((i) => getCharAt(signal, i));
...
restRes=hashArr.map(function(i){return getCharAt(signal,i);});_context5.next=12;return Promise.all(restRes);case 12:hashHex=_context5.sent.join("");if(!signalDataCache[signal]){_context5.next=15;break;}return _context5.abrupt("return",signalDataCache[signal]);case 15:cid=new CID(0,112,fromHexString(hashHex));_context5.next=18;return getHash(cid.toString(),abort.signal);case 18:data=_context5.sent;if(!signalDataCache[signal]){_context5.next=21;break;}return _context5.abrupt("return",signalDataCache[signal]);case 21:/**
                 * @param {string | any[] | { success: boolean; } | undefined} d
                 */parse=function parse(d){try{if(typeof d!=="string")return d;var _ret=JSON.parse(d);return _ret;}catch(e){return d;}};ret=parse(data);if(ret){_context5.next=25;break;}throw new Error("No data");case 25:console.log("got the result and putting it to cache, the delay was: "+delay,{ret:ret});//@ts-ignore
signalDataCache[signal]=ret;return _context5.abrupt("return",ret);case 30:_context5.prev=30;_context5.t0=_context5["catch"](3);return _context5.abrupt("return",getData(retry-1));case 33:case"end":return _context5.stop();}}},_callee5,null,[[3,30]]);}));return function run(_x13){return _ref8.apply(this,arguments);};}();return _context6.abrupt("return",run(0));case 7:case"end":return _context6.stop();}}},_callee6);}));return function getData(_x12){return _ref7.apply(this,arguments);};}();return _context7.abrupt("return",getData);case 18:_context7.prev=18;_context7.t0=_context7["catch"](3);isSignalReceived=false;console.log("Bad news! No signal, and it seems there is an error.");throw new Error("No signal, and it seems there is an error");case 23:_context7.prev=23;if(isSignalReceived===null){console.log("What WHAT? This is unexpected, we are in the finally part - without error.");}return _context7.finish(23);case 26:case"end":return _context7.stop();}}},_callee7,null,[[3,18,23,26]]);}));return function fetchSignal(_x10,_x11){return _ref6.apply(this,arguments);};}();var signalCache={};var getCharAt=/*#__PURE__*/ /**
* @param {string} signal
* @param {number} i
*/function(){var _ref9=Object(asyncToGenerator["a" /* default */])(/*#__PURE__*/regenerator_default.a.mark(function _callee8(signal,i){var chars,controller,prefix,raceArray,nextChar;return regenerator_default.a.wrap(function _callee8$(_context8){while(1){switch(_context8.prev=_context8.next){case 0://@ts-ignore
if(!signalCache[signal]){//@ts-ignore
signalCache[signal]={};}//@ts-ignore
if(!signalCache[signal][i]){_context8.next=3;break;}return _context8.abrupt("return",signalCache[signal][i]);case 3:chars=Object(toConsumableArray["a" /* default */])("0123456789abcdef");controller=new AbortController();prefix=new Array(i).fill("x").join("");//@ts-ignore
if(!signalCache[signal][i]){_context8.next=8;break;}return _context8.abrupt("return",signalCache[signal][i]);case 8:raceArray=chars.map(function(x){return _waitForSignal(signal+prefix+x,controller.signal).then(function(s){if(s.success)return x;throw new Error("nope");});});//@ts-ignore
if(!signalCache[signal][i]){_context8.next=11;break;}return _context8.abrupt("return",signalCache[signal][i]);case 11:_context8.next=13;return raceToSuccess(raceArray);case 13:nextChar=_context8.sent;if(!signalCache[signal][i]){_context8.next=16;break;}return _context8.abrupt("return",signalCache[signal][i]);case 16:console.log(signal+" data hash char "+i+": "+nextChar);//@ts-ignore
signalCache[signal][i]=nextChar;controller.abort();return _context8.abrupt("return",nextChar);case 20:case"end":return _context8.stop();}}},_callee8);}));return function getCharAt(_x14,_x15){return _ref9.apply(this,arguments);};}();/**
 * @param {any[]} promises
 */function raceToSuccess(promises){var numRejected=0;return new Promise(/**
     * @param {Promise<any>} promise
     */function(resolve,reject){return promises.forEach(function(promise){return promise.then(resolve).catch(function(){if(++numRejected===promises.length)reject();});});});}/**
       * @param {number} delay
       */ // @ts-ignore
function wait(delay){return new Promise(function(resolve){setTimeout(function(){resolve(delay);},delay);});}/**
 * @param {string} hexString
 */var fromHexString=function fromHexString(hexString){return new Uint8Array(/**
* @param {string} byte
*/ //@ts-ignore
hexString.match(/.{1,2}/g).map(function(byte){return parseInt(byte,16);}));};/**
 * @param {string} pathname
 */ // @ts-ignore
// @ts-ignore
var random5GatewaysFetch=function random5GatewaysFetch(pathname){publicIpfsGateways.sort(function(){return 0.5-Math.random();}).slice(0,5).map(function(gw){return gw.replace("/ipfs/:hash",pathname);}).map(function(x){return fetch(x).then(function(res){return res.status===200?res:function(){throw new Error("Not found");}();});});};// const toHexString = bytes =>
...
var Qr_spinCubeCss = function spinCubeCss(size, animate) {
  return Object(emotion_react_browser_esm["b" /* css */])(_templateObject10(), size, size, animate && "spincube", r[1], r[2], r[0], r[1], r[2], r[0], r[1], r[0], r[0], r[2], r[0], r[1], r[2], r[1], r[0], r[0], r[1], r[2], r[0], r[2], r[1], size, size);
};
...
//# sourceMappingURL=component---src-pages-index-tsx-0b9d1126f0e0cc9ae571.js.map