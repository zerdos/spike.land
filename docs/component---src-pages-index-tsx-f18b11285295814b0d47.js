...
// EXTERNAL MODULE: ./node_modules/@zedvision/code/dist/versions.js
var versions = __webpack_require__(75);

// CONCATENATED MODULE: ./node_modules/@zedvision/code/dist/hash.js
...
function _getClient() {
  _getClient = Object(asyncToGenerator["a" /* default */])( /*#__PURE__*/regenerator_default.a.mark(function _callee4() {
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            return _context4.abrupt("return", ipfsClient);

          case 2:
            _context4.next = 4;
            return new Function(window.location.hostname === "[::1]" ? "return import(\"./ipfsKV.js\")" : "return import(\"https://unpkg.com/@zedvision/code@".concat(v.code, "/src/ipfsKV.js\")"))();

          case 4:
            _context4.next = 6;
            return _context4.sent.getIpfsClient();

          case 6:
            ipfsClient = _context4.sent;
            return _context4.abrupt("return", ipfsClient);
...
var forkMe = __webpack_require__(160);
...
var pages_BlogIndex = function BlogIndex(_ref) {
  ...
  return Object(emotion_react_browser_esm["c" /* jsx */])(layout["a" /* Layout */], null, Object(emotion_react_browser_esm["c" /* jsx */])(seo["a" /* SEO */], {
    ...
    return Object(emotion_react_browser_esm["c" /* jsx */])("article", {
      ...
      css: /*#__PURE__*/Object(emotion_react_browser_esm["b" /* css */])("margin-bottom:", Object(typography["b" /* rhythm */])(1 / 4), ";" + ( true ? "" : undefined),  true ? "" : undefined)
...
/* harmony import */ var _emotion_styled_base__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(31);
...
/* harmony import */ var _zed_profile_pic_jpg__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(46);
