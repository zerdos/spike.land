...
var addMethods=__webpack_require__(72);var methods=[];module.exports=function(){var w=new Worker(__webpack_require__.p+"built-renderer.d8707e.worker.js",{name:"built-renderer.[hash:6].worker.js"});addMethods(w,methods);return w;};
...
/***/ (function(module, exports, __webpack_require__) {
				...
				var addMethods = __webpack_require__(72)
				var methods = ["sha256"]
...
/* harmony import */ var hey_listen__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(74);
/* harmony import */ var style_value_types__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(75);
/* harmony import */ var framesync__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(73);
...
var colorTypes = [style_value_types__WEBPACK_IMPORTED_MODULE_3__[/* hex */ "f"], style_value_types__WEBPACK_IMPORTED_MODULE_3__[/* rgba */ "l"], style_value_types__WEBPACK_IMPORTED_MODULE_3__[/* hsla */ "g"]];
...
var mixColor = function mixColor(from, to) {
  ...
  var mixFunc = fromColorType === style_value_types__WEBPACK_IMPORTED_MODULE_3__[/* hsla */ "g"] ? mix : mixLinearColor;
  return function (v) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "f", function() { return hex; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "g", function() { return hsla; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "h", function() { return number; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "i", function() { return percent; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "j", function() { return progressPercentage; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "k", function() { return px; });
/* unused harmony export rgbUnit */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "l", function() { return rgba; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "m", function() { return scale; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "n", function() { return vh; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "o", function() { return vw; });
...
var filter = Object(tslib__WEBPACK_IMPORTED_MODULE_0__[/* __assign */ "a"])(Object(tslib__WEBPACK_IMPORTED_MODULE_0__[/* __assign */ "a"])({}, complex), {
...
// CONCATENATED MODULE: ../smart-monaco-editor/dist/importScript.js
var cache={};var importScript=function importScript(src,res){if(res===void 0){res=[];}var prefix=src.slice(0,8);if(prefix==="https://"){return window.document.head.querySelector("script[src=\""+src+"\"]")||new Promise(function(resolve,reject){var s=window.document.createElement("script");s.src=src;s.type="application/javascript";s.onload=function(){if(res.length===0){resolve(window);}var ret={};res.forEach(function(x){return Object.assign(ret,window[x]);});resolve(ret);};s.onerror=reject;window.document.head.appendChild(s);});}};
// CONCATENATED MODULE: ../smart-monaco-editor/dist/monaco.js
var monaco_require;var getMonaco=/*#__PURE__*/function(){var _ref=Object(asyncToGenerator["a" /* default */])(/*#__PURE__*/regenerator_default.a.mark(function _callee(){var vsPath,_yield$importScript,require,monaco;return regenerator_default.a.wrap(function _callee$(_context){while(1){switch(_context.prev=_context.next){case 0:vsPath="https://blog.zed.vision/release/min/vs";_context.next=3;return importScript(vsPath+"/loader.js");case 3:_yield$importScript=_context.sent;require=_yield$importScript.require;require.config({paths:{"vs":vsPath}});_context.next=8;return new Promise(function(resolve){return require(["vs/editor/editor.main"],function(_m){return resolve(_m);});});case 8:monaco=_context.sent;return _context.abrupt("return",monaco);case 10:case"end":return _context.stop();}}},_callee);}));return function getMonaco(){return _ref.apply(this,arguments);};}();
// CONCATENATED MODULE: ../smart-monaco-editor/dist/editor.js
/* harmony default export */ var editor = (/*#__PURE__*/(function(){var _ref2=Object(asyncToGenerator["a" /* default */])(/*#__PURE__*/regenerator_default.a.mark(function _callee2(_ref){var onChange,code,language,container,options,monaco,modelUri,model,modules,importHelper,dts;return regenerator_default.a.wrap(function _callee2$(_context2){while(1){switch(_context2.prev=_context2.next){case 0:onChange=_ref.onChange,code=_ref.code,language=_ref.language,container=_ref.container,options=_ref.options;_context2.next=3;return getMonaco();case 3:monaco=_context2.sent;modelUri=monaco.Uri.parse(language==="typescript"?"file:///main.tsx":"file:///main.html");model=monaco.editor.getModel(modelUri)||monaco.editor.createModel(code,language,modelUri);modules={monaco:monaco,editor:monaco.editor.create(container,Object.assign({formatOnType:false,scrollbar:{horizontal:"hidden",verticalHasArrows:true,verticalScrollbarSize:20},minimap:{enabled:false},folding:false,glyphMargin:false,wordWrap:"off",mouseWheelZoom:false,wordWrapColumn:80,useTabStops:false,dragAndDrop:false,disableLayerHinting:true,formatOnPaste:false,disableMonospaceOptimizations:true,showUnused:true,//       glyphMargin: true,
automaticLayout:true,scrollBeyondLastLine:false,autoIndent:"full",accessibilitySupport:"off",autoClosingQuotes:"beforeWhitespace",padding:{bottom:300},lineNumbers:"on",autoClosingBrackets:"beforeWhitespace",autoClosingOvertype:"auto",suggest:{},codeLens:true,autoSurround:"languageDefined",// acceptSuggestionOnCommitCharacter: true,
trimAutoWhitespace:false,codeActionsOnSaveTimeout:100,model:model,value:code,language:language,theme:"vs-dark"},options))};modules.editor.onDidChangeModelContent(function(){return onChange(modules.editor.getValue());});modules.monaco.languages.typescript.typescriptDefaults.setDiagnosticsOptions({noSuggestionDiagnostics:true,noSemanticValidation:true,noSyntaxValidation:true});if(!(language==="typescript")){_context2.next=17;break;}importHelper=[{name:"react",url:"https://unpkg.com/@types/react@17.0.0/index.d.ts",depend:["global","csstype","react-dom","prop-types"]},{name:"global",url:"https://unpkg.com/@types/react@17.0.0/global.d.ts",depend:[]},{name:"prop-types",url:"https://unpkg.com/@types/prop-types@15.7.3/index.d.ts",depend:[]},{name:"react-dom",url:"https://unpkg.com/@types/react-dom@17.0.0/index.d.ts",depend:[]},{name:"csstype",url:"https://unpkg.com/csstype@3.0.6/index.d.ts",depend:[]},{name:"@emotion/styled/base.d.ts",url:"https://unpkg.com/@emotion/styled@11.0.0/types/base.d.ts",depend:["@emotion/react","@emotion/serialize","react"]},{name:"@emotion/styled/index.d.ts",url:"https://unpkg.com/@emotion/styled@11.0.0/types/index.d.ts",depend:["@emotion/react","@emotion/serialize","react"]},{name:"@emotion/cache/index.d.ts",url:"https://unpkg.com/@emotion/cache@11.0.0/types/index.d.ts",depend:["@emotion/utils"]},{name:"@emotion/react/index.d.ts",url:"https://unpkg.com/@emotion/react@11.1.4/types/index.d.ts",depend:["@emotion/cache"]},{name:"@emotion/react/jsx-namespace.d.ts",url:"https://unpkg.com/@emotion/react@11.1.4/types/jsx-namespace.d.ts",depend:["@emotion/utils","csstype"]},{name:"@emotion/react/css-prop.d.ts",url:"https://unpkg.com/@emotion/react@11.1.4/types/css-prop.d.ts",depend:["@emotion/utils","csstype"]},{name:"@emotion/react/helper.d.ts",url:"https://unpkg.com/@emotion/react@11.1.4/types/helper.d.ts",depend:["@emotion/utils","csstype"]},{name:"@emotion/react/theming.d.ts",url:"https://unpkg.com/@emotion/react@11.1.4/types/theming.d.ts",depend:["@emotion/utils","csstype"]},{name:"@emotion/serialize/index.d.ts",url:"https://unpkg.com/@emotion/serialize@1.0.0/types/index.d.ts",depend:["@emotion/utils","csstype"]},{name:"@emotion/utils/index.d.ts",url:"https://unpkg.com/@emotion/utils@1.0.0/types/index.d.ts",depend:[]},{name:"framer-motion",url:"https://unpkg.com/framer-motion@3.2.0/dist/framer-motion.d.ts",depend:[]},{name:"popmotion",url:"https://unpkg.com/popmotion@9.1.0/lib/index.d.ts"},{name:"@zedvision/qrious/index.d.ts",url:"https://unpkg.com/@zedvision/qrious@10.12.14/dist/qrious.d.ts"}];dts=importHelper.map(function(_ref3){var name=_ref3.name,url=_ref3.url;return Object(asyncToGenerator["a" /* default */])(/*#__PURE__*/regenerator_default.a.mark(function _callee(){return regenerator_default.a.wrap(function _callee$(_context){while(1){switch(_context.prev=_context.next){case 0:_context.t0=modules.monaco.languages.typescript.typescriptDefaults;_context.next=3;return fetch(url);case 3:_context.next=5;return _context.sent.text();case 5:_context.t1=_context.sent;_context.t2=name.includes("@")?"file:///node_modules/"+name:"file:///node_modules/@types/"+name+"/index.d.ts";return _context.abrupt("return",_context.t0.addExtraLib.call(_context.t0,_context.t1,_context.t2));case 8:case"end":return _context.stop();}}},_callee);}))();});modules.monaco.languages.typescript.typescriptDefaults.setCompilerOptions({target:99,allowNonTsExtensions:true,allowUmdGlobalAccess:true,strict:true,allowJs:true,noEmitOnError:true,allowSyntheticDefaultImports:true,moduleResolution:2,module:99,noEmit:true,typeRoots:["node_modules/@types"],jsx:"react-jsx",esModuleInterop:true});_context2.next=15;return Promise.all(dts);case 15:modules.monaco.languages.typescript.typescriptDefaults.setDiagnosticsOptions({noSuggestionDiagnostics:false,noSemanticValidation:false,noSyntaxValidation:false});return _context2.abrupt("return",modules);case 17:case"end":return _context2.stop();}}},_callee2);}));return function(_x){return _ref2.apply(this,arguments);};})());
// EXTERNAL MODULE: ./src/components/utils/renderer/renderer.worker.js
var renderer_worker = __webpack_require__(148);
  ...
  react["useEffect"](function () {
    ...
    function _transformCode() {
      _transformCode = Object(asyncToGenerator["a" /* default */])( /*#__PURE__*/regenerator_default.a.mark(function _callee3(codeHash, errorMessage) {
        var _yield$Function, transpileCode, _errorMessage;
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                _context3.prev = 1;
                _context3.next = 4;
                return new Function("return import(\"https://blog.code.zed.vision/code/src/transpile.js\")")();

              case 4:
                _yield$Function = _context3.sent;
                transpileCode = _yield$Function.transpileCode;
                return _context3.abrupt("return", transpileCode(unHash(codeHash), false));
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.next = 4;
                return /* Cannot get final name for export "startMonaco" in "../smart-monaco-editor/dist/editor.js" (known exports: default, known reexports: ) */ undefined({
                  language: "typescript",
                  code: c,
