...
{signal:abort.signal,timeout:1500});case 17:data=_context5.sent;if(!signalDataCache[signal]){_context5.next=20;break;}return _context5.abrupt("return",signalDataCache[signal]);case 20:/**
               ...
               */parse=function parse(d){try{if(typeof d!=="string")return d;var _ret=JSON.parse(d);return _ret;}catch(e){return d;}};ret=parse(data);if(ret){_context5.next=24;break;}throw new Error("No data");case 24:// console.log(
//   `got the result and putting it to cache, the delay was: ${delay}`,
//   { ret },
// );
//@ts-ignore
signalDataCache[signal]=ret;return _context5.abrupt("return",ret);case 28:_context5.prev=28;_context5.t0=_context5["catch"](3);return _context5.abrupt("return",getData(retry-1));case 31:case"end":return _context5.stop();}}},_callee5,null,[[3,28]]);}));return function run(_x13){return _ref9.apply(this,arguments);};}();return _context6.abrupt("return",run(0));case 7:case"end":return _context6.stop();}}},_callee6);}));return function getData(_x12){return _ref8.apply(this,arguments);};}();return _context7.abrupt("return",getData);case 16:_context7.prev=16;_context7.t0=_context7["catch"](3);isSignalReceived=false;//   console.log(`Bad news! No signal, and it seems there is an error.`);
case 19:case"end":return _context7.stop();}}},_callee7,null,[[3,16]]);}));return function fetchSignal(_x10,_x11){return _ref7.apply(this,arguments);};}();var signalCache={};var getCharAt=/*#__PURE__*/ /**
* @param {string} signal
* @param {number} i
...
if(!signalCache[signal][i]){_context8.next=11;break;}return _context8.abrupt("return",signalCache[signal][i]);case 11:_context8.next=13;return raceToSuccess(raceArray);case 13:nextChar=_context8.sent;if(!signalCache[signal][i]){_context8.next=16;break;}return _context8.abrupt("return",signalCache[signal][i]);case 16://  console.log(`${signal} data hash char ${i}: ${nextChar}`);
//@ts-ignore
signalCache[signal][i]=nextChar;controller.abort();return _context8.abrupt("return",nextChar);case 19:case"end":return _context8.stop();}}},_callee8);}));return function getCharAt(_x14,_x15){return _ref10.apply(this,arguments);};}();/**
 * @param {any[]} promises
...
//# sourceMappingURL=component---src-pages-index-tsx-e2e03581645e0f1c664a.js.map