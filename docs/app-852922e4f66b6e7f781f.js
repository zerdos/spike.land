...
;// CONCATENATED MODULE: ../../.yarn/cache/@babel-runtime-npm-7.13.9-f5cea06d51-e6f79d20e1.zip/node_modules/@babel/runtime/helpers/esm/setPrototypeOf.js
...
;// CONCATENATED MODULE: ../../.yarn/cache/@babel-runtime-npm-7.13.9-f5cea06d51-e6f79d20e1.zip/node_modules/@babel/runtime/helpers/esm/inheritsLoose.js
...
var setPrototypeOf = __webpack_require__(3153);
...
var _typeof = __webpack_require__(6849).default;
...
"use strict";
exports.__esModule=true;exports.shallowCompare=exports.validateRedirect=exports.insertParams=exports.resolve=exports.match=exports.pick=exports.startsWith=undefined;var _invariant=__webpack_require__(4573);var _invariant2=_interopRequireDefault(_invariant);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}////////////////////////////////////////////////////////////////////////////////
...
"use strict";
var _interopRequireDefault=__webpack_require__(1519);var _gatsby=__webpack_require__(2444);var _getManifestPathname=_interopRequireDefault(__webpack_require__(343));/* global __MANIFEST_PLUGIN_HAS_LOCALISATION__ */ // when we don't have localisation in our manifest, we tree shake everything away
...
// EXTERNAL MODULE: ../../.yarn/cache/@babel-runtime-npm-7.13.9-f5cea06d51-e6f79d20e1.zip/node_modules/@babel/runtime/helpers/esm/defineProperty.js
...
// EXTERNAL MODULE: ../../.yarn/cache/react-npm-17.0.1-98658812fc-a76d86ec97.zip/node_modules/react/index.js
var react = __webpack_require__(7693);
// EXTERNAL MODULE: ../../.yarn/cache/invariant-npm-2.2.4-717fbdb119-96d8a2a4f0.zip/node_modules/invariant/browser.js
...
;// CONCATENATED MODULE: ../../.yarn/$$virtual/@gatsbyjs-reach-router-virtual-56d47aea2a/0/cache/@gatsbyjs-reach-router-npm-1.3.6-85044649ca-be2d5b3eba.zip/node_modules/@gatsbyjs/reach-router/es/lib/history.js
var _extends=Object.assign||function(target){for(var i=1;i<arguments.length;i++){var source=arguments[i];for(var key in source){if(Object.prototype.hasOwnProperty.call(source,key)){target[key]=source[key];}}}return target;};var getLocation=function getLocation(source){var _source$location=source.location,search=_source$location.search,hash=_source$location.hash,href=_source$location.href,origin=_source$location.origin,protocol=_source$location.protocol,host=_source$location.host,hostname=_source$location.hostname,port=_source$location.port;var pathname=source.location.pathname;if(!pathname&&href&&canUseDOM){var url=new URL(href);pathname=url.pathname;}return{pathname:encodeURI(decodeURI(pathname)),search:search,hash:hash,href:href,origin:origin,protocol:protocol,host:host,hostname:hostname,port:port,state:source.history.state,key:source.history.state&&source.history.state.key||"initial"};};var createHistory=function createHistory(source,options){var listeners=[];var location=getLocation(source);var transitioning=false;var resolveTransition=function resolveTransition(){};return{get location(){return location;},get transitioning(){return transitioning;},_onTransitionComplete:function _onTransitionComplete(){transitioning=false;resolveTransition();},listen:function listen(listener){listeners.push(listener);var popstateListener=function popstateListener(){location=getLocation(source);listener({location:location,action:"POP"});};source.addEventListener("popstate",popstateListener);return function(){source.removeEventListener("popstate",popstateListener);listeners=listeners.filter(function(fn){return fn!==listener;});};},navigate:function navigate(to){var _ref=arguments.length>1&&arguments[1]!==undefined?arguments[1]:{},state=_ref.state,_ref$replace=_ref.replace,replace=_ref$replace===undefined?false:_ref$replace;if(typeof to==="number"){source.history.go(to);}else{state=_extends({},state,{key:Date.now()+""});// try...catch iOS Safari limits to 100 pushState calls
try{if(transitioning||replace){source.history.replaceState(state,null,to);}else{source.history.pushState(state,null,to);}}catch(e){source.location[replace?"replace":"assign"](to);}}location=getLocation(source);transitioning=true;var transition=new Promise(function(res){return resolveTransition=res;});listeners.forEach(function(listener){return listener({location:location,action:"PUSH"});});return transition;}};};////////////////////////////////////////////////////////////////////////////////
// Stores history entries in memory for testing or other platforms like Native
var createMemorySource=function createMemorySource(){var initialPath=arguments.length>0&&arguments[0]!==undefined?arguments[0]:"/";var searchIndex=initialPath.indexOf("?");var initialLocation={pathname:searchIndex>-1?initialPath.substr(0,searchIndex):initialPath,search:searchIndex>-1?initialPath.substr(searchIndex):""};var index=0;var stack=[initialLocation];var states=[null];return{get location(){return stack[index];},addEventListener:function addEventListener(name,fn){},removeEventListener:function removeEventListener(name,fn){},history:{get entries(){return stack;},get index(){return index;},get state(){return states[index];},pushState:function pushState(state,_,uri){var _uri$split=uri.split("?"),pathname=_uri$split[0],_uri$split$=_uri$split[1],search=_uri$split$===undefined?"":_uri$split$;index++;stack.push({pathname:pathname,search:search.length?"?"+search:search});states.push(state);},replaceState:function replaceState(state,_,uri){var _uri$split2=uri.split("?"),pathname=_uri$split2[0],_uri$split2$=_uri$split2[1],search=_uri$split2$===undefined?"":_uri$split2$;stack[index]={pathname:pathname,search:search};states[index]=state;},go:function go(to){var newIndex=index+to;if(newIndex<0||newIndex>states.length-1){return;}index=newIndex;}}};};////////////////////////////////////////////////////////////////////////////////
...
;// CONCATENATED MODULE: ../../.yarn/$$virtual/@gatsbyjs-reach-router-virtual-56d47aea2a/0/cache/@gatsbyjs-reach-router-npm-1.3.6-85044649ca-be2d5b3eba.zip/node_modules/@gatsbyjs/reach-router/es/index.js
...
var plugins=__webpack_require__(363);var _require$publicLoader=__webpack_require__(2641)/* .publicLoader */ .jN,getResourceURLsForPathname=_require$publicLoader.getResourceURLsForPathname,loadPage=_require$publicLoader.loadPage,loadPageSync=_require$publicLoader.loadPageSync;exports.h=function(api,args,defaultReturn,argTransform){if(args===void 0){args={};}// Hooks for gatsby-cypress's API handler
...
;// CONCATENATED MODULE: ../../.yarn/cache/mitt-npm-2.1.0-77f3c96db4-549fd125e9.zip/node_modules/mitt/dist/mitt.es.js
...
/* harmony import */ var _loader__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(2641);
...
// EXTERNAL MODULE: ../../.yarn/cache/@babel-runtime-npm-7.13.9-f5cea06d51-e6f79d20e1.zip/node_modules/@babel/runtime/helpers/esm/inheritsLoose.js + 1 modules
var inheritsLoose = __webpack_require__(5772);
;// CONCATENATED MODULE: ../../.yarn/cache/@babel-runtime-npm-7.13.9-f5cea06d51-e6f79d20e1.zip/node_modules/@babel/runtime/helpers/esm/arrayLikeToArray.js
...
;// CONCATENATED MODULE: ../../.yarn/cache/@babel-runtime-npm-7.13.9-f5cea06d51-e6f79d20e1.zip/node_modules/@babel/runtime/helpers/esm/arrayWithoutHoles.js

function _arrayWithoutHoles(arr) {
  if (Array.isArray(arr)) return _arrayLikeToArray(arr);
}
;// CONCATENATED MODULE: ../../.yarn/cache/@babel-runtime-npm-7.13.9-f5cea06d51-e6f79d20e1.zip/node_modules/@babel/runtime/helpers/esm/iterableToArray.js
function _iterableToArray(iter) {
  if (typeof Symbol !== "undefined" && Symbol.iterator in Object(iter)) return Array.from(iter);
}
;// CONCATENATED MODULE: ../../.yarn/cache/@babel-runtime-npm-7.13.9-f5cea06d51-e6f79d20e1.zip/node_modules/@babel/runtime/helpers/esm/unsupportedIterableToArray.js
...
;// CONCATENATED MODULE: ../../.yarn/cache/@babel-runtime-npm-7.13.9-f5cea06d51-e6f79d20e1.zip/node_modules/@babel/runtime/helpers/esm/nonIterableSpread.js
function _nonIterableSpread() {
  throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.");
}
;// CONCATENATED MODULE: ../../.yarn/cache/@babel-runtime-npm-7.13.9-f5cea06d51-e6f79d20e1.zip/node_modules/@babel/runtime/helpers/esm/toConsumableArray.js
...
"use strict";
/* harmony import */ var _babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(549);
/* harmony import */ var _babel_runtime_helpers_esm_inheritsLoose__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(5772);
...
// EXTERNAL MODULE: ../../.yarn/cache/react-npm-17.0.1-98658812fc-a76d86ec97.zip/node_modules/react/index.js
var react = __webpack_require__(7693);
// EXTERNAL MODULE: ../../.yarn/$$virtual/react-dom-virtual-398c6d9c0a/0/cache/react-dom-npm-17.0.1-588d0088ca-6a70028fbe.zip/node_modules/react-dom/index.js
var react_dom = __webpack_require__(2475);
...
var loader = __webpack_require__(2641);
...
/* harmony import */ var _babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(549);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(7693);
/* harmony import */ var _loader__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(2641);
...
0,[[1942,658,774]]]);
//# sourceMappingURL=app-852922e4f66b6e7f781f.js.map