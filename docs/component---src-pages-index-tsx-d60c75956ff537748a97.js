...
case 13:_context.next=15;return ipfsClient.add(signal);case 15:_yield$ipfsClient$add=_context.sent;path=_yield$ipfsClient$add.path;return _context.abrupt("return",{success:true});case 18:case"end":return _context.stop();}}},_callee);}));return _sendSignal.apply(this,arguments);};// export const sha256ToCID = (str) =>
...
//# sourceMappingURL=component---src-pages-index-tsx-d60c75956ff537748a97.js.map