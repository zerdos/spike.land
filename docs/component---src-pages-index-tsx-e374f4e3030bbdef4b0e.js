...
// CONCATENATED MODULE: ../code/js/workers/getWorker.js
var getWorker=function getWorker(file){var workerSrc;var forceNormalWorker=false;var pathname=window.location.pathname;if(pathname.indexOf("/ipfs/")!==-1){var cid=pathname.slice(6,52);forceNormalWorker=true;workerSrc="/ipfs/"+cid+"/js/workers/"+file;}else if(location.origin!=="https://code.zed.vision"){forceNormalWorker=true;workerSrc=window.URL.createObjectURL(new Blob(["self.importScripts(\"https://code.zed.vision/js/"+file+"\");"]));}else{workerSrc="https://code.zed.vision/js/workers/"+file;}return{workerSrc:workerSrc,forceNormalWorker:forceNormalWorker};};
...
//# sourceMappingURL=component---src-pages-index-tsx-e374f4e3030bbdef4b0e.js.map