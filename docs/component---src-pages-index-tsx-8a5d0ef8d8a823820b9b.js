 ...
 */ /**
 * @param {number} delay
 */function _fetchSignal(){_fetchSignal=Object(asyncToGenerator["a" /* default */])(/*#__PURE__*/regenerator_default.a.mark(function _callee4(signal,_retry){var retry,smallSignal,cid,resData,_yield$import2,ipfsClient,ipfsCat,res,resCID,_resData;return regenerator_default.a.wrap(function _callee4$(_context4){while(1){switch(_context4.prev=_context4.next){case 0:if(!(typeof window==="undefined")){_context4.next=2;break;}return _context4.abrupt("return");case 2:retry=typeof _retry==="number"?_retry:999;console.log("retrying hash fetch");if(!(window.location.hostname!=="code.zed.vision")){_context4.next=33;break;}console.log("we are NOT on code.zed.vision");_context4.prev=6;if(!(retry===0)){_context4.next=9;break;}throw new Error("No more retry");case 9:smallSignal=signal.slice(-8);log("signal to wait: "+smallSignal);console.log("https://zed.vision/signal?signal="+smallSignal);_context4.next=14;return fetch("https://zed.vision/signal?signal="+smallSignal+"&securityrandomparam="+Math.random()).then(function(x){return x.text();});case 14:cid=_context4.sent;console.log(cid);if(!(String(cid)==="404")){_context4.next=20;break;}_context4.next=19;return wait(Math.random()*4000);case 19:return _context4.abrupt("return",fetchSignal(signal,retry-1));case 20:log(cid+" is available");resData=fetch("https://code.zed.vision/ipfs/"+cid).then(function(x){return x();});log(cid+" downloaded - "+resData);return _context4.abrupt("return",/*#__PURE__*/Object(asyncToGenerator["a" /* default */])(/*#__PURE__*/regenerator_default.a.mark(function _callee2(){return regenerator_default.a.wrap(function _callee2$(_context2){while(1){switch(_context2.prev=_context2.next){case 0:return _context2.abrupt("return",parse(resData));case 1:case"end":return _context2.stop();}}},_callee2);})));case 26:_context4.prev=26;_context4.t0=_context4["catch"](6);_context4.next=30;return wait(Math.random()*4000);case 30:if(!(retry>1)){_context4.next=32;break;}return _context4.abrupt("return",fetchSignal(signal,retry-1));case 32:throw new Error("no signal");case 33:log("retry: "+retry);_context4.prev=34;if(!(retry===0)){_context4.next=37;break;}throw new Error("No more retry");case 37:_context4.next=39;return __webpack_require__.e(/* import() */ 4).then(__webpack_require__.bind(null, "PhsD"));case 39:_yield$import2=_context4.sent;ipfsClient=_yield$import2.ipfsClient;ipfsCat=_yield$import2.ipfsCat;_context4.next=44;return ipfsClient.add(signal,{onlyHash:true});case 44:res=_context4.sent;resCID=res.cid.toString();log("CID to wait: "+resCID);_context4.next=49;return ipfsCat(resCID,{timeout:1500});case 49:_resData=_context4.sent;log(resCID+" downloaded - "+_resData);return _context4.abrupt("return",/*#__PURE__*/Object(asyncToGenerator["a" /* default */])(/*#__PURE__*/regenerator_default.a.mark(function _callee3(){return regenerator_default.a.wrap(function _callee3$(_context3){while(1){switch(_context3.prev=_context3.next){case 0:_context3.t0=parse;_context3.next=3;return hash_getData(signal,20);case 3:_context3.t1=_context3.sent;return _context3.abrupt("return",(0,_context3.t0)(_context3.t1));case 5:case"end":return _context3.stop();}}},_callee3);})));case 54:_context4.prev=54;_context4.t1=_context4["catch"](34);if(!(retry>1)){_context4.next=58;break;}return _context4.abrupt("return",fetchSignal(signal,retry-1));case 58:throw new Error("no signal");case 59:case"end":return _context4.stop();}}},_callee4,null,[[6,26],[34,54]]);}));return _fetchSignal.apply(this,arguments);}function wait(delay){return new Promise(function(resolve){setTimeout(function(){resolve(delay);},delay);});}function hash_getData(_x5,_x6){return _getData.apply(this,arguments);}// if (retry === 0) throw new Error("Cant fetch data");
...
//# sourceMappingURL=component---src-pages-index-tsx-8a5d0ef8d8a823820b9b.js.map