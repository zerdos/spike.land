...
var Qr_spinCubeCss = function spinCubeCss(size) {
  return Object(emotion_react_browser_esm["b" /* css */])(_templateObject10(), size, size, r[1], r[2], r[0], r[1], r[0], r[0], r[2], r[0], r[1], r[2], r[1], r[0], r[0], r[1], r[2], r[0], r[2], r[1], size, size);
};
