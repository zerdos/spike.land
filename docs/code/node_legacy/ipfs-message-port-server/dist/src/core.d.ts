...
export type Time = Date | import("ipfs-message-port-protocol/src/data").LooseUnixFSTime | import("ipfs-message-port-protocol/src/data").HRTime;
...
export type FileObject = {
    ...
    content?: string | Blob | ArrayBufferView | ArrayBuffer | Iterable<ArrayBufferView | ArrayBuffer> | AsyncIterable<ArrayBufferView | ArrayBuffer> | undefined;
...
export type DecodedFileContent = string | Blob | ArrayBufferView | ArrayBuffer | Iterable<ArrayBufferView | ArrayBuffer> | AsyncIterable<ArrayBufferView | ArrayBuffer>;
...
export type AddOptions = {
    ...
    progress?: void | import("ipfs-message-port-protocol/src/core").RemoteCallback | undefined;
...
export type SingleFileInput = string | Blob | ArrayBufferView | ArrayBuffer | FileInput | import("ipfs-message-port-protocol/src/core").RemoteIterable<ArrayBufferView | ArrayBuffer>;
...
export type FileInput = {
    path?: string | undefined;
    content?: string | Blob | ArrayBufferView | ArrayBuffer | import("ipfs-message-port-protocol/src/core").RemoteIterable<ArrayBufferView> | import("ipfs-message-port-protocol/src/core").RemoteIterable<ArrayBuffer> | undefined;
    mode?: string | number | undefined;
    mtime?: Date | import("ipfs-message-port-protocol/src/data").LooseUnixFSTime | import("ipfs-message-port-protocol/src/data").HRTime | undefined;
};
export type FileContent = string | Blob | ArrayBufferView | ArrayBuffer | import("ipfs-message-port-protocol/src/core").RemoteIterable<ArrayBufferView> | import("ipfs-message-port-protocol/src/core").RemoteIterable<ArrayBuffer>;
