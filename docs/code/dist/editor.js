const importScript = (src, res = [])=>window.document.head.querySelector(`script[src="${src}"]`) || new Promise(function(resolve, reject) {
...
export const startMonaco = async ({ onChange , code , language , options  })=>{
    ...
    if (isMobile()) {
        ...
        language === "typescript" ? await importScript("https://cdnjs.cloudflare.com/ajax/libs/ace/1.4.12/mode-typescript.min.js") : await importScript("https://cdnjs.cloudflare.com/ajax/libs/ace/1.4.12/mode-html.min.js");
