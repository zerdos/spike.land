...
`,E=-1;function I({text1:n,text2:e,cursorPos:t}){if(n===e)return n?[[0,n]]:[];if(t){const o=ee(n,e,t);if(o)return o}let s=T(n,e);const i=n.substring(0,s);n=n.substring(s),e=e.substring(s),s=P(n,e);const c=n.substring(n.length-s);n=n.substring(0,n.length-s),e=e.substring(0,e.length-s);const r=X(n,e);return i&&r.unshift([0,i]),c&&r.push([0,c]),z(r),r}function X(n,e){let t;if(!n)return[[1,e]];if(!e)return[[E,n]];const s=n.length>e.length?n:e,i=n.length>e.length?e:n,c=s.indexOf(i);if(c!==-1)return t=[[1,s.substring(0,c)],[0,i],[1,s.substring(c+i.length)]],n.length>e.length&&(t[0][0]=t[2][0]=E),t;if(i.length===1)return[[E,n],[1,e]];const r=K(n,e);if(r){const o=r[0]||"",l=r[1]||"",d=r[2]||"",a=r[3]||"",u=r[4]||"",y=I({text1:o,text2:d,cursorPos:0}),g=I({text1:l,text2:a,cursorPos:0});return y.concat([[0,u[1]]],g)}return G(n,e)}function G(n,e){const t=n.length,s=e.length,i=Math.ceil((t+s)/2),c=i,r=2*i,o=new Array(r),l=new Array(r);for(let f=0;f<r;f++)o[f]=-1,l[f]=-1;o[c+1]=0,l[c+1]=0;const d=t-s,a=d%2!==0;let u=0,y=0,g=0,p=0;for(let f=0;f<i;f++){for(let m=-f+u;m<=f-y;m+=2){const h=i+m;let b;m===-f||m!==f&&o[h-1]<o[h+1]?b=o[h+1]:b=o[h-1]+1;let k=b-m;for(;b<t&&k<s&&n.charAt(b)===e.charAt(k);)b++,k++;if(o[h]=b,b>t)y+=2;else if(k>s)u+=2;else if(a){const S=i+d-m;if(S>=0&&S<r&&l[S]!==-1){const M=t-l[S];if(b>=M)return W(n,e,b,k)}}}let w;for(let m=-f+g;m<=f-p;m+=2){const h=i+m;m===-f||m!==f&&l[h-1]<l[h+1]?w=l[h+1]:w=l[h-1]+1;let b=w-m;for(;w<t&&b<s&&n.charAt(t-w-1)===e.charAt(s-b-1);)w++,b++;if(l[h]=w,w>t)p+=2;else if(b>s)g+=2;else if(!a){const k=i+d-m;if(k>=0&&k<r&&o[k]!==-1){const S=o[k],M=i+S-k;if(w=t-w,S>=w)return W(n,e,S,M)}}}}return[[E,n],[1,e]]}function W(n,e,t,s){const i=n.substring(0,t),c=e.substring(0,s),r=n.substring(t),o=e.substring(s),l=I({text1:i,text2:c,cursorPos:0}),d=I({text1:r,text2:o,cursorPos:0});return l.concat(d)}function T(n,e){if(!n||!e||n.charAt(0)!==e.charAt(0))return 0;let t=0,s=Math.min(n.length,e.length),i=s,c=0;for(;t<i;)n.substring(c,i)==e.substring(c,i)?(t=i,c=t):s=i,i=Math.floor((s-t)/2+t);return O(n.charCodeAt(i-1))&&i--,i}function P(n,e){if(!n||!e||n.slice(-1)!==e.slice(-1))return 0;let t=0,s=Math.min(n.length,e.length),i=s,c=0;for(;t<i;)n.substring(n.length-i,n.length-c)==e.substring(e.length-i,e.length-c)?(t=i,c=t):s=i,i=Math.floor((s-t)/2+t);return N(n.charCodeAt(n.length-i))&&i--,i}function K(n,e){const t=n.length>e.length?n:e,s=n.length>e.length?e:n;if(t.length<4||s.length*2<t.length)return null;function i(g,p,f){const w=g.substring(f,f+Math.floor(g.length/4));let m=-1,h="",b,k,S,M;for(;(m=p.indexOf(w,m+1))!==-1;){const L=T(g.substring(f),p.substring(m)),D=P(g.substring(0,f),p.substring(0,m));h.length<D+L&&(h=p.substring(m-D,m)+p.substring(m,m+L),b=g.substring(0,f-D),k=g.substring(f+L),S=p.substring(0,m-D),M=p.substring(m+L))}return h.length*2>=g.length?[b,k,S,M,h]:null}const c=i(t,s,Math.ceil(t.length/4)),r=i(t,s,Math.ceil(t.length/2));let o;if(r===null&&c===null)return null;if(r===null){if(c===null)return null;o=c}else if(c===null){if(r===null)return null;o=r}else o=c[4].length>r[4].length?c:r;let l,d,a,u;n.length>e.length?(l=o[0],d=o[1],a=o[2],u=o[3]):(a=o[0],u=o[1],l=o[2],d=o[3]);const y=o[4];return[l,d,a,u,y]}function z(n){const e=[...n];e.push([0,""]);let t=0,s=0,i=0,c="",r="",o,l;for(;t<e.length;){if(t<e.length-1&&!e[t][1]){e.splice(t,1);continue}switch(e[t][0]){case 1:i++,r+=e[t][1],t++;break;case E:s++,c+=e[t][1],t++;break;case 0:if(l=t-i-s-1,t<e.length-1&&!e[t][1]){e.splice(t,1);break}if(c.length>0||r.length>0){c.length>0&&r.length>0&&(o=T(r,c),o!==0&&(l>=0?e[l][1]+=r.substring(0,o):(e.splice(0,0,[0,r.substring(0,o)]),t++),r=r.substring(o),c=c.substring(o)),o=P(r,c),o!==0&&(e[t][1]=r.substring(r.length-o)+e[t][1],r=r.substring(0,r.length-o),c=c.substring(0,c.length-o)));const a=i+s;c.length===0&&r.length===0?(e.splice(t-a,a),t=t-a):c.length===0?(e.splice(t-a,a,[1,r]),t=t-a+1):r.length===0?(e.splice(t-a,a,[E,c]),t=t-a+1):(e.splice(t-a,a,[E,c],[1,r]),t=t-a+2)}t!==0&&e[t-1][0]===0?(e[t-1][1]+=e[t][1],e.splice(t,1)):t++,i=0,s=0,c="",r="";break}}e[e.length-1][1]===""&&e.pop();let d=!1;for(t=1;t<e.length-1;)e[t-1][0]===0&&e[t+1][0]===0&&(e[t][1].substring(e[t][1].length-e[t-1][1].length)===e[t-1][1]?(e[t][1]=e[t-1][1]+e[t][1].substring(0,e[t][1].length-e[t-1][1].length),e[t+1][1]=e[t-1][1]+e[t+1][1],e.splice(t-1,1),d=!0):e[t][1].substring(0,e[t+1][1].length)==e[t+1][1]&&(e[t-1][1]+=e[t+1][1],e[t][1]=e[t][1].substring(e[t+1][1].length)+e[t+1][1],e.splice(t+1,1),d=!0)),t++;return d?z(e):e}function O(n){return n>=55296&&n<=56319}function N(n){return n>=56320&&n<=57343}function Q(n){return N(n.charCodeAt(0))}function Y(n){return O(n.charCodeAt(n.length-1))}function Z(n){const e=[];for(let t=0;t<n.length;t++)n[t][1].length>0&&e.push(n[t]);return e}function x(n,e,t,s){return Y(n)||Q(s)?null:Z([[0,n],[E,e],[1,t],[0,s]])}function ee(n,e,t){const s=typeof t=="number"?{index:t,length:0}:t.oldRange,i=typeof t=="number"?null:t.newRange,c=n.length,r=e.length;if(s.length===0&&(i===null||i.length===0)){const o=s.index,l=n.slice(0,o),d=n.slice(o),a=i?i.index:null;e:{const u=o+r-c;if(a!==null&&a!==u)break e;if(u<0||u>r)break e;const y=e.slice(0,u),g=e.slice(u);if(g!==d)break e;const p=Math.min(o,u),f=l.slice(0,p),w=y.slice(0,p);if(f!==w)break e;const m=l.slice(p),h=y.slice(p);return x(f,m,h,d)}e:{if(a!==null&&a!==o)break e;const u=o,y=e.slice(0,o),g=e.slice(o);if(y!==l)break e;const p=Math.min(c-o,r-o),f=d.slice(d.length-p),w=g.slice(g.length-p);if(f!==w)break e;const m=d.slice(0,d.length-p),h=g.slice(0,g.length-p);return x(l,m,h,f)}}if(s.length>0&&i&&i.length===0){e:{const o=n.slice(0,s.index),l=n.slice(s.index+s.length),d=o.length,a=l.length;if(r<d+a)break e;const u=e.slice(0,d),y=e.slice(r-a);if(o!==u||l!==y)break e;const g=n.slice(d,c-a),p=e.slice(d,r-a);return x(o,g,p,l)}}return null}function R(n,e,t){return I({text1:n,text2:e,cursorPos:t})}R.INSERT=1,R.DELETE=E,R.EQUAL=0;const C=window.document;let U=!0,B=0,H=0,v="",_="",V="",j="";export async function run(){await J(),await F("https://unpkg.com/@babel/standalone@7.12.6/babel.min.js"),(async()=>{const s=e();j=s;const i=await $({language:"typescript",code:s,onChange:c});function c(l){if(!i)return;if(v=l,!B)o(v);else{const d=l,a=setInterval(()=>{(l!==v||!B)&&clearInterval(a),B||o(v)},100)}}async function r(){if(!i||!i.monaco)return;const l=i.monaco.Uri.parse("file:///main.tsx"),d=await i.monaco.languages.typescript.getTypeScriptWorker(),a=await(await d(l)).getSemanticDiagnostics("file:///main.tsx"),u=await(await d(l)).getCompilerOptionsDiagnostics("file:///main.tsx"),y=await(await d(l)).getSyntacticDiagnostics("file:///main.tsx");return[...a,...u,...y]}async function o(l){if(B===1)return;try{B=1;const d=await r(),a=C.getElementById("error");if(B=0,l!==v)return;if(d&&d.length){if(v!=l)return;if(_===l)return;C.getElementById("root").classList.add("transparent");const u=R(j,l,0);if(u.length<=3){i.monaco.editor.setTheme("hc-black");return}a.innerHTML=d[0].messageText.toString(),C.getElementById("root").style.setProperty("dispay","none"),a.style.display="block",_=l,i.monaco.editor.setTheme("vs-light"),setTimeout(()=>{i.monaco.editor.setTheme("hc-black")},H++);return}j=l,a.style.display="none",i.monaco.editor.setTheme("vs-dark"),C.getElementById("root").classList.remove("transparent"),H=0,B=0,n(t(l))}catch(d){if(B=0,l!==v)return;i.monaco.editor.setTheme("vs-light"),setTimeout(()=>{i.monaco.editor.setTheme("hc-black")},10),console.error(d)}}})(),n(t(e())),C.getElementById("root").setAttribute("style","display:block");async function n(s){console.log(s);const i=new Function("transpileCode",`return function(){ 
        ${s} 
    }`)();if(!U){const c=async o=>{if(o!==j)return;if(V===o)return;V=o;const l={codeTranspiled:s,code:j},d=JSON.stringify(l),a=new Request("https://code.zed.vision",{body:d,method:"POST",headers:{"content-type":"application/json;charset=UTF-8"}}),u=await fetch(a),{hash:y}=await u.json();try{const p=window.localStorage,f=p.getItem("codeBoXHash");if(f!==y){p.setItem("codeBoXHash",y),p.setItem(y,j),g("h",y);function g(w,m){const h=new URLSearchParams(window.location.search);h.set(w,m),window.history.replaceState({},"",decodeURIComponent(`${window.location.pathname}?${h}`))}}}catch(p){console.log("no localStorage")}},r=v;setTimeout(()=>c(v),500)}U=!1,i()}function e(){const s=new URLSearchParams(window.location.search),i=s.get("h")||localStorage.getItem("codeBoXHash");return i&&window.localStorage.getItem(i)||window.localStorage.getItem("STARTER")||q}function t(s){return window.Babel.transform(s,{plugins:[],presets:["react",["typescript",{isTSX:!0,allExtensions:!0}]]}).code.replace(/import/gi,"///")}}
