 ...
 * @public
 */
export declare const AnimatePresence: React.FunctionComponent<
 ...
 * @public
 */
export declare class AnimateSharedLayout
  extends React.Component<SharedLayoutProps> {
 ...
 * @internal
 */
export declare function animateVisualElement(
...
declare type AnimationOptions_2<V> =
  & (Tween | Spring)
 ...
 * @public
 */
export declare type ForwardRefComponent<T, P> = ForwardRefExoticComponent<
 ...
 * @internal
 */
export declare const FramerTreeLayoutContext: import("react").Context<
 ...
 * @public
 */
export declare type HTMLMotionProps<TagName extends keyof ReactHTML> =
 ...
 */
export declare class HTMLVisualElement<
 ...
 * @public
 */
export declare type KeyframesTarget = ResolvedKeyframesTarget | [
  null,
  ...CustomValueType[],
] | CustomValueType[];
...
declare type LayoutUpdateHandler = (
  layout: AxisBox2D,
  prev: AxisBox2D,
...
export declare const m:
  & import("./types").HTMLMotionComponents
...
export declare function MotionConfig(
  { children, features, ...props }: MotionConfigProps,
): JSX.Element;
 ...
 * @public
 */
export declare interface MotionProps
  extends
    AnimationProps,
    MotionCallbacks,
    GestureHandlers,
 ...
 * @public
 */
export declare type MotionStyle =
  & MotionCSS
  & MotionTransform
...
declare type RenderComponent<P = {}> = (
  Component: string | React.ComponentType<P>,
  props: MotionProps,
  visualElement: VisualElement,
) => any;
 ...
 * @public
 */
export declare type ResolvedKeyframesTarget = [null, ...number[]] | number[] | [
  null,
  ...string[],
] | string[];
...
export declare const SharedLayoutContext: import("react").Context<
  SyncLayoutBatcher | SharedLayoutSyncMethods
>;
 ...
 * @public
 */
export declare type SVGAttributesAsMotionValues<T> = MakeMotion<
  SVGAttributesWithoutMotionProps<T>
>;

declare interface SVGAttributesWithoutMotionProps<T>
  extends
 ...
 * @public
 */
export declare interface SVGMotionProps<T>
...
declare type UnwrapSVGFactoryElement<F> = F extends React_2.SVGProps<infer P>
  ? P
  : never;
 ...
 * @deprecated
 */
export declare function useDeprecatedInvertedScale(
 ...
 * @internal
 */
export declare function useExternalRef<E = Element>(
  externalRef?: Ref<E>,
): RefObject<E>;
 ...
 * @public
 */
export declare function useGestures<GestureHandlers>(
 ...
 */
declare type UseVisualElement<E, P = MotionProps> = (
  Component: string | React_2.ComponentType<P>,
  props: MotionProps & P,
  isStatic?: boolean,
  ref?: Ref<E>,
) => VisualElement;
