...
/******/ 	return __webpack_require__(__webpack_require__.s = "./node_modules/workerize-loader/dist/rpc-worker-loader.js!./node_modules/gatsby/dist/utils/babel-loader.js?!./src/components/utils/renderer/renderer.worker.ts");
/******/ })
/************************************************************************/
/******/ ({
...
/*!******************************************************************************************************************************************************************************!*\
  !*** ./node_modules/workerize-loader/dist/rpc-worker-loader.js!./node_modules/gatsby/dist/utils/babel-loader.js??ref--19!./src/components/utils/renderer/renderer.worker.ts ***!
  \******************************************************************************************************************************************************************************/
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "renderWorker", function() { return renderWorker; });
...
self.importScripts("https://cdn.jsdelivr.net/npm/@ampproject/worker-dom@0.27.4/dist/worker/worker.js");


async function renderWorker(code, props) {
  try {
    const componentFactory = new Function("props", "React", `${code}; return Counter(props)`);

    const Counter = props => componentFactory(props, react__WEBPACK_IMPORTED_MODULE_0__);

    return react_dom_server__WEBPACK_IMPORTED_MODULE_1___default.a.renderToString( /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["createElement"](Counter, props));
  } catch (error) {
    return {
      error
    };
