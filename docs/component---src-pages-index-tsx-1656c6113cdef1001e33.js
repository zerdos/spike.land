...
// console.log(cid);
return cid;};var hash=/*#__PURE__*/ /**p
* @param {string} data
* @param {{
* signal: AbortSignal
* timeout: number
* onlyHash: boolean
* }} [options]
*/function(){var _ref=Object(asyncToGenerator["a" /* default */])(/*#__PURE__*/regenerator_default.a.mark(function _callee(data,options){var opts,onlyHash,signal,timeout,cid,res;return regenerator_default.a.wrap(function _callee$(_context){while(1){switch(_context.prev=_context.next){case 0:opts=options||{onlyHash:true,signal:null,timeout:1500};onlyHash=opts.onlyHash,signal=opts.signal,timeout=opts.timeout;// deno-lint-ignore ban-ts-comment
// @ts-ignore
_context.next=4;return ipfs.add(""+data,{onlyHash:onlyHash}).then(function(d){return d.cid.toString();});case 4:cid=_context.sent;if(onlyHash){_context.next=9;break;}_context.next=8;return feedTheCache(cid);case 8:return _context.abrupt("return",cid);case 9:_context.prev=9;_context.next=12;return getHash(cid,{signal:signal,timeout:timeout,onlyHash:onlyHash}).then(function(x){return{success:x===data};});case 12:res=_context.sent;return _context.abrupt("return",res);case 16:_context.prev=16;_context.t0=_context["catch"](9);return _context.abrupt("return",{success:false});case 19:case"end":return _context.stop();}}},_callee,null,[[9,16]]);}));return function hash(_x2,_x3){return _ref.apply(this,arguments);};}();/**
 * @type {
  * [string]
  * }
  */var cidCache={};/**
 ...
 * [string]
 * }
 */var cidLock={semaphore:0};/**
 * @param {string | number} cid
 * @param {{signal: AbortSignal; timeout: number}}  options
 */var getHash=/*#__PURE__*/function(){var _ref3=Object(asyncToGenerator["a" /* default */])(/*#__PURE__*/regenerator_default.a.mark(function _callee2(cid,_ref2){var signal,timeout,e_1,_a,_yield$import,ipfsClient,aborted,data,resultUintArr,data_1,data_1_1,res,result;return regenerator_default.a.wrap(function _callee2$(_context2){while(1){switch(_context2.prev=_context2.next){case 0:signal=_ref2.signal,timeout=_ref2.timeout;_context2.next=3;return __webpack_require__("Ykow")(ipfs);case 3:_yield$import=_context2.sent;ipfsClient=_yield$import.ipfsClient;if(!cidCache[cid]){_context2.next=7;break;}return _context2.abrupt("return",cidCache[cid]);case 7:signal.onabort=function(){aborted=1;};aborted=0;_context2.prev=9;if(!aborted){_context2.next=12;break;}return _context2.abrupt("return","");case 12:if(!(typeof cidCache[cid]!=="undefined"&&cidCache[cid]!=="")){_context2.next=14;break;}return _context2.abrupt("return",cidCache[cid]);case 14:if(!(cidLock.semaphore>128)){_context2.next=19;break;}_context2.next=17;return wait(Math.random()*100);case 17:_context2.next=14;break;case 19:cidLock.semaphore++;_context2.next=22;return ipfsClient.cat(cid,{timeout:timeout||300});case 22:data=_context2.sent;if(!cidCache[cid]){_context2.next=25;break;}return _context2.abrupt("return",cidCache[cid]);case 25:/** @type {number[]} */resultUintArr=[];_context2.prev=26;data_1=__asyncValues(data);case 28:_context2.next=30;return data_1.next();case 30:data_1_1=_context2.sent;if(data_1_1.done){_context2.next=36;break;}res=data_1_1.value;resultUintArr.concat(res);case 34:_context2.next=28;break;case 36:_context2.next=41;break;case 38:_context2.prev=38;_context2.t0=_context2["catch"](26);e_1={error:_context2.t0};case 41:_context2.prev=41;_context2.prev=42;if(!(data_1_1&&!data_1_1.done&&(_a=data_1.return))){_context2.next=46;break;}_context2.next=46;return _a.call(data_1);case 46:_context2.prev=46;if(!e_1){_context2.next=49;break;}throw e_1.error;case 49:return _context2.finish(46);case 50:return _context2.finish(41);case 51:result=new TextDecoder().decode(new Uint8Array(resultUintArr));cidCache[cid]=result;cidLock.semaphore--;return _context2.abrupt("return",result);case 57:_context2.prev=57;_context2.t1=_context2["catch"](9);cidLock.semaphore--;cidLock[cid]=null;case 61:case"end":return _context2.stop();}}},_callee2,null,[[9,57],[26,38,41,51],[42,,46,50]]);}));return function getHash(_x4,_x5){return _ref3.apply(this,arguments);};}();/**
...
.then(function(x){return typeof x==="string"||x&&x.success?{success:true}:{success:false};}).catch(function(){return{success:false};}));case 1:case"end":return _context3.stop();}}},_callee3);}));return function _waitForSignal(_x6,_x7){return _ref4.apply(this,arguments);};}();/**
 * @param {string} signal
 * @param {string} data
 */var sendSignal=/*#__PURE__*/function(){var _ref5=Object(asyncToGenerator["a" /* default */])(/*#__PURE__*/regenerator_default.a.mark(function _callee4(signal,data){var _yield$import2,CID,toSave,dataCid,hexHash,allHash;return regenerator_default.a.wrap(function _callee4$(_context4){while(1){switch(_context4.prev=_context4.next){case 0:if(!(typeof window==="undefined")){_context4.next=2;break;}return _context4.abrupt("return","no webpack please");case 2:_context4.next=4;return hash(signal);case 4:_context4.next=6;return __webpack_require__("Ykow")(ipfs);case 6:_yield$import2=_context4.sent;CID=_yield$import2.CID;if(!data){_context4.next=20;break;}// @ts-ignore
toSave=data;if(typeof data!=="string")toSave=JSON.stringify(data);//@ts-ignore
_context4.next=13;return hash(data);case 13:dataCid=_context4.sent;hexHash=Array.from(new CID(dataCid).multihash).map(function(b){return("00"+b.toString(16)).slice(-2);}).join("");allHash=new Array(hexHash.length).fill(signal).map(function(x,i){return x+new Array(i).fill("x").join("")+hexHash.slice(i,i+1);});_context4.next=18;return Promise.all(allHash.slice(0,5).map(function(x){return hash(x);}));case 18:_context4.next=20;return Promise.all(allHash.slice(5).map(function(x){return hash(x);}));case 20:return _context4.abrupt("return",{success:true});case 21:case"end":return _context4.stop();}}},_callee4);}));return function sendSignal(_x8,_x9){return _ref5.apply(this,arguments);};}();var signalDataCache={};// @ts-ignore
var fetchSignal=/*#__PURE__*/ /**
* @param {string} signal
* @param {number} _retry
* @returns ()=>any
*/ // @ts-ignore
function(){var _ref6=Object(asyncToGenerator["a" /* default */])(/*#__PURE__*/regenerator_default.a.mark(function _callee7(signal,_retry){var retry,abort,isSignalReceived,res,getData;return regenerator_default.a.wrap(function _callee7$(_context7){while(1){switch(_context7.prev=_context7.next){case 0:if(!(typeof window==="undefined")){_context7.next=2;break;}return _context7.abrupt("return","no webpack please");case 2:retry=typeof _retry==="number"?_retry:999;abort=new AbortController();isSignalReceived=null;_context7.prev=5;if(!(retry===0)){_context7.next=8;break;}throw new Error("No more retry");case 8:_context7.next=10;return _waitForSignal(signal,abort.signal);case 10:res=_context7.sent;if(res.success){_context7.next=13;break;}return _context7.abrupt("return",fetchSignal(signal,retry-1));case 13:isSignalReceived=true;// console.log(`Signal received!`, { res });
getData=/*#__PURE__*/ /**
     *
     * @param {number} retry
     * @returns *
     */ // @ts-ignore
function(){var _ref7=Object(asyncToGenerator["a" /* default */])(/*#__PURE__*/regenerator_default.a.mark(function _callee6(retry){var _yield$import3,CID,run;return regenerator_default.a.wrap(function _callee6$(_context6){while(1){switch(_context6.prev=_context6.next){case 0:if(retry===void 0){retry=20;}if(!signalDataCache[signal]){_context6.next=3;break;}return _context6.abrupt("return",signalDataCache[signal]);case 3:_context6.next=5;return __webpack_require__("Ykow")(ipfs);case 5:_yield$import3=_context6.sent;CID=_yield$import3.CID;if(!(retry===0)){_context6.next=9;break;}return _context6.abrupt("return","");case 9:/**
       * @param {number} delay
       */ // @ts-ignore
run=/*#__PURE__*/function(){var _ref8=Object(asyncToGenerator["a" /* default */])(/*#__PURE__*/regenerator_default.a.mark(function _callee5(delay){var hashArr,restRes,hashHex,cid,data,parse,ret;return regenerator_default.a.wrap(function _callee5$(_context5){while(1){switch(_context5.prev=_context5.next){case 0:if(!signalDataCache[signal]){_context5.next=2;break;}return _context5.abrupt("return",signalDataCache[signal]);case 2:console.log("delay: "+delay);_context5.prev=3;hashArr=new Array(68).fill(0).map(function(_x,i){return i;});restRes=hashArr.map(function(i){return getCharAt(signal,i);});_context5.next=8;return Promise.all(restRes);case 8:hashHex=_context5.sent.join("");if(!signalDataCache[signal]){_context5.next=11;break;}return _context5.abrupt("return",signalDataCache[signal]);case 11:cid=new CID(0,112,fromHexString(hashHex));_context5.next=14;return getHash(cid.toString(),// @ts-ignore
{signal:abort.signal,timeout:1500});case 14:data=_context5.sent;if(!signalDataCache[signal]){_context5.next=17;break;}return _context5.abrupt("return",signalDataCache[signal]);case 17:/**
               * @param {string | any[] | { success: boolean; } | undefined} d
               */parse=function parse(d){try{if(typeof d!=="string")return d;var _ret=JSON.parse(d);return _ret;}catch(e){return d;}};ret=parse(data);if(ret){_context5.next=21;break;}throw new Error("No data");case 21:// console.log(
//   `got the result and putting it to cache, the delay was: ${delay}`,
//   { ret },
// );
//@ts-ignore
signalDataCache[signal]=ret;return _context5.abrupt("return",ret);case 25:_context5.prev=25;_context5.t0=_context5["catch"](3);return _context5.abrupt("return",getData(retry-1));case 28:case"end":return _context5.stop();}}},_callee5,null,[[3,25]]);}));return function run(_x13){return _ref8.apply(this,arguments);};}();return _context6.abrupt("return",run(0));case 11:case"end":return _context6.stop();}}},_callee6);}));return function getData(_x12){return _ref7.apply(this,arguments);};}();return _context7.abrupt("return",getData);case 18:_context7.prev=18;_context7.t0=_context7["catch"](5);isSignalReceived=false;throw new Error("no signal");case 22:case"end":return _context7.stop();}}},_callee7,null,[[5,18]]);}));return function fetchSignal(_x10,_x11){return _ref6.apply(this,arguments);};}();var signalCache={};var getCharAt=/*#__PURE__*/ /**
* @param {string} signal
* @param {number} i
...
//@ts-ignore
signalCache[signal][i]=nextChar;controller.abort();return _context8.abrupt("return",nextChar);case 19:case"end":return _context8.stop();}}},_callee8);}));return function getCharAt(_x14,_x15){return _ref9.apply(this,arguments);};}();/**
 * @param {any[]} promises
...
* @param {string} byte
*/ //@ts-ignore
hexString.match(/.{1,2}/g).map(function(byte){return parseInt(byte,16);}));};// @ts-ignore
...
webpackEmptyAsyncContext.id = "Ykow";

/***/ })

}]);
//# sourceMappingURL=component---src-pages-index-tsx-1656c6113cdef1001e33.js.map