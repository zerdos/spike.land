 ...
 *
 * @param {string} cid
 */var feedTheCache=function feedTheCache(cid){// console.log(cid);
 ...
 * @param {string} signal
 * @param {string} data
 */var sendSignal=/*#__PURE__*/function(){var _ref3=Object(asyncToGenerator["a" /* default */])(/*#__PURE__*/regenerator_default.a.mark(function _callee3(signal,data){var CID,dataCid,hexHash;return regenerator_default.a.wrap(function _callee3$(_context3){while(1){switch(_context3.prev=_context3.next){case 0:if(!data){_context3.next=10;break;}_context3.next=3;return __webpack_require__.e(/* import() */ 5).then(__webpack_require__.bind(null, "60a2"));case 3:CID=_context3.sent.default;_context3.next=6;return hash(data,false);case 6:dataCid=_context3.sent;hexHash=Array.from(new CID(dataCid).multihash).map(function(b){return("00"+b.toString(16)).slice(-2);}).join("");_context3.next=10;return Promise.all(new Array(hexHash.length).fill(signal).map(function(x,i){return x+hexHash.slice(0,i+1);}).map(function(x){return hash(x,false);}));case 10:_context3.next=12;return hash(signal,false);case 12:return _context3.abrupt("return",{success:true});case 13:case"end":return _context3.stop();}}},_callee3);}));return function sendSignal(_x5,_x6){return _ref3.apply(this,arguments);};}();/**
 * @param {string} url
