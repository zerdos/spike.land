...
//@ts-ignore
var ipfs;var getIpfs=/*#__PURE__*/function(){var _ref=Object(asyncToGenerator["a" /* default */])(/*#__PURE__*/regenerator_default.a.mark(function _callee(){var _yield$importScript,IpfsMessagePortClient,workerSrc,_ipfsWorker,ipfsWorker,_MessageChannel,port1,port2,msg;return regenerator_default.a.wrap(function _callee$(_context){while(1){switch(_context.prev=_context.next){case 0:if(!ipfs){_context.next=2;break;}return _context.abrupt("return",ipfs);case 2:_context.next=4;return importScript("https://unpkg.com/ipfs-message-port-client@0.4.3/dist/index.min.js");case 4:_yield$importScript=_context.sent;IpfsMessagePortClient=_yield$importScript.IpfsMessagePortClient;workerSrc=window.location.hostname==="blog.zed.vision"?"https://blog.zed.vision/code/src/ipfsWorker.js":window.location.hostname==="[::1]"?location.href+"src/ipfsWorker.js":location.origin+"/src/ipfsWorker.js";if(!(typeof SharedWorker!=="undefined")){_context.next=12;break;}_ipfsWorker=new SharedWorker(workerSrc);//@ts-ignore
window.ipfsWorker=_ipfsWorker;ipfs=IpfsMessagePortClient.from(_ipfsWorker.port);return _context.abrupt("return",ipfs);case 12:ipfsWorker=new Worker(workerSrc);//@ts-ignore
window.ipfsWorker=ipfsWorker;_MessageChannel=new MessageChannel(),port1=_MessageChannel.port1,port2=_MessageChannel.port2;msg={clientInit:true,port:port1};ipfsWorker.postMessage(msg,[port1]);ipfs=IpfsMessagePortClient.from(port2);return _context.abrupt("return",ipfs);case 19:case"end":return _context.stop();}}},_callee);}));return function getIpfs(){return _ref.apply(this,arguments);};}();

/***/ })

}]);
//# sourceMappingURL=16-e40036aca14beb4c2b0e.js.map