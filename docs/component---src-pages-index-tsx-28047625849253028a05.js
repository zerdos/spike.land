...
// EXTERNAL MODULE: ./node_modules/@emotion/react/dist/emotion-react.browser.esm.js + 12 modules
      ...
      return regenerator_default.a.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return __webpack_require__.e(/* import() */ 5).then(__webpack_require__.bind(null, "lRBY"));
...
// CONCATENATED MODULE: ./node_modules/@zedvision/code/src/hash.js




var log = function log(msg) {
  if (typeof mgs === "string") console.log(msg);else if (typeof msg === "object") console.table({
    msg: msg
...
var sendSignal = /*#__PURE__*/function () {
  var _ref = Object(asyncToGenerator["a" /* default */])( /*#__PURE__*/regenerator_default.a.mark(function _callee(signal, data) {
    var _yield$import, ipfsClient, toSave, dataCid, _URL, pathname, _yield$ipfsClient$add, path;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return _context.abrupt("return", "no webpack please");

          case 2:
            _context.next = 4;
            return __webpack_require__.e(/* import() */ 4).then(__webpack_require__.bind(null, "/x44"));

          case 4:
            _yield$import = _context.sent;
            ipfsClient = _yield$import.ipfsClient;
            log("sending signal: ".concat(signal));
            ...
            log(toSave);
            _context.next = 14;
            return ipfsClient.add(toSave);

          case 14:
            dataCid = _context.sent.cid.toString();
            _URL = new URL(signal), pathname = _URL.pathname;
            _context.next = 18;
            return fetch("https://zed.vision/signal/?cid=".concat(dataCid, "&signal=").concat(pathname.slice(1)));

          case 18:
            fetch("https://zed.vision/ipfs/".concat(dataCid)); // const hexHash = Array.from((new CID(dataCid)).multihash).map((b) =>
          ...
          case 19:
            _context.next = 21;
            return ipfsClient.add(signal);

          case 21:
            _yield$ipfsClient$add = _context.sent;
            path = _yield$ipfsClient$add.path;
  ...
  return function sendSignal(_x, _x2) {
...
function _fetchSignal() {
  _fetchSignal = Object(asyncToGenerator["a" /* default */])( /*#__PURE__*/regenerator_default.a.mark(function _callee4(signal, _retry) {
    var retry, smallSignal, cid, resData, _yield$import2, ipfsClient, ipfsCat, res, resCID, _resData;
    ...
    return regenerator_default.a.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 2:
            retry = typeof _retry === "number" ? _retry : 999; // console.log("retrying hash fetch");
          ...
          case 7:
            smallSignal = signal.slice(-8); ////    log(`signal to wait: ${smallSignal}`);
            // console.log(`https://zed.vision/signal?signal=${smallSignal}`);

            _context4.next = 10;
            return fetch("https://zed.vision/signal?signal=".concat(smallSignal, "&securityrandomparam=").concat(Math.random() * 10000)).then(function (x) {
              return x.text();
            });
          ...
          case 15:
            return _context4.abrupt("return", fetchSignal(signal, retry - 1));

          case 16:
            _context4.next = 18;
            return fetch("https://code.zed.vision/ipfs/".concat(cid)).then(function (x) {
              return x.text();
            });

          case 18:
            resData = _context4.sent;
            return _context4.abrupt("return", /*#__PURE__*/Object(asyncToGenerator["a" /* default */])( /*#__PURE__*/regenerator_default.a.mark(function _callee2() {
              return regenerator_default.a.wrap(function _callee2$(_context2) {
                while (1) {
                  switch (_context2.prev = _context2.next) {
                    case 0:
                      return _context2.abrupt("return", parse(resData));
          ...
          case 34:
            ...
            ipfsClient = _yield$import2.ipfsClient;
            ipfsCat = _yield$import2.ipfsCat;
            _context4.next = 39;
            return ipfsClient.add(signal, {
              onlyHash: true
            });
          ...
          case 39:
            res = _context4.sent;
            resCID = res.cid.toString(); //  log(`CID to wait: ${resCID}`);
            //

            _context4.next = 43;
            return ipfsCat(resCID, {
              timeout: 1500
            });

          case 43:
            _resData = _context4.sent;
            return _context4.abrupt("return", /*#__PURE__*/Object(asyncToGenerator["a" /* default */])( /*#__PURE__*/regenerator_default.a.mark(function _callee3() {
              return regenerator_default.a.wrap(function _callee3$(_context3) {
                while (1) {
                  switch (_context3.prev = _context3.next) {
                    case 0:
...
function _getData() {
  _getData = Object(asyncToGenerator["a" /* default */])( /*#__PURE__*/regenerator_default.a.mark(function _callee5(signal, retry) {
    var _URL2, pathname, signalPath, res, cid, data, content;

    return regenerator_default.a.wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            _URL2 = new URL(signal), pathname = _URL2.pathname;
            signalPath = pathname.slice(1);
            _context5.next = 4;
            return fetch("https://zed.vision/signal?signal=".concat(signalPath));
          ...
          case 7:
            cid = _context5.sent;
            _context5.next = 10;
            return fetch("https://code.zed.vision/ipfs/".concat(cid));
...
function parse(d) {
  try {
    ...
    var ret = JSON.parse(d); //   console.log({ ret });
...
// CONCATENATED MODULE: ./node_modules/@zedvision/qrious/dist/qrious.esm.js
...
//# sourceMappingURL=component---src-pages-index-tsx-28047625849253028a05.js.map