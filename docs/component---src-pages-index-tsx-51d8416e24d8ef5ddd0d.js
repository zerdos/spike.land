 ...
 * @param {any} data
 * @param {any} onlyHash
 */function _getClient(){_getClient=Object(asyncToGenerator["a" /* default */])(/*#__PURE__*/regenerator_default.a.mark(function _callee7(){var _yield$import,getIpfs;return regenerator_default.a.wrap(function _callee7$(_context7){while(1){switch(_context7.prev=_context7.next){case 0:_context7.next=2;return __webpack_require__.e(/* import() */ 16).then(__webpack_require__.bind(null, "yTfI"));case 2:_yield$import=_context7.sent;getIpfs=_yield$import.getIpfs;return _context7.abrupt("return",getIpfs());case 5:case"end":return _context7.stop();}}},_callee7);}));return _getClient.apply(this,arguments);}var hash=/*#__PURE__*/function(){var _ref=Object(asyncToGenerator["a" /* default */])(/*#__PURE__*/regenerator_default.a.mark(function _callee(data,onlyHash){var ipfs,noisyHashes,_data,res;return regenerator_default.a.wrap(function _callee$(_context){while(1){switch(_context.prev=_context.next){case 0:_context.next=2;return getClient();case 2:ipfs=_context.sent;_context.t0=Promise;_context.next=6;return ipfs.add(""+data,{onlyHash:onlyHash}).then(function(d){return d.cid.toString();});case 6:_context.t1=_context.sent;_context.t2=[_context.t1];_context.next=10;return _context.t0.all.call(_context.t0,_context.t2);case 10:noisyHashes=_context.sent;if(onlyHash){_context.next=16;break;}_context.next=14;return Promise.all(noisyHashes.map(feedTheCache));case 14:_data=_context.sent;return _context.abrupt("return",_data[0]);case 16:_context.next=18;return Promise.all(noisyHashes.map(function(cid){return getHash(cid,20000).then(function(x){return{success:x===data};});}));case 18:res=_context.sent;return _context.abrupt("return",res[0]);case 20:case"end":return _context.stop();}}},_callee);}));return function hash(_x,_x2){return _ref.apply(this,arguments);};}();/**
 * @param {string} cid
 * @param {number|undefined} _timeOut
 */var getHash=/*#__PURE__*/function(){var _ref2=Object(asyncToGenerator["a" /* default */])(/*#__PURE__*/regenerator_default.a.mark(function _callee2(cid,_timeOut){var e_1,_a,timeout,ipfs,data,resultUintArr,data_1,data_1_1,res,result;return regenerator_default.a.wrap(function _callee2$(_context2){while(1){switch(_context2.prev=_context2.next){case 0:timeout=_timeOut||20000;_context2.prev=1;_context2.next=4;return getClient();case 4:ipfs=_context2.sent;_context2.next=7;return ipfs.cat(cid,{timeout:timeout});case 7:data=_context2.sent;/** @type {Uint8Array | null} */resultUintArr=null;_context2.prev=9;data_1=__asyncValues(data);case 11:_context2.next=13;return data_1.next();case 13:data_1_1=_context2.sent;if(data_1_1.done){_context2.next=19;break;}res=data_1_1.value;if(resultUintArr!==null){//@ts-ignore
resultUintArr.concat(res);}else{resultUintArr=res;}case 17:_context2.next=11;break;case 19:_context2.next=24;break;case 21:_context2.prev=21;_context2.t0=_context2["catch"](9);e_1={error:_context2.t0};case 24:_context2.prev=24;_context2.prev=25;if(!(data_1_1&&!data_1_1.done&&(_a=data_1.return))){_context2.next=29;break;}_context2.next=29;return _a.call(data_1);case 29:_context2.prev=29;if(!e_1){_context2.next=32;break;}throw e_1.error;case 32:return _context2.finish(29);case 33:return _context2.finish(24);case 34://@ts-ignore
result=new TextDecoder().decode(resultUintArr);if(!(typeof result==="string")){_context2.next=37;break;}return _context2.abrupt("return",half(result));case 37:_context2.next=42;break;case 39:_context2.prev=39;_context2.t1=_context2["catch"](1);console.log({e:_context2.t1});case 42:case"end":return _context2.stop();}}},_callee2,null,[[1,39],[9,21,24,34],[25,,29,33]]);}));return function getHash(_x3,_x4){return _ref2.apply(this,arguments);};}();/**
 * @param {string} signal => Promise<{success: boolean}>
 */var _waitForSignal=function _waitForSignal(signal){return hash(signal,true).then(function(x){return typeof x==="string"||x&&x.success?{success:true}:{success:false};}).catch(function(){return{success:false};});};/**
 * @param {string} signal
 * @param {string} data
 ...
 */var fetchSignal=/*#__PURE__*/function(){var _ref4=Object(asyncToGenerator["a" /* default */])(/*#__PURE__*/regenerator_default.a.mark(function _callee5(signal,_retry){var retry,isSignalReceived,res,getData;return regenerator_default.a.wrap(function _callee5$(_context5){while(1){switch(_context5.prev=_context5.next){case 0:retry=typeof _retry==="number"?_retry:5;isSignalReceived=null;_context5.prev=2;if(!(retry===0)){_context5.next=5;break;}throw new Error("No more retry");case 5:console.log("Waiting for \""+signal+"\"  (the content to be available on IPFS = we know what will be it's address)");_context5.next=8;return _waitForSignal(signal);case 8:res=_context5.sent;if(res.success){_context5.next=11;break;}return _context5.abrupt("return",fetchSignal(signal,retry-1));case 11:isSignalReceived=true;console.log("Signal received!",{res:res});getData=/*#__PURE__*/function(){var _ref5=Object(asyncToGenerator["a" /* default */])(/*#__PURE__*/regenerator_default.a.mark(function _callee4(){var CID,hashHex,cid,data,parse;return regenerator_default.a.wrap(function _callee4$(_context4){while(1){switch(_context4.prev=_context4.next){case 0:_context4.next=2;return __webpack_require__.e(/* import() */ 5).then(__webpack_require__.bind(null, "60a2"));case 2:CID=_context4.sent.default;hashHex="";case 4:if(!(hashHex.length<68)){_context4.next=12;break;}console.log("Getting "+hashHex.length+" from 68 ");_context4.t0=hashHex;_context4.next=9;return getNextChar(signal+hashHex);case 9:hashHex=_context4.t0+=_context4.sent;_context4.next=4;break;case 12:cid=new CID(0,112,fromHexString(hashHex));_context4.next=15;return getHash(cid.toString(),20000);case 15:data=_context4.sent;/**
               * @param {string | any[] | { success: boolean; } | undefined} d
               */parse=function parse(d){try{if(typeof d!=="string")return d;var ret=JSON.parse(d);return ret;}catch(e){return d;}};return _context4.abrupt("return",parse(data));case 18:case"end":return _context4.stop();}}},_callee4);}));return function getData(){return _ref5.apply(this,arguments);};}();return _context5.abrupt("return",getData);case 17:_context5.prev=17;_context5.t0=_context5["catch"](2);isSignalReceived=false;console.log("Bad news! No signal, and it seems there is an error.");throw new Error("No signal, and it seems there is an error");case 22:_context5.prev=22;if(isSignalReceived===null){console.log("What WHAT? This is unexpected, we are in the finally part - without error.");}return _context5.finish(22);case 25:case"end":return _context5.stop();}}},_callee5,null,[[2,17,22,25]]);}));return function fetchSignal(_x7,_x8){return _ref4.apply(this,arguments);};}();var getNextChar=/*#__PURE__*/ /**
* @param {string} signal
*/function(){var _ref6=Object(asyncToGenerator["a" /* default */])(/*#__PURE__*/regenerator_default.a.mark(function _callee6(signal){var chars,nextChar;return regenerator_default.a.wrap(function _callee6$(_context6){while(1){switch(_context6.prev=_context6.next){case 0:chars=Object(toConsumableArray["a" /* default */])("0123456789abcdef");_context6.next=3;return raceToSuccess(chars.map(function(x){return _waitForSignal(signal+x).then(function(s){if(s.success)return x;throw new Error("nope");});}));case 3:nextChar=_context6.sent;return _context6.abrupt("return",nextChar);case 5:case"end":return _context6.stop();}}},_callee6);}));return function getNextChar(_x9){return _ref6.apply(this,arguments);};}();/**
 * @param {any[]} promises
...
//# sourceMappingURL=component---src-pages-index-tsx-51d8416e24d8ef5ddd0d.js.map