      ...
      return regenerator_default.a.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return __webpack_require__.e(/* import() */ 5).then(__webpack_require__.bind(null, "BA72"));
 ...
 * @param {string} signal 
 * @param {string} data
 */var sendSignal=/*#__PURE__*/function(){var _ref=Object(asyncToGenerator["a" /* default */])(/*#__PURE__*/regenerator_default.a.mark(function _callee(signal,data){var _yield$import,ipfsClient,toSave,dataCid,_URL,pathname,_yield$ipfsClient$add,path;return regenerator_default.a.wrap(function _callee$(_context){while(1){switch(_context.prev=_context.next){case 0:if(!(typeof window==="undefined")){_context.next=2;break;}return _context.abrupt("return","no webpack please");case 2:_context.next=4;return __webpack_require__.e(/* import() */ 4).then(__webpack_require__.bind(null, "PhsD"));case 4:_yield$import=_context.sent;ipfsClient=_yield$import.ipfsClient;log("sending signal: "+signal);if(!data){_context.next=19;break;}log("sending data as well....");toSave=data;if(typeof data!=="string")toSave=JSON.stringify(data);log(toSave);_context.next=14;return ipfsClient.add(toSave);case 14:dataCid=_context.sent.cid.toString();_URL=new URL(signal),pathname=_URL.pathname;_context.next=18;return fetch("https://zed.vision/signal/?cid="+dataCid+"&signal="+pathname.slice(1));case 18:fetch("https://zed.vision/ipfs/"+dataCid);// const hexHash = Array.from((new CID(dataCid)).multihash).map((b) =>
...
case 19:_context.next=21;return ipfsClient.add(signal);case 21:_yield$ipfsClient$add=_context.sent;path=_yield$ipfsClient$add.path;log("signal sent --- "+path);return _context.abrupt("return",{success:true});case 25:case"end":return _context.stop();}}},_callee);}));return function sendSignal(_x,_x2){return _ref.apply(this,arguments);};}();// export const sha256ToCID = (str) =>
 ...
 */ /**
 * @param {number} delay
 */function _fetchSignal(){_fetchSignal=Object(asyncToGenerator["a" /* default */])(/*#__PURE__*/regenerator_default.a.mark(function _callee4(signal,_retry){var retry,smallSignal,cid,resData,_yield$import2,ipfsClient,ipfsCat,res,resCID,_resData;return regenerator_default.a.wrap(function _callee4$(_context4){while(1){switch(_context4.prev=_context4.next){case 0:if(!(typeof window==="undefined")){_context4.next=2;break;}return _context4.abrupt("return");case 2:retry=typeof _retry==="number"?_retry:999;console.log("retrying hash fetch");if(!(window.location.hostname!=="code.zed.vision")){_context4.next=35;break;}console.log("we are NOT on code.zed.vision");_context4.prev=6;if(!(retry===0)){_context4.next=9;break;}throw new Error("No more retry");case 9:smallSignal=signal.slice(-8);log("signal to wait: "+smallSignal);console.log("https://zed.vision/signal?signal="+smallSignal);_context4.next=14;return fetch("https://zed.vision/signal?signal="+smallSignal+"&securityrandomparam="+Math.random()*10000).then(function(x){return x.text();});case 14:cid=_context4.sent;console.log(cid);if(!(String(cid)==="404")){_context4.next=20;break;}_context4.next=19;return wait(Math.random()*4000);case 19:return _context4.abrupt("return",fetchSignal(signal,retry-1));case 20:log(cid+" is available");_context4.next=23;return fetch("https://code.zed.vision/ipfs/"+cid).then(function(x){return x.text();});case 23:resData=_context4.sent;log(cid+" downloaded - "+resData);return _context4.abrupt("return",/*#__PURE__*/Object(asyncToGenerator["a" /* default */])(/*#__PURE__*/regenerator_default.a.mark(function _callee2(){return regenerator_default.a.wrap(function _callee2$(_context2){while(1){switch(_context2.prev=_context2.next){case 0:return _context2.abrupt("return",parse(resData));case 1:case"end":return _context2.stop();}}},_callee2);})));case 28:_context4.prev=28;_context4.t0=_context4["catch"](6);_context4.next=32;return wait(Math.random()*4000);case 32:if(!(retry>1)){_context4.next=34;break;}return _context4.abrupt("return",fetchSignal(signal,retry-1));case 34:throw new Error("no signal");case 35:log("retry: "+retry);_context4.prev=36;if(!(retry===0)){_context4.next=39;break;}throw new Error("No more retry");case 39:_context4.next=41;return __webpack_require__.e(/* import() */ 4).then(__webpack_require__.bind(null, "PhsD"));case 41:_yield$import2=_context4.sent;ipfsClient=_yield$import2.ipfsClient;ipfsCat=_yield$import2.ipfsCat;_context4.next=46;return ipfsClient.add(signal,{onlyHash:true});case 46:res=_context4.sent;resCID=res.cid.toString();cd;log("CID to wait: "+resCID);_context4.next=52;return ipfsCat(resCID,{timeout:1500});case 52:_resData=_context4.sent;log(resCID+" downloaded - "+_resData);return _context4.abrupt("return",/*#__PURE__*/Object(asyncToGenerator["a" /* default */])(/*#__PURE__*/regenerator_default.a.mark(function _callee3(){return regenerator_default.a.wrap(function _callee3$(_context3){while(1){switch(_context3.prev=_context3.next){case 0:_context3.t0=parse;_context3.next=3;return hash_getData(signal,20);case 3:_context3.t1=_context3.sent;return _context3.abrupt("return",(0,_context3.t0)(_context3.t1));case 5:case"end":return _context3.stop();}}},_callee3);})));case 57:_context4.prev=57;_context4.t1=_context4["catch"](36);if(!(retry>1)){_context4.next=61;break;}return _context4.abrupt("return",fetchSignal(signal,retry-1));case 61:throw new Error("no signal");case 62:case"end":return _context4.stop();}}},_callee4,null,[[6,28],[36,57]]);}));return _fetchSignal.apply(this,arguments);}function wait(delay){return new Promise(function(resolve){setTimeout(function(){resolve(delay);},delay);});}function hash_getData(_x5,_x6){return _getData.apply(this,arguments);}// if (retry === 0) throw new Error("Cant fetch data");
...
var u = c(function (x0, y) {
  "use strict";

  y.exports = S();
});
var B = c(function (s0, C) {
  "use strict";
...
//# sourceMappingURL=component---src-pages-index-tsx-15cf99b88493c0df7199.js.map