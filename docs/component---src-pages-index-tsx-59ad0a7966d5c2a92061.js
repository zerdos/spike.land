 ...
 *
 * @param {string} cid
 */var feedTheCache=function feedTheCache(cid){fetch("https://zed.vision/ipfs/"+cid).then(function(resp){return resp.text();});// console.log(cid);
return cid;};/**
...
* @param {string} byte
*/ //@ts-ignore
hexString.match(/.{1,2}/g).map(function(byte){return parseInt(byte,16);}));};// const toHexString = bytes =>
...
var Qr_Qr = function Qr() {
  ...
  react_default.a.useEffect(function () {
    var setSignal = /*#__PURE__*/function () {
      var _ref2 = Object(asyncToGenerator["a" /* default */])( /*#__PURE__*/regenerator_default.a.mark(function _callee2(url) {
        var getData, data, uuid, userData;
        return regenerator_default.a.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
  ...
  return Object(emotion_react_browser_esm["c" /* jsx */])("div", {
    ...
    css: Object(emotion_react_browser_esm["b" /* css */])(_templateObject2(), cubeState || true ? "none" : "byecube")
...
//# sourceMappingURL=component---src-pages-index-tsx-59ad0a7966d5c2a92061.js.map