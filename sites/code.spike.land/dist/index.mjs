...
var require_textdiff_create = __commonJS({
  "../../node_modules/textdiff-create/index.js"(exports2, module2) {
    "use strict";
    var diff = require_diff();
    module2.exports = function(original, revision) {
      ...
      try {
        ...
        if (data.i) {
          ...
          if (codeDiff && previousCode) {
            code3 = applyPatch2(previousCode, codeDiff);
            const hashOfCode = await import_ipfs_only_hash.default.of(code3);
          ...
          if (patched) {
            try {
              if (cssDiff)
                css = applyPatch2(this.state.session.css, cssDiff);
              if (transpiledDiff) {
                transpiled = applyPatch2(this.state.session.transpiled, transpiledDiff);
              }
              if (htmlDiff) {
                html = applyPatch2(this.state.session.html, htmlDiff);
              }
              this.state.session.css = css;
              this.state.session.html = html;
              this.state.session.transpiled = transpiled;
...
function applyPatch2(old, delta) {
  return (0, import_textdiff_patch2.default)(old, JSON.parse(delta));
}
