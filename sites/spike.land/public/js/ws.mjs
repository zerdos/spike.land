...
var renderFromString = (App2) => {
  const html = renderToString(jsx(App2, null));
  return {
    html,
...
var AppToRender = ({ codeSpace: codeSpace2, children: children2 }) => {
  ...
  return jsx(Fragment11, null, jsx(InPortal, {
    node: portalNode
  }, jsx(AutoUpdateApp, {
    hash: hash4,
...
var run = async (startState) => {
  ...
  const App2 = startState.App;
  renderPreviewWindow(codeSpace, App2);
  initShims(assets);
  join2();
...
async function join2() {
  ...
  wsConnection.addEventListener("open", () => {
    ...
    sendWS = (0, import_throttle.default)(mess, 1e3, {
      leading: true,
      trailing: true
    });
