...
function y2(n3, r4, o5) {
  var i4 = d2(t2++, 2);
  if (i4.t = n3, !i4.__c && (i4.__ = [o5 ? o5(r4) : z2(void 0, r4), function(n4) {
...
function _2(r4, o5) {
  var i4 = d2(t2++, 3);
  !l.__s && w2(i4.__H, o5) && (i4.__ = r4, i4.o = o5, u2.__H.__h.push(i4));
}
function h2(r4, o5) {
  var i4 = d2(t2++, 4);
  !l.__s && w2(i4.__H, o5) && (i4.__ = r4, i4.o = o5, u2.__h.push(i4));
}
function s2(n3) {
...
function q2(n3) {
  var r4 = u2.context[n3.__c], o5 = d2(t2++, 9);
...
var r3, n2, a3, i3, l3, c3, p3, _3, d3, g4, h3;
var init_dist = __esm({
  "../../node_modules/preact-render-to-string/dist/index.mjs"() {
    init_define_process();
    init_preact_module();
...
var jsx, jsxDEV, jsxs, Fragment, hydrate, render, unmountComponentAtNode, renderToString, toChildArray, react_default, createContext, createElement, cloneElement, createFactory, createPortal, createRef, useCallback, useContext, useDebugValue, isValidElement, useEffect, useImperativeHandle, useLayoutEffect, useMemo, useReducer, useRef, useState, lazy, Suspense, StrictMode, SuspenseList, findDOMNode, forwardRef, memo, Children, PureComponent, Component, version, flushSync;
var init_react = __esm({
  "react.ts"() {
    ...
    ({ jsx, jsxDEV, jsxs } = window.PreactJSX);
    ({ Fragment } = preact_module_exports);
    ({ hydrate, render, unmountComponentAtNode } = window.ReactDOM);
    ({ renderToString } = window);
    ({ toChildArray } = preact_module_exports);
    react_default = compat_module_default;
    ({
      createContext,
      createElement,
      cloneElement,
