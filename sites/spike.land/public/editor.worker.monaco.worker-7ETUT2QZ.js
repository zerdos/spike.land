(() => {
  // <define:process>
  var define_process_default = { env: {}, version: "1.1.1", browser: true };
  ...
  var globals = typeof self === "object" ? self : typeof self === "object" ? self : {};
  var nodeProcess = void 0;
  if (typeof globals.vscode !== "undefined" && typeof globals.vscode.process !== "undefined") {
    nodeProcess = globals.vscode.process;
  } else if (typeof define_process_default !== "undefined") {
    nodeProcess = define_process_default;
  }
  ...
  if (typeof globals.vscode !== "undefined" && typeof globals.vscode.process !== "undefined") {
    ...
    safeProcess = {
      get platform() {
        return define_process_default.platform;
      },
      get arch() {
        return define_process_default.arch;
      },
      get env() {
        return define_process_default.env;
      },
      cwd() {
        return define_process_default.env["VSCODE_CWD"] || define_process_default.cwd();
      }
    };
  } else {
    safeProcess = {
  ...
  Codicon.bellSlashDot = new Codicon("bell-slash-dot", { fontCharacter: "\\f101" });
  ...
  (function(EditorOption2) {
    ...
    EditorOption2[EditorOption2["enableDropIntoEditor"] = 32] = "enableDropIntoEditor";
    EditorOption2[EditorOption2["emptySelectionClipboard"] = 33] = "emptySelectionClipboard";
    EditorOption2[EditorOption2["extraEditorClassName"] = 34] = "extraEditorClassName";
    EditorOption2[EditorOption2["fastScrollSensitivity"] = 35] = "fastScrollSensitivity";
    EditorOption2[EditorOption2["find"] = 36] = "find";
    EditorOption2[EditorOption2["fixedOverflowWidgets"] = 37] = "fixedOverflowWidgets";
    EditorOption2[EditorOption2["folding"] = 38] = "folding";
    EditorOption2[EditorOption2["foldingStrategy"] = 39] = "foldingStrategy";
    EditorOption2[EditorOption2["foldingHighlight"] = 40] = "foldingHighlight";
    EditorOption2[EditorOption2["foldingImportsByDefault"] = 41] = "foldingImportsByDefault";
    EditorOption2[EditorOption2["foldingMaximumRegions"] = 42] = "foldingMaximumRegions";
    EditorOption2[EditorOption2["unfoldOnClickAfterEndOfLine"] = 43] = "unfoldOnClickAfterEndOfLine";
    EditorOption2[EditorOption2["fontFamily"] = 44] = "fontFamily";
    EditorOption2[EditorOption2["fontInfo"] = 45] = "fontInfo";
    EditorOption2[EditorOption2["fontLigatures"] = 46] = "fontLigatures";
    EditorOption2[EditorOption2["fontSize"] = 47] = "fontSize";
    EditorOption2[EditorOption2["fontWeight"] = 48] = "fontWeight";
    EditorOption2[EditorOption2["formatOnPaste"] = 49] = "formatOnPaste";
    EditorOption2[EditorOption2["formatOnType"] = 50] = "formatOnType";
    EditorOption2[EditorOption2["glyphMargin"] = 51] = "glyphMargin";
    EditorOption2[EditorOption2["gotoLocation"] = 52] = "gotoLocation";
    EditorOption2[EditorOption2["hideCursorInOverviewRuler"] = 53] = "hideCursorInOverviewRuler";
    EditorOption2[EditorOption2["hover"] = 54] = "hover";
    EditorOption2[EditorOption2["inDiffEditor"] = 55] = "inDiffEditor";
    EditorOption2[EditorOption2["inlineSuggest"] = 56] = "inlineSuggest";
    EditorOption2[EditorOption2["letterSpacing"] = 57] = "letterSpacing";
    EditorOption2[EditorOption2["lightbulb"] = 58] = "lightbulb";
    EditorOption2[EditorOption2["lineDecorationsWidth"] = 59] = "lineDecorationsWidth";
    EditorOption2[EditorOption2["lineHeight"] = 60] = "lineHeight";
    EditorOption2[EditorOption2["lineNumbers"] = 61] = "lineNumbers";
    EditorOption2[EditorOption2["lineNumbersMinChars"] = 62] = "lineNumbersMinChars";
    EditorOption2[EditorOption2["linkedEditing"] = 63] = "linkedEditing";
    EditorOption2[EditorOption2["links"] = 64] = "links";
    EditorOption2[EditorOption2["matchBrackets"] = 65] = "matchBrackets";
    EditorOption2[EditorOption2["minimap"] = 66] = "minimap";
    EditorOption2[EditorOption2["mouseStyle"] = 67] = "mouseStyle";
    EditorOption2[EditorOption2["mouseWheelScrollSensitivity"] = 68] = "mouseWheelScrollSensitivity";
    EditorOption2[EditorOption2["mouseWheelZoom"] = 69] = "mouseWheelZoom";
    EditorOption2[EditorOption2["multiCursorMergeOverlapping"] = 70] = "multiCursorMergeOverlapping";
    EditorOption2[EditorOption2["multiCursorModifier"] = 71] = "multiCursorModifier";
    EditorOption2[EditorOption2["multiCursorPaste"] = 72] = "multiCursorPaste";
    EditorOption2[EditorOption2["occurrencesHighlight"] = 73] = "occurrencesHighlight";
    EditorOption2[EditorOption2["overviewRulerBorder"] = 74] = "overviewRulerBorder";
    EditorOption2[EditorOption2["overviewRulerLanes"] = 75] = "overviewRulerLanes";
    EditorOption2[EditorOption2["padding"] = 76] = "padding";
    EditorOption2[EditorOption2["parameterHints"] = 77] = "parameterHints";
    EditorOption2[EditorOption2["peekWidgetDefaultFocus"] = 78] = "peekWidgetDefaultFocus";
    EditorOption2[EditorOption2["definitionLinkOpensInPeek"] = 79] = "definitionLinkOpensInPeek";
    EditorOption2[EditorOption2["quickSuggestions"] = 80] = "quickSuggestions";
    EditorOption2[EditorOption2["quickSuggestionsDelay"] = 81] = "quickSuggestionsDelay";
    EditorOption2[EditorOption2["readOnly"] = 82] = "readOnly";
    EditorOption2[EditorOption2["renameOnType"] = 83] = "renameOnType";
    EditorOption2[EditorOption2["renderControlCharacters"] = 84] = "renderControlCharacters";
    EditorOption2[EditorOption2["renderFinalNewline"] = 85] = "renderFinalNewline";
    EditorOption2[EditorOption2["renderLineHighlight"] = 86] = "renderLineHighlight";
    EditorOption2[EditorOption2["renderLineHighlightOnlyWhenFocus"] = 87] = "renderLineHighlightOnlyWhenFocus";
    EditorOption2[EditorOption2["renderValidationDecorations"] = 88] = "renderValidationDecorations";
    EditorOption2[EditorOption2["renderWhitespace"] = 89] = "renderWhitespace";
    EditorOption2[EditorOption2["revealHorizontalRightPadding"] = 90] = "revealHorizontalRightPadding";
    EditorOption2[EditorOption2["roundedSelection"] = 91] = "roundedSelection";
    EditorOption2[EditorOption2["rulers"] = 92] = "rulers";
    EditorOption2[EditorOption2["scrollbar"] = 93] = "scrollbar";
    EditorOption2[EditorOption2["scrollBeyondLastColumn"] = 94] = "scrollBeyondLastColumn";
    EditorOption2[EditorOption2["scrollBeyondLastLine"] = 95] = "scrollBeyondLastLine";
    EditorOption2[EditorOption2["scrollPredominantAxis"] = 96] = "scrollPredominantAxis";
    EditorOption2[EditorOption2["selectionClipboard"] = 97] = "selectionClipboard";
    EditorOption2[EditorOption2["selectionHighlight"] = 98] = "selectionHighlight";
    EditorOption2[EditorOption2["selectOnLineNumbers"] = 99] = "selectOnLineNumbers";
    EditorOption2[EditorOption2["showFoldingControls"] = 100] = "showFoldingControls";
    EditorOption2[EditorOption2["showUnused"] = 101] = "showUnused";
    EditorOption2[EditorOption2["snippetSuggestions"] = 102] = "snippetSuggestions";
    EditorOption2[EditorOption2["smartSelect"] = 103] = "smartSelect";
    EditorOption2[EditorOption2["smoothScrolling"] = 104] = "smoothScrolling";
    EditorOption2[EditorOption2["stickyTabStops"] = 105] = "stickyTabStops";
    EditorOption2[EditorOption2["stopRenderingLineAfter"] = 106] = "stopRenderingLineAfter";
    EditorOption2[EditorOption2["suggest"] = 107] = "suggest";
    EditorOption2[EditorOption2["suggestFontSize"] = 108] = "suggestFontSize";
    EditorOption2[EditorOption2["suggestLineHeight"] = 109] = "suggestLineHeight";
    EditorOption2[EditorOption2["suggestOnTriggerCharacters"] = 110] = "suggestOnTriggerCharacters";
    EditorOption2[EditorOption2["suggestSelection"] = 111] = "suggestSelection";
    EditorOption2[EditorOption2["tabCompletion"] = 112] = "tabCompletion";
    EditorOption2[EditorOption2["tabIndex"] = 113] = "tabIndex";
    EditorOption2[EditorOption2["unicodeHighlighting"] = 114] = "unicodeHighlighting";
    EditorOption2[EditorOption2["unusualLineTerminators"] = 115] = "unusualLineTerminators";
    EditorOption2[EditorOption2["useShadowDOM"] = 116] = "useShadowDOM";
    EditorOption2[EditorOption2["useTabStops"] = 117] = "useTabStops";
    EditorOption2[EditorOption2["wordSeparators"] = 118] = "wordSeparators";
    EditorOption2[EditorOption2["wordWrap"] = 119] = "wordWrap";
    EditorOption2[EditorOption2["wordWrapBreakAfterCharacters"] = 120] = "wordWrapBreakAfterCharacters";
    EditorOption2[EditorOption2["wordWrapBreakBeforeCharacters"] = 121] = "wordWrapBreakBeforeCharacters";
    EditorOption2[EditorOption2["wordWrapColumn"] = 122] = "wordWrapColumn";
    EditorOption2[EditorOption2["wordWrapOverride1"] = 123] = "wordWrapOverride1";
    EditorOption2[EditorOption2["wordWrapOverride2"] = 124] = "wordWrapOverride2";
    EditorOption2[EditorOption2["wrappingIndent"] = 125] = "wrappingIndent";
    EditorOption2[EditorOption2["wrappingStrategy"] = 126] = "wrappingStrategy";
    EditorOption2[EditorOption2["showDeprecated"] = 127] = "showDeprecated";
    EditorOption2[EditorOption2["inlayHints"] = 128] = "inlayHints";
    EditorOption2[EditorOption2["editorClassName"] = 129] = "editorClassName";
    EditorOption2[EditorOption2["pixelRatio"] = 130] = "pixelRatio";
    EditorOption2[EditorOption2["tabFocusMode"] = 131] = "tabFocusMode";
    EditorOption2[EditorOption2["layoutInfo"] = 132] = "layoutInfo";
    EditorOption2[EditorOption2["wrappingInfo"] = 133] = "wrappingInfo";
