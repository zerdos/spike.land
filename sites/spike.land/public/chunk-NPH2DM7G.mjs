...
var React, createContext, Fragment, hydrate, render, unmountComponentAtNode, react_default, createElement, cloneElement, createFactory, createRef, useCallback, useContext, useDebugValue, isValidElement, useEffect, useImperativeHandle, useLayoutEffect, useMemo, useReducer, useRef, useState, lazy, Suspense, StrictMode, forwardRef, memo, Children, PureComponent, Component, version, flushSync;
