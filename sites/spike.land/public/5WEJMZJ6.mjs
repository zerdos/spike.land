...
var ReplaceTransition = function(_React$Component) {
  ...
  _proto.render = function render() {
    ...
    var _React$Children$toArr = React68.Children.toArray(children2), first = _React$Children$toArr[0], second = _React$Children$toArr[1];
    ...
    return React68.createElement(TransitionGroup_default, props, inProp ? React68.cloneElement(first, {
      key: "first",
...
// js/Qr.tsx
var QRious = lazy(() => import("./D3BBB4FN.mjs").then(({ QRious: QRious2 }) => ({ default: QRious2 })));
...
var Editor = ({ code, i: i2, codeSpace }) => {
  ...
  useEffect29(() => {
    ...
    const setMonaco = async () => {
      const { startMonaco } = await import("./CRDEFJJ6.mjs");
