export const files = {
  ...
  "js/ws.mjs": "QmQeNze5SWguoVPDssRNp1zW2T1ELZZc9SgBWwsuVrxScY",
  "manifest.json": "QmXmokoZc6CTgga36sBaEXYvw3fPCjJSCrXx1HzLkQewnm",
  "package.json": "QmagGLqdfZhJpShLSx8p9Xf4ZLepf4MedhcEtD8hyXZtfS",
