  ...
  factory: function (require) {
    ...
    (() => {
        ...
        await s.packUtils.prepareForPack(t, { report: o }, async () => {
          ...
          try {
            for (const i of r) {
              ...
              o.reportInfo(null, i),
                await n.xfs.copyPromise(s, r, { overwrite: !0 }),
                a.tick();
            }
          } finally {
            c.stop();
      ...
      class f extends o.BaseCommand {
        ...
        async execute() {
          const t = await i.Configuration.find(
              this.context.cwd,
              this.context.plugins,
            ),
            { project: e } = await i.Project.find(t, this.context.cwd),
            o = e.getWorkspaceByIdent(
              i.structUtils.parseIdent(this.workspaceName),
            ),
            r = function (
              {
                project: t,
                ...
                production: o = !1,
                scopes: r =
                  (o ? ["dependencies"] : i.Manifest.hardDependencies),
              },
            ) {
              const a = new Set([...e]);
              for (const e of a) {
            ...
            s = await async function (t, e = "Dockerfile") {
              ...
              const r = [
                n.ppath.join(t.cwd, o),
                n.ppath.join(t.project.cwd, o),
              ];
              ...
              await n.xfs.mktempPromise(async (o) => {
                ...
                await t.startTimerPromise("Copy files", async () => {
                  await async function (
                    { destination: t, project: e, report: o },
                  ) {
                    const r = e.configuration.get("rcFilename");
                    o.reportInfo(null, r),
                      await n.xfs.copyPromise(
                        n.ppath.join(t, r),
                        n.ppath.join(e.cwd, r),
                        { overwrite: !0 },
                      );
                    ...
                    await async function (
                      ...
                      const r = e.configuration.get("yarnPath"),
                        ...
                        a = n.ppath.join(t, i);
                      o.reportInfo(null, i),
                        await n.xfs.copyPromise(a, r, { overwrite: !0 });
                    }({ destination: f, project: e, report: t }),
                    await async function (
                      { destination: t, workspaces: e, report: o },
                    ) {
                      for (const r of e) {
                        const e = n.ppath.join(
                            r.relativeCwd,
                            i.Manifest.fileName,
                          ),
                          a = n.ppath.join(t, e),
                    ...
                    await async function (
                      ...
                      parseDescriptor: (t) => {
                        if (t.range.startsWith("exec:")) {
                          const e = function (t) {
                            const { params: e, selector: o } = i.structUtils
                                .parseRange(t),
                              r = n.npath.toPortablePath(o);
                            return {
                              parentLocator: e && "string" == typeof e.locator
                          ...
                          return {
                            parentLocator: e.parentLocator,
                            paths: [e.path],
                          };
                        }
                        if (t.range.startsWith("patch:")) {
                          const { parentLocator: e, patchPaths: o } = a
                            .patchUtils.parseDescriptor(t);
                          if (!e) return;
                    ...
                    await async function (
                      { destination: t, project: e, cache: o, report: r },
                    ) {
                    ...
                    await async function (
                      ...
                      const r = (0, n.toFilename)(
                          e.configuration.get("lockfileFilename"),
                        ),
                        i = n.ppath.join(t, r);
                      o.reportInfo(null, r),
                    ...
                    this.copyFiles && this.copyFiles.length &&
                    await async function (
                      {
                        destination: t,
                        files: e,
                ...
                await i.execUtils.pipevp("docker", [
                  "build",
                  ...this.args,
                  "-f",
                  s,
