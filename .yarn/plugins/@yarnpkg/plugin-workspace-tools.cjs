  ...
  factory: function (require) {
    var plugin = (() => {
      ...
      var $e = K((te) => {
        ...
        te.exceedsLimit = (e, t, r = 1, n) =>
          n === !1 || !te.isInteger(e) || !te.isInteger(t)
            ? !1
      ...
      var ke = K((is, at) => {
        ...
        at.exports = (e, t = {}) => {
          let r = (n, s = {}) => {
            let a = t.escapeInvalid && it.isInvalidBrace(s),
              i = n.invalid === !0 && t.escapeInvalid === !0,
              o = "";
            if (n.value) {
              return (a || i) && it.isOpenOrClose(n) ? "\\" + n.value : n.value;
            }
      ...
      var At = K((cs, ut) => {
        ...
        var lt = ct(),
          pe = (e, t, r) => {
            ...
            return f >= 0 && (k = pt(g, f, p, n)),
              p.negatives = y,
              p.positives = k,
              p.result = Ir(y, k, n),
              n.capture === !0
                ? p.result = `(${p.result})`
                : n.wrap !== !1 && k.length + y.length > 1 &&
                  (p.result = `(?:${p.result})`),
              pe.cache[h] = p,
              p.result;
          };
        ...
        function Mr(e, t) {
          ...
          for (s = dt(t + 1, n) - 1; e < s && s <= t;) {
            a.add(s), n += 1, s = dt(t + 1, n) - 1;
          }
          ...
          for (let h = 0; h < s.length; h++) {
            ...
            if (!r.isPadded && o && o.pattern === f.pattern) {
              o.count.length > 1 && o.count.pop(),
                ...
                o.string = o.pattern + gt(o.count),
                i = g + 1;
              continue;
            }
            r.isPadded && (A = Gr(g, r, n)),
              f.string = A + f.pattern + gt(f.count),
              a.push(f),
              i = g + 1,
              o = f;
          }
      ...
      var Ge = K((us, Rt) => {
        ...
        var qr = require("util"),
          yt = At(),
          bt = (e) => e !== null && typeof e == "object" && !Array.isArray(e),
          Kr = (e) => (t) => e === !0 ? Number(t) : String(t),
          De = (e) => typeof e == "number" || typeof e == "string" && e !== "",
          Re = (e) => Number.isInteger(+e),
          Ue = (e) => {
            let t = `${e}`, r = -1;
          ...
          Ct = (...e) =>
            new RangeError("Invalid range arguments: " + qr.inspect(...e)),
          wt = (e, t, r) => {
          ...
          Xr = (e, t, r = 1, n = {}) => {
            ...
            let f = Ue(o) || Ue(h) || Ue(g),
              A = f ? Math.max(o.length, h.length, g.length) : 0,
              p = f === !1 && Wr(e, t, n) === !1,
              k = n.transform || Kr(p);
            if (n.toRegex && r === 1) return Et(_t(e, A), _t(t, A), !0, n);
            let y = { negatives: [], positives: [] },
              R = (T) => y[T < 0 ? "negatives" : "positives"].push(Math.abs(T)),
              _ = [],
              x = 0;
            for (
              ;
              ...
              n.toRegex === !0 && r > 1 ? R(s) : _.push(jr(k(s, x), A, p)),
                s = i ? s - r : s + r,
                x++;
            }
            return n.toRegex === !0
              ? r > 1 ? Fr(y, n) : xt(_, null, B({ wrap: !1 }, n))
              : _;
          },
          Zr = (e, t, r = 1, n = {}) => {
            if (!Re(e) && e.length > 1 || !Re(t) && t.length > 1) {
              return wt(e, t, n);
            }
          ...
          Te = (e, t, r, n = {}) => {
            ...
            return s.capture === !0 && (s.wrap = !0),
              ...
              Re(r)
                ? Re(e) && Re(t)
                  ? Xr(e, t, r, s)
                  : Zr(e, t, Math.max(Math.abs(r), 1), s)
                : r != null && !bt(r)
                ? Qr(r, s)
                : Te(e, t, 1, r);
          };
          ...
          zr = (e, t = {}) => {
            let r = (n, s = {}) => {
              ...
              if (n.nodes && n.ranges > 0) {
                let f = vt.reduce(n.nodes),
                  A = Yr(...f, Q(B({}, t), { wrap: !1, toRegex: !0 }));
                if (A.length !== 0) {
                  return f.length > 1 && A.length > 1 ? `(${A})` : A;
                }
              }
          ...
          Jr = (e, t = {}) => {
            let r = t.rangeLimit === void 0 ? 1e3 : t.rangeLimit,
              n = (s, a = {}) => {
                ...
                for (
                  ;
                  i.type !== "brace" && i.type !== "root" && i.parent;
...
`,
      ...
      var Pt = K((hs, Nt) => {
        ...
        var en = ke(),
          ...
          hn = (e, t = {}) => {
            ...
            let r = t || {},
              n = typeof r.maxLength == "number"
                ? Math.min(It, r.maxLength)
                : It;
            if (e.length > n) {
            ...
            let s = { type: "root", input: e, nodes: [] },
              ...
              R = (_) => {
                if (
                  _.type === "text" && o.type === "dot" && (o.type = "text"),
                    o && o.type === "text" && _.type === "text"
                ) {
                  o.value += _.value;
                  return;
                }
            ...
            for (R({ type: "bos" }); f < g;) {
              if (i = a[a.length - 1], p = y(), !(p === fn || p === pn)) {
                if (p === qe) {
      ...
      var Gt = K((ds, Dt) => {
        ...
        var Ut = ke(),
          ...
          V = (e, t = {}) => {
            ...
            return t && t.expand === !0 && t.nodupes === !0 &&
              (r = [...new Set(r)]),
              r;
          };
        V.parse = (e, t = {}) => mn(e, t);
        V.stringify = (e, t = {}) =>
          typeof e == "string" ? Ut(V.parse(e, t), t) : Ut(e, t);
        V.compile = (
          e,
          t = {},
        ) => (typeof e == "string" && (e = V.parse(e, t)), dn(e, t));
        V.expand = (e, t = {}) => {
          typeof e == "string" && (e = V.parse(e, t));
          let r = gn(e, t);
          return t.noempty === !0 && (r = r.filter(Boolean)),
      ...
      var er = K((As, Qt) => {
        ...
        var Xt = be(),
          ...
          Gn = (e, t) => {
            ...
            for (; g < n;) {
              ...
              if (x === !0 || b === Xe) {
                for (ne++; M() !== !0 && (b = H());) {
                  ...
                  if (x !== !0 && b === Fe && (b = H()) === Fe) {
                    if (
                      p = C.isBrace = !0, y = C.isGlob = !0, G = !0, s === !0
                    ) continue;
                    break;
                  }
                  if (x !== !0 && b === Bn) {
            ...
            r.noext === !0 && (R = !1, y = !1);
            let w = h, j = "", c = "";
            f > 0 && (j = h.slice(0, f), h = h.slice(f), A -= f),
              w && y === !0 && A > 0
                ? (w = h.slice(0, A), c = h.slice(A))
                : y === !0
                ? (w = "", c = h)
                : w = h,
              w && w !== "" && w !== "/" && w !== h &&
              Vt(w.charCodeAt(w.length - 1)) && (w = w.slice(0, -1)),
              r.unescape === !0 &&
              (c && (c = Xt.removeBackslashes(c)),
                w && T === !0 && (w = Xt.removeBackslashes(w)));
            let u = {
              prefix: j,
              input: e,
              start: f,
            ...
            if (
              r.tokens === !0 &&
              (u.maxDepth = 0, Vt(b) || i.push(C), u.tokens = i),
      ...
      var sr = K((Rs, tr) => {
        ...
        var Oe = ye(),
          ...
          nr = (e, t) => {
            ...
            let H = [],
              ...
              u,
              I = () => l.index === s - 1,
              $ = l.peek = (m = 1) => e[l.index + m],
              ee = l.advance = () => e[++l.index] || "",
              se = () => e.slice(l.index + 1),
              z = (m = "", L = 0) => {
              ...
              v = (m) => {
                if (c.type === "globstar") {
                  let L = l.braces > 0 &&
                      (m.type === "comma" || m.type === "brace"),
                    d = m.extglob === !0 ||
                      H.length && (m.type === "pipe" || m.type === "paren");
                  m.type !== "slash" && m.type !== "paren" && !L && !d &&
                    (l.output = l.output.slice(0, -c.output.length),
                      c.type = "star",
                      c.value = "*",
                      c.output = M,
                      l.output += c.output);
                ...
                if (
                  H.length && m.type !== "paren" &&
                  (H[H.length - 1].inner += m.value),
                    (m.value || m.output) && Ce(m),
                    c && c.type === "text" && m.type === "text"
                ) {
              ...
              Se = (m, L) => {
                ...
                we("parens"),
                  v({ type: m, value: L, output: l.output ? "" : y }),
                  v({ type: "paren", extglob: !0, value: ee(), output: S }),
                  H.push(d);
              },
              Cr = (m) => {
                ...
                if (m.type === "negate") {
                  let S = M;
                  m.inner && m.inner.length > 1 && m.inner.includes("/") &&
                  (S = E(r)),
                    (S !== M || I() || /^\)+$/.test(se())) &&
                    (L = m.close = `)$))${S}`),
                    m.inner.includes("*") && (d = se()) &&
                    /^\.[^\\/.]+$/.test(d) && (L = m.close = `)${d})${S})`),
                    m.prev.type === "bos" && (l.negatedExtglob = !0);
                }
                v({ type: "paren", extglob: !0, value: u, output: L }),
                  ue("parens");
              };
            if (r.fastpaths !== !1 && !/(^[*!]|[/()[\]{}"])/.test(e)) {
                ...
                L = e.replace(
                  ...
                  (d, S, P, F, q, Me) =>
                    F === "\\"
                      ...
                      : F === "?"
                      ? S
                        ? S + F + (q ? O.repeat(q.length) : "")
                        : Me === 0
                        ? C + (q ? O.repeat(q.length) : "")
                        : O.repeat(P.length)
                      : F === "."
                      ? A.repeat(P.length)
                      : F === "*"
              ...
              return m === !0 &&
                (r.unescape === !0 ? L = L.replace(/\\/g, "") : L = L.replace(
                  /\\+/g,
                  (d) => d.length % 2 == 0 ? "\\\\" : d ? "\\" : "",
                )),
                L === e && r.contains === !0
                  ? (l.output = e, l)
                  : (l.output = J.wrapOutput(L, l, t), l);
            }
            for (; !I();) {
              ...
              if (u === "\\") {
                ...
                if (
                  S && S[0].length > 2 &&
                  (P = S[0].length, l.index += P, P % 2 != 0 && (u += "\\")),
                    r.unescape === !0 ? u = ee() : u += ee(),
                    l.brackets === 0
                ) {
                  v({ type: "text", value: u });
                  continue;
                  ...
                  if (d.includes("[") && (c.posix = !0, d.includes(":"))) {
                    ...
                    if (q) {
                      c.value = P + q,
                        l.backtrack = !0,
                        ee(),
                        !a.output && i.indexOf(c) === 1 && (a.output = y);
                      continue;
                    }
                  }
                }
              ...
              if (u === '"') {
                l.quotes = l.quotes === 1 ? 0 : 1,
                  r.keepQuotes === !0 && v({ type: "text", value: u });
                continue;
              }
              if (u === "(") {
              ...
              if (u === ")") {
                ...
                v({ type: "paren", value: u, output: l.parens ? ")" : "\\)" }),
                  ue("parens");
                continue;
              }
              if (u === "[") {
                if (r.nobracket === !0 || !se().includes("]")) {
                  if (
                    r.nobracket !== !0 && r.strictBrackets === !0
              ...
              if (u === "]") {
                if (
                  r.nobracket === !0 ||
                  c && c.type === "bracket" && c.value.length === 1
                ) {
                ...
                let d = c.value.slice(1);
                if (
                  c.posix !== !0 && d[0] === "^" && !d.includes("/") &&
                  (u = `/${u}`),
                    c.value += u,
                    Ce({ value: u }),
                    r.literalBrackets === !1 || J.hasRegexChars(d)
                ) continue;
                let S = J.escapeRegex(c.value);
                if (
                  l.output = l.output.slice(0, -c.value.length),
                    r.literalBrackets === !0
                ) {
              ...
              if (u === ",") {
                ...
                S && j[j.length - 1] === "braces" && (S.comma = !0, d = "|"),
                  v({ type: "comma", value: u, output: d });
                continue;
              }
              if (u === "/") {
              ...
              if (u === ".") {
                ...
                if (
                  l.braces + l.parens === 0 && c.type !== "bos" &&
                  c.type !== "slash"
                ) {
              ...
              if (u === "+") {
                ...
                if (
                  c &&
                    (c.type === "bracket" || c.type === "paren" ||
                      c.type === "brace") || l.parens > 0
                ) {
                  v({ type: "plus", value: u });
                  continue;
                }
              ...
              if (c.type === "star") {
                ...
                if (d.type === "slash" && d.prev.type !== "bos" && !F && I()) {
                  l.output = l.output.slice(0, -(d.output + c.output).length),
                    d.output = `(?:${d.output}`,
                    c.type = "globstar",
                    c.output = E(r) + (r.strictSlashes ? ")" : "|$)"),
                    c.value += u,
                    l.globstar = !0,
                    l.output += d.output + c.output,
                    z(u);
                  continue;
                }
                if (
                  d.type === "slash" && d.prev.type !== "bos" && m[0] === "/"
                ) {
                  let ve = m[1] !== void 0 ? "|$" : "";
                  l.output = l.output.slice(0, -(d.output + c.output).length),
                    d.output = `(?:${d.output}`,
              ...
              if (r.bash === !0) {
                L.output = ".*?",
                  (c.type === "bos" || c.type === "slash") &&
                  (L.output = b + L.output),
                  v(L);
                continue;
              }
              if (
                c && (c.type === "bracket" || c.type === "paren") &&
                r.regex === !0
              ) {
                L.output = u, v(L);
                continue;
              }
              (l.index === l.start || c.type === "slash" || c.type === "dot") &&
              (c.type === "dot"
                ? (l.output += x, c.output += x)
                : r.dot === !0
                ? (l.output += T, c.output += T)
                : (l.output += b, c.output += b),
                $() !== "*" && (l.output += y, c.output += y)), v(L);
            }
            for (; l.brackets > 0;) {
              if (r.strictBrackets === !0) {
                throw new SyntaxError(de("closing", "]"));
            ...
            if (
              r.strictSlashes !== !0 &&
              (c.type === "star" || c.type === "bracket") &&
              v({ type: "maybe_slash", value: "", output: `${k}?` }),
                l.backtrack === !0
            ) {
              l.output = "";
              for (let m of l.tokens) {
                l.output += m.output != null ? m.output : m.value,
                  m.suffix && (l.output += m.suffix);
              }
            }
            return l;
          };
        nr.fastpaths = (e, t) => {
          let r = B({}, t),
            n = typeof r.maxLength == "number" ? Math.min(Ne, r.maxLength) : Ne,
            s = e.length;
          if (s > n) {
            throw new SyntaxError(
              `Input length: ${s}, exceeds maximum allowed length: ${n}`,
          ...
          r.capture && (O = `(${O})`);
          let W = (b) =>
              b.noglobstar === !0 ? O : `(${x}(?:(?!${y}${b.dot ? g : i}).)*?)`,
            G = (b) => {
              switch (b) {
                case "*":
                  return `${R}${h}${O}`;
      ...
      var ir = K((ys, ar) => {
        ...
        var Fn = require("path"),
          ...
          D = (e, t, r = !1) => {
            ...
            let s = t || {},
              a = ze.isWindows(t),
              i = n ? D.compileRe(e, t) : D.makeRe(e, t, !1, !0),
              o = i.state;
            delete i.state;
            let h = () => !1;
            if (s.ignore) {
            ...
            let g = (f, A = !1) => {
              let { isMatch: p, match: k, output: y } = D.test(f, i, t, {
                  glob: e,
                  posix: a,
                }),
                R = {
              ...
              return typeof s.onResult == "function" && s.onResult(R),
                p === !1
                  ? (R.isMatch = !1, A ? R : !1)
                  : h(f)
                  ? (typeof s.onIgnore == "function" && s.onIgnore(R),
                    R.isMatch = !1,
                    A ? R : !1)
                  : (typeof s.onMatch == "function" && s.onMatch(R),
                    A ? R : !0);
            };
        ...
        D.test = (e, t, r, { glob: n, posix: s } = {}) => {
          ...
          let a = r || {},
            i = a.format || (s ? ze.toPosixSlashes : null),
            o = e === n,
            h = o && i ? i(e) : e;
          return o === !1 && (h = i ? i(e) : e, o = h === n),
            (o === !1 || a.capture === !0) &&
            (a.matchBase === !0 || a.basename === !0
              ? o = D.matchBase(e, t, r, s)
              : o = t.exec(h)),
            { isMatch: Boolean(o), match: o, output: h };
        };
        D.matchBase = (e, t, r, n = ze.isWindows(r)) =>
          (t instanceof RegExp ? t : D.makeRe(t, r)).test(Fn.basename(e));
        D.isMatch = (e, t, r) => D(t, r)(e);
        D.parse = (e, t) =>
          Array.isArray(e)
            ? e.map((r) => D.parse(r, t))
            : Ye(e, Q(B({}, t), { fastpaths: !1 }));
        D.scan = (e, t) => Qn(e, t);
        ...
        D.makeRe = (e, t = {}, r = !1, n = !1) => {
          ...
          return t.fastpaths !== !1 && (e[0] === "." || e[0] === "*") &&
            (s.output = Ye.fastpaths(e, t)),
            s.output || (s = Ye(e, t)),
            D.compileRe(s, t, r, n);
        };
        D.toRegex = (e, t) => {
      ...
      var hr = K((_s, ur) => {
        ...
        var lr = require("util"),
          ...
          N = (e, t, r) => {
            ...
            for (let f = 0; f < t.length; f++) {
              let A = oe(String(t[f]), Q(B({}, r), { onResult: o }), !0),
                p = A.state.negated || A.state.negatedExtglob;
              p && i++;
              for (let k of e) {
                let y = A(k, !0);
                !(p ? !y.isMatch : y.isMatch) ||
                  (p ? n.add(y.output) : (n.delete(y.output), s.add(y.output)));
              }
            }
        ...
        N.contains = (e, t, r) => {
          if (typeof e != "string") {
            throw new TypeError(
              `Expected a string: "${lr.inspect(e)}"`,
            );
          }
          ...
          if (typeof t == "string") {
            ...
            if (
              e.includes(t) || e.startsWith("./") && e.slice(2).includes(t)
            ) return !0;
          }
        ...
        N.capture = (e, t, r) => {
          let n = Ve.isWindows(r),
            a = oe.makeRe(String(e), Q(B({}, r), { capture: !0 })).exec(
              n ? Ve.toPosixSlashes(t) : t,
            );
      ...
      var Vn = {};
      Or(Vn, { default: () => es });
      var He = X(require("@yarnpkg/cli")),
        ae = X(require("@yarnpkg/core")),
        nt = X(require("@yarnpkg/core")),
        le = X(require("clipanion")),
        Ae = class extends He.BaseCommand {
          constructor() {
            super(...arguments);
          ...
          async execute() {
            let t = await ae.Configuration.find(
                this.context.cwd,
                this.context.plugins,
              ),
              { project: r, workspace: n } = await ae.Project.find(
                t,
                this.context.cwd,
              ),
              s = await ae.Cache.find(t);
            await r.restoreInstallState({ restoreResolutions: !1 });
            let a;
            if (this.all) a = new Set(r.workspaces);
            else if (this.workspaces.length === 0) {
              if (!n) {
                throw new He.WorkspaceRequiredError(
                  r.cwd,
                  this.context.cwd,
                );
              }
              a = new Set([n]);
                ...
                this.workspaces.map((o) =>
                  r.getWorkspaceByIdent(nt.structUtils.parseIdent(o))
                ),
              );}
            for (let o of a) {
              for (
                let h of this.production
                  ? ["dependencies"]
                  : ae.Manifest.hardDependencies
              ) {
                for (let g of o.manifest.getForScope(h).values()) {
      ...
      var st = Ae;
      var Ie = X(require("@yarnpkg/cli")),
        ge = X(require("@yarnpkg/core")),
        Ee = X(require("@yarnpkg/core")),
        Y = X(require("@yarnpkg/core")),
        Rr = X(require("@yarnpkg/plugin-git")),
        U = X(require("clipanion")),
        Be = X(hr()),
        yr = X(require("os")),
        br = X(Ar()),
        re = X(require("typanion")),
        xe = class extends Ie.BaseCommand {
          constructor() {
            ...
            this.jobs = U.Option.String("-j,--jobs", {
              ...
              validator: re.isOneOf([
                re.isEnum(["unlimited"]),
                re.applyCascade(re.isNumber(), [
                  re.isInteger(),
                  re.isAtLeast(1),
                ]),
              ]),
          ...
          async execute() {
            let t = await ge.Configuration.find(
              ...
              { project: r, workspace: n } = await ge.Project.find(
                t,
                this.context.cwd,
              );
            if (!this.all && !n) {
              throw new Ie.WorkspaceRequiredError(
                r.cwd,
                this.context.cwd,
              );
            }
            ...
            let s = this.cli.process([this.commandName, ...this.args]),
              a = s.path.length === 1 && s.path[0] === "run" &&
            ...
            let i = this.all ? r.topLevelWorkspace : n,
              o = this.since
                ? Array.from(
                  await Rr.gitUtils.fetchChangedWorkspaces({
                    ref: this.since,
                    project: r,
                  }),
                )
                : [
                  i,
                  ...this.from.length > 0
                    ? i.getRecursiveWorkspaceChildren()
                    : [],
                ],
              h = (E) =>
                Be.default.isMatch(
                  Y.structUtils.stringifyIdent(E.locator),
                  this.from,
                ),
              ...
              f = new Set([
                ...
                ...g.map((E) => [
                  ...this.recursive
                    ? this.since
                      ? E.getRecursiveWorkspaceDependents()
                      : E.getRecursiveWorkspaceDependencies()
                    : E.getRecursiveWorkspaceChildren(),
                ]).flat(),
              ]),
              A = [],
              p = !1;
            if (a == null ? void 0 : a.includes(":")) {
              for (
                let E of r.workspaces
              ) if (E.manifest.scripts.has(a) && (p = !p, p === !1)) break;
            }
            for (let E of f) {
              a && !E.manifest.scripts.has(a) && !p &&
                  !(await ge.scriptUtils.getWorkspaceAccessibleBinaries(E)).has(
                    a,
                  ) ||
                ...
                this.publicOnly && E.manifest.private === !0 || A.push(E);
            }
            let k = this.parallel
                ? this.jobs === "unlimited"
                  ? Infinity
                  : Number(this.jobs) || Math.max(1, (0, yr.cpus)().length / 2)
                : 1,
              y = k === 1 ? !1 : this.parallel,
              R = y ? this.interlaced : !0,
              _ = (0, br.default)(k),
              x = new Map(),
              T = new Set(),
              O = 0,
              W = null,
              G = !1,
              ne = await Ee.StreamReport.start({
                configuration: t,
                stdout: this.context.stdout,
              }, async (E) => {
                let b = async (C, { commandIndex: M }) => {
                  ...
                  try {
                    ...
                    if (this.verbose) {
                      ...
                      E.reportInfo(
                        null,
                        `${l} Process exited (exit code ${I})${ee}`,
                      );
                    }
                ...
                for (; x.size > 0 && !E.hasErrors();) {
                  ...
                  for (let [H, w] of x) {
                    ...
                    if (this.topological || this.topologicalDev) {
                      let c = this.topologicalDev
                        ? new Map([
                          ...w.manifest.dependencies,
                          ...w.manifest.devDependencies,
                        ])
                        : w.manifest.dependencies;
                      for (let u of c.values()) {
                        ...
                        if (
                          j = I === null ||
                            !x.has(I.anchoredLocator.locatorHash), !j
                        ) break;
                      }
                    }
                    if (
                      !!j &&
                      (T.add(w.anchoredDescriptor.descriptorHash),
                        C.push(_(async () => {
                          let c = await b(w, { commandIndex: ++O });
                          return x.delete(H),
                            T.delete(w.anchoredDescriptor.descriptorHash),
                            c;
                        })),
                        !y)
                    ) break;
                  ...
                  if (C.length === 0) {
                    let H = Array.from(x.values()).map((w) =>
                      Y.structUtils.prettyLocator(t, w.anchoredLocator)
                    ).join(", ");
                    E.reportError(
                      Ee.MessageName.CYCLIC_DEPENDENCIES,
                      `Dependency cycle detected (${H})`,
                    );
                    return;
                  }
                  let l = (await Promise.all(C)).find((H) => H !== 0);
                  W === null && (W = typeof l != "undefined" ? 1 : W),
      ...
      function zn(e, { configuration: t, commandIndex: r, verbose: n }) {
        if (!n) return null;
        let s = Y.structUtils.convertToIdent(e.locator),
          i = `[${Y.structUtils.stringifyIdent(s)}]:`,
