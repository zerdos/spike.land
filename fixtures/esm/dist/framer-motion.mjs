...
var __commonJS = (cb2, mod) =>
  function __require2() {
    return mod ||
      (0, cb2[__getOwnPropNames(cb2)[0]])((mod = { exports: {} }).exports, mod),
      mod.exports;
  };
  ...
  "../../node_modules/tslib/tslib.js"(exports, module) {
    ...
    (function (factory) {
      ...
      var extendStatics = Object.setPrototypeOf ||
        { __proto__: [] } instanceof Array && function (d, b2) {
            d.__proto__ = b2;
          } ||
        function (d, b2) {
          for (var p in b2) {
...
function useVisualElement(Component, visualState, props, createVisualElement) {
  ...
  if (!visualElementRef.current && createVisualElement) {
    visualElementRef.current = createVisualElement(Component, {
      ...
      parent,
      props,
      presenceId: presenceContext === null || presenceContext === void 0
        ? void 0
        : presenceContext.id,
  ...
  useEffect2(function () {
    var _a;
    (_a = visualElement2 === null || visualElement2 === void 0
          ? void 0
          : visualElement2.animationState) === null || _a === void 0
      ? void 0
      : _a.animateChanges();
  });
  useIsomorphicLayoutEffect(function () {
...
function resolveVariantFromProps(
  ...
  if (typeof definition === "string") {
    definition = (_a = props.variants) === null || _a === void 0
      ? void 0
      : _a[definition];
  }
  if (typeof definition === "function") {
...
function checkIfControllingVariants(props) {
  var _a;
  return typeof ((_a = props.animate) === null || _a === void 0
        ? void 0
        : _a.start) === "function" ||
    isVariantLabel(props.initial) || isVariantLabel(props.animate) ||
    isVariantLabel(props.whileHover) || isVariantLabel(props.whileDrag) ||
    isVariantLabel(props.whileTap) || isVariantLabel(props.whileFocus) ||
...
function useCreateMotionContext(props) {
  var _a = getCurrentTreeVariants(props, useContext5(MotionContext)),
    initial = _a.initial,
    animate3 = _a.animate;
      ...
      resolveVelocity = (t) => {
        ...
        return dampingRatio * undampedAngularFreq * envelope *
            (Math.sin(angularFreq * t) *
                (initialVelocity +
                  dampingRatio * undampedAngularFreq * initialDelta) /
                angularFreq + initialDelta * Math.cos(angularFreq * t)) -
          envelope *
...
var isColorString = (type, testProp) =>
  (v) => {
    return Boolean(
...
var splitColor = (aName, bName, cName) =>
  (v) => {
    if (!isString(v)) {
      return v;
    }
...
function test(v) {
  ...
  return isNaN(v) && isString(v) &&
    ((_b = (_a = v.match(floatRegex)) === null || _a === void 0
                  ? void 0
                  : _a.length) !== null && _b !== void 0
            ? _b
            : 0) +
          ((_d = (_c = v.match(colorRegex)) === null || _c === void 0
                  ? void 0
...
function detectAnimationFromOptions(config) {
  ...
  if (keys.has("ease") || keys.has("duration") && !keys.has("dampingRatio")) {
    ...
    keys.has("dampingRatio") || keys.has("stiffness") || keys.has("mass") ||
    keys.has("damping") || keys.has("restSpeed") || keys.has("restDelta")
  ) {
    return spring;
  }
  return keyframes;
...
var isAnimatable = function (key, value) {
  ...
  if (
    typeof value === "string" && complex.test(value) &&
...
var getDefaultTransition = function (valueKey, to) {
  ...
  if (isKeyframesTarget(to)) {
    ...
    transitionFactory = defaultTransitions[valueKey] ||
...
function getDelayFromTransition(transition, key) {
  ...
  return (_b = (_a = valueTransition.delay) !== null && _a !== void 0
          ? _a
          : transition.delay) !== null && _b !== void 0
    ? _b
    : 0;
}
...
function getAnimation(key, value, target, transition, onComplete) {
  var _a;
  var valueTransition = getValueTransition(transition, key);
  var origin = (_a = valueTransition.from) !== null && _a !== void 0
    ? _a
    : value.get();
  ...
  if (origin === "none" && isTargetAnimatable && typeof target === "string") {
    ...
    !Array.isArray(target) && isZero(target) && typeof origin === "string"
  ) {
  ...
  warning(
    ...
    "You are trying to animate ".concat(key, ' from "').concat(origin, '" to "')
      .concat(target, '". ').concat(
        origin,
        " is not an animatable value - to enable this animation set ",
      ).concat(origin, " to a value animatable to ").concat(
        target,
        ...
        __assign(
          ...
          ),
          {
            onUpdate: function (v) {
              var _a2;
              options.onUpdate(v);
              (_a2 = valueTransition.onUpdate) === null || _a2 === void 0
                ? void 0
                : _a2.call(valueTransition, v);
            },
            onComplete: function () {
              var _a2;
              options.onComplete();
              (_a2 = valueTransition.onComplete) === null || _a2 === void 0
                ? void 0
                : _a2.call(valueTransition);
            },
          },
        ),
      );
  ...
  function set() {
    ...
    onComplete();
    (_a2 = valueTransition === null || valueTransition === void 0
          ? void 0
          : valueTransition.onUpdate) === null || _a2 === void 0
      ? void 0
      : _a2.call(valueTransition, finalTarget);
    (_b = valueTransition === null || valueTransition === void 0
          ? void 0
          : valueTransition.onComplete) === null || _b === void 0
      ? void 0
      : _b.call(valueTransition);
    return {
      stop: function () {
      },
    };
  }
  return !isOriginAnimatable || !isTargetAnimatable ||
...
function mixValues(
  ...
  if (shouldCrossfadeOpacity) {
    ...
    target.opacityExit = mix(
      (_b = follow.opacity) !== null && _b !== void 0 ? _b : 1,
      0,
      easeCrossfadeOut(progress2),
    );
  } else if (isOnlyMember) {
    target.opacity = mix(
      (_c = follow.opacity) !== null && _c !== void 0 ? _c : 1,
      (_d = lead.opacity) !== null && _d !== void 0 ? _d : 1,
      progress2,
    );
  }
  for (var i = 0; i < numBorders; i++) {
    ...
    var canMix = followRadius === 0 || leadRadius === 0 ||
      isPx(followRadius) === isPx(leadRadius);
    if (canMix) {
      target[borderLabel] = Math.max(
        mix(asNumber(followRadius), asNumber(leadRadius), progress2),
        0,
      );
...
function getRadius(values, radiusName) {
  var _a;
  return (_a = values[radiusName]) !== null && _a !== void 0
    ? _a
    : values.borderRadius;
}
...
function hasTransform(values) {
  return hasScale(values) || hasTranslate(values.x) || hasTranslate(values.y) ||
    values.z || values.rotate || values.rotateX || values.rotateY;
}
...
function applyTreeDeltas(box, treeScale, treePath, isSharedTransition) {
  ...
  for (var i = 0; i < treeLength; i++) {
    ...
    if (
      ((_b = (_a = node.instance) === null || _a === void 0
              ? void 0
...
function transformAxis(axis, transforms, _a) {
  ...
  var axisOrigin = transforms[originKey] !== void 0
...
function calcAxisDelta(delta, source, target, origin) {
  ...
  delta.translate = mix(target.min, target.max, delta.origin) -
    delta.originPoint;
...
function boxEquals(a2, b2) {
  return a2.x.min === b2.x.min && a2.x.max === b2.x.max &&
    a2.y.min === b2.y.min && a2.y.max === b2.y.max;
}
  ...
  NodeStack2.prototype.exitAnimationComplete = function () {
    this.members.forEach(function (node) {
      ...
      (_b = (_a = node.options).onExitComplete) === null || _b === void 0
        ? void 0
        : _b.call(_a);
      (_e = (_c = node.resumingFrom) === null || _c === void 0
            ? void 0
...
function buildProjectionTransform(delta, treeScale, latestTransform) {
  ...
  var transform2 = "translate3d(".concat(xTranslate, "px, ").concat(
    yTranslate,
    "px, 0) ",
  );
  if (latestTransform) {
...
function createProjectionNode(_a) {
  ...
  return function () {
    ...
    ProjectionNode.prototype.mount = function (instance, isLayoutDirty) {
      ...
      (_a2 = this.parent) === null || _a2 === void 0
        ? void 0
        : _a2.children.add(this);
      ...
      if (
        this.options.animate !== false && visualElement2 && (layoutId || layout)
      ) {
        this.addEventListener("didUpdate", function (_a3) {
          ...
          var layoutTransition =
            (_c = (_b2 = _this.options.transition) !== null && _b2 !== void 0
                  ? _b2
          ...
          var onLayoutAnimationComplete =
            visualElement2.getProps().onLayoutAnimationComplete;
          var targetChanged = !_this.targetLayout ||
            !boxEquals(_this.targetLayout, newLayout) ||
            hasRelativeTargetChanged;
          var hasOnlyRelativeTargetChanged = !hasLayoutChanged &&
            hasRelativeTargetChanged;
          if (
            ((_d = _this.resumeFrom) === null || _d === void 0
              ? void 0
              : _d.instance) ||
            ...
            _this.isLead() &&
              ((_f = (_e = _this.options).onExitComplete) === null ||
                  _f === void 0
                ? void 0
                : _f.call(_e));
          }
    ...
    ProjectionNode.prototype.unmount = function () {
      ...
      (_a2 = this.getStack()) === null || _a2 === void 0
        ? void 0
        : _a2.remove(this);
    ...
    ProjectionNode.prototype.startUpdate = function () {
      ...
      (_a2 = this.nodes) === null || _a2 === void 0
        ? void 0
        : _a2.forEach(resetRotation);
    };
    ProjectionNode.prototype.willUpdate = function (shouldNotifyListeners) {
      ...
      if (this.root.isUpdateBlocked()) {
        (_b = (_a2 = this.options).onExitComplete) === null || _b === void 0
          ? void 0
          : _b.call(_a2);
        return;
      }
      ...
      var transformTemplate =
        (_c = this.options.visualElement) === null || _c === void 0
          ? void 0
          : _c.getProps().transformTemplate;
      this.prevTransformTemplateValue =
        transformTemplate === null || transformTemplate === void 0
          ? void 0
    ...
    ProjectionNode.prototype.updateLayout = function () {
      ...
      (_a2 = this.options.visualElement) === null || _a2 === void 0
        ? void 0
    ...
    ProjectionNode.prototype.resetTransform = function () {
      ...
      var hasProjection = this.projectionDelta &&
        !isDeltaZero(this.projectionDelta);
      var transformTemplate =
        (_a2 = this.options.visualElement) === null || _a2 === void 0
          ? void 0
          : _a2.getProps().transformTemplate;
    ...
    ProjectionNode.prototype.removeTransform = function (box) {
      ...
      for (var i = 0; i < this.path.length; i++) {
        ...
        removeBoxTransforms(
          boxWithoutTransform,
          node.latestValues,
          (_a2 = node.snapshot) === null || _a2 === void 0
            ? void 0
            : _a2.layout,
          sourceBox,
        );
    ...
    ProjectionNode.prototype.setOptions = function (options) {
      ...
      this.options = __assign(__assign(__assign({}, this.options), options), {
        crossfade: (_a2 = options.crossfade) !== null && _a2 !== void 0
          ? _a2
          : true,
      });
    };
    ...
    ProjectionNode.prototype.scheduleRender = function (notifyAll) {
      ...
      (_b = (_a2 = this.options).scheduleRender) === null || _b === void 0
        ? void 0
        : _b.call(_a2);
      notifyAll &&
    ...
    ProjectionNode.prototype.setAnimationOrigin = function (
      ...
      var isSharedLayoutAnimation = snapshot === null || snapshot === void 0
        ? void 0
        : snapshot.isShared;
      var isOnlyMember =
        (((_a2 = this.getStack()) === null || _a2 === void 0
          ? void 0
          : _a2.members.length) || 0) <= 1;
      ...
      this.mixTargetDelta = function (latest) {
        ...
        if (
          _this.relativeTarget && _this.relativeTargetOrigin && _this.layout &&
          ((_a3 = _this.relativeParent) === null || _a3 === void 0
            ? void 0
            : _a3.layout)
        ) {
          calcRelativePosition(
    ...
    ProjectionNode.prototype.startAnimation = function (options) {
      var _this = this;
      var _a2, _b;
      (_a2 = this.currentAnimation) === null || _a2 === void 0
        ? void 0
        : _a2.stop();
        ...
        _this.currentAnimation = animate2(
          ...
          __assign(__assign({}, options), {
            onUpdate: function (latest) {
              ...
              (_a3 = options.onUpdate) === null || _a3 === void 0
                ? void 0
                : _a3.call(options, latest);
            },
            onComplete: function () {
              var _a3;
              (_a3 = options.onComplete) === null || _a3 === void 0
                ? void 0
                : _a3.call(options);
    ...
    ProjectionNode.prototype.finishAnimation = function () {
      ...
      if (this.currentAnimation) {
        (_a2 = this.mixTargetDelta) === null || _a2 === void 0
          ? void 0
          : _a2.call(this, animationTarget);
    ...
    ProjectionNode.prototype.registerSharedNode = function (layoutId, node) {
      ...
      node.promote({
        transition:
          (_a2 = node.options.initialPromotionConfig) === null || _a2 === void 0
            ? void 0
            : _a2.transition,
    ...
    ProjectionNode.prototype.getProjectionStyles = function (styleProp) {
      ...
      if (!this.projectionDelta || !this.layout || !lead.target) {
        ...
        if (this.options.layoutId) {
          emptyStyles.opacity =
            (_b = this.latestValues.opacity) !== null && _b !== void 0 ? _b : 1;
      ...
      styles.transformOrigin = "".concat(x.origin * 100, "% ").concat(
        y.origin * 100,
        "% 0",
      );
      if (lead.animationValues) {
        styles.opacity = lead === this
          ? (_d = (_c = valuesToRender.opacity) !== null && _c !== void 0
                  ? _c
                  : this.latestValues.opacity) !== null && _d !== void 0
            ? _d
            : 1
        ...
        styles.opacity = lead === this
          ...
          : (_f = valuesToRender.opacityExit) !== null && _f !== void 0
          ? _f
          : 0;
      }
    ...
    ProjectionNode.prototype.resetTree = function () {
      this.root.nodes.forEach(function (node) {
        var _a2;
        return (_a2 = node.currentAnimation) === null || _a2 === void 0
          ? void 0
          : _a2.stop();
      });
...
function notifyLayoutUpdate(node) {
  var _a, _b, _c, _d;
  var snapshot =
    (_b = (_a = node.resumeFrom) === null || _a === void 0
          ? void 0
          : _a.snapshot) !== null && _b !== void 0
      ? _b
      : node.snapshot;
  if (
    ...
    (_d = (_c = node.options).onExitComplete) === null || _d === void 0
      ? void 0
      : _d.call(_c);
  }
...
function mountNodeEarly(node, id3) {
  ...
  var searchElement = searchNode && searchNode !== node.root
    ? searchNode.instance
    : document;
  var element = searchElement.querySelector(
    '[data-projection-id="'.concat(id3, '"]'),
  );
  if (element) {
...
function useProjection(
  ...
  if (
    !ProjectionNodeConstructor || !visualElement2 ||
    (visualElement2 === null || visualElement2 === void 0
      ? void 0
  ...
  visualElement2.projection = new ProjectionNodeConstructor(
    ...
    (_b = visualElement2.parent) === null || _b === void 0
      ? void 0
      : _b.projection,
  );
  ...
  function MotionComponent(props, externalRef) {
    ...
    if (!config.isStatic && isBrowser) {
      context.visualElement = useVisualElement(
        Component,
        visualState,
        __assign(__assign({}, config), props),
        createVisualElement,
      );
      useProjection(
        projectionId,
...
function useLayoutId(_a) {
  ...
  var layoutId = _a.layoutId;
  var layoutGroupId =
    (_b = useContext7(LayoutGroupContext)) === null || _b === void 0
      ? void 0
      : _b.id;
...
function buildTransform(_a, _b, transformIsDefault, transformTemplate) {
  ...
  for (var i = 0; i < numTransformKeys; i++) {
    ...
    transformString += "".concat(translateAlias[key] || key, "(").concat(
      transform2[key],
      ") ",
    );
    if (key === "z") {
...
function buildHTMLStyles(state, latestValues, options, transformTemplate) {
  ...
  for (var key in latestValues) {
    ...
    if (isTransformProp(key)) {
      ...
      if (
        value !== ((_a = valueType.default) !== null && _a !== void 0 ? _a : 0)
      ) {
...
function makeLatestValues(props, context, presenceContext, scrapeMotionValues) {
  ...
  if (
    context && isVariantNode && !isControllingVariants &&
    props.inherit !== false
  ) {
...
function useFocusGesture(_a) {
  ...
  var onFocus = function () {
    var _a2;
    (_a2 = visualElement2.animationState) === null || _a2 === void 0
      ? void 0
      : _a2.setActive(AnimationType.Focus, true);
  };
  var onBlur = function () {
    var _a2;
    (_a2 = visualElement2.animationState) === null || _a2 === void 0
      ? void 0
      : _a2.setActive(AnimationType.Focus, false);
  };
...
function filterPrimaryPointer(eventHandler) {
  return function (event) {
    ...
    var isPrimaryPointer = !isMouseEvent2 ||
      isMouseEvent2 && event.button === 0;
    if (isPrimaryPointer) {
      eventHandler(event);
    }
  };
...
function createHoverEvent(visualElement2, isActive, callback) {
  return function (event, info) {
    ...
    (_a = visualElement2.animationState) === null || _a === void 0
      ? void 0
...
function useTapGesture(_a) {
  ...
  function removePointerEndListener() {
    var _a2;
    (_a2 = cancelPointerEndListeners.current) === null || _a2 === void 0
      ? void 0
      : _a2.call(cancelPointerEndListeners);
  ...
  function checkPointerEnd() {
    ...
    (_a2 = visualElement2.animationState) === null || _a2 === void 0
      ? void 0
      : _a2.setActive(AnimationType.Tap, false);
    return !isDragActive();
  }
  ...
  function onPointerDown(event, info) {
    ...
    (_a2 = visualElement2.animationState) === null || _a2 === void 0
      ? void 0
      : _a2.setActive(AnimationType.Tap, true);
...
var fireObserverCallback = function (entry) {
  var _a;
  (_a = observerCallbacks.get(entry.target)) === null || _a === void 0
    ? void 0
    : _a(entry);
};
...
function useIntersectionObserver(shouldObserve, state, visualElement2, _a) {
  ...
  useEffect5(function () {
    ...
    var intersectionCallback = function (entry) {
      ...
      (_a2 = visualElement2.animationState) === null || _a2 === void 0
        ? void 0
        : _a2.setActive(AnimationType.InView, isIntersecting);
      var props = visualElement2.getProps();
...
function useMissingIntersectionObserver(
  ...
  useEffect5(function () {
    ...
    requestAnimationFrame(function () {
      ...
      (_a2 = visualElement2.animationState) === null || _a2 === void 0
        ? void 0
        : _a2.setActive(AnimationType.InView, true);
    });
  }, [shouldObserve]);
}
...
function setVariants(visualElement2, variantLabels) {
  var reversedLabels = __spreadArray([], __read(variantLabels), false)
    .reverse();
  reversedLabels.forEach(function (key) {
    var _a;
    var variant = visualElement2.getVariant(key);
    variant && setTarget(visualElement2, variant);
    (_a = visualElement2.variantChildren) === null || _a === void 0
      ? void 0
...
function checkTargetForNewValues(visualElement2, target, origin) {
  ...
  for (var i = 0; i < numNewValues; i++) {
    ...
    if (value === null) {
      value = (_b = (_a = origin[key]) !== null && _a !== void 0
              ? _a
              : visualElement2.readValue(key)) !== null && _b !== void 0
        ? _b
        : target[key];
    }
  ...
  for (var key in target) {
    origin[key] =
      (_a = getOriginFromTransition(key, transition)) !== null && _a !== void 0
        ? _a
        : (_b = visualElement2.getValue(key)) === null || _b === void 0
        ? void 0
        : _b.get();
  }
  return origin;
...
function animateVariant(visualElement2, variant, options) {
  ...
  var _b = (resolved || {}).transition,
    transition = _b === void 0
      ? visualElement2.getDefaultTransition() || {}
      : _b;
...
function animateTarget(visualElement2, definition, _a) {
  ...
  var animations2 = [];
  var animationTypeState = type &&
    ((_b = visualElement2.animationState) === null || _b === void 0
      ? void 0
      : _b.getState()[type]);
  for (var key in target) {
...
function animateChildren(
  ...
  var animations2 = [];
  var maxStaggerDuration = (visualElement2.variantChildren.size - 1) *
    staggerChildren;
  ...
  Array.from(visualElement2.variantChildren).sort(sortByTreeOrder).forEach(
    function (child, i) {
      animations2.push(
        animateVariant(
          child,
...
function shouldBlockAnimation(_a, key) {
  ...
  var shouldBlock = protectedKeys.hasOwnProperty(key) &&
...
function createAnimationState(visualElement2) {
  ...
  function animateChanges(options, changedActiveType) {
    ...
    var _loop_1 = function (i2) {
      ...
      var prop = (_a = props[type]) !== null && _a !== void 0
        ? _a
        : context[type];
      ...
      var isInherited = prop === context[type] && prop !== props[type] &&
        propIsVariant;
      if (
        isInherited && isInitialRender && visualElement2.manuallyAnimateOnMount
      ) {
        isInherited = false;
      }
      ...
      if (
        ...
        !prop && !typeState.prevProp || isAnimationControls(prop) ||
        typeof prop === "boolean"
      ) {
        return "continue";
      }
      ...
      if (shouldAnimateType && !isInherited) {
        animations2.push.apply(
          ...
          __spreadArray(
            [],
            __read(definitionList.map(function (animation) {
              return {
                animation,
  ...
  exit: makeRenderlessComponent(function (props) {
    ...
    useEffect7(function () {
      ...
      var animation =
        (_a2 = visualElement2.animationState) === null || _a2 === void 0
          ? void 0
          : _a2.setActive(AnimationType.Exit, !isPresent2, {
            custom: (_b = presenceContext === null || presenceContext === void 0
                    ? void 0
...
var VisualElementDragControls = function () {
  ...
  VisualElementDragControls2.prototype.start = function (originEvent, _a) {
    ...
    var onStart = function (event, info) {
      ...
      (_a2 = _this.visualElement.animationState) === null || _a2 === void 0
        ? void 0
        : _a2.setActive(AnimationType.Drag, true);
    };
  ...
  VisualElementDragControls2.prototype.resolveConstraints = function () {
    ...
    if (
      prevConstraints !== this.constraints && layout && this.constraints &&
  ...
  VisualElementDragControls2.prototype.startAnimation = function (velocity) {
    ...
    var momentumAnimations = eachAxis(function (axis) {
      ...
      var transition = (_a2 = constraints === null || constraints === void 0
              ? void 0
              : constraints[axis]) !== null && _a2 !== void 0
        ? _a2
        : {};
      if (dragSnapToOrigin) {
        transition = { min: 0, max: 0 };
      }
      var bounceStiffness = dragElastic
        ? 200
        : 1e6;
  ...
  VisualElementDragControls2.prototype.getAxisMotionValue = function (axis) {
    ...
    return externalMotionValue
      ...
      : this.visualElement.getValue(
        axis,
        (_b = (_a = this.visualElement.getProps().initial) ===
                  null ||
                _a === void 0
              ? void 0
...
var visualElement = function (_a) {
  ...
  return function (_a2, options) {
    var parent = _a2.parent,
      ...
      shouldReduceMotion = _a2.shouldReduceMotion;
    if (options === void 0) {
      options = {};
    }
    var isMounted = false;
    ...
    var element = __assign(
      __assign({
        ...
        mount: function (newInstance) {
          ...
          if (isVariantNode && parent && !isControllingVariants) {
            removeFromVariantTree = parent === null || parent === void 0
              ? void 0
        ...
        unmount: function () {
          var _a3;
          (_a3 = element.projection) === null || _a3 === void 0
            ? void 0
            : _a3.unmount();
        ...
        addVariantChild: function (child) {
          ...
          if (closestVariantNode) {
            (_a3 = closestVariantNode.variantChildren) === null ||
              _a3 === void 0
              ? void 0
              : _a3.add(child);
            return function () {
        ...
        removeValue: function (key2) {
          var _a3;
          values.delete(key2);
          (_a3 = valueSubscriptions.get(key2)) === null || _a3 === void 0
            ? void 0
            : _a3();
        ...
        readValue: function (key2) {
          var _a3;
          return (_a3 = latestValues[key2]) !== null && _a3 !== void 0
            ? _a3
      ...
      }, lifecycles),
      {
        ...
        getVariant: function (name) {
          var _a3;
          return (_a3 = props.variants) === null || _a3 === void 0
            ? void 0
            : _a3[name];
        },
        ...
        getVariantContext: function (startAtParent) {
          ...
          if (!isControllingVariants) {
            var context_1 = (parent === null || parent === void 0
              ? void 0
              : parent.getVariantContext()) || {};
  ...
  targetPositionalKeys.forEach(function (key) {
    ...
    if (fromType !== toType) {
      if (isNumOrPxType(fromType) && isNumOrPxType(toType)) {
        ...
        transitionEnd[key] = transitionEnd[key] !== void 0
          ? transitionEnd[key]
          : target[key];
...
var svgVisualElement = visualElement(
  __assign(__assign({}, htmlConfig), {
    ...
    readValueFromInstance: function (domElement, key) {
      var _a;
      if (isTransformProp(key)) {
        return ((_a = getDefaultValueType(key)) === null || _a === void 0
          ? void 0
          : _a.default) || 0;
      }
    ...
    if (projection) {
      ...
      if (
        (switchLayoutGroup === null || switchLayoutGroup === void 0
          ? void 0
          : switchLayoutGroup.register) && layoutId
      ) {
    ...
    if (prevProps.isPresent !== isPresent2) {
      if (isPresent2) {
        ...
        es_default.postRender(function () {
          var _a2;
          if (
            !((_a2 = projection.getStack()) === null || _a2 === void 0
              ? void 0
              : _a2.members.length)
          ) {
            _this.safeToRemove();
...
function MeasureLayout(props) {
  ...
  return React__default2.createElement(
...
var HTMLProjectionNode = createProjectionNode({
  ...
  resetTransform: function (instance, value) {
    instance.style.transform = value !== null && value !== void 0
      ? value
      : "none";
  },
});
  ...
  var context = useMemo4(function () {
    return {
      ...
      onExitComplete: function (childId) {
        ...
        try {
          for (
            var _b = __values(presenceChildren.values()), _c = _b.next();
            !_c.done;
            _c = _b.next()
          ) {
  ...
  children.forEach(function (child) {
    ...
    if (seenChildren) {
      if (seenChildren.has(key)) {
        console.warn(
          'Children of AnimatePresence require unique keys. "'.concat(
            key,
            '" is a duplicate.',
          ),
        );
...
var AnimatePresence = function (_a) {
  ...
  var exiting = useRef7(/* @__PURE__ */ new Set()).current;
  ...
  return React4.createElement(
    React4.Fragment,
    null,
    exiting.size ? childrenToRender : childrenToRender.map(function (child) {
...
var LayoutGroup = function (_a) {
  ...
  var upstreamId = (_b = layoutGroupContext.id) !== null && _b !== void 0
    ? _b
  ...
  if (context.current === null) {
    ...
    context.current = {
      id: id3,
      group: inheritId
        ? (_c = layoutGroupContext === null || layoutGroupContext === void 0
                ? void 0
                : layoutGroupContext.group) !== null && _c !== void 0
          ? _c
          : nodeGroup()
        : nodeGroup(),
    };
...
import { useContext as useContext15, useMemo as useMemo6 } from "react";
    ...
    if (isLazyBundle(features)) {
      features().then(function (_a2) {
        var renderer2 = _a2.renderer,
          loadedFeatures2 = __rest(_a2, ["renderer"]);
...
function ReorderGroup(_a, externalRef) {
  ...
  var context = {
    ...
    registerItem: function (value, layout) {
      if (
        layout && order2.findIndex(function (entry) {
    ...
    updateOrder: function (id3, offset, velocity) {
      ...
      if (order2 !== newOrder) {
        ...
        onReorder(
          newOrder.map(getValue).filter(function (value) {
...
function transform() {
  ...
  var interpolator = interpolate(
    inputRange,
    outputRange,
    __assign({ mixer: getMixer2(outputRange[0]) }, options),
  );
...
function ReorderItem(_a, externalRef) {
  var children = _a.children,
    ...
    as = _b === void 0 ? "li" : _b,
    onDrag = _a.onDrag,
    props = __rest(_a, ["children", "style", "value", "as", "onDrag"]);
  var Component = useConstant(function () {
    return motion(as);
  });
  ...
  var point = {
    x: useDefaultMotionValue(
      style === null || style === void 0 ? void 0 : style.x,
    ),
    y: useDefaultMotionValue(
      style === null || style === void 0 ? void 0 : style.y,
    ),
  };
  ...
  return React10.createElement(
    Component,
    __assign({ drag: axis }, props, {
      dragSnapToOrigin: true,
      style: __assign(__assign({}, style), { x: point.x, y: point.y, zIndex }),
      layout: true,
...
var domAnimation = __assign(
  __assign({ renderer: createDomVisualElement }, animations),
  gestureAnimations,
);

// ../../node_modules/framer-motion/dist/es/render/dom/features-max.mjs
var domMax = __assign(
  __assign(__assign(__assign({}, domAnimation), drag), layoutFeatures),
  ...
  useMemo7(function () {
    return value.attach(function (v, set) {
      ...
      activeSpringAnimation.current = animate(
        __assign(
          __assign(
            { from: value.get(), to: v, velocity: value.getVelocity() },
            config,
          ),
          { onUpdate: set },
        ),
...
function useElementScroll(ref) {
  ...
  useIsomorphicLayoutEffect(function () {
    ...
    var updateScrollValues = createScrollUpdater(
      values,
...
var getCurrentTime2 = typeof performance !== "undefined"
  ? function () {
  ...
  var controls = {
    ...
    mount: function () {
      ...
      pendingAnimations.forEach(function (_a) {
        ...
        controls.start.apply(
          controls,
          __spreadArray([], __read(animation), false),
        ).then(resolve);
      });
      return function () {
        hasMounted = false;
...
import { useRef as useRef13, useState as useState5 } from "react";
function useCycle() {
  var items = [];
  for (var _i = 0; _i < arguments.length; _i++) {
  ...
  var _a = __read(useState5(items[index.current]), 2),
    item = _a[0],
    setItem = _a[1];
  return [
    item,
...
import { useEffect as useEffect21, useState as useState6 } from "react";
...
function useAnimatedState(initialState) {
  var _a = __read(useState6(initialState), 2),
    animationState = _a[0],
